...
bool ViewportCuller::cubeInFrustum(double x0, double y0, double z0, double x1, double y1, double z1)
{
    ...
    if (!faces[0].inFront(xc, yc, zc, r))
    {
        return false;
    }
    if (!faces[1].inFront(xc, yc, zc, r))
    {
        return false;
    }
    if (!faces[2].inFront(xc, yc, zc, r))
    {
        return false;
    }
    if (!faces[3].inFront(xc, yc, zc, r))
    {
        return false;
    }
    if (!faces[4].inFront(xc, yc, zc, r))
    {
        return false;
    }
    if (!faces[5].inFront(xc, yc, zc, r))
    {
        return false;
    }

    if (!faces[0].inFront(x0, y0, z0, x1, y1, z1))
    {
        return false;
    }
    if (!faces[1].inFront(x0, y0, z0, x1, y1, z1))
    {
        return false;
    }
    if (!faces[2].inFront(x0, y0, z0, x1, y1, z1))
    {
        return false;
    }
    if (!faces[3].inFront(x0, y0, z0, x1, y1, z1))
    {
        return false;
    }
    if (!faces[4].inFront(x0, y0, z0, x1, y1, z1))
    {
        return false;
    }
    if (!faces[5].inFront(x0, y0, z0, x1, y1, z1))
    {
        return false;
    }
    return true;
...
bool ViewportCuller::cubeFullyInFrustum(double x0, double y0, double z0, double x1, double y1, double z1)
{
    ...
    if (!faces[0].fullyInFront(x0, y0, z0, x1, y1, z1))
    {
        return false;
    }
    if (!faces[1].fullyInFront(x0, y0, z0, x1, y1, z1))
    {
        return false;
    }
    if (!faces[2].fullyInFront(x0, y0, z0, x1, y1, z1))
    {
        return false;
    }
    if (!faces[3].fullyInFront(x0, y0, z0, x1, y1, z1))
    {
        return false;
    }
    if (!faces[4].fullyInFront(x0, y0, z0, x1, y1, z1))
    {
        return false;
    }
    if (!faces[5].fullyInFront(x0, y0, z0, x1, y1, z1))
    {
        return false;
    }
    return true;
