...
class find_iterator : public iterator_facade<
                      ...
                      private detail::find_iterator_base<IteratorT>
{
  ...
  public:
    ...
    */
    ...
    find_iterator(
        IteratorT Begin,
        IteratorT End,
        FinderT Finder) : detail::find_iterator_base<IteratorT>(Finder, 0),
                          m_Match(Begin, Begin),
                          m_End(End)
    {
        increment();
  ...
  private:
    ...
    bool equal(const find_iterator &Other) const
    {
        ...
        return bEof || bOtherEof ? bEof == bOtherEof : (m_Match == Other.m_Match && m_End == Other.m_End);
    }
...
*/
template <typename IteratorT>
class split_iterator : public iterator_facade<
                       ...
                       private detail::find_iterator_base<IteratorT>
{
  ...
  public:
    ...
    */
    split_iterator(const split_iterator &Other) : base_type(Other),
                                                  m_Match(Other.m_Match),
                                                  m_Next(Other.m_Next),
                                                  m_End(Other.m_End),
                                                  m_bEof(Other.m_bEof)
  ...
  private:
    ...
    bool equal(const split_iterator &Other) const
    {
        ...
        return bEof || bOtherEof ? bEof == bOtherEof : (m_Match == Other.m_Match && m_Next == Other.m_Next && m_End == Other.m_End);
    }
