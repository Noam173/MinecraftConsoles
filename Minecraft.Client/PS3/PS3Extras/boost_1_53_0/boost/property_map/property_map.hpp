...
template <class PA>
struct is_property_map : boost::mpl::and_<
                             has_key_type<PA>,
                             has_value_type<PA>,
                             has_reference<PA>,
                             has_category<PA>>
...
template <typename PA>
struct property_traits : boost::mpl::if_<is_property_map<PA>,
...
#else
          ,
          class T = typename std::iterator_traits<RandomAccessIterator>::value_type, class R = typename std::iterator_traits<RandomAccessIterator>::reference
#endif
          >
...
class iterator_property_map<RandomAccessIterator,
                            ...
                            ValueType, Reference>
    : public parallel::distributed_property_map<ProcessGroup,
                                                GlobalMap,
