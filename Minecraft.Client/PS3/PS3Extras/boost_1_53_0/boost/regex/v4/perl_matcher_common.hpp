...
{
    ::boost::re_detail::concrete_protected_call<perl_matcher<BidiIterator, Allocator, traits>>
        obj(this, proc);
    return obj.execute();
}
#endif
...
bool perl_matcher<BidiIterator, Allocator, traits>::find_imp()
{
    ...
    try
    {
        ...
        unsigned type = (m_match_flags & match_continuous) ? static_cast<unsigned int>(regbase::restart_continue)
