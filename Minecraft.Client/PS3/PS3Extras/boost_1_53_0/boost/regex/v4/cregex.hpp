...
class BOOST_REGEX_DECL RegEx
{
  ...
  public:
    ...
    unsigned int Grep(GrepCallback cb, const std::string &s, match_flag_type flags = match_default)
    {
    ...
    unsigned int GrepFiles(GrepFileCallback cb, const std::string &files, bool recurse = false, match_flag_type flags = match_default)
    {
    ...
    unsigned int FindFiles(FindFilesCallback cb, const std::string &files, bool recurse = false, match_flag_type flags = match_default)
    {
