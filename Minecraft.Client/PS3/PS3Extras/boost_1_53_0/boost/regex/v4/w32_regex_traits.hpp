...
class w32_regex_traits_char_layer : public w32_regex_traits_base<charT>
{
  ...
  public:
    ...
    regex_constants::escape_syntax_type escape_syntax_type(charT c) const
    {
        ...
        if (i == m_char_map.end())
        {
            if (::boost::re_detail::w32_is_lower(c, this->m_locale))
            {
                return regex_constants::escape_type_class;
            }
            if (::boost::re_detail::w32_is_upper(c, this->m_locale))
            {
...
class w32_regex_traits
{
  public:
    ...
    {
        if ((f & re_detail::w32_regex_traits_implementation<charT>::mask_base) && (this->m_pimpl->isctype(f & re_detail::w32_regex_traits_implementation<charT>::mask_base, c)))
        {
            return true;
        }
        ...
        else if ((f & re_detail::w32_regex_traits_implementation<charT>::mask_vertical) && (::boost::re_detail::is_separator(c) || (c == '\v')))
        {
            return true;
        }
        else if ((f & re_detail::w32_regex_traits_implementation<charT>::mask_horizontal) && this->isctype(c, 0x0008u) && !this->isctype(c, re_detail::w32_regex_traits_implementation<charT>::mask_vertical))
        {
            return true;
        }
        return false;
