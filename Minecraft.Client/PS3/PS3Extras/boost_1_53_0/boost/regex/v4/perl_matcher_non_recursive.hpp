...
#pragma option push -w-8008 -w-8066 -w-8004
    ...
    if ((m_backup_state->state_id != saved_state_repeater_count) || (static_cast<saved_repeater<BidiIterator> *>(m_backup_state)->count.get_id() != rep->state_id) || (next_count->get_id() != rep->state_id))
    {
