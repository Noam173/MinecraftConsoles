...
#if !defined(BOOST_NO_TEMPLATED_ITERATOR_CONSTRUCTORS) && !BOOST_WORKAROUND(BOOST_MSVC, < 1310) && !BOOST_WORKAROUND(__BORLANDC__, <= 0x0551) && !BOOST_WORKAROUND(__DECCXX_VER, BOOST_TESTED_AT(60590042))
