    ...
    class named_sem_callbacks : public windows_named_sync_interface
    {
      public:
        ...
        virtual bool open(create_enum_t, const char *id_name)
        {
            ...
            bool created;
            return m_sem_wrapper.open_or_create(aux_str.c_str(), static_cast<long>(m_sem_count), winapi_semaphore_wrapper::MaxCount, sem_perm, created);
        }
...
inline windows_named_semaphore::windows_named_semaphore(create_only_t, const char *name, unsigned int initial_count, const permissions &perm)
    : m_sem_wrapper()
{
...
inline windows_named_semaphore::windows_named_semaphore(open_or_create_t, const char *name, unsigned int initial_count, const permissions &perm)
    : m_sem_wrapper()
{
    named_sem_callbacks callbacks(m_sem_wrapper, initial_count);
