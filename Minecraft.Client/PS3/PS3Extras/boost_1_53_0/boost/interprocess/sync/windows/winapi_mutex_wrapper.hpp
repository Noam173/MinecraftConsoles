...
class winapi_mutex_functions
{
  ...
  public:
    ...
    bool timed_lock(const boost::posix_time::ptime &abs_time)
    {
        ...
        unsigned long ret = winapi::wait_for_single_object(m_mtx_hnd, (abs_time - microsec_clock::universal_time()).total_milliseconds());
        if (ret == winapi::wait_object_0)
        {
            return true;
        }
    ...
    : public winapi_mutex_functions
{
  ...
  public:
    ...
    bool open_or_create(const char *name, const permissions &perm)
    {
        ...
        {
            m_mtx_hnd = winapi::open_or_create_mutex(name, false, (winapi::interprocess_security_attributes *)perm.get_permissions());
