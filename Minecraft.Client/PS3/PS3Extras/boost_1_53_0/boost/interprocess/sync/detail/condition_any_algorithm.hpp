...
class condition_any_algorithm
{
  ...
  public:
    template <class Lock>
    static bool wait(ConditionAnyMembers &data, Lock &mut, bool timeout_enabled, const boost::posix_time::ptime &abs_time);
...
template <class ConditionAnyMembers>
template <class Lock>
bool condition_any_algorithm<ConditionAnyMembers>::wait(ConditionAnyMembers &data, Lock &lock, bool tout_enabled, const boost::posix_time::ptime &abs_time)
{
    if (tout_enabled)
    {
...
template <class ConditionAnyMembers>
template <class Lock>
void condition_any_algorithm<ConditionAnyMembers>::do_wait(ConditionAnyMembers &data, Lock &lock)
{
...
template <class ConditionAnyMembers>
template <class Lock>
bool condition_any_algorithm<ConditionAnyMembers>::do_timed_wait(ConditionAnyMembers &data, Lock &lock, const boost::posix_time::ptime &abs_time)
{
    // lock internal before unlocking external to avoid race with a notifier
    scoped_lock<mutex_type> internal_lock(data.get_mutex());
    {
