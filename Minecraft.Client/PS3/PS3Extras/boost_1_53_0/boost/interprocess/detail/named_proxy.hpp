...
//! allocation syntax.
template <class SegmentManager // segment manager to construct the object
          ,
...
class named_proxy
{
  ...
  public:
    ...
    {
        CtorNArg<T, is_iterator, Args...> &&ctor_obj = CtorNArg<T, is_iterator, Args...>(boost::forward<Args>(args)...);
...
#define BOOST_PP_LOCAL_MACRO(n)                                                                \
    ...
    {                                                                                          \
      ...
      private:                                                                                 \
        void construct(void *mem, true_)                                                       \
        {                                                                                      \
            new ((void *)mem) T(BOOST_PP_ENUM(n, BOOST_INTERPROCESS_PP_MEMBER_IT_FORWARD, _)); \
        }                                                                                      \
                                                                                               \
        void construct(void *mem, false_)                                                      \
        {                                                                                      \
            new ((void *)mem) T(BOOST_PP_ENUM(n, BOOST_INTERPROCESS_PP_MEMBER_FORWARD, _));    \
        }                                                                                      \
                                                                                               \
...
#define BOOST_PP_LOCAL_MACRO(n)                                                                      \
    ...
    {                                                                                                \
        typedef BOOST_PP_CAT(BOOST_PP_CAT(Ctor, n), Arg)<T, is_iterator, BOOST_PP_ENUM_PARAMS(n, P)> \
            ctor_obj_t;                                                                              \
        ctor_obj_t ctor_obj(BOOST_PP_ENUM(n, BOOST_INTERPROCESS_PP_PARAM_FORWARD, _));               \
        return mp_mngr->template generic_construct<T>(mp_name, m_num, m_find, m_dothrow, ctor_obj);  \
    }                                                                                                \
    //!
