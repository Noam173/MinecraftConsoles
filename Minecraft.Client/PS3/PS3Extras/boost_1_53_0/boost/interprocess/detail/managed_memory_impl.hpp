...
template <class CharType, class MemoryAlgorithm, template <class IndexConfig> class IndexType, std::size_t Offset = 0>
class basic_managed_memory_impl
{
  ...
  public:
    typedef typename segment_manager_type<CharType, MemoryAlgorithm, IndexType>::type segment_manager;
    ...
    typedef typename segment_manager::char_ptr_holder_t char_ptr_holder_t;
  ...
  private:
    typedef basic_managed_memory_impl<CharType, MemoryAlgorithm, IndexType, Offset> self_t;
  ...
  public:
    ...
    allocation_command(boost::interprocess::allocation_type command, size_type limit_size,
                       ...
                       T *reuse_ptr = 0)
    {
        return mp_header->allocation_command(command, limit_size, preferred_size, received_size, reuse_ptr);
    }
