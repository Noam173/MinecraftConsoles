...
{
    typedef ipcdetail::managed_open_or_create_impl<shared_memory_object, AllocationAlgorithm::Alignment, true, false> type;
};
...
class basic_managed_shared_memory
    : public ipcdetail::basic_managed_memory_impl<CharType, AllocationAlgorithm, IndexType, ipcdetail::shmem_open_or_create<AllocationAlgorithm>::type::ManagedOpenOrCreateUserOffset>,
      private ipcdetail::shmem_open_or_create<AllocationAlgorithm>::type
{
    /// @cond
    typedef ipcdetail::basic_managed_memory_impl<CharType, AllocationAlgorithm, IndexType,
  ...
  public: // functions
    ...
    basic_managed_shared_memory(create_only_t, const char *name,
        ...
        : base_t(), base2_t(create_only, name, size, read_write, addr,
    ...
    basic_managed_shared_memory(open_or_create_t,
        ...
        : base_t(), base2_t(open_or_create, name, size, read_write, addr,
    ...
    basic_managed_shared_memory(open_copy_on_write_t, const char *name,
                                const void *addr = 0)
        : base_t(), base2_t(open_only, name, copy_on_write, addr,
                            create_open_func_t(get_this_pointer(),
                                               ipcdetail::DoOpen))
    {
    }
    ...
    basic_managed_shared_memory(open_read_only_t, const char *name,
                                const void *addr = 0)
        : base_t(), base2_t(open_only, name, read_only, addr,
                            create_open_func_t(get_this_pointer(),
                                               ipcdetail::DoOpen))
    {
    }
    ...
    basic_managed_shared_memory(open_only_t, const char *name,
                                const void *addr = 0)
        : base_t(), base2_t(open_only, name, read_write, addr,
                            create_open_func_t(get_this_pointer(),
                                               ipcdetail::DoOpen))
    {
    }
    ...
    {
        return base_t::template grow<basic_managed_shared_memory>(shmname, extra_bytes);
    }
    ...
    {
        return base_t::template shrink_to_fit<basic_managed_shared_memory>(shmname);
    }
    /// @cond
