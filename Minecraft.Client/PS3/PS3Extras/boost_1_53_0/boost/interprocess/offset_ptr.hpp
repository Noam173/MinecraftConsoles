...
{
    static const bool value = ipcdetail::is_cv_same<From, To>::value || ipcdetail::is_cv_same<void, To>::value;
};
...
class offset_ptr
{
  ...
  public:
    ...
    typedef typename ipcdetail::
        remove_volatile<typename ipcdetail::
                            remove_const<PointedType>::type>::type value_type;
  ...
  public: // Public Functions
    ...
    offset_ptr(T *ptr, typename ipcdetail::enable_if<ipcdetail::is_convertible<T *, PointedType *>>::type * = 0)
        : internal(static_cast<OffsetType>(ipcdetail::offset_ptr_to_offset<0>(static_cast<PointedType *>(ptr), this)))
    {
    }
    ...
    offset_ptr(const offset_ptr &ptr)
        : internal(static_cast<OffsetType>(ipcdetail::offset_ptr_to_offset_from_other<0>(this, &ptr, ptr.internal.m_offset)))
    {
    }
    ...
    offset_ptr(const offset_ptr<T2, DifferenceType, OffsetType, OffsetAlignment> &ptr
        ...
        : internal(static_cast<OffsetType>(ipcdetail::offset_ptr_to_offset_from_other<0>(this, &ptr, ptr.get_offset())))
    {
    }
    ...
    offset_ptr(const offset_ptr<T2, DifferenceType, OffsetType, OffsetAlignment> &ptr, typename ipcdetail::enable_if_c<ipcdetail::is_convertible<T2 *, PointedType *>::value && !ipcdetail::offset_ptr_maintains_address<T2, PointedType>::value>::type * = 0)
        : internal(static_cast<OffsetType>(ipcdetail::offset_ptr_to_offset<0>(static_cast<PointedType *>(ptr.get()), this)))
    {
    }
    ...
    offset_ptr(const offset_ptr<T2, P2, O2, A2> &r, ipcdetail::static_cast_tag)
        : internal(static_cast<OffsetType>(ipcdetail::offset_ptr_to_offset<0>(static_cast<PointedType *>(r.get()), this)))
    {
    }
    ...
    offset_ptr(const offset_ptr<T2, P2, O2, A2> &r, ipcdetail::const_cast_tag)
        : internal(static_cast<OffsetType>(ipcdetail::offset_ptr_to_offset<0>(const_cast<PointedType *>(r.get()), this)))
    {
    }
    ...
    offset_ptr(const offset_ptr<T2, P2, O2, A2> &r, ipcdetail::dynamic_cast_tag)
        : internal(static_cast<OffsetType>(ipcdetail::offset_ptr_to_offset<0>(dynamic_cast<PointedType *>(r.get()), this)))
    {
    }
    ...
    offset_ptr(const offset_ptr<T2, P2, O2, A2> &r, ipcdetail::reinterpret_cast_tag)
        : internal(static_cast<OffsetType>(ipcdetail::offset_ptr_to_offset<0>(reinterpret_cast<PointedType *>(r.get()), this)))
    {
    }
    ...
    template <class T2>
#ifndef BOOST_INTERPROCESS_DOXYGEN_INVOKED
    typename ipcdetail::enable_if_c<ipcdetail::is_convertible<T2 *, PointedType *>::value && ipcdetail::offset_ptr_maintains_address<T2, PointedType>::value, offset_ptr &>::type
#else
    offset_ptr &
#endif
...
inline std::basic_ostream<E, T> &operator<<(std::basic_ostream<E, T> &os, offset_ptr<W, X, Y, Z> const &p)
{
...
//! for offset ptr
template <class E, class T, class W, class X, class Y, std::size_t Z>
inline std::basic_istream<E, T> &operator>>(std::basic_istream<E, T> &is, offset_ptr<W, X, Y, Z> &p)
{
...
{
    return boost::interprocess::offset_ptr<T1, P1, O1, A1>(r, boost::interprocess::ipcdetail::static_cast_tag());
}
...
{
    return boost::interprocess::offset_ptr<T1, P1, O1, A1>(r, boost::interprocess::ipcdetail::const_cast_tag());
}
...
{
    return boost::interprocess::offset_ptr<T1, P1, O1, A1>(r, boost::interprocess::ipcdetail::dynamic_cast_tag());
}
...
{
    return boost::interprocess::offset_ptr<T1, P1, O1, A1>(r, boost::interprocess::ipcdetail::reinterpret_cast_tag());
}
