...
{
    typedef ipcdetail::managed_open_or_create_impl<file_wrapper, AllocationAlgorithm::Alignment, true, false> type;
};
...
class basic_managed_mapped_file
    : public ipcdetail::basic_managed_memory_impl<CharType, AllocationAlgorithm, IndexType, ipcdetail::mfile_open_or_create<AllocationAlgorithm>::type::ManagedOpenOrCreateUserOffset>
{
    /// @cond
  public:
  ...
  public: // functions
    ...
    {
        return base_t::template grow<basic_managed_mapped_file>(filename, extra_bytes);
    }
    ...
    {
        return base_t::template shrink_to_fit<basic_managed_mapped_file>(filename);
    }
