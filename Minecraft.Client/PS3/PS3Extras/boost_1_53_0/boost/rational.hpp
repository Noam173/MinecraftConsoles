...
template <typename IntType>
class rational : less_than_comparable<rational<IntType>,
                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                  decrementable<rational<IntType>>>>>>>>>>>>>>>>>
{
  ...
  public:
    ...
    rational(param_type n, param_type d) : num(n), den(d)
    {
        normalize();
    }
...
#pragma parse_mfunc_templ off
    ...
    {
        return operator!() ? 0 : &helper::parts;
    }
...
bool rational<IntType>::operator<(const rational<IntType> &r) const
{
    ...
    {
        int_type n, d, q, r;
    } ts = {this->num, this->den, this->num / this->den, this->num % this->den}, rs = {r.num, r.den, r.num / r.den,
                                                                                       r.num % r.den};
    unsigned reverse = 0u;
