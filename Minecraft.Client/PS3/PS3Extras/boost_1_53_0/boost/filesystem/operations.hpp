...
BOOST_SCOPED_ENUM_START(copy_option){none, fail_if_exists = none, overwrite_if_exists};
...
inline void copy(const path &from, const path &to, system::error_code &ec)
{
...
inline void copy_directory(const path &from, const path &to, system::error_code &ec)
{
...
inline void copy_file(const path &from, const path &to, system::error_code &ec)
{
...
inline void copy_symlink(const path &existing_symlink, const path &new_symlink, system::error_code &ec)
{
...
inline void create_directory_symlink(const path &to, const path &from, system::error_code &ec)
{
...
inline void create_hard_link(const path &to, const path &new_hard_link, system::error_code &ec)
{
...
inline void create_symlink(const path &to, const path &new_symlink, system::error_code &ec)
{
...
inline bool equivalent(const path &p1, const path &p2, system::error_code &ec)
{
...
inline boost::uintmax_t file_size(const path &p, system::error_code &ec)
{
...
inline boost::uintmax_t hard_link_count(const path &p, system::error_code &ec)
{
...
inline void last_write_time(const path &p, const std::time_t new_time, system::error_code &ec)
{
...
inline void permissions(const path &p, perms prms, system::error_code &ec)
{
...
inline boost::uintmax_t remove_all(const path &p, system::error_code &ec)
{
...
inline void rename(const path &old_p, const path &new_p, system::error_code &ec)
{
...
inline void resize_file(const path &p, uintmax_t size, system::error_code &ec)
{
...
inline space_info space(const path &p, system::error_code &ec)
{
...
// ec == 0 means throw on error
{
    ...
    else
    {
        ...
        // per ticket #5653.
        bool or_pred = (m_options & symlink_option::recurse) == symlink_option::recurse || (ec == 0 ? !is_symlink(m_stack.top()->symlink_status())
          ...
          boost::single_pass_traversal_tag>
{
  public:
    ...
    bool no_push_pending() const
    {
        ...
        return (m_imp->m_options & symlink_option::_detail_no_push) == symlink_option::_detail_no_push;
    }
