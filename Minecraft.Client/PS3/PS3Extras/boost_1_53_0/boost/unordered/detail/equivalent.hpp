...
template <typename T>
struct grouped_ptr_node : boost::unordered::detail::value_base<T>,
...
struct pick_grouped_node2
{
    ...
    typedef typename boost::unordered::detail::allocator_traits<
        typename boost::unordered::detail::rebind_wrap<A, node>::type>::pointer node_pointer;
...
struct grouped_table_impl : boost::unordered::detail::table<Types>
{
                             ...
                             iterator n2, iterator end2)
    {
        ...
        for (; n1 != end1; ++n1)
        {
            ...
            iterator next = n1;
            ++next;
            if (matches != 1 + count_equal(next, end1, v))
            {
                return false;
            }
        }
