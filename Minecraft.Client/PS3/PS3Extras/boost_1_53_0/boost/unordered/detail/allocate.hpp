...
#define BOOST_UNORDERED_FWD_PARAM(z, n, a) \
    BOOST_FWD_REF(BOOST_PP_CAT(A, n))      \
    BOOST_PP_CAT(a, n)
    ...
    {                                                                                                              \
        BOOST_PP_REPEAT_##z(n, BOOST_UNORDERED_EARGS_MEMBER, _)                                                    \
            BOOST_PP_CAT(emplace_args, n)(                                                                         \
                BOOST_PP_ENUM_BINARY_PARAMS_Z(z, n, Arg, b)) : BOOST_PP_ENUM_##z(n, BOOST_UNORDERED_EARGS_INIT, _) \
        {                                                                                                          \
        }                                                                                                          \
    };                                                                                                             \
                                                                                                                   \
...
#define BOOST_UNORDERED_CHECK_MEMBER(count, result, name, member)     \
    ...
    {                                                                 \
        typedef BOOST_PP_CAT(choice, result) type;                    \
                                                                      ...
                                                                      \
    template <class U>                                                \
    static typename BOOST_PP_CAT(test, count)<&U::name>::type         \
    test(BOOST_PP_CAT(choice, count))

#define BOOST_UNORDERED_DEFAULT_MEMBER(count, result) \
    template <class U>                                \
    static BOOST_PP_CAT(choice, result)::type         \
    test(BOOST_PP_CAT(choice, count))
...
#define BOOST_UNORDERED_DEFAULT_TYPE_TMPLT(tname)                          \
    ...
    {                                                                      \
        ...
        typedef typename boost::detail::if_true<value>::                   \
            BOOST_NESTED_TEMPLATE then<Tp, DefaultWrap>::type::tname type; \
    }
...
BOOST_UNORDERED_HAS_FUNCTION(
    construct, U, (boost::unordered::detail::make<ValueType *>(), boost::unordered::detail::make<Args const>()...), 2);

#else

template <typename T, typename ValueType>
BOOST_UNORDERED_HAS_FUNCTION(
    construct, U, (boost::unordered::detail::make<ValueType *>(), boost::unordered::detail::make<ValueType const>()), 2);
...
template <typename Alloc, typename T>
struct rebind_wrap : boost::container::allocator_traits<Alloc>::
