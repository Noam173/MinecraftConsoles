...
struct table : boost::unordered::detail::functions<
  ...
  public:
    ...
    typedef boost::unordered::iterator_detail::
        iterator<node>
            iterator;
    typedef boost::unordered::iterator_detail::
        c_iterator<node, const_node_pointer>
            c_iterator;
    typedef boost::unordered::iterator_detail::
        l_iterator<node, policy>
            l_iterator;
    typedef boost::unordered::iterator_detail::
        cl_iterator<node, const_node_pointer, policy>
            cl_iterator;
    ...
    table(std::size_t num_buckets,
          hasher const &hf,
          key_equal const &eq,
          node_allocator const &a) : functions(hf, eq),
                                     allocators_(a, a),
    ...
    table(table const &x, node_allocator const &a) : functions(x),
                                                     allocators_(a, a),
    ...
    table(table &x, boost::unordered::detail::move_tag m) : functions(x),
    ...
    table(table &x, node_allocator const &a,
          boost::unordered::detail::move_tag) : functions(x),
                                                allocators_(a, a),
                                                bucket_count_(x.bucket_count_),
                                                size_(0),
                                                mlf_(x.mlf_),
    ...
    void create_buckets(std::size_t new_count)
    {
        ...
        if (buckets_)
        {
            ...
            (constructor.get() +
             static_cast<std::ptrdiff_t>(new_count))
                ->next_ =
    ...
    iterator generic_find_node(
        ...
        Pred const &eq) const
    {
        return static_cast<table_impl const *>(this)->find_node_impl(policy::apply_hash(hf, k), k, eq);
    }
    ...
    {
        return static_cast<table_impl const *>(this)->find_node_impl(key_hash, k, this->key_eq());
    }

    iterator find_node(key_type const &k) const
    {
        return static_cast<table_impl const *>(this)->find_node_impl(hash(k), k, this->key_eq());
    }
...
inline void table<Types>::reserve_for_insert(std::size_t size)
{
    ...
    {
        std::size_t num_buckets = min_buckets_for_size((std::max)(size,
                                                                  size_ + (size_ >> 1)));
