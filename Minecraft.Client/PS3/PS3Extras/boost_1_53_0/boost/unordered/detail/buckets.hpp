          ...
          typename Node::value_type const &>
{
  ...
  public:
    ...
    cl_iterator(iterator x, std::size_t b, std::size_t c) : ptr_(x.node_), bucket_(b), bucket_count_(c)
    {
    }

    cl_iterator(boost::unordered::iterator_detail::l_iterator<
                Node, Policy> const &x) : ptr_(x.ptr_), bucket_(x.bucket_), bucket_count_(x.bucket_count_)
    {
    }
          ...
          typename Node::value_type &>
{
  ...
  public:
    ...
    explicit iterator(typename Node::link_pointer x) : node_(static_cast<node_pointer>(x))
    {
    }
          ...
          typename Node::value_type const &>
{
  ...
  public:
    ...
    explicit c_iterator(typename Node::link_pointer x) : node_(static_cast<node_pointer>(x))
    {
    }
...
struct node_constructor
{
  ...
  public:
    node_constructor(node_allocator &n) : alloc_(n),
                                          node_(),
...
struct node_holder : private node_constructor<NodeAlloc>
{
  ...
  public:
    ...
    explicit node_holder(Table &b) : base(b.node_alloc()),
                                     nodes_()
    {
        if (b.size_)
        {
...
struct pick_policy : pick_policy_impl<
...
struct rv_ref : boost::detail::if_true<
                    boost::is_class<T>::value>::BOOST_NESTED_TEMPLATE then<boost::unordered::detail::rv_ref_impl<T>,
