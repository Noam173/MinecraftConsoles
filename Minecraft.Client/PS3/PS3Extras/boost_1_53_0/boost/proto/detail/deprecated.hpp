...
#define BOOST_PROTO_VARARG_TEMPLATE_YES_(R, DATA, I, ELEM)                                                                                                     \
    BOOST_PP_LIST_FOR_EACH_I_R(                                                                                                                                \
        R, BOOST_PROTO_VARARG_TEMPLATE_AUX_, I, BOOST_PP_TUPLE_TO_LIST(BOOST_PP_DEC(BOOST_PP_SEQ_SIZE(ELEM)), BOOST_PP_SEQ_TO_TUPLE(BOOST_PP_SEQ_TAIL(ELEM)))) \
    /**/
...
#define BOOST_PROTO_VARARG_TEMPLATE_(R, DATA, I, ELEM) \
    BOOST_PP_IF(                                       \
        BOOST_PP_DEC(BOOST_PP_SEQ_SIZE(ELEM)), BOOST_PROTO_VARARG_TEMPLATE_YES_, BOOST_PROTO_VARARG_TEMPLATE_NO_)(R, DATA, I, ELEM) /**/
...
#define BOOST_PROTO_TEMPLATE_PARAMS_YES_(R, DATA, I, ELEM) \
    <                                                      \
        BOOST_PP_SEQ_ENUM(                                 \
            BOOST_PP_LIST_FOR_EACH_I_R(                    \
                R, BOOST_PROTO_VARARG_TYPE_AUX_, I, BOOST_PP_TUPLE_TO_LIST(BOOST_PP_DEC(BOOST_PP_SEQ_SIZE(ELEM)), BOOST_PP_SEQ_TO_TUPLE(BOOST_PP_SEQ_TAIL(ELEM)))))> /**/
...
#define BOOST_PROTO_VARARG_TYPE_(R, DATA, I, ELEM) \
    ...
    BOOST_PP_IF(                                   \
        BOOST_PP_DEC(BOOST_PP_SEQ_SIZE(ELEM)), BOOST_PROTO_TEMPLATE_PARAMS_YES_, BOOST_PROTO_TEMPLATE_PARAMS_NO_)(R, DATA, I, ELEM) BOOST_PP_EXPR_IF(BOOST_PP_GREATER(I, 1), const) /**/
...
#define BOOST_PROTO_VARARG_AS_EXPR_(R, DATA, I, ELEM)                                                                                                                        \
    BOOST_PP_EXPR_IF(                                                                                                                                                        \
        BOOST_PP_GREATER(I, 1), ((                                                                                                                                           \
                                    BOOST_PP_SEQ_HEAD(ELEM)                                                                                                                  \
                                        BOOST_PP_IF(                                                                                                                         \
                                            BOOST_PP_DEC(BOOST_PP_SEQ_SIZE(ELEM)), BOOST_PROTO_TEMPLATE_PARAMS_YES_, BOOST_PROTO_TEMPLATE_PARAMS_NO_)(R, DATA, I, ELEM)()))) \
    /**/
...
#define BOOST_PROTO_VARARG_FUN_(Z, N, DATA)                                                                                                                                                                   \
    template <                                                                                                                                                                                                \
        BOOST_PP_SEQ_ENUM(                                                                                                                                                                                    \
            BOOST_PP_SEQ_FOR_EACH_I(                                                                                                                                                                          \
                BOOST_PROTO_VARARG_TEMPLATE_, ~, BOOST_PP_SEQ_PUSH_FRONT(BOOST_PROTO_SEQ_PUSH_FRONT(BOOST_PP_TUPLE_ELEM(4, 2, DATA), (BOOST_PP_TUPLE_ELEM(4, 3, DATA))), BOOST_PP_TUPLE_ELEM(4, 1, DATA)))    \
                BOOST_PP_REPEAT_##Z(N, BOOST_PROTO_VARARG_AS_PARAM_, typename A))>                                                                                                                            \
    typename boost::proto::result_of::make_expr<                                                                                                                                                              \
        BOOST_PP_SEQ_FOR_EACH_I(                                                                                                                                                                              \
            BOOST_PROTO_VARARG_TYPE_, ~, BOOST_PP_SEQ_PUSH_FRONT(BOOST_PROTO_SEQ_PUSH_FRONT(BOOST_PP_TUPLE_ELEM(4, 2, DATA), (BOOST_PP_TUPLE_ELEM(4, 3, DATA))), BOOST_PP_TUPLE_ELEM(4, 1, DATA)))            \
    ...
    {                                                                                                                                                                                                         \
        return boost::proto::detail::make_expr_<                                                                                                                                                              \
            ...
            BOOST_PP_SEQ_ENUM(                                                                                                                                                                                \
                BOOST_PP_SEQ_FOR_EACH_I(                                                                                                                                                                      \
                    BOOST_PROTO_VARARG_AS_EXPR_, ~, BOOST_PP_SEQ_PUSH_FRONT(BOOST_PROTO_SEQ_PUSH_FRONT(BOOST_PP_TUPLE_ELEM(4, 2, DATA), (BOOST_PP_TUPLE_ELEM(4, 3, DATA))), BOOST_PP_TUPLE_ELEM(4, 1, DATA))) \
...
#define BOOST_PROTO_DEFINE_FUNCTION_TEMPLATE(ARGCOUNT, NAME, DOMAIN, TAG, BOUNDARGS)               \
    BOOST_PP_REPEAT_FROM_TO(                                                                       \
        ARGCOUNT, BOOST_PP_INC(ARGCOUNT), BOOST_PROTO_VARARG_FUN_, (NAME, TAG, BOUNDARGS, DOMAIN)) \
    /**/
...
#define BOOST_PROTO_DEFINE_VARARG_FUNCTION_TEMPLATE(NAME, DOMAIN, TAG, BOUNDARGS)                                                                 \
    BOOST_PP_REPEAT(                                                                                                                              \
        BOOST_PP_SUB(BOOST_PP_INC(BOOST_PROTO_MAX_ARITY), BOOST_PP_SEQ_SIZE(BOUNDARGS)), BOOST_PROTO_VARARG_FUN_, (NAME, TAG, BOUNDARGS, DOMAIN)) \
    /**/
