          ...
          int>
{
    ...
    BOOST_PP_REPEAT_FROM_TO(
        N, BOOST_PROTO_MAX_ARITY, BOOST_PROTO_CHILD, detail::if_vararg<BOOST_PP_CAT(A, BOOST_PP_DEC(N))> BOOST_PP_INTERCEPT)
};
...
{
template <
    template <BOOST_PP_ENUM_PARAMS(N, typename BOOST_PP_INTERCEPT)> class T, BOOST_PP_ENUM_PARAMS(N, typename A)>
