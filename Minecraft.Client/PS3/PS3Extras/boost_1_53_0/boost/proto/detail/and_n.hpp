...
#define M0(Z, N, DATA)                                                                       \
    typedef                                                                                  \
        typename proto::when<proto::_, BOOST_PP_CAT(G, N)>::template impl<Expr, State, Data> \
...
#undef M0
    ...
    result_type operator()(
        typename _and_impl::expr_param e, typename _and_impl::state_param s, typename _and_impl::data_param d) const
    {
