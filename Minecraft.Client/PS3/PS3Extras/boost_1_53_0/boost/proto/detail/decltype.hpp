...
#define BOOST_PROTO_DECLTYPE_NESTED_TYPEDEF_TPL_(NESTED, EXPR)                                                                                                   \
    ...
    struct NESTED                                                                                                                                                \
        : boost::mpl::if_c<                                                                                                                                      \
              1 == BOOST_PP_CAT(sz, NESTED), typename BOOST_PP_CAT(nested_and_hidden_, NESTED)::type &, typename BOOST_PP_CAT(nested_and_hidden_, NESTED)::type> \
    {                                                                                                                                                            \
    };
...
struct as_subscriptable
{
    typedef
        typename mpl::if_c<
            is_class<T>::value, subscript_wrapper<T>, T>::type
            type;
};
...
struct as_subscriptable<T const>
{
    typedef
        typename mpl::if_c<
            is_class<T>::value, subscript_wrapper<T> const, T const>::type
            type;
};
...
#define BOOST_PROTO_GET_POINTER(Type, Obj)         \
    boost::proto::detail::proto_get_pointer<Type>( \
        boost::proto::detail::lvalue(Obj), (true ? 0 : get_pointer(Obj)), (true ? 0 : boost::addressof(boost::proto::detail::lvalue(Obj)))) /**/
...
struct result_of_<T U::*(V), typename enable_if_c<is_member_object_pointer<T U::*>::value>::type>
{
    ...
    typedef
        typename mpl::eval_if_c<
            (is_V_a_smart_ptr || is_reference<V>::value), mpl::eval_if_c<is_ptr_to_const, add_reference<typename add_const<T>::type>, add_reference<T>>, mpl::identity<T>>::type
            type;
};

////////////////////////////////////////////////////////////////////////////////////////////
template <
    typename T, typename U, bool IsMemPtr = is_member_object_pointer<typename remove_reference<U>::type>::value>
struct mem_ptr_fun
{
    ...
    result_type operator()(
        typename add_reference<typename add_const<T>::type>::type t, typename add_reference<typename add_const<U>::type>::type u) const
    {
        return t->*u;
    }
};
...
struct mem_ptr_fun<T, U, true>
{
    typedef
        typename class_member_traits<
            typename uncvref<U>::type>::class_type
            V;

    BOOST_PROTO_DECLTYPE_(
        BOOST_PROTO_GET_POINTER(V, proto::detail::make_mutable<T>())->*proto::detail::make<U>(), result_type)

    result_type operator()(
        typename add_reference<typename add_const<T>::type>::type t, U u) const
    {
