...
#define BOOST_PROTO_MATCHES_N_FUN(Z, N, DATA) \
    matches_<                                 \
        typename detail::expr_traits<typename Args1::BOOST_PP_CAT(child, N)>::value_type::proto_derived_expr, typename detail::expr_traits<typename Args1::BOOST_PP_CAT(child, N)>::value_type::proto_grammar, typename Args2::BOOST_PP_CAT(child, N)::proto_grammar>

#define BOOST_PROTO_DEFINE_MATCHES(Z, N, DATA) \
    matches_<                                  \
        Expr, BasicExpr, typename BOOST_PP_CAT(G, N)::proto_grammar>
