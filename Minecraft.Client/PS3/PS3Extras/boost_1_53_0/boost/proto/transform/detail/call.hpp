    ...
    template <typename Expr, typename State, typename Data>
        ...
        : call<
              typename detail::expand_pattern<
                  ...
                  ,
                  BOOST_PP_CAT(A, BOOST_PP_DEC(N)), detail::BOOST_PP_CAT(expand_pattern_rest_, BOOST_PP_DEC(N)) < Fun BOOST_PP_ENUM_TRAILING_PARAMS(BOOST_PP_DEC(N), A)>>::type > ::template impl<Expr, State, Data>
    {
    };
};
#endif
