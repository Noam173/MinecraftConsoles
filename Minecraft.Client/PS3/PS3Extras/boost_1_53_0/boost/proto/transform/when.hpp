    ...
    : transform<when<Grammar, Fun>>
{
    ...
    struct impl : transform_impl<Expr, State, Data>
    {
        ...
        typedef
            typename mpl::if_c<
                is_callable<R>::value, proto::call<Fun> // "R" is a function to call
                ,
    ...
    struct impl
        : remove_reference<
              typename mpl::eval_if_c<
                  proto::result_of::has_env_var<Data, transforms_type>::value, proto::result_of::env_var<Data, transforms_type>, proto::result_of::env_var<Data, data_type>>::type>::type::template when<Grammar>::template impl<Expr, State, Data>
    {
    };
};
