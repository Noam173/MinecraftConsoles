    ...
    : transform<fold_tree<Sequence, State0, Fun>>
{
    ...
    struct impl
        : fold<
              Sequence, State0, detail::fold_tree_<typename Expr::proto_tag, Fun>>::template impl<Expr, State, Data>
    {
    };
    ...
    : transform<reverse_fold_tree<Sequence, State0, Fun>>
{
    ...
    struct impl
        : reverse_fold<
              Sequence, State0, detail::reverse_fold_tree_<typename Expr::proto_tag, Fun>>::template impl<Expr, State, Data>
    {
    };
