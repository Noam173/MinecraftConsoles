...
struct _data : transform<_data>
{
    ...
    struct impl
        : mpl::if_c<
              is_env<Data>::value, _env_var<data_type>, _env>::type::template impl<Expr, State, Data>
    {
    };
};
...
struct _void : transform<_void>
{
    ...
    struct impl : transform_impl<Expr, State, Data>
    {
        ...
        void operator()(
            typename impl::expr_param, typename impl::state_param, typename impl::data_param) const
        {
        }
    };
};
