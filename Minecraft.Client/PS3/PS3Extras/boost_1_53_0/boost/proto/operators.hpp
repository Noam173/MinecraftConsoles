...
struct enable_unary
    : boost::lazy_enable_if_c<
          boost::mpl::and_<
              Trait, lazy_matches<result_of::make_expr<Tag, basic_default_domain, Arg>, Grammar>>::value,
...
struct enable_unary<Domain, proto::_, Trait, Tag, Arg &>
    : boost::lazy_enable_if_c<
          Trait::value, result_of::make_expr<Tag, Domain, Arg &>>
{
};
...
struct enable_unary<deduce_domain, not_a_grammar, Trait, Tag, Arg &>
    : enable_unary<
          typename domain_of<Arg>::type, typename domain_of<Arg>::type::proto_grammar, Trait, Tag, Arg &>
{
};
...
struct enable_binary
    : boost::lazy_enable_if_c<
          boost::mpl::and_<
              Trait, lazy_matches<result_of::make_expr<Tag, basic_default_domain, Left, Right>, Grammar>>::value,
...
struct enable_binary<deduce_domain, not_a_grammar, Trait, Tag, Left &, Right &>
    : enable_binary<
          typename deduce_domain2<Left, Right>::type, typename deduce_domain2<Left, Right>::type::proto_grammar, Trait, Tag, Left &, Right &>
{
};
...
#define BOOST_PROTO_DEFINE_UNARY_OPERATOR(OP, TAG, TRAIT, DOMAIN, POST)                                        \
    ...
    BOOST_PROTO_DISABLE_MSVC_C4714 BOOST_FORCEINLINE                                                           \
        typename boost::proto::detail::enable_unary<                                                           \
            DOMAIN, DOMAIN::proto_grammar, BOOST_PROTO_APPLY_UNARY_(TRAIT, Arg), TAG, Arg &>::type const       \
    ...
    BOOST_PROTO_DISABLE_MSVC_C4714 BOOST_FORCEINLINE                                                           \
        typename boost::proto::detail::enable_unary<                                                           \
            DOMAIN, DOMAIN::proto_grammar, BOOST_PROTO_APPLY_UNARY_(TRAIT, Arg), TAG, Arg const &>::type const \
...
#define BOOST_PROTO_DEFINE_BINARY_OPERATOR(OP, TAG, TRAIT, DOMAIN)                                                                      \
    ...
    BOOST_PROTO_DISABLE_MSVC_C4714 BOOST_FORCEINLINE                                                                                    \
        typename boost::proto::detail::enable_binary<                                                                                   \
            DOMAIN, DOMAIN::proto_grammar, BOOST_PROTO_APPLY_BINARY_(TRAIT, Left, Right), TAG, Left &, Right &>::type const             \
    ...
    BOOST_PROTO_DISABLE_MSVC_C4714 BOOST_FORCEINLINE                                                                                    \
        typename boost::proto::detail::enable_binary<                                                                                   \
            DOMAIN, DOMAIN::proto_grammar, BOOST_PROTO_APPLY_BINARY_(TRAIT, Left, Right), TAG, Left &, Right const &>::type const       \
    ...
    BOOST_PROTO_DISABLE_MSVC_C4714 BOOST_FORCEINLINE                                                                                    \
        typename boost::proto::detail::enable_binary<                                                                                   \
            DOMAIN, DOMAIN::proto_grammar, BOOST_PROTO_APPLY_BINARY_(TRAIT, Left, Right), TAG, Left const &, Right &>::type const       \
    ...
    BOOST_PROTO_DISABLE_MSVC_C4714 BOOST_FORCEINLINE                                                                                    \
        typename boost::proto::detail::enable_binary<                                                                                   \
            DOMAIN, DOMAIN::proto_grammar, BOOST_PROTO_APPLY_BINARY_(TRAIT, Left, Right), TAG, Left const &, Right const &>::type const \
...
BOOST_FORCEINLINE
    typename result_of::make_expr<
        tag::if_else_, deduce_domain, A0 const &, A1 const &, A2 const &>::type const
    if_else(A0 const &a0, A1 const &a1, A2 const &a2)
{
    return proto::detail::make_expr_<
        tag::if_else_, deduce_domain, A0 const &, A1 const &, A2 const &>()(a0, a1, a2);
}
} // namespace exprns_
...
#define BOOST_PROTO_APPLY_UNARY_(TRAIT, ARG) \
    boost::mpl::and_<                        \
        TRAIT<ARG>, boost::mpl::not_<boost::proto::is_extension<ARG>>> /**/

#define BOOST_PROTO_APPLY_BINARY_(TRAIT, LEFT, RIGHT)                    \
    boost::mpl::and_<                                                    \
        boost::mpl::or_<TRAIT<LEFT>, TRAIT<RIGHT>>, boost::mpl::not_<    \
                                                        boost::mpl::or_< \
                                                            boost::proto::is_extension<LEFT>, boost::proto::is_extension<RIGHT>>>> /**/

#else

#define BOOST_PROTO_APPLY_UNARY_(TRAIT, ARG) \
    boost::mpl::and_<                        \
        TRAIT<BOOST_PROTO_UNCVREF(ARG)>, boost::mpl::not_<boost::proto::is_extension<ARG>>> /**/

#define BOOST_PROTO_APPLY_BINARY_(TRAIT, LEFT, RIGHT)                                                              \
    boost::mpl::and_<                                                                                              \
        boost::mpl::or_<TRAIT<BOOST_PROTO_UNCVREF(LEFT)>, TRAIT<BOOST_PROTO_UNCVREF(RIGHT)>>, boost::mpl::not_<    \
                                                                                                  boost::mpl::or_< \
                                                                                                      boost::proto::is_extension<LEFT>, boost::proto::is_extension<RIGHT>>>> /**/
