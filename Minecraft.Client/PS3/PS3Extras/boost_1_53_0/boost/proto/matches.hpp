...
struct vararg_matches<Expr, Args1, Args2, Back, true, true, typename Back::proto_is_vararg_>
    : matches_<
          Expr, proto::basic_expr<ignore, Args1, Args1::arity>, proto::basic_expr<ignore, Args2, Args1::arity>>
{
};
...
struct vararg_matches<Expr, Args1, Args2, Back, true, false, typename Back::proto_is_vararg_>
    : and_2<
          matches_<
              Expr, proto::basic_expr<ignore, Args1, Args2::arity>, proto::basic_expr<ignore, Args2, Args2::arity>>::value,
...
template <
    typename T, typename U, bool B = is_array<BOOST_PROTO_UNCVREF(T)>::value>
...
struct terminal_matches
    : mpl::or_<
          mpl::and_<
              is_cv_ref_compatible<T, U>, lambda_matches<
                                              BOOST_PROTO_UNCVREF(T), BOOST_PROTO_UNCVREF(U)>>,
...
struct matches_<Expr, proto::basic_expr<Tag, Args1, 1>, proto::basic_expr<Tag, Args2, 1>>
    : matches_<
          typename detail::expr_traits<typename Args1::child0>::value_type::proto_derived_expr, typename detail::expr_traits<typename Args1::child0>::value_type::proto_grammar, typename Args2::child0::proto_grammar>
{
};
...
struct matches_<Expr, proto::basic_expr<Tag, Args, Arity>, proto::if_<If, Then, Else>>
    : mpl::eval_if_c<
          ...
          matches_<Expr, proto::basic_expr<Tag, Args, Arity>, typename Then::proto_grammar>, matches_<Expr, proto::basic_expr<Tag, Args, Arity>, typename Else::proto_grammar>>::type
{
    typedef
        typename mpl::if_c<
            static_cast<bool>(
...
struct matches_<Expr, proto::basic_expr<Tag, Args, Arity>, switch_<Cases, Transform>>
    : matches_<
          Expr, proto::basic_expr<Tag, Args, Arity>, typename Cases::template case_<typename when<_, Transform>::template impl<Expr, int, int>::result_type>::proto_grammar>
{
    typedef
...
struct matches_<Expr, proto::basic_expr<Tag, Args, Arity>, switch_<Cases>>
    : matches_<
          Expr, proto::basic_expr<Tag, Args, Arity>, typename Cases::template case_<Tag>::proto_grammar>
{
...
struct matches
    : detail::matches_<
          typename Expr::proto_derived_expr, typename Expr::proto_grammar, typename Grammar::proto_grammar>
{
};
...
struct _ : transform<_>
{
    ...
    struct impl : transform_impl<Expr, State, Data>
    {
        ...
        operator()(
            typename impl::expr_param e, typename impl::state_param, typename impl::data_param) const
        {
            return e;
        }
    };
...
struct if_ : transform<if_<If, Then, Else>>
{
    ...
    struct impl : transform_impl<Expr, State, Data>
    {
        ...
        typedef
            typename mpl::if_c<
                static_cast<bool>(remove_reference<condition>::type::value), when<_, Then>, when<_, Else>>::type
                which;
...
struct or_ : transform<or_<BOOST_PROTO_LOGICAL_G>>
{
    ...
    struct impl
        : detail::matches_<
              typename Expr::proto_derived_expr, typename Expr::proto_grammar, or_>::which::template impl<Expr, State, Data>
    {
    };
...
struct switch_ : transform<switch_<Cases, Transform>>
{
    ...
    struct impl
        : Cases::template case_<
              typename when<_, Transform>::template impl<Expr, State, Data>::result_type>::template impl<Expr, State, Data>
    {
    };
};
