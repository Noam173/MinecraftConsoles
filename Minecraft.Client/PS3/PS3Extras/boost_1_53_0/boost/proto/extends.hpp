        ...
        typename BOOST_PROTO_RESULT_OF<                                                                             \
            proto_generator(                                                                                        \
                typename boost::proto::result_of::funop<                                                            \
                    proto_derived_expr Const()(A const &...), proto_derived_expr, proto_domain>::type)>::type const \
        operator()(A const &...a) Const()                                                                           \
    {                                                                                                               \
        typedef boost::proto::result_of::funop<                                                                     \
            proto_derived_expr Const()(A const &...), proto_derived_expr, proto_domain>                             \
            funop;                                                                                                  \
        return proto_generator()(                                                                                   \
            funop::call(                                                                                            \
    ...
    Typename() BOOST_PROTO_RESULT_OF<                                                                                                      \
        Typename() This::proto_generator(                                                                                                  \
            Typename() boost::proto::base_expr<                                                                                            \
                Typename() This::proto_domain, boost::proto::tag::assign, boost::proto::list2<This &, This Const() &>>::type)>::type const \
    operator=(This Const() & a)                                                                                                            \
    {                                                                                                                                      \
        typedef Typename() boost::proto::base_expr<                                                                                        \
            Typename() This::proto_domain, boost::proto::tag::assign, boost::proto::list2<This &, This Const() &>>::type                   \
            that_type;                                                                                                                     \
...
#define BOOST_PROTO_EXTENDS_ASSIGN_IMPL_(ThisConst, ThatConst)                                                                                                                                                         \
    ...
    BOOST_PROTO_DISABLE_MSVC_C4714 BOOST_FORCEINLINE                                                                                                                                                                   \
        typename BOOST_PROTO_RESULT_OF<                                                                                                                                                                                \
            proto_generator(                                                                                                                                                                                           \
                typename boost::proto::base_expr<                                                                                                                                                                      \
                    proto_domain, boost::proto::tag::assign, boost::proto::list2<proto_derived_expr ThisConst() &, typename boost::proto::result_of::as_child<A ThatConst(), proto_domain>::type>>::type)>::type const \
        operator=(A ThatConst() & a) ThisConst()                                                                                                                                                                       \
    {                                                                                                                                                                                                                  \
        typedef                                                                                                                                                                                                        \
            typename boost::proto::base_expr<                                                                                                                                                                          \
                proto_domain, boost::proto::tag::assign, boost::proto::list2<proto_derived_expr ThisConst() &, typename boost::proto::result_of::as_child<A ThatConst(), proto_domain>::type>>::type                   \
                that_type;                                                                                                                                                                                             \
        that_type const that = {                                                                                                                                                                                       \
            *static_cast<proto_derived_expr ThisConst() *>(this), boost::proto::as_child<proto_domain>(a)};                                                                                                            \
...
#define BOOST_PROTO_EXTENDS_SUBSCRIPT_IMPL_(ThisConst, ThatConst)                                                                                                                                                         \
    ...
    BOOST_PROTO_DISABLE_MSVC_C4714 BOOST_FORCEINLINE                                                                                                                                                                      \
        typename BOOST_PROTO_RESULT_OF<                                                                                                                                                                                   \
            proto_generator(                                                                                                                                                                                              \
                typename boost::proto::base_expr<                                                                                                                                                                         \
                    proto_domain, boost::proto::tag::subscript, boost::proto::list2<proto_derived_expr ThisConst() &, typename boost::proto::result_of::as_child<A ThatConst(), proto_domain>::type>>::type)>::type const \
        operator[](A ThatConst() & a) ThisConst()                                                                                                                                                                         \
    {                                                                                                                                                                                                                     \
        typedef                                                                                                                                                                                                           \
            typename boost::proto::base_expr<                                                                                                                                                                             \
                proto_domain, boost::proto::tag::subscript, boost::proto::list2<proto_derived_expr ThisConst() &, typename boost::proto::result_of::as_child<A ThatConst(), proto_domain>::type>>::type                   \
                that_type;                                                                                                                                                                                                \
        that_type const that = {                                                                                                                                                                                          \
            *static_cast<proto_derived_expr ThisConst() *>(this), boost::proto::as_child<proto_domain>(a)};                                                                                                               \
        return proto_generator()(that);                                                                                                                                                                                   \
...
#define BOOST_PROTO_EXTENDS_FUNCTION_CONST()                                        \
    ...
    BOOST_PP_REPEAT_FROM_TO(                                                        \
        0, BOOST_PROTO_MAX_FUNCTION_CALL_ARITY, BOOST_PROTO_DEFINE_FUN_OP_CONST, ~) \
    /**/

#define BOOST_PROTO_EXTENDS_FUNCTION_NON_CONST()                                        \
    BOOST_PROTO_EXTENDS_FUNCTION_()                                                     \
    BOOST_PP_REPEAT_FROM_TO(                                                            \
        0, BOOST_PROTO_MAX_FUNCTION_CALL_ARITY, BOOST_PROTO_DEFINE_FUN_OP_NON_CONST, ~) \
    /**/

#define BOOST_PROTO_EXTENDS_FUNCTION()                                        \
    BOOST_PROTO_EXTENDS_FUNCTION_()                                           \
    BOOST_PP_REPEAT_FROM_TO(                                                  \
        0, BOOST_PROTO_MAX_FUNCTION_CALL_ARITY, BOOST_PROTO_DEFINE_FUN_OP, ~) \
    /**/
#endif
...
///
template <
    typename Expr, typename Derived, typename Domain // = proto::default_domain
    ,
