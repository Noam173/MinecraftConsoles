...
ifndef BOOST_FT_config_valid
    BOOST_PP_EXPAND(#) define BOOST_FT_cc_id 1 BOOST_PP_EXPAND(#) define BOOST_FT_cc_name implicit_cc
...
#undef _
    ...
    BOOST_PP_EXPAND(#) else BOOST_PP_EXPAND(#) undef BOOST_FT_config_valid
...
BOOST_PP_EXPAND(#)
define BOOST_FT_cc_id BOOST_PP_INC(BOOST_PP_ITERATION())
