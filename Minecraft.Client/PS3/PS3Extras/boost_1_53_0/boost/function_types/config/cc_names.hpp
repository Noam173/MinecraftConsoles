...
#define BOOST_FT_BUILTIN_CC_NAMES \
    ((IMPLICIT, implicit_cc, BOOST_PP_EMPTY))((CDECL, cdecl_cc, BOOST_PP_IDENTITY(__cdecl)))((STDCALL, stdcall_cc, BOOST_PP_IDENTITY(__stdcall)))((PASCAL, pascal_cc, BOOST_PP_IDENTITY(pascal)))((FASTCALL, fastcall_cc, BOOST_PP_IDENTITY(__fastcall)))((CLRCALL, clrcall_cc, BOOST_PP_IDENTITY(__clrcall)))((THISCALL, thiscall_cc, BOOST_PP_IDENTITY(__thiscall)))((IMPLICIT_THISCALL, thiscall_cc, BOOST_PP_EMPTY))
