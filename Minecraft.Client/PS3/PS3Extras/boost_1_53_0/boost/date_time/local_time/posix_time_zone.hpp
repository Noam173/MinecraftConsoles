...
{
    bad_offset(std::string const &msg = std::string()) : std::out_of_range(std::string("Offset out of range: " + msg))
    {
    }
};
...
{
    bad_adjustment(std::string const &msg = std::string()) : std::out_of_range(std::string("Adjustment out of range: " + msg))
    {
    }
};
...
class posix_time_zone_base : public date_time::time_zone_base<posix_time::ptime, CharT>
{
  public:
    ...
    posix_time_zone_base(const string_type &s) : // zone_names_("std_name","std_abbrev","no-dst","no-dst"),
                                                 zone_names_(),
                                                 has_dst_(false),
