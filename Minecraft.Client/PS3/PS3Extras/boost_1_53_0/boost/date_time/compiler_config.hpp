...
#if (BOOST_WORKAROUND(__BORLANDC__, BOOST_TESTED_AT(0x581)) || BOOST_WORKAROUND(__GNUC__, < 3) || (BOOST_WORKAROUND(_MSC_VER, <= 1300))) && !defined(USE_DATE_TIME_PRE_1_33_FACET_IO)
