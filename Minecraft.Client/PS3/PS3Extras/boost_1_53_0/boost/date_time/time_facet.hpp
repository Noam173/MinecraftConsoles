...
class time_facet : public boost::date_time::date_facet<typename time_type::date_type, CharT, OutItrT>
{
...
class time_input_facet : public boost::date_time::date_input_facet<typename time_type::date_type, CharT, InItrT>
{
  public:
    typedef typename time_type::date_type date_type;
    typedef typename time_type::time_duration_type time_duration_type;
  ...
  protected:
    ...
    inline InItrT check_special_value(InItrT &sitr, InItrT &stream_end, temporal_type &tt, char_type c = '\0') const
    {
        match_results mr;
        if ((c == '-' || c == '+') && (*sitr != c))
  ...
  private:
    ...
    inline int_type decimal_adjust(int_type val, const unsigned short places) const
    {
