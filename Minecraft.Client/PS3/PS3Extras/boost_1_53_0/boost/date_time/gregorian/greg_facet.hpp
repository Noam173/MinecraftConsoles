...
inline std::basic_istream<charT> &operator>>(std::basic_istream<charT> &is, date &d)
{
...
template <class charT>
inline std::basic_istream<charT> &operator>>(std::basic_istream<charT> &is, greg_month &m)
{
    typedef boost::date_time::all_date_names_put<greg_facet_config, charT> facet_def;
...
template <class charT>
inline std::basic_istream<charT> &operator>>(std::basic_istream<charT> &is, greg_weekday &wd)
{
    typedef boost::date_time::all_date_names_put<greg_facet_config, charT> facet_def;
