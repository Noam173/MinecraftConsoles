...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_CAPTURE_DECL_TYPED_(                                                                                                                                                      \
    ...
    typedef BOOST_PP_EXPR_IIF(typename01, typename)                                                                                                         /* remove ref because typed var can have & prefix */     \
        ::boost::remove_reference<BOOST_PP_EXPR_IIF(typename01, typename)::boost::function_traits</* instead of using Boost.Typeof, get bind type as 1st */ /* argument type of func type `void (type_ [&] var_)` */ \
                                                                                                  void(BOOST_LOCAL_FUNCTION_AUX_PP_BIND_TRAITS_VAR_WITH_TYPE(                                                        \
                                                                                                      bind_traits))>::arg1_type>::type                                                                               \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_CAPTURE_DECL_DEDUCED_(                                 \
    ...
    BOOST_SCOPE_EXIT_DETAIL_CAPTURE_DECL(r,                                                       \
                                         ...
                                         i, BOOST_LOCAL_FUNCTION_AUX_PP_BIND_TRAITS_VAR_WITHOUT_TYPE(bind_traits))
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_CAPTURE_DECL_(                                                           \
    ...
    BOOST_PP_IIF(BOOST_PP_IS_EMPTY(                                                                                 \
                 ...
                 BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_CAPTURE_DECL_TYPED_)(r, BOOST_PP_TUPLE_ELEM(2, 0, id_typename), \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_PARAM_DECL_(                                                                             \
    ...
    BOOST_SCOPE_EXIT_DETAIL_PARAM_DECL(r,                                                                                           \
                                       (                                                                                            \
                                           BOOST_PP_TUPLE_ELEM(2, 0, id_typename), /* ScopeExit expects typename or EMPTY() here */ \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_MEMBER_DECL_VAR_(                                                    \
    ...
    BOOST_IDENTITY_TYPE((/* must use IDENTITY because of tparam comma */                                        \
                         ::boost::scope_exit::detail::member<                                                   \
                             BOOST_SCOPE_EXIT_DETAIL_PARAM_T(id, i, var), BOOST_SCOPE_EXIT_DETAIL_TAG(id, i)>)) \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_THIS_TYPEDEF_TYPED_(                    \
    id, typename01, all_bind_this_types)                                           \
    typedef BOOST_LOCAL_FUNCTION_AUX_PP_BIND_TRAITS_THIS_TYPE(BOOST_PP_LIST_FIRST( \
        all_bind_this_types))                                                      \
        BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_THIS_CAPTURE_TYPE_(id);
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_THIS_TYPEDEF_(                                                                                                       \
    id, typename01, all_bind_this_types)                                                                                                                        \
    /* typedef type_ */                                                                                                                                         \
    BOOST_PP_IIF(BOOST_PP_IS_EMPTY(/* all_bind_this_type is list with 1 elem (possibly PP_EMPTY), */ /* otherwise got a pp-parsing error before getting here */ \
                 ...
                 BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_THIS_TYPEDEF_TYPED_)(id, typename01, all_bind_this_types)
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_ALL_(                                                                                                                                                                                                              \
    ...
    BOOST_PP_IIF(BOOST_PP_LIST_IS_CONS(all_bind_this_types),                                                                                                                                                                                                  \
                 ...
                 BOOST_PP_TUPLE_EAT(3))(id, typename01, all_bind_this_types)                                                                                                                                                                                  \
        BOOST_PP_LIST_FOR_EACH_I(BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_TAG_DECL_, id,                                                                                                                                                                            \
            ...
            BOOST_PP_LIST_FOR_EACH_I(BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_CAPTURE_DECL_,                                                                                                                                                                        \
                                     (id, typename01), all_binds) /* binding class */                                                                                                                                                                         \
    ...
    {                                                                                                                                                                                                                                                         \
        ...
        BOOST_PP_LIST_FOR_EACH_I(                                                                                                                                                                                                                             \
            ...
            (id, typename01), all_binds)                                                                                                                                                                                                                      \
    } BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_PARAMS_VAR_(id) = /* NOTE: there is no way to wrap member initializer commas within */ /* parenthesis so you must handle these commas manually if expanding */ /* this macro within another macro */                 \
        {                                                                                                                                                                                               /* initialize the struct with param values to bind */ \
         ...
         BOOST_PP_COMMA_IF(BOOST_PP_BITAND(                                                                                                                                                                                                                   \
             BOOST_PP_LIST_IS_CONS(all_bind_this_types), BOOST_PP_LIST_IS_CONS(all_binds)))                                                                                                                                                                   \
             BOOST_PP_LIST_FOR_EACH_I(                                                                                                                                                                                                                        \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_BIND(id, typename01, decl_traits)                                                                                                                                                                                                                                                                                                                    \
    ...
    ::boost::scope_exit::detail::declared<boost::scope_exit::detail::resolve</* cannot prefix with `::` as in `sizeof(:: ...` because the name */ /* must refer to the local variable name to allow multiple local */ /* functions (and exits) within the same scope (however this */ /* does not allow for nesting because local variables cannot be */ /* used in nested code blocks) */ \
                                                                             sizeof(BOOST_LOCAL_FUNCTION_AUX_DECL_ARGS_VAR)>::cmp1<0>::cmp2>                                                                                                                                                                                                                                               \
