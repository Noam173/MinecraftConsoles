...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_PARAM_ARG_TYPE_(typename01, i) \
    ...
    ::boost::function_traits<                                                \
        BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_F_TYPE_>::BOOST_PP_CAT(BOOST_PP_CAT(arg, i), _type)

#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_ARG_TYPEDEF_(                                                                                              \
    r, typename01, i, param_traits)                                                                                                                      \
    typedef BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_PARAM_ARG_TYPE_(typename01,                                                                            \
                                                                  BOOST_PP_INC(i)) /* name must follow Boost.FunctionTraits arg1_type, arg2_type, ... */ \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_PARAM_DECL_ENUM_(                                    \
    ...
    BOOST_PP_IIF(BOOST_PP_COMPL(default01),                                                        \
                 ...
                 BOOST_PP_IIF(BOOST_PP_IS_EMPTY(                                                   \
                              ...
                              BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_PARAM_DEFAULT_ASSIGNMENT_))(param_traits)
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_MAYBECONST_BIND_DECL_TYPE_(                                                                                                                                                                                                                                                                             \
    ...
    BOOST_PP_IIF(BOOST_PP_COMPL(BOOST_PP_TUPLE_ELEM(4, 3,                                                                                                                                                                                                                                                                                             \
                 ...
                 BOOST_PP_EMPTY, BOOST_PP_IIF(BOOST_LOCAL_FUNCTION_DETAIL_PP_KEYWORD_IS_THISUNDERSCORE_BACK(bind_var_without_type),                                                                                                                                                                                           /* pointed obj const */ \
                                              BOOST_PP_EXPR_IIF(BOOST_PP_TUPLE_ELEM(4, 1, id_typename_offset_const), typename) BOOST_PP_IDENTITY(::boost::local_function::aux::add_pointed_const <), BOOST_PP_EXPR_IIF(BOOST_PP_TUPLE_ELEM(4, 1, id_typename_offset_const), typename) BOOST_PP_IDENTITY(::boost::add_const <) /* outer type const */  \
                                              ))()                                                                                                                                                                                                                                                                                                    \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_MAYBECONST_BIND_DECL_(   \
    ...
    BOOST_PP_IIF(                                                      \
        ...
        BOOST_PP_TUPLE_REM(1))(bind_var_without_type)
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_COMMA_NOBIND_PARAM_DECL_( \
    z, n, unused)                                                       \
    , ::boost::local_function::aux::nobind_t & /* param name not needed here because no bind param not used */
    ...
    ::boost::local_function::aux::member_type<                                 \
        ...
        BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_MAYBECONST_BIND_MEMBER_VAR_(     \
            BOOST_PP_ADD(i, BOOST_PP_TUPLE_ELEM(4, 2,                          \
                                                id_typename_offset_const))); /* end member variable declaration */
    ...
    (/* member variable initialization */                                                                                                                                        \
     static_cast<                                                                                                                                                                \
         BOOST_SCOPE_EXIT_DETAIL_PARAMS_T(                                                                                                                                       \
             BOOST_PP_TUPLE_ELEM(2, 0, id_offset)) *>(BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_PARAMS_)                                                                             \
         ->BOOST_SCOPE_EXIT_DETAIL_PARAM(                                                                                                                                        \
             BOOST_PP_TUPLE_ELEM(2, 0, id_offset), BOOST_PP_ADD(i, BOOST_PP_TUPLE_ELEM(2, 1, id_offset)), BOOST_LOCAL_FUNCTION_AUX_PP_BIND_TRAITS_VAR_WITHOUT_TYPE(bind_traits)) \
         .value)
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_CALL_BODY_(id, typename01,                                                       \
    ...
    BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_BODY_FUNC_(                                                                          \
        BOOST_PP_LIST_FOR_EACH_I(const_bind_macro,                                                                             \
                                 0 /* no offset */, const_binds) /* pass plain binds */                                        \
        BOOST_PP_COMMA_IF(                                                                                                     \
            BOOST_PP_BITAND(                                                                                                   \
                BOOST_PP_LIST_IS_CONS(const_binds), BOOST_PP_LIST_IS_CONS(binds)))                                             \
            BOOST_PP_LIST_FOR_EACH_I(bind_macro,                             /* offset index of # const-binds (could be 0) */  \
        ...
        BOOST_PP_COMMA_IF(                                                                                                     \
            ...
            BOOST_PP_EXPR_IIF(has_const_bind_this, const_bind_this_macro)                                                      \
                BOOST_PP_EXPR_IIF(has_bind_this, bind_this_macro) /* pass params */                                            \
        BOOST_PP_COMMA_IF(                                                                                                     \
            BOOST_PP_BITAND(                                                                                                   \
                BOOST_PP_BITOR(                                                                                                \
                    BOOST_PP_BITOR(                                                                                            \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_CALL_(z, defaults_n,                                                                  \
    ...
    operator()(                                                                                                                     \
        BOOST_PP_LIST_FOR_EACH_I(                                                                                                   \
            ...
            typename01, params)) /* cannot be const because of binds (same as for global fctor) */                                  \
    {                                                                                                                               \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_STATIC_CALL_COMMA_BIND_PARAM_DECLS_(                                            \
    ...
    BOOST_PP_IIF(BOOST_PP_BITOR(has_bind_this,                                                                                \
                 ...
                 BOOST_PP_TUPLE_EAT(2))(id, typename01) /* fill with nobind_t (if no local-types as tparams) */               \
        BOOST_PP_REPEAT(BOOST_PP_SUB(BOOST_LOCAL_FUNCTION_CONFIG_BIND_MAX,                                                    \
                                     BOOST_PP_IIF(BOOST_PP_BITOR(has_bind_this,                                               \
                                                                 has_const_bind_this),                                        \
                                                  BOOST_PP_INC,                                                               \
                                                  BOOST_PP_TUPLE_REM(1))(BOOST_PP_LIST_SIZE(BOOST_PP_LIST_APPEND(const_binds, \
                                                                                                                 binds)))),   \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_STATIC_CALL_(z, defaults_n,                                                                                       \
        ...
        BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_STATIC_CALL_FUNC_(z, defaults_n, ~)(                                                                              \
            void *object                                                                                                                                        \
                BOOST_PP_IIF(BOOST_LOCAL_FUNCTION_CONFIG_LOCALS_AS_TPARAMS,                                                                                     \
                             ...
                             BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_STATIC_CALL_COMMA_BIND_PARAM_DECLS_)(id, typename01,                                         \
                                                                                                        const_binds, has_const_bind_this, binds, has_bind_this) \
                    BOOST_PP_LIST_FOR_EACH_I(                                                                                                                   \
    ...
    {                                                                                                                                                           \
        ...
        return static_cast<                                                                                                                                     \
                   BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_CLASS_TYPE_(id) *>(object)                                                                             \
            ->BOOST_PP_IIF(BOOST_LOCAL_FUNCTION_CONFIG_LOCALS_AS_TPARAMS,                                                                                       \
                           BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_STATIC_CALL_OPERATOR_,                                                                         \
                           BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_STATIC_CALL_BODY_)(id, typename01, params,                                                     \
                                                                                    const_binds, has_const_bind_this, binds, has_bind_this);                    \
    }
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_CALL_FOR_DEFAULTS_(z, defaults_n,                                                                                                                                                             \
    ...
    BOOST_PP_EXPAND(                                                                                                                                                                                                                        \
        BOOST_PP_TUPLE_ELEM(9, 0,                                                                                                                                                                                                           \
                            op_id_typename_decl_params_constbinds_hasconstthis_binds_hasthis)(z, defaults_n, BOOST_PP_TUPLE_ELEM(9, 1, /* id */                                                                                             \
                                                                                                                                 op_id_typename_decl_params_constbinds_hasconstthis_binds_hasthis),                                         \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_COMMA_BIND_TYPES_(                                                                         \
    ...
    BOOST_PP_LIST_FOR_EACH_I(                                                                                                            \
        ...
        const_binds)                                                                                                                     \
    BOOST_PP_LIST_FOR_EACH_I(                                                                                                            \
        BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_COMMA_MAYBECONST_BIND_TYPE_, /* offset of # of const-binds */                              \
        (id, typename01, BOOST_PP_LIST_SIZE(const_binds), 0 /* const */),                                                                \
        binds)                                                                                                                           \
    BOOST_PP_IIF(BOOST_PP_BITOR(has_bind_this,                                                                                           \
                                has_const_bind_this),                                                                                    \
        ...
        BOOST_PP_REPEAT(BOOST_PP_SUB(BOOST_LOCAL_FUNCTION_CONFIG_BIND_MAX,                                                               \
                                     BOOST_PP_IIF(BOOST_PP_BITOR(has_bind_this, has_const_bind_this),                                    \
                                                  BOOST_PP_INC,                                                                          \
                                                  BOOST_PP_TUPLE_REM(1))(BOOST_PP_LIST_SIZE(BOOST_PP_LIST_APPEND(const_binds, binds)))), \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_BIND_TYPEOF_TYPEDEFS_(                                                           \
    ...
    /* bind typeof types */                                                                                                    \
    BOOST_PP_LIST_FOR_EACH_I(                                                                                                  \
        BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_MAYBECONST_TYPEDEF_, /* offset index with # of preceding const-binds (if any) */ \
    ...
    BOOST_PP_EXPR_IIF(has_const_bind_this,                                                                                     \
                      typedef BOOST_LOCAL_FUNCTION_AUX_TYPEOF_TYPE(                                                            \
                          BOOST_PP_EXPR_IIF(typename01, typename)::boost::local_function::aux::add_pointed_const<              \
                              BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_THIS_TYPE(id, typename01)>::type                              \
                              this_); /* close typedef */                                                                      \
    )                                                                                                                          \
    /* ... or, non-const this */                                                                                               \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_BIND_MEMBER_DECLS_(                                                                                    \
    ...
    BOOST_PP_EXPR_IIF(BOOST_PP_BITOR(has_bind_this, has_const_bind_this), /* this is * so no & */                                                    \
                      BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_THIS_TYPE(id, typename01)                                                                   \
                          BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_BIND_MEMBER_THIS_; /* end member variable declaration */                             \
    )
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_COMMA_STATIC_BINDS_(                                                                       \
    ...
    BOOST_PP_IIF(BOOST_PP_BITOR(has_bind_this,                                                                                           \
                 ...
                 BOOST_PP_TUPLE_EAT(1))(id) /* fill with nobind_t (if no local-types as tparams) */                                      \
        BOOST_PP_REPEAT(BOOST_PP_SUB(BOOST_LOCAL_FUNCTION_CONFIG_BIND_MAX,                                                               \
                                     BOOST_PP_IIF(BOOST_PP_BITOR(has_bind_this, has_const_bind_this),                                    \
                                                  BOOST_PP_INC,                                                                          \
                                                  BOOST_PP_TUPLE_REM(1))(BOOST_PP_LIST_SIZE(BOOST_PP_LIST_APPEND(const_binds, binds)))), \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_(                                                                                                                                                                                               \
    ...
    {                                                                                                                                                                                                                                         \
        /* function type */                                                                                                                                                                                                                   \
      private:                                                                                                                                                                                                                                \
        typedef BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_F_(id, typename01,                                                                                                                                                                      \
        ...
        typedef BOOST_PP_EXPR_IIF(typename01, typename)                                                                                                                                                                                       \
            BOOST_IDENTITY_TYPE((/* IDENTITY for template param comma */                                                                                                                                                                      \
                                 ::boost::local_function::aux::function<                                                                                                                                                                      \
                                     BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_F_TYPE_, default_count                                                                                                                                             \
                                                                                        BOOST_PP_IIF(BOOST_LOCAL_FUNCTION_CONFIG_LOCALS_AS_TPARAMS,                                                                                           \
                                                                                                     BOOST_PP_TUPLE_EAT(6),                                                                                                                   \
                                                                                                     BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_COMMA_BIND_TYPES_)(id, typename01, const_binds, has_const_bind_this,                               \
                                                                                                                                                              binds, has_bind_this)>))                                                        \
      ...
      public:                                                                                                                                                                                                                                 \
        ...
        enum                                                                                                                                                                                                                                  \
        {                                                                                                                                                                                                                                     \
            arity = ::boost::function_traits</* can't use static data */                                                                                                                                                                      \
        ...
        inline explicit BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_CLASS_TYPE_(id)(                                                                                                                                                                \
            void *BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_PARAMS_) /* NOTE: there is no way to wrap member initializer commas */ /* within paren so you must handle these commas manually if */ /* expanding this macro within another macro */ \
        ...
        BOOST_PP_REPEAT(/* PP_INC to handle no dflt (EXPAND for MVSC) */                                                                                                                                                                      \
                        ...
                        (BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_CALL_, id, typename01, decl_traits, params, const_binds, has_const_bind_this, binds, has_bind_this))                                                                           \
        ...
        BOOST_PP_REPEAT(/* PP_INC to handle no dflt (EXPAND for MVSC) */                                                                                                                                                                      \
                        BOOST_PP_EXPAND(BOOST_PP_INC(default_count)),                                                                                                                                                                         \
                        BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_CALL_FOR_DEFAULTS_,                                                                                                                                                             \
                        (BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_STATIC_CALL_, id, typename01, decl_traits, params, const_binds, has_const_bind_this, binds, has_bind_this))                                                                    \
        ...
        {                                                                                                                                                                                                                                     \
            functor.BOOST_LOCAL_FUNCTION_AUX_FUNCTION_INIT_CALL_FUNC(                                                                                                                                                                         \
                object                                                                                                                                                                                                                        \
                    BOOST_PP_IIF(BOOST_LOCAL_FUNCTION_CONFIG_LOCALS_AS_TPARAMS,                                                                                                                                                               \
                                 BOOST_PP_TUPLE_EAT(6),                                                                                                                                                                                       \
                                 BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_COMMA_STATIC_BINDS_)(id, typename01, const_binds, has_const_bind_this,                                                                                                 \
                                                                                            binds, has_bind_this)                                                                                                                             \
            ...
            BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_BODY_FUNC_(/* const binds */                                                                                                                                                                \
                                                             ...
                                                             BOOST_PP_COMMA_IF(                                                                                                                                                               \
                                                                 BOOST_PP_BITAND(                                                                                                                                                             \
                                                                     BOOST_PP_BITOR(                                                                                                                                                          \
                                                                         BOOST_PP_LIST_IS_CONS(const_binds), BOOST_PP_LIST_IS_CONS(binds)),                                                                                                   \
                                                                     BOOST_PP_BITOR(has_const_bind_this, has_bind_this))) /* const pointer to const object */                                                                                 \
                                                             BOOST_PP_EXPR_IIF(has_const_bind_this,                                                                                                                                           \
                                                                               BOOST_PP_EXPR_IIF(typename01, typename)::boost::local_function::aux::add_pointed_const<                                                                        \
                                                                                   BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_THIS_TYPE(id,                                                                                                           \
                                                                                                                                typename01)>::type const this_ /* special name to access object this */                                       \
                                                             ...
                                                             BOOST_PP_COMMA_IF(                                                                                                                                                               \
                                                                 ...
                                                                 BOOST_PP_LIST_FOR_EACH_I(                                                                                                                                                    \
                                                                     BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_PARAM_DECL_ENUM_,                                                                                                                  \
                                                                     1 /* with defaults */, params)) /* end body function params */ /* cannot be const because recursive functor is non const member */ /* user local function definition `{ ... }` will follow here */ /* `END` macro will close function class decl `};` here */
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR(id, typename01, decl_traits)                                                                                                                                                \
    BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_(id, typename01, decl_traits /* params (might have defaults) */                                                                                                                 \
                                           ,                                                                                                                                                                              \
                                           BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_PARAMS(decl_traits), BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_PARAMS_DEFAULT_COUNT(decl_traits) /* const bind vars (`this` excluded) */ \
                                           ,                                                                                                                                                                              \
                                           BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_CONST_BINDS(decl_traits) /* if const bind `this` is present */                                                                         \
                                           ,                                                                                                                                                                              \
                                           BOOST_PP_LIST_IS_CONS(                                                                                                                                                         \
                                               BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_CONST_BIND_THIS_TYPES(                                                                                                             \
                                                   decl_traits)) /* bind (non-const) vars (`this` excluded) */                                                                                                            \
                                           ,                                                                                                                                                                              \
                                           BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_BINDS(decl_traits) /* if (non-const) bind `this` is present */                                                                         \
                                           ,                                                                                                                                                                              \
                                           BOOST_PP_LIST_IS_CONS(                                                                                                                                                         \
