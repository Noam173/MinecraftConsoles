...
#define BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_APPEND_RETURN(                                          \
    ...
    (/* returns */                                                                                      \
     ...
     BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_PARAMS(decl_traits),      /* const-bind vars */            \
     BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_CONST_BINDS(decl_traits), /* const-bind `this` types */    \
     BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_CONST_BIND_THIS_TYPES(                                     \
         decl_traits),                                                     /* bind vars */              \
     BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_BINDS(decl_traits),           /* bind `this` types */      \
     BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_BIND_THIS_TYPES(decl_traits), /* error message (if any) */ \
...
#define BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_APPEND_PARAM(                                                        \
    ...
    (                                                              /* returns */                                     \
     BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_RETURNS(decl_traits), /* params and defaults */                         \
     BOOST_PP_LIST_APPEND(                                                                                           \
         BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_PARAMS(decl_traits),  /* append param (with no default -- EMPTY) */ \
...
#define BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_APPEND_PARAM_DEFAULT(                                           \
    ...
    (                                                              /* returns */                                \
     BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_RETURNS(decl_traits), /* unbind params and defaults */             \
...
#define BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_APPEND_BIND(                                            \
    ...
    (                                                                  /* returns */                    \
     ...
     BOOST_PP_LIST_APPEND(                                                                              \
         ...
         ((var_without_type, var_with_type), BOOST_PP_NIL)),               /* bind `this` types */      \
     BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_BIND_THIS_TYPES(decl_traits), /* error message (if any) */ \
     BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_ERROR(decl_traits))
    ...
    (                                                              /* returns */                        \
     ...
     BOOST_PP_LIST_APPEND(                                                                              \
         BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_CONST_BINDS(                                           \
             decl_traits),                                                                              \
         ((var_without_type, var_with_type), BOOST_PP_NIL)), /* const-bind `this` types */              \
     BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_CONST_BIND_THIS_TYPES(                                     \
         decl_traits),                                                     /* bind vars */              \
     BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_BINDS(decl_traits),           /* bind `this` types */      \
     BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_BIND_THIS_TYPES(decl_traits), /* error message (if any) */ \
