...
#define BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_VALIDATE_RETURN_COUNT(                                                        \
    ...
    BOOST_PP_IIF(BOOST_PP_GREATER(BOOST_PP_LIST_SIZE(                                                                         \
                                  ...
                                  1),                                                                                         \
                 BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_SET_ERROR, /* else do nothing (keeping previous error, if any) */    \
                 decl_traits BOOST_PP_TUPLE_EAT(2))(decl_traits,    /* trailing `EMPTY` because error might not be present */ \
