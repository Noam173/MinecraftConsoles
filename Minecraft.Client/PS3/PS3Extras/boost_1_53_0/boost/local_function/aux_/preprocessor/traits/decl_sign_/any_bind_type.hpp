...
#define BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_SIGN_ANY_BIND_THIS_TYPE_(sign)                                                                                                                                                                                                                                                          \
    BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_SIGN_ANY_BIND_WITH_TYPE(/* can't use `THISUNDERSCIRE_REMOVE_BACK` because `sign` contains */ /* multiple tokens (and not just one token) so */ /* `IS_THISUNDERSCORE_BACK` does not work (but we know `sign` ends */ /* with this_ if we here so we can manually force the removal using */ \
                                                                    BOOST_PP_CAT(sign,                                                                                                                                                                                                                                                  \
