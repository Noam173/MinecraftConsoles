...
#define BOOST_LOCAL_FUNCTION_AUX_arg_typedef(z, arg_n, unused)                                                                   \
    typedef BOOST_LOCAL_FUNCTION_AUX_arg_type(z, arg_n, ~) /* name must follow Boost.FunctionTraits arg1_type, arg2_type, ... */ \
...
#define BOOST_LOCAL_FUNCTION_AUX_arg_param_type(z, arg_n, comma01) \
    ...
    typename ::boost::call_traits<                                 \
        BOOST_LOCAL_FUNCTION_AUX_arg_type(z, arg_n, ~)>::param_type
...
#define BOOST_LOCAL_FUNCTION_AUX_bind_member_decl(z, bind_n, unused) \
    ...
    typename member_type<                                            \
        BOOST_LOCAL_FUNCTION_AUX_bind_type(z, bind_n, ~)>::pointer BOOST_LOCAL_FUNCTION_AUX_bind_member(z, bind_n, ~);
    ...
    typedef R (*BOOST_LOCAL_FUNCTION_AUX_call_ptr(z, n, ~))(                              \
        object_ptr                                                                        \
            BOOST_PP_IIF(BOOST_LOCAL_FUNCTION_CONFIG_LOCALS_AS_TPARAMS,                   \
                         ...
                         BOOST_PP_REPEAT_##z)(BOOST_LOCAL_FUNCTION_CONFIG_BIND_MAX,       \
...
#define BOOST_LOCAL_FUNCTION_AUX_operator_call(z, defaults_n, arity)                                                                   \
    ...
    inline R operator()(                                                                                                               \
        BOOST_PP_ENUM_##z(BOOST_PP_SUB(arity, defaults_n),                                                                             \
                          BOOST_LOCAL_FUNCTION_AUX_arg_param_decl, ~)) /* cannot be const because of binds (same as for local ftor) */ \
    {                                                                                                                                  \
