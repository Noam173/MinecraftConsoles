...
{ // Check both alpha and beta.
    return check_alpha(function, alpha, result, pol) && check_beta(function, beta, result, pol);
} // bool check_dist
...
{
    return check_dist(function, alpha, beta, result, pol) && beta_detail::check_x(function, x, result, pol);
...
{
    return check_dist(function, alpha, beta, result, pol) && check_prob(function, p, result, pol);
...
class beta_distribution
{
  public:
        ...
        RealType variance) // Expected value of variance.
    {
        ...
        if (false ==
            (beta_detail::check_mean(function, mean, &result, Policy()) && beta_detail::check_variance(function, variance, &result, Policy())))
        {
            return result;
        }
