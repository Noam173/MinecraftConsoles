...
//
#if !defined(BOOST_MATH_TR1_NO_LIB) && !defined(BOOST_MATH_TR1_SOURCE) && !defined(BOOST_ALL_NO_LIB) && defined(__cplusplus)
...
#include <boost/config/auto_link.hpp>
#endif
#if !defined(BOOST_MATH_TR1_NO_LIB) && !defined(BOOST_MATH_TR1_SOURCE) && !defined(BOOST_ALL_NO_LIB) && defined(__cplusplus) && !defined(BOOST_MATH_NO_LONG_DOUBLE_MATH_FUNCTIONS)
