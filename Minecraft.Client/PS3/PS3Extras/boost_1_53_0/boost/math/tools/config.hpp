...
#if (defined(__CYGWIN__) || defined(__FreeBSD__) || defined(__NetBSD__) || (defined(__hppa) && !defined(__OpenBSD__)) || (defined(__NO_LONG_DOUBLE_MATH) && (DBL_MANT_DIG != LDBL_MANT_DIG))) && !defined(BOOST_MATH_NO_LONG_DOUBLE_MATH_FUNCTIONS)
...
#if defined(__CYGWIN__) || defined(__HP_aCC) || defined(BOOST_INTEL) || defined(BOOST_NO_NATIVE_LONG_DOUBLE_FP_CLASSIFY) || (defined(__GNUC__) && !defined(BOOST_MATH_USE_C99)) || defined(BOOST_MATH_NO_LONG_DOUBLE_MATH_FUNCTIONS)
...
#define BOOST_MATH_INSTRUMENT_FPU                   \
    ...
    {                                               \
        fexcept_t cpu_flags;                        \
        fegetexceptflag(&cpu_flags, FE_ALL_EXCEPT); \
        BOOST_MATH_INSTRUMENT_VARIABLE(cpu_flags);  \
    } while (0);
