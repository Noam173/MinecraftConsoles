...
#define BOOST_MATH_BIG_CONSTANT(T, D, x)                                                                                                                                                                                                \
    boost::math::tools::make_big_value<T>(                                                                                                                                                                                              \
        ...
        mpl::bool_<(is_convertible<long double, T>::value) &&                                                                                                                                                                           \
                   ((D <= std::numeric_limits<long double>::digits) || is_floating_point<T>::value || (std::numeric_limits<T>::is_specialized && (std::numeric_limits<T>::digits10 <= std::numeric_limits<long double>::digits10)))>(), \
