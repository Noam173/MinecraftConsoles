...
struct static_gcd_helper2_t
{
    ...
    struct helper
    {
        BOOST_STATIC_CONSTANT(static_gcd_type, value = static_gcd_helper2_t<Value2>::BOOST_NESTED_TEMPLATE
...
struct static_gcd_helper_t
{
    BOOST_STATIC_CONSTANT(static_gcd_type, value = static_gcd_helper2_t<Value1>::BOOST_NESTED_TEMPLATE
                                               helper<Value2>::value);
};
#endif
...
struct static_lcm_helper_t
{
    BOOST_STATIC_CONSTANT(static_gcd_type, value = static_lcm_helper2_t<Value1>::BOOST_NESTED_TEMPLATE
                                               helper<Value2>::value);
};
#endif
