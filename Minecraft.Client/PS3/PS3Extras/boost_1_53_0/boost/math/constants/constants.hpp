        ...
        typename mpl::if_<
            ...
            typename mpl::if_<
                ...
                typename mpl::if_<
                    ...
                    mpl::int_<t1::value>>::type>::type>::type>::type type;
};
...
#define BOOST_DEFINE_MATH_CONSTANT(name, x, y)                                                                                     \
    ...
    {                                                                                                                              \
      private:                                                                                                                     \
        ...
        template <int N>                                                                                                           \
        static T compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(mpl::int_<N>));                                                    \
      ...
      public:                                                                                                                      \
        ...
        template <int N>                                                                                                           \
        static inline T get(const mpl::int_<N> &)                                                                                  \
        {                                                                                                                          \
    ...
    inline BOOST_CONSTEXPR T name(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(T) BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE_SPEC(Policy)) \
    {                                                                                                                              \
        return detail::BOOST_JOIN(constant_, name)<T>::get(typename construction_traits<T, Policy>::type());                       \
    }                                                                                                                              \
    template <class T>                                                                                                             \
    inline BOOST_CONSTEXPR T name(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(T))                                                       \
    {                                                                                                                              \
    ...
    {                                                                                                                              \
    static const float name = BOOST_JOIN(x, F);                                                                                    \
    }                                                                                                                              \
    namespace double_constants                                                                                                     \
    {                                                                                                                              \
    static const double name = x;                                                                                                  \
    }                                                                                                                              \
    namespace long_double_constants                                                                                                \
    {                                                                                                                              \
    static const long double name = BOOST_JOIN(x, L);                                                                              \
    }                                                                                                                              \
    namespace constants                                                                                                            \
    {
