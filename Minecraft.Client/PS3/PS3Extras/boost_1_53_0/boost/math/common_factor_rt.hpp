...
template <typename T, bool IsSpecialized, bool IsSigned>
struct gcd_optimal_evaluator_helper_t
    : gcd_optimal_evaluator_helper2_t<IsSpecialized, IsSigned>::BOOST_NESTED_TEMPLATE helper<T>
{
};
#endif
...
#define BOOST_PRIVATE_GCD_SF(St, Ut)                        \
    ...
    {                                                       \
        St operator()(St a, St b) const                     \
        {                                                   \
            Ut const a_abs =                                \
                         static_cast<Ut>(a < 0 ? -a : +a),  \
                     b_abs = static_cast<Ut>(               \
                         b < 0 ? -b : +b);                  \
...
template <typename T, bool IsSpecialized, bool IsSigned>
struct lcm_optimal_evaluator_helper_t
    : lcm_optimal_evaluator_helper2_t<IsSpecialized, IsSigned>::BOOST_NESTED_TEMPLATE helper<T>
{
};
#endif
