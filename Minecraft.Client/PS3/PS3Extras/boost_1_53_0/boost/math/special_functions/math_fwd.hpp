...
#define BOOST_MATH_DECLARE_SPECIAL_FUNCTIONS(Policy)                                                                       \
    ...
    spherical_harmonic_r(unsigned n, int m, T1 theta, T2 phi)                                                              \
    {                                                                                                                      \
        return ::boost::math::spherical_harmonic_r(n, m, theta, phi, Policy());                                            \
    }                                                                                                                      \
                                                                                                                           \
    template <class T1, class T2>                                                                                          \
    inline typename boost::math::tools::promote_args<T1, T2>::type                                                         \
    ...
    {                                                                                                                      \
        return boost::math::ellint_2(k, Policy());                                                                         \
                                                                                                                           ...
                                                                                                                           \
    template <class T1, class T2>                                                                                          \
    inline typename boost::math::tools::promote_args<T1, T2>::type ellint_2(T1 k, T2 phi)                                  \
    {                                                                                                                      \
    ...
    {                                                                                                                      \
        return boost::math::ellint_1(k, Policy());                                                                         \
                                                                                                                           ...
                                                                                                                           \
    template <class T1, class T2>                                                                                          \
    inline typename boost::math::tools::promote_args<T1, T2>::type ellint_1(T1 k, T2 phi)                                  \
    {                                                                                                                      \
        return boost::math::ellint_1(k, phi, Policy());                                                                    \
    }                                                                                                                      \
                                                                                                                           \
    template <class T1, class T2, class T3>                                                                                \
    inline typename boost::math::tools::promote_args<T1, T2, T3>::type ellint_3(T1 k, T2 v, T3 phi)                        \
    {                                                                                                                      \
        return boost::math::ellint_3(k, v, phi, Policy());                                                                 \
    }                                                                                                                      \
                                                                                                                           \
    template <class T1, class T2>                                                                                          \
    inline typename boost::math::tools::promote_args<T1, T2>::type ellint_3(T1 k, T2 v)                                    \
    {                                                                                                                      \
    ...
    template <class RT>                                                                                                    \
    inline typename boost::math::tools::promote_args<RT>::type falling_factorial(RT x, unsigned n)                         \
    {                                                                                                                      \
        return boost::math::falling_factorial(x, n, Policy());                                                             \
    }                                                                                                                      \
    template <class RT>                                                                                                    \
    inline typename boost::math::tools::promote_args<RT>::type rising_factorial(RT x, unsigned n)                          \
    {                                                                                                                      \
    ...
    {                                                                                                                      \
        return boost::math::tgamma(z, Policy());                                                                           \
                                                                                                                           ...
                                                                                                                           \
    template <class RT>                                                                                                    \
    inline typename boost::math::tools::promote_args<RT>::type tgamma1pm1(RT z)                                            \
    {                                                                                                                      \
        return boost::math::tgamma1pm1(z, Policy());                                                                       \
    }                                                                                                                      \
                                                                                                                           \
    template <class RT1, class RT2>                                                                                        \
    inline typename boost::math::tools::promote_args<RT1, RT2>::type tgamma(RT1 a, RT2 z)                                  \
    {                                                                                                                      \
        return boost::math::tgamma(a, z, Policy());                                                                        \
    }                                                                                                                      \
                                                                                                                           \
    template <class RT>                                                                                                    \
    inline typename boost::math::tools::promote_args<RT>::type lgamma(RT z, int *sign)                                     \
    {                                                                                                                      \
    ...
    {                                                                                                                      \
        return boost::math::lgamma(x, Policy());                                                                           \
                                                                                                                           ...
                                                                                                                           \
    template <class RT1, class RT2>                                                                                        \
    inline typename boost::math::tools::promote_args<RT1, RT2>::type tgamma_lower(RT1 a, RT2 z)                            \
    {                                                                                                                      \
        return boost::math::tgamma_lower(a, z, Policy());                                                                  \
    }                                                                                                                      \
                                                                                                                           \
    template <class RT1, class RT2>                                                                                        \
    inline typename boost::math::tools::promote_args<RT1, RT2>::type gamma_q(RT1 a, RT2 z)                                 \
    {                                                                                                                      \
        return boost::math::gamma_q(a, z, Policy());                                                                       \
    }                                                                                                                      \
                                                                                                                           \
    template <class RT1, class RT2>                                                                                        \
    inline typename boost::math::tools::promote_args<RT1, RT2>::type gamma_p(RT1 a, RT2 z)                                 \
    {                                                                                                                      \
        return boost::math::gamma_p(a, z, Policy());                                                                       \
    }                                                                                                                      \
                                                                                                                           \
    template <class T1, class T2>                                                                                          \
    inline typename boost::math::tools::promote_args<T1, T2>::type tgamma_delta_ratio(T1 z, T2 delta)                      \
    {                                                                                                                      \
        return boost::math::tgamma_delta_ratio(z, delta, Policy());                                                        \
    }                                                                                                                      \
                                                                                                                           \
    template <class T1, class T2>                                                                                          \
    inline typename boost::math::tools::promote_args<T1, T2>::type tgamma_ratio(T1 a, T2 b)                                \
    {                                                                                                                      \
        return boost::math::tgamma_ratio(a, b, Policy());                                                                  \
    }                                                                                                                      \
                                                                                                                           \
    template <class T1, class T2>                                                                                          \
    inline typename boost::math::tools::promote_args<T1, T2>::type gamma_p_derivative(T1 a, T2 x)                          \
    {                                                                                                                      \
        return boost::math::gamma_p_derivative(a, x, Policy());                                                            \
    }                                                                                                                      \
                                                                                                                           \
    template <class T1, class T2>                                                                                          \
    inline typename boost::math::tools::promote_args<T1, T2>::type gamma_p_inv(T1 a, T2 p)                                 \
    {                                                                                                                      \
        return boost::math::gamma_p_inv(a, p, Policy());                                                                   \
    }                                                                                                                      \
                                                                                                                           \
    template <class T1, class T2>                                                                                          \
    inline typename boost::math::tools::promote_args<T1, T2>::type gamma_p_inva(T1 a, T2 p)                                \
    {                                                                                                                      \
        return boost::math::gamma_p_inva(a, p, Policy());                                                                  \
    }                                                                                                                      \
                                                                                                                           \
    template <class T1, class T2>                                                                                          \
    inline typename boost::math::tools::promote_args<T1, T2>::type gamma_q_inv(T1 a, T2 q)                                 \
    {                                                                                                                      \
        return boost::math::gamma_q_inv(a, q, Policy());                                                                   \
    }                                                                                                                      \
                                                                                                                           \
    template <class T1, class T2>                                                                                          \
    inline typename boost::math::tools::promote_args<T1, T2>::type gamma_q_inva(T1 a, T2 q)                                \
    {                                                                                                                      \
    ...
    {                                                                                                                      \
        return boost::math::powm1(a, z, Policy());                                                                         \
                                                                                                                           ...
                                                                                                                           \
    template <class T>                                                                                                     \
    inline typename boost::math::tools::promote_args<T>::type sqrt1pm1(const T &val)                                       \
    {                                                                                                                      \
    ...
    {                                                                                                                      \
        return boost::math::float_distance(a, b, Policy());                                                                \
                                                                                                                           ...
                                                                                                                           \
    template <class RT1, class RT2>                                                                                        \
    inline typename boost::math::tools::promote_args<RT1, RT2>::type owens_t(RT1 a, RT2 z)                                 \
    {                                                                                                                      \
