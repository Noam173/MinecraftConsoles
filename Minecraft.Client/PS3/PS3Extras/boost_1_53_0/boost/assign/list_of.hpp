...
class converter
{
  ...
  public:
    ...
    Container convert_to_container() const
    {
        ...
        BOOST_STATIC_CONSTANT(bool, is_array_flag = sizeof(assign_detail::assign_is_array(c)) == sizeof(type_traits::yes_type));
...
template <class T>
class generic_list : public converter<generic_list<BOOST_DEDUCED_TYPENAME assign_decay<T>::type>,
...
struct static_generic_list : public converter<static_generic_list<T, N>, assign_reference<T> *>
{
  private:
  ...
  public:
    ...
    static_generic_list(T &r) : current_(1)
    {
        refs_[0] = r;
    }
