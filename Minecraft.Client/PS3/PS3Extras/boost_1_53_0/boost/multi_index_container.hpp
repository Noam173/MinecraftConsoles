...
class multi_index_container : private ::boost::base_from_member<
                              ...
                              BOOST_MULTI_INDEX_PRIVATE_IF_MEMBER_TEMPLATE_FRIENDS detail::header_holder<
                                  typename detail::prevent_eti<
                                      ...
                                      typename boost::detail::allocator::rebind_to<
                                          Allocator,
                                          typename detail::multi_index_node_type<
                                              Value, IndexSpecifierList, Allocator>::type>::type>::type::pointer,
...
#pragma parse_mfunc_templ off
  ...
  public:
    ...
    struct index_type_list : super_index_type_list
    {
        ...
        typedef mpl::v_iter<
            type,
            mpl::size<super_index_type_list>::value>
            end;
    };
#else
    ...
    explicit multi_index_container(const allocator_type &al) : bfm_allocator(al),
    ...
    multi_index_container(
        const multi_index_container<Value, IndexSpecifierList, Allocator> &x) : bfm_allocator(x.bfm_allocator::member),
                                                                                bfm_header(),
                                                                                super(x),
                                                                                node_count(0)
    {
    ...
    BOOST_MULTI_INDEX_PROTECTED_IF_MEMBER_TEMPLATE_FRIENDS : typedef typename super::copy_map_type copy_map_type;
        ...
        BOOST_APPEND_EXPLICIT_TEMPLATE_NON_TYPE(int, N))
{
    ...
    BOOST_STATIC_ASSERT(N >= 0 &&
                        N <
                            mpl::size<
                                BOOST_DEDUCED_TYPENAME multi_index_type::index_type_list>::type::value);
...
struct nth_index_const_iterator
{
    typedef typename detail::prevent_eti<
        nth_index<MultiIndexContainer, N>,
        typename nth_index<MultiIndexContainer, N>::type>::type::const_iterator type;
};
