...
class const_sub_array : public boost::detail::multi_array::multi_array_impl_base<T, NumDims>
{
  ...
  public:
    ...
    const_sub_array(const const_sub_array<T, NumDims, OPtr> &rhs) : base_(rhs.base_), extents_(rhs.extents_), strides_(rhs.strides_),
  ...
  public: // Should be protected
    ...
    const_sub_array(TPtr base,
                    ...
                    const index *strides,
                    const index *index_base) : base_(base), extents_(extents), strides_(strides),
...
class sub_array : public const_sub_array<T, NumDims, T *>
{
  ...
  public: // should be private
    ...
    sub_array(T *base,
              const size_type *extents,
              const index *strides,
              const index *index_base) : super_type(base, extents, strides, index_base)
    {
    }
};
