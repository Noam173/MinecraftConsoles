...
struct value_accessor_generator
{
    ...
    typedef typename mpl::eval_if_c<(dimensionality == 1),
...
struct associated_types
    : mpl::aux::msvc_eti_base<
          typename value_accessor_generator<T, NumDims>::type>::type
{
};
...
class multi_array_impl_base
    ...
    public mpl::aux::msvc_eti_base<
        typename value_accessor_generator<T, mpl::size_t<NumDims>>::type>::type
#else
