...
class const_multi_array_view : public boost::detail::multi_array::multi_array_impl_base<T, NumDims>
{
  ...
  public:
    ...
    const_multi_array_view(const const_multi_array_view<T, NumDims, OPtr> &other) : base_(other.base_), origin_offset_(other.origin_offset_),
    ...
    template <typename OPtr>
    bool operator==(const const_multi_array_view<T, NumDims, OPtr> &rhs)
        const
    {
  ...
  public: // should be protected
    ...
    explicit const_multi_array_view(TPtr base,
                                    ...
                                    const boost::array<Index, NumDims> &strides) : base_(base), origin_offset_(0)
    {
...
class multi_array_view : public const_multi_array_view<T, NumDims, T *>
{
  ...
  public: // should be private
    ...
    explicit multi_array_view(T *base,
                              const ExtentList &extents,
                              const boost::array<Index, NumDims> &strides) : super_type(base, extents, strides)
    {
    }
};
