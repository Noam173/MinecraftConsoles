...
struct map_codomain_compare
{
    static int apply(typename LeftT::const_iterator &left_, typename RightT::const_iterator &right_)
    {
        ...
        return if_<
            ...
            atomic_codomain_compare<LeftT, RightT>>::type::apply(left_, right_);
    }
};
  ...
  public:
    ...
    int co_compare(LeftIterT &left, RightIterT &right)
    {
        ...
        return if_<
            ...
            empty_codomain_compare<LeftT, RightT>>::type::apply(left, right);
    }

    int restrict_result(int state)
    {
    ...
    int next_both(LeftIterT &left, RightIterT &right)
    {
        ...
        { // left:  *left . . *joint_     left could be superset
            ...
            else
            {
                ...
                if (joint_ == _left.end() || typename LeftT::key_compare()(key_value<RightT>(right), key_value<LeftT>(joint_)))
                {
                    _result = unrelated;
                    return stop;
                }
        ...
        { // left:             *left   left could be subset
            ...
            else
            {
                ...
                if (joint_ == _right.end() || typename LeftT::key_compare()(key_value<LeftT>(left), key_value<RightT>(joint_)))
                {
                    _result = unrelated;
                    return stop;
                }
