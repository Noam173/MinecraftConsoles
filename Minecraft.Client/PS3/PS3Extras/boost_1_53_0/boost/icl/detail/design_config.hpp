...
#define ICL_COMPARE template <class> \
class
...
#define ICL_COMBINE template <class> \
class
...
#define ICL_SECTION template <class> \
class
...
#define ICL_INTERVAL(itl_compare) template <class, itl_compare> \
class
#define ICL_INTERVAL2(itl_compare) template <class DomT2, itl_compare> \
class
...
//------------------------------------------------------------------------------
#define ICL_ALLOC template <class> \
class
