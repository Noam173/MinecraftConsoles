...
template <class Type>
inline typename enable_if<is_interval<Type>, typename interval_traits<Type>::domain_type>::type
...
template <class Type>
typename enable_if<
    mpl::and_<is_static_right_open<Type>, is_discrete<typename interval_traits<Type>::domain_type>>, Type>::type
...
template <class Type>
typename enable_if<
    mpl::and_<is_static_left_open<Type>, is_discrete<typename interval_traits<Type>::domain_type>>, Type>::type
singleton(const typename interval_traits<Type>::domain_type &value)
{
    // ASSERT: This always creates an interval with exactly one element
    typedef typename interval_traits<Type>::domain_type domain_type;
    typedef typename interval_traits<Type>::domain_compare domain_compare;
    BOOST_ASSERT((numeric_minimum<domain_type, domain_compare, is_numeric<domain_type>::value>::is_less_than(value)));
...
singleton(const typename interval_traits<Type>::domain_type &value)
{
    ...
    return interval_traits<Type>::construct(domain_prior<Type>(value), domain_next<Type>(value));
}
...
template <class Type>
typename enable_if<
    mpl::and_<is_static_right_open<Type>, boost::detail::is_incrementable<typename interval_traits<Type>::domain_type>>, Type>::type
...
template <class Type>
typename enable_if<
    mpl::and_<is_static_left_open<Type>, boost::detail::is_incrementable<typename interval_traits<Type>::domain_type>>, Type>::type
unit_trail(const typename interval_traits<Type>::domain_type &value)
{
    typedef typename interval_traits<Type>::domain_type domain_type;
    typedef typename interval_traits<Type>::domain_compare domain_compare;
...
template <class Type>
typename enable_if<
    mpl::and_<is_static_open<Type>, is_discrete<typename interval_traits<Type>::domain_type>>, Type>::type
unit_trail(const typename interval_traits<Type>::domain_type &value)
{
    typedef typename interval_traits<Type>::domain_type domain_type;
    typedef typename interval_traits<Type>::domain_compare domain_compare;
...
template <class Type>
typename enable_if<
    mpl::and_<is_static_closed<Type>, is_discrete<typename interval_traits<Type>::domain_type>>, Type>::type
unit_trail(const typename interval_traits<Type>::domain_type &value)
{
    return interval_traits<Type>::construct(value, value);
}
     ...
     const typename interval_traits<Type>::domain_type &right)
{
    ...
    if (interval_traits<Type>::domain_compare()(left, right))
    {
        BOOST_ASSERT((numeric_minimum<domain_type, domain_compare, is_numeric<domain_type>::value>::is_less_than(left)));
        return construct<Type>(domain_prior<Type>(left), right);
    }
    else
    {
        BOOST_ASSERT((numeric_minimum<domain_type, domain_compare, is_numeric<domain_type>::value>::is_less_than(right)));
...
//- first ----------------------------------------------------------------------
template <class Type>
inline typename enable_if<mpl::or_<is_static_right_open<Type>, is_static_closed<Type>>, typename interval_traits<Type>::domain_type>::type
...
template <class Type>
inline typename enable_if<mpl::and_<mpl::or_<is_static_left_open<Type>, is_static_open<Type>>, is_discrete<typename interval_traits<Type>::domain_type>>, typename interval_traits<Type>::domain_type>::type
first(const Type &object)
{
...
first(const Type &object)
{
    return is_left_closed(object.bounds()) ? lower(object) : domain_next<Type>(lower(object));
}

//- last -----------------------------------------------------------------------
template <class Type>
inline typename enable_if<mpl::or_<is_static_left_open<Type>, is_static_closed<Type>>, typename interval_traits<Type>::domain_type>::type
...
template <class Type>
inline typename enable_if<mpl::and_<mpl::or_<is_static_right_open<Type>, is_static_open<Type>>, is_discrete<typename interval_traits<Type>::domain_type>>, typename interval_traits<Type>::domain_type>::type
last(const Type &object)
{
    typedef typename interval_traits<Type>::domain_type domain_type;
    typedef typename interval_traits<Type>::domain_compare domain_compare;
    BOOST_ASSERT((numeric_minimum<domain_type, domain_compare, is_numeric<domain_type>::value>::is_less_than(upper(object))));
...
last(const Type &object)
{
    typedef typename interval_traits<Type>::domain_type domain_type;
    typedef typename interval_traits<Type>::domain_compare domain_compare;
    BOOST_ASSERT((numeric_minimum<domain_type, domain_compare, is_numeric<domain_type>::value>::is_less_than_or(upper(object), is_right_closed(object.bounds()))));
    return is_right_closed(object.bounds()) ? upper(object) : domain_prior<Type>(upper(object));
}

//- last_next ------------------------------------------------------------------
template <class Type>
inline typename enable_if<mpl::and_<mpl::or_<is_static_left_open<Type>, is_static_closed<Type>>, is_discrete<typename interval_traits<Type>::domain_type>>, typename interval_traits<Type>::domain_type>::type
...
last_next(const Type &object)
{
    return is_right_closed(object.bounds()) ? domain_next<Type>(upper(object)) : upper(object);
}
...
{
    return typename Type::bounded_domain_type(lower(object), object.bounds().left());
}
...
is_empty(const Type &object)
{
    return domain_less_equal<Type>(upper(object), lower(object)) || domain_less_equal<Type>(upper(object), domain_next<Type>(lower(object)));
}
...
is_empty(const Type &object)
{
    return domain_less<Type>(upper(object), lower(object)) || (domain_equal<Type>(upper(object), lower(object)) && object.bounds() != interval_bounds::closed());
}
...
{
    BOOST_ASSERT(!(icl::is_empty(left) || icl::is_empty(right)));
    return domain_less<Type>(upper(left), lower(right)) || (domain_equal<Type>(upper(left), lower(right)) && inner_bounds(left, right) != interval_bounds::open());
}
...
{
    return domain_less_equal<Type>(icl::first(super), element) && domain_less_equal<Type>(element, icl::last(super));
}
...
contains(const Type &super, const typename interval_traits<Type>::domain_type &element)
{
    return domain_less<Type>(icl::lower(super), element) && domain_less_equal<Type>(element, icl::upper(super));
}
...
contains(const Type &super, const typename interval_traits<Type>::domain_type &element)
{
    return domain_less_equal<Type>(icl::lower(super), element) && domain_less<Type>(element, icl::upper(super));
}
...
exclusive_less(const Type &left, const Type &right)
{
    return icl::is_empty(left) || icl::is_empty(right) || domain_less_equal<Type>(upper(left), lower(right));
}
...
exclusive_less(const Type &left, const Type &right)
{
    return icl::is_empty(left) || icl::is_empty(right) || domain_less<Type>(last(left), first(right));
}
...
exclusive_less(const Type &left, const Type &right)
{
    return icl::is_empty(left) || icl::is_empty(right) || domain_less<Type>(upper(left), lower(right)) || (domain_equal<Type>(upper(left), lower(right)) && inner_bounds(left, right) != interval_bounds::open());
}
...
lower_equal(const Type &left, const Type &right)
{
    return (left.bounds().left() == right.bounds().left()) && domain_equal<Type>(lower(left), lower(right));
}
...
upper_equal(const Type &left, const Type &right)
{
    return (left.bounds().right() == right.bounds().right()) && domain_equal<Type>(upper(left), upper(right));
}
...
{
    return (icl::is_empty(left) && icl::is_empty(right)) || (lower_equal(left, right) && upper_equal(left, right));
}
...
touches(const Type &left, const Type &right)
{
    return is_complementary(inner_bounds(left, right)) && domain_equal<Type>(upper(left), lower(right));
}
...
cardinality(const Type &object)
{
    ...
    else if (object.bounds() == interval_bounds::closed() && domain_equal<Type>(lower(object), upper(object)))
    {
...
left_subtract(Type right, const Type &left_minuend)
{
    ...
    return dynamic_interval_traits<Type>::construct_bounded(reverse_bounded_upper(left_minuend), bounded_upper(right));
}
...
right_subtract(Type left, const Type &right_minuend)
{
    ...
    return dynamic_interval_traits<Type>::construct_bounded(bounded_lower(left), reverse_bounded_lower(right_minuend));
}
...
{
    return !(icl::is_empty(left) || icl::is_empty(right) || exclusive_less(left, right) || exclusive_less(right, left));
}
...
template <class Type>
typename boost::
    enable_if<mpl::and_<is_interval<Type>, has_difference<typename interval_traits<Type>::domain_type>, is_discrete<typename interval_traits<Type>::domain_type>>, typename difference_type_of<interval_traits<Type>>::type>::type
...
template <class Type>
typename boost::
    enable_if<mpl::and_<is_interval<Type>, has_difference<typename interval_traits<Type>::domain_type>, is_continuous<typename interval_traits<Type>::domain_type>>, typename difference_type_of<interval_traits<Type>>::type>::type
    distance(const Type &x1, const Type &x2)
{
    typedef typename difference_type_of<interval_traits<Type>>::type DiffT;
...
template <class Type>
typename boost::
    enable_if<mpl::or_<is_static_left_open<Type>, is_static_open<Type>>, std::string>::type
...
template <class Type>
typename boost::
    enable_if<mpl::or_<is_static_right_open<Type>, is_static_closed<Type>>, std::string>::type
    left_bracket(const Type &)
{
    return "[";
}
...
template <class Type>
typename boost::
    enable_if<mpl::or_<is_static_right_open<Type>, is_static_open<Type>>, std::string>::type
...
template <class Type>
typename boost::
    enable_if<mpl::or_<is_static_left_open<Type>, is_static_closed<Type>>, std::string>::type
    right_bracket(const Type &)
{
    return "]";
}
