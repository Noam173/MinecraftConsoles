                             ...
                             DomainT, CodomainT, Traits, Compare, Combine, Section, Interval, Alloc>
{
  ...
  public:
    ...
    explicit interval_map(const interval_base_map<SubType, DomainT, CodomainT,
    ...
    template <class SubType>
    interval_map &operator=(const interval_base_map<SubType, DomainT, CodomainT,
                                                    Traits, Compare, Combine, Section, Interval, Alloc> &src)
    {
        this->assign(src);
        return *this;
...
struct type_to_string<icl::interval_map<DomainT, CodomainT, Traits, Compare, Combine, Section, Interval, Alloc>>
{
    ...
    {
        return "itv_map<" + type_to_string<DomainT>::apply() + "," + type_to_string<CodomainT>::apply() + "," + type_to_string<Traits>::apply() + ">";
    }
};
