...
{
    typedef typename get_element_type<Type, has_element_type<Type>::value>::type type;
};
...
{
    typedef typename get_value_type<Type, has_value_type<Type>::value>::type type;
};
...
struct key_type_of
{
    typedef typename get_key_type<Type, has_key_type<Type>::value>::type type;
};
