...
struct has_max_infinity
{
    ...
    BOOST_STATIC_CONSTANT(bool,
                          value = (type_traits::ice_and<is_numeric<Type>::value, type_traits::ice_not<std::numeric_limits<Type>::has_infinity>::value>::value));
};
...
struct numeric_infinity
{
    ...
    static Type value()
    {
        return get_numeric_infinity<Type, has_std_infinity<Type>::value, has_max_infinity<Type>::value>::value();
    }
};
...
struct infinity
{
    ...
    static Type value()
    {
        return get_infinity<Type, is_numeric<Type>::value, has_rep_type<Type>::value, has_size_type<Type>::value, has_difference_type<Type>::value>::value();
    }
};
