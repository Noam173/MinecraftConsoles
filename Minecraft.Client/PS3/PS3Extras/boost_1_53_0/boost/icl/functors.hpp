...
{
    inline static Type identity_element()
    {
        return boost::icl::identity_element<Type>::value();
    }
};
    ...
    : public std::binary_function<Type &, const Type &, void>
{
    inline static Type identity_element()
    {
        return boost::icl::unit_element<Type>::value();
    }
};
...
template <>
inline std::string unary_template_to_string<inplace_plus>::apply()
{
    return "+=";
}
...
template <>
inline std::string unary_template_to_string<inplace_et>::apply()
{
    return "&=";
}
...
template <>
inline std::string unary_template_to_string<inplace_star>::apply()
{
    return "*=";
}
...
template <>
inline std::string unary_template_to_string<inplace_max>::apply()
{
    return "max=";
}
...
template <>
inline std::string unary_template_to_string<inplace_min>::apply()
{
    return "min=";
}
...
struct inverse
{
    typedef typename remove_reference<typename Functor::first_argument_type>::type argument_type;
...
struct conversion
{
    ...
    typedef typename remove_const<
        typename remove_reference<typename Combiner::first_argument_type>::type>::type
        argument_type;
...
template <class Combiner>
struct version : public conversion<Combiner>
{
