...
template <typename ColorBase, int K>
struct kth_element_reference_type<const ColorBase, K> : public kth_element_reference_type<ColorBase, K>
{
};
template <typename ColorBase, int K>
struct kth_element_const_reference_type;
template <typename ColorBase, int K>
struct kth_element_const_reference_type<const ColorBase, K> : public kth_element_const_reference_type<ColorBase, K>
{
};
...
struct mapping_transform
    : public mpl::at<typename SrcLayout::channel_mapping_t,
                     typename detail::type_to_index<typename DstLayout::channel_mapping_t, mpl::integral_c<int, K>>::type>::type
{
};
...
struct homogeneous_color_base<Element, Layout, 1>
{
  ...
  public:
    ...
    typename element_reference_type<homogeneous_color_base>::type at(mpl::int_<0>)
    {
        return _v0;
    }
    typename element_const_reference_type<homogeneous_color_base>::type at(mpl::int_<0>) const
    {
        return _v0;
    }
    ...
    homogeneous_color_base(const homogeneous_color_base<E2, L2, 1> &c) : _v0(at_c<0>(c))
    {
    }
};
...
struct homogeneous_color_base<Element, Layout, 2>
{
  ...
  public:
    ...
    typename element_reference_type<homogeneous_color_base>::type at(mpl::int_<1>)
    {
        return _v1;
    }
    typename element_const_reference_type<homogeneous_color_base>::type at(mpl::int_<1>) const
    {
        return _v1;
    }
    ...
    template <typename E2, typename L2>
    homogeneous_color_base(const homogeneous_color_base<E2, L2, 2> &c) : _v0(at_c<mapping_transform<Layout, L2, 0>::value>(c)),
    ...
    template <typename E2, typename L2>
    homogeneous_color_base(homogeneous_color_base<E2, L2, 2> &c) : _v0(at_c<mapping_transform<Layout, L2, 0>::value>(c)),
                                                                   _v1(at_c<mapping_transform<Layout, L2, 1>::value>(c))
    {
    }
    ...
    template <typename P>
    homogeneous_color_base(P *p, bool) : _v0(&semantic_at_c<0>(*p)),
...
struct homogeneous_color_base<Element, Layout, 3>
{
  ...
  public:
    ...
    typename element_reference_type<homogeneous_color_base>::type at(mpl::int_<2>)
    {
        return _v2;
    }
    typename element_const_reference_type<homogeneous_color_base>::type at(mpl::int_<2>) const
    {
        return _v2;
    }
    ...
    template <typename E2, typename L2>
    homogeneous_color_base(const homogeneous_color_base<E2, L2, 3> &c) : _v0(gil::at_c<mapping_transform<Layout, L2, 0>::value>(c)),
    ...
    // Support for l-value reference proxy copy construction
    template <typename E2, typename L2>
    homogeneous_color_base(homogeneous_color_base<E2, L2, 3> &c) : _v0(gil::at_c<mapping_transform<Layout, L2, 0>::value>(c)),
                                                                   _v1(gil::at_c<mapping_transform<Layout, L2, 1>::value>(c)),
                                                                   _v2(gil::at_c<mapping_transform<Layout, L2, 2>::value>(c))
    {
    }
...
struct homogeneous_color_base<Element, Layout, 4>
{
  ...
  public:
    ...
    typename element_reference_type<homogeneous_color_base>::type at(mpl::int_<3>)
    {
        return _v3;
    }
    typename element_const_reference_type<homogeneous_color_base>::type at(mpl::int_<3>) const
    {
        return _v3;
    }
    homogeneous_color_base()
    ...
    template <typename E2, typename L2>
    homogeneous_color_base(const homogeneous_color_base<E2, L2, 4> &c) : _v0(at_c<mapping_transform<Layout, L2, 0>::value>(c)),
                                                                         _v1(at_c<mapping_transform<Layout, L2, 1>::value>(c)),
    ...
    // Support for l-value reference proxy copy construction
    template <typename E2, typename L2>
    homogeneous_color_base(homogeneous_color_base<E2, L2, 4> &c) : _v0(at_c<mapping_transform<Layout, L2, 0>::value>(c)),
                                                                   _v1(at_c<mapping_transform<Layout, L2, 1>::value>(c)),
                                                                   _v2(at_c<mapping_transform<Layout, L2, 2>::value>(c)),
                                                                   _v3(at_c<mapping_transform<Layout, L2, 3>::value>(c))
    {
...
struct homogeneous_color_base<Element, Layout, 5>
{
  ...
  public:
    ...
    typename element_reference_type<homogeneous_color_base>::type at(mpl::int_<4>)
    {
        return _v4;
    }
    typename element_const_reference_type<homogeneous_color_base>::type at(mpl::int_<4>) const
    {
        return _v4;
    }
    homogeneous_color_base()
    ...
    template <typename E2, typename L2>
    homogeneous_color_base(const homogeneous_color_base<E2, L2, 5> &c) : _v0(at_c<mapping_transform<Layout, L2, 0>::value>(c)),
                                                                         _v1(at_c<mapping_transform<Layout, L2, 1>::value>(c)),
                                                                         _v2(at_c<mapping_transform<Layout, L2, 2>::value>(c)),
                                                                         _v3(at_c<mapping_transform<Layout, L2, 3>::value>(c)),
    ...
    // Support for l-value reference proxy copy construction
    template <typename E2, typename L2>
    homogeneous_color_base(homogeneous_color_base<E2, L2, 5> &c) : _v0(at_c<mapping_transform<Layout, L2, 0>::value>(c)),
                                                                   _v1(at_c<mapping_transform<Layout, L2, 1>::value>(c)),
                                                                   _v2(at_c<mapping_transform<Layout, L2, 2>::value>(c)),
                                                                   _v3(at_c<mapping_transform<Layout, L2, 3>::value>(c)),
                                                                   _v4(at_c<mapping_transform<Layout, L2, 4>::value>(c))
...
inline void swap(detail::homogeneous_color_base<E, L, N> &x, detail::homogeneous_color_base<E, L, N> &y)
{
