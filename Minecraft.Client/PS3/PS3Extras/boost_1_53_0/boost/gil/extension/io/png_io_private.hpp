...
class png_reader : public file_mgr
{
  ...
  public:
    png_reader(FILE *file) : file_mgr(file)
    {
        init();
    }
    png_reader(const char *filename) : file_mgr(filename, "rb")
    {
        init();
    }
...
class png_writer : public file_mgr
{
  ...
  public:
    png_writer(FILE *file) : file_mgr(file)
    {
        init();
    }
    png_writer(const char *filename) : file_mgr(filename, "wb")
    {
        init();
    }
