...
struct views_get_nthchannel_type : public mpl::transform<Views, get_nthchannel_type<mpl::_1>>
{
};
} // namespace detail
...
struct views_get_ccv_type : public mpl::transform<Views, get_ccv_type<mpl::_1, DstP, CC>>
{
};
} // namespace detail
