...
template <typename Images>
struct images_get_const_views_t : public mpl::transform<Images, get_const_view_t<mpl::_1>>
{
};
...
struct any_image_get_const_view
{
    ...
    template <typename Image>
    result_type operator()(const Image &img) const
    {
...
class any_image : public variant<ImageTypes>
{
  ...
  public:
    ...
    template <typename T>
    explicit any_image(const T &obj) : parent_t(obj)
    {
    }
    template <typename T>
