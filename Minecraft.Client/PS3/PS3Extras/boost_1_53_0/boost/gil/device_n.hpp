...
template <>
struct devicen_t<1> : public mpl::vector1<devicen_color_t<0>>
{
};
...
/// \ingroup ColorSpaceModel
template <>
struct devicen_t<2> : public mpl::vector2<devicen_color_t<0>, devicen_color_t<1>>
{
};
...
/// \ingroup ColorSpaceModel
template <>
struct devicen_t<3> : public mpl::vector3<devicen_color_t<0>, devicen_color_t<1>, devicen_color_t<2>>
{
};
...
/// \ingroup ColorSpaceModel
template <>
struct devicen_t<4> : public mpl::vector4<devicen_color_t<0>, devicen_color_t<1>, devicen_color_t<2>, devicen_color_t<3>>
{
};
...
/// \ingroup ColorSpaceModel
template <>
struct devicen_t<5> : public mpl::vector5<devicen_color_t<0>, devicen_color_t<1>, devicen_color_t<2>, devicen_color_t<3>, devicen_color_t<4>>
{
};
...
/// \ingroup LayoutModel
template <int N>
struct devicen_layout_t : public layout<devicen_t<N>>
{
};
