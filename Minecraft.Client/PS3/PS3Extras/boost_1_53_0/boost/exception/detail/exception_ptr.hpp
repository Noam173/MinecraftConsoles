...
struct
    bad_exception_ : boost::exception,
                     std::bad_exception
{
...
get_static_exception_object()
{
    ...
    c << throw_function(BOOST_CURRENT_FUNCTION) << throw_file(__FILE__) << throw_line(__LINE__);
...
#endif
class
    unknown_exception : public boost::exception,
...
template <class T>
class
    current_exception_std_exception_wrapper : public T,
                                              public boost::exception
{
  public:
    ...
    current_exception_std_exception_wrapper(T const &e1, boost::exception const &e2) : T(e1),
                                                                                       boost::exception(e2)
    {
        add_original_type(e1);
    }
