...
#if (defined(_WIN32) || defined(_WIN64) || defined(_WINCE)) && !defined(__GNUC__) && !(defined(__BORLANDC__) && (__BORLANDC__ >= 0x600)) && !(defined(__MWERKS__) && (__MWERKS__ <= 0x3003))
...
template <
    typename BidiIter, typename RegexTraits = regex_traits<typename iterator_value<BidiIter>::type>, typename CompilerTraits = compiler_traits<RegexTraits>>
