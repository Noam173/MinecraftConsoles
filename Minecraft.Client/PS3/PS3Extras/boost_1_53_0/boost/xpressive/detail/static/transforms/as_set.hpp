...
struct ListSet
    : or_<
          when<
              comma<ListSet<Char>, CharLiteral<Char>>, make<mpl::next<call<ListSet<Char>(_left)>>> // TODO make a custom transform for this...
              >,
          when<
              assign<detail::set_initializer_type, CharLiteral<Char>>, make<mpl::int_<1>>>>
{
};
...
struct as_list_set_matcher : proto::transform<as_list_set_matcher<Char, Callable>>
{
    ...
    struct impl : proto::transform_impl<Expr, State, Data>
    {
        ...
        typedef detail::set_matcher<
            typename data_type::traits_type, typename ListSet<Char>::template impl<Expr, State, Data>::result_type>
            result_type;
...
struct merge_charset
{
    ...
    merge_charset(CharSet &charset, Data &data)
        : charset_(charset), visitor_(data)
    {
    }
    ...
    void call_(Expr const &expr, Tag) const
    {
        this->set_(
            typename Grammar::template impl<Expr const &, detail::end_xpression, Data &>()(
                expr, detail::end_xpression(), this->visitor_));
    }
...
struct as_set_matcher : proto::transform<as_set_matcher<Grammar, Callable>>
{
    ...
    struct impl : proto::transform_impl<Expr, State, Data>
    {
        ...
        typedef
            typename mpl::if_c<
                detail::is_narrow_char<char_type>::value, detail::basic_chset<char_type>, detail::compound_charset<typename data_type::traits_type>>::type
                charset_type;

        typedef detail::charset_matcher<
            typename data_type::traits_type, typename data_type::icase_type, charset_type>
            result_type;
