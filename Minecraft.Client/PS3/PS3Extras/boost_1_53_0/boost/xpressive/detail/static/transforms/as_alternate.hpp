    ...
    struct impl : proto::transform_impl<Expr, State, Data>
    {
        typedef detail::alternates_list<
            typename Grammar::template impl<
                Expr, detail::alternate_end_xpression, Data>::result_type,
            State>
            result_type;
            ...
            typename impl::expr_param expr, typename impl::state_param state, typename impl::data_param data) const
        {
            return result_type(
                typename Grammar::template impl<Expr, detail::alternate_end_xpression, Data>()(
                    expr, detail::alternate_end_xpression(), data),
                state);
        }
    };
};
...
struct as_alternate_matcher : proto::transform<as_alternate_matcher<Grammar, Callable>>
{
    ...
    struct impl : proto::transform_impl<Expr, State, Data>
    {
        ...
        typedef detail::alternate_matcher<
            typename Grammar::template impl<Expr, State, Data>::result_type, typename data_type::traits_type>
            result_type;
