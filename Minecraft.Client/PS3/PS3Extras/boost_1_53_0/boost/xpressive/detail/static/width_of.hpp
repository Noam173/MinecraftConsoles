...
struct width_of<Expr, Char, proto::tag::shift_right>
    : add_widths<
          width_of<typename remove_reference<typename Expr::proto_child0>::type::proto_base_expr, Char>::value, width_of<typename remove_reference<typename Expr::proto_child1>::type::proto_base_expr, Char>::value>
{
};
...
struct width_of<Expr, Char, proto::tag::assign>
    : width_of_assign<
          Expr, Char, typename proto::result_of::value<typename remove_reference<typename Expr::proto_child0>::type::proto_base_expr>::type>
{
};
...
struct width_of<Expr, Char, generic_quant_tag<Count, Count>>
    : mpl::if_c<
          mpl::equal_to<unknown_width, width_of<typename remove_reference<typename Expr::proto_child0>::type::proto_base_expr, Char>>::value, unknown_width, mpl::times<width_of<typename remove_reference<typename Expr::proto_child0>::type::proto_base_expr, Char>, mpl::size_t<Count>>>::type
{
};
