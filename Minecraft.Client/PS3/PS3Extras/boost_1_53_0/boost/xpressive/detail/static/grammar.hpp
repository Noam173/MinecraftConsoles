...
#define BOOST_XPRESSIVE_CHECK_REGEX(Expr, Char) \
    BOOST_MPL_ASSERT((                          \
        typename boost::mpl::if_c<              \
            boost::xpressive::is_valid_regex<Expr, Char>::value, boost::mpl::true_, boost::xpressive::INVALID_REGULAR_EXPRESSION>::type));
...
struct as_repeat
    : if_<
          make<detail::use_simple_repeat<_child, Char>>, as_simple_quantifier<Gram, Greedy>, as_default_quantifier<Greedy>>
{
};
...
struct InvertibleCases
{
    ...
    struct case_<detail::lookahead_tag, Dummy>
        : when<
              unary_expr<detail::lookahead_tag, Gram>, as_lookahead<Gram>>
    {
    };
    ...
    struct case_<detail::lookbehind_tag, Dummy>
        : when<
              unary_expr<detail::lookbehind_tag, Gram>, as_lookbehind<Gram>>
    {
    };
    ...
    struct case_<tag::terminal, Dummy>
        : when<
              or_<
                  CharLiteral<Char>, terminal<detail::posix_charset_placeholder>, terminal<detail::range_placeholder<_>>, terminal<detail::logical_newline_placeholder>, terminal<detail::assert_word_placeholder<detail::word_boundary<mpl::true_>>>>,
              as_matcher>
    {
    };
};
...
struct Cases
{
    ...
    struct case_<tag::shift_right, Dummy>
        : when<
              shift_right<Gram, Gram>, reverse_fold<_, _state, Gram>>
    {
    };
    ...
    struct case_<tag::bitwise_or, Dummy>
        : when<
              bitwise_or<Gram, Gram>, in_sequence<
    ...
    struct case_<optional_tag<Greedy>, Dummy>
        : when<
              unary_expr<optional_tag<Greedy>, Gram>, in_sequence<call<as_optional<Gram, Greedy>(_child)>>>
    {
    };
    ...
    struct case_<tag::dereference, Dummy>
        : when<
              dereference<Gram>, call<Gram(as_repeat<Char, Gram, mpl::true_>)>>
    {
    };
    ...
    struct case_<tag::unary_plus, Dummy>
        : when<
              unary_plus<Gram>, call<Gram(as_repeat<Char, Gram, mpl::true_>)>>
    {
    };
    ...
    struct case_<tag::logical_not, Dummy>
        : when<
              logical_not<Gram>, call<Gram(as_repeat<Char, Gram, mpl::true_>)>>
    {
    };
    ...
    struct case_<detail::generic_quant_tag<Min, Max>, Dummy>
        : when<
              unary_expr<detail::generic_quant_tag<Min, Max>, Gram>, call<Gram(as_repeat<Char, Gram, mpl::true_>)>>
    {
    };
    ...
    struct case_<tag::negate, Dummy>
        : when<
              negate<switch_<NonGreedyRepeatCases<Gram>>>, call<Gram(call<as_repeat<Char, Gram, mpl::false_>(_child)>)>>
    {
    };
    ...
    struct case_<tag::complement, Dummy>
        : when<
              complement<switch_<InvertibleCases<Char, Gram>>>, in_sequence<call<as_inverse(call<switch_<InvertibleCases<Char, Gram>>(_child)>)>>>
    {
    };
    ...
    struct case_<detail::lookahead_tag, Dummy>
        : when<
              unary_expr<detail::lookahead_tag, Gram>, in_sequence<as_lookahead<Gram>>>
    {
    };
    ...
    struct case_<detail::lookbehind_tag, Dummy>
        : when<
              unary_expr<detail::lookbehind_tag, Gram>, in_sequence<as_lookbehind<Gram>>>
    {
    };
    ...
    struct case_<detail::keeper_tag, Dummy>
        : when<
              unary_expr<detail::keeper_tag, Gram>, in_sequence<as_keeper<Gram>>>
    {
    };
    ...
    struct case_<tag::assign, Dummy>
        : or_<
              when<assign<detail::basic_mark_tag, Gram>, call<Gram(as_marker)>>, when<ListSet<Char>, in_sequence<as_list_set_matcher<Char>>>>
    {
    };
    ...
    struct case_<tag::subscript, Dummy>
        : or_<
              when<subscript<detail::set_initializer_type, Gram>, in_sequence<call<as_set_matcher<Gram>(_right)>>>, when<subscript<ActionableGrammar<Char>, _>, call<ActionableGrammar<Char>(as_action)>>>
    {
    };
};
...
struct ActionableCases
{
    ...
    struct case_<proto::tag::assign, Dummy>
        : or_<
              typename Cases<Char, Gram>::template case_<proto::tag::assign>, when<proto::assign<terminal<detail::attribute_placeholder<_>>, _>, in_sequence<as_attr_matcher>>>
    {
    };
};
