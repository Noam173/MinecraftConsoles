...
struct as_simple_quantifier : proto::transform<as_simple_quantifier<Grammar, Greedy, Callable>>
{
    ...
    struct impl : proto::transform_impl<Expr, State, Data>
    {
        ...
        typedef detail::simple_repeat_matcher<xpr_type, Greedy>
            matcher_type;
            ...
            typename impl::expr_param expr, typename impl::state_param, typename impl::data_param data) const
        {
            ...
            matcher_type matcher(
                xpr, (uint_t)min_type<typename expr_type::proto_tag>::value, (uint_t)max_type<typename expr_type::proto_tag>::value, xpr.get_width().value());
    ...
    struct impl : proto::transform_impl<Expr, State, Data>
    {
        ...
        typedef
            typename shift_right<
                terminal<detail::mark_begin_matcher>::type, typename shift_right<
...
struct InsertMark
    : or_<
          when<proto::assign<detail::basic_mark_tag, _>, _>, otherwise<add_hidden_mark>>
{
};
...
struct as_default_quantifier_impl : proto::transform<as_default_quantifier_impl<Greedy, Min, Max>>
{
    ...
    struct impl : proto::transform_impl<Expr, State, Data>
    {
        ...
        typedef
            typename shift_right<
                terminal<detail::repeat_begin_matcher>::type, typename shift_right<
                                                                  marked_sub_type, typename terminal<detail::repeat_end_matcher<Greedy>>::type>::type>::type
                result_type;
...
struct as_default_optional : proto::transform<as_default_optional<Grammar, Greedy, Callable>>
{
    ...
    struct impl : proto::transform_impl<Expr, State, Data>
    {
        typedef detail::alternate_end_xpression
            end_xpr;

        typedef detail::optional_matcher<
            typename Grammar::template impl<Expr, end_xpr, Data>::result_type, Greedy>
            result_type;
...
struct as_mark_optional : proto::transform<as_mark_optional<Grammar, Greedy, Callable>>
{
    ...
    struct impl : proto::transform_impl<Expr, State, Data>
    {
            ...
            typename impl::expr_param expr, typename impl::state_param, typename impl::data_param data) const
        {
            ...
            return result_type(
                typename Grammar::template impl<Expr, end_xpr, Data>()(expr, end_xpr(), data), mark_number);
        }
    };
};
...
struct IsMarkerOrRepeater
    : or_<
          shift_right<terminal<detail::repeat_begin_matcher>, _>, assign<terminal<detail::mark_placeholder>, _>>
{
};
...
struct as_optional
    : or_<
          when<IsMarkerOrRepeater, as_mark_optional<Grammar, Greedy>>, otherwise<as_default_optional<Grammar, Greedy>>>
{
};
...
struct as_default_quantifier : proto::transform<as_default_quantifier<Greedy, Callable>>
{
    ...
    struct impl : proto::transform_impl<Expr, State, Data>
    {
        ...
        typedef as_default_quantifier_impl<
            Greedy, min_type<typename expr_type::proto_tag>::value, max_type<typename expr_type::proto_tag>::value>
            other;
