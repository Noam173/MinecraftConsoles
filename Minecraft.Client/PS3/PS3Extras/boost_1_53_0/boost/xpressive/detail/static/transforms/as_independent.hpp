...
struct IndependentEndXpression
    : or_<
          when<NotHasAction, detail::true_xpression()>, otherwise<detail::independent_end_xpression()>>
{
};
...
struct as_lookahead : proto::transform<as_lookahead<Grammar, Callable>>
{
    ...
    struct impl : proto::transform_impl<Expr, State, Data>
    {
        ...
        typedef detail::lookahead_matcher<xpr_type>
            result_type;
            ...
            typename impl::expr_param expr, typename impl::state_param, typename impl::data_param data) const
        {
            ...
            return result_type(
                typename Grammar::template impl<arg_type, end_xpr_type, Data>()(
                    proto::child(expr), IndependentEndXpression::impl<arg_type, int, int>()(proto::child(expr), i, i), data),
                false);
        }
    };
};
...
struct as_lookbehind : proto::transform<as_lookbehind<Grammar, Callable>>
{
    ...
    struct impl : proto::transform_impl<Expr, State, Data>
    {
        ...
        typedef detail::lookbehind_matcher<xpr_type>
            result_type;
...
struct as_keeper : proto::transform<as_keeper<Grammar, Callable>>
{
    ...
    struct impl : proto::transform_impl<Expr, State, Data>
    {
        ...
        typedef detail::keeper_matcher<xpr_type>
            result_type;
