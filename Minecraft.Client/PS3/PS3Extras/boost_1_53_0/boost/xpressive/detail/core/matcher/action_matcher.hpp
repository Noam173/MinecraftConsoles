...
struct mem_ptr_eval
{
    ...
    typedef
        typename proto::result_of::value<
            typename proto::result_of::child_c<right_type, 0>::type>::type
            function_type;

    typedef fusion::transform_view<
        typename fusion::result_of::push_front<
            typename fusion::result_of::pop_front<right_type>::type const, reference_wrapper<left_type>>::type const,
    ...
    result_type operator()(Expr &expr, Context &ctx) const
    {
        return fusion::invoke<function_type>(
            proto::value(proto::child_c<0>(proto::right(expr))), evaluated_args(
                                                                     fusion::push_front(fusion::pop_front(proto::right(expr)), boost::ref(proto::left(expr))), proto::eval_fun<Context>(ctx)));
    }
};
...
struct mem_ptr_eval<Expr, Context, true>
{
    ...
    typedef typename boost::result_of<
        function_type(typename proto::result_of::eval<left_type, Context>::type)>::type result_type;
        ...
        result_type operator()(Expr &expr, action_context const &ctx) const
        {
            ...
            if (where_ == ctx.args().end())
            {
                BOOST_THROW_EXCEPTION(
                    regex_error(
                        regex_constants::error_badarg, "An argument to an action was unspecified"));
            }
...
struct subreg_transform : proto::transform<subreg_transform>
{
    ...
    struct impl : proto::transform_impl<Expr, State, Data>
    {
        ...
        result_type operator()(
            typename impl::expr_param, typename impl::state_param state, typename impl::data_param data) const
        {
...
struct attr_transform : proto::transform<attr_transform>
{
    ...
    struct impl : proto::transform_impl<Expr, State, Data>
    {
        ...
        result_type operator()(
            typename impl::expr_param, typename impl::state_param state, typename impl::data_param) const
        {
    ...
    struct impl : proto::transform_impl<Expr, State, Data>
    {
        typedef
            typename proto::unary_expr<
                attr_with_default_tag, typename Grammar::template impl<Expr, State, Data>::result_type>::type
                result_type;
...
struct BindActionArgs
    : proto::or_<
          proto::when<proto::terminal<any_matcher>, subreg_transform>, proto::when<proto::terminal<mark_placeholder>, mark_transform>, proto::when<proto::terminal<read_attr<proto::_, proto::_>>, attr_transform>, proto::when<proto::terminal<proto::_>, by_ref_transform>, proto::when<proto::bitwise_or<proto::terminal<read_attr<proto::_, proto::_>>, BindActionArgs>, attr_with_default_transform<proto::bitwise_or<attr_transform, BindActionArgs>>>, proto::otherwise<proto::nary_expr<proto::_, proto::vararg<BindActionArgs>>>>
{
};
    ...
    bool match(match_state<BidiIter> &state, Next const &next) const
    {
        ...
        typedef
            typename boost::result_of<BindActionArgs(
                Actor const &, match_state<BidiIter> &, int const &)>::type
                action_type;
