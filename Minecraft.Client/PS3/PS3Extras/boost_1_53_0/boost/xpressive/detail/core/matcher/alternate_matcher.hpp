...
struct alternate_matcher
    : quant_style<
          Alternates::width != unknown_width::value && Alternates::pure ? quant_fixed_width : quant_variable_width, Alternates::width, Alternates::pure>
{
