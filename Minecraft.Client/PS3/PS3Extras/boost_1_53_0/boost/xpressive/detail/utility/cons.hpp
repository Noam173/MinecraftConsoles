...
struct deref_traits_impl
{
    ...
    typedef typename mpl::eval_if<
        is_const<cons_type>, add_reference<typename add_const<value_type>::type>, add_reference<value_type>>::type
        type;
...
struct next_traits_impl
{
    ...
    typedef cons_iterator<
        typename mpl::eval_if<
            is_const<cons_type>, add_const<cdr_type>, mpl::identity<cdr_type>>::type>
        type;
...
struct cons : sequence_base<cons<Car, Cdr>>
{
    ...
    explicit cons(
        typename call_traits<Car>::param_type car_, typename call_traits<Cdr>::param_type cdr_ = Cdr())
        : car(car_), cdr(cdr_)
    {
    }
