...
inline sequence<BidiIter> make_char_xpression(
    Char ch, regex_constants::syntax_option_type flags, Traits const &tr)
{
...
inline sequence<BidiIter> make_any_xpression(
    regex_constants::syntax_option_type flags, Traits const &tr)
{
...
inline sequence<BidiIter> make_literal_xpression(
    typename Traits::string_type const &literal, regex_constants::syntax_option_type flags, Traits const &tr)
{
...
inline sequence<BidiIter> make_backref_xpression(
    int mark_nbr, regex_constants::syntax_option_type flags, Traits const &tr)
{
    if (0 != (regex_constants::icase_ & flags))
    {
...
inline void merge_charset(
    basic_chset<Char> &basic, compound_charset<Traits> const &compound, Traits const &tr)
{
...
inline sequence<BidiIter> make_charset_xpression(
    compound_charset<Traits> &chset, Traits const &tr, regex_constants::syntax_option_type flags)
{
...
inline sequence<BidiIter> make_posix_charset_xpression(
    typename Traits::char_class_type m, bool no, regex_constants::syntax_option_type // flags
    ,
    Traits const & // traits
)
{
