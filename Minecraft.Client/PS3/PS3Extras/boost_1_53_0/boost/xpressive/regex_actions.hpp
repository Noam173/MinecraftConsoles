...
struct BindArgs
    : proto::function<
          proto::terminal<let_tag>, proto::vararg<
                                        proto::when<
                                            proto::assign<proto::_, proto::_>, proto::call<BindArg(proto::_data, proto::_)>>>>
{
};
...
struct at
{
    ...
    struct result<This(Cont &, Idx)>
        : mpl::if_c<
              is_const<Cont>::value, typename Cont::const_reference, typename Cont::reference>
    {
    };
...
struct front
{
    ...
    struct result<This(Sequence)>
    {
        ...
        typedef
            typename mpl::if_c<
                is_const<sequence_type>::value, typename sequence_type::const_reference, typename sequence_type::reference>::type
                type;
    };
...
struct top
{
    ...
    struct result<This(Sequence)>
    {
        ...
        typedef
            typename mpl::if_c<
                is_const<sequence_type>::value, typename sequence_type::value_type const &, typename sequence_type::value_type &>::type
                type;
    };
...
struct insert
{
    ...
    struct result<This(Cont, Value), void>
    {
        ...
        typedef
            typename mpl::if_c<
                is_iterator, typename cont_type::iterator, std::pair<typename cont_type::iterator, bool>>::type
                type;
    };
...
struct as
{
    ...
    T operator()(sub_match<BidiIter> const &val) const
    {
        ...
        BOOST_MPL_ASSERT_MSG(
            (xpressive::detail::is_char<char_type>::value), CAN_ONLY_CONVERT_FROM_CHARACTER_SEQUENCES, (char_type));
      ...
      proto::terminal<reference_wrapper<T>>::type
{
    ...
    local()
        : detail::value_wrapper<T>(), base_type(base_type::make(boost::ref(detail::value_wrapper<T>::value)))
    {
    }

    explicit local(T const &t)
        : detail::value_wrapper<T>(t), base_type(base_type::make(boost::ref(detail::value_wrapper<T>::value)))
    {
    }
...
struct ReplaceAlgo
    : proto::or_<
          proto::when<
              proto::terminal<mark_placeholder>, op::at(proto::_data, proto::call<mark_nbr(proto::_value)>)>,
          proto::when<
              proto::terminal<any_matcher>, op::at(proto::_data, proto::size_t<0>)>,
          proto::when<
              proto::terminal<reference_wrapper<proto::_>>, op::unwrap_reference(proto::_value)>,
