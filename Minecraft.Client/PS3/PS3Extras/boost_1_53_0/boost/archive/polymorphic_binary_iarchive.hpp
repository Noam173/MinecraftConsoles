...
class polymorphic_binary_iarchive : public detail::polymorphic_iarchive_route<naked_binary_iarchive>
{
  public:
    polymorphic_binary_iarchive(std::istream &is, unsigned int flags = 0) : detail::polymorphic_iarchive_route<naked_binary_iarchive>(is, flags)
    {
    }
