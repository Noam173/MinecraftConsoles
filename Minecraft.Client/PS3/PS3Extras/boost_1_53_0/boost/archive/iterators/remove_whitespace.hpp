          ...
          single_pass_traversal_tag>
{
  ...
  public:
    ...
    filter_iterator(Base start) : super_t(start),
                                  m_full(false)
    {
    }
    filter_iterator()
...
template <class Base>
class remove_whitespace : public filter_iterator<
                              ...
                              Base>
{
  ...
  public:
    ...
    template <class T>
    remove_whitespace(BOOST_PFTO_WRAPPER(T) start) : super_t(Base(BOOST_MAKE_PFTO_WRAPPER(static_cast<T>(start))))
    {
    }
    // intel 7.1 doesn't like default copy constructor
    remove_whitespace(const remove_whitespace &rhs) : super_t(rhs.base_reference())
    {
    }
};
