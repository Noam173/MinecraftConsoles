...
class polymorphic_xml_wiarchive : public detail::polymorphic_iarchive_route<naked_xml_wiarchive>
{
  public:
    polymorphic_xml_wiarchive(std::wistream &is, unsigned int flags = 0) : detail::polymorphic_iarchive_route<naked_xml_wiarchive>(is, flags)
    {
    }
