...
class polymorphic_text_wiarchive : public detail::polymorphic_iarchive_route<naked_text_wiarchive>
{
  public:
    polymorphic_text_wiarchive(std::wistream &is, unsigned int flags = 0) : detail::polymorphic_iarchive_route<naked_text_wiarchive>(is, flags)
    {
    }
