...
class polymorphic_iarchive_impl : public detail::interface_iarchive<polymorphic_iarchive>
{
  ...
  public:
    ...
    virtual void load_object(
        void *t,
        const detail::basic_iserializer &bis) = 0;
...
class polymorphic_iarchive : public polymorphic_iarchive_impl,
