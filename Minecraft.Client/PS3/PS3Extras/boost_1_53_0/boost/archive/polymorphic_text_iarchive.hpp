...
class polymorphic_text_iarchive : public detail::polymorphic_iarchive_route<naked_text_iarchive>
{
  public:
    polymorphic_text_iarchive(std::istream &is, unsigned int flags = 0) : detail::polymorphic_iarchive_route<naked_text_iarchive>(is, flags)
    {
    }
