...
class xml_oarchive_impl : public basic_text_oprimitive<std::ostream>,
...
class xml_oarchive : public xml_oarchive_impl<xml_oarchive>
{
  public:
    xml_oarchive(std::ostream &os, unsigned int flags = 0) : xml_oarchive_impl<xml_oarchive>(os, flags)
    {
    }
    ~xml_oarchive()
    {
