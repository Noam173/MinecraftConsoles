...
#define DONT_USE_HAS_NEW_OPERATOR ( \
    defined(__BORLANDC__) || BOOST_WORKAROUND(__IBMCPP__, < 1210) || defined(BOOST_MSVC) && (BOOST_MSVC <= 1300) || defined(__SUNPRO_CC) && (__SUNPRO_CC < 0x590))
...
class iserializer : public basic_iserializer
{
  ...
  protected:
    ...
    explicit iserializer() : basic_iserializer(
...
{
  public:
    explicit auto_ptr_with_deleter(T *p) : m_p(p)
    {
    }
...
template <class Archive, class T>
pointer_iserializer<Archive, T>::pointer_iserializer() : basic_pointer_iserializer(
                                                             boost::serialization::singleton<
                                                                 BOOST_DEDUCED_TYPENAME
                                                                     boost::serialization::type_info_implementation<T>::type>::get_const_instance())
{
    ...
    typedef BOOST_DEDUCED_TYPENAME mpl::eval_if<is_pointer<T>,
                                                ...
                                                BOOST_DEDUCED_TYPENAME mpl::eval_if<is_array<T>,
                                                                                    ...
                                                                                    BOOST_DEDUCED_TYPENAME mpl::eval_if<is_enum<T>,
                                                                                                                        ...
                                                                                                                        mpl::identity<detail::load_non_pointer_type<Archive>>>>>::type typex;
    typex::invoke(ar, t);
}
