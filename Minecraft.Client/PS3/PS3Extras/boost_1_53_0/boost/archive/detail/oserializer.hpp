...
class oserializer : public basic_oserializer
{
  private:
    ...
    // static one
  public:
    explicit BOOST_DLLEXPORT oserializer() : basic_oserializer(
    ...
    {
        return boost::serialization::tracking_level<T>::value == boost::serialization::track_always || (boost::serialization::tracking_level<T>::value == boost::serialization::track_selectively && serialized_as_pointer());
    }
...
template <class Archive, class T>
pointer_oserializer<Archive, T>::pointer_oserializer() : basic_pointer_oserializer(
                                                             boost::serialization::singleton<
                                                                 BOOST_DEDUCED_TYPENAME
                                                                     boost::serialization::type_info_implementation<T>::type>::get_const_instance())
{
...
struct save_pointer_type
{
    ...
    struct polymorphic
    {
            ...
            T &t)
        {
            ...
            // fail
            const basic_pointer_oserializer *bpos = static_cast<const basic_pointer_oserializer *>(
                boost::serialization::singleton<
    ...
    static void invoke(Archive &ar, const TPtr t)
    {
        ...
        if (NULL == t)
        {
            basic_oarchive &boa = boost::serialization::smart_cast_reference<basic_oarchive &>(ar);
...
{
    typedef BOOST_DEDUCED_TYPENAME mpl::eval_if<is_pointer<T>,
                                                ...
                                                BOOST_DEDUCED_TYPENAME mpl::eval_if<is_enum<T>,
                                                                                    ...
                                                                                    BOOST_DEDUCED_TYPENAME mpl::eval_if<is_array<T>,
                                                                                                                        ...
                                                                                                                        // else
                                                                                                                        mpl::identity<detail::save_non_pointer_type<Archive>>>>>::type typex;
    typex::invoke(ar, t);
}
