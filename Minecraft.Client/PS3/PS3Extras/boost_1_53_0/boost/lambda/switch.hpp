...
#define BOOST_LAMBDA_A_I_B(z, i, T) \
    BOOST_PP_COMMA_IF(i)            \
    BOOST_PP_CAT(BOOST_PP_TUPLE_ELEM(2, 0, T), i) BOOST_PP_TUPLE_ELEM(2, 1, T)
...
switch_statement(const lambda_functor<TestArg> &a1)
{
    return lambda_functor_base<
        switch_action<1>,
        tuple<lambda_functor<TestArg>>>(tuple<lambda_functor<TestArg>>(a1));
}
...
#define BOOST_LAMBDA_SWITCH_STATEMENT(N)                                                                                                                                    \
    ...
    {                                                                                                                                                                       \
        return lambda_functor_base<                                                                                                                                         \
            switch_action<BOOST_PP_INC(N),                                                                                                                                  \
                          BOOST_LAMBDA_A_I_LIST(N, TagData)>,                                                                                                               \
            tuple<lambda_functor<TestArg>, BOOST_LAMBDA_A_I_LIST(N, Arg)>>(tuple<lambda_functor<TestArg>, BOOST_LAMBDA_A_I_LIST(N, Arg)>(ta, BOOST_LAMBDA_A_I_LIST(N, a))); \
    }
