    ...
    struct sig
    {
      ...
      public:
        typedef typename return_type_2_comma< // comma needs special handling
            ...
            typename detail::element_or_null<1, rets_t>::type>::type type;
    };
};
...
template <class Action, class Bound, class Open>
class binary_rt
{
  private:
    typedef typename detail::deduce_argument_types<Bound, Open>::type rets_t;
...
class unary_rt
{
  ...
  public:
    typedef typename return_type_1_prot<
        Action,
        typename detail::element_or_null<0, rets_t>::type>::type type;
};
...
class lambda_functor_base<logical_action<and_action>, Args>
{
  ...
  public:
    ...
    struct sig
    {
        typedef typename detail::binary_rt<logical_action<and_action>, Args, SigArgs>::type type;
    };
};
...
class lambda_functor_base<logical_action<or_action>, Args>
{
  ...
  public:
    ...
    struct sig
    {
        typedef typename detail::binary_rt<logical_action<or_action>, Args, SigArgs>::type type;
    };
};
...
class lambda_functor_base<other_action<subscript_action>, Args>
{
  ...
  public:
    ...
    struct sig
    {
        typedef typename detail::binary_rt<other_action<subscript_action>, Args, SigArgs>::type
            type;
    };
};
...
#define BOOST_LAMBDA_BINARY_ACTION(SYMBOL, ACTION_CLASS)                                \
    ...
    {                                                                                   \
      ...
      public:                                                                           \
        ...
        struct sig                                                                      \
        {                                                                               \
            typedef typename detail::binary_rt<ACTION_CLASS, Args, SigArgs>::type type; \
        };                                                                              \
    };
...
#define BOOST_LAMBDA_PREFIX_UNARY_ACTION(SYMBOL, ACTION_CLASS)                         \
    ...
    {                                                                                  \
      ...
      public:                                                                          \
        ...
        struct sig                                                                     \
        {                                                                              \
            typedef typename detail::unary_rt<ACTION_CLASS, Args, SigArgs>::type type; \
        };                                                                             \
    };
...
#define BOOST_LAMBDA_POSTFIX_UNARY_ACTION(SYMBOL, ACTION_CLASS)                          \
    ...
    {                                                                                    \
      ...
      public:                                                                            \
        ...
        RET call(CALL_FORMAL_ARGS) const                                                 \
        {                                                                                \
            return detail::select(boost::tuples::get<0>(args), CALL_ACTUAL_ARGS) SYMBOL; \
        }                                                                                \
        template <class SigArgs>                                                         \
        struct sig                                                                       \
        {                                                                                \
