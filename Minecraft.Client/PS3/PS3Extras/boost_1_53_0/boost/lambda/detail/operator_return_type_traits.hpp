...
template <>
struct promote_code<bool>
{
    static const int value = 10;
};
template <>
struct promote_code<char>
{
    static const int value = 20;
};
template <>
struct promote_code<unsigned char>
{
    static const int value = 30;
};
template <>
struct promote_code<signed char>
{
    static const int value = 40;
};
template <>
struct promote_code<short int>
{
...
template <>
struct promote_code<int>
{
    static const int value = 100;
};
template <>
struct promote_code<unsigned int>
{
    static const int value = 200;
};
template <>
struct promote_code<long>
{
    static const int value = 300;
};
template <>
struct promote_code<unsigned long>
{
    static const int value = 400;
};

template <>
struct promote_code<float>
{
    static const int value = 500;
};
template <>
struct promote_code<double>
{
    static const int value = 600;
};
template <>
struct promote_code<long double>
{
    static const int value = 700;
};
...
template <>
struct promote_code<std::complex<float>>
{
    static const int value = 800;
};
template <>
struct promote_code<std::complex<double>>
{
    static const int value = 900;
};
template <>
struct promote_code<std::complex<long double>>
{
...
template <>
struct promote_to_int<bool>
{
    typedef int type;
};
template <>
struct promote_to_int<char>
{
    typedef int type;
};
template <>
struct promote_to_int<unsigned char>
{
    typedef int type;
};
template <>
struct promote_to_int<signed char>
{
    typedef int type;
};
template <>
struct promote_to_int<short int>
{
    typedef int type;
};
...
template <>
struct promote_to_int<unsigned short int>
{
    typedef detail::IF<sizeof(int) <= sizeof(unsigned short int),
...
struct return_type_1<unary_arithmetic_action<Act>, A>
{
    typedef
        typename plain_return_type_1<
            ...
            typename detail::remove_reference_and_cv<A>::type>::type type;
};
...
struct return_type_1<other_action<addressof_action>, A>
{
    typedef
        typename plain_return_type_1<
            ...
            typename detail::remove_reference_and_cv<A>::type>::type type1;
...
template <>
struct contentsof_type<null_type>
{
    typedef detail::unspecified type;
};

template <class A>
struct contentsof_type<const A>
{
    typedef typename contentsof_type<A>::type type;
};

template <class A>
struct contentsof_type<volatile A>
{
    typedef typename contentsof_type<A>::type type;
};

template <class A>
struct contentsof_type<const volatile A>
{
    typedef typename contentsof_type<A>::type type;
};
...
template <class A>
struct contentsof_type<A *>
{
    typedef A &type;
};
template <class A>
struct contentsof_type<A *const>
{
    typedef A &type;
};
template <class A>
struct contentsof_type<A *volatile>
{
    typedef A &type;
};
template <class A>
struct contentsof_type<A *const volatile>
{
    typedef A &type;
};

template <class A, int N>
struct contentsof_type<A[N]>
{
    typedef A &type;
};
template <class A, int N>
struct contentsof_type<const A[N]>
{
    typedef const A &type;
};
template <class A, int N>
struct contentsof_type<volatile A[N]>
{
    typedef volatile A &type;
};
template <class A, int N>
struct contentsof_type<const volatile A[N]>
{
...
struct return_type_1<other_action<contentsof_action>, A>
{
    ...
    typedef typename detail::IF_type<
        ...
        detail::contentsof_type<
            typename boost::remove_reference<A>::type>,
        detail::identity_mapping<type1>>::type type;
};
...
struct pointer_arithmetic_traits<plus_action, A, B>
{
    ...
    typedef typename array_to_pointer<typename boost::remove_reference<A>::type>::type AP;
    typedef typename array_to_pointer<typename boost::remove_reference<B>::type>::type BP;
    ...
    typedef typename detail::IF<
        ...
        typename detail::IF<is_pointer_A, AP, BP>::RET>::RET type;
};
...
struct pointer_arithmetic_traits<minus_action, A, B>
{
        ...
        boost::is_same<
            typename boost::remove_const<
                typename boost::remove_pointer<
                    typename boost::remove_const<AP>::type>::type>::type,
            typename boost::remove_const<
                typename boost::remove_pointer<
                    typename boost::remove_const<BP>::type>::type>::type>::value;
    ...
    typedef typename detail::IF<
        ...
        typename detail::IF<
            is_pointer_A,
            AP,
            detail::return_type_deduction_failure<detail::illegal_pointer_arithmetic>>::RET>::RET type;
};
...
struct return_type_2<arithmetic_action<Act>, A, B>
{
    ...
    typedef typename plain_return_type_2<arithmetic_action<Act>, plain_A, plain_B>::type type1;
    ...
    typedef typename detail::IF_type<
        ...
        plain_return_type_2<arithmetic_action<Act>, plain_A, plain_B>>::type type;
};
...
struct return_type_2_arithmetic_phase_1
{
    typedef typename return_type_2_arithmetic_phase_2<
        ...
        typename remove_reference_and_cv<B>::type>::type type;
};
...
{
    typedef typename pointer_arithmetic_traits<Act, A, B>::type type;
};

template <class A, class B>
struct return_type_2_arithmetic_phase_2
{
    typedef typename return_type_2_arithmetic_phase_3<
        typename promote_to_int<A>::type,
        typename promote_to_int<B>::type>::type type;
};
...
{
    typedef detail::IF<sizeof(long) <= sizeof(unsigned int),
                       unsigned long,
                       long>::RET type;
};
...
struct return_type_2_arithmetic_phase_3
{
    enum
    {
        promote_code_A_value = promote_code<A>::value,
...
struct return_type_2<bitwise_action<Act>, A, B>
{
    ...
    typedef typename plain_return_type_2<bitwise_action<Act>, plain_A, plain_B>::type type1;

    // if user defined return type, do not enter type deductions
    typedef typename detail::IF_type<
        boost::is_same<type1, detail::unspecified>::value,
        return_type_2<arithmetic_action<plus_action>, A, B>,
        plain_return_type_2<bitwise_action<Act>, plain_A, plain_B>>::type type;
...
struct leftshift_type
{
    ...
    typedef typename detail::IF<
        boost::is_convertible<
            ...
            std::ostream *>::value,
        std::ostream &,
        typename detail::remove_reference_and_cv<A>::type>::RET type;
};
...
struct leftshift_type
{
  ...
  public:
    typedef typename detail::IF_type<
        ...
        detail::remove_reference_and_cv<A>>::type type;
};
...
struct return_type_2<bitwise_action<leftshift_action>, A, B>
{
    ...
    typedef typename plain_return_type_2<bitwise_action<leftshift_action>, plain_A, plain_B>::type type1;

    // if user defined return type, do not enter type deductions
    typedef typename detail::IF_type<
        boost::is_same<type1, detail::unspecified>::value,
        detail::leftshift_type<A, B>,
        plain_return_type_2<bitwise_action<leftshift_action>, plain_A, plain_B>>::type type;
};
...
struct return_type_2<bitwise_action<rightshift_action>, A, B>
{
    ...
    typedef typename plain_return_type_2<bitwise_action<rightshift_action>, plain_A, plain_B>::type type1;

    // if user defined return type, do not enter type deductions
    typedef typename detail::IF_type<
        boost::is_same<type1, detail::unspecified>::value,
        detail::rightshift_type<A, B>,
        plain_return_type_2<bitwise_action<rightshift_action>, plain_A, plain_B>>::type type;
};
...
struct return_type_2<logical_action<Act>, A, B>
{
    ...
    typedef typename plain_return_type_2<logical_action<Act>, plain_A, plain_B>::type type;
};
...
struct return_type_2<relational_action<Act>, A, B>
{
    ...
    typedef typename plain_return_type_2<relational_action<Act>, plain_A, plain_B>::type type;
};
...
struct return_type_2<arithmetic_assignment_action<Act>, A, B>
{
    ...
    typedef typename plain_return_type_2<
        arithmetic_assignment_action<Act>, plain_A, plain_B>::type type1;
...
struct return_type_2<bitwise_assignment_action<Act>, A, B>
{
    ...
    typedef typename plain_return_type_2<
        bitwise_assignment_action<Act>, plain_A, plain_B>::type type1;
...
struct return_type_2<other_action<assignment_action>, A, B>
{
    ...
    typedef typename plain_return_type_2<
        other_action<assignment_action>, plain_A, plain_B>::type type1;
...
struct return_type_2<other_action<comma_action>, A, B>
{
    ...
    typedef typename plain_return_type_2<
        other_action<comma_action>, plain_A, plain_B>::type type;
};
...
template <class A, class B>
struct subscript_type<A *, B>
{
    typedef A &type;
};
template <class A, class B>
struct subscript_type<A *const, B>
{
    typedef A &type;
};
template <class A, class B>
struct subscript_type<A *volatile, B>
{
    typedef A &type;
};
template <class A, class B>
struct subscript_type<A *const volatile, B>
{
    typedef A &type;
};

template <class A, class B, int N>
struct subscript_type<A[N], B>
{
    typedef A &type;
};
...
template <class A, class B, int N>
struct subscript_type<const A[N], B>
{
    typedef const A &type;
};
template <class A, class B, int N>
struct subscript_type<volatile A[N], B>
{
    typedef volatile A &type;
};
template <class A, class B, int N>
struct subscript_type<const volatile A[N], B>
{
    typedef const volatile A &type;
};
...
struct return_type_2<other_action<subscript_action>, A, B>
{
    ...
    typedef typename plain_return_type_2<
        other_action<subscript_action>, plain_A, plain_B>::type type1;

    typedef typename detail::IF_type<
        boost::is_same<type1, detail::unspecified>::value,
        detail::subscript_type<nonref_A, nonref_B>,
        plain_return_type_2<other_action<subscript_action>, plain_A, plain_B>>::type type;
};
