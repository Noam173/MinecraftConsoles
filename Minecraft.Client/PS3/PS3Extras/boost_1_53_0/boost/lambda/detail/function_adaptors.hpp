...
struct function_adaptor
{
    ...
    struct sig
        : result_converter<
              Args, tuples::length<typename Args::tail_type>::value, detail::has_sig<plainF>::value>
    {
    };
    ...
    class sig
    {
      ...
      public:
        typedef typename plainF::template sig<
            typename detail::remove_references_from_elements<Args>::type>::type type;
    };
#endif
...
template <class Func>
struct function_adaptor<const Func>; // error
    ...
    class sig
    {
      ...
      public:
        typedef typename detail::IF<boost::is_reference<argument_type>::value,
                                    ...
                                    typename boost::remove_cv<T>::type>::RET type;
    };
