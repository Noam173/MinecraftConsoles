...
struct find
{
    ...
    {
        typedef typename boost::remove_const<
            typename boost::tuples::element<1, Args>::type>::type type;
    };

    template <class A, class C>
    A operator()(A a, A b, const C &c) const
    {
...
struct find_end
{
    ...
    template <class A, class C>
    A operator()(A a, A b, C c, C d) const
    {
        return ::std::find_end(a, b, c, d);
    }

    template <class A, class C, class E>
    A operator()(A a, A b, C c, C d, E e) const
    {
    ...
    struct sig
    {
        typedef typename ::std::iterator_traits<
            typename boost::remove_const<
                typename boost::tuples::element<1, Args>::type>::type>::difference_type type;
    };
...
struct mismatch
{
    ...
    {
        typedef typename boost::remove_const<
            typename boost::tuples::element<1, Args>::type>::type element1_type;

        typedef typename boost::remove_const<
            typename boost::tuples::element<3, Args>::type>::type element2_type;
...
struct transform
{
    ...
    template <class A, class C, class D>
    C operator()(A a, A b, C c, D d) const
    {
        return std::transform(a, b, c, d);
    }

    template <class A, class C, class D, class E>
    D operator()(A a, A b, C c, D d, E e) const
    {
...
struct replace_copy
{
    ...
    template <class A, class C, class D>
    C operator()(A a, A b, C c, const D &d, const D &e) const
    {
...
struct replace_copy_if
{
    ...
    template <class A, class C, class D, class E>
    C operator()(A a, A b, C c, D d, const E &e) const
    {
...
struct remove_copy
{
    ...
    template <class A, class C, class D>
    C operator()(A a, A b, C c, const D &d) const
    {
...
struct rotate_copy
{
    ...
    D operator()(A a, A b, A c, D d) const
    {
...
struct partial_sort_copy
{
    ...
    template <class A, class C>
    C operator()(A a, A b, C c, C d) const
    {
        return ::std::partial_sort_copy(a, b, c, d);
    }

    template <class A, class C, class E>
    C operator()(A a, A b, C c, C d, E e) const
    {
...
struct lower_bound
{
    ...
    template <class A, class C, class D>
    A operator()(A a, A b, const C &c, D d) const
    {
...
struct equal_range
{
    ...
    {
        typedef typename boost::remove_const<
            typename boost::tuples::element<1, Args>::type>::type element_type;
...
struct merge
{
    ...
    {
        typedef typename boost::remove_const<
            typename boost::tuples::element<5, Args>::type>::type type;
    };

    template <class A, class C, class E>
    E operator()(A a, A b, C c, C d, E e) const
    {
        return std::merge(a, b, c, d, e);
    }

    template <class A, class C, class E, class F>
    E operator()(A a, A b, C c, C d, E e, F f) const
    {
...
struct min
{
    ...
    template <class A, class C>
    A operator()(const A &a, const A &b, C c) const
    {
...
#define CALL_MEMBER(X)                                                                      \
    ...
    {                                                                                       \
        ...
        {                                                                                   \
            typedef typename boost::remove_const<                                           \
                typename boost::tuples::element<1, Args>::type>::type::const_iterator type; \
        };                                                                                  \
                                                                                            \
        template <class T>                                                                  \
