             ...
             const lambda_functor<Arg3> &a3)
{
    return lambda_functor_base<
        ifthenelse_action,
        tuple<lambda_functor<Arg1>, lambda_functor<Arg2>, lambda_functor<Arg3>>>(tuple<lambda_functor<Arg1>, lambda_functor<Arg2>, lambda_functor<Arg3>>(a1, a2, a3));
}
                    ...
                    const Arg3 &a3)
{
    return lambda_functor_base<
        ...
        tuple<lambda_functor<Arg1>,
              typename const_copy_argument<Arg2>::type,
              typename const_copy_argument<Arg3>::type>>(tuple<lambda_functor<Arg1>,
                                                               typename const_copy_argument<Arg2>::type,
...
{
    typedef detail::return_type_deduction_failure<return_type_2_ifthenelsereturn> type;
...
struct return_type_2_ifthenelsereturn<1, false, false, false, A, B>
{
    ...
    typedef typename return_type_2_ifthenelsereturn<
        2,
...
struct same_or_not
{
    ...
    typedef typename arithmetic_or_not<
...
struct return_type_2<other_action<ifthenelsereturn_action>, A, B>
{
    ...
    typedef typename boost::add_const<typename detail::same_or_not<A1, B1>::type>::type type;
};
    ...
    lambda_functor_base<other_action<ifthenelsereturn_action>, Args>
{
    ...
    struct sig
    {
      ...
      public:
        typedef typename return_type_2<
            other_action<ifthenelsereturn_action>, ret1, ret2>::type type;
    };
  ...
  public:
    ...
    RET call(CALL_FORMAL_ARGS) const
    {
        return (detail::select(boost::tuples::get<0>(args), CALL_ACTUAL_ARGS)) ? detail::select(boost::tuples::get<1>(args), CALL_ACTUAL_ARGS)
                                                                               : detail::select(boost::tuples::get<2>(args), CALL_ACTUAL_ARGS);
    }
};
