...
template <int N, class HT, class TT>
inline typename access_traits<
    typename element<N, cons<HT, TT>>::type>::const_type
...
{
    typedef typename IF<
        ::boost::is_function<T>::value, non_storeable_type<T>, T>::RET type;
};
template <>
...
struct cons<HT, null_type>
{
    ...
    template <int N>
    typename access_traits<
        typename element<N, self_type>::type>::non_const_type
    ...
    template <int N>
    typename access_traits<
        typename element<N, self_type>::type>::const_type
...
{
    typedef typename detail::generate_error<T &>::
