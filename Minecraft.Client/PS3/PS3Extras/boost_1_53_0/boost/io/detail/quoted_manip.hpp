...
{
    return detail::quoted_proxy<std::basic_string<Char, Traits, Alloc> const &, Char>(s, escape, delim);
}
...
{
    return detail::quoted_proxy<std::basic_string<Char, Traits, Alloc> &, Char>(s, escape, delim);
}
