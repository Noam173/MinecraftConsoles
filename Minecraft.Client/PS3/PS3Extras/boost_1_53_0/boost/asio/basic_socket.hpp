      ...
      public socket_base
{
  public:
     ...
     */
#if defined(BOOST_MSVC) && (BOOST_MSVC >= 1400) && (!defined(_WIN32_WINNT) || _WIN32_WINNT < 0x0600) && !defined(BOOST_ASIO_ENABLE_CANCELIO)
                       ...
                       BOOST_ASIO_MOVE_ARG(ConnectHandler) handler)
    {
        ...
        BOOST_ASIO_CONNECT_HANDLER_CHECK(ConnectHandler, handler)
        type_check;
