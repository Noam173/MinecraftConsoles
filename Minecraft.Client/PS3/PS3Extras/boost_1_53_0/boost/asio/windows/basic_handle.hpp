...
#if defined(BOOST_ASIO_HAS_WINDOWS_RANDOM_ACCESS_HANDLE) || defined(BOOST_ASIO_HAS_WINDOWS_STREAM_HANDLE) || defined(BOOST_ASIO_HAS_WINDOWS_OBJECT_HANDLE) || defined(GENERATING_DOCUMENTATION)
