  ...
  public:
                    ...
                    socket_base::message_flags flags, Handler handler)
    {
        ...
        start_op(impl, reactor::write_op, p.p, true,
                 ((impl.state_ & socket_ops::stream_oriented) && buffer_sequence_adapter<boost::asio::const_buffer,
                       ...
                       socket_base::message_flags flags, Handler handler)
    {
        ...
        start_op(impl,
                 ...
                 ((impl.state_ & socket_ops::stream_oriented) && buffer_sequence_adapter<boost::asio::mutable_buffer,
