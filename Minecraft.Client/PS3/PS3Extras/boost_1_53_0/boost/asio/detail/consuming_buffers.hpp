    ...
    : public boost::iterator<std::forward_iterator_tag, const Buffer>
{
  ...
  private:
    ...
    bool equal(const consuming_buffers_iterator &other) const
    {
        ...
        return !at_end_ && !other.at_end_ && buffer_cast<const void *>(first_) == buffer_cast<const void *>(other.first_) && buffer_size(first_) == buffer_size(other.first_) && begin_remainder_ == other.begin_remainder_ && end_remainder_ == other.end_remainder_;
    }
