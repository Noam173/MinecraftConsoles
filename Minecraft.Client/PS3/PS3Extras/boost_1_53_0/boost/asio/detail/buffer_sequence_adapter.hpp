    ...
    : buffer_sequence_adapter_base
{
  public:
        ...
        const boost::array<Elem, 2> &buffer_sequence)
    {
        ...
        total_buffer_size_ = boost::asio::buffer_size(buffer_sequence[0]) + boost::asio::buffer_size(buffer_sequence[1]);
    }
    ...
    {
        return boost::asio::buffer_size(buffer_sequence[0]) == 0 && boost::asio::buffer_size(buffer_sequence[1]) == 0;
    }
