...
std::basic_string<Ch> decode_char_entities(const std::basic_string<Ch> &s)
{
    ...
    for (typename Str::const_iterator it = s.begin(); it != end; ++it)
    {
        if (*it == Ch('&'))
        {
            ...
            if (ent == detail::widen<Ch>("lt"))
            {
                r += Ch('<');
            }
            else if (ent == detail::widen<Ch>("gt"))
            {
                r += Ch('>');
            }
            else if (ent == detail::widen<Ch>("amp"))
            {
                r += Ch('&');
            }
            else if (ent == detail::widen<Ch>("quot"))
            {
                r += Ch('"');
            }
            else if (ent == detail::widen<Ch>("apos"))
            {
                r += Ch('\'');
            }
            else
