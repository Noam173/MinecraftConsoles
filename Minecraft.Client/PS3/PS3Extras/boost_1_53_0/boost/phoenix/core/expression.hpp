...
template <
    template <typename> class Actor, typename Tag, BOOST_PHOENIX_typename_A_void(BOOST_PHOENIX_COMPOSITE_LIMIT), typename Dummy = void>
struct expr_ext;

template <
    typename Tag, BOOST_PHOENIX_typename_A_void(BOOST_PHOENIX_COMPOSITE_LIMIT), typename Dummy = void>
...
#define M1(Z, N, D)      \
    BOOST_PP_COMMA_IF(N) \
    typename call_traits<BOOST_PP_CAT(A, N)>::param_type BOOST_PP_CAT(a, N)
    ...
    : proto::transform<expr_ext<Actor, Tag, BOOST_PHOENIX_A>, int>
{
    typedef
        typename proto::result_of::make_expr<
            Tag, proto::basic_default_domain, BOOST_PP_REPEAT(BOOST_PHOENIX_ITERATION, M0, _)>::type
            base_type;
    ...
    static type make(BOOST_PP_REPEAT(BOOST_PHOENIX_ITERATION, M1, _))
    {
        actor<base_type> const e =
            {
                proto::make_expr<
                    Tag, proto::basic_default_domain>(BOOST_PHOENIX_a)};
        return e;
    }
