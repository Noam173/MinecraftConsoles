...
BOOST_PHOENIX_DEFINE_EXPRESSION_VARARG(
    (boost)(phoenix)(detail)(function_eval), (meta_grammar)(meta_grammar), BOOST_PP_DEC(BOOST_PHOENIX_COMPOSITE_LIMIT))
            ...
            typename boost::add_const<                                    \
                typename boost::result_of<                                \
                    boost::phoenix::evaluator(                            \
                        BOOST_PP_CAT(A, n), Context)>::type>::type>::type \
            BOOST_PP_CAT(a, n);
...
#else
template <
    typename This, typename F, BOOST_PHOENIX_typename_A, typename Context>
struct result<This(F, BOOST_PHOENIX_A, Context)>
{
    ...
    typedef typename boost::result_of<fn(BOOST_PHOENIX_a)>::type
        type;
    /*
    typedef typename
        mpl::eval_if_c<
...
typename result<
    function_eval(
        F const &, BOOST_PHOENIX_A_ref, Context const &)>::type
...
typename result<
    function_eval(
        F &, BOOST_PHOENIX_A_ref, Context const &)>::type
