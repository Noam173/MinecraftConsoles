    ...
    : proto::callable
{
    ...
    result_type
    operator()(
        reference_wrapper<A0> const &a0, reference_wrapper<A1> const &a1) const
    {
...
struct function_equal_
    : proto::when<
          proto::if_<
              proto::matches<proto::_, proto::_state>(), proto::or_<proto::when<proto::terminal<proto::_>, compare(proto::_value, proto::call<proto::_value(proto::_state)>)>, proto::otherwise<function_equal_otherwise(proto::_, proto::_state)>>, proto::call<function_equal_otherwise()>>>
{
};
    ...
    : proto::callable
{
    ...
    result_type operator()(Expr1 const &e1, Expr1 const &e2) const
    {
        return this->evaluate(
            e1, e2, typename proto::arity_of<Expr1>::type());
    }
...
#define BOOST_PHOENIX_FUNCTION_EQUAL_R(Z, N, DATA) \
    &&function_equal_()(                           \
        proto::child_c<N>(e1), proto::child_c<N>(e2)) /**/

#define BOOST_PHOENIX_FUNCTION_EQUAL(Z, N, DATA)               \
    template <typename Expr1>                                  \
    result_type                                                \
    evaluate(                                                  \
        Expr1 const &e1, Expr1 const &e2, mpl::long_<N>) const \
    {                                                          \
        return function_equal_()(                              \
            proto::child_c<0>(e1), proto::child_c<0>(e2))      \
            BOOST_PP_REPEAT_FROM_TO(                           \
                1, N, BOOST_PHOENIX_FUNCTION_EQUAL_R, _);      \
    }                                                          \
/**/

    BOOST_PP_REPEAT_FROM_TO(
        1, BOOST_PP_INC(BOOST_PROTO_MAX_ARITY), BOOST_PHOENIX_FUNCTION_EQUAL, _)
