...
struct env
{
    typedef
        typename fusion::result_of::at_c<
            typename boost::remove_reference<Context>::type, 0>::type
            type;
};
...
struct actions
{
    typedef
        typename fusion::result_of::at_c<
            typename boost::remove_reference<Context>::type, 1>::type
            type;
};
} // namespace result_of
    ...
    : proto::transform<_context>
{
        ...
        : proto::transform_impl<Expr, State, Data>
    {
        ...
        result_type operator()(
            typename impl::expr_param, typename impl::state_param s, typename impl::data_param d) const
        {
...
template <typename Env, typename Actions>
typename result_of::context<Env const &, Actions const &>::type const inline context(Env const &env, Actions const &actions)
{
    vector2<Env const &, Actions const &> e = {env, actions};
    return e;
}
...
template <typename Env, typename Actions>
typename result_of::context<Env const &, Actions const &>::type const inline make_context(Env const &env, Actions const &actions)
{
    return context(env, actions);
}

template <typename Env, typename Actions>
typename result_of::context<Env &, Actions const &>::type const inline context(Env &env, Actions const &actions)
{
    vector2<Env &, Actions const &> e = {env, actions};
    return e;
}
...
template <typename Env, typename Actions>
typename result_of::context<Env &, Actions const &>::type const inline make_context(Env &env, Actions const &actions)
{
    return context(env, actions);
}

template <typename Env, typename Actions>
typename result_of::context<Env const &, Actions &>::type const inline context(Env const &env, Actions &actions)
{
    vector2<Env const &, Actions &> e = {env, actions};
    return e;
}
...
template <typename Env, typename Actions>
typename result_of::context<Env const &, Actions &>::type const inline make_context(Env const &env, Actions &actions)
{
    return context(env, actions);
}

template <typename Env, typename Actions>
typename result_of::context<Env &, Actions &>::type const inline context(Env &env, Actions &actions)
{
    vector2<Env &, Actions &> e = {env, actions};
    return e;
}
...
template <typename Env, typename Actions>
typename result_of::context<Env &, Actions &>::type const inline make_context(Env &env, Actions &actions)
{
    return context(env, actions);
}
    ...
    : proto::transform<_env>
{
        ...
        : proto::transform_impl<Expr, State, Data>
    {
        ...
        result_type operator()(
            typename impl::expr_param, typename impl::state_param s, typename impl::data_param) const
        {
            return s;
        }
    };
    ...
    : proto::transform_impl<Expr, State, proto::empty_env>
{
    typedef
        typename fusion::result_of::at_c<
            typename boost::remove_reference<State>::type, 0>::type
            result_type;
...
template <typename Context>
typename fusion::result_of::at_c<Context, 0>::type inline env(Context &ctx)
{
    return fusion::at_c<0>(ctx);
}

template <typename Context>
typename fusion::result_of::at_c<Context const, 0>::type inline env(Context const &ctx)
{
    return fusion::at_c<0>(ctx);
}
    ...
    : proto::transform<_actions>
{
        ...
        : proto::transform_impl<Expr, State, Data>
    {
        ...
        result_type operator()(
            typename impl::expr_param, typename impl::state_param, typename impl::data_param d) const
        {
            return d;
        }
    };
    ...
    : proto::transform_impl<Expr, State, proto::empty_env>
{
    typedef
        typename fusion::result_of::at_c<
            typename boost::remove_reference<State>::type, 1>::type
            result_type;
...
template <typename Context>
typename fusion::result_of::at_c<Context, 1>::type inline actions(Context &ctx)
{
    return fusion::at_c<1>(ctx);
}

template <typename Context>
typename fusion::result_of::at_c<Context const, 1>::type inline actions(Context const &ctx)
{
    return fusion::at_c<1>(ctx);
}
...
template <
    BOOST_PP_ENUM_PARAMS_WITH_A_DEFAULT(
        BOOST_PHOENIX_LIMIT, typename A, mpl::void_),
    typename Dummy = void>
struct make_env;
...
result_of::make_env<>::type inline make_env()
{
    return result_of::make_env<>::type();
}
#define BOOST_PHOENIX_M0(Z, N, D)                                                                                    \
    template <BOOST_PHOENIX_typename_A(N)>                                                                           \
    typename result_of::make_env<BOOST_PHOENIX_A_ref(N)>::type inline make_env(BOOST_PHOENIX_A_ref_a(N))             \
    {                                                                                                                \
    ...
    template <BOOST_PHOENIX_typename_A(N)>                                                                           \
    typename result_of::make_env<BOOST_PHOENIX_A_const_ref(N)>::type inline make_env(BOOST_PHOENIX_A_const_ref_a(N)) \
    {                                                                                                                \
