          ...
          >
{
    typedef proto::basic_expr<
        proto::tag::terminal, proto::term<T>, 0>
        base_type;
...
struct meta_grammar::case_<proto::tag::terminal, Dummy>
    : proto::or_<
          enable_rule<rule::argument, Dummy>, enable_rule<rule::custom_terminal, Dummy>, enable_rule<rule::terminal, Dummy>>
{
};
