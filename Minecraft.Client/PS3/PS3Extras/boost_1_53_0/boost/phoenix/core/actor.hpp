...
#define BOOST_PHOENIX_ACTOR_ASSIGN_CALL(Z, N, D)                                \
    proto::when<                                                                \
        ...
        proto::and_<                                                            \
            BOOST_PP_ENUM(                                                      \
                N, BOOST_PHOENIX_ACTOR_ASSIGN_CHILD, _)>> /**/
...
struct assign
    : proto::or_<
          BOOST_PP_ENUM_SHIFTED(
              BOOST_PHOENIX_LIMIT, BOOST_PHOENIX_ACTOR_ASSIGN_CALL, _),
          proto::when<
              proto::terminal<proto::_>, do_assign(proto::_, proto::_state)>>
{
};
...
struct actor
{
    typedef typename mpl::eval_if_c<
        mpl::or_<
            is_custom_terminal<Expr>, mpl::bool_<is_placeholder<Expr>::value>>::value,
        proto::terminal<Expr>, mpl::identity<Expr>>::type
        expr_type;
    ...
    typename proto::result_of::make_expr<
        proto::tag::assign, phoenix_domain, proto_base_expr, A0>::type const
    ...
    template <typename A0>
    typename proto::result_of::make_expr<
        proto::tag::subscript, phoenix_domain, proto_base_expr, A0>::type const
    operator[](A0 const &a0) const
    {
    ...
    typename evaluator::impl<
        proto_base_expr const &, typename result_of::context<Env const &, default_actions const &>::type, proto::empty_env>::result_type
