...
#define BOOST_PHOENIX_UNARY_FUNCTIONAL(__, ___, name)                                                                     \
    ...
    {                                                                                                                     \
    typedef proto::functional::make_expr<proto::tag::name>                                                                \
    ...
    template <typename Operand>                                                                                           \
    typename result_of::BOOST_PP_CAT(make_, name)<Operand>::type inline BOOST_PP_CAT(make_, name)(Operand const &operand) \
    {                                                                                                                     \
...
#define BOOST_PHOENIX_BINARY_FUNCTIONAL(__, ___, name)                                                                             \
    ...
    typename result_of::BOOST_PP_CAT(make_, name)<Rhs, Lhs>::type inline BOOST_PP_CAT(make_, name)(Lhs const &lhs, Rhs const &rhs) \
    {                                                                                                                              \
