...
#define BOOST_PHOENIX_M1(R, PRODUCT) \
    ((BOOST_PP_SEQ_ENUM(BOOST_PP_SEQ_FOR_EACH_I_R(R, BOOST_PHOENIX_M1_R, _, PRODUCT)))) /**/
...
#define BOOST_PHOENIX_M2(_, N, TUPLE) \
    BOOST_PP_COMMA_IF(N)              \
    BOOST_PP_TUPLE_ELEM(BOOST_PHOENIX_ITERATION, N, TUPLE) /**/

#define BOOST_PHOENIX_M3(_, N, TUPLE) \
    BOOST_PP_COMMA_IF(N)              \
    BOOST_PP_TUPLE_ELEM(BOOST_PHOENIX_ITERATION, N, TUPLE) a##N /**/
