...
struct BOOST_PP_CAT(vector, BOOST_PHOENIX_ITERATION)
{
    ...
    typedef BOOST_PP_CAT(vector, BOOST_PP_DEC(BOOST_PHOENIX_ITERATION))<BOOST_PP_ENUM_SHIFTED_PARAMS(BOOST_PHOENIX_ITERATION, A)> args_type;
...
#define BOOST_PHOENIX_SUPPORT_VECTOR_ADAT_PARAM1              \
    (                                                         \
        BOOST_PP_CAT(                                         \
            boost::phoenix::vector, BOOST_PHOENIX_ITERATION)) \
        BOOST_PP_REPEAT(BOOST_PHOENIX_ITERATION, M1, _) /**/
...
BOOST_FUSION_ADAPT_TPL_STRUCT_NO_PARTIAL(
    BOOST_PHOENIX_SUPPORT_VECTOR_ADAT_PARAM0, BOOST_PHOENIX_SUPPORT_VECTOR_ADAT_PARAM1, BOOST_PHOENIX_SUPPORT_VECTOR_ADAT_PARAM2)
