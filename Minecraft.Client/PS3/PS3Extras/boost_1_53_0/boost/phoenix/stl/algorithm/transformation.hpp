...
struct unique_copy
{
    ...
    typename detail::decay_array<O>::type operator()(R &r, O o) const
    {
        return std::unique_copy(
            detail::begin_(r), detail::end_(r), o);
    }
    ...
    {
        return std::unique_copy(
            detail::begin_(r), detail::end_(r), o, p);
    }
};
...
struct rotate
{
    ...
    {
        std::rotate(
            detail::begin_(r), m, detail::end_(r));
    }
};
...
struct rotate_copy
{
    ...
    typename detail::decay_array<O>::type operator()(R &r, M m, O o) const
    {
        return std::rotate_copy(
            detail::begin_(r), m, detail::end_(r), o);
    }
};
...
struct merge
{
    ...
    {
        return std::merge(
            detail::begin_(r1), detail::end_(r1), detail::begin_(r2), detail::end_(r2), o);
    }
    ...
    {
        return std::merge(
            detail::begin_(r1), detail::end_(r1), detail::begin_(r2), detail::end_(r2), o, c);
    }
};
