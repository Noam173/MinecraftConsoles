...
struct find_end
{
    ...
    {
        return std::find_end(
            detail::begin_(r), detail::end_(r), detail::begin_(r2), detail::end_(r2));
    }
    ...
    {
        return std::find_end(
            detail::begin_(r), detail::end_(r), detail::begin_(r2), detail::end_(r2), p);
    }
};
...
{
    typedef std::pair<
        typename range_result_iterator<R>::type, typename range_result_iterator<R>::type>
        type;
};
} // namespace result_of
...
{
    typedef std::pair<
        typename range_result_iterator<R>::type, typename detail::decay_array<I>::type>
        type;
};
} // namespace result_of
...
struct includes
{
    ...
    {
        return std::includes(
            detail::begin_(r1), detail::end_(r1), detail::begin_(r2), detail::end_(r2));
    }
    ...
    {
        return std::includes(
            detail::begin_(r1), detail::end_(r1), detail::begin_(r2), detail::end_(r2), c);
    }
};
...
struct lexicographical_compare
{
    ...
    {
        return std::lexicographical_compare(
            detail::begin_(r1), detail::end_(r1), detail::begin_(r2), detail::end_(r2), p);
    }
};
