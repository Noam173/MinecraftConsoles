...
struct assign
{
    ...
    template <
        typename This, typename C, typename Arg1>
    ...
    template <
        typename This, typename C, typename Arg1, typename Arg2>
    ...
    template <
        typename This, typename C, typename Arg1, typename Arg2, typename Arg3>
    ...
    C &operator()(
        C &c, Arg1 arg1, Arg2 arg2, Arg3 const &arg3) const
    {
...
struct erase
{
    ...
    typedef boost::mpl::eval_if_c<
        boost::is_same<
            typename remove_reference<Arg1>::type, typename iterator_of<C>::type>::value
    ...
    typedef typename boost::mpl::eval_if_c<
        has_mapped_type<C>::value, map_erase_result, iterator_of<C>>::type
        type;
};
} // namespace result_of
...
struct erase
{
    ...
    typename stl_impl::disable_if_is_void<
        typename result_of::erase<C, Arg1>::type>::type
    ...
    template <typename C, typename Arg1, typename Arg2>
    typename stl_impl::disable_if_is_void<
        typename result_of::erase<C, Arg1, Arg2>::type>::type
...
{
template <
    typename C, typename Arg1, typename Arg2 = mpl::void_, typename Arg3 = mpl::void_>
class insert
{
    ...
    typedef boost::mpl::eval_if<
        map_insert_returns_pair<typename remove_const<C>::type>, pair_iterator_bool, iterator_of<C>>
        choice_1;

    typedef boost::mpl::eval_if_c<
        boost::mpl::and_<
            boost::is_same<Arg3, mpl::void_>, boost::mpl::not_<boost::is_same<Arg1, Arg2>>>::value,
        iterator_of<C>, boost::mpl::identity<void>>
        choice_2;

  public:
    typedef typename boost::mpl::eval_if_c<
        boost::is_same<Arg2, mpl::void_>::value, choice_1, choice_2>::type
        type;
};
} // namespace result_of
...
struct insert
{
    ...
    template <typename C, typename Arg1, typename Arg2>
    typename stl_impl::disable_if_is_void<
        typename result<insert(C &, Arg1, Arg2)>::type>::type
    operator()(C &c, Arg1 arg1, Arg2 arg2) const
    {
    ...
    template <typename C, typename Arg1, typename Arg2, typename Arg3>
    typename stl_impl::disable_if_is_void<
        typename result<insert(C &, Arg1, Arg2, Arg3)>::type>::type
    operator()(
...
struct rbegin
{
    ...
    struct result<This(C &)>
    {
        typedef typename const_qualified_reverse_iterator_of<C>::type
            type;
    };
...
struct splice
{
    ...
    template <
        typename C, typename Arg1, typename Arg2, typename Arg3>
    void operator()(
        C &c, Arg1 arg1, Arg2 &arg2, Arg3 arg3) const
    {
    ...
    template <
        typename C, typename Arg1, typename Arg2, typename Arg3, typename Arg4>
    void operator()(
        C c, Arg1 arg1, Arg2 &arg2, Arg3 arg3, Arg4 arg4) const
    {
