...
#define BOOST_PHOENIX_SCOPE_DYNAMIC_MEMBER(_, N, __) \
    typedef                                          \
        typename expression::dynamic_member<         \
            mpl::int_<N>, self_type *>::type const   \
...
{
    typedef BOOST_PP_CAT(vector, BOOST_PHOENIX_ITERATION)<BOOST_PHOENIX_A> tuple_type;
    typedef dynamic<BOOST_PHOENIX_A>
        self_type;
    ...
    BOOST_PP_REPEAT(
        BOOST_PHOENIX_ITERATION, BOOST_PHOENIX_SCOPE_DYNAMIC_MEMBER, _)
