    ...
    typedef                                         \
        typename proto::result_of::value<           \
            typename proto::result_of::child_c<     \
                BOOST_PP_CAT(A, N), 0>::type>::type \
            BOOST_PP_CAT(tag_type, N);              \
                                                    \
    typedef                                         \
        typename proto::result_of::child_c<         \
            BOOST_PP_CAT(A, N), 1>::type            \
...
{
    BOOST_PP_REPEAT(
        BOOST_PHOENIX_ITERATION, BOOST_PHOENIX_TYPEDEF_LOCAL_TYPES, _)
    typedef fusion::map<
        BOOST_PP_REPEAT(
            BOOST_PHOENIX_ITERATION, BOOST_PHOENIX_TYPEDEF_LOCAL_PAIR_TYPES, _)>
        type;
    ...
    static type const make(BOOST_PHOENIX_A_a)
    {
        return type(
            BOOST_PP_REPEAT(
                BOOST_PHOENIX_ITERATION, BOOST_PHOENIX_CHILD_OF, _));
    }
};
