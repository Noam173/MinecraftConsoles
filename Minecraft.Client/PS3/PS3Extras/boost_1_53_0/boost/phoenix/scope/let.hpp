...
BOOST_PHOENIX_DEFINE_EXPRESSION(
    (boost)(phoenix)(let_), (proto::terminal<proto::_>) // Locals
...
struct let_eval
{
    ...
    struct result<This(Vars, Map, Expr, Context)>
    {
        ...
        typedef typename result_of::eval<
            Expr, typename result_of::context<
                      scoped_environment<
                          env_type, env_type, locals_type, map_type>,
                      actions_type>::type>::type
            type;
    };
...
struct is_nullary::when<rule::let_, Dummy>
    : proto::make<
          mpl::and_<
              ...
              evaluator(
                  proto::_child_c<2>, proto::call<functional::context(proto::make<mpl::true_()>, proto::make<detail::scope_is_nullary_actions()>)>, proto::make<proto::empty_env()>)>()>
{
};
} // namespace phoenix
} // namespace boost
