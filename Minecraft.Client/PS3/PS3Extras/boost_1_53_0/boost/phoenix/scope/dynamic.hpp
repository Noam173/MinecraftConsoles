...
#define BOOST_PHOENIX_DYNAMIC_CTOR_INIT(R, DATA, I, ELEM) \
    BOOST_PP_COMMA_IF(I)                                  \
    BOOST_PP_TUPLE_ELEM(2, 1, ELEM)(init<I>(this)) /**/

#define BOOST_PHOENIX_DYNAMIC_MEMBER(R, DATA, I, ELEM) \
    BOOST_PP_CAT(member, BOOST_PP_INC(I))              \
    ...
    struct NAME                                                                   \
        : ::boost::phoenix::dynamic<                                              \
              BOOST_PP_SEQ_FOR_EACH_I(                                            \
                  BOOST_PHOENIX_DYNAMIC_TEMPLATE_PARAMS, _, MEMBER)>              \
    {                                                                             \
        NAME()                                                                    \
...
#define BOOST_PHOENIX_DYNAMIC(NAME, MEMBER)                              \
    BOOST_PHOENIX_DYNAMIC_BASE(                                          \
        NAME, BOOST_PP_CAT(BOOST_PHOENIX_DYNAMIC_FILLER_0 MEMBER, _END)) \
    /**/

BOOST_PHOENIX_DEFINE_EXPRESSION(
    (boost)(phoenix)(dynamic_member), (proto::terminal<proto::_>)(proto::terminal<proto::_>))
...
struct dynamic_frame : noncopyable
{
    ...
    dynamic_frame(DynamicScope const &s, Tuple const &init)
        : tuple(init), save(s.frame), scope(s)
    {
        scope.frame = this;
    }
    ...
    struct result<This(N, Scope, Context)>
    {
        typedef
            typename boost::remove_pointer<
                typename proto::detail::uncvref<
                    typename proto::result_of::value<Scope>::type>::type>::type
                scope_type;
        typedef
        ...
        typedef
            typename fusion::result_of::at_c<
                tuple_type, proto::detail::uncvref<
                                typename proto::result_of::value<N>::type>::type::value>::type
                type;
    };
    ...
    operator()(N, Scope s, Context const &) const
    {
        return fusion::at_c<
            proto::detail::uncvref<
                typename proto::result_of::value<N>::type>::type::value>(
...
template <
    BOOST_PHOENIX_typename_A_void(BOOST_PHOENIX_DYNAMIC_LIMIT), typename Dummy = void>
struct dynamic;
