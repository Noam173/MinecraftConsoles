...
#define BOOST_PHOENIX_ADAPT_CALLABLE_NULLARY(NAME, FUNC)                              \
    boost::phoenix::detail::expression::function_eval<FUNC>::type const inline NAME() \
    {                                                                                 \
...
#define BOOST_PHOENIX_ADAPT_CALLABLE(NAME, FUNC, N)                                       \
    ...
    typename boost::phoenix::detail::expression::function_eval<                           \
        FUNC, BOOST_PHOENIX_A(N)>::type const inline NAME(BOOST_PHOENIX_A_const_ref_a(N)) \
    {                                                                                     \
        return boost::phoenix::detail::expression::                                       \
...
#define BOOST_PHOENIX_ADAPT_CALLABLE_VARARG(NAME, FUNC)                              \
    ...
    BOOST_PP_REPEAT_FROM_TO(                                                         \
        1, BOOST_PHOENIX_LIMIT, BOOST_PHOENIX_ADAPT_CALLABLE_VARARG_R, (NAME, FUNC)) \
    /**/

#define BOOST_PHOENIX_ADAPT_CALLABLE_VARARG_R(Z, N, D)                 \
    BOOST_PHOENIX_ADAPT_CALLABLE(                                      \
        BOOST_PP_TUPLE_ELEM(2, 0, D), BOOST_PP_TUPLE_ELEM(2, 1, D), N) \
    /**/
