...
#define BOOST_PHOENIX_ADAPT_FUNCTION_NULLARY(RESULT, NAME, FUNC)                                                         \
    ...
    boost::phoenix::detail::expression::function_eval<                                                                   \
        detail::BOOST_PP_CAT(NAME, _impl_nullary)>::type const inline NAME()                                             \
    {                                                                                                                    \
        return boost::phoenix::detail::expression::                                                                      \
            function_eval<detail::BOOST_PP_CAT(NAME, _impl_nullary)>::make(detail::BOOST_PP_CAT(NAME, _impl_nullary)()); \
    }                                                                                                                    \
    /**/
    ...
    {                                                                                                                                                                      \
        ...
        {                                                                                                                                                                  \
            return FUNC(BOOST_PHOENIX_a(N));                                                                                                                               \
                                                                                                                                                                           ...
                                                                                                                                                                           \
    template <BOOST_PHOENIX_typename_A(N)>                                                                                                                                 \
    typename boost::phoenix::detail::expression::function_eval<                                                                                                            \
        detail::BOOST_PP_CAT(BOOST_PP_CAT(NAME, _impl_), N), BOOST_PHOENIX_A(N)>::type const inline NAME(BOOST_PHOENIX_A_const_ref_a(N))                                   \
    {                                                                                                                                                                      \
        return boost::phoenix::detail::expression::                                                                                                                        \
            function_eval<                                                                                                                                                 \
                detail::BOOST_PP_CAT(BOOST_PP_CAT(NAME, _impl_), N), BOOST_PHOENIX_A(N)>::make(detail::BOOST_PP_CAT(BOOST_PP_CAT(NAME, _impl_), N)(), BOOST_PHOENIX_a(N)); \
    }                                                                                                                                                                      \
    /**/
...
#define BOOST_PHOENIX_ADAPT_FUNCTION_VARARG(RESULT, NAME, FUNC)                              \
    ...
    BOOST_PP_REPEAT_FROM_TO(                                                                 \
        1, BOOST_PHOENIX_LIMIT, BOOST_PHOENIX_ADAPT_FUNCTION_VARARG_R, (RESULT, NAME, FUNC)) \
    /**/

#define BOOST_PHOENIX_ADAPT_FUNCTION_VARARG_R(Z, N, D)                                               \
    BOOST_PHOENIX_ADAPT_FUNCTION(                                                                    \
        BOOST_PP_TUPLE_ELEM(3, 0, D), BOOST_PP_TUPLE_ELEM(3, 1, D), BOOST_PP_TUPLE_ELEM(3, 2, D), N) \
    /**/
