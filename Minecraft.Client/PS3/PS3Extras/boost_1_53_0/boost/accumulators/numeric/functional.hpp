...
#define BOOST_NUMERIC_FUNCTIONAL_DEFINE_UNARY_OP(Name, Op)                            \
    ...
    {                                                                                 \
        BOOST_TYPEOF_NESTED_TYPEDEF_TPL(                                              \
            nested, Op boost::numeric::functional::detail::lvalue_of<Arg>())          \
        typedef typename nested::type type;                                           \
    };                                                                                \
    template <typename Arg, typename EnableIf>                                        \
    struct Name##_base                                                                \
        : std::unary_function<                                                        \
              typename remove_const<Arg>::type, typename result_of_##Name<Arg>::type> \
    {                                                                                 \
...
#define BOOST_NUMERIC_FUNCTIONAL_DEFINE_BINARY_OP(Name, Op, RetType)                                                               \
    ...
    struct Name##_base                                                                                                             \
        : std::binary_function<                                                                                                    \
              typename remove_const<Left>::type, typename remove_const<Right>::type, typename result_of_##Name<Left, Right>::type> \
    {                                                                                                                              \
...
#define BOOST_NUMERIC_FUNCTIONAL_DEDUCED(Left, Op, Right)                   \
    BOOST_TYPEOF_NESTED_TYPEDEF_TPL(                                        \
        nested, boost::numeric::functional::detail::lvalue_of<Left>() Op    \
