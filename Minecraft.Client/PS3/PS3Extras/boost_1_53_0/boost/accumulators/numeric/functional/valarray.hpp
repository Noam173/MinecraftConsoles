...
typename lazy_enable_if<
    mpl::and_<is_scalar<Right>, mpl::not_<is_same<Left, Right>>>, acc_detail::make_valarray<functional::divides<Left, Right>>>::type
...
template <typename Left, typename Right>
typename lazy_enable_if<
    mpl::and_<is_scalar<Right>, mpl::not_<is_same<Left, Right>>>, acc_detail::make_valarray<functional::multiplies<Left, Right>>>::type
operator*(std::valarray<Left> const &left, Right const &right)
{
...
typename lazy_disable_if<
    is_same<Left, Right>, acc_detail::make_valarray<functional::plus<Left, Right>>>::type
...
#define BOOST_NUMERIC_FUNCTIONAL_DEFINE_VALARRAY_BIN_OP(Name, Op)                                                            \
    ...
    struct Name<Left, Right, std_valarray_tag, std_valarray_tag>                                                             \
        : std::binary_function<                                                                                              \
              Left, Right, std::valarray<typename Name<typename Left::value_type, typename Right::value_type>::result_type>> \
    {                                                                                                                        \
    ...
    struct Name<Left, Right, std_valarray_tag, void>                                                                         \
        : std::binary_function<                                                                                              \
              Left, Right, std::valarray<typename Name<typename Left::value_type, Right>::result_type>>                      \
    {                                                                                                                        \
        typedef typename Left::value_type left_value_type;                                                                   \
        typedef std::valarray<                                                                                               \
    ...
    struct Name<Left, Right, void, std_valarray_tag>                                                                         \
        : std::binary_function<                                                                                              \
              Left, Right, std::valarray<typename Name<Left, typename Right::value_type>::result_type>>                      \
    {                                                                                                                        \
        typedef typename Right::value_type right_value_type;                                                                 \
        typedef std::valarray<                                                                                               \
...
struct average<Left, Right, std_valarray_tag, RightTag>
    : mpl::if_<
          are_integral<typename Left::value_type, Right>, divides<Left, double const>, divides<Left, Right>>::type
{
};
