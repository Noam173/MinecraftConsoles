...
#define BOOST_DETAIL_function_arg(z, n, _) \
    typedef typename remove_reference<     \
        typename add_const<BOOST_PP_CAT(A, n)>::type>::type BOOST_PP_CAT(arg, n);

#define BOOST_DETAIL_cat_arg_counts(s, state, n)           \
    BOOST_PP_IF(                                           \
        n, BOOST_PP_CAT(state, BOOST_PP_CAT(_, n)), state) \
    /**/

#define function_name                                                                                             \
    BOOST_PP_SEQ_FOLD_LEFT(                                                                                       \
        BOOST_DETAIL_cat_arg_counts, BOOST_PP_CAT(function, BOOST_PP_SEQ_HEAD(args)), BOOST_PP_SEQ_TAIL(args)(0)) \
    /**/
...
{
    BOOST_PP_REPEAT(
        BOOST_MPL_LIMIT_METAFUNCTION_ARITY, BOOST_DETAIL_default_arg, ~)
            ...
            typename BOOST_PP_CAT(mpl::apply, BOOST_MPL_LIMIT_METAFUNCTION_ARITY)< \
                F                                                                  \
                    BOOST_PP_ENUM_TRAILING_PARAMS(                                 \
                        BOOST_MPL_LIMIT_METAFUNCTION_ARITY, arg)>::type            \
            impl;                                                                  \
...
#define arg_type(r, _, i, is_const) \
    BOOST_PP_COMMA_IF(i)            \
    BOOST_PP_CAT(A, i) BOOST_PP_CAT(const_if, is_const) &
...
#define param(r, _, i, is_const) \
    BOOST_PP_COMMA_IF(i)         \
    BOOST_PP_CAT(A, i)           \
        BOOST_PP_CAT(const_if, is_const) & BOOST_PP_CAT(x, i)
...
#define gen_operator(r, _, n)                          \
    BOOST_PP_SEQ_FOR_EACH_PRODUCT_R(                   \
        r, call_operator, BOOST_PP_REPEAT(n, bits, ~)) \
    /**/
