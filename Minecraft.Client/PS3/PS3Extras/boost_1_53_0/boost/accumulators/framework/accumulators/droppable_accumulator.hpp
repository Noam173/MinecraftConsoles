...
struct add_ref_visitor
{
    ...
    void operator()(Accumulator &acc) const
    {
        ...
        this->args_[accumulator].template visit_if<detail::contains_feature_of_<dependencies>>(
            *this);
    }
    ...
    : as_feature<Feature>::type
{
    ...
    typedef
        typename mpl::transform<
            typename feature_type::dependencies, as_droppable<mpl::_1>>::type
            dependencies;
