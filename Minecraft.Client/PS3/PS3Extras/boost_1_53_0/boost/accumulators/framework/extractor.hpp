...
struct argument_pack_result
    : accumulator_set_result<
          typename remove_reference<
              typename parameter::binding<Args, tag::accumulator>::type>::type,
          Feature>
{
};
...
struct extractor_result
    : mpl::eval_if<
          detail::is_accumulator_set<A>, accumulator_set_result<A, Feature>, argument_pack_result<A, Feature>>
{
};
...
#define BOOST_ACCUMULATORS_EXTRACTOR_FUN_OP(z, n, _)                                       \
    ...
    operator()(                                                                            \
        AccumulatorSet const &acc                                                          \
            BOOST_PP_ENUM_TRAILING_BINARY_PARAMS_Z(z, n, A, const &a)) const               \
    {                                                                                      \
        BOOST_MPL_ASSERT((detail::is_accumulator_set<AccumulatorSet>));                    \
        typedef typename as_feature<Feature>::type feature_type;                           \
    ...
    BOOST_PP_REPEAT_FROM_TO(
        2, BOOST_PP_INC(BOOST_ACCUMULATORS_MAX_ARGS), BOOST_ACCUMULATORS_EXTRACTOR_FUN_OP, _)
...
#define BOOST_ACCUMULATORS_DEFINE_EXTRACTOR_FUN_IMPL(z, n, Tag, Feature, ParamsSeq)     \
    ...
    typename boost::accumulators::detail::extractor_result<                             \
        Arg1, BOOST_ACCUMULATORS_MAKE_FEATURE(Tag, Feature, ParamsSeq)>::type           \
...
#define BOOST_ACCUMULATORS_DEFINE_EXTRACTOR_FUN(z, n, _) \
    BOOST_ACCUMULATORS_DEFINE_EXTRACTOR_FUN_IMPL(        \
        z, n, BOOST_PP_ARRAY_ELEM(0, _), BOOST_PP_ARRAY_ELEM(1, _), BOOST_PP_ARRAY_ELEM(2, _))

#define BOOST_ACCUMULATORS_DEFINE_EXTRACTOR(Tag, Feature, ParamSeq) \
    BOOST_PP_REPEAT(                                                \
        BOOST_PP_INC(BOOST_ACCUMULATORS_MAX_ARGS), BOOST_ACCUMULATORS_DEFINE_EXTRACTOR_FUN, (3, (Tag, Feature, ParamSeq)))
