...
struct intersection_multi_linestring_multi_linestring_point
{
                                       ...
                                       Strategy const &strategy)
    {
        ...
        for (typename boost::range_iterator<
                 MultiLinestring1 const>::type it1 = boost::begin(ml1);
             it1 != boost::end(ml1);
             ++it1)
        {
            for (typename boost::range_iterator<
                     MultiLinestring2 const>::type it2 = boost::begin(ml2);
                 it2 != boost::end(ml2);
                 ++it2)
            {
                out = intersection_linestring_linestring_point<PointOut>::apply(*it1, *it2, out, strategy);
            }
        }
...
struct intersection_linestring_multi_linestring_point
{
    ...
    {
        for (typename boost::range_iterator<
                 MultiLinestring const>::type it = boost::begin(ml);
             it != boost::end(ml);
             ++it)
        {
            out = intersection_linestring_linestring_point<PointOut>::apply(linestring, *it, out, strategy);
        }
                                       ...
                                       Strategy const &strategy)
    {
             ...
             ++it)
        {
            out = intersection_of_linestring_with_areal<
                ReverseAreal, LineStringOut, OverlayType>::apply(*it, areal, out, strategy);
        }
...
struct intersection_of_areal_with_multi_linestring
{
                                       ...
                                       Strategy const &strategy)
    {
        return intersection_of_multi_linestring_with_areal<
            ReverseAreal, LineStringOut, OverlayType>::apply(ml, areal, out, strategy);
    }
};
...
struct clip_multi_linestring
{
                                       ...
                                       Box const &box, OutputIterator out, Strategy const &)
    {
        ...
        for (typename boost::range_iterator<MultiLinestring const>::type it = boost::begin(multi_linestring);
             it != boost::end(multi_linestring); ++it)
        {
            out = detail::intersection::clip_range_with_box<LinestringOut>(box, *it, out, lb_strategy);
        }
        return out;
    }
};
...
struct intersection_insert<
    ...
    false, false, false> : detail::intersection::intersection_multi_linestring_multi_linestring_point<GeometryOut>
{
};
...
struct intersection_insert<
    ...
    false, false, false> : detail::intersection::intersection_linestring_multi_linestring_point<GeometryOut>
{
};
...
struct intersection_insert<
    ...
    false, true, false> : detail::intersection::clip_multi_linestring<GeometryOut>
{
};
...
struct intersection_insert<
    ...
    false, true, false> : detail::intersection::intersection_of_linestring_with_areal<ReverseMultiPolygon,
                                                                                      GeometryOut,
                                                                                      OverlayType>
{
};
...
struct intersection_insert<
    ...
    true, false, false> : detail::intersection::intersection_of_areal_with_multi_linestring<ReversePolygon,
                                                                                            GeometryOut,
                                                                                            OverlayType>
{
};
...
struct intersection_insert<
    ...
    false, true, false> : detail::intersection::intersection_of_multi_linestring_with_areal<ReverseRing,
                                                                                            GeometryOut,
                                                                                            OverlayType>
{
};
...
struct intersection_insert<
    ...
    false, true, false> : detail::intersection::intersection_of_multi_linestring_with_areal<ReverseMultiPolygon,
                                                                                            GeometryOut,
                                                                                            OverlayType>
{
};
