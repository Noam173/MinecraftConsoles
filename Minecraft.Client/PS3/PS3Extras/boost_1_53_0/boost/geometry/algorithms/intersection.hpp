...
struct intersection_box_box
{
                             ...
                             Strategy const &strategy)
    {
        ...
        return intersection_box_box<Dimension + 1, DimensionCount>::apply(box1, box2, box_out, strategy);
    }
};
...
struct intersection
{
                             ...
                             Strategy const &strategy)
    {
        ...
        intersection_insert<
            ...
            overlay_intersection>::apply(geometry1, geometry2, std::back_inserter(geometry_out), strategy);
    ...
    : intersection<Geometry2, Geometry1, Tag2, Tag1, false>
{
        ...
        Strategy const &strategy)
    {
        return intersection<
            Geometry2, Geometry1,
            Tag2, Tag1,
            false>::apply(g2, g1, out, strategy);
    }
};
...
struct intersection<
    Box1, Box2,
    box_tag, box_tag,
    Reverse> : public detail::intersection::intersection_box_box<0, geometry::dimension<Box1>::value>
{
};
                         ...
                         GeometryOut &geometry_out)
{
    ...
    return dispatch::intersection<
        Geometry1,
        Geometry2>::apply(geometry1, geometry2, geometry_out, strategy());
}
