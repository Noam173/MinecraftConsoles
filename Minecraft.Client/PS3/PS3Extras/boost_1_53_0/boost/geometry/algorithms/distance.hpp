...
struct point_to_segment
{
                                                             ...
                                                             Segment const &segment, Strategy const &)
    {
        typename strategy::distance::services::default_strategy<
            ...
            Strategy>::type segment_strategy;
                                             ...
                                             PPStrategy const &pp_strategy, PSStrategy const &ps_strategy)
    {
        return distance_containment(
            point_to_range<
                ...
                Closure,
                PPStrategy,
                PSStrategy>::apply(point, ring, pp_strategy, ps_strategy),
          ...
          false>
{
        ...
        typename detail::distance::default_strategy<Geometry1, Geometry2>::type const &)
    {
        return distance<
            ...
            Tag2, Tag1, StrategyTag,
            false>::apply(g2, g1, reversed_strategy());
    }
};
    ...
    false>
{
                                                             ...
                                                             Strategy const &strategy)
    {
        ...
        return detail::distance::point_to_range<
            Point, Linestring, closed, Strategy, ps_strategy_type>::apply(point, linestring, strategy, ps_strategy_type());
    }
};
    ...
    false>
{
                                                             ...
                                                             Strategy const &strategy)
    {
        ...
        return detail::distance::point_to_range<
            Point, Linestring, closed, pp_strategy_type, Strategy>::apply(point, linestring, pp_strategy_type(), strategy);
    }
};
    ...
    false>
{
                                    ...
                                    Strategy const &strategy)
    {
        typedef typename strategy::distance::services::default_strategy<
            segment_tag,
            Point,
            typename point_type<Ring>::type>::type ps_strategy_type;

        std::pair<return_type, bool>
            dc = detail::distance::point_to_ring<
                Point, Ring,
                geometry::closure<Ring>::value,
                Strategy, ps_strategy_type>::apply(point, ring, strategy, ps_strategy_type());
    ...
    false>
{
                                    ...
                                    Strategy const &strategy)
    {
        typedef typename strategy::distance::services::default_strategy<
            segment_tag,
            Point,
            typename point_type<Polygon>::type>::type ps_strategy_type;

        std::pair<return_type, bool>
            dc = detail::distance::point_to_polygon<
                Point, Polygon,
                geometry::closure<Polygon>::value,
                Strategy, ps_strategy_type>::apply(point, polygon, strategy, ps_strategy_type());
...
struct distance<
    ...
    false> : detail::distance::point_to_segment<Point, Segment, Strategy>
{
};
    ...
    Strategy const &strategy)
{
    ...
    return dispatch::distance<
        Geometry1,
        Geometry2,
        Strategy>::apply(geometry1, geometry2, strategy);
}
