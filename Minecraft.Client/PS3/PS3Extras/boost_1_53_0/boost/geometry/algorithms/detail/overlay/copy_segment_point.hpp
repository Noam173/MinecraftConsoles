...
struct copy_segment_point_polygon
{
                             ...
                             PointOut &point)
    {
        ...
        return copy_segment_point_range<
            ...
            Reverse,
            SegmentIdentifier,
            PointOut>::apply(seg_id.ring_index < 0
...
struct copy_segment_point
{
    BOOST_MPL_ASSERT_MSG(
        false, NOT_OR_NOT_YET_IMPLEMENTED_FOR_THIS_GEOMETRY_TYPE, (types<GeometryIn>));
};
                               ...
                               PointOut &point_out)
{
    ...
    return dispatch::copy_segment_point<
        ...
        Reverse,
        SegmentIdentifier,
        PointOut>::apply(geometry, seg_id, second, point_out);
}
                               ...
                               PointOut &point_out)
{
    ...
    if (seg_id.source_index == 0)
    {
        return dispatch::copy_segment_point<
            ...
            Reverse1,
            SegmentIdentifier,
            PointOut>::apply(geometry1, seg_id, second, point_out);
    }
    else if (seg_id.source_index == 1)
    {
        return dispatch::copy_segment_point<
            ...
            Reverse2,
            SegmentIdentifier,
            PointOut>::apply(geometry2, seg_id, second, point_out);
    }
    // Exception?
    return false;
}
                                ...
                                PointOut &point1, PointOut &point2)
{
    ...
    return copy_segment_point<Reverse1, Reverse2>(geometry1, geometry2, seg_id, false, point1) && copy_segment_point<Reverse1, Reverse2>(geometry1, geometry2, seg_id, true, point2);
}
