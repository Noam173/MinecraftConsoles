...
struct intersection_segment_segment_point
{
                                       ...
                                       Strategy const &)
    {
        ...
        segment_intersection_points<point_type> is = strategy::intersection::relate_cartesian_segments<
            policies::relate::segments_intersection_points<
                Segment1,
                Segment2,
                segment_intersection_points<point_type>>>::apply(segment1, segment2);
...
struct intersection_of_linestring_with_areal
{
                                       ...
                                       Strategy const &)
    {
        ...
        geometry::get_turns<
            ...
            detail::overlay::calculate_distance_policy>(linestring, areal, turns, policy);
...
struct intersection_insert
{
    BOOST_MPL_ASSERT_MSG(
        false, NOT_OR_NOT_YET_IMPLEMENTED_FOR_THIS_GEOMETRY_TYPES_OR_ORIENTATIONS, (types<Geometry1, Geometry2, GeometryOut>));
};
...
struct intersection_insert<
    ...
    true, true, true> : detail::overlay::overlay<Geometry1, Geometry2, Reverse1, Reverse2, ReverseOut, GeometryOut, OverlayType>
{
};
...
struct intersection_insert<
    ...
    true, true, true> : detail::overlay::overlay<Geometry, Box, Reverse1, Reverse2, ReverseOut, GeometryOut, OverlayType>
{
};
...
struct intersection_insert<
    ...
    false, false, false> : detail::intersection::intersection_segment_segment_point<GeometryOut>
{
};
...
struct intersection_insert<
    ...
    false, false, false> : detail::intersection::intersection_linestring_linestring_point<GeometryOut>
{
};
    ...
    false, true, false>
{
                                       ...
                                       Box const &box, OutputIterator out, Strategy const &)
    {
        ...
        return detail::intersection::clip_range_with_box<GeometryOut>(box, linestring, out, lb_strategy);
    }
};
...
struct intersection_insert<
    ...
    false, true, false> : detail::intersection::intersection_of_linestring_with_areal<ReversePolygon,
                                                                                      GeometryOut,
                                                                                      OverlayType>
{
};
...
struct intersection_insert<
    ...
    false, true, false> : detail::intersection::intersection_of_linestring_with_areal<ReverseRing,
                                                                                      GeometryOut,
                                                                                      OverlayType>
{
};
    ...
    false, true, false>
{
                                       ...
                                       Box const &box, OutputIterator out, Strategy const &)
    {
        ...
        typedef typename point_type<GeometryOut>::type point_type;
        strategy::intersection::liang_barsky<Box, point_type> lb_strategy;
        return detail::intersection::clip_range_with_box<GeometryOut>(box, range, out, lb_strategy);
    }
};
    ...
    Areal1, Areal2, false>
{
                                       ...
                                       Geometry2 const &geometry2, OutputIterator out, Strategy const &)
    {
        ...
        detail::get_turns::no_interrupt_policy policy;
        geometry::get_turns<
            false, false, detail::overlay::assign_null_policy>(geometry1, geometry2, turns, policy);
        for (typename std::vector<turn_info>::const_iterator it = turns.begin(); it != turns.end(); ++it)
        {
            *out++ = it->point;
        }
...
struct intersection_insert_reversed
{
                                       ...
                                       Strategy const &strategy)
    {
        return intersection_insert<
            ...
            OverlayType,
            Reverse2, Reverse1, ReverseOut>::apply(g2, g1, out, strategy);
    }
};
                             ...
                             Strategy const &strategy)
{
    return boost::mpl::if_c<
        ...
        geometry::dispatch::intersection_insert<
            ...
            geometry::detail::overlay::do_reverse<geometry::point_order<Geometry2>::value, ReverseSecond>::value>>::type::apply(geometry1, geometry2, out, strategy);
}
                                          ...
                                          Strategy const &strategy)
{
    ...
    return detail::intersection::insert<
        GeometryOut, false, overlay_intersection>(geometry1, geometry2, out, strategy);
}
