    ...
    Segment const &segment)
{
    ...
    geometry::detail::assign::assign_point_from_index<
        Segment, point_type, Index, 0, dimension<Segment>::type::value>::apply(segment, point);
    return point;
}
...
struct relate_cartesian_segments
{
    ...
    typedef typename select_calculation_type<segment_type1, segment_type2, CalculationType>::type coordinate_type;
                                    ...
                                    coordinate_type const &dx_b, coordinate_type const &dy_b)
    {
        ...
        sides.set<0>(
            side::apply(detail::get_from_index<0>(b), detail::get_from_index<1>(b), detail::get_from_index<0>(a)),
            side::apply(detail::get_from_index<0>(b), detail::get_from_index<1>(b), detail::get_from_index<1>(a)));
        sides.set<1>(
            side::apply(detail::get_from_index<0>(a), detail::get_from_index<1>(a), detail::get_from_index<0>(b)),
            side::apply(detail::get_from_index<0>(a), detail::get_from_index<1>(a), detail::get_from_index<1>(b)));
        ...
        typedef typename select_most_precise<
            coordinate_type, double>::type promoted_type;
  ...
  private:
    ...
    {
        return math::equals(get<0>(point1), get<0>(point2)) && math::equals(get<1>(point1), get<1>(point2));
    }
    ...
    static inline bool analyse_equal(segment_type1 const &a, segment_type2 const &b)
    {
        ...
        return math::equals(a_1, b_1) || math::equals(a_2, b_1) || math::equals(a_1, b_2) || math::equals(a_2, b_2);
    }
    ...
    static inline return_type relate_collinear(segment_type1 const &a, segment_type2 const &b, coordinate_type a_1, coordinate_type a_2, coordinate_type b_1, coordinate_type b_2, bool a_swapped, bool b_swapped)
    {
        ...
        bool const a1_eq_b1 = both_swapped ? swapped_a2_eq_b2 : a_swapped ? swapped_a2_eq_b1
                                                            : b_swapped   ? swapped_a1_eq_b2
                                                                          : swapped_a1_eq_b1;
        bool const a2_eq_b2 = both_swapped ? swapped_a1_eq_b1 : a_swapped ? swapped_a1_eq_b2
                                                            : b_swapped   ? swapped_a2_eq_b1
                                                                          : swapped_a2_eq_b2;

        bool const a1_eq_b2 = both_swapped ? swapped_a2_eq_b1 : a_swapped ? swapped_a2_eq_b2
                                                            : b_swapped   ? swapped_a1_eq_b1
                                                                          : swapped_a1_eq_b2;
        bool const a2_eq_b1 = both_swapped ? swapped_a1_eq_b2 : a_swapped ? swapped_a1_eq_b1
                                                            : b_swapped   ? swapped_a2_eq_b2
                                                                          : swapped_a2_eq_b1;
        ...
        if ((swapped_a2_eq_b1 || swapped_a1_eq_b2) && !swapped_a1_eq_b1 && !swapped_a2_eq_b2)
        {
            if (a2_eq_b1)
            {
                return Policy::collinear_touch(get<1, 0>(a), get<1, 1>(a), 0, -1);
            }
            if (a1_eq_b2)
            {
                return Policy::collinear_touch(get<0, 0>(a), get<0, 1>(a), -1, 0);
            }
            if (a2_eq_b2)
            {
                return Policy::collinear_touch(get<1, 0>(a), get<1, 1>(a), 0, 0);
            }
            if (a1_eq_b1)
            {
                return Policy::collinear_touch(get<0, 0>(a), get<0, 1>(a), -1, -1);
            }
        }
        ...
        if (has_common_points)
        {
            ...
            if (a2_eq_b2)
            {
                return Policy::collinear_interior_boundary_intersect(a_in_b ? a : b, a_in_b, 0, 0, false);
            }
            if (a1_eq_b2)
            {
                return Policy::collinear_interior_boundary_intersect(a_in_b ? a : b, a_in_b, arrival_a, 0, true);
            }
            if (a2_eq_b1)
            {
                return Policy::collinear_interior_boundary_intersect(a_in_b ? a : b, a_in_b, 0, -arrival_a, true);
            }
            if (a1_eq_b1)
            {
                return Policy::collinear_interior_boundary_intersect(a_in_b ? a : b, a_in_b, arrival_a, -arrival_a, false);
            }
        }
        ...
        */
        ...
        if (b_1 < a_2 && a_2 < b_2)
        {
            ...
            return both_swapped ? Policy::collinear_overlaps(get<0, 0>(a), get<0, 1>(a), get<1, 0>(b), get<1, 1>(b), -1, 1, opposite)
        ...
        if (b_1 < a_1 && a_1 < b_2)
        {
            ...
            return both_swapped ? Policy::collinear_overlaps(get<0, 0>(b), get<0, 1>(b), get<1, 0>(a), get<1, 1>(a), 1, -1, opposite)
