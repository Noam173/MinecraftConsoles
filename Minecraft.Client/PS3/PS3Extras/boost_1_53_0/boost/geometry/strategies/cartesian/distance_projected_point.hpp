...
class projected_point
{
  public:
    ...
    typedef typename promote_floating_point<
        typename strategy::distance::services::return_type<
            Strategy>::type>::type calculation_type;
  ...
  private:
    ...
    typedef typename strategy::distance::services::similar_type<
        Strategy,
        Point,
        fp_point_type>::type fp_strategy_type;
  ...
  public:
                                  ...
                                  PointOfSegment const &p1, PointOfSegment const &p2) const
    {
        ...
        */
        ...
        fp_strategy_type fp_strategy = strategy::distance::services::get_similar<
            Strategy, Point, fp_point_type>::apply(strategy);
...
struct get_similar<projected_point<Point, PointOfSegment, CalculationType, Strategy>, P1, P2>
{
    static inline typename similar_type<
        projected_point<Point, PointOfSegment, CalculationType, Strategy>, P1, P2>::type
    apply(projected_point<Point, PointOfSegment, CalculationType, Strategy> const &)
    {
...
struct get_comparable<projected_point<Point, PointOfSegment, CalculationType, Strategy>>
{
    typedef typename comparable_type<
        projected_point<Point, PointOfSegment, CalculationType, Strategy>>::type comparable_type;
    ...
    typedef strategy::distance::projected_point<
        ...
        typename boost::mpl::if_<
            ...
            typename default_strategy<
                ...
                cartesian_tag, cartesian_tag>::type,
            Strategy>::type>
        type;
};
