...
{
    BOOST_MPL_ASSERT_MSG(
        false, NOT_IMPLEMENTED_FOR_THIS_STRATEGY, (types<Strategy, Point1, Point2>));
};
...
{
    BOOST_MPL_ASSERT_MSG(
        false, NOT_IMPLEMENTED_FOR_THIS_POINT_TYPE_COMBINATION, (types<Point1, Point2, CsTag1, CsTag2>));
};
