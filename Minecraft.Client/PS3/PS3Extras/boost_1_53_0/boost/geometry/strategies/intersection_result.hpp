...
struct de9im
{
    ...
    inline de9im()
        : ii(-1), ib(-1), ie(-1), bi(-1), bb(-1), be(-1), ei(-1), eb(-1), ee(-1)
    {
    }
    ...
    inline de9im(int ii0, int ib0, int ie0,
        ...
        : ii(ii0), ib(ib0), ie(ie0), bi(bi0), bb(bb0), be(be0), ei(ei0), eb(eb0), ee(ee0)
    {
    }
...
struct de9im_segment : public de9im
{
    ...
    inline de9im_segment()
        : de9im(), collinear(false), opposite(false), parallel(false), degenerate(false)
    {
    }
    ...
    inline de9im_segment(double a, double b,
        ...
        : de9im(ii0, ib0, ie0, bi0, bb0, be0, ei0, eb0, ee0), collinear(c), opposite(o), parallel(p), degenerate(d), ra(a), rb(b)
    {
    }
