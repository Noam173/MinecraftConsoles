        ...
        struct checker
        {
            ...
            static void apply(ApplyMethod const &)
            {
                ...
                typedef typename parameter_type_of<
                    ApplyMethod, 0>::type ptype1;

                typedef typename parameter_type_of<
                    ApplyMethod, 1>::type ptype2;
                ...
                typedef typename strategy::distance::services::similar_type<
                    Strategy, ptype2, ptype1>::type stype;
    ...
    struct PointSegmentDistanceStrategy
    {
      ...
      private:
        struct checker
        {
            ...
            {
                typedef typename parameter_type_of<
                    ApplyMethod, 0>::type ptype;

                typedef typename parameter_type_of<
                    ApplyMethod, 1>::type sptype;
