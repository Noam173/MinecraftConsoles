...
class iterator_geometry_to_set<rectangle_concept, rectangle_type>
{
  ...
  public:
    ...
    iterator_geometry_to_set(const rectangle_type &rectangle, direction_1d dir,
                             orientation_2d orient = HORIZONTAL, bool is_hole = false, bool = false, direction_1d = CLOCKWISE) : rectangle_(), vertex_(), corner_(0), orient_(orient), is_hole_(is_hole)
    {
...
class iterator_geometry_to_set<polygon_90_concept, polygon_type>
{
  ...
  public:
    ...
    iterator_geometry_to_set(const polygon_type &polygon, direction_1d dir, orientation_2d orient = HORIZONTAL, bool is_hole = false, bool winding_override = false, direction_1d w = CLOCKWISE) : vertex_(), itrb(), itre(), last_vertex_(),
    ...
    iterator_geometry_to_set(const iterator_geometry_to_set &that) : vertex_(), itrb(), itre(), last_vertex_(), is_hole_(), multiplier_(), first_pt(),
...
class iterator_geometry_to_set<polygon_90_with_holes_concept, polygon_with_holes_type>
{
  ...
  public:
    ...
    iterator_geometry_to_set(const polygon_with_holes_type &polygon, direction_1d dir,
                             orientation_2d orient = HORIZONTAL, bool is_hole = false, bool = false, direction_1d = CLOCKWISE) : itrb(), itre(), itrhib(), itrhie(), itrhb(), itrhe(), orient_(orient), is_hole_(is_hole), started_holes()
    {
    ...
    iterator_geometry_to_set(const iterator_geometry_to_set &that) : itrb(), itre(), itrhib(), itrhie(), itrhb(), itrhe(), orient_(), is_hole_(), started_holes()
    {
        itrb = that.itrb;
        itre = that.itre;
