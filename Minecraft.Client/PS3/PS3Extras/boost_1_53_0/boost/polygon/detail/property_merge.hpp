...
class property_merge_point
{
  ...
  public:
    ...
    inline void x(coordinate_type value)
    {
        x_ = value;
    }
    inline void y(coordinate_type value)
    {
        y_ = value;
    }
};
...
class property_merge_interval
{
  ...
  public:
    ...
    inline coordinate_type low() const
    {
        return low_;
    }
    inline coordinate_type high() const
    {
        return high_;
    }
    inline void low(coordinate_type value)
    {
        low_ = value;
    }
    inline void high(coordinate_type value)
    {
        high_ = value;
    }
};
...
class merge_scanline
{
  public:
    ...
    merge_scanline(const merge_scanline &that) : output(that.output),
  ...
  private:
    ...
    class less_vertex_data
    {
      public:
        ...
        {
            if (lvalue.first.x() < rvalue.first.x())
            {
                return true;
            }
            if (lvalue.first.x() > rvalue.first.x())
            ...
            if (lvalue.first.y() < rvalue.first.y())
            {
                return true;
            }
            return false;
