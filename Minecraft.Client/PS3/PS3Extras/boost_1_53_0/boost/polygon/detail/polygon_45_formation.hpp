...
struct polygon_45_formation : public boolean_op_45<Unit>
{
    ...
    typedef typename boolean_op_45<Unit>::template Scan45<Count2, typename boolean_op_45<Unit>::template boolean_op_45_output_functor<0>> Scan45;
    ...
    class ActiveTail45
    {
      ...
      public:
        ...
        // constructor
        inline ActiveTail45(const Vertex45 &vertex, ActiveTail45 *otherTailp = 0) : tailp_(0), otherTailp_(0), holesList_(), head_(0)
        {
        ...
        inline ActiveTail45(Point point, ActiveTail45 *otherTailp, bool head = true) : tailp_(0), otherTailp_(0), holesList_(), head_(0)
        {
            tailp_ = new PolyLine45;
        ...
        inline ActiveTail45(ActiveTail45 *otherTailp) : tailp_(0), otherTailp_(0), holesList_(), head_(0)
        {
        ...
        // copy constructor
        inline ActiveTail45(const ActiveTail45 &that) : tailp_(0), otherTailp_(0), holesList_(), head_(0)
        {
            (*this) = that;
        }
         ...
         */
        inline PolyLine45 *getTail() const
        {
            return tailp_;
        }
         ...
         */
        inline PolyLine45 *getOtherTail() const
        {
         ...
         */
        inline ActiveTail45 *getOtherActiveTail() const
        {
            return otherTailp_;
        }
         ...
         */
        inline bool isOtherTail(const ActiveTail45 &b) const
        {
         ...
         */
        inline ActiveTail45 &updateTail(PolyLine45 *newTail)
        {
            tailp_ = newTail;
            return *this;
        }
         ...
         */
        inline const std::list<ActiveTail45 *> &getHoles() const
        {
            return holesList_;
        }
         ...
         */
        inline void copyHoles(ActiveTail45 &that)
        {
    ...
    class Vertex45CountT
    {
      public:
        ...
        {
            counts[0] = counts[1] = counts[2] = counts[3] = count;
            return *this;
        }
        ...
        inline ct &operator[](int index)
        {
            return counts[index];
        }
        inline ct operator[](int index) const
        {
            return counts[index];
        }
        inline Vertex45CountT &operator+=(const Vertex45CountT &count)
        ...
        {
            counts[element.rise + 1] += element.count;
            return *this;
        }
    ...
    class Vertex45CompactT
    {
      public:
        ...
        inline bool haveVertex45(int index) const
        {
            return count[index];
        }
    ...
    class Polygon45Formation
    {
      ...
      public:
        ...
        inline Polygon45Formation(const Polygon45Formation &that) : scanData_(), x_((std::numeric_limits<Unit>::min)()), justBefore_(false), fractureHoles_(0)
        {
            (*this) = that;
        }
    ...
    class Polygon45Tiling
    {
      ...
      public:
        ...
        inline Polygon45Tiling(const Polygon45Tiling &that) : scanData_(), x_((std::numeric_limits<Unit>::min)()), justBefore_(false)
        {
            (*this) = that;
        }
  ...
  public:
    ...
    class iteratorHoles
    {
      ...
      public:
        ...
        inline bool operator==(const iteratorHoles &that)
        {
    ...
    inline iteratorHoles begin_holes() const
    {
        return iteratorHoles(p_->getHoles().begin());
    }
    inline iteratorHoles end_holes() const
    {
        return iteratorHoles(p_->getHoles().end());
    }
    inline ActiveTail45 *yield()
    {
        return p_;
    }
...
template <typename T>
struct PolyLineByConcept<T, polygon_45_with_holes_concept>
{
    typedef PolyLine45PolygonData<T> type;
};
template <typename T>
struct PolyLineByConcept<T, polygon_with_holes_concept>
{
    typedef PolyLine45PolygonData<T> type;
};
template <typename T>
struct PolyLineByConcept<T, polygon_45_concept>
{
    typedef PolyLine45HoleData<T> type;
};
template <typename T>
struct PolyLineByConcept<T, polygon_concept>
{
    typedef PolyLine45HoleData<T> type;
};

template <typename T>
struct geometry_concept<PolyLine45PolygonData<T>>
{
    typedef polygon_45_with_holes_concept type;
};
template <typename T>
struct geometry_concept<PolyLine45HoleData<T>>
{
