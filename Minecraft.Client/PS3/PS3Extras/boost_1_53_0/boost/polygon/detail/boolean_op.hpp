...
class BooleanOp
{
  ...
  public:
    inline BooleanOp() : scanData_(), nextItr_(), nullT_()
    {
        nextItr_ = scanData_.end();
        nullT_ = 0;
    }
    inline BooleanOp(T nullT) : scanData_(), nextItr_(), nullT_(nullT)
    {
        nextItr_ = scanData_.end();
    }
...
class BinaryCount
{
  public:
    ...
    inline BinaryCount &operator=(int count)
    {
        counts_[0] = count, counts_[1] = count;
        return *this;
    }
...
class UnaryCount
{
  public:
    ...
    inline UnaryCount &operator=(int count)
    {
        count_ = count;
        return *this;
    }
    inline UnaryCount &operator=(const UnaryCount &that)
    {
        count_ = that.count_;
        return *this;
    }
    ...
    inline bool operator==(const UnaryCount &that) const
    {
    ...
    inline UnaryCount operator+(const UnaryCount &that) const
    {
        UnaryCount tmp(*this);
        tmp += that;
        return tmp;
    ...
    inline UnaryCount operator-() const
    {
        UnaryCount tmp;
        return tmp - *this;
    }
