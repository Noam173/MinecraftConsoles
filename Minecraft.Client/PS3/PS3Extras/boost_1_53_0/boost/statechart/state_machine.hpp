...
class send_function
{
  public:
    ...
    send_function(
        ...
        IdType eventType) : toState_(toState), evt_(evt), eventType_(eventType)
    {
    }
...
struct state_cast_impl : public mpl::if_<
                             ...
                             state_cast_impl_reference_target>::type
{
};
...
class history_key
{
  ...
  private:
    ...
    history_key(
        ...
        orthogonal_position_type historizedOrthogonalRegion) : historyContextType_(historyContextType),
...
// typically small compared to the cycles dynamic_cast needs
      ...
      public:
        ...
        explicit state_iterator(
            typename state_base_type::state_list_type::const_iterator
                baseIterator) : baseIterator_(baseIterator)
        {
        }
  ...
  protected:
    //////////////////////////////////////////////////////////////////////////
    state_machine() : currentStatesEnd_(currentStates_.end()),
                      pOutermostState_(0),
  ...
  public:
    ...
    void store_deep_history()
    {
        ...
        typedef detail::constructor<
            history_context_list, outermost_context_base_type>
            constructor_type;
        // 5.2.10.6 declares that reinterpret_casting a function pointer to a
        // different function pointer and back must yield the same value. The
        // following reinterpret_cast is the first half of such a sequence.
  ...
  private: // implementation
    ...
    class initial_construct_function
    {
      public:
        //////////////////////////////////////////////////////////////////////
        initial_construct_function(state_machine &machine) : machine_(machine)
        {
        }
        ...
        state_base_type *pCurrentState)
    {
        ...
        state_base_type *const pOutermostUnstableState =
            get_pointer(pOutermostUnstableState_);
        state_base_type *const pHandlingState = pOutermostUnstableState == 0 ? pCurrentState : pOutermostUnstableState;
    ...
    class exception_event_handler
    {
      public:
        ...
        exception_event_handler(
            ...
            state_base_type *pCurrentState = 0) : machine_(machine),
    ...
    class terminator
    {
      public:
        //////////////////////////////////////////////////////////////////////
        terminator(
            state_machine &machine, const event_base *pNewTriggeringEvent) : machine_(machine),
    ...
    typedef std::map<
        ...
        typename boost::detail::allocator::rebind_to<
            allocator_type, std::pair<const history_key_type, void (*)()>>::type>
        history_map_type;
    ...
    typedef std::map<
        ...
        typename boost::detail::allocator::rebind_to<
            allocator_type,
            std::pair<const state_base_type *const, event_queue_type>>::type>
        deferred_map_type;
