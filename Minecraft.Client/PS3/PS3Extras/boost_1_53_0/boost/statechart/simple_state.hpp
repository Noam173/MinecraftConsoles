...
class transition_function
{
  public:
    transition_function(
        ...
        const Event &evt) : pTransitionAction_(pTransitionAction),
                            evt_(evt)
    {
    }
                                                           ...
                                                           typename Context::inner_context_type, InnerInitial>::type
{
  ...
  public:
    ...
    typedef typename mpl::or_<
        deep_history,
        typename context_type::inherited_deep_history>::type inherited_deep_history;
  ...
  private:
    ...
    result transit_impl(const TransitionAction &transitionAction)
    {
        ...
        typedef typename mpl::distance<
            ...
            typename mpl::find<
                possible_transition_contexts, TransitionContext>::type>::type proposed_transition_context_position;

        typedef typename mpl::plus<
            termination_state_position,
            mpl::long_<1>>::type uml_transition_context_position;

        typedef typename mpl::deref<typename mpl::max_element<
            mpl::list<
                proposed_transition_context_position,
                uml_transition_context_position>,
            mpl::greater<mpl::placeholders::_, mpl::placeholders::_>>::type>::type real_transition_context_position;
...
#pragma warning(pop)
        ...
        detail::constructor<
            context_list_type, outermost_context_base_type>::construct(pCommonContext, outermostContextBase);
        ...
        typename rtti_policy_type::id_type eventType)
    {
        typedef typename mpl::if_<
            ...
            local_react_impl_non_empty>::type impl;
    ...
    void check_store_deep_history()
    {
        typedef typename mpl::if_<
            ...
            check_store_deep_history_impl_no>::type impl;
