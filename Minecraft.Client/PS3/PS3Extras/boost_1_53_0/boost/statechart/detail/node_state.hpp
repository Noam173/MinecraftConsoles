...
class node_state_base : public state_base<Allocator, RttiPolicy>
{
  ...
  protected:
    //////////////////////////////////////////////////////////////////////////
    node_state_base(typename RttiPolicy::id_provider_type idProvider) : base_type(idProvider)
    {
    }
...
class node_state : public node_state_base<Allocator, RttiPolicy>
{
  ...
  protected:
    //////////////////////////////////////////////////////////////////////////
    node_state(typename RttiPolicy::id_provider_type idProvider) : base_type(idProvider)
    {
