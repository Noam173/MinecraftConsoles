...
///////////////////////////////////////////////////////////////////////////////
template <
    typename RT, typename A = nil_t, typename B = nil_t, typename C = nil_t
...
template <
    ...
    >
struct function_ptr
    : public function<function_ptr_action<RT, A, B, C
#if PHOENIX_LIMIT > 3
                                          ,
                                          D, E, F
#if PHOENIX_LIMIT > 6
...
template <
    typename RT,
    typename ClassT, typename A = nil_t, typename B = nil_t, typename C = nil_t
                                  ...
                                  >
{
    ...
    template <typename CT>
    result_type operator()(CT &obj,
                           A a, B b, C c, D d, E e, F f, G g) const
    {
                                  ...
                                  >
{
    ...
    template <typename CT>
    result_type operator()(CT &obj,
                           A a, B b, C c, D d, E e, F f, G g, H h) const
    {
                                  ...
                                  >
{
    ...
    template <typename CT>
    result_type operator()(CT &obj,
                           A a, B b, C c, D d, E e, F f, G g, H h, I i) const
    {
                                  ...
                                  >
{
    ...
    template <typename CT>
    result_type operator()(CT &obj,
                           A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k) const
    {
                                  ...
                                  A, B, C, D, E, F, G, H, I, J, K, L, nil_t, nil_t, nil_t, nil_t>
{
    ...
    template <typename CT>
    result_type operator()(CT &obj,
                           A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k, L l) const
    {
                                  ...
                                  A, B, C, D, E, F, G, H, I, J, K, L, M, nil_t, nil_t, nil_t>
{
    ...
    template <typename CT>
    result_type operator()(CT &obj,
                           A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k, L l, M m) const
    {
                                  ...
                                  A, B, C, D, E, F, G, H, I, J, K, L, M, N, nil_t, nil_t>
{
    ...
    template <typename CT>
    result_type operator()(CT &obj,
                           A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k, L l, M m, N n) const
    {
                                  ...
                                  A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, nil_t>
{
    ...
    template <typename CT>
    result_type operator()(CT &obj,
                           A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k, L l, M m, N n, O o) const
    {
...
template <
    ...
    >
struct bound_member
    : public function<bound_member_action<RT, ClassT, A, B, C
#if PHOENIX_LIMIT > 3
                                          ,
                                          D, E, F
#if PHOENIX_LIMIT > 6
