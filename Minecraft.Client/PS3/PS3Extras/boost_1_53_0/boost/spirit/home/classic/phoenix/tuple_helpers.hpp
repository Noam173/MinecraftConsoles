...
struct concat_tuple_element
{
    ...
    typedef
        typename concat_tuple_element<
            ...
            typename tuple_element<N + 1, TupleT2>::type>::type
            type;
};
...
struct concat_tuples
{
    ...
    typedef
        typename concat_tuple_element<
            TupleT1, TupleT2, 0,
            typename tuple_element<0, TupleT2>::type>::type
            type;
};
...
struct convert_actors_<4>
{
    ...
    struct apply
    {
        ...
        do_(ActorTupleT const &actor_tuple)
        {
            ...
            using namespace tuple_index_names;
            return TupleResultT(
                converter0::do_(actor_tuple), converter1::do_(actor_tuple), converter2::do_(actor_tuple), converter3::do_(actor_tuple));
        }
    };
};
...
struct convert_actors_<5>
{
    ...
    struct apply
    {
        ...
        do_(ActorTupleT const &actor_tuple)
        {
            ...
            using namespace tuple_index_names;
            return TupleResultT(
                converter0::do_(actor_tuple), converter1::do_(actor_tuple), converter2::do_(actor_tuple), converter3::do_(actor_tuple), converter4::do_(actor_tuple));
        }
    };
};
...
struct convert_actors_<6>
{
    ...
    struct apply
    {
        ...
        do_(ActorTupleT const &actor_tuple)
        {
            ...
            using namespace tuple_index_names;
            return TupleResultT(
                converter0::do_(actor_tuple), converter1::do_(actor_tuple), converter2::do_(actor_tuple), converter3::do_(actor_tuple), converter4::do_(actor_tuple), converter5::do_(actor_tuple));
        }
    };
};
...
struct convert_actors_<7>
{
    ...
    struct apply
    {
        ...
        do_(ActorTupleT const &actor_tuple)
        {
            ...
            using namespace tuple_index_names;
            return TupleResultT(
                converter0::do_(actor_tuple), converter1::do_(actor_tuple), converter2::do_(actor_tuple), converter3::do_(actor_tuple), converter4::do_(actor_tuple), converter5::do_(actor_tuple), converter6::do_(actor_tuple));
        }
    };
};
...
struct convert_actors_<8>
{
    ...
    struct apply
    {
        ...
        do_(ActorTupleT const &actor_tuple)
        {
            ...
            using namespace tuple_index_names;
            return TupleResultT(
                converter0::do_(actor_tuple), converter1::do_(actor_tuple), converter2::do_(actor_tuple), converter3::do_(actor_tuple), converter4::do_(actor_tuple), converter5::do_(actor_tuple), converter6::do_(actor_tuple), converter7::do_(actor_tuple));
        }
    };
};
...
struct convert_actors_<9>
{
    ...
    struct apply
    {
        ...
        do_(ActorTupleT const &actor_tuple)
        {
            ...
            using namespace tuple_index_names;
            return TupleResultT(
                converter0::do_(actor_tuple), converter1::do_(actor_tuple), converter2::do_(actor_tuple), converter3::do_(actor_tuple), converter4::do_(actor_tuple), converter5::do_(actor_tuple), converter6::do_(actor_tuple), converter7::do_(actor_tuple), converter8::do_(actor_tuple));
        }
    };
};
...
struct convert_actors_<10>
{
    ...
    struct apply
    {
        ...
        do_(ActorTupleT const &actor_tuple)
        {
            ...
            using namespace tuple_index_names;
            return TupleResultT(
                converter0::do_(actor_tuple), converter1::do_(actor_tuple), converter2::do_(actor_tuple), converter3::do_(actor_tuple), converter4::do_(actor_tuple), converter5::do_(actor_tuple), converter6::do_(actor_tuple), converter7::do_(actor_tuple), converter8::do_(actor_tuple), converter9::do_(actor_tuple));
        }
    };
};
...
struct convert_actors_<11>
{
    ...
    struct apply
    {
        ...
        do_(ActorTupleT const &actor_tuple)
        {
            ...
            using namespace tuple_index_names;
            return TupleResultT(
                converter0::do_(actor_tuple), converter1::do_(actor_tuple), converter2::do_(actor_tuple), converter3::do_(actor_tuple), converter4::do_(actor_tuple), converter5::do_(actor_tuple), converter6::do_(actor_tuple), converter7::do_(actor_tuple), converter8::do_(actor_tuple), converter9::do_(actor_tuple), converter10::do_(actor_tuple));
        }
    };
};
...
struct convert_actors_<13>
{
    ...
    struct apply
    {
        ...
        do_(ActorTupleT const &actor_tuple)
        {
            ...
            using namespace tuple_index_names;
            return TupleResultT(
                converter0::do_(actor_tuple), converter1::do_(actor_tuple), converter2::do_(actor_tuple), converter3::do_(actor_tuple), converter4::do_(actor_tuple), converter5::do_(actor_tuple), converter6::do_(actor_tuple), converter7::do_(actor_tuple), converter8::do_(actor_tuple), converter9::do_(actor_tuple), converter10::do_(actor_tuple), converter11::do_(actor_tuple), converter12::do_(actor_tuple));
        }
    };
};
...
struct convert_actors_<14>
{
    ...
    struct apply
    {
        ...
        do_(ActorTupleT const &actor_tuple)
        {
            ...
            using namespace tuple_index_names;
            return TupleResultT(
                converter0::do_(actor_tuple), converter1::do_(actor_tuple), converter2::do_(actor_tuple), converter3::do_(actor_tuple), converter4::do_(actor_tuple), converter5::do_(actor_tuple), converter6::do_(actor_tuple), converter7::do_(actor_tuple), converter8::do_(actor_tuple), converter9::do_(actor_tuple), converter10::do_(actor_tuple), converter11::do_(actor_tuple), converter12::do_(actor_tuple), converter13::do_(actor_tuple));
        }
    };
};
...
struct convert_actors_<15>
{
    ...
    struct apply
    {
        ...
        do_(ActorTupleT const &actor_tuple)
        {
            ...
            using namespace tuple_index_names;
            return TupleResultT(
                converter0::do_(actor_tuple), converter1::do_(actor_tuple), converter2::do_(actor_tuple), converter3::do_(actor_tuple), converter4::do_(actor_tuple), converter5::do_(actor_tuple), converter6::do_(actor_tuple), converter7::do_(actor_tuple), converter8::do_(actor_tuple), converter9::do_(actor_tuple), converter10::do_(actor_tuple), converter11::do_(actor_tuple), converter12::do_(actor_tuple), converter13::do_(actor_tuple), converter14::do_(actor_tuple));
        }
    };
};
