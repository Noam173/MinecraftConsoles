...
struct post_order
{
    ...
    struct result
    {
        typedef typename traverse_post_order_return<
            MetaT, ParserT, traverse_post_order_env<0, 0, 0, 0>>::type
            type;
    };
...
struct action_identity_policy
{
    ...
    typename parser_traversal_action_result<
        TransformT, ActionT, SubjectT, EnvT>::type
...
struct binary_identity_policy
{
    ...
    typename parser_traversal_binary_result<
        TransformT, BinaryT, LeftT, RightT, EnvT>::type
    generate_binary(
        BinaryT const &, LeftT const &left_, RightT const &right_, EnvT const & /*env*/) const
    {
        typedef typename BinaryT::parser_generator_t parser_generator_t;
