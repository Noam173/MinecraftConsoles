...
template <typename A0> // enables lit(n)
struct use_terminal<qi::domain, terminal_ex<tag::lit, fusion::vector1<A0>>, typename enable_if<is_same<A0, boost::long_long_type>>::type>
    : mpl::true_
{
};

template <typename A0> // enables long_long(n)
struct use_terminal<qi::domain, terminal_ex<tag::long_long, fusion::vector1<A0>>>
    : is_arithmetic<A0>
{
};
...
struct use_terminal<qi::domain, terminal_ex<tag::int_parser<T, Radix, MinDigits, MaxDigits>, fusion::vector1<A0>>> : mpl::true_
{
};
...
template <
    typename T, unsigned Radix = 10, unsigned MinDigits = 1, int MaxDigits = -1>
...
struct make_primitive<
    terminal_ex<tag::lit, fusion::vector1<A0>>, Modifiers, typename enable_if<is_same<A0, signed short>>::type>
...
template <typename Modifiers, typename A0>
struct make_primitive<
    terminal_ex<tag::lit, fusion::vector1<A0>>, Modifiers, typename enable_if<is_same<A0, signed>>::type>
...
template <typename Modifiers, typename A0>
struct make_primitive<
    terminal_ex<tag::lit, fusion::vector1<A0>>, Modifiers, typename enable_if<is_same<A0, signed long>>::type>
...
template <typename Modifiers, typename A0>
struct make_primitive<
    terminal_ex<tag::lit, fusion::vector1<A0>>, Modifiers, typename enable_if<is_same<A0, boost::long_long_type>>::type>
...
struct make_primitive<
    tag::int_parser<T, Radix, MinDigits, MaxDigits>, Modifiers>
...
struct make_primitive<
    terminal_ex<tag::int_parser<T, Radix, MinDigits, MaxDigits>, fusion::vector1<A0>>, Modifiers>
