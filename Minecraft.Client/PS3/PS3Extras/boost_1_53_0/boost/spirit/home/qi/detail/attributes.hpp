...
struct transform_attribute
    : mpl::if_<
          mpl::and_<
              mpl::not_<is_const<Exposed>>, mpl::not_<is_reference<Exposed>>, traits::is_proxy<Transformed>>,
          proxy_transform_attribute<Exposed, Transformed>, default_transform_attribute<Exposed, Transformed>>::type
{
};

template <typename Exposed, typename Transformed>
struct transform_attribute<boost::optional<Exposed>, Transformed, typename disable_if<is_same<boost::optional<Exposed>, Transformed>>::type>
{
    typedef Transformed &type;
...
struct transform_attribute<unused_type, unused_type>
{
    ...
    static unused_type pre(unused_type)
    {
        return unused;
    }
