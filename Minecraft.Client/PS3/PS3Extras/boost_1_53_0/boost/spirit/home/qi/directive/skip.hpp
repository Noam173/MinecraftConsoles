...
struct reskip_parser : unary_parser<reskip_parser<Subject>>
{
    ...
    bool parse(Iterator &first, Iterator const &last, Context &context, Skipper const &u // --> The skipper is reintroduced
               ,
...
struct skip_parser : unary_parser<skip_parser<Subject, Skipper>>
{
    ...
    bool parse(Iterator &first, Iterator const &last, Context &context, Skipper_ const & // skipper --> bypass the supplied skipper
               ,
               Attribute &attr) const
    {
