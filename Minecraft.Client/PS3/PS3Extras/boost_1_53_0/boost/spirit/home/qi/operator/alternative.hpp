...
struct alternative : nary_parser<alternative<Elements>>
{
    ...
    struct attribute
    {
        ...
        typedef typename traits::build_attribute_sequence<
            Elements, Context, traits::alternative_attribute_transform, Iterator, qi::domain>::type all_attributes;
        ...
        // to T.
        typedef typename traits::build_variant<all_attributes>::type
            type;
    };
