...
struct make_bool
{
    ...
    typedef typename mpl::if_<
        mpl::and_<
            no_case, is_same<bool_policies<T>, Policies>>,
        any_bool_parser<T, no_case_bool_policies<T>>, any_bool_parser<T, Policies>>::type
        result_type;
...
struct make_direct_bool
{
    ...
    typedef typename mpl::if_<
        mpl::and_<
            no_case, is_same<bool_policies<T>, Policies>>,
        literal_bool_parser<T, no_case_bool_policies<T>, false>, literal_bool_parser<T, Policies, false>>::type
        result_type;
...
struct make_literal_bool
{
    ...
    typedef typename mpl::if_<
        mpl::and_<
            no_case, is_same<bool_policies<T>, Policies>>,
        literal_bool_parser<T, no_case_bool_policies<T>>, literal_bool_parser<T, Policies>>::type
        result_type;
...
struct make_primitive<
    terminal_ex<tag::lit, fusion::vector1<A0>>, Modifiers, typename enable_if<is_same<A0, bool>>::type>
