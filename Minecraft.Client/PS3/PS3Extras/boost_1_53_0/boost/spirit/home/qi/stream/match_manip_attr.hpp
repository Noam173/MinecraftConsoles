...
inline detail::match_manip<Expr, mpl::false_, mpl::true_, unused_type, fusion::vector<BOOST_PP_ENUM(N, BOOST_SPIRIT_QI_ATTRIBUTE_REFERENCE, A)>>
match(
    Expr const &xpr, BOOST_PP_ENUM_BINARY_PARAMS(N, A, &attr))
{
...
inline detail::match_manip<Expr, mpl::false_, mpl::true_, Skipper, fusion::vector<BOOST_PP_ENUM(N, BOOST_SPIRIT_QI_ATTRIBUTE_REFERENCE, A)>>
phrase_match(
    Expr const &xpr, Skipper const &s, BOOST_SCOPED_ENUM(skip_flag) post_skip, BOOST_PP_ENUM_BINARY_PARAMS(N, A, &attr))
{
    using qi::detail::match_manip;
...
inline detail::match_manip<Expr, mpl::false_, mpl::true_, Skipper, fusion::vector<BOOST_PP_ENUM(N, BOOST_SPIRIT_QI_ATTRIBUTE_REFERENCE, A)>>
phrase_match(
    Expr const &xpr, Skipper const &s, BOOST_PP_ENUM_BINARY_PARAMS(N, A, &attr))
{
    using qi::detail::match_manip;
