...
struct use_terminal<qi::domain, terminal<
...
struct use_lazy_terminal<
    qi::domain, tag::char_code<tag::char_, CharEncoding>, 2 // arity
    > : mpl::true_
{
};
...
struct literal_char
    : char_parser<
          literal_char<CharEncoding, no_attribute, false>, typename CharEncoding::char_type, typename mpl::if_c<no_attribute, unused_type, typename CharEncoding::char_type>::type>
{
...
struct literal_char<CharEncoding, no_attribute, true> // case insensitive
    : char_parser<
          literal_char<CharEncoding, no_attribute, true>, typename mpl::if_c<no_attribute, unused_type, typename CharEncoding::char_type>::type>
{
    typedef typename CharEncoding::char_type char_type;
    typedef CharEncoding char_encoding;

    literal_char(char_type ch)
        : lo(static_cast<char_type>(char_encoding::tolower(ch))), hi(static_cast<char_type>(char_encoding::toupper(ch)))
    {
    }
    ...
    : char_parser<char_range<CharEncoding, true>, typename CharEncoding::char_type>
{
    ...
    char_range(char_type from, char_type to)
        : from_lo(static_cast<char_type>(char_encoding::tolower(from))), to_lo(static_cast<char_type>(char_encoding::tolower(to))), from_hi(static_cast<char_type>(char_encoding::toupper(from))), to_hi(static_cast<char_type>(char_encoding::toupper(to)))
    {
    }
...
template <typename CharEncoding, bool no_attribute, bool no_case = false>
struct char_set
    : char_parser<char_set<CharEncoding, no_attribute, false>, typename mpl::if_c<no_attribute, unused_type, typename CharEncoding::char_type>::type>
{
    typedef typename CharEncoding::char_type char_type;
    typedef CharEncoding char_encoding;
    ...
    char_set(String const &str)
    {
        ...
        typedef typename remove_const<
            typename traits::char_type_of<String>::type>::type
            in_type;
...
struct char_set<CharEncoding, no_attribute, true> // case insensitive
    : char_parser<char_set<CharEncoding, no_attribute, true>, typename mpl::if_c<no_attribute, unused_type, typename CharEncoding::char_type>::type>
{
    typedef typename CharEncoding::char_type char_type;
    typedef CharEncoding char_encoding;
    ...
    char_set(String const &str)
    {
        ...
        while (ch)
        {
            ...
            if (next == '-')
            {
                ...
                chset.set(static_cast<char_type>(CharEncoding::tolower(ch)), static_cast<char_type>(CharEncoding::tolower(next)));
                chset.set(static_cast<char_type>(CharEncoding::toupper(ch)), static_cast<char_type>(CharEncoding::toupper(next)));
            }
            else
            {
                chset.set(static_cast<char_type>(CharEncoding::tolower(ch)));
...
struct basic_literal
{
    static bool const no_case =
        has_modifier<
            Modifiers, tag::char_code_base<tag::no_case>>::value;

    static bool const no_attr =
        !has_modifier<
            Modifiers, tag::lazy_eval>::value;
...
struct make_primitive<
    terminal_ex<
        tag::char_code<tag::char_, CharEncoding>, fusion::vector1<A0>>,
    Modifiers>
{
    static bool const no_case =
    ...
    typedef typename mpl::if_<
        traits::is_string<A0>, char_set<char_encoding, false, no_case>, literal_char<char_encoding, false, no_case>>::type
        result_type;
...
struct make_primitive<
    terminal_ex<tag::lit, fusion::vector1<A0>>, Modifiers, typename enable_if<traits::is_char<A0>>::type>
{
    static bool const no_case =
        has_modifier<
            Modifiers, tag::char_code_base<tag::no_case>>::value;
...
struct make_primitive<
    terminal_ex<
        tag::char_code<tag::char_, CharEncoding>, fusion::vector1<Char (&)[2]> // For single char strings
        >,
    Modifiers>
{
    static bool const no_case =
...
struct make_primitive<
    terminal_ex<
        tag::char_code<tag::char_, CharEncoding>, fusion::vector2<A0, A1>>,
    Modifiers>
{
    static bool const no_case =
        has_modifier<Modifiers, tag::char_code_base<tag::no_case>>::value;
...
struct make_primitive<
    terminal_ex<
        tag::char_code<tag::char_, CharEncoding>, fusion::vector2<Char (&)[2], Char (&)[2]> // For single char strings
        >,
    Modifiers>
{
    static bool const no_case =
    ...
    {
        return result_type(
            fusion::at_c<0>(term.args)[0], fusion::at_c<1>(term.args)[0]);
    }
};
} // namespace qi
} // namespace spirit
