...
{
    static void
    call(Iterator const &first, Iterator const &last, reference_wrapper<Attribute> attr)
    {
        if (traits::is_empty(attr))
        {
            attr = Attribute(first, last);
...
{
    static void
    call(Iterator const &first, Iterator const &last, boost::optional<Attribute> &attr)
    {
        Attribute val;
...
{
    static void
    call(Iterator const &first, Iterator const &last, iterator_range<Iterator> &attr)
    {
...
struct assign_to_attribute_from_value
{
    ...
    typedef typename mpl::eval_if<
        is_one_element_sequence, fusion::result_of::at_c<Attribute, 0>, mpl::identity<Attribute &>>::type type;
...
struct assign_to_attribute_from_value<Attribute, reference_wrapper<T>, typename disable_if<is_same<Attribute, reference_wrapper<T>>>::type>
{
    static void
...
template <typename Attribute, typename T>
struct assign_to_attribute_from_value<Attribute, boost::optional<T>, typename disable_if<is_same<Attribute, boost::optional<T>>>::type>
{
    static void
...
template <typename Attribute, typename T>
struct assign_to_container_from_value<Attribute, boost::optional<T>, typename disable_if<is_same<Attribute, boost::optional<T>>>::type>
{
    static void
    call(boost::optional<T> const &val, Attribute &attr)
    {
...
template <typename Attribute, typename T>
struct assign_to_container_from_value<Attribute, reference_wrapper<T>, typename disable_if<is_same<Attribute, reference_wrapper<T>>>::type>
{
    static void
    call(reference_wrapper<T> const &val, Attribute &attr)
    {
...
assign_to(T const &val, Attribute &attr)
{
    typedef typename mpl::and_<
        traits::is_container<Attribute>, traits::not_is_variant<Attribute>, traits::not_is_optional<Attribute>>::type is_not_wrapped_container;
