...
template <typename Parser, typename Iterator, typename Context, typename Skipper, typename Attribute>
bool lazy_parse_impl(Parser const &p, Iterator &first, Iterator const &last, Context &context, Skipper const &skipper, Attribute &attr, mpl::true_)
{
...
struct lazy_parser : parser<lazy_parser<Function, Modifiers>>
{
    ...
    struct attribute
    {
        typedef typename boost::result_of<qi_modify(tag::lazy_eval, Modifiers)>::type
            modifier;

        typedef typename remove_reference<
            typename boost::result_of<Function(unused_type, Context)>::type>::type
            expr_type;
    ...
    bool parse(Iterator &first, Iterator const &last, Context &context, Skipper const &skipper, Attribute &attr) const
    {
        return detail::lazy_parse_impl_main(
            compile<qi::domain>(function(unused, context), qi_modify()(tag::lazy_eval(), modifiers)), first, last, context, skipper, attr);
    }

    template <typename Context>
    info what(Context &context) const
    {
        return info("lazy", compile<qi::domain>(function(unused, context), qi_modify()(tag::lazy_eval(), modifiers))
                                .what(context));
    }
    ...
    : unary_parser<lazy_directive<Function, Subject, Modifiers>>
{
    ...
    struct attribute
    {
        ...
        typedef typename proto::result_of::make_expr<
            proto::tag::subscript, directive_expr_type, Subject>::type
            expr_type;
    ...
    lazy_directive(
        Function const &function, Subject const &subject, Modifiers const &modifiers)
    ...
    info what(Context &context) const
    {
        return info("lazy-directive", compile<qi::domain>(
                                          proto::make_expr<proto::tag::subscript>(
                                              function(unused, context), subject),
                                          qi_modify()(tag::lazy_eval(), modifiers))
                                          .what(context));
...
struct make_primitive<lazy_terminal<Terminal, Actor, Arity>, Modifiers>
{
    ...
    result_type operator()(
        lazy_terminal<Terminal, Actor, Arity> const &lt, Modifiers const &modifiers) const
    {
...
struct make_directive<lazy_terminal<Terminal, Actor, Arity>, Subject, Modifiers>
{
    ...
    result_type operator()(
        lazy_terminal<Terminal, Actor, Arity> const &lt, Subject const &subject, Modifiers const &modifiers) const
    {
...
struct handles_container<
    ...
    : handles_container<
          typename qi::lazy_parser<Actor, Modifiers>::template attribute<Context, Iterator>::parser_type, Attribute, Context, Iterator>
{
};

template <typename Subject, typename Actor, typename Modifiers, typename Attribute, typename Context, typename Iterator>
struct handles_container<
    qi::lazy_directive<Actor, Subject, Modifiers>, Attribute, Context, Iterator>
    : handles_container<
          typename qi::lazy_directive<Actor, Subject, Modifiers>::template attribute<Context, Iterator>::parser_type, Attribute, Context, Iterator>
{
};
} // namespace traits
} // namespace spirit
