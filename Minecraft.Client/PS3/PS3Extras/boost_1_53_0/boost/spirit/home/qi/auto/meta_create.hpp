...
struct meta_create_container
{
    typedef make_unary_proto_expr<
        typename Container::value_type, proto::tag::dereference, qi::domain>
        make_proto_expr;
...
struct meta_create_sequence
{
    ...
    typedef typename mpl::fold<
        typename fusion::result_of::as_vector<Sequence>::type, mpl::vector<>, mpl::push_back<mpl::_, mpl::_>>::type sequence_type;
...
template <typename T>
struct meta_create_impl<T, typename enable_if<mpl::and_<
                               traits::is_container<T>, mpl::not_<traits::is_string<T>>>>::type>
...
{
    typedef make_nary_proto_expr<
        typename boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>::types, proto::tag::bitwise_or, qi::domain>
        make_proto_expr;
...
struct meta_create_exists<qi::domain, T>
    : mpl::not_<is_same<
          qi::no_auto_mapping_exists, typename meta_create<qi::domain, T>::type>>
{
};
} // namespace traits
} // namespace spirit
