...
template <typename A0> // enables lit(n)
struct use_terminal<qi::domain, terminal_ex<tag::lit, fusion::vector1<A0>>, typename enable_if<is_same<A0, boost::ulong_long_type>>::type>
    : mpl::true_
{
};

template <typename A0> // enables ulong_long(n)
struct use_terminal<qi::domain, terminal_ex<tag::ulong_long, fusion::vector1<A0>>>
    : is_arithmetic<A0>
{
};
...
struct use_terminal<qi::domain, terminal_ex<tag::uint_parser<T, Radix, MinDigits, MaxDigits>, fusion::vector1<A0>>> : mpl::true_
{
};
...
struct make_primitive<
    terminal_ex<tag::lit, fusion::vector1<A0>>, Modifiers, typename enable_if<is_same<A0, unsigned short>>::type>
...
template <typename Modifiers, typename A0>
struct make_primitive<
    terminal_ex<tag::lit, fusion::vector1<A0>>, Modifiers, typename enable_if<is_same<A0, unsigned>>::type>
...
template <typename Modifiers, typename A0>
struct make_primitive<
    terminal_ex<tag::lit, fusion::vector1<A0>>, Modifiers, typename enable_if<is_same<A0, unsigned long>>::type>
...
template <typename Modifiers, typename A0>
struct make_primitive<
    terminal_ex<tag::lit, fusion::vector1<A0>>, Modifiers, typename enable_if<is_same<A0, boost::ulong_long_type>>::type>
...
struct make_primitive<
    tag::uint_parser<T, Radix, MinDigits, MaxDigits>, Modifiers>
...
struct make_primitive<
    terminal_ex<tag::uint_parser<T, Radix, MinDigits, MaxDigits>, fusion::vector1<A0>>, Modifiers>
