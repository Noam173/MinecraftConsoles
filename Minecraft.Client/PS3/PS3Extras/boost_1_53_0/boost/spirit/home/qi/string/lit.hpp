...
struct use_lazy_terminal<
    qi::domain, tag::char_code<tag::string, CharEncoding>, 1 /*arity*/
    > : mpl::true_
{
};
...
struct make_primitive<T, Modifiers, typename enable_if<traits::is_string<T>>::type>
{
    ...
    typedef typename mpl::if_<
        no_case, no_case_literal_string<const_string, true>, literal_string<const_string, true>>::type
        result_type;
    ...
    Modifiers>
{
    ...
    typedef typename add_const<A0>::type const_string;
    typedef typename mpl::if_<
        no_case, no_case_literal_string<const_string, false>, literal_string<const_string, false>>::type
        result_type;
