...
phrase_match(
    Expr const &expr, Skipper const &s, BOOST_SCOPED_ENUM(skip_flag) post_skip = skip_flag::postskip)
{
...
phrase_match(
    Expr const &xpr, Skipper const &s, BOOST_SCOPED_ENUM(skip_flag) post_skip, Attribute &p)
{
    using qi::detail::match_manip;
...
inline detail::match_manip<
    Expr, mpl::false_, mpl::false_, Skipper, Attribute>
phrase_match(
    Expr const &xpr, Skipper const &s, Attribute &p)
{
    using qi::detail::match_manip;
