    ...
    : unary_parser<attr_cast_parser<Exposed, Transformed, Subject>>
{
    ...
    typedef typename mpl::eval_if<
        traits::not_is_unused<Transformed>, mpl::identity<Transformed>, traits::attribute_of<subject_type>>::type
    ...
    struct attribute
        : mpl::if_<traits::not_is_unused<Exposed>, Exposed, transformed_attribute_type>
    {
    };
    ...
    tag::stateful_tag<Expr, tag::attr_cast, Exposed, Transformed>, Modifiers>
{
    ...
    result_type operator()(Terminal const &term, unused_type) const
    {
        typedef tag::stateful_tag<
            Expr, tag::attr_cast, Exposed, Transformed>
            tag_type;
