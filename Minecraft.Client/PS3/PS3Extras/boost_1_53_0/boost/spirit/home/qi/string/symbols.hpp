...
{
template <
    typename Char = char, typename T = unused_type, typename Lookup = tst<Char, T>, typename Filter = tst_pass_through>
struct symbols
    : proto::extends<
...
struct make_primitive<reference<symbols<Char, T, Lookup, Filter>>, Modifiers>
{
    ...
    typedef typename mpl::if_<
        no_case, symbols<Char, T, Lookup, nc_filter>, reference_>::type
        result_type;
...
{
///////////////////////////////////////////////////////////////////////////
template <typename Char, typename T, typename Lookup, typename Filter, typename Attr, typename Context, typename Iterator>
