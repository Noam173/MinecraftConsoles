...
#define BOOST_SPIRIT_LOG2 (#error)(#error)(1000000)(1584960)(2000000)(2321920)(2584960)(2807350)(3000000)(3169920)(3321920)(3459430)(3584960)(3700430)(3807350)(3906890)(4000000)(4087460)(4169920)(4247920)(4321920)(4392310)(4459430)(4523560)(4584960)(4643850)(4700430)(4754880)(4807350)(4857980)(4906890)(4954190)(5000000)(5044390)(5087460)(5129280)(5169925) /***/
...
struct radix_traits
{
    ...
    inline static bool is_valid(Char ch)
    {
        ...
        return (ch >= '0' && ch <= '9') || (ch >= 'a' && ch <= static_cast<Char>('a' + Radix - 10 - 1)) || (ch >= 'A' && ch <= static_cast<Char>('A' + Radix - 10 - 1));
    }
...
struct int_extractor
{
    ...
    {
        return call(ch, count, n, mpl::bool_<((MaxDigits < 0) || (MaxDigits > digits_traits<T, Radix>::value)) && std::numeric_limits<T>::is_modulo>());
    }
};
...
template <
    typename T, unsigned Radix, unsigned MinDigits, int MaxDigits, typename Accumulator = positive_accumulator<Radix>, bool Accumulate = false>
struct extract_int
{
...
#pragma warning(disable : 4127) // conditional expression is constant
        ...
        Iterator &first, Iterator const &last, Attribute &attr)
    {
        ...
        typedef typename traits::attribute_type<Attribute>::type
            attribute_type;
        ...
        {
            BOOST_PP_REPEAT(
                SPIRIT_NUMERICS_LOOP_UNROLL, SPIRIT_NUMERIC_INNER_LOOP, _)
        }
...
#pragma warning(pop)
    ...
    inline static bool
    parse(
        Iterator &first, Iterator const &last, unused_type)
    {
...
///////////////////////////////////////////////////////////////////////////
template <typename T,
          bool force_unsigned = mpl::and_<is_integral<T>, is_signed<T>>::value>
