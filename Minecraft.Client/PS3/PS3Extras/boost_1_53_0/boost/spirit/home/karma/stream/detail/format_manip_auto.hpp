...
struct format_delimited<Expr, Delimiter, typename enable_if<traits::meta_create_exists<karma::domain, Expr>>::type>
{
    typedef typename result_of::create_generator<Expr>::type expr_type;
    typedef format_manip<
    ...
    static type call(Expr const &expr, Delimiter const &delimiter, BOOST_SCOPED_ENUM(delimit_flag) pre_delimit)
    {
