...
struct alternative_properties
{
    ...
    typedef typename mpl::accumulate<
        ...
        mpl::int_<karma::generator_properties::countingbuffer>, mpl::bitor_<mpl::_2, mpl::_1>>::type type;
};
...
struct base_alternative : nary_generator<Derived>
{
    ...
    struct attribute
    {
        ...
        typedef typename traits::build_attribute_sequence<
            Elements, Context, traits::alternative_attribute_transform, Iterator, karma::domain>::type all_attributes;
