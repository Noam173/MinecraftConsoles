...
struct compound_modifier<
    Current, tag::char_code<tag::upper, CharEncoding>, typename enable_if<has_modifier<Current, tag::char_code<tag::lower, CharEncoding>>>::type>
    : Current
{
    compound_modifier()
        : Current()
...
template <typename Current, typename CharEncoding>
struct compound_modifier<
    Current, tag::char_code<tag::lower, CharEncoding>, typename enable_if<has_modifier<Current, tag::char_code<tag::upper, CharEncoding>>>::type>
    : Current
{
    compound_modifier()
        : Current()
