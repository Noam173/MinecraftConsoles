    ...
    : primitive_generator<any_stream_generator<Char, CharEncoding, Tag>>
{
    ...
    template <
        typename T, typename Traits, typename Properties, typename Context, typename Delimiter, typename Attribute>
    static bool generate(
        karma::detail::output_iterator<
            karma::ostream_iterator<T, Char, Traits>, Properties> &sink,
    ...
    : primitive_generator<lit_stream_generator<T, Char, CharEncoding, Tag>>
{
    ...
    // generated by a format_manip object.
    template <
        typename T1, typename Traits, typename Properties, typename Context, typename Delimiter, typename Attribute>
    bool generate(
        karma::detail::output_iterator<
            karma::ostream_iterator<T1, Char, Traits>, Properties> &sink,
...
struct make_stream
{
    ...
    typedef any_stream_generator<
        Char, typename spirit::detail::get_encoding_with_case<Modifiers, unused_type, lower || upper>::type, typename detail::get_casetag<Modifiers, lower || upper>::type>
        result_type;
...
struct make_any_stream
{
    ...
    typedef lit_stream_generator<
        const_attribute, Char, typename spirit::detail::get_encoding_with_case<Modifiers, unused_type, lower || upper>::type, typename detail::get_casetag<Modifiers, lower || upper>::type>
        result_type;
...
struct make_primitive<
    terminal_ex<tag::stream_tag<Char>, fusion::vector1<A0>>, Modifiers>
    : make_any_stream<Char, A0, Modifiers>
{
};
