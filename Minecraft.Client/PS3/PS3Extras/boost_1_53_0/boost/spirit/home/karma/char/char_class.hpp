...
struct char_class
    : char_generator<
          char_class<Tag, CharEncoding, CharClass>, CharEncoding, CharClass>
{
    ...
    bool test(unused_type, CharParam &, Context &) const
    {
        ...
        BOOST_SPIRIT_ASSERT_MSG(false, char_class_not_usable_without_attribute, ());
        return false;
    }
...
struct make_primitive<tag::char_code<CharClass, CharEncoding>, Modifiers>
{
    ...
    typedef tag::char_code<
        typename detail::make_char_class<CharClass, lower, upper>::type, CharEncoding>
        tag_type;

    typedef char_class<
        tag_type, typename spirit::detail::get_encoding_with_case<Modifiers, CharEncoding, lower || upper>::type, typename detail::get_casetag<Modifiers, lower || upper>::type>
        result_type;
