    ...
    : primitive_generator<any_bool_generator<T, CharEncoding, Tag, Policies>>
{
  public:
    ...
    bool
    generate(OutputIterator &sink, Context &context, Delimiter const &d, Attribute const &attr) const
    {
...
struct make_bool
{
    ...
    typedef any_bool_generator<
        T, typename spirit::detail::get_encoding_with_case<Modifiers, unused_type, lower || upper>::type, typename detail::get_casetag<Modifiers, lower || upper>::type, Policies>
        result_type;
...
struct make_bool_literal
{
    ...
    typedef literal_bool_generator<
        bool, typename spirit::detail::get_encoding_with_case<Modifiers, unused_type, lower || upper>::type, typename detail::get_casetag<Modifiers, lower || upper>::type, bool_policies<>, false>
        result_type;
...
struct make_bool_direct
{
    ...
    typedef literal_bool_generator<
        T, typename spirit::detail::get_encoding_with_case<Modifiers, unused_type, lower || upper>::type, typename detail::get_casetag<Modifiers, lower || upper>::type, Policies, false>
        result_type;
...
struct make_primitive<
    terminal_ex<tag::stateful_tag<Policies, tag::bool_, T>, fusion::vector1<A0>>, Modifiers>
    : detail::make_bool_direct<Modifiers, typename remove_const<T>::type, Policies>
{
};
...
struct basic_bool_literal
{
    ...
    typedef literal_bool_generator<
        bool, typename spirit::detail::get_encoding_with_case<Modifiers, unused_type, lower || upper>::type, typename detail::get_casetag<Modifiers, lower || upper>::type, bool_policies<>, true>
        result_type;
...
template <typename Modifiers, typename A0>
struct make_primitive<
    terminal_ex<tag::lit, fusion::vector1<A0>>, Modifiers, typename enable_if<traits::is_bool<A0>>::type>
    : detail::basic_bool_literal<Modifiers>
{
    static bool const lower =
        has_modifier<Modifiers, tag::char_code_base<tag::lower>>::value;
