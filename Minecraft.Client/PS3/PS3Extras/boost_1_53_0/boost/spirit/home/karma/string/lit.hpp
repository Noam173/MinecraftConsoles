...
struct use_lazy_terminal<
    karma::domain, tag::char_code<tag::string, CharEncoding>, 1 /*arity*/
    > : mpl::true_
{
};
    ...
    : primitive_generator<any_string<CharEncoding, Tag>>
{
             ...
             Attribute const &attr)
    {
        ...
        return karma::detail::string_generate(sink, traits::extract_from<attribute_type>(attr, context), char_encoding(), Tag()) &&
...
{
    typedef CharEncoding char_encoding;
    typedef typename remove_const<typename traits::char_type_of<String>::type>::type
        char_type;
    ...
    // it fails.
    template <
        typename OutputIterator, typename Context, typename Delimiter, typename Attribute>
...
struct make_primitive<
    tag::char_code<tag::string, CharEncoding>, Modifiers>
{
...
struct make_primitive<T, Modifiers, typename enable_if<traits::is_string<T>>::type>
{
    ...
    typedef literal_string<
        const_string, typename spirit::detail::get_encoding_with_case<Modifiers, unused_type, lower || upper>::type, typename detail::get_casetag<Modifiers, lower || upper>::type, true>
        result_type;
...
struct make_string_direct
{
    ...
    typedef literal_string<
        const_string, typename spirit::detail::get_encoding_with_case<Modifiers, unused_type, lower || upper>::type, typename detail::get_casetag<Modifiers, lower || upper>::type, no_attribute>
        result_type;
...
struct make_primitive<
    terminal_ex<
        tag::char_code<tag::string, CharEncoding>, fusion::vector1<A0>>,
    Modifiers>
...
struct make_primitive<
    terminal_ex<tag::lit, fusion::vector1<A0>>, Modifiers, typename enable_if<traits::is_string<A0>>::type>
...
template <typename String, typename CharEncoding, typename Tag, bool no_attribute, typename Attribute, typename Context, typename Iterator>
