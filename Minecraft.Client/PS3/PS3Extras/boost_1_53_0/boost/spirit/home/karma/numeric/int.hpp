...
struct use_terminal<karma::domain, terminal_ex<tag::int_generator<T, Radix, force_sign>, fusion::vector1<A0>>> : mpl::true_
{
};
...
struct use_lazy_terminal<
    karma::domain, tag::int_generator<T, Radix, force_sign>, 1 // arity
    > : mpl::true_
{
};
...
///////////////////////////////////////////////////////////////////////////
template <
    typename T, typename CharEncoding, typename Tag, unsigned Radix, bool force_sign>
struct any_int_generator
    : primitive_generator<any_int_generator<T, CharEncoding, Tag, Radix, force_sign>>
{
  private:
    template <typename OutputIterator, typename Attribute>
    static bool insert_int(OutputIterator &sink, Attribute const &attr)
    {
        return sign_inserter::call(sink, traits::test_zero(attr), traits::test_negative(attr), force_sign) &&
  ...
  public:
    ...
    static bool
    generate(OutputIterator &sink, Context &context, Delimiter const &d, Attribute const &attr)
    {
...
///////////////////////////////////////////////////////////////////////////
template <
    typename T, typename CharEncoding, typename Tag, unsigned Radix, bool force_sign, bool no_attribute>
...
struct make_int
{
    ...
    typedef any_int_generator<
        T, typename spirit::detail::get_encoding_with_case<Modifiers, unused_type, lower || upper>::type, typename detail::get_casetag<Modifiers, lower || upper>::type, Radix, force_sign>
        result_type;
...
struct make_int_direct
{
    ...
    typedef literal_int_generator<
        T, typename spirit::detail::get_encoding_with_case<Modifiers, unused_type, lower || upper>::type, typename detail::get_casetag<Modifiers, lower || upper>::type, Radix, force_sign, false>
        result_type;
...
struct make_primitive<
    terminal_ex<tag::int_generator<T, Radix, force_sign>, fusion::vector1<A0>>, Modifiers>
    : detail::make_int_direct<typename remove_const<T>::type, Modifiers, Radix, force_sign>
{
};
...
struct basic_int_literal
{
    ...
    typedef literal_int_generator<
        T, typename spirit::detail::get_encoding_with_case<Modifiers, unused_type, lower || upper>::type, typename detail::get_casetag<Modifiers, lower || upper>::type, 10, false, true>
        result_type;
...
template <typename Modifiers, typename A0>
struct make_primitive<
    terminal_ex<tag::lit, fusion::vector1<A0>>, Modifiers, typename enable_if<traits::is_int<A0>>::type>
{
    static bool const lower =
        has_modifier<Modifiers, tag::char_code_base<tag::lower>>::value;
    static bool const upper =
    ...
    typedef literal_int_generator<
        typename remove_const<A0>::type, typename spirit::detail::get_encoding_with_case<Modifiers, unused_type, lower || upper>::type, typename detail::get_casetag<Modifiers, lower || upper>::type, 10, false, true>
        result_type;
