...
struct make_component<karma::domain, proto::tag::terminal>
{
    ...
    struct result<This(Elements, Modifiers)>
    {
        typedef typename karma::make_primitive<
            typename remove_const<typename Elements::car_type>::type, typename remove_reference<Modifiers>::type>::result_type type;
    };
...
struct make_component<karma::domain, Tag>
{
    ...
    struct result<This(Elements, Modifiers)>
    {
        typedef typename karma::make_composite<Tag, Elements, typename remove_reference<Modifiers>::type>::result_type
            type;
    };
