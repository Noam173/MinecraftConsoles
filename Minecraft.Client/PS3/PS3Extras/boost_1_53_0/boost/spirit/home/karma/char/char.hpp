...
struct use_terminal<karma::domain, tag::char_code<tag::char_, CharEncoding> // enables char_
                    > : mpl::true_
{
};

template <typename CharEncoding, typename A0>
struct use_terminal<karma::domain, terminal_ex<
...
struct use_terminal<karma::domain, terminal_ex<tag::lit, fusion::vector1<A0>> // enables lit('x')
                    ,
...
struct use_lazy_terminal<
    karma::domain, tag::char_code<tag::char_, CharEncoding>, 1 // arity
    > : mpl::true_
{
};
...
struct literal_char
    : char_generator<literal_char<CharEncoding, Tag, no_attribute>, CharEncoding, Tag>
{
    typedef typename CharEncoding::char_type char_type;
    typedef CharEncoding char_encoding;
    ...
    : char_generator<char_range<CharEncoding, Tag>, CharEncoding, Tag>
{
    ...
    char_range(char_type from, char_type to)
        : from(spirit::char_class::convert<char_encoding>::to(Tag(), from)), to(spirit::char_class::convert<char_encoding>::to(Tag(), to))
    {
    }
    ...
    bool test(unused_type, CharParam &, Context &) const
    {
        ...
        BOOST_SPIRIT_ASSERT_MSG(false, char_range_not_usable_without_attribute, ());
        return false;
    }
...
template <typename CharEncoding, typename Tag, bool no_attribute>
struct char_set
    : char_generator<char_set<CharEncoding, Tag, no_attribute>, CharEncoding, Tag>
{
    typedef typename CharEncoding::char_type char_type;
    typedef CharEncoding char_encoding;
    ...
    bool test(unused_type, CharParam &, Context &) const
    {
        ...
        // what to output. The following assertion fires if this situation
        // is detected in your code.
        BOOST_SPIRIT_ASSERT_MSG(false, char_set_not_usable_without_attribute, ());
        return false;
    }
...
struct basic_literal
{
    ...
    typedef literal_char<
        ...
        typename get_casetag<Modifiers, lower || upper>::type, true>
        result_type;
...
struct make_char_direct
{
    ...
    typedef typename mpl::if_<
        traits::is_string<A0>, char_set<encoding, tag, no_attribute>, literal_char<encoding, tag, no_attribute>>::type result_type;
