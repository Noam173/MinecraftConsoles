...
{
template <
    typename OutputIterator, typename Context, typename Delimiter, typename Properties, typename F>
...
void debug(rule<OutputIterator, T1, T2, T3, T4> &r, F f)
{
    ...
    typedef debug_handler<
        OutputIterator, typename rule_type::context_type, typename rule_type::delimiter_type, typename rule_type::properties, F>
        debug_handler;
...
void debug(rule<OutputIterator, T1, T2, T3, T4> &r)
{
    ...
    typedef debug_handler<
        OutputIterator, typename rule_type::context_type, typename rule_type::delimiter_type, typename rule_type::properties, simple_trace>
        debug_handler;
