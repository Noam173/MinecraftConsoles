...
template <
    typename OutputIterator, typename T1, typename T2, typename T3, typename T4>
struct rule
    : proto::extends<
          typename proto::terminal<
              reference<rule<OutputIterator, T1, T2, T3, T4> const>>::type,
      ...
      generator<rule<OutputIterator, T1, T2, T3, T4>>
{
    ...
    typedef typename mpl::if_<
        is_same<encoding_type, unused_type>, unused_type, tag::char_code<tag::encoding, encoding_type>>::type
    ...
    rule<OutputIterator_, T1_, T2_, T3_, T4_> &r, Expr const &expr)
{
    ...
    typedef typename rule<OutputIterator_, T1_, T2_, T3_, T4_>::encoding_modifier_type
        encoding_modifier_type;
...
struct nonterminal_handles_container
    : mpl::and_<
          traits::is_container<RuleAttribute>, is_convertible<Attribute, RuleAttribute>>
{
};
} // namespace detail
...
///////////////////////////////////////////////////////////////////////////
template <
    typename IteratorA, typename IteratorB, typename Attribute, typename Context, typename T1, typename T2, typename T3, typename T4>
struct handles_container<
    karma::rule<IteratorA, T1, T2, T3, T4>, Attribute, Context, IteratorB>
