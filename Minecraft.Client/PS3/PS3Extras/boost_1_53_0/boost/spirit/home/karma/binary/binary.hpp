...
template <typename Modifiers, typename T, BOOST_SCOPED_ENUM(boost::endian::endianness) endian, int bits>
...
#define BOOST_SPIRIT_MAKE_BINARY_PRIMITIVE(name, endiantype, bits)                                                    \
    ...
    struct make_primitive<terminal_ex<tag::name, fusion::vector1<A0>>, Modifiers>                                     \
        : detail::basic_binary_literal<Modifiers, detail::integer<bits>, boost::endian::endianness::endiantype, bits> \
    {                                                                                                                 \
    };                                                                                                                \
                                                                                                                      \
    /***/
...
#define BOOST_SPIRIT_MAKE_BINARY_IEEE754_PRIMITIVE(name, endiantype, bits)                                                   \
    ...
    template <typename Modifiers, typename A0>                                                                               \
    struct make_primitive<terminal_ex<tag::name, fusion::vector1<A0>>, Modifiers>                                            \
        : detail::basic_binary_literal<Modifiers, detail::floating_point<bits>, boost::endian::endianness::endiantype, bits> \
    {                                                                                                                        \
    };                                                                                                                       \
                                                                                                                             \
    /***/
