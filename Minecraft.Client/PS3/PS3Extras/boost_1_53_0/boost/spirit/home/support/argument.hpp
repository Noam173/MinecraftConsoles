...
BOOST_PHOENIX_DEFINE_CUSTOM_TERMINAL(
    template <int N>
    ,
    boost::spirit::argument<N>, mpl::false_ // is not nullary
    ,
    v2_eval(
        proto::make<
...
BOOST_PHOENIX_DEFINE_CUSTOM_TERMINAL(
    template <typename Dummy>
    ,
    boost::spirit::attribute_context<Dummy>, mpl::false_ // is not nullary
    ,
    v2_eval(
        proto::make<
...
struct get_arg
{
    typedef typename fusion::result_of::size<Sequence>::type
        sequence_size;
    ...
    typedef typename fusion::result_of::at_c<Sequence, N>::type
        type;
...
struct attribute_context
{
    ...
    struct result
    {
        ...
        typedef typename remove_const<
            typename mpl::at_c<typename Env::args_type, 0>::type>::type
            type;
    };
...
struct argument
{
    ...
    struct result
    {
        typedef typename mpl::at_c<typename Env::args_type, 0>::type
            arg_type;
