...
// problems with the following template specialization
    ...
    struct result<nary_proto_expr_function(T1, T2)>
    {
        ...
        typedef typename spirit::traits::meta_create<Domain, T1>::type
            right_type;

        typedef typename mpl::eval_if<
            traits::not_is_unused<left_type>, proto::result_of::make_expr<OpTag, left_type, right_type>, mpl::identity<right_type>>::type type;
    };
...
// problems with the following template specialization
    ...
    struct result<nary_proto_expr_function(T1, T2)>
    {
        ...
        typedef typename spirit::traits::meta_create<Domain, T2>::type
            right_type;
...
struct make_nary_proto_expr
{
    ...
    typedef typename fusion::result_of::fold<
        Sequence, unused_type, make_proto_expr>::type type;
...
struct is_fusion_sequence_but_not_proto_expr
    : mpl::and_<
          fusion::traits::is_sequence<T>, mpl::not_<proto::is_expr<T>>>
{
};
} // namespace detail
} // namespace spirit
