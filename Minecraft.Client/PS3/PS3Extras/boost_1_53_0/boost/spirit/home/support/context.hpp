...
BOOST_PHOENIX_DEFINE_CUSTOM_TERMINAL(
    template <int N>
    ,
    boost::spirit::attribute<N>, mpl::false_ // is not nullary
    ,
    v2_eval(
        proto::make<
...
BOOST_PHOENIX_DEFINE_CUSTOM_TERMINAL(
    template <int N>
    ,
    boost::spirit::local_variable<N>, mpl::false_ // is not nullary
    ,
    v2_eval(
        proto::make<
...
struct context
{
    ...
    context(
        typename Attributes::car_type attribute, Args const &args, Context &caller_context) : attributes(attribute, fusion::as_list(fusion::transform(args, detail::expand_arg<Context>(caller_context)))), locals()
    {
    }
...
struct attribute
{
    ...
    struct result
    {
        typedef typename attributes_of<typename mpl::at_c<typename Env::args_type, 1>::type>::type
            attributes_type;
        ...
        typedef typename fusion::result_of::at_c<attributes_type, N>::type
            type;
    };
...
struct local_variable
{
    ...
    struct result
    {
        typedef typename locals_of<typename mpl::at_c<typename Env::args_type, 1>::type>::type
            locals_type;

        typedef typename fusion::result_of::size<locals_type>::type
            locals_size;
        ...
        typedef typename fusion::result_of::at_c<locals_type, N>::type
            type;
    };
