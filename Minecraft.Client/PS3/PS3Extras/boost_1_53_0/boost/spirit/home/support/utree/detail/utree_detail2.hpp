...
class list::node_iterator<boost::reference_wrapper<Value>>
    : public boost::iterator_facade<
          node_iterator<boost::reference_wrapper<Value>>, boost::reference_wrapper<Value>, boost::bidirectional_traversal_tag>
{
  public:
    node_iterator()
...
struct index_impl
{
    static utree &apply(utree &ut, std::size_t i)
    {
        ...
        default:
            BOOST_THROW_EXCEPTION(
                bad_type_exception("index operation performed on non-list utree type",
                                   ut.get_type()));
        }
    }
...
template <typename F>
typename boost::result_of<F(utree const &, utree const &)>::type inline utree::visit(utree const &x, utree const &y, F f)
{
...
inline void utree::pop_front()
{
    ...
    {
        BOOST_THROW_EXCEPTION(
            bad_type_exception("pop_front() called on non-list utree type",
                               get_type()));
    }
...
inline void utree::pop_back()
{
    ...
    {
        BOOST_THROW_EXCEPTION(
            bad_type_exception("pop_back() called on non-list utree type",
                               get_type()));
    }
...
inline utree::iterator utree::erase(iterator pos)
{
    ...
    {
        BOOST_THROW_EXCEPTION(
            bad_type_exception("erase() called on non-list utree type",
                               get_type()));
    }
...
inline utree::const_iterator utree::begin() const
{
    ...
    {
        BOOST_THROW_EXCEPTION(
            bad_type_exception("begin() called on non-list utree type",
                               get_type()));
    }
...
inline utree::const_iterator utree::end() const
{
    ...
    {
        BOOST_THROW_EXCEPTION(
            bad_type_exception("end() called on non-list utree type",
                               get_type()));
    }
...
inline std::size_t utree::size() const
{
    ...
    {
        BOOST_THROW_EXCEPTION(
            bad_type_exception("size() called on non-list and non-string utree type",
                               get_type()));
    }
...
inline utree &utree::front()
{
    ...
    {
        BOOST_THROW_EXCEPTION(
            bad_type_exception("front() called on non-list utree type", get_type()));
    }
    else if (!l.first)
    {
        BOOST_THROW_EXCEPTION(
...
struct utree_cast
{
    ...
    To operator()(From const &val) const
    {
        ...
        typedef typename boost::mpl::eval_if<
            is_iterator_range<To>, boost::is_same<From, To>, boost::is_convertible<From, To>>::type is_convertible;
