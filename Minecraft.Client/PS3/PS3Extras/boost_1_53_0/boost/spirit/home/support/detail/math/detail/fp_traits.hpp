...
template <class T>
struct uint32_t_coverage
{
    typedef not_all_bits type;
};

template <>
struct uint32_t_coverage<single_precision_tag>
{
    typedef all_bits type;
};

template <class T, class U>
struct fp_traits_impl
{
...
template <class T, class U>
uint32_t fp_traits_impl<T, U>::exponent;
template <class T, class U>
uint32_t fp_traits_impl<T, U>::flag;
template <class T, class U>
uint32_t fp_traits_impl<T, U>::mantissa;
template <class T, class U>
size_t fp_traits_impl<T, U>::offset_;
template <class T, class U>
bool fp_traits_impl<T, U>::is_init_;
...
template <class T, class U>
void fp_traits_impl<T, U>::do_init_()
{
...
template <>
struct fp_traits_impl<float, single_precision_tag>
{
    typedef uint32_t bits;
...
template <>
struct fp_traits_impl<double, double_precision_tag>
{
    typedef uint32_t bits;
...
struct fp_traits_impl<double, double_precision_tag>
{
    ...
    static const uint64_t mantissa = ((uint64_t)0x000fffff << 32) + (uint64_t)0xffffffff;
...
template <>
struct fp_traits_impl<long double, double_precision_tag>
{
    typedef uint32_t bits;
    typedef not_all_bits coverage;
...
#if defined(__i386) || defined(__i386__) || defined(_M_IX86) || defined(__amd64) || defined(__amd64__) || defined(_M_AMD64) || defined(__x86_64) || defined(__x86_64__) || defined(_M_X64)

// Intel extended double precision format (80 bits)

template <>
struct fp_traits_impl<long double, extended_double_precision_tag>
{
    typedef uint32_t bits;
    typedef not_all_bits coverage;
...
#elif defined(__powerpc) || defined(__powerpc__) || defined(__POWERPC__) || defined(__ppc) || defined(__ppc__) || defined(__PPC__)
...
#elif defined(__m68k) || defined(__m68k__) || defined(__mc68000) || defined(__mc68000__)
...
template <>
struct size_to_precision<4>
{
    typedef single_precision_tag type;
};

template <>
struct size_to_precision<8>
{
    typedef double_precision_tag type;
};

template <>
struct size_to_precision<10>
{
    typedef extended_double_precision_tag type;
};

template <>
struct size_to_precision<12>
{
    typedef extended_double_precision_tag type;
};

template <>
struct size_to_precision<16>
{
    typedef extended_double_precision_tag type;
};
