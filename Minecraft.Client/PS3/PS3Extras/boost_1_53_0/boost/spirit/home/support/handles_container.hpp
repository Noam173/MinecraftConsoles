...
struct binary_handles_container
    : mpl::or_<
          handles_container<Left, Attribute, Context, Iterator>, handles_container<Right, Attribute, Context, Iterator>>
{
};
    ...
    : mpl::not_<
          is_same<
              typename mpl::find_if<
                  Elements, handles_container<mpl::_, Attribute, Context, Iterator>>::type,
