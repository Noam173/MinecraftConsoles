...
struct utree_is_less_than
{
    ...
    bool operator()(utree::invalid_type, utree::invalid_type) const
    {
        BOOST_THROW_EXCEPTION(bad_type_exception("no less-than comparison for this utree type",
...
inline utree operator+(utree const &a, utree const &b)
{
    ...
    {
        BOOST_THROW_EXCEPTION(bad_type_exception("addition performed on non-arithmetic utree types",
                                                 a.which(), b.which()));
    }
    return r;
}
...
inline utree operator-(utree const &a, utree const &b)
{
    ...
    if (r.which() == utree_type::invalid_type)
    {
        BOOST_THROW_EXCEPTION(bad_type_exception("subtraction performed on non-arithmetic utree types",
                                                 a.which(), b.which()));
    }
    return r;
}
...
inline utree operator*(utree const &a, utree const &b)
{
    ...
    if (r.which() == utree_type::invalid_type)
    {
        BOOST_THROW_EXCEPTION(bad_type_exception("multiplication performed on non-arithmetic utree types",
                                                 a.which(), b.which()));
    }
    return r;
}
...
inline utree operator/(utree const &a, utree const &b)
{
    ...
    if (r.which() == utree_type::invalid_type)
    {
        BOOST_THROW_EXCEPTION(bad_type_exception("division performed on non-arithmetic utree types",
                                                 a.which(), b.which()));
    }
    return r;
}
...
inline utree operator%(utree const &a, utree const &b)
{
    ...
    if (r.which() == utree_type::invalid_type)
    {
        BOOST_THROW_EXCEPTION(bad_type_exception("modulos performed on non-integral utree types",
                                                 a.which(), b.which()));
    }
    return r;
}
...
inline utree operator-(utree const &a)
{
    ...
    if (r.which() == utree_type::invalid_type)
    {
        BOOST_THROW_EXCEPTION(bad_type_exception("negation performed on non-arithmetic utree type",
                                                 a.which()));
    }
    return r;
}
...
inline utree operator&(utree const &a, utree const &b)
{
    ...
    if (r.which() == utree_type::invalid_type)
    {
        BOOST_THROW_EXCEPTION(bad_type_exception("bitwise and performed on non-integral utree types",
                                                 a.which(), b.which()));
    }
    return r;
}
...
inline utree operator|(utree const &a, utree const &b)
{
    ...
    if (r.which() == utree_type::invalid_type)
    {
        BOOST_THROW_EXCEPTION(bad_type_exception("bitwise or performed on non-integral utree types",
                                                 a.which(), b.which()));
    }
    return r;
}
...
inline utree operator^(utree const &a, utree const &b)
{
    ...
    if (r.which() == utree_type::invalid_type)
    {
        BOOST_THROW_EXCEPTION(bad_type_exception("bitwise xor performed on non-integral utree types",
                                                 a.which(), b.which()));
    }
    return r;
}
...
inline utree operator<<(utree const &a, utree const &b)
{
    ...
    if (r.which() == utree_type::invalid_type)
    {
        BOOST_THROW_EXCEPTION(bad_type_exception("left shift performed on non-integral utree types",
                                                 a.which(), b.which()));
    }
    return r;
}
...
inline utree operator>>(utree const &a, utree const &b)
{
    ...
    if (r.which() == utree_type::invalid_type)
    {
        BOOST_THROW_EXCEPTION(bad_type_exception("right shift performed on non-integral utree types",
                                                 a.which(), b.which()));
    }
    return r;
}
...
inline utree operator~(utree const &a)
{
    ...
    if (r.which() == utree_type::invalid_type)
    {
        BOOST_THROW_EXCEPTION(bad_type_exception("inversion performed on non-integral utree type",
                                                 a.which()));
    }
    return r;
}
