    ...
    : proto::transform_impl<Expr, State, Data>
{
    ...
    typedef make_component<Domain, proto::tag::terminal>
        make_component_;

    typedef typename make_component_::template result<make_component_(elements, Data)>::type
        result_type;

    result_type operator()(
        typename make_terminal_impl::expr_param expr, typename make_terminal_impl::state_param /*state*/
        ,
...
struct make_unary : proto::transform<make_unary<Domain, Tag, Grammar>>
{
    ...
    {
        typedef typename proto::result_of::child_c<Expr, 0>::type
            child;
        ...
        typedef typename result_of::make_cons<child_component>::type
            elements;
    ...
    : proto::transform<make_binary<Domain, Tag, Grammar>>
{
    ...
    struct impl : proto::transform_impl<Expr, State, Data>
    {
        typedef typename proto::reverse_fold_tree<
            proto::_, proto::make<fusion::nil>, make_binary_helper<Grammar>>::template impl<Expr, State, Data>
            reverse_fold_tree;
...
struct make_directive : proto::transform<make_directive<Domain, Grammar>>
{
    ...
    struct impl : proto::transform_impl<Expr, State, Data>
    {
        ...
        typedef typename proto::result_of::value<lhs>::type
            tag_type;
        ...
        typedef typename Grammar::
            template result<Grammar(
                typename proto::result_of::child_c<Expr, 1>::type, State, modifier_type)>::type
                rhs_component;
    ...
    struct impl : proto::transform_impl<Expr, State, Data>
    {
        ...
        typedef
            typename mpl::eval_if_c<
                ...
                proto::result_of::child_c<Expr, 1>, proto::result_of::value<typename proto::result_of::child_c<Expr, 1>::type>>::type
                rhs_component;
#endif
        ...
        {
            return (*this)(
                expr, state, data, typename phoenix::is_actor<typename proto::result_of::child_c<Expr, 1>::type>::type());
        }

        result_type operator()(
            typename impl::expr_param expr, typename impl::state_param state, typename impl::data_param data, mpl::false_) const
        {
            elements_type elements =
                detail::make_cons(
                    Grammar()(
        ...
        result_type operator()(
            typename impl::expr_param expr, typename impl::state_param state, typename impl::data_param data, mpl::true_) const
        {
            elements_type elements =
                detail::make_cons(
                    Grammar()(
