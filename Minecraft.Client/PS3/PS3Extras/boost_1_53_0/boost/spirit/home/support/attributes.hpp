...
struct value_type_is_substitute
    : is_substitute<
          typename container_value<T>::type, typename container_value<Expected>::type>
{
};
...
struct is_weak_substitute_impl<T, Expected,
                               typename enable_if<
                                   mpl::and_<
                                       is_container<T>, is_container<Expected>, value_type_is_weak_substitute<T, Expected>>>::type>
    : mpl::true_
{
};
...
struct is_weak_substitute_impl<T, Expected,
                               typename enable_if<
                                   mpl::and_<
                                       fusion::traits::is_sequence<T>, fusion::traits::is_sequence<Expected>, mpl::equal<T, Expected, is_weak_substitute<mpl::_1, mpl::_2>>>>::type>
    : mpl::true_
{
};
...
struct is_weak_substitute_impl<T, Expected,
                               typename enable_if<
                                   mpl::and_<
                                       mpl::not_<fusion::traits::is_sequence<T>>, fusion::traits::is_sequence<Expected>>>::type>
    : mpl::false_
{
};
} // namespace detail
...
struct compute_compatible_component_variant
    : mpl::or_<
          traits::detail::attribute_is_compatible<Expected, Attribute>, traits::is_hold_any<Expected>, mpl::eval_if<is_container<Expected>, traits::detail::is_hold_any_container<Expected>, mpl::false_>>
{
};
...
struct compute_compatible_component_variant<Variant, Expected, mpl::false_, typename enable_if<detail::has_types<Variant>>::type>
{
    ...
    typedef typename mpl::find_if<types, is_same<Expected, mpl::_1>>::type
        iter;

    typedef typename mpl::distance<
        typename mpl::begin<types>::type, iter>::type distance;
    ...
    typedef typename mpl::eval_if<type, mpl::deref<iter>, mpl::identity<unused_type>>::type
        compatible_type;
...
struct compute_compatible_component
    : compute_compatible_component_variant<Attribute, Expected, typename spirit::traits::not_is_variant<Attribute, Domain>::type>
{
};
...
struct attribute_not_unused
{
    ...
    struct apply
        : not_is_unused<typename attribute_of<Component, Context, Iterator>::type>
    {
    };
};
...
struct attribute_size_impl<Attribute, typename enable_if<
                                          mpl::and_<
                                              fusion::traits::is_sequence<Attribute>, mpl::not_<traits::is_container<Attribute>>>>::type>
{
...
struct attribute_size_impl<Attribute, typename enable_if<
                                          mpl::and_<
                                              traits::is_container<Attribute>, mpl::not_<traits::is_iterator_range<Attribute>>>>::type>
{
...
struct wrap_if_not_tuple
    : mpl::if_<
          fusion::traits::is_sequence<Attribute>, Attribute &, fusion::vector1<Attribute &>>
{
};
...
struct build_fusion_vector
{
    ...
    typedef typename filter_unused_attributes<Sequence>::type
        filtered_attributes;
    ...
    typedef typename mpl::eval_if<
        fusion::result_of::empty<filtered_attributes>, mpl::identity<unused_type>, fusion::result_of::as_vector<filtered_attributes>>::type
        type;
};
...
struct build_attribute_sequence
{
    ...
    typedef typename fusion::result_of::transform<Sequence, element_attribute>::type
        type;
};
...
struct has_no_unused
    : is_same<
          typename mpl::find_if<Sequence, is_same<mpl::_, unused_type>>::type, typename mpl::end<Sequence>::type>
{
};
...
struct build_collapsed_variant<Sequence, false, 2>
{
    typedef boost::optional<
        typename mpl::deref<
            typename mpl::next<
                typename mpl::begin<Sequence>::type>::type>::type>
        type;
};
} // namespace detail
...
struct build_variant
{
    ...
    typedef typename mpl::fold<
        ...
        mpl::if_<
            ...
            mpl::_1, mpl::push_back<mpl::_1, mpl::_2>>>::type
        no_duplicates;
...
struct make_attribute
{
    ...
    typedef typename mpl::if_<
        is_same<typename remove_const<ActualAttribute>::type, unused_type>, attribute_type, ActualAttribute &>::type
        type;
...
// sequence
///////////////////////////////////////////////////////////////////////////
template <typename T, bool IsFusionSeq = fusion::traits::is_sequence<T>::value, bool IsProtoExpr = proto::is_expr<T>::value>
...
struct token_printer_debug
    : mpl::if_<
          ...
          detail::token_printer_debug_for_chars, detail::token_printer_debug>::type
{
};
