...
{
template <
    typename F, typename A0 = void, typename A1 = void, typename A2 = void, typename Dummy = void>
...
struct function_eval<F, A0>
{
    typedef phoenix::actor<
        typename phoenix::as_composite<
            phoenix::detail::function_eval<1>, F, A0>::type>
        type;
...
struct function_eval<F, A0, A1>
{
    typedef phoenix::actor<
        typename phoenix::as_composite<
            phoenix::detail::function_eval<2>, F, A0, A1>::type>
        type;
...
struct function_eval<F, A0, A1, A2>
{
    typedef phoenix::actor<
        typename phoenix::as_composite<
            phoenix::detail::function_eval<3>, F, A0, A1, A2>::type>
        type;
