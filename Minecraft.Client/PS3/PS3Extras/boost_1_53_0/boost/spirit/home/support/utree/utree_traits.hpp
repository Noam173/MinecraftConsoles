...
{
    static int call(utree::list_type const &u)
    {
        return u.which();
    }
};
...
template <
    typename IteratorA, typename IteratorB, typename Context, typename T1, typename T2, typename T3, typename T4>
