  ...
  protected:
                             ...
                             bool &seen_BOL_assertion_, bool &seen_EOL_assertion_)
    {
             ...
             iter_ != end_; ++iter_)
        {
            ...
            macro_iter_pair map_iter_ = macromap_.insert(macro_pair(name_, static_cast<const detail::node *>(0)));
                          ...
                          size_t_vector &dfa_)
    {
        ...
        for (std::size_t index_ = 0; index_ < seen_vectors_->size(); ++index_)
        {
                 ...
                 iter_ != end_; ++iter_)
            {
                ...
                const std::size_t transition_ = closure(&equivset_->_followpos, seen_sets_, seen_vectors_,
                                                        hash_vector_, dfa_alphabet_, dfa_);
