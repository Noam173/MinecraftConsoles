...
#define BOOST_SPIRIT_FAKE_CALL(T) (*(T *)0)
    ...
    static auto do_call(F &&f, fwd_tag<A>, fwd_tag<B>, ...)
        -> typename fwd_storage<
            decltype(f(BOOST_SPIRIT_FAKE_CALL(A), BOOST_SPIRIT_FAKE_CALL(B))), fwd_attrib_context>::type
    {
        return {};
    }
    ...
    static auto do_call(F &&f, fwd_tag<A>, fwd_tag<B>, fwd_tag<C>, ...)
        -> typename fwd_storage<
            decltype(f(BOOST_SPIRIT_FAKE_CALL(A), BOOST_SPIRIT_FAKE_CALL(B), BOOST_SPIRIT_FAKE_CALL(C))), fwd_attrib_context_pass>::type
    {
        return {};
    }
    ...
    {
        do_call(f, fwd_tag<typename std::remove_reference<A>::type>()...)(std::forward<F>(f), std::forward<A>(a)...);
    }
