...
struct less_type
{
    ...
    struct result
    {
        typedef typename remove_const<
            typename mpl::at_c<typename Env::args_type, 4>::type>::type
            context_type;
...
inline typename expression::less<
    typename phoenix::as_actor<T>::type>::type const
less(T const &v)
{
...
inline typename expression::lookahead<
    typename phoenix::as_actor<T>::type, typename phoenix::as_actor<std::size_t>::type>::type const
...
inline typename expression::lookahead<
    typename phoenix::as_actor<Idtype>::type, typename phoenix::as_actor<std::size_t>::type>::type const
