...
struct wrap_action
{
    ...
    {
        void (*pf)(void (*)(A0, A1, A2, A3), Iterator &, Iterator &, BOOST_SCOPED_ENUM(pass_flags) &, IdType &, Context const &) = &wrap_action::arg4_action;
    ...
    {
        void (*pf)(void (*)(A0, A1, A2), Iterator &, Iterator &, BOOST_SCOPED_ENUM(pass_flags) &, IdType, Context const &) = &wrap_action::arg3_action;
    ...
    {
        void (*pf)(void (*)(A0, A1), Iterator &, Iterator &, BOOST_SCOPED_ENUM(pass_flags) &, IdType, Context const &) = &wrap_action::arg2_action;
    ...
    {
        void (*pf)(void (*)(), Iterator &, Iterator &, BOOST_SCOPED_ENUM(pass_flags) &, IdType, Context const &) = &arg0_action;
