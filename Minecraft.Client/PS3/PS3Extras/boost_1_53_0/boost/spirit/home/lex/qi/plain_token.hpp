...
struct use_terminal<qi::domain, terminal_ex<tag::token, fusion::vector1<A0>>> : mpl::or_<is_integral<A0>, is_enum<A0>>
{
};

// enables token(idmin, idmax)
template <typename A0, typename A1>
struct use_terminal<qi::domain, terminal_ex<tag::token, fusion::vector2<A0, A1>>> : mpl::and_<
...
struct use_lazy_terminal<
    qi::domain, tag::token, 1> : mpl::true_
{
};
...
template <>
struct use_lazy_terminal<
    qi::domain, tag::token, 2> : mpl::true_
{
};
} // namespace spirit
} // namespace boost
