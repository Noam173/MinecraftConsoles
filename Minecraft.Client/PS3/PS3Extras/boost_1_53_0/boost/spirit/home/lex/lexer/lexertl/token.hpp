...
operator<<(std::basic_ostream<Char, Traits> &os, token<Iterator, AttributeTypes, HasState, Idtype> const &t)
{
    if (t.is_valid())
    {
...
struct token_value_type
    : mpl::eval_if<
          ...
          mpl::identity<IteratorPair>, token_value_typesequence<IteratorPair, AttributeTypes>>
{
};
} // namespace detail
...
struct assign_to_container_from_value<Attribute, lex::lexertl::token<Iterator, AttributeTypes, HasState, Idtype>>
    : assign_to_attribute_from_value<Attribute, lex::lexertl::token<Iterator, AttributeTypes, HasState, Idtype>>
{
};
...
{
    static void
    call(lex::lexertl::token<Iterator, lex::omit, HasState, Idtype> const &t, Attribute &attr)
    {
        // do nothing
    }
};
...
struct assign_to_attribute_from_value<
    fusion::vector2<Idtype_, iterator_range<Iterator>>, lex::lexertl::token<Iterator, AttributeTypes, HasState, Idtype>>
{
    static void
    call(lex::lexertl::token<Iterator, AttributeTypes, HasState, Idtype> const &t, fusion::vector2<Idtype_, iterator_range<Iterator>> &attr)
    {
