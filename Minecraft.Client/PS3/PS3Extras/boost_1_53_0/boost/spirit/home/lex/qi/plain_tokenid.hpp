...
struct use_terminal<qi::domain, terminal_ex<tag::tokenid, fusion::vector1<A0>>> : mpl::or_<is_integral<A0>, is_enum<A0>>
{
};

// enables tokenid(idmin, idmax)
template <typename A0, typename A1>
struct use_terminal<qi::domain, terminal_ex<tag::tokenid, fusion::vector2<A0, A1>>> : mpl::and_<
                                                                                          mpl::or_<is_integral<A0>, is_enum<A0>>, mpl::or_<is_integral<A1>, is_enum<A1>>>
{
};
...
struct use_lazy_terminal<
    qi::domain, tag::tokenid, 1> : mpl::true_
{
};
...
template <>
struct use_lazy_terminal<
    qi::domain, tag::tokenid, 2> : mpl::true_
{
};
} // namespace spirit
} // namespace boost
    ...
    : primitive_parser<plain_tokenid_range<TokenId>>
{
    ...
    info what(Context & /*context*/) const
    {
        return info("tokenid_range", "token(" +
