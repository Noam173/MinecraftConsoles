...
{
    template <
        typename Env, typename Init, typename Cond, typename Step, typename Do>
    struct result
    {
        typedef void type;
    };
    ...
    template <
        typename RT, typename Env, typename Init, typename Cond, typename Step, typename Do>
    static void
    eval(
        Env const &env, Init &init, Cond &cond, Step &step, Do &do_)
    {
