...
struct compute_no_nullary
{
    ...
    struct apply
    {
        typedef typename mpl::or_<typename T::no_nullary, State>::type
            type;
    };
};
} // namespace detail
...
struct composite : EvalTuple
{
    ...
    typedef typename mpl::fold<
        EvalTuple, mpl::false_, detail::compute_no_nullary>::type
        no_nullary;
    ...
    eval(Env const &env) const
    {
        ...
        return detail::
            composite_eval<fusion::result_of::size<base_type>::value>::template call<return_type>(*this, env);
    }
