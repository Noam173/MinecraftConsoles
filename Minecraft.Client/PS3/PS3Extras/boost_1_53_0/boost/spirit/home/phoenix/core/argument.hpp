...
struct argument
{
    ...
    struct result
    {
        typedef typename fusion::result_of::at<typename Env::tie_type, mpl::int_<N>>::type
            type;
    };
    ...
    eval(Env const &env) const
    {
        typedef typename mpl::if_<
            mpl::less<mpl::int_<N>, mpl::size<typename Env::args_type>>, int, detail::error_argument_not_found<argument<N>>>::type
            check_out_of_bounds;
