...
void ref(actor<Base> const &v, detail::error_attempting_to_convert_an_actor_to_a_reference = detail::error_attempting_to_convert_an_actor_to_a_reference());

template <typename Base>
void cref(actor<Base> const &v, detail::error_attempting_to_convert_an_actor_to_a_reference = detail::error_attempting_to_convert_an_actor_to_a_reference());
} // namespace phoenix
} // namespace boost
