...
{
    template <
        typename Env, typename Cond, typename Default, typename Case0>
    struct result
    {
        typedef void type;
    };
    ...
    template <
        typename RT, typename Env, typename Cond, typename Default, typename Case0>
    static void
    eval(
        Env const &env, Cond &cond, Default &default_, Case0 &_0)
    {
...
{
    template <
        typename Env, typename Cond, typename Default, typename Case0, typename Case1>
    struct result
    {
        typedef void type;
    };
    ...
    template <
        typename RT, typename Env, typename Cond, typename Default, typename Case0, typename Case1>
    static void
    eval(
        Env const &env, Cond &cond, Default &default_, Case0 &_0, Case1 &_1)
    {
        switch (cond.eval(env))
        {
        case Case0::value:
