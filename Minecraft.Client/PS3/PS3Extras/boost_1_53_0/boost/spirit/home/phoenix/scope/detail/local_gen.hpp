...
#define PHOENIX_LOCAL_GEN_PARAM(z, n, data) \
    actor<composite<assign_eval, fusion::vector<local_variable<K##n>, V##n>>> const &a##n
...
template <
    BOOST_PP_ENUM_PARAMS(N, typename K), BOOST_PP_ENUM_PARAMS(N, typename V)>
PHOENIX_LOCAL_GEN_NAME<
    fusion::vector<BOOST_PP_ENUM_PARAMS(N, V)>, detail::map_local_index_to_tuple<BOOST_PP_ENUM_PARAMS(N, K)>>
operator()(
    BOOST_PP_ENUM(N, PHOENIX_LOCAL_GEN_PARAM, _)) const
{
