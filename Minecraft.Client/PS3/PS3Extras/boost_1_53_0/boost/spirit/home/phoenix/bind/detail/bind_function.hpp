...
template <typename RT, BOOST_PP_ENUM_PARAMS(N, typename T), BOOST_PP_ENUM_PARAMS(N, typename A)>
inline actor<
    typename as_composite<
        detail::function_eval<N>, detail::function_ptr<N, RT, RT (*)(BOOST_PP_ENUM_PARAMS(N, T))>, BOOST_PP_ENUM_PARAMS(N, A)>::type>
bind(RT (*f)(BOOST_PP_ENUM_PARAMS(N, T)), BOOST_PP_ENUM_BINARY_PARAMS(N, A, const &_))
{
    typedef detail::function_ptr<
        N, RT, RT (*)(BOOST_PP_ENUM_PARAMS(N, T))>
        fp_type;
