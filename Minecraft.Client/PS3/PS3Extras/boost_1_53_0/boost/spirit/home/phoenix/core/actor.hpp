...
struct actor : Eval
{
    ...
    typedef typename mpl::eval_if<
        ...
        ,
        mpl::identity<detail::error_expecting_arguments>, eval_result<eval_type, basic_environment<>>>::type
        nullary_result;
...
operator,
    (actor<BaseT0> const &a0, actor<BaseT1> const &a1);
} // namespace phoenix
} // namespace boost
