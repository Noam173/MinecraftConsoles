...
{
    template <
        typename C, typename Arg1 = fusion::void_, typename Arg2 = fusion::void_, typename Arg3 = fusion::void_>
    struct result
    {
...
struct erase
{
    ...
    struct result
    {
        ...
        typedef typename boost::mpl::eval_if<
            has_mapped_type<C>, map_erase_result, iterator_of<C>>::type
            type;
    };
...
struct insert
{
    ...
    template <
        typename C, typename Arg1, typename Arg2 = fusion::void_, typename Arg3 = fusion::void_>
    class result
    {
        ...
        typedef boost::mpl::eval_if<
            map_insert_returns_pair<C>, pair_iterator_bool, iterator_of<C>>
            choice_1;

        typedef boost::mpl::eval_if<
            boost::mpl::and_<
                boost::is_same<Arg3, fusion::void_>, boost::mpl::not_<boost::is_same<Arg1, Arg2>>>,
            iterator_of<C>, boost::mpl::identity<void>>
            choice_2;

      public:
        typedef typename boost::mpl::eval_if<
            boost::is_same<Arg2, fusion::void_>, choice_1, choice_2>::type
            type;
    };
...
{
    template <
        typename C, typename Arg1, typename Arg2, typename Arg3 = fusion::void_, typename Arg4 = fusion::void_>
    struct result
    {
        typedef void type;
    };
    ...
    void operator()(
        C &c, Arg1 const &arg1, Arg2 &arg2, Arg3 const &arg3) const
    {
    ...
    void operator()(
        C &c, Arg1 const &arg1, Arg2 &arg2, Arg3 const &arg3, Arg4 const &arg4) const
    {
