...
#define PHOENIX_AS_ACTOR(z, n, data) \
    typename mpl::eval_if<           \
        is_same<BOOST_PP_CAT(T, n), fusion::void_>, mpl::identity<fusion::void_>, as_actor_base<BOOST_PP_CAT(T, n)>>::type
...
///////////////////////////////////////////////////////////////////////////////
template <
    typename EvalPolicy, BOOST_PP_ENUM_PARAMS_WITH_A_DEFAULT(
                             PHOENIX_COMPOSITE_LIMIT, typename T, fusion::void_)>
struct as_composite
{
    typedef composite<
        EvalPolicy, fusion::vector<
...
struct re_curry
{
    typedef actor<
        typename as_composite<
            EvalPolicy, BOOST_PP_ENUM_PARAMS(PHOENIX_COMPOSITE_LIMIT, T)>::type>
        type;
};
} // namespace phoenix
} // namespace boost
