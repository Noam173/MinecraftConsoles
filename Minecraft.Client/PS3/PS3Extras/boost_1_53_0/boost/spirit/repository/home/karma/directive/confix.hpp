...
struct make_directive<
    terminal_ex<repository::tag::confix, fusion::vector2<Prefix, Suffix>>, Subject, Modifiers>
{
    ...
    typedef repository::karma::confix_generator<
        Subject, prefix_type, suffix_type>
        result_type;

    template <typename Terminal>
    result_type operator()(Terminal const &term, Subject const &subject, Modifiers const &modifiers) const
    {
        return result_type(subject, compile<karma::domain>(fusion::at_c<0>(term.args), modifiers), compile<karma::domain>(fusion::at_c<1>(term.args), modifiers));
    }
};
...
struct has_semantic_action<
    ...
    : mpl::or_<
          has_semantic_action<Subject>, has_semantic_action<Prefix>, has_semantic_action<Suffix>>
{
};
} // namespace traits
} // namespace spirit
