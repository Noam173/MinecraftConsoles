...
struct subrule_group
    : proto::extends<
          typename proto::terminal<
              spirit::qi::reference<subrule_group<Defs> const>>::type,
          subrule_group<Defs>>,
      spirit::qi::parser<subrule_group<Defs>>
{
    ...
    bool parse_subrule(Def const &def, Iterator &first, Iterator const &last, Context & /*caller_context*/, Skipper const &skipper, Attribute &attr) const
    {
...
struct subrule
    : proto::extends<
          typename proto::terminal<
              spirit::qi::reference<subrule<ID_, T1, T2> const>>::type,
          subrule<ID_, T1, T2>>,
      spirit::qi::parser<subrule<ID_, T1, T2>>
{
    ...
    bool parse(Iterator &first, Iterator const &last, subrule_context<Group, Attributes, Locals> &context, Skipper const &skipper, Attribute &attr, Params const &params) const
    {
        return context.group.template parse_subrule_id<ID_>(
