...
struct subrule_group
    : proto::extends<
          typename proto::terminal<
              spirit::karma::reference<subrule_group<Defs> const>>::type,
          subrule_group<Defs>>,
      spirit::karma::generator<subrule_group<Defs>>
{
    ...
    static size_t const params_size =
        // Forward to first subrule.
        remove_reference<
            typename fusion::result_of::front<Defs>::type>::type::second_type::params_size;

    subrule_group(subrule_group const &rhs)
        : base_type(terminal::make(reference_(*this))), defs(rhs.defs)
    {
    }

    explicit subrule_group(Defs const &defs)
        : base_type(terminal::make(reference_(*this))), defs(defs)
    {
    }
    ...
    struct def_type
    {
        ...
        typedef typename fusion::result_of::at_key<defs_type const, id_type>::type
            type;
    };
    ...
    bool generate_subrule(Def const &def, OutputIterator &sink, Context & /*caller_context*/, Delimiter const &delimiter, Attribute const &attr) const
    {
        ...
        typedef subrule_context<
            this_type, fusion::cons<subrule_attr_reference_type, subrule_parameter_types>, subrule_locals_type>
            context_type;
        ...
        context_type context(*this, traits::pre_transform<karma::domain, subrule_attr_type>(
    ...
    bool generate_subrule(Def const &def, OutputIterator &sink, Context &caller_context, Delimiter const &delimiter, Attribute const &attr, Params const &params) const
    {
        ...
        context_type context(*this, traits::pre_transform<karma::domain, subrule_attr_type>(make_attribute::call(attr)), params, caller_context);
...
///////////////////////////////////////////////////////////////////////////
template <
    int ID_, typename Locals, typename Attr, typename AttrRef, typename Parameters, size_t ParamsSize, typename Subject, bool Auto_>
...
///////////////////////////////////////////////////////////////////////////
template <
    int ID_, typename T1 = unused_type, typename T2 = unused_type>
struct subrule
    : proto::extends<
          typename proto::terminal<
              spirit::karma::reference<subrule<ID_, T1, T2> const>>::type,
          subrule<ID_, T1, T2>>,
      spirit::karma::generator<subrule<ID_, T1, T2>>
{
    ...
    typedef mpl::int_<
        spirit::karma::generator_properties::all_properties>
        properties;
    ...
    typedef typename spirit::detail::extract_sig<template_params>::type
        sig_type;

    // This is the subrule's attribute type
    typedef typename spirit::detail::attr_from_sig<sig_type>::type
        attr_type;
    ...
    struct def_type_helper
    {
        ...
        typedef subrule_definition<
            ID_, locals_type, attr_type, attr_reference_type, parameter_types, params_size, subject_type, Auto> const type;
    };
    ...
    struct group_type_helper
    {
        ...
        typedef typename fusion::result_of::make_map<id_type, def_type>::type
            defs_type;
    ...
    {
        return operator%=(
            sr, static_cast<Expr const &>(expr));
    }
    template <typename Expr>
    friend typename group_type_helper<Expr, true>::type
    ...
    {
        return operator%=(
            static_cast<subrule const &>(sr), expr);
    }
    template <typename Expr>
    friend typename group_type_helper<Expr, true>::type
    ...
    {
        return operator%=(
            static_cast<subrule const &>(sr), static_cast<Expr const &>(expr));
    }
                  ...
                  Delimiter const & /*delimiter*/, Attribute const & /*attr*/) const
    {
        ...
        BOOST_SPIRIT_ASSERT_MSG(false, subrule_used_outside_subrule_group, (id_type));
    ...
    bool generate(OutputIterator &sink, subrule_context<Group, Attributes, Locals> &context, Delimiter const &delimiter, Attribute const &attr, Params const &params) const
    {
        return context.group.template generate_subrule_id<ID_>(
