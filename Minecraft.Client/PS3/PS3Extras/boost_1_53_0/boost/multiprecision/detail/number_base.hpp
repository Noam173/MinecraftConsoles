...
struct expression<tag, Arg1, void, void, void>
{
    ...
    const Arg1 &left_ref() const BOOST_NOEXCEPT
    {
        return arg;
    }
...
struct expression<tag, Arg1, Arg2, void, void>
{
    ...
    const Arg2 &right_ref() const BOOST_NOEXCEPT
    {
        return arg2;
    }
...
struct expression<tag, Arg1, Arg2, Arg3, void>
{
    ...
    const Arg2 &middle_ref() const BOOST_NOEXCEPT
    {
        return arg2;
    }
    const Arg3 &right_ref() const BOOST_NOEXCEPT
    {
        return arg3;
    }
...
struct expression
{
    ...
    typedef typename combine_expression<
        typename combine_expression<
            ...
            right_middle_result_type>::type,
        right_result_type>::type result_type;
    typedef tag tag_type;
    ...
    left_middle_type left_middle() const
    {
        return left_middle_type(arg2);
    }
    right_middle_type right_middle() const
    {
    ...
    const Arg2 &left_middle_ref() const BOOST_NOEXCEPT
    {
        return arg2;
    }
    const Arg3 &right_middle_ref() const BOOST_NOEXCEPT
    {
        return arg3;
    }
    const Arg4 &right_ref() const BOOST_NOEXCEPT
    {
        return arg4;
    }
