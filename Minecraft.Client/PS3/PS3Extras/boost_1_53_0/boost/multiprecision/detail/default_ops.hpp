...
#define UNARY_OP_FUNCTOR(func, category)                                                                                                                                            \
    ...
    template <class tag, class A1, class A2, class A3, class A4>                                                                                                                    \
        inline typename enable_if_c<number_category<detail::expression<tag, A1, A2, A3, A4>>::value == category,                                                                    \
                                    detail::expression<                                                                                                                             \
                                        detail::function, detail::BOOST_JOIN(func, _funct) < typename detail::backend_type<detail::expression<tag, A1, A2, A3, A4>>::type>,         \
                                    detail::expression<tag, A1, A2, A3, A4>> > ::type                                                                                               \
                                                                               func(const detail::expression<tag, A1, A2, A3, A4> &arg)                                             \
    {                                                                                                                                                                               \
        return detail::expression<                                                                                                                                                  \
                   detail::function, detail::BOOST_JOIN(func, _funct) < typename detail::backend_type<detail::expression<tag, A1, A2, A3, A4>>::type>,                              \
               detail::expression<tag, A1, A2, A3, A4> > (detail::BOOST_JOIN(func, _funct) < typename detail::backend_type<detail::expression<tag, A1, A2, A3, A4>>::type>(), arg); \
    }                                                                                                                                                                               \
    template <class Backend>                                                                                                                                                        \
        inline typename enable_if_c<number_category<Backend>::value == category,                                                                                                    \
                                    detail::expression<                                                                                                                             \
                                        detail::function, detail::BOOST_JOIN(func, _funct) < Backend>,                                                                              \
                                    number<Backend, et_on>> > ::type                                                                                                                \
                                                              func(const number<Backend, et_on> &arg)                                                                               \
    {                                                                                                                                                                               \
        return detail::expression<                                                                                                                                                  \
                   detail::function, detail::BOOST_JOIN(func, _funct) < Backend>,                                                                                                   \
               number<Backend, et_on> > (detail::BOOST_JOIN(func, _funct) < Backend>(), arg);                                                                                       \
    }                                                                                                                                                                               \
    template <class Backend>                                                                                                                                                        \
...
#define BINARY_OP_FUNCTOR(func, category)                                                                                                                                                                                            \
    ...
    {                                                                                                                                                                                                                                \
        return detail::expression<                                                                                                                                                                                                   \
                   detail::function, detail::BOOST_JOIN(func, _funct) < Backend>,                                                                                                                                                    \
               number<Backend, et_on>, number<Backend, et_on> > (detail::BOOST_JOIN(func, _funct) < Backend>(), arg, a);                                                                                                             \
    }                                                                                                                                                                                                                                \
    ...
    {                                                                                                                                                                                                                                \
        return detail::expression<                                                                                                                                                                                                   \
                   detail::function, detail::BOOST_JOIN(func, _funct) < Backend>,                                                                                                                                                    \
               number<Backend, et_on>, detail::expression<tag, A1, A2, A3, A4> > (detail::BOOST_JOIN(func, _funct) < Backend>(), arg, a);                                                                                            \
    }                                                                                                                                                                                                                                \
    ...
    {                                                                                                                                                                                                                                \
        return detail::expression<                                                                                                                                                                                                   \
                   detail::function, detail::BOOST_JOIN(func, _funct) < Backend>,                                                                                                                                                    \
               detail::expression<tag, A1, A2, A3, A4>, number<Backend, et_on> > (detail::BOOST_JOIN(func, _funct) < Backend>(), arg, a);                                                                                            \
    }                                                                                                                                                                                                                                \
    ...
    {                                                                                                                                                                                                                                \
        return detail::expression<                                                                                                                                                                                                   \
                   detail::function, detail::BOOST_JOIN(func, _funct) < typename detail::backend_type<detail::expression<tag, A1, A2, A3, A4>>::type>,                                                                               \
               detail::expression<tag, A1, A2, A3, A4>, detail::expression<tagb, A1b, A2b, A3b, A4b> > (detail::BOOST_JOIN(func, _funct) < typename detail::backend_type<detail::expression<tag, A1, A2, A3, A4>>::type>(), arg, a); \
    }                                                                                                                                                                                                                                \
    ...
    {                                                                                                                                                                                                                                \
        return detail::expression<                                                                                                                                                                                                   \
                   detail::function, detail::BOOST_JOIN(func, _funct) < Backend>,                                                                                                                                                    \
               number<Backend, et_on>, Arithmetic > (detail::BOOST_JOIN(func, _funct) < Backend>(), arg, a);                                                                                                                         \
    }                                                                                                                                                                                                                                \
    ...
    {                                                                                                                                                                                                                                \
        return detail::expression<                                                                                                                                                                                                   \
                   detail::function, detail::BOOST_JOIN(func, _funct) < typename detail::backend_type<detail::expression<tag, A1, A2, A3, A4>>::type>,                                                                               \
               detail::expression<tag, A1, A2, A3, A4>, Arithmetic > (detail::BOOST_JOIN(func, _funct) < typename detail::backend_type<detail::expression<tag, A1, A2, A3, A4>>::type>(), arg, a);                                   \
    }                                                                                                                                                                                                                                \
    template <class Backend, class Arithmetic>                                                                                                                                                                                       \
        inline typename enable_if_c<                                                                                                                                                                                                 \
            is_arithmetic<Arithmetic>::value && (number_category<Backend>::value == category),                                                                                                                                       \
    ...
    {                                                                                                                                                                                                                                \
        return detail::expression<                                                                                                                                                                                                   \
                   detail::function, detail::BOOST_JOIN(func, _funct) < Backend>,                                                                                                                                                    \
               Arithmetic, number<Backend, et_on> > (detail::BOOST_JOIN(func, _funct) < Backend>(), arg, a);                                                                                                                         \
    }                                                                                                                                                                                                                                \
    template <class tag, class A1, class A2, class A3, class A4, class Arithmetic>                                                                                                                                                   \
        inline typename enable_if_c<                                                                                                                                                                                                 \
            is_arithmetic<Arithmetic>::value && (number_category<detail::expression<tag, A1, A2, A3, A4>>::value == category),                                                                                                       \
    ...
    {                                                                                                                                                                                                                                \
        return detail::expression<                                                                                                                                                                                                   \
                   detail::function, detail::BOOST_JOIN(func, _funct) < typename detail::backend_type<detail::expression<tag, A1, A2, A3, A4>>::type>,                                                                               \
               Arithmetic, detail::expression<tag, A1, A2, A3, A4> > (detail::BOOST_JOIN(func, _funct) < typename detail::backend_type<detail::expression<tag, A1, A2, A3, A4>>::type>(), arg, a);                                   \
    }                                                                                                                                                                                                                                \
    template <class Backend>                                                                                                                                                                                                         \
    inline typename enable_if_c<(number_category<Backend>::value == category),                                                                                                                                                       \
                                number<Backend, et_off>>::type                                                                                                                                                                       \
...
#define HETERO_BINARY_OP_FUNCTOR_B(func, Arg2, category)                                                                                                                                     \
    ...
    {                                                                                                                                                                                        \
        return detail::expression<                                                                                                                                                           \
                   detail::function, detail::BOOST_JOIN(func, _funct) < typename detail::backend_type<detail::expression<tag, A1, A2, A3, A4>>::type>,                                       \
               detail::expression<tag, A1, A2, A3, A4>, Arg2 > (detail::BOOST_JOIN(func, _funct) < typename detail::backend_type<detail::expression<tag, A1, A2, A3, A4>>::type>(), arg, a); \
    }                                                                                                                                                                                        \
    template <class Backend>                                                                                                                                                                 \
        inline typename enable_if_c<                                                                                                                                                         \
    ...
    {                                                                                                                                                                                        \
        return detail::expression<                                                                                                                                                           \
                   detail::function, detail::BOOST_JOIN(func, _funct) < Backend>,                                                                                                            \
               number<Backend, et_on>, Arg2 > (detail::BOOST_JOIN(func, _funct) < Backend>(), arg, a);                                                                                       \
    }                                                                                                                                                                                        \
    template <class Backend>                                                                                                                                                                 \
    inline typename enable_if_c<                                                                                                                                                             \
        (number_category<Backend>::value == category),                                                                                                                                       \
