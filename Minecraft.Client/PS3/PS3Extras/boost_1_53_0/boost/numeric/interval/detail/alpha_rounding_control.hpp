...
struct alpha_rounding_control
{
    ...
    {
        set_rounding_mode(mode_downward.dmode);
    }
    static void upward()
    {
        set_rounding_mode(mode_upward.dmode);
    }
    static void to_nearest()
    {
        set_rounding_mode(mode_to_nearest.dmode);
    }
    static void toward_zero()
    {
        set_rounding_mode(mode_toward_zero.dmode);
    }
};
...
struct alpha_rounding_control
{
    ...
    static void downward()
    {
        set_rounding_mode(FP_RND_RM);
    }
    static void upward()
    {
        set_rounding_mode(FP_RND_RP);
    }
    static void to_nearest()
    {
        set_rounding_mode(FP_RND_RN);
    }
    static void toward_zero()
    {
        set_rounding_mode(FP_RND_RZ);
    }
};
#endif
} // namespace detail
...
struct rounding_control<double> : detail::alpha_rounding_control
{
    ...
    static double to_int(const double &r)
    {
        return rint(r);
    }
};
