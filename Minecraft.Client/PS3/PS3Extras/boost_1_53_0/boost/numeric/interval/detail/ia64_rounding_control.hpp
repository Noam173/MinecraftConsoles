...
template <>
struct rounding_control<float> : detail::ia64_rounding_control
{
...
template <>
struct rounding_control<double> : detail::ia64_rounding_control
{
...
template <>
struct rounding_control<long double> : detail::ia64_rounding_control
{
