...
template <typename ExprT>
BOOST_UBLAS_INLINE
    typename ExprT::iterator
    begin(vector_expression<ExprT> &e)
{
...
BOOST_UBLAS_INLINE
    typename iterator_type<ExprT, TagT>::type
...
template <typename TagT, typename ExprT>
BOOST_UBLAS_INLINE
    typename const_iterator_type<ExprT, TagT>::type
...
BOOST_UBLAS_INLINE
    typename IteratorT::dual_iterator_type
    begin(IteratorT &it)
{
    return it.begin();
}
