...
class index_assign : public fill_policy_wrapper<index_assign>
{
  public:
    ...
    BOOST_UBLAS_INLINE static void apply(T &e, const S &i, const V &v)
    {
        e()(i) = v;
    }
    template <class T, typename S, typename V>
    BOOST_UBLAS_INLINE static void apply(T &e, const S &i, const S &j, const V &v)
    {
        e()(i, j) = v;
    }
};
...
struct no_wrap
{
    ...
    BOOST_UBLAS_INLINE static void apply1(const S1 & /*s*/, S2 & /*i*/, S3 & /*j*/)
    {
    }
     ...
     */
    template <class S1, class S2, class S3>
    BOOST_UBLAS_INLINE static void apply2(const S1 & /*s1*/, const S1 & /*s2*/, S2 & /*i1*/, S3 & /*i2*/)
    {
    }
};
...
struct wrap
{
     ...
     */
    template <class S1, class S2, class S3>
    BOOST_UBLAS_INLINE static void apply1(const S1 &s, S2 &i1, S3 &i2)
    {
        if (i2 >= s)
        {
            i1++;
    ...
    BOOST_UBLAS_INLINE static void apply2(const S1 &s1, const S1 &s2, S2 &i1, S3 &i2)
    {
        if (i2 >= s2)
        {
            i2 = 0; // Wrap to the next block
        }
        else
        {
            i1 -= s1; // Move up (or right) one block
        }
    }
};
...
class by_row_policy : public traverse_policy_wrapper<by_row_policy<Wrap>>
{
  public:
    ...
    BOOST_UBLAS_INLINE static void advance(S1 & /*i*/, S2 &j)
    {
        j++;
    }

    template <class E1, class E2, typename S1, typename S2, typename S3, typename S4, typename S5>
    BOOST_UBLAS_INLINE static bool next(const E1 &e, const E2 &me, S1 &i, S2 &j, const S3 & /*i0*/, const S3 &j0, S4 &k, S5 &l)
    {
        l++;
        j++;
        if (l >= e().size2())
    ...
    BOOST_UBLAS_INLINE static void apply_wrap(const E &e, S1 &i, S2 &j)
    {
...
class matrix_expression_assigner
{
  ...
  private:
    ...
    template <class AE>
    BOOST_UBLAS_INLINE matrix_expression_assigner &apply(const matrix_expression<AE> &nme)
    {
        size_type bi = i;
        size_type bj = j;
