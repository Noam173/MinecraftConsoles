...
template <class V>
class sparse_vector_element : public container_reference<V>
{
  public:
  ...
  public:
    ...
    sparse_vector_element(vector_type &v, size_type i) : container_reference<vector_type>(v), i_(i)
    {
    }
    BOOST_UBLAS_INLINE
    sparse_vector_element(const sparse_vector_element &p) : container_reference<vector_type>(p), i_(p.i_)
    {
    }
    BOOST_UBLAS_INLINE
    ...
    template <class D>
    BOOST_UBLAS_INLINE sparse_vector_element &operator=(const D &d)
    {
        set(d);
        return *this;
    }
...
class mapped_vector : public vector_container<mapped_vector<T, A>>
{
  ...
  public:
    ...
    // Construction and destruction
    BOOST_UBLAS_INLINE
    mapped_vector() : vector_container<self_type>(),
                      size_(0), data_()
    {
    }
    BOOST_UBLAS_INLINE
    mapped_vector(size_type size, size_type non_zeros = 0) : vector_container<self_type>(),
                                                             size_(size), data_()
    {
        detail::map_reserve(data(), restrict_capacity(non_zeros));
    }
    BOOST_UBLAS_INLINE
    mapped_vector(const mapped_vector &v) : vector_container<self_type>(),
                                            size_(v.size_), data_(v.data_)
    {
    }
    template <class AE>
    BOOST_UBLAS_INLINE
    mapped_vector(const vector_expression<AE> &ae, size_type non_zeros = 0) : vector_container<self_type>(),
                                                                              size_(ae().size()), data_()
    {
        detail::map_reserve(data(), restrict_capacity(non_zeros));
  ...
  public:
    ...
    class const_iterator : public container_const_reference<mapped_vector>,
    ...
    class iterator : public container_reference<mapped_vector>,
                     public bidirectional_iterator_base<sparse_bidirectional_iterator_tag,
                                                        iterator, value_type>
    {
      public:
...
class compressed_vector : public vector_container<compressed_vector<T, IB, IA, TA>>
{
  ...
  public:
    ...
    // Construction and destruction
    BOOST_UBLAS_INLINE
    compressed_vector() : vector_container<self_type>(),
    ...
    compressed_vector(size_type size, size_type non_zeros = 0) : vector_container<self_type>(),
    ...
    BOOST_UBLAS_INLINE
    compressed_vector(const compressed_vector &v) : vector_container<self_type>(),
    ...
    template <class AE>
    BOOST_UBLAS_INLINE
    compressed_vector(const vector_expression<AE> &ae, size_type non_zeros = 0) : vector_container<self_type>(),
  ...
  public:
    ...
    class const_iterator : public container_const_reference<compressed_vector>,
                           public bidirectional_iterator_base<sparse_bidirectional_iterator_tag,
                                                              const_iterator, value_type>
    {
      public:
    ...
    class iterator : public container_reference<compressed_vector>,
                     public bidirectional_iterator_base<sparse_bidirectional_iterator_tag,
                                                        iterator, value_type>
    {
      public:
 ...
 */
template <class T, std::size_t IB, class IA, class TA>
class coordinate_vector : public vector_container<coordinate_vector<T, IB, IA, TA>>
{
  ...
  public:
    ...
    // Construction and destruction
    BOOST_UBLAS_INLINE
    coordinate_vector() : vector_container<self_type>(),
    ...
    explicit BOOST_UBLAS_INLINE
    coordinate_vector(size_type size, size_type non_zeros = 0) : vector_container<self_type>(),
    ...
    BOOST_UBLAS_INLINE
    coordinate_vector(const coordinate_vector &v) : vector_container<self_type>(),
    ...
    template <class AE>
    BOOST_UBLAS_INLINE
    coordinate_vector(const vector_expression<AE> &ae, size_type non_zeros = 0) : vector_container<self_type>(),
  ...
  public:
    ...
    template <class C> // Container assignment without temporary
    BOOST_UBLAS_INLINE coordinate_vector &operator=(const vector_container<C> &v)
    {
        resize(v().size(), false);
        assign(v);
        return *this;
    ...
    template <class AE>
    BOOST_UBLAS_INLINE coordinate_vector &operator=(const vector_expression<AE> &ae)
    {
        self_type temporary(ae, capacity_);
        return assign_temporary(temporary);
    }
    template <class AE>
    BOOST_UBLAS_INLINE coordinate_vector &assign(const vector_expression<AE> &ae)
    {
        vector_assign<scalar_assign>(*this, ae);
        return *this;
    }
    ...
    template <class AE>
    BOOST_UBLAS_INLINE coordinate_vector &plus_assign(const vector_expression<AE> &ae)
    {
        vector_assign<scalar_plus_assign>(*this, ae);
        return *this;
    }
    ...
    template <class AE>
    BOOST_UBLAS_INLINE coordinate_vector &minus_assign(const vector_expression<AE> &ae)
    {
        vector_assign<scalar_minus_assign>(*this, ae);
        return *this;
    }
    template <class AT>
    BOOST_UBLAS_INLINE coordinate_vector &operator*=(const AT &at)
    {
        vector_assign_scalar<scalar_multiplies_assign>(*this, at);
        return *this;
    }
  ...
  public:
    ...
    class const_iterator : public container_const_reference<coordinate_vector>,
                           public bidirectional_iterator_base<sparse_bidirectional_iterator_tag,
                                                              const_iterator, value_type>
    {
      public:
    ...
    class iterator : public container_reference<coordinate_vector>,
                     public bidirectional_iterator_base<sparse_bidirectional_iterator_tag,
                                                        iterator, value_type>
    {
      public:
