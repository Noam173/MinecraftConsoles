 ...
 */
template <class E>
class scalar_expression : public ublas_expression<E>
{
  public:
    typedef E expression_type;
...
template <class T>
class scalar_reference : public scalar_expression<scalar_reference<T>>
{
  ...
  public:
    ...
    BOOST_UBLAS_INLINE
    explicit scalar_reference(reference t) : t_(t)
    {
    }
...
class scalar_value : public scalar_expression<scalar_value<T>>
{
  ...
  public:
    ...
    BOOST_UBLAS_INLINE
    scalar_value(const value_type &t) : t_(t)
    {
    }
 ...
 */
template <class E>
class vector_expression : public ublas_expression<E>
{
  public:
  ...
  public:
    ...
    template <class A>
    BOOST_UBLAS_INLINE const vector_indirect<const E, indirect_array<A>> operator()(const indirect_array<A> &ia) const
    {
        return vector_indirect<const E, indirect_array<A>>(operator()(), ia);
    }
    template <class A>
    BOOST_UBLAS_INLINE
        vector_indirect<E, indirect_array<A>>
        operator()(const indirect_array<A> &ia)
    {
    ...
    template <class A>
    BOOST_UBLAS_INLINE const vector_indirect<const E, indirect_array<A>> project(const indirect_array<A> &ia) const
    {
        return vector_indirect<const E, indirect_array<A>>(operator()(), ia);
    }
    template <class A>
    BOOST_UBLAS_INLINE
        vector_indirect<E, indirect_array<A>>
        project(const indirect_array<A> &ia)
    {
        return vector_indirect<E, indirect_array<A>>(operator()(), ia);
    }
#endif
 ...
 */
template <class C>
class vector_container : public vector_expression<C>
{
  public:
    static const unsigned complexity = 0;
...
class matrix_expression : public ublas_expression<E>
{
  ...
  public:
    ...
    template <class A>
    BOOST_UBLAS_INLINE const matrix_indirect<const E, indirect_array<A>> operator()(const indirect_array<A> &ia1, const indirect_array<A> &ia2) const
    {
        return matrix_indirect<const E, indirect_array<A>>(operator()(), ia1, ia2);
    }
    template <class A>
    BOOST_UBLAS_INLINE
        matrix_indirect<E, indirect_array<A>>
        operator()(const indirect_array<A> &ia1, const indirect_array<A> &ia2)
    {
    ...
    template <class A>
    BOOST_UBLAS_INLINE const matrix_indirect<const E, indirect_array<A>> project(const indirect_array<A> &ia1, const indirect_array<A> &ia2) const
    {
        return matrix_indirect<const E, indirect_array<A>>(operator()(), ia1, ia2);
    }
    template <class A>
    BOOST_UBLAS_INLINE
        matrix_indirect<E, indirect_array<A>>
        project(const indirect_array<A> &ia1, const indirect_array<A> &ia2)
    {
        return matrix_indirect<E, indirect_array<A>>(operator()(), ia1, ia2);
    }
#endif
...
template <class I>
BOOST_UBLAS_INLINE
    typename I::dual_iterator_type
    begin(const I &it, iterator1_tag)
{
...
BOOST_UBLAS_INLINE
    typename I::dual_iterator_type
    end(const I &it, iterator1_tag)
{
    return it().find2(1, it.index1(), it().size2());
}
template <class I>
BOOST_UBLAS_INLINE
    typename I::dual_reverse_iterator_type
    rbegin(const I &it, iterator1_tag)
{
...
BOOST_UBLAS_INLINE
    typename I::dual_iterator_type
    begin(const I &it, iterator2_tag)
{
...
BOOST_UBLAS_INLINE
    typename I::dual_reverse_iterator_type
    rbegin(const I &it, iterator2_tag)
{
