...
class generalized_vector_of_vector : public matrix_container<generalized_vector_of_vector<T, L, A>>
{
  ...
  public:
    ...
    BOOST_UBLAS_INLINE
    generalized_vector_of_vector() : matrix_container<self_type>(),
    ...
    BOOST_UBLAS_INLINE
    generalized_vector_of_vector(size_type size1, size_type size2, size_type non_zeros = 0) : matrix_container<self_type>(),
    ...
    BOOST_UBLAS_INLINE
    generalized_vector_of_vector(const generalized_vector_of_vector &m) : matrix_container<self_type>(),
    ...
    template <class AE>
    BOOST_UBLAS_INLINE
    generalized_vector_of_vector(const matrix_expression<AE> &ae, size_type non_zeros = 0) : matrix_container<self_type>(),
    ...
    template <class AE>
    BOOST_UBLAS_INLINE generalized_vector_of_vector &operator=(const matrix_expression<AE> &ae)
    {
        self_type temporary(ae);
        return assign_temporary(temporary);
    }
    template <class AE>
    BOOST_UBLAS_INLINE generalized_vector_of_vector &assign(const matrix_expression<AE> &ae)
    {
        matrix_assign<scalar_assign>(*this, ae);
        return *this;
    }
    ...
    template <class AE>
    BOOST_UBLAS_INLINE generalized_vector_of_vector &plus_assign(const matrix_expression<AE> &ae)
    {
    ...
    template <class AE>
    BOOST_UBLAS_INLINE generalized_vector_of_vector &minus_assign(const matrix_expression<AE> &ae)
    {
        matrix_assign<scalar_minus_assign>(*this, ae);
        return *this;
    }
    template <class AT>
    BOOST_UBLAS_INLINE generalized_vector_of_vector &operator*=(const AT &at)
    {
  ...
  public:
    ...
    class const_iterator1 : public container_const_reference<generalized_vector_of_vector>,
                                                               ...
                                                               const_iterator1, value_type>
    {
      public:
        ...
        BOOST_UBLAS_INLINE
        const_iterator1(const self_type &m, int rank, size_type i, size_type j, const const_vectoriterator_type &itv, const const_subiterator_type &it) : container_const_reference<self_type>(m), rank_(rank), i_(i), j_(j), itv_(itv), it_(it)
        {
        }
        BOOST_UBLAS_INLINE
    ...
    class iterator1 : public container_reference<generalized_vector_of_vector>,
                      public bidirectional_iterator_base<sparse_bidirectional_iterator_tag,
                                                         iterator1, value_type>
    {
      public:
        ...
        BOOST_UBLAS_INLINE
        iterator1(self_type &m, int rank, size_type i, size_type j, const vectoriterator_type &itv, const subiterator_type &it) : container_reference<self_type>(m), rank_(rank), i_(i), j_(j), itv_(itv), it_(it)
        {
        }
                                                               ...
                                                               const_iterator2, value_type>
    {
      public:
        ...
        BOOST_UBLAS_INLINE
        const_iterator2(const self_type &m, int rank, size_type i, size_type j, const const_vectoriterator_type &itv, const const_subiterator_type &it) : container_const_reference<self_type>(m), rank_(rank), i_(i), j_(j), itv_(itv), it_(it)
        {
        }
        BOOST_UBLAS_INLINE
    ...
    class iterator2 : public container_reference<generalized_vector_of_vector>,
                      public bidirectional_iterator_base<sparse_bidirectional_iterator_tag,
                                                         iterator2, value_type>
    {
      public:
        ...
        BOOST_UBLAS_INLINE
        iterator2(self_type &m, int rank, size_type i, size_type j, const vectoriterator_type &itv, const subiterator_type &it) : container_reference<self_type>(m), rank_(rank), i_(i), j_(j), itv_(itv), it_(it)
        {
        }
