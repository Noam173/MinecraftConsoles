...
template <class E>
class storage_array : private nonassignable
{
};

// Unbounded array - with allocator
template <class T, class ALLOC>
class unbounded_array : public storage_array<unbounded_array<T, ALLOC>>
{
  ...
  public:
    ...
    unbounded_array(const ALLOC &a = ALLOC()) : alloc_(a), size_(0)
    {
        data_ = 0;
    }
    explicit BOOST_UBLAS_INLINE
    unbounded_array(size_type size, const ALLOC &a = ALLOC()) : alloc_(a), size_(size)
    {
        if (size_)
        {
    ...
    BOOST_UBLAS_INLINE
    unbounded_array(size_type size, const value_type &init, const ALLOC &a = ALLOC()) : alloc_(a), size_(size)
    {
        if (size_)
        {
            data_ = alloc_.allocate(size_);
    ...
    BOOST_UBLAS_INLINE
    unbounded_array(const unbounded_array &c) : storage_array<unbounded_array<T, ALLOC>>(),
...
class bounded_array : public storage_array<bounded_array<T, N, ALLOC>>
{
  ...
  public:
    ...
    // Construction and destruction
    BOOST_UBLAS_INLINE
    bounded_array() : size_(0) /*, data_ ()*/
    {                          // size 0 - use bounded_vector to default construct with size N
    }
    explicit BOOST_UBLAS_INLINE
    bounded_array(size_type size) : size_(size) /*, data_ ()*/
    {
        BOOST_UBLAS_CHECK(size_ <= N, bad_size());
        // data_ (an array) elements are already default constructed
    }
    BOOST_UBLAS_INLINE
    bounded_array(size_type size, const value_type &init) : size_(size) /*, data_ ()*/
    {
        BOOST_UBLAS_CHECK(size_ <= N, bad_size());
    ...
    BOOST_UBLAS_INLINE
    bounded_array(const bounded_array &c) : size_(c.size_)
    {
...
template <class T>
class array_adaptor : public storage_array<array_adaptor<T>>
{
  ...
  public:
    ...
    // Construction and destruction
    BOOST_UBLAS_INLINE
    array_adaptor() : size_(0), own_(true), data_(new value_type[0])
    {
    }
    explicit BOOST_UBLAS_INLINE
    array_adaptor(size_type size) : size_(size), own_(true), data_(new value_type[size])
    {
    }
    BOOST_UBLAS_INLINE
    array_adaptor(size_type size, const value_type &init) : size_(size), own_(true), data_(new value_type[size])
    {
        std::fill(data_, data_ + size_, init);
    }
    BOOST_UBLAS_INLINE
    array_adaptor(size_type size, pointer data) : size_(size), own_(false), data_(data)
    {
    }
    BOOST_UBLAS_INLINE
    array_adaptor(const array_adaptor &a) : storage_array<self_type>(),
...
template <class T>
class shallow_array_adaptor : public storage_array<shallow_array_adaptor<T>>
{
  ...
  public:
    ...
    // Construction and destruction
    BOOST_UBLAS_INLINE
    shallow_array_adaptor() : size_(0), own_(true), data_(new value_type[0])
    {
    }
    explicit BOOST_UBLAS_INLINE
    shallow_array_adaptor(size_type size) : size_(size), own_(true), data_(new value_type[size])
    {
    }
    BOOST_UBLAS_INLINE
    shallow_array_adaptor(size_type size, const value_type &init) : size_(size), own_(true), data_(new value_type[size])
    {
        std::fill(data_.get(), data_.get() + size_, init);
    }
    BOOST_UBLAS_INLINE
    shallow_array_adaptor(size_type size, pointer data) : size_(size), own_(false), data_(data, leaker<value_type>())
    {
    }

    BOOST_UBLAS_INLINE
    shallow_array_adaptor(const shallow_array_adaptor &a) : storage_array<self_type>(),
...
class basic_range
{
  ...
  public:
    ...
    BOOST_UBLAS_INLINE
    basic_range(size_type start, size_type stop) : start_(start), size_(stop - start)
    {
  ...
  public:
...
#else
    class const_iterator : public container_const_reference<basic_range>,
                                                              ...
                                                              const_iterator, value_type>
    {
      public:
        ...
        // Construction and destruction
        BOOST_UBLAS_INLINE
        const_iterator() : container_const_reference<basic_range>(), it_()
        {
        }
        BOOST_UBLAS_INLINE
        const_iterator(const basic_range &r, const const_subiterator_type &it) : container_const_reference<basic_range>(r), it_(it)
        {
        }
...
class basic_slice
{
  ...
  public:
    ...
    // Construction and destruction
    BOOST_UBLAS_INLINE
    basic_slice() : start_(0), stride_(0), size_(0)
    {
    }
    BOOST_UBLAS_INLINE
    basic_slice(size_type start, difference_type stride, size_type size) : start_(start), stride_(stride), size_(size)
    {
    }
  ...
  public:
    ...
    typedef indexed_const_iterator<self_type, std::random_access_iterator_tag> const_iterator;
#else
    class const_iterator : public container_const_reference<basic_slice>,
                           public random_access_iterator_base<std::random_access_iterator_tag,
                                                              const_iterator, value_type>
    {
      public:
        ...
        // Construction and destruction
        BOOST_UBLAS_INLINE
        const_iterator() : container_const_reference<basic_slice>(), it_()
        {
        }
        BOOST_UBLAS_INLINE
        const_iterator(const basic_slice &s, const const_subiterator_type &it) : container_const_reference<basic_slice>(s), it_(it)
        {
        }
...
class indirect_array
{
  ...
  public:
    ...
    // Construction and destruction
    BOOST_UBLAS_INLINE
    indirect_array() : size_(), data_()
    {
    }
    explicit BOOST_UBLAS_INLINE
    indirect_array(size_type size) : size_(size), data_(size)
    {
    }
    BOOST_UBLAS_INLINE
    indirect_array(size_type size, const array_type &data) : size_(size), data_(data)
    {
    }
    BOOST_UBLAS_INLINE
    indirect_array(pointer start, pointer stop) : size_(stop - start), data_(stop - start)
    {
...
#else
    class const_iterator : public container_const_reference<indirect_array>,
                           public random_access_iterator_base<std::random_access_iterator_tag,
                                                              const_iterator, value_type>
    {
      public:
        ...
        // Construction and destruction
        BOOST_UBLAS_INLINE
        const_iterator() : container_const_reference<indirect_array>(), it_()
        {
        }
        BOOST_UBLAS_INLINE
        const_iterator(const indirect_array &ia, const const_subiterator_type &it) : container_const_reference<indirect_array>(ia), it_(it)
        {
        }
...
template <class V>
class index_pair : public container_reference<V>
{
  ...
  public:
    ...
    BOOST_UBLAS_INLINE
    index_pair(V &v, size_type i) : container_reference<V>(v), i_(i),
                                    v1_(v.data1_[i]), v2_(v.data2_[i]),
                                    dirty_(false), is_copy_(false)
    {
    }
    BOOST_UBLAS_INLINE
    index_pair(const self_type &rhs) : container_reference<V>(rhs()), i_(0),
...
class index_pair_array : private boost::noncopyable
{
  ...
  public:
    ...
    BOOST_UBLAS_INLINE
    index_pair_array(size_type size, V1 &data1, V2 &data2) : size_(size), data1_(data1), data2_(data2)
    {
    }
...
template <class M>
class index_triple : public container_reference<M>
{
  ...
  public:
    ...
    BOOST_UBLAS_INLINE
    index_triple(M &m, size_type i) : container_reference<M>(m), i_(i),
                                      v1_(m.data1_[i]), v2_(m.data2_[i]), v3_(m.data3_[i]),
                                      dirty_(false), is_copy_(false)
    {
    }
    BOOST_UBLAS_INLINE
    index_triple(const self_type &rhs) : container_reference<M>(rhs()), i_(0),
...
class index_triple_array : private boost::noncopyable
{
  ...
  public:
    ...
    BOOST_UBLAS_INLINE
    index_triple_array(size_type size, V1 &data1, V2 &data2, V3 &data3) : size_(size), data1_(data1), data2_(data2), data3_(data3)
    {
    }
