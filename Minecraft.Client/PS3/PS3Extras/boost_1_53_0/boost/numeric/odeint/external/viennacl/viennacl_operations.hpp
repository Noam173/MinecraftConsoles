...
struct viennacl_operations
{
    ...
    struct scale_sum3
    {
        ...
        void operator()(viennacl::vector<T1> &v1,
                        ...
                        const viennacl::vector<T4> &v4) const
        {
            using namespace viennacl;
            ...
            static generator::custom_operation op(
                sym_v1 = sym_a1 * sym_v2 + sym_a2 * sym_v3 + sym_a3 * sym_v4);
    ...
    struct scale_sum4
    {
                        ...
                        const viennacl::vector<T5> &v5) const
        {
            ...
            static generator::custom_operation op(
                sym_v1 = sym_a1 * sym_v2 + sym_a2 * sym_v3 + sym_a3 * sym_v4 + sym_a4 * sym_v5);
    ...
    struct scale_sum5
    {
        ...
        void operator()(viennacl::vector<T1> &v1,
                        ...
                        const viennacl::vector<T6> &v6) const
        {
            using namespace viennacl;
            ...
            static generator::custom_operation op(
                sym_v1 = sym_a1 * sym_v2 + sym_a2 * sym_v3 + sym_a3 * sym_v4 + sym_a4 * sym_v5 + sym_a5 * sym_v6);
