  ...
  public:
    ...
    typedef typename boost::fusion::result_of::as_vector<
        typename boost::mpl::copy<
            ...
            boost::mpl::inserter<
                boost::mpl::vector0<>,
                boost::mpl::push_back<boost::mpl::_1, array_wrapper<Value, boost::mpl::_2>>>>::type>::type coef_a_type;
...
#pragma warning(default : 4307 34)
                        ...
                        StateTemp &x_tmp, Deriv F[StageCount - 1]) const
    {
        ...
        boost::fusion::for_each(m_stages, calculate_stage<
                                              unwrapped_system_type, StateIn, StateTemp, DerivIn, Deriv, StateOut, Time>(algebra, sys, in, dxdt, out, x_tmp, F, t, dt));
    }
