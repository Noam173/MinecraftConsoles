...
#if defined(__osf__) && !defined(_REENTRANT) && (defined(_GLIBCXX_HAVE_GTHR_DEFAULT) || defined(_GLIBCPP_HAVE_GTHR_DEFAULT))
...
#if defined(_GLIBCXX_HAVE_GTHR_DEFAULT) || defined(_GLIBCXX__PTHREADS) || defined(_GLIBCXX_HAS_GTHREADS) || defined(_WIN32)
//
