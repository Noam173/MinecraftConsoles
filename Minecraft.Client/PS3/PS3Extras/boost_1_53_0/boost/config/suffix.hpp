...
//
#if defined(BOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION) && !defined(BOOST_NO_PARTIAL_SPECIALIZATION_IMPLICIT_DEFAULT_ARGS)
...
// thread API enabled:
//
#if defined(BOOST_DISABLE_WIN32) && defined(_WIN32) && !defined(BOOST_DISABLE_THREADS) && !defined(BOOST_HAS_PTHREADS)
...
//
#if (defined(__MT__) || defined(_MT) || defined(_REENTRANT) || defined(_PTHREADS) || defined(__APPLE__) || defined(__DragonFly__)) && !defined(BOOST_HAS_THREADS)
...
//
#if defined(BOOST_HAS_THREADS) && !defined(BOOST_HAS_PTHREADS) && !defined(BOOST_HAS_WINTHREADS) && !defined(BOOST_HAS_BETHREADS) && !defined(BOOST_HAS_MPTASKS)
#undef BOOST_HAS_THREADS
#endif
