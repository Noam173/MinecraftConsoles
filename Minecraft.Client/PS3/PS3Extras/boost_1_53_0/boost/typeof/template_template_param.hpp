...
#define BOOST_TYPEOF_TEMPLATE_PARAM_ENCODE(This, n)                      \
    typedef typename boost::type_of::encode_template<BOOST_PP_CAT(V, n), \
                                                     BOOST_PP_CAT(P, n) < BOOST_TYPEOF_SEQ_ENUM(BOOST_TYPEOF_MAKE_OBJS(BOOST_TYPEOF_TEMPLATE_PARAM_GETPARAMS(This)), BOOST_TYPEOF_PLACEHOLDER)> > ::type BOOST_PP_CAT(V, BOOST_PP_INC(n));
...
#define BOOST_TYPEOF_TEMPLATE_PARAM_EXPANDTYPE(This)                          \
    template <BOOST_PP_SEQ_ENUM(BOOST_TYPEOF_TEMPLATE_PARAM_GETPARAMS(This))> \
    class
...
#define BOOST_TYPEOF_REGISTER_TYPE_FOR_TEMPLATE_TEMPLATE(Name, Params, ID)                           \
    ...
    template <class Iter>                                                                            \
    struct decode_template_impl<boost::mpl::size_t<ID>, Iter>                                        \
    {                                                                                                \
