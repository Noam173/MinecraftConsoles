...
class BOOST_SERIALIZATION_DECL(BOOST_PP_EMPTY()) void_caster : private boost::noncopyable
{
  ...
  public:
    ...
    void_caster(
        ...
        void_caster const *const parent = 0) : m_derived(derived),
                                               m_base(base),
...
template <class Derived, class Base>
void_caster_primitive<Derived, Base>::void_caster_primitive() : void_caster(
...
template <class Derived, class Base>
class void_caster_virtual_base : public void_caster
{
    virtual bool has_virtual_base() const
    {
        return true;
...
template <class Derived, class Base>
void_caster_virtual_base<Derived, Base>::void_caster_virtual_base() : void_caster(
                                                                          &(type_info_implementation<Derived>::type::get_const_instance()),
                                                                          &(type_info_implementation<Base>::type::get_const_instance()))
{
...
template <class Derived, class Base>
struct void_caster_base : public void_caster
{
    typedef BOOST_DEDUCED_TYPENAME mpl::eval_if<boost::is_virtual_base_of<Base, Derived>,
                                                mpl::identity<
                                                    void_cast_detail::void_caster_virtual_base<Derived, Base>>, // else
                                                mpl::identity<
                                                    void_cast_detail::void_caster_primitive<Derived, Base>>>::type type;
};
...
)
{
    typedef BOOST_DEDUCED_TYPENAME mpl::eval_if<boost::is_virtual_base_of<Base, Derived>,
                                                mpl::identity<
                                                    void_cast_detail::void_caster_virtual_base<Derived, Base>>, // else
                                                mpl::identity<
                                                    void_cast_detail::void_caster_primitive<Derived, Base>>>::type typex;
    return singleton<typex>::get_const_instance();
}

template <class Derived, class Base>
class void_caster : public void_cast_detail::void_caster_base<Derived, Base>::type
{
};
