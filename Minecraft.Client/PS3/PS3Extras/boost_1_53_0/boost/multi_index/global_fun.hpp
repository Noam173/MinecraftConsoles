...
struct non_ref_global_fun_base
{
    ...
    Type operator()(
        const reference_wrapper<
            typename remove_const<Value>::type> &x,
        int = 0) const
    {
        return operator()(x.get());
    }
...
struct global_fun : mpl::if_c<
                        ...
                        typename mpl::if_c<
                            ...
                            detail::non_const_ref_global_fun_base<Value, Type, PtrToFunction>>::type,
                        detail::non_ref_global_fun_base<Value, Type, PtrToFunction>>::type
{
};
