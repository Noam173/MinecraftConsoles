...
class hashed_index : BOOST_MULTI_INDEX_PROTECTED_IF_MEMBER_TEMPLATE_FRIENDS SuperMeta::type
...
#pragma parse_mfunc_templ off
  ...
  public:
    ...
    typedef tuple<std::size_t,
                  key_from_value, hasher, key_equal>
        ctor_args;
  ...
  public:
    ...
    BOOST_MULTI_INDEX_PROTECTED_IF_MEMBER_TEMPLATE_FRIENDS : hashed_index(const ctor_args_list &args_list, const allocator_type &al) : super(args_list.get_tail(), al),
    ...
    hashed_index(
        const hashed_index<KeyFromValue, Hash, Pred, SuperMeta, TagList, Category> &x) : super(x),
    ...
    node_type *insert_(value_param_type v, node_type *x)
    {
        ...
        {
            return node_type::from_impl(pos);
        }
