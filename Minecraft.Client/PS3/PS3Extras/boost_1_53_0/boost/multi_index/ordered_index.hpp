...
#pragma parse_mfunc_templ off
  ...
  public:
    ...
    typedef value_comparison<
        value_type, KeyFromValue, Compare>
        value_compare;
  ...
  public:
    ...
    BOOST_MULTI_INDEX_PROTECTED_IF_MEMBER_TEMPLATE_FRIENDS : ordered_index(const ctor_args_list &args_list, const allocator_type &al) : super(args_list.get_tail(), al),
    ...
    ordered_index(
        const ordered_index<KeyFromValue, Compare, SuperMeta, TagList, Category> &x) : super(x),
