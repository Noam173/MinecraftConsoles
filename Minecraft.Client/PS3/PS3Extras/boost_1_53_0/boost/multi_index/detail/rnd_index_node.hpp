...
struct random_access_index_node_impl
{
    typedef typename prevent_eti<
        ...
        typename boost::detail::allocator::rebind_to<
            Allocator, random_access_index_node_impl>::type>::type::pointer pointer;
    typedef typename prevent_eti<
        Allocator,
        typename boost::detail::allocator::rebind_to<
            Allocator, random_access_index_node_impl>::type>::type::const_pointer const_pointer;
    typedef typename prevent_eti<
        Allocator,
        typename boost::detail::allocator::rebind_to<
            Allocator, pointer>::type>::type::pointer ptr_pointer;
...
struct random_access_index_node_trampoline : prevent_eti<
                                                 Super,
                                                         ...
                                                         char>::type>>::type
{
    typedef typename prevent_eti<
        ...
        random_access_index_node_impl<
            typename boost::detail::allocator::rebind_to<
                typename Super::allocator_type,
                char>::type>>::type impl_type;
};

template <typename Super>
struct random_access_index_node : Super, random_access_index_node_trampoline<Super>
{
  private:
