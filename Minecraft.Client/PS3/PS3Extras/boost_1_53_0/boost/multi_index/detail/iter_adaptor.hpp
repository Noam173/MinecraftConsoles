...
class forward_iter_adaptor_base : public forward_iterator_helper<
                                      Derived,
...
template <class Derived, class Base>
class bidirectional_iter_adaptor_base : public bidirectional_iterator_helper<
                                            Derived,
                                            typename Base::value_type,
                                            typename Base::difference_type,
                                            typename Base::pointer,
...
template <class Derived, class Base>
class random_access_iter_adaptor_base : public random_access_iterator_helper<
                                            Derived,
                                            typename Base::value_type,
                                            typename Base::difference_type,
                                            typename Base::pointer,
...
struct iter_adaptor_base
{
    ...
    typedef typename prevent_eti<
        selector,
        typename mpl::apply2<
            selector, Derived, Base>::type>::type type;
};
