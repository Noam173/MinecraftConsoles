...
struct node_base
{
  private:
    typedef typename boost::intrusive::
        pointer_traits<VoidPtr>
            void_ptr_traits;
    typedef typename void_ptr_traits::
        template rebind_pointer<node_base>::type node_base_ptr;
    typedef typename void_ptr_traits::
        template rebind_pointer<node_base_ptr>::type node_base_ptr_ptr;
...
class iterator
    : public std::iterator<std::random_access_iterator_tag, T, typename boost::intrusive::pointer_traits<Pointer>::difference_type, Pointer, Reference>
{
    typedef boost::intrusive::
        pointer_traits<Pointer>
            ptr_traits;
    typedef typename ptr_traits::template rebind_pointer<void>::type void_ptr;
    typedef node<void_ptr, T> node_type;
    typedef node_base<void_ptr> node_base_type;
    typedef typename ptr_traits::template rebind_pointer<node_type>::type node_ptr;
    typedef boost::intrusive::
        pointer_traits<node_ptr>
            node_ptr_traits;
    typedef typename ptr_traits::template rebind_pointer<node_base_type>::type node_base_ptr;
    typedef typename ptr_traits::template rebind_pointer<node_base_ptr>::type node_base_ptr_ptr;
    typedef typename ptr_traits::template rebind_pointer<T>::type friend_iterator_pointer;
...
struct index_traits
{
    ...
    typedef stable_vector_detail::
        node_base<VoidPtr>
            node_base_type;
    typedef typename void_ptr_traits::template rebind_pointer<node_base_type>::type node_base_ptr;
    typedef typename void_ptr_traits::template rebind_pointer<node_base_ptr>::type node_base_ptr_ptr;
    typedef boost::intrusive::
        pointer_traits<node_base_ptr>
            node_base_ptr_traits;
    typedef boost::intrusive::
        pointer_traits<node_base_ptr_ptr>
            node_base_ptr_ptr_traits;
    typedef typename allocator_traits<VoidAllocator>::
        template portable_rebind_alloc<node_base_ptr>::type node_base_ptr_allocator;
    ...
    {
        for (index_iterator it = index.begin(), it_end = index_traits::get_fix_up_end(index); it != it_end; ++it)
        {
...
class stable_vector
{
    ...
    typedef typename boost::intrusive::pointer_traits<typename allocator_traits_type::pointer>::
        template rebind_pointer<void>::type void_ptr;
    typedef typename allocator_traits_type::
        template portable_rebind_alloc<void>::type void_allocator_type;
    typedef stable_vector_detail::index_traits<void_ptr, void_allocator_type> index_traits_type;
    ...
    typedef boost::intrusive::
        pointer_traits<typename allocator_traits_type::pointer>
            ptr_traits;
    ...
    typedef boost::intrusive::
        pointer_traits<node_ptr>
            node_ptr_traits;
    typedef typename ptr_traits::template rebind_pointer<const node_type>::type const_node_ptr;
    typedef boost::intrusive::
        pointer_traits<const_node_ptr>
            const_node_ptr_traits;
    ...
    typedef ::boost::container::container_detail::
        integral_constant<unsigned, 2>
            allocator_v2;
    typedef ::boost::container::container_detail::integral_constant<unsigned, boost::container::container_detail::
                                                                                  version<Allocator>::value>
        alloc_version;
    typedef typename allocator_traits_type::
        template portable_rebind_alloc<node_type>::type node_allocator_type;

    typedef ::boost::container::container_detail::
        allocator_version_traits<node_allocator_type>
            allocator_version_traits_t;
    ...
    typedef stable_vector_detail::iterator<T, typename allocator_traits<Allocator>::reference, typename allocator_traits<Allocator>::pointer> iterator_impl;
    typedef stable_vector_detail::iterator<T, typename allocator_traits<Allocator>::const_reference, typename allocator_traits<Allocator>::const_pointer> const_iterator_impl;
    ///@endcond
  public:
    //////////////////////////////////////////////
    //
...
#if !defined(BOOST_CONTAINER_DOXYGEN_INVOKED)
                ,
                typename container_detail::enable_if_c<!container_detail::is_convertible<InputIterator, size_type>::value>::type * = 0
#endif
    )
    {
        STABLE_VECTOR_CHECK_INVARIANT;
...
#include BOOST_PP_LOCAL_ITERATE()
...
#if !defined(BOOST_CONTAINER_DOXYGEN_INVOKED)
                    ,
                    typename container_detail::enable_if_c<!container_detail::is_convertible<InputIterator, size_type>::value && container_detail::is_input_iterator<InputIterator>::value>::type * = 0
#endif
    )
    {
        STABLE_VECTOR_CHECK_INVARIANT;
    ...
    iterator insert(const_iterator position, FwdIt first, FwdIt last, typename container_detail::enable_if_c<!container_detail::is_convertible<FwdIt, size_type>::value && !container_detail::is_input_iterator<FwdIt>::value>::type * = 0)
    {
  ...
  private:
    ...
    void priv_clear_pool()
    {
        if (!this->index.empty() && this->index.back())
        {
            ...
            multiallocation_chain holder;
            holder.incorporate_after(holder.before_begin(), node_ptr_traits::static_cast_from(pool_first_ref), node_ptr_traits::static_cast_from(pool_last_ref), internal_data.pool_size);
    ...
    void priv_put_in_pool(multiallocation_chain &ch)
    {
        ...
        node_base_ptr &pool_last_ref = this->index.back();
        ch.incorporate_after(ch.before_begin(), node_ptr_traits::static_cast_from(pool_first_ref), node_ptr_traits::static_cast_from(pool_last_ref), internal_data.pool_size);
    ...
    {
        return node_ptr_traits::pointer_to(static_cast<node_type &>(const_cast<node_base_type &>(this->internal_data.end_node)));
    }
    ...
    {
        // This can throw
        boost::container::allocator_traits<node_allocator_type>::construct(this->priv_node_alloc(), container_detail::addressof(p->value), ::boost::forward<ValueConvertible>(value_convertible));
        // This does not throw
        ...
        : public node_allocator_type
    {
      ...
      public:
        ...
        explicit ebo_holder(BOOST_FWD_REF(AllocatorRLValue) a)
            : node_allocator_type(boost::forward<AllocatorRLValue>(a)), pool_size(0), end_node()
        {
        }

        ebo_holder()
            : node_allocator_type(), pool_size(0), end_node()
        {
        }
    ...
    const node_allocator_type &priv_node_alloc() const
    {
        return internal_data;
    }
