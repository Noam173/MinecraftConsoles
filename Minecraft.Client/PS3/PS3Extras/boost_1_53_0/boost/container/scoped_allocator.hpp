...
struct uses_allocator_imp
{
  ...
  public:
    enum
    {
        value = sizeof(test<T>(0, alloc)) == sizeof(char)
    };
};
...
template <class T
              BOOST_PP_ENUM_TRAILING(BOOST_PP_ADD(BOOST_CONTAINER_MAX_IS_CONSTRUCTIBLE_PARAMETERS, 1), BOOST_CONTAINER_PP_TEMPLATE_PARAM_WITH_DEFAULT, void)>
struct is_constructible_impl;
...
#define BOOST_PP_LOCAL_MACRO(n)                                                                                                                                   \
    ...
    struct is_constructible_impl<T BOOST_PP_ENUM_TRAILING_PARAMS(n, P)                                                                                            \
                                     BOOST_PP_ENUM_TRAILING(BOOST_PP_SUB(BOOST_CONTAINER_MAX_IS_CONSTRUCTIBLE_PARAMETERS, n), BOOST_CONTAINER_PP_IDENTITY, void), \
                                 void>                                                                                                                            \
    {                                                                                                                                                             \
        typedef char yes_type;                                                                                                                                    \
        struct no_type                                                                                                                                            \
...
template <class T
              BOOST_PP_ENUM_TRAILING(BOOST_CONTAINER_MAX_IS_CONSTRUCTIBLE_PARAMETERS, BOOST_CONTAINER_PP_TEMPLATE_PARAM_WITH_DEFAULT, void)>
struct is_constructible
    : boost::integral_constant<bool, is_constructible_impl<T
...
// Finally just inherit from the implementation to define he trait
template <class T, class InnerAlloc
                       BOOST_PP_ENUM_TRAILING(BOOST_PP_SUB(BOOST_CONTAINER_MAX_IS_CONSTRUCTIBLE_PARAMETERS, 2), BOOST_CONTAINER_PP_TEMPLATE_PARAM_WITH_DEFAULT, void)>
struct is_constructible_with_allocator_prefix
    : is_constructible<T, allocator_arg_t, InnerAlloc BOOST_PP_ENUM_TRAILING_PARAMS(BOOST_PP_SUB(BOOST_CONTAINER_MAX_IS_CONSTRUCTIBLE_PARAMETERS, 2), P)>
{
};
/*
   template <class T
...
template <class T, class InnerAlloc
                       BOOST_PP_ENUM_TRAILING(BOOST_CONTAINER_MAX_CONSTRUCTOR_PARAMETERS, BOOST_CONTAINER_PP_TEMPLATE_PARAM_WITH_DEFAULT, void)>
struct is_constructible_with_allocator_prefix
    : constructible_with_allocator_prefix<T>
{
};
...
inline void dispatch_allocator_prefix_suffix(boost::true_type use_alloc_prefix, OutermostAlloc &outermost_alloc, InnerAlloc &inner_alloc, T *p, BOOST_FWD_REF(Args)... args)
{
    (void)use_alloc_prefix;
    allocator_traits<OutermostAlloc>::construct(outermost_alloc, p, allocator_arg, inner_alloc, ::boost::forward<Args>(args)...);
}

template <typename OutermostAlloc, typename InnerAlloc, typename T, class... Args>
inline void dispatch_allocator_prefix_suffix(boost::false_type use_alloc_prefix, OutermostAlloc &outermost_alloc, InnerAlloc &inner_alloc, T *p, BOOST_FWD_REF(Args)... args)
{
    (void)use_alloc_prefix;
    allocator_traits<OutermostAlloc>::construct(outermost_alloc, p, ::boost::forward<Args>(args)..., inner_alloc);
}

template <typename OutermostAlloc, typename InnerAlloc, typename T, class... Args>
inline void dispatch_uses_allocator(boost::true_type uses_allocator, OutermostAlloc &outermost_alloc, InnerAlloc &inner_alloc, T *p, BOOST_FWD_REF(Args)... args)
{
    (void)uses_allocator;
    ...
    dispatch_allocator_prefix_suffix(is_constructible_with_allocator_prefix<T, InnerAlloc, Args...>(), outermost_alloc, inner_alloc, p, ::boost::forward<Args>(args)...);
}

template <typename OutermostAlloc, typename InnerAlloc, typename T, class... Args>
inline void dispatch_uses_allocator(boost::false_type uses_allocator, OutermostAlloc &outermost_alloc, InnerAlloc &inner_alloc, T *p, BOOST_FWD_REF(Args)... args)
{
    (void)uses_allocator;
    (void)inner_alloc;
    allocator_traits<OutermostAlloc>::construct(outermost_alloc, p, ::boost::forward<Args>(args)...);
}

#else // #if !defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES)

#define BOOST_PP_LOCAL_MACRO(n)                                                                                                                                                                                                        \
    template <typename OutermostAlloc, typename InnerAlloc, typename T BOOST_PP_ENUM_TRAILING_PARAMS(n, class P)>                                                                                                                      \
    ...
    {                                                                                                                                                                                                                                  \
        (void)use_alloc_prefix,                                                                                                                                                                                                        \
            allocator_traits<OutermostAlloc>::construct(outermost_alloc, p, allocator_arg, inner_alloc BOOST_PP_ENUM_TRAILING(n, BOOST_CONTAINER_PP_PARAM_FORWARD, _));                                                                \
    }                                                                                                                                                                                                                                  \
                                                                                                                                                                                                                                       \
    template <typename OutermostAlloc, typename InnerAlloc, typename T BOOST_PP_ENUM_TRAILING_PARAMS(n, class P)>                                                                                                                      \
    inline void dispatch_allocator_prefix_suffix(                                                                                                                                                                                      \
    ...
    {                                                                                                                                                                                                                                  \
        (void)use_alloc_prefix;                                                                                                                                                                                                        \
        allocator_traits<OutermostAlloc>::construct(outermost_alloc, p BOOST_PP_ENUM_TRAILING(n, BOOST_CONTAINER_PP_PARAM_FORWARD, _), inner_alloc);                                                                                   \
    }                                                                                                                                                                                                                                  \
                                                                                                                                                                                                                                       \
    template <typename OutermostAlloc, typename InnerAlloc, typename T BOOST_PP_ENUM_TRAILING_PARAMS(n, class P)>                                                                                                                      \
    ...
    {                                                                                                                                                                                                                                  \
        (void)uses_allocator;                                                                                                                                                                                                          \
        dispatch_allocator_prefix_suffix(is_constructible_with_allocator_prefix<T, InnerAlloc BOOST_PP_ENUM_TRAILING_PARAMS(n, P)>(), outermost_alloc, inner_alloc, p BOOST_PP_ENUM_TRAILING(n, BOOST_CONTAINER_PP_PARAM_FORWARD, _)); \
    }                                                                                                                                                                                                                                  \
                                                                                                                                                                                                                                       \
    template <typename OutermostAlloc, typename InnerAlloc, typename T BOOST_PP_ENUM_TRAILING_PARAMS(n, class P)>                                                                                                                      \
    inline void dispatch_uses_allocator(boost::false_type uses_allocator, OutermostAlloc &outermost_alloc, InnerAlloc &inner_alloc, T *p BOOST_PP_ENUM_TRAILING(n, BOOST_CONTAINER_PP_PARAM_LIST, _))                                  \
    {                                                                                                                                                                                                                                  \
        (void)uses_allocator;                                                                                                                                                                                                          \
        (void)inner_alloc;                                                                                                                                                                                                             \
        allocator_traits<OutermostAlloc>::construct(outermost_alloc, p BOOST_PP_ENUM_TRAILING(n, BOOST_CONTAINER_PP_PARAM_FORWARD, _));                                                                                                \
    }                                                                                                                                                                                                                                  \
//!
    ...
    : public OuterAlloc
{
  ...
  public:
    ...
    scoped_allocator_adaptor_base(BOOST_FWD_REF(OuterA2) outerAlloc, const InnerAllocs &...args)
        : outer_allocator_type(::boost::forward<OuterA2>(outerAlloc)), m_inner(args...)
    {
    }
    ...
    scoped_allocator_adaptor_base(BOOST_RV_REF(scoped_allocator_adaptor_base) other)
        : outer_allocator_type(::boost::move(other.outer_allocator())), m_inner(::boost::move(other.inner_allocator()))
    {
    }
  ...
  protected:
    ...
    scoped_allocator_adaptor_base(internal_type_t, BOOST_FWD_REF(OuterA2) outerAlloc, const inner_allocator_type &inner)
        : outer_allocator_type(::boost::forward<OuterA2>(outerAlloc)), m_inner(inner)
    {
    }
...
template <
    typename OuterAlloc, bool Dummy
...
#define BOOST_PP_LOCAL_MACRO(n)                                                                                                                                                                                          \
    ...
    class scoped_allocator_adaptor_base<OuterAlloc, true BOOST_PP_ENUM_TRAILING_PARAMS(n, Q)                                                                                                                             \
                                                        BOOST_PP_ENUM_TRAILING(BOOST_PP_SUB(BOOST_CONTAINER_MAX_CONSTRUCTOR_PARAMETERS, n), BOOST_CONTAINER_PP_IDENTITY, nat)>                                           \
        : public OuterAlloc                                                                                                                                                                                              \
    {                                                                                                                                                                                                                    \
        typedef allocator_traits<OuterAlloc> outer_traits_type;                                                                                                                                                          \
        BOOST_COPYABLE_AND_MOVABLE(scoped_allocator_adaptor_base)                                                                                                                                                        \
      ...
      public:                                                                                                                                                                                                            \
        ...
        scoped_allocator_adaptor_base(BOOST_FWD_REF(OuterA2) outerAlloc                                                                                                                                                  \
            ...
            : outer_allocator_type(::boost::forward<OuterA2>(outerAlloc)), m_inner(BOOST_PP_ENUM_PARAMS(n, q))                                                                                                           \
        {                                                                                                                                                                                                                \
        }                                                                                                                                                                                                                \
                                                                                                                                                                                                                         \
        scoped_allocator_adaptor_base(const scoped_allocator_adaptor_base &other)                                                                                                                                        \
        ...
        {                                                                                                                                                                                                                \
                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                         \
        template <class OuterA2>                                                                                                                                                                                         \
        scoped_allocator_adaptor_base(const scoped_allocator_adaptor_base<OuterA2, true BOOST_PP_ENUM_TRAILING_PARAMS(n, Q)                                                                                              \
                                                                                       BOOST_PP_ENUM_TRAILING(BOOST_PP_SUB(BOOST_CONTAINER_MAX_CONSTRUCTOR_PARAMETERS, n), BOOST_CONTAINER_PP_IDENTITY, nat)> &other)    \
            : outer_allocator_type(other.outer_allocator()), m_inner(other.inner_allocator())                                                                                                                            \
        {                                                                                                                                                                                                                \
        }                                                                                                                                                                                                                \
                                                                                                                                                                                                                         \
        template <class OuterA2>                                                                                                                                                                                         \
        scoped_allocator_adaptor_base(BOOST_RV_REF_BEG scoped_allocator_adaptor_base<OuterA2, true BOOST_PP_ENUM_TRAILING_PARAMS(n, Q)                                                                                   \
                                                                                                  BOOST_PP_ENUM_TRAILING(BOOST_PP_SUB(BOOST_CONTAINER_MAX_CONSTRUCTOR_PARAMETERS, n), BOOST_CONTAINER_PP_IDENTITY, nat)> \
...
#if defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES)
                                    ,
                                    true BOOST_PP_ENUM_TRAILING(BOOST_CONTAINER_MAX_CONSTRUCTOR_PARAMETERS, BOOST_CONTAINER_PP_IDENTITY, nat)
#endif
                                    >
    : public OuterAlloc
{
  ...
  public:
    ...
    struct rebind_base
    {
        typedef scoped_allocator_adaptor_base<typename allocator_traits<OuterAlloc>::template portable_rebind_alloc<U>::type
#if defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES)
                                              ,
                                              true BOOST_PP_ENUM_TRAILING(BOOST_CONTAINER_MAX_CONSTRUCTOR_PARAMETERS, BOOST_CONTAINER_PP_IDENTITY, container_detail::nat)
#endif
                                              >
            other;
    };
    ...
    template <class OuterA2>
    scoped_allocator_adaptor_base(BOOST_RV_REF_BEG scoped_allocator_adaptor_base<
                                  OuterA2
#if defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES)
                                  ,
                                  true BOOST_PP_ENUM_TRAILING(BOOST_CONTAINER_MAX_CONSTRUCTOR_PARAMETERS, BOOST_CONTAINER_PP_IDENTITY, container_detail::nat)
...
class scoped_allocator_adaptor
#endif
    : public container_detail::scoped_allocator_adaptor_base<OuterAlloc
#if !defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES) || defined(BOOST_CONTAINER_DOXYGEN_INVOKED)
                                                             ,
                                                             InnerAllocs...
#else
                                                             ...
                                                             >
{
  ...
  public:
    /// @cond
    typedef container_detail::scoped_allocator_adaptor_base<OuterAlloc
#if !defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES) || defined(BOOST_CONTAINER_DOXYGEN_INVOKED)
                                                            ,
                                                            InnerAllocs...
#else
    ...
    struct rebind
    {
        typedef scoped_allocator_adaptor<typename outer_traits_type::template portable_rebind_alloc<U>::type
#if !defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES) || defined(BOOST_CONTAINER_DOXYGEN_INVOKED)
                                         ,
                                         InnerAllocs...
#else
...
#include BOOST_PP_LOCAL_ITERATE()
    ...
    void destroy(T *p)
    {
        allocator_traits<typename outermost_allocator<OuterAlloc>::type>::destroy(get_outermost_allocator(this->outer_allocator()), p);
    }
    ...
    {
        return scoped_allocator_adaptor(internal_type_t(), outer_traits_type::select_on_container_copy_construction(this->outer_allocator()), outer_traits_type::select_on_container_copy_construction(this->inner_allocator()));
    }
    /// @cond
    base_type &base()
    {
    ...
    {
        container_detail::dispatch_uses_allocator(uses_allocator<T, inner_allocator_type>(), get_outermost_allocator(this->outer_allocator()), this->inner_allocator(), p, ::boost::forward<Args>(args)...);
    }
...
#define BOOST_PP_LOCAL_MACRO(n)                                                                                                                                                                                                            \
    ...
    {                                                                                                                                                                                                                                      \
        container_detail::dispatch_uses_allocator(uses_allocator<T, inner_allocator_type>(), get_outermost_allocator(this->outer_allocator()), this->inner_allocator(), p BOOST_PP_ENUM_TRAILING(n, BOOST_CONTAINER_PP_PARAM_FORWARD, _)); \
    }                                                                                                                                                                                                                                      \
//!
#define BOOST_PP_LOCAL_LIMITS (0, BOOST_CONTAINER_MAX_CONSTRUCTOR_PARAMETERS)
#include BOOST_PP_LOCAL_ITERATE()
                                   ...
                                   > &b)
{
    ...
    const bool has_zero_inner =
        boost::container::container_detail::is_same<Q0, container_detail::nat>::value;
#endif

    return a.outer_allocator() == b.outer_allocator() && (has_zero_inner || a.inner_allocator() == b.inner_allocator());
}
