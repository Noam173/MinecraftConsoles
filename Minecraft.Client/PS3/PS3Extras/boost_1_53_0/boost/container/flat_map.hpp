...
class flat_map
{
  ...
  private:
    ...
    typedef container_detail::flat_tree<Key,
                                        ...
                                        Compare,
                                        typename allocator_traits<Allocator>::template portable_rebind_alloc<container_detail::pair<Key, T>>::type>
        impl_tree_t;
    ...
    typedef container_detail::flat_tree_value_compare<Compare, container_detail::select1st<std::pair<Key, T>>, std::pair<Key, T>> value_compare_impl;
    typedef typename container_detail::get_flat_tree_iterators<typename allocator_traits<Allocator>::pointer>::iterator iterator_impl;
    typedef typename container_detail::get_flat_tree_iterators<typename allocator_traits<Allocator>::pointer>::const_iterator const_iterator_impl;
    typedef typename container_detail::get_flat_tree_iterators<typename allocator_traits<Allocator>::pointer>::reverse_iterator reverse_iterator_impl;
    typedef typename container_detail::get_flat_tree_iterators<typename allocator_traits<Allocator>::pointer>::const_reverse_iterator const_reverse_iterator_impl;
    /// @endcond
  ...
  public:
    ...
    template <class InputIterator>
    flat_map(ordered_unique_range_t, InputIterator first, InputIterator last, const Compare &comp = Compare(), const allocator_type &a = allocator_type())
    ...
    {
        return container_detail::force_copy<iterator>(m_flat_tree.emplace_hint_unique(container_detail::force_copy<impl_const_iterator>(hint), boost::forward<Args>(args)...));
    }
...
#define BOOST_PP_LOCAL_MACRO(n)                                                                                                                             \
    ...
    {                                                                                                                                                       \
        return container_detail::force_copy<std::pair<iterator, bool>>(m_flat_tree.emplace_unique(BOOST_PP_ENUM(n, BOOST_CONTAINER_PP_PARAM_FORWARD, _)));  \
    }                                                                                                                                                       \
                                                                                                                                                            \
    BOOST_PP_EXPR_IF(n, template <)                                                                                                                         \
                        BOOST_PP_ENUM_PARAMS(n, class P) BOOST_PP_EXPR_IF(n, >)                                                                             \
    ...
    {                                                                                                                                                       \
        return container_detail::force_copy<iterator>(m_flat_tree.emplace_hint_unique(container_detail::force_copy<impl_const_iterator>(hint)               \
...
#include BOOST_PP_LOCAL_ITERATE()
    ...
    {
        return container_detail::force_copy<std::pair<iterator, bool>>(m_flat_tree.insert_unique(boost::move(x)));
    }
    ...
    iterator insert(const_iterator position, const value_type &x)
    {
        return container_detail::force_copy<iterator>(
            m_flat_tree.insert_unique(container_detail::force_copy<impl_const_iterator>(position), container_detail::force<impl_value_type>(x)));
    }
    ...
    {
        return container_detail::force_copy<iterator>(m_flat_tree.insert_unique(container_detail::force_copy<impl_const_iterator>(position), boost::move(container_detail::force<impl_value_type>(x))));
    }
    ...
    {
        return container_detail::force_copy<iterator>(m_flat_tree.erase(container_detail::force_copy<impl_const_iterator>(position)));
    }
    ...
    {
        return container_detail::force_copy<iterator>(
            m_flat_tree.erase(container_detail::force_copy<impl_const_iterator>(first), container_detail::force_copy<impl_const_iterator>(last)));
    }
...
class flat_multimap
{
  ...
  public:
    ...
    iterator emplace_hint(const_iterator hint, Args &&...args)
    {
        return container_detail::force_copy<iterator>(m_flat_tree.emplace_hint_equal(container_detail::force_copy<impl_const_iterator>(hint), boost::forward<Args>(args)...));
    }
...
#define BOOST_PP_LOCAL_MACRO(n)                                                                                                                            \
    BOOST_PP_EXPR_IF(n, template <)                                                                                                                        \
                        BOOST_PP_ENUM_PARAMS(n, class P) BOOST_PP_EXPR_IF(n, >)                                                                            \
                            ...
                            emplace(BOOST_PP_ENUM(n, BOOST_CONTAINER_PP_PARAM_LIST, _))                                                                    \
    {                                                                                                                                                      \
        return container_detail::force_copy<iterator>(m_flat_tree.emplace_equal(BOOST_PP_ENUM(n, BOOST_CONTAINER_PP_PARAM_FORWARD, _)));                   \
    }                                                                                                                                                      \
                                                                                                                                                           \
    BOOST_PP_EXPR_IF(n, template <)                                                                                                                        \
                        BOOST_PP_ENUM_PARAMS(n, class P) BOOST_PP_EXPR_IF(n, >)                                                                            \
                            ...
                            emplace_hint(const_iterator hint                                                                                               \
                                             BOOST_PP_ENUM_TRAILING(n, BOOST_CONTAINER_PP_PARAM_LIST, _))                                                  \
    {                                                                                                                                                      \
        return container_detail::force_copy<iterator>(m_flat_tree.emplace_hint_equal(container_detail::force_copy<impl_const_iterator>(hint)               \
                                                                                         BOOST_PP_ENUM_TRAILING(n, BOOST_CONTAINER_PP_PARAM_FORWARD, _))); \
    }                                                                                                                                                      \
//!
#define BOOST_PP_LOCAL_LIMITS (0, BOOST_CONTAINER_MAX_CONSTRUCTOR_PARAMETERS)
#include BOOST_PP_LOCAL_ITERATE()
    ...
    iterator insert(const_iterator position, const value_type &x)
    {
        return container_detail::force_copy<iterator>(m_flat_tree.insert_equal(container_detail::force_copy<impl_const_iterator>(position), container_detail::force<impl_value_type>(x)));
    }
    ...
    iterator insert(const_iterator position, BOOST_RV_REF(value_type) x)
    {
        return container_detail::force_copy<iterator>(m_flat_tree.insert_equal(container_detail::force_copy<impl_const_iterator>(position), boost::move(x)));
    }
    ...
    iterator erase(const_iterator first, const_iterator last)
    {
        return container_detail::force_copy<iterator>(m_flat_tree.erase(container_detail::force_copy<impl_const_iterator>(first), container_detail::force_copy<impl_const_iterator>(last)));
    }
