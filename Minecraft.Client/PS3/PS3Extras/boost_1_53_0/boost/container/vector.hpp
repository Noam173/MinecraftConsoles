...
class vector_const_iterator
{
  public:
    ...
    typedef typename boost::intrusive::pointer_traits<Pointer>::template rebind_pointer<const value_type>::type pointer;
  ...
  public:
    ...
    vector_const_iterator operator++(int)
    {
        Pointer tmp = m_ptr;
        ++*this;
        return vector_const_iterator(tmp);
    }
...
struct vector_value_traits
{
    ...
    typedef typename container_detail::if_c<trivial_dctr, container_detail::null_scoped_destructor_n<Allocator>, container_detail::scoped_destructor_n<Allocator>>::type OldArrayDestructor;
    // This is the anti-exception array destructor
    // to destroy objects created with copy construction
    typedef typename container_detail::if_c<nothrow_copy, container_detail::null_scoped_destructor_n<Allocator>, container_detail::scoped_destructor_n<Allocator>>::type ArrayDestructor;
    // This is the anti-exception array deallocator
    typedef typename container_detail::if_c<nothrow_copy, container_detail::null_scoped_array_deallocator<Allocator>, container_detail::scoped_array_deallocator<Allocator>>::type ArrayDeallocator;
};
...
struct vector_alloc_holder
{
    ...
    {
        return allocator_version_traits<Allocator>::allocation_command(this->alloc(), command, limit_size, preferred_size, received_size, reuse);
    }
...
class vector : private container_detail::vector_alloc_holder<Allocator>
{
  ...
  public:
    ...
    {
        this->assign(container_detail::to_raw_pointer(x.members_.m_start), container_detail::to_raw_pointer(x.members_.m_start + x.members_.m_size));
    }
        ...
        : base_t(a)
    {
        ...
        {
            this->assign(container_detail::to_raw_pointer(mx.members_.m_start), container_detail::to_raw_pointer(mx.members_.m_start) + mx.members_.m_size);
        }
    }
        ...
        BOOST_CONTAINER_NOEXCEPT
    {
        if (&x != this)
        {
            ...
            {
                this->assign(boost::make_move_iterator(container_detail::to_raw_pointer(x.members_.m_start)), boost::make_move_iterator(container_detail::to_raw_pointer(x.members_.m_start + x.members_.m_size)));
            }
        }
        return *this;
    }
    ...
    void assign(InIt first, InIt last
                ...
                ,
                typename container_detail::enable_if_c<!container_detail::is_convertible<InIt, size_type>::value
    ...
    void reserve(size_type new_cap)
    {
        if (this->capacity() < new_cap)
        {
            ...
            std::pair<pointer, bool> ret =
                this->allocation_command(allocate_new | expand_fwd | expand_bwd,
            ...
            else
            {
                ...
                if (alloc_version::value > 1 && ret.second)
                {
                    ...
                    ++this->num_expand_bwd;
#endif
                    this->priv_range_insert_expand_backwards(container_detail::to_raw_pointer(ret.first), real_cap, container_detail::to_raw_pointer(this->members_.m_start), 0, proxy);
                }
                // New buffer
                else
                {
                    ...
                    ++this->num_alloc;
#endif
                    this->priv_range_insert_new_allocation(container_detail::to_raw_pointer(ret.first), real_cap, container_detail::to_raw_pointer(this->members_.m_start), 0, proxy);
                }
            }
        }
    }
    ...
    void emplace_back(Args &&...args)
    {
        ...
        else
        {
            ...
            this->priv_forward_range_insert(back_pos, 1, type(this->alloc(), ::boost::forward<Args>(args)...));
        }
    }
    ...
    iterator emplace(const_iterator position, Args &&...args)
    {
        ...
        typedef container_detail::insert_emplace_proxy<Allocator, T *, Args...> type;
        return this->priv_forward_range_insert(position.get_ptr(), 1, type(this->alloc(), ::boost::forward<Args>(args)...));
    }
...
#define BOOST_PP_LOCAL_MACRO(n)                                                                                                                                                                                  \
    BOOST_PP_EXPR_IF(n, template <)                                                                                                                                                                              \
                        BOOST_PP_ENUM_PARAMS(n, class P) BOOST_PP_EXPR_IF(n, >) void emplace_back(BOOST_PP_ENUM(n, BOOST_CONTAINER_PP_PARAM_LIST, _))                                                            \
    {                                                                                                                                                                                                            \
        T *back_pos = container_detail::to_raw_pointer(this->members_.m_start) + this->members_.m_size;                                                                                                          \
        if (this->members_.m_size < this->members_.m_capacity)                                                                                                                                                   \
        {                                                                                                                                                                                                        \
            allocator_traits_type::construct(this->alloc(), back_pos BOOST_PP_ENUM_TRAILING(n, BOOST_CONTAINER_PP_PARAM_FORWARD, _));                                                                            \
            ++this->members_.m_size;                                                                                                                                                                             \
        }                                                                                                                                                                                                        \
        else                                                                                                                                                                                                     \
        {                                                                                                                                                                                                        \
            container_detail::BOOST_PP_CAT(insert_emplace_proxy_arg, n)<Allocator, T * BOOST_PP_ENUM_TRAILING_PARAMS(n, P)> proxy(this->alloc() BOOST_PP_ENUM_TRAILING(n, BOOST_CONTAINER_PP_PARAM_FORWARD, _)); \
            this->priv_forward_range_insert(back_pos, 1, proxy);                                                                                                                                                 \
        }                                                                                                                                                                                                        \
    }                                                                                                                                                                                                            \
                                                                                                                                                                                                                 \
    BOOST_PP_EXPR_IF(n, template <)                                                                                                                                                                              \
                        BOOST_PP_ENUM_PARAMS(n, class P) BOOST_PP_EXPR_IF(n, >)                                                                                                                                  \
                            iterator                                                                                                                                                                             \
                            emplace(const_iterator pos                                                                                                                                                           \
                                        BOOST_PP_ENUM_TRAILING(n, BOOST_CONTAINER_PP_PARAM_LIST, _))                                                                                                             \
    {                                                                                                                                                                                                            \
        container_detail::BOOST_PP_CAT(insert_emplace_proxy_arg, n)<Allocator, T * BOOST_PP_ENUM_TRAILING_PARAMS(n, P)> proxy(this->alloc() BOOST_PP_ENUM_TRAILING(n, BOOST_CONTAINER_PP_PARAM_FORWARD, _));     \
        return this->priv_forward_range_insert(container_detail::to_raw_pointer(pos.get_ptr()), 1, proxy);                                                                                                       \
    }                                                                                                                                                                                                            \
//!
...
#include BOOST_PP_LOCAL_ITERATE()
    ...
    iterator erase(const_iterator first, const_iterator last)
    {
        if (first != last)
        {
            ...
            T *ptr = container_detail::to_raw_pointer(boost::move(container_detail::to_raw_pointer(last.get_ptr()), end_pos, container_detail::to_raw_pointer(first.get_ptr())));
  ...
  private:
    ...
    {
        return this->priv_forward_range_insert(p.get_ptr(), 1, container_detail::get_insert_value_proxy<T *>(this->alloc(), ::boost::forward<U>(x)));
    }
    ...
    void priv_push_back(BOOST_FWD_REF(U) x)
    {
        ...
        {
            // There is more memory, just construct a new object at the end
            allocator_traits_type::construct(this->alloc(), container_detail::to_raw_pointer(this->members_.m_start + this->members_.m_size), ::boost::forward<U>(x));
            ++this->members_.m_size;
        }
        else
        {
    ...
    void priv_shrink_to_fit(allocator_v1)
    {
        if (this->members_.m_capacity)
        {
            ...
            else
            {
                ...
                size_type real_cap = 0;
                std::pair<pointer, bool> ret =
                    this->allocation_command(allocate_new, this->size(), this->size(), real_cap, this->members_.m_start);
    ...
    void priv_shrink_to_fit(allocator_v2)
    {
        if (this->members_.m_capacity)
        {
            ...
            else
            {
                ...
                if (this->allocation_command(shrink_in_place | nothrow_allocation, this->capacity(), this->size(), received_size, this->members_.m_start).first)
                {
    ...
    iterator priv_forward_range_insert(const pointer &pos, const size_type n, const InsertionProxy insert_range_proxy)
    {
        ...
        if (alloc_version::value > 1)
        { // Version 2 allocator, compile time check
            ...
            if (!same_buffer_start)
            {
                ...
                // There is not enough memory, allocate a new
                // buffer or expand the old one.
                std::pair<pointer, bool> ret = (this->allocation_command(allocate_new | expand_fwd | expand_bwd,
                ...
                else
                {
                    ...
                    ++this->num_alloc;
#endif
                    this->priv_range_insert_new_allocation(container_detail::to_raw_pointer(ret.first), real_cap, raw_pos, n, insert_range_proxy);
                }
            }
            else
            {
        ...
        { // Version 1 allocator
            ...
            else
            {
                ...
                ++this->num_alloc;
#endif
                this->priv_range_insert_new_allocation(new_buf, new_cap, raw_pos, n, insert_range_proxy);
            }
        }
        return iterator(this->members_.m_start + n_pos);
    }
    ...
    // Absolutely experimental. This function might change, disappear or simply crash!
    template <class BiDirPosConstIt, class BiDirSkipConstIt, class BiDirValueIt>
    void priv_insert_ordered_at(size_type element_count, BiDirPosConstIt last_position_it, bool do_skip, BiDirSkipConstIt last_skip_it, BiDirValueIt last_value_it)
    {
        ...
        typename value_traits::ArrayDestructor past_hole_values_destroyer(begin_ptr + old_size_pos + element_count, this->alloc(), size_type(0u));
  ...
  private:
    ...
    void priv_range_insert_expand_forward(T *const pos, const size_type n, InsertionProxy insert_range_proxy)
    {
        ...
        else if (elems_after >= n)
        {
            ...
            ::boost::container::uninitialized_move_alloc(this->alloc(), old_finish - n, old_finish, old_finish);
            this->members_.m_size += n;
    ...
    template <class InsertionProxy>
    void priv_range_insert_new_allocation(T *const new_start, size_type new_cap, T *const pos, const size_type n, InsertionProxy insert_range_proxy)
    {
        ...
        if (old_buffer)
        {
            new_finish = ::boost::container::uninitialized_move_alloc(this->alloc(), container_detail::to_raw_pointer(this->members_.m_start), pos, old_finish = new_finish);
        ...
        if (old_buffer)
        {
            new_finish = ::boost::container::uninitialized_move_alloc(this->alloc(), pos, old_buffer + this->members_.m_size, new_finish);
    ...
    template <class InsertionProxy>
    void priv_range_insert_expand_backwards(T *const new_start, const size_type new_capacity,
                                            T *const pos, const size_type n, InsertionProxy insert_range_proxy)
    {
        ...
        if (s_before >= before_plus_new)
        {
            ...
            if (s_before >= new_size)
            {
                ...
                ::boost::container::uninitialized_move_alloc(this->alloc(), pos, old_finish, new_start + before_plus_new);
            ...
            else
            {
                ...
                ::boost::container::uninitialized_move_alloc_n(this->alloc(), pos, raw_gap, new_start + before_plus_new);
        ...
        else
        {
            ...
            if (s_before <= elemsbefore)
            {
                ...
                ::boost::container::uninitialized_move_alloc_n(this->alloc(), old_start, s_before, new_start);
            ...
            else
            {
                ...
                T *const new_pos = ::boost::container::uninitialized_move_alloc(this->alloc(), old_start, pos, new_start);
                this->members_.m_size = elemsbefore;
            ...
            if (do_after)
            {
                ...
                else
                {
                    ...
                    ::boost::container::uninitialized_move_alloc(this->alloc(), pos, old_finish, old_finish + mid_last_dist);
