...
{
    typedef ::boost::container::container_detail::integral_constant<unsigned, Version> alloc_version;
    ...
    {
        return a.allocation_command(command, limit_size, preferred_size, received_size, reuse);
    }
};
...
{
    typedef ::boost::container::container_detail::integral_constant<unsigned, 1> alloc_version;
    ...
    typedef container_detail::basic_multiallocation_chain<void_ptr> multialloc_cached_counted;
    typedef boost::container::container_detail::
        transform_multiallocation_chain<multialloc_cached_counted, value_type>
