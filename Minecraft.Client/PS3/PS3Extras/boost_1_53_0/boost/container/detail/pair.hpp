...
struct pair
{
  ...
  public:
    ...
    pair(BOOST_FWD_REF(U) u, BOOST_FWD_REF(V) v)
        : first(::boost::forward<U>(u)), second(::boost::forward<V>(v))
    {
    }
    ...
    */
    ...
    template <class D, class S>
    typename ::boost::container::container_detail::enable_if_c<!(::boost::container::container_detail::is_same<T1, D>::value &&
