...
class constant_iterator
    : public std::iterator<std::random_access_iterator_tag, T, Difference, const T *, const T &>
{
...
class repeat_iterator
    : public std::iterator<std::random_access_iterator_tag, T, Difference>
{
...
struct emplace_functor
{
    ...
    {
        allocator_traits<A>::construct(a, ptr, ::boost::forward<Args>(container_detail::get<IdxPack>(args_))...);
    }
...
#define BOOST_PP_LOCAL_MACRO(n)                                                                                     \
    ...
    {                                                                                                               \
        ...
        void operator()(A &a, T *ptr)                                                                               \
        {                                                                                                           \
            allocator_traits<A>::construct(a, ptr BOOST_PP_ENUM_TRAILING(n, BOOST_CONTAINER_PP_MEMBER_FORWARD, _)); \
        }                                                                                                           \
