...
struct list_hook
{
    typedef typename container_detail::bi::make_list_base_hook<container_detail::bi::void_pointer<VoidPointer>, container_detail::bi::link_mode<container_detail::bi::normal_link>>::type type;
};
...
struct intrusive_list_type
{
    ...
    typedef typename boost::intrusive::pointer_traits<typename allocator_traits_type::pointer>::template rebind_pointer<void>::type
        void_pointer;
    typedef typename container_detail::list_node<value_type, void_pointer> node_type;
    typedef typename container_detail::bi::make_list<node_type, container_detail::bi::base_hook<typename list_hook<void_pointer>::type>, container_detail::bi::constant_time_size<true>, container_detail::bi::size_type<typename allocator_traits_type::size_type>>::type container_type;
    typedef container_type type;
};

template <class T, class IIterator>
class list_const_iterator
    : public std::iterator<std::bidirectional_iterator_tag, T, typename iiterator_types<T, IIterator>::difference_type, typename iiterator_types<T, IIterator>::const_pointer, typename iiterator_types<T, IIterator>::const_reference>
{
  protected:
    IIterator m_it;
...
#endif
class list
    : protected container_detail::node_alloc_holder<Allocator, typename container_detail::intrusive_list_type<Allocator>::type>
{
    /// @cond
    typedef typename container_detail::intrusive_list_type<Allocator>::type Icont;
