...
struct allocator_traits
{
    ...
    template <class T>
    using rebind_alloc = see_documentation;
    ...
    typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_EVAL_DEFAULT(boost::container::container_detail::, Alloc,
                                                          const_pointer, typename boost::intrusive::pointer_traits<pointer>::template rebind_pointer<const value_type>)
        const_pointer;
    // reference
    typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_DEFAULT(boost::container::container_detail::, Alloc,
    ...
    // void_pointer
    typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_EVAL_DEFAULT(boost::container::container_detail::, Alloc,
                                                          void_pointer, typename boost::intrusive::pointer_traits<pointer>::template rebind_pointer<void>)
        void_pointer;
    // const_void_pointer
    typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_EVAL_DEFAULT(boost::container::container_detail::, Alloc,
                                                          const_void_pointer, typename boost::intrusive::pointer_traits<pointer>::template rebind_pointer<const void>)
        const_void_pointer;
    // difference_type
    typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_DEFAULT(boost::container::container_detail::, Alloc,
    ...
    // C++11
    template <typename T>
    using rebind_alloc = typename boost::intrusive::detail::type_rebinder<Alloc, T>::type;
    template <typename T>
    using rebind_traits = allocator_traits<rebind_alloc<T>>;
...
#include BOOST_PP_LOCAL_ITERATE()
    ...
    static pointer allocate(Alloc &a, size_type n, const_void_pointer p)
    {
        const bool value = boost::container::container_detail::
            has_member_function_callable_with_allocate<Alloc, const size_type, const const_void_pointer>::value;
    ...
    static void destroy(Alloc &a, T *p)
    {
        ...
        const bool value = boost::container::container_detail::
            has_member_function_callable_with_destroy<Alloc, const destroy_pointer>::value;
        ::boost::integral_constant<bool, value> flag;
    ...
    {
        const bool value = boost::container::container_detail::
            has_member_function_callable_with_max_size<const Alloc>::value;
        ::boost::integral_constant<bool, value> flag;
    ...
    {
        const bool value = boost::container::container_detail::
            has_member_function_callable_with_select_on_container_copy_construction<const Alloc>::value;
        ::boost::integral_constant<bool, value> flag;
...
///@cond
  ...
  private:
    ...
    {
        const bool value = boost::container::container_detail::
            has_member_function_callable_with_construct<Alloc, T *, Args...>::value;
        ::boost::integral_constant<bool, value> flag;
...
#define BOOST_PP_LOCAL_MACRO(n)                                                                                      \
    ...
    {                                                                                                                \
        ::boost::integral_constant<bool, container_detail::is_std_allocator<Alloc>::value> flag;                     \
        allocator_traits::priv_construct(flag, a, p BOOST_PP_ENUM_TRAILING(n, BOOST_CONTAINER_PP_PARAM_FORWARD, _)); \
    }                                                                                                                \
//
#define BOOST_PP_LOCAL_LIMITS (0, BOOST_CONTAINER_MAX_CONSTRUCTOR_PARAMETERS)
#include BOOST_PP_LOCAL_ITERATE()
...
#define BOOST_PP_LOCAL_MACRO(n)                                                                                                                                           \
    template <class T BOOST_PP_ENUM_TRAILING_PARAMS(n, class P)>                                                                                                          \
    static void priv_construct(boost::false_type, Alloc &a, T *p BOOST_PP_ENUM_TRAILING(n, BOOST_CONTAINER_PP_PARAM_LIST, _))                                             \
    {                                                                                                                                                                     \
        const bool value =                                                                                                                                                \
            boost::container::container_detail::has_member_function_callable_with_construct<Alloc, T * BOOST_PP_ENUM_TRAILING(n, BOOST_CONTAINER_PP_FWD_TYPE, _)>::value; \
        ::boost::integral_constant<bool, value> flag;                                                                                                                     \
        priv_construct_dispatch2(flag, a, p BOOST_PP_ENUM_TRAILING(n, BOOST_CONTAINER_PP_PARAM_FORWARD, _));                                                              \
    }                                                                                                                                                                     \
                                                                                                                                                                          \
    template <class T BOOST_PP_ENUM_TRAILING_PARAMS(n, class P)>                                                                                                          \
    static void priv_construct(boost::true_type, Alloc &a, T *p BOOST_PP_ENUM_TRAILING(n, BOOST_CONTAINER_PP_PARAM_LIST, _))                                              \
    {                                                                                                                                                                     \
        priv_construct_dispatch2(boost::false_type(), a, p BOOST_PP_ENUM_TRAILING(n, BOOST_CONTAINER_PP_PARAM_FORWARD, _));                                               \
    }                                                                                                                                                                     \
                                                                                                                                                                          \
    template <class T BOOST_PP_ENUM_TRAILING_PARAMS(n, class P)>                                                                                                          \
    static void priv_construct_dispatch2(boost::true_type, Alloc &a, T *p BOOST_PP_ENUM_TRAILING(n, BOOST_CONTAINER_PP_PARAM_LIST, _))                                    \
    {                                                                                                                                                                     \
        a.construct(p BOOST_PP_ENUM_TRAILING(n, BOOST_CONTAINER_PP_PARAM_FORWARD, _));                                                                                    \
    }                                                                                                                                                                     \
                                                                                                                                                                          \
    template <class T BOOST_PP_ENUM_TRAILING_PARAMS(n, class P)>                                                                                                          \
    static void priv_construct_dispatch2(boost::false_type, Alloc &, T *p BOOST_PP_ENUM_TRAILING(n, BOOST_CONTAINER_PP_PARAM_LIST, _))                                    \
    {                                                                                                                                                                     \
