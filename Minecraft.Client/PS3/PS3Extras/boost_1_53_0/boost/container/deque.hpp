...
class deque_base
{
  ...
  public:
    ...
    typedef typename val_alloc_traits_type::template portable_rebind_alloc<val_alloc_ptr>::type ptr_alloc_t;
  ...
  public:
                               ...
                               val_alloc_cptr, val_alloc_cref>
    {
      public:
        static size_type s_buffer_size()
        {
            return deque_base<T, Allocator>::s_buffer_size();
        }
      ...
      public:
        ...
        bool operator<(const self_t &x) const
        {
            return (this->m_node == x.m_node) ? (this->m_cur < x.m_cur) : (this->m_node < x.m_node);
        }
    ...
    class iterator : public const_iterator
    {
      ...
      public:
        ...
        {
            this->const_iterator::operator+=(off);
            return *this;
        }
    ...
    explicit deque_base(BOOST_RV_REF(deque_base) x)
        : members_(boost::move(x.ptr_alloc()), boost::move(x.alloc()))
    {
    }
  ...
  protected:
    ...
    {
        members_holder()
            : map_allocator_type(), allocator_type(), m_map(0), m_map_size(0), m_start(), m_finish(m_start)
        {
        }

        explicit members_holder(const allocator_type &a)
            : map_allocator_type(a), allocator_type(a), m_map(0), m_map_size(0), m_start(), m_finish(m_start)
        {
        }
        ...
        members_holder(BOOST_FWD_REF(PtrAllocConvertible) pa, BOOST_FWD_REF(ValAllocConvertible) va)
            : map_allocator_type(boost::forward<PtrAllocConvertible>(pa)), allocator_type(boost::forward<ValAllocConvertible>(va)), m_map(0), m_map_size(0), m_start(), m_finish(m_start)
        {
        }
  ...
  public:
        ...
        : Base(allocator_traits_type::select_on_container_copy_construction(x.alloc()))
    {
        if (x.size())
        {
            ...
            boost::container::uninitialized_copy_alloc(this->alloc(), x.begin(), x.end(), this->members_.m_start);
        }
    }
        ...
        : Base(a)
    {
        ...
        else
        {
            if (mx.size())
            {
                ...
                boost::container::uninitialized_copy_alloc(this->alloc(), mx.begin(), mx.end(), this->members_.m_start);
            }
        }
    }
    ...
    void emplace_front(Args &&...args)
    {
        ...
        {
            allocator_traits_type::construct(this->alloc(), this->priv_push_front_simple_pos(), boost::forward<Args>(args)...);
    ...
    void emplace_back(Args &&...args)
    {
        ...
        {
            allocator_traits_type::construct(this->alloc(), this->priv_push_back_simple_pos(), boost::forward<Args>(args)...);
...
#define BOOST_PP_LOCAL_MACRO(n)                                                                                                                                                                                                   \
    BOOST_PP_EXPR_IF(n, template <)                                                                                                                                                                                               \
                        BOOST_PP_ENUM_PARAMS(n, class P) BOOST_PP_EXPR_IF(n, >) void emplace_front(BOOST_PP_ENUM(n, BOOST_CONTAINER_PP_PARAM_LIST, _))                                                                            \
    {                                                                                                                                                                                                                             \
        if (priv_push_front_simple_available())                                                                                                                                                                                   \
        {                                                                                                                                                                                                                         \
            allocator_traits_type::construct(this->alloc(), this->priv_push_front_simple_pos()                                                                                                                                    \
                                                                BOOST_PP_ENUM_TRAILING(n, BOOST_CONTAINER_PP_PARAM_FORWARD, _));                                                                                                  \
            priv_push_front_simple_commit();                                                                                                                                                                                      \
        }                                                                                                                                                                                                                         \
        else                                                                                                                                                                                                                      \
        {                                                                                                                                                                                                                         \
            container_detail::BOOST_PP_CAT(insert_non_movable_emplace_proxy_arg, n)<Allocator, iterator BOOST_PP_ENUM_TRAILING_PARAMS(n, P)> proxy(this->alloc() BOOST_PP_ENUM_TRAILING(n, BOOST_CONTAINER_PP_PARAM_FORWARD, _)); \
    ...
    {                                                                                                                                                                                                                             \
        ...
        {                                                                                                                                                                                                                         \
            allocator_traits_type::construct(this->alloc(), this->priv_push_back_simple_pos()                                                                                                                                     \
                                                                BOOST_PP_ENUM_TRAILING(n, BOOST_CONTAINER_PP_PARAM_FORWARD, _));                                                                                                  \
    ...
    {                                                                                                                                                                                                                             \
        ...
        {                                                                                                                                                                                                                         \
            container_detail::BOOST_PP_CAT(insert_emplace_proxy_arg, n)<Allocator, iterator BOOST_PP_ENUM_TRAILING_PARAMS(n, P)> proxy(this->alloc() BOOST_PP_ENUM_TRAILING(n, BOOST_CONTAINER_PP_PARAM_FORWARD, _));             \
...
#include BOOST_PP_LOCAL_ITERATE()
    ...
    void pop_front() BOOST_CONTAINER_NOEXCEPT
    {
        ...
        {
            allocator_traits_type::destroy(this->alloc(), container_detail::to_raw_pointer(this->members_.m_start.m_cur));
    ...
    void pop_back() BOOST_CONTAINER_NOEXCEPT
    {
        if (this->members_.m_finish.m_cur != this->members_.m_finish.m_first)
        {
            ...
            allocator_traits_type::destroy(this->alloc(), container_detail::to_raw_pointer(this->members_.m_finish.m_cur));
        }
        else
        {
  ...
  private:
    ...
    void priv_range_check(size_type n) const
    {
        if (n >= this->size())
        {
            BOOST_RETHROW std::out_of_range("deque");
        }
    }
    ...
    iterator priv_insert(const_iterator position, BOOST_FWD_REF(U) x)
    {
        ...
        {
            return priv_insert_aux_impl(position, (size_type)1, container_detail::get_insert_value_proxy<iterator>(this->alloc(), ::boost::forward<U>(x)));
        }
    }
    ...
    void priv_push_front(BOOST_FWD_REF(U) x)
    {
        if (this->priv_push_front_simple_available())
        {
            allocator_traits_type::construct(this->alloc(), this->priv_push_front_simple_pos(), ::boost::forward<U>(x));
            this->priv_push_front_simple_commit();
        }
        else
        {
            priv_insert_aux_impl(this->cbegin(), (size_type)1, container_detail::get_insert_value_proxy<iterator>(this->alloc(), ::boost::forward<U>(x)));
        }
    }
    ...
    void priv_push_back(BOOST_FWD_REF(U) x)
    {
        if (this->priv_push_back_simple_available())
        {
            allocator_traits_type::construct(this->alloc(), this->priv_push_back_simple_pos(), ::boost::forward<U>(x));
            this->priv_push_back_simple_commit();
        }
        else
        {
            priv_insert_aux_impl(this->cend(), (size_type)1, container_detail::get_insert_value_proxy<iterator>(this->alloc(), ::boost::forward<U>(x)));
    ...
    void priv_destroy_range(iterator p, iterator p2)
    {
        for (; p != p2; ++p)
        {
            allocator_traits_type::destroy(this->alloc(), container_detail::to_raw_pointer(&*p));
        }
    }
        ...
        if (elemsbefore < length / 2)
        {
            ...
            else
            {
                ...
                if (elemsbefore >= n)
                {
                    ...
                    ::boost::container::uninitialized_move_alloc(this->alloc(), this->members_.m_start, start_n, new_start);
                    this->members_.m_start = new_start;
        ...
        else
        {
            ...
            else
            {
                ...
                if (elemsafter >= n)
                {
                    ...
                    ::boost::container::uninitialized_move_alloc(this->alloc(), finish_n, this->members_.m_finish, this->members_.m_finish);
                    this->members_.m_finish = new_finish;
                ...
                else
                {
                    ...
                    ::boost::container::uninitialized_move_alloc(this->alloc(), pos, old_finish, this->members_.m_finish + raw_gap);
                    BOOST_TRY
                    {
    ...
    void priv_fill_initialize(const value_type &value)
    {
        ...
        BOOST_TRY
        {
            ...
            {
                boost::container::uninitialized_fill_alloc(this->alloc(), *cur, *cur + this->s_buffer_size(), value);
            }
            boost::container::uninitialized_fill_alloc(this->alloc(), this->members_.m_finish.m_first, this->members_.m_finish.m_cur, value);
        }
        BOOST_CATCH(...)
        {
    ...
    void priv_range_initialize(FwdIt first, FwdIt last, std::forward_iterator_tag)
    {
        ...
        BOOST_TRY
        {
                 ...
                 ++cur_node)
            {
                ...
                ::boost::container::uninitialized_copy_or_move_alloc(this->alloc(), first, mid, *cur_node);
                first = mid;
            }
            ::boost::container::uninitialized_copy_or_move_alloc(this->alloc(), first, last, this->members_.m_finish.m_first);
        }
        BOOST_CATCH(...)
        {
    ...
    void priv_reallocate_map(size_type nodes_to_add, bool add_at_front)
    {
        ...
        {
            new_nstart = this->members_.m_map + (this->members_.m_map_size - new_num_nodes) / 2 + (add_at_front ? nodes_to_add : 0);
            ...
            {
                boost::move_backward(this->members_.m_start.m_node, this->members_.m_finish.m_node + 1, new_nstart + old_num_nodes);
            }
        }
        else
        {
