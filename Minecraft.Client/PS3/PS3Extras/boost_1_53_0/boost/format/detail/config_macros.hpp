...
#if defined(BOOST_NO_LOCALE_ISDIGIT) || defined(BOOST_OVERLOAD_FOR_NON_CONST) || defined(BOOST_IO_STD) || defined(BOOST_IO_NEEDS_USING_DECLARATION) || defined(BOOST_NO_TEMPLATE_STD_STREAM) || defined(BOOST_FORMAT_STREAMBUF_DEFINED) || defined(BOOST_FORMAT_OSTREAM_DEFINED)
...
#define BOOST_IO_STD ::std::
    ...
    (BOOST_WORKAROUND(__BORLANDC__, <= 0x564) || BOOST_WORKAROUND(__BORLANDC__, BOOST_TESTED_AT(0x570)))
