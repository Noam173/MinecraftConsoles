...
// Effects : the result is placed in res.
{
    ...
    else
    {
        ...
        if (n_before)
        {
            res.append(static_cast<size_type>(n_before), fill_char);
        }
        if (prefix_space)
        {
            res.append(1, prefix_space);
        ...
        if (n_after)
        {
            res.append(static_cast<size_type>(n_after), fill_char);
        }
    }
} // -mk_str(..)
...
inline void put_head(BOOST_IO_STD basic_ostream<Ch, Tr> &os, const T &x)
{
    disambiguater<Ch, Tr, T>::put_head(os, x, 1L);
}
template <class Ch, class Tr, class T>
inline void put_last(BOOST_IO_STD basic_ostream<Ch, Tr> &os, const T &x)
{
...
template <class Ch, class Tr, class T>
inline void put_head(BOOST_IO_STD basic_ostream<Ch, Tr> &, const T &)
{
}

template <class Ch, class Tr, class T>
inline void put_head(BOOST_IO_STD basic_ostream<Ch, Tr> &os, const group1<T> &x)
{
...
template <class Ch, class Tr, class T>
inline void put_last(BOOST_IO_STD basic_ostream<Ch, Tr> &os, const group1<T> &x)
{
...
template <class Ch, class Tr, class T>
inline void put_head(BOOST_IO_STD basic_ostream<Ch, Tr> &, T &)
{
}

template <class Ch, class Tr, class T>
inline void put_last(BOOST_IO_STD basic_ostream<Ch, Tr> &os, T &x)
{
    os << x;
}
#endif
...
#pragma warning(disable : 4267)
    ...
    if (!two_stepped_padding)
    {
        ...
        size_type res_size = (std::min)(static_cast<size_type>(specs.truncate_ - !!prefix_space),
                                        buf.pcount());
    ...
    { // 2-stepped padding
        ...
        { //   length w exceeded
            ...
            { // hum..  we need to pad (multi_output, or spacepad present)
                ...
                BOOST_ASSERT(i + (tmp_size - i) + (std::max)(d, (std::streamsize)0) == static_cast<size_type>(w));
