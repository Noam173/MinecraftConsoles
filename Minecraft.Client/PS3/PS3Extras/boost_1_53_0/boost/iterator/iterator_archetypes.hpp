...
typedef mpl::int_<
    (readable_iterator_bit | writable_iterator_bit)>::type readable_writable_iterator_t;

typedef mpl::int_<
    (readable_iterator_bit | lvalue_iterator_bit)>::type readable_lvalue_iterator_t;

typedef mpl::int_<
    (lvalue_iterator_bit | writable_iterator_bit)>::type writable_lvalue_iterator_t;
...
struct writable_operator_brackets
{
    ...
    {
        return read_write_proxy<ValueType>();
    }
};
...
struct operator_brackets
    : mpl::aux::msvc_eti_base<
          typename mpl::eval_if<
              is_convertible<TraversalCategory, random_access_traversal_tag>, mpl::eval_if<iterator_archetypes::has_access<AccessCategory, iterator_archetypes::writable_iterator_t>, mpl::identity<writable_operator_brackets<Value>>, mpl::if_<iterator_archetypes::has_access<AccessCategory, iterator_archetypes::readable_iterator_t>, readable_operator_brackets<Value>, no_operator_brackets>>, mpl::identity<no_operator_brackets>>::type>::type
{
};
...
struct traversal_archetype_
    : mpl::aux::msvc_eti_base<
          typename traversal_archetype_impl<TraversalCategory>::template archetype<Derived, Value>>::type
{
    typedef typename traversal_archetype_impl<TraversalCategory>::template archetype<Derived, Value>
        base;
...
struct traversal_archetype_impl<incrementable_traversal_tag>
{
    ...
    struct archetype
    {
        ...
        struct bogus
        {
        }; // This use to be void, but that causes trouble for iterator_facade. Need more research. -JGS
        typedef bogus difference_type;

        Derived &operator++()
        {
            return (Derived &)static_object<Derived>::get();
        }
...
struct iterator_access_archetype
    : mpl::aux::msvc_eti_base<
          typename iterator_access_archetype_impl<
              AccessCategory>::template archetype<Value>>::type
{
};
    ...
    iterator_archetypes::readable_iterator_t>
{
    ...
    struct archetype
    {
        ...
        {
            return detail::arrow_proxy<Value>();
        }
    };
};
    ...
    iterator_archetypes::writable_iterator_t>
{
    ...
    struct archetype
    {
        ...
        {
            return detail::assign_proxy<Value>();
        }
    };
};
    ...
    iterator_archetypes::readable_writable_iterator_t>
{
              ...
              Value, iterator_archetypes::readable_iterator_t>
    {
        ...
        {
            return detail::read_write_proxy<Value>();
        }
    };
};
...
struct iterator_access_archetype_impl<iterator_archetypes::readable_lvalue_iterator_t>
{
              ...
              Value, iterator_archetypes::readable_iterator_t>
    {
        ...
        {
            return static_object<Value>::get();
        }
        Value *operator->() const
        {
            return 0;
...
struct traversal_archetype_base
    : detail::operator_brackets<
          typename remove_cv<Value>::type, AccessCategory, TraversalCategory>,
      detail::traversal_archetype_<
          iterator_archetype<Value, AccessCategory, TraversalCategory>, Value, TraversalCategory>
{
};
      ...
      traversal_archetype_base<Value, AccessCategory, TraversalCategory>
{
    ...
    typedef typename detail::facade_iterator_category<
        TraversalCategory, typename mpl::eval_if<iterator_archetypes::has_access<AccessCategory, iterator_archetypes::writable_iterator_t>, remove_const<Value>, add_const<Value>>::type, typename access::reference>::type iterator_category;

    // Needed for some broken libraries (see below)
    typedef boost::iterator<
        iterator_category, Value, typename traversal_archetype_base<Value, AccessCategory, TraversalCategory>::difference_type, typename access::pointer, typename access::reference>
...
// iterator operations
#if BOOST_WORKAROUND(BOOST_DINKUMWARE_STDLIB, < 310) || BOOST_WORKAROUND(_RWSTD_VER, BOOST_TESTED_AT(0x20101))
    ,
      public detail::iterator_archetype_base<
          Value, AccessCategory, TraversalCategory>::workaround_iterator_base
#endif
{
    ...
    iterator_archetype(iterator_archetype const &x)
        : detail::iterator_archetype_base<
              Value, AccessCategory, TraversalCategory>(x)
    {
    }
