...
struct tuple_meta_transform_impl
{
    typedef tuples::cons<
        typename mpl::apply1<
            typename mpl::lambda<UnaryMetaFun>::type, typename Tuple::head_type>::type,
        typename tuple_meta_transform<
            typename Tuple::tail_type, UnaryMetaFun>::type>
        type;
};
...
struct tuple_meta_transform
    : mpl::eval_if<
          boost::is_same<Tuple, tuples::null_type>, mpl::identity<tuples::null_type>, tuple_meta_transform_impl<Tuple, UnaryMetaFun>>
{
};
...
template <
    typename Tuple, class BinaryMetaFun, typename StartType>
struct tuple_meta_accumulate_impl
{
    typedef typename mpl::apply2<
        typename mpl::lambda<BinaryMetaFun>::type, typename Tuple::head_type, typename tuple_meta_accumulate<typename Tuple::tail_type, BinaryMetaFun, StartType>::type>::type type;
};
...
#endif
          ,
          mpl::identity<StartType>, tuple_meta_accumulate_impl<Tuple, BinaryMetaFun, StartType>>
{
};

#if defined(BOOST_NO_FUNCTION_TEMPLATE_ORDERING) || (BOOST_WORKAROUND(BOOST_INTEL_CXX_VERSION, != 0) && defined(_MSC_VER))
...
tuples::null_type BOOST_TUPLE_ALGO(tuple_transform)(tuples::null_type const &, Fun BOOST_TUPLE_ALGO_TERMINATOR)
{
        ...
        BOOST_TUPLE_ALGO_RECURSE)
{
    typedef typename tuple_meta_transform<
        BOOST_DEDUCED_TYPENAME Tuple::tail_type, Fun>::type transformed_tail_type;

    return tuples::cons<
        BOOST_DEDUCED_TYPENAME mpl::apply1<
            Fun, BOOST_DEDUCED_TYPENAME Tuple::head_type>::type,
...
Fun BOOST_TUPLE_ALGO(tuple_for_each)(
    tuples::null_type, Fun f BOOST_TUPLE_ALGO_TERMINATOR)
{
    return f;
}
...
template <typename Tuple, typename Fun>
Fun BOOST_TUPLE_ALGO(tuple_for_each)(
    Tuple &t, Fun f BOOST_TUPLE_ALGO_RECURSE)
{
    f(t.get_head());
...
struct minimum_traversal_category_in_iterator_tuple
{
    typedef typename tuple_impl_specific::tuple_meta_transform<
        IteratorTuple, pure_traversal_tag<iterator_traversal<>>>::type tuple_of_traversal_tags;

    typedef typename tuple_impl_specific::tuple_meta_accumulate<
        tuple_of_traversal_tags, minimum_category<>, random_access_traversal_tag>::type type;
};
...
struct zip_iterator_base
{
  private:
    ...
    typedef typename detail::tuple_of_references<IteratorTuple>::type reference;
    ...
    typedef typename iterator_traits<
        typename tuples::element<0, IteratorTuple>::type>::difference_type difference_type;

    // Traversal catetgory is the minimum traversal category in the
    // iterator tuple.
    typedef typename detail::minimum_traversal_category_in_iterator_tuple<
        IteratorTuple>::type traversal_category;
...
class zip_iterator : public detail::zip_iterator_base<IteratorTuple>::type
{
  ...
  public:
    ...
    zip_iterator(
        ...
        typename enable_if_convertible<
            OtherIteratorTuple,
            IteratorTuple>::type * = 0) : m_iterator_tuple(other.get_iterator_tuple())
    {
    }
  ...
  private:
    ...
    typename super_t::difference_type distance_to(
        const zip_iterator<OtherIteratorTuple> &other) const
    {
