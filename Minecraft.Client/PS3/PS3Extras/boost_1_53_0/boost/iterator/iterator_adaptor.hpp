...
struct enable_if_convertible
{
    typedef typename mpl::if_<
        mpl::or_<
            is_same<From, To>, is_convertible<From, To>>,
        boost::detail::enable_type, int &>::type type;
};
...
struct enable_if_convertible
    : iterators::enable_if<
          is_convertible<From, To>, boost::detail::enable_type>
{
};
...
struct iterator_adaptor_base
{
    typedef iterator_facade<
        ...
        typename boost::detail::ia_dflt_help<
            Value, mpl::eval_if<
                       is_same<Reference, use_default>, iterator_value<Base>, remove_reference<Reference>>>::type
#else
        ,
        typename boost::detail::ia_dflt_help<
        ...
        typename boost::detail::ia_dflt_help<
            Reference, mpl::eval_if<
                           is_same<Value, use_default>, iterator_reference<Base>, add_reference<Value>>>::type
