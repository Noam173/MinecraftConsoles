...
class function_input_iterator
    : public mpl::if_<
          ...
          typename mpl::if_<
              ...
              impl::function_input_iterator<Function, Input>>::type>::type
{
    typedef typename mpl::if_<
        ...
        typename mpl::if_<
            function_types::is_function_reference<Function>,
            impl::function_reference_input_iterator<Function, Input>,
            impl::function_input_iterator<Function, Input>>::type>::type base_type;
...
struct infinite
{
    ...
    bool operator==(infinite &) const
    {
        return false;
    };
    bool operator==(infinite const &) const
    {
        return false;
    };
};
