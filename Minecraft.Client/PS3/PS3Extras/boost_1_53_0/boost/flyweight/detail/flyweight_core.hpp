...
class flyweight_core
{
  public:
    ...
    typedef typename mpl::apply2<
        ...
        rep_type,
        key_type>::type entry_type;
    typedef typename mpl::apply2<
        FactorySpecifier,
        entry_type,
        key_type>::type factory_type;
    ...
    typedef typename mpl::apply2<
        ...
        flyweight_core_tracking_helper<
            ValuePolicy, Tag, TrackingPolicy,
            FactorySpecifier, LockingPolicy,
            HolderSpecifier>>::type handle_type;
...
#include <boost/flyweight/detail/perfect_fwd.hpp>
    ...
    static handle_type insert(const value_type &x)
    {
        return insert_value(x);
    }
    static handle_type insert(value_type &x)
    {
        return insert_value(x);
    }
