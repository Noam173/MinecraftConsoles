          ...
          typename mpl::next<First>::type, Last, Index + 1>
{
    using conversion_test_overloads_iterate<
        typename mpl::next<First>::type, Last, Index + 1>::apply;
    ...
    typedef typename mpl::copy<
        ...
        mpl::inserter<
            ...
            mpl::if_<
                ...
                mpl::_1,
                mpl::push_back<mpl::_1, mpl::_2>>>>::type candidate_types;
  ...
  public:
    typedef typename deduce_common_type<
        ...
        mpl::vector4<
            ...
            typename propagate_cv<unrefed_T_type, unrefed_U_type>::type &>>::type type;
};

template <class T, class U>
struct common_type_impl
    : public common_type_dispatch_on_rvalueness<T, U, sizeof(::boost::detail_type_traits_common_type::rvalue_test(declval<bool>() ? declval<T>() : declval<U>())) == sizeof(yes_type)>
{
};
