...
struct floating_point_promotion
    : mpl::at<
          ...
          mpl::plus<
              is_same<T, float>, mpl::multiplies<is_same<T, float const>, mpl::int_<2>>, mpl::multiplies<is_same<T, float volatile>, mpl::int_<3>>, mpl::multiplies<is_same<T, float const volatile>, mpl::int_<4>>>>
{
};
...
BOOST_TT_AUX_TYPE_TRAIT_DEF1(
    floating_point_promotion, T, BOOST_DEDUCED_TYPENAME boost::type_traits::detail::floating_point_promotion<T>::type)
} // namespace boost
