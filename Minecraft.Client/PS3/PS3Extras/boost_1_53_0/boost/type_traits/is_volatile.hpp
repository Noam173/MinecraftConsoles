...
struct is_volatile_helper<false, false>
{
    ...
    {
        static T *t;
        BOOST_STATIC_CONSTANT(bool, value = (sizeof(boost::detail::yes_type) == sizeof(boost::detail::is_volatile_tester(t))));
    };
};
...
struct is_volatile_impl
    : public is_volatile_helper<
          is_reference<T>::value, is_array<T>::value>::template result_<T>
{
};
