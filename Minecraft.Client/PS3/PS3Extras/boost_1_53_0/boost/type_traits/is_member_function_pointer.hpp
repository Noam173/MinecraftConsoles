...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(
    is_member_function_pointer, T, ::boost::type_traits::is_mem_fun_pointer_impl<typename remove_cv<T>::type>::value)
...
struct is_member_function_pointer_impl
    : public is_mem_fun_pointer_select<
          ::boost::type_traits::ice_or<
              ::boost::is_reference<T>::value, ::boost::is_array<T>::value>::value>::template result_<T>
{
};
