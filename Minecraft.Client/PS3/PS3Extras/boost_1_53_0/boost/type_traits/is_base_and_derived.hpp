...
#ifndef BOOST_IS_BASE_OF
#if !BOOST_WORKAROUND(__BORLANDC__, BOOST_TESTED_AT(0x581)) && !BOOST_WORKAROUND(__SUNPRO_CC, <= 0x540) && !BOOST_WORKAROUND(__EDG_VERSION__, <= 243) && !BOOST_WORKAROUND(__DMC__, BOOST_TESTED_AT(0x840))
...
BOOST_TT_AUX_BOOL_TRAIT_DEF2(
    is_base_and_derived, Base, Derived, (::boost::detail::is_base_and_derived_impl<Base, Derived>::value))
