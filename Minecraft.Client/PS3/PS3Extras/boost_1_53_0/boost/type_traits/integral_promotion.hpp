...
// Please, keep in sync.
#if (defined(BOOST_MSVC) && (BOOST_MSVC < 1300)) || (defined(BOOST_INTEL_CXX_VERSION) && defined(_MSC_VER) && (BOOST_INTEL_CXX_VERSION <= 600)) || (defined(__BORLANDC__) && (__BORLANDC__ == 0x600) && (_MSC_VER < 1300))
...
struct integral_promotion
    : public boost::mpl::eval_if<
          need_promotion<BOOST_DEDUCED_TYPENAME remove_cv<T>::type>, integral_promotion_impl<T>, boost::mpl::identity<T>>
{
};
...
BOOST_TT_AUX_TYPE_TRAIT_DEF1(
    integral_promotion, T, BOOST_DEDUCED_TYPENAME boost::type_traits::detail::integral_promotion<T>::type)
} // namespace boost
