                                    ...
                                    function_traits<Signature>::arity>
{
  private:
    ...
    coroutine(context::fcontext_t *callee,
              ...
              Allocator const &alloc) : detail::coroutine_op<Signature,
                                                             coroutine<Signature>,
                                                             typename function_traits<Signature>::result_type,
                                                             function_traits<Signature>::arity>(),
  ...
  public:
    typedef typename detail::caller<
        Signature,
        boost::coroutines::coroutine>::type caller_type;

    coroutine() BOOST_NOEXCEPT : detail::coroutine_op<
                                     Signature,
                                     coroutine<Signature>,
                                     typename function_traits<Signature>::result_type,
                                     function_traits<Signature>::arity>(),
    ...
    explicit coroutine(coroutine_fn fn, attributes const &attr = attributes(),
                       ...
                       std::allocator<coroutine> const &alloc =
                           std::allocator<coroutine>()) : detail::coroutine_op<Signature,
                                                                               coroutine<Signature>,
                                                                               typename function_traits<Signature>::result_type,
                                                                               function_traits<Signature>::arity>(),
                                                          detail::coroutine_get<
    ...
    explicit coroutine(BOOST_RV_REF(Fn) fn, attributes const &attr = attributes(),
                       ...
                       typename disable_if<
                           ...
                           dummy *>::type = 0) : detail::coroutine_op<Signature,
                                                                      coroutine<Signature>,
                                                                      typename function_traits<Signature>::result_type,
                                                                      function_traits<Signature>::arity>(),
                                                 detail::coroutine_get<
    ...
    coroutine(BOOST_RV_REF(coroutine) other) BOOST_NOEXCEPT : detail::coroutine_op<
                                                                  Signature,
                                                                  coroutine<Signature>,
                                                                  typename function_traits<Signature>::result_type,
                                                                  function_traits<Signature>::arity>(),
