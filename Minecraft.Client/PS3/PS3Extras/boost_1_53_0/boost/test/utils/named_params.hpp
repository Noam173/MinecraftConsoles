...
struct named_parameter_base
{
    ...
    {
        return named_parameter_combine<NP, Derived>(np, *static_cast<Derived const *>(this));
    }
};
    ...
    : nfp_detail::named_parameter_base<named_parameter<T, unique_id, ReferenceType>>
{
    ...
    {
        return m_erased ? nil_t::inst().template any_cast<ref_type>() : m_value;
    }
...
struct typed_keyword<bool, unique_id, false>
    : keyword<unique_id, false>, named_parameter<bool, unique_id, bool>
{
    typedef unique_id id;
...
inline void
#if BOOST_WORKAROUND(__MWERKS__, BOOST_TESTED_AT(0x3003)) || BOOST_WORKAROUND(__DECCXX_VER, BOOST_TESTED_AT(60590042))
