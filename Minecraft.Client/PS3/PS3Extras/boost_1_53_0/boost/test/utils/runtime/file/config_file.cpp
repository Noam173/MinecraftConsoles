...
void param_namespace::insert_param(cstring param_name, cstring param_value)
{
...
void param_namespace::print_full_name(std::ostream &os) const
{
    if (!p_parent)
    {
        return;
...
void param_namespace::load_impl(config_file_iterator cf_it,
