...
class parameter
{
  public:
    ...
    BOOST_READONLY_PROPERTY(dstring, (parameter))
    p_name;
    BOOST_READONLY_PROPERTY(dstring, (parameter))
    p_value;
