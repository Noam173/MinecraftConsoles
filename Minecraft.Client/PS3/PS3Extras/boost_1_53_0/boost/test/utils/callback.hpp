...
struct invoker
{
    ...
    R invoke(Functor &f, T1 t1)
    {
        return f(t1);
    }
    template <typename Functor, typename T1, typename T2>
    R invoke(Functor &f, T1 t1, T2 t2)
    {
        return f(t1, t2);
    }
    template <typename Functor, typename T1, typename T2, typename T3>
    R invoke(Functor &f, T1 t1, T2 t2, T3 t3)
    {
        return f(t1, t2, t3);
    }
};
...
{
    template <typename Functor>
    unused invoke(Functor &f)
    {
        f();
        return unused();
    }
    template <typename Functor, typename T1>
    unused invoke(Functor &f, T1 t1)
    {
        f(t1);
        return unused();
    }
    template <typename Functor, typename T1, typename T2>
    unused invoke(Functor &f, T1 t1, T2 t2)
    {
        f(t1, t2);
        return unused();
    }
    template <typename Functor, typename T1, typename T2, typename T3>
    unused invoke(Functor &f, T1 t1, T2 t2, T3 t3)
    {
        f(t1, t2, t3);
        return unused();
    }
...
class callback0
{
  public:
    ...
    {
        m_impl.reset(new ut_detail::callback0_impl_t<R, Functor>(f));
    }
...
struct callback1_impl_t : callback1_impl<R, T1>
{
    ...
    virtual R invoke(T1 t1)
    {
        return invoker<R>().invoke(m_f, t1);
    }
...
class callback1
{
  public:
    ...
    void operator=(Functor f)
    {
        m_impl.reset(new ut_detail::callback1_impl_t<R, T1, Functor>(f));
    }

    R operator()(T1 t1) const
    {
        return m_impl->invoke(t1);
    }
...
struct callback2_impl_t : callback2_impl<R, T1, T2>
{
    ...
    {
        return invoker<R>().template invoke<Functor, T1, T2>(m_f, t1, t2);
    }
...
class callback2
{
  public:
    ...
    void operator=(callback2 const &rhs)
    {
        m_impl = rhs.m_impl;
    }
    ...
    void operator=(Functor f)
    {
        m_impl.reset(new ut_detail::callback2_impl_t<R, T1, T2, Functor>(f));
    }

    R operator()(T1 t1, T2 t2) const
    {
        return m_impl->invoke(t1, t2);
    }
...
struct callback3_impl_t : callback3_impl<R, T1, T2, T3>
{
    ...
    {
        return invoker<R>().invoke(m_f, t1, t2, t3);
    }
...
class callback3
{
  public:
    ...
    void operator=(Functor f)
    {
        m_impl.reset(new ut_detail::callback3_impl_t<R, T1, T2, T3, Functor>(f));
    }

    R operator()(T1 t1, T2 t2, T3 t3) const
    {
        return m_impl->invoke(t1, t2, t3);
    }
