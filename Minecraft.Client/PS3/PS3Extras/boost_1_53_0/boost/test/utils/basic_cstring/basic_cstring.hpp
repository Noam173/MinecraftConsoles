...
class basic_cstring
{
  ...
  public:
    ...
    {
        *this = basic_cstring<CharT>(s.begin(), s.end());
        return *this;
    }
...
inline basic_cstring<CharT>::basic_cstring(pointer s)
    : m_begin(s ? s : null_str()), m_end(m_begin + (s ? traits_type::length(s) : 0))
{
}
...
template <typename CharT>
inline basic_cstring<CharT>::basic_cstring(pointer s, size_type arg_size)
