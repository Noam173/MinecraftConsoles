...
{
  public:
    master_test_suite_t() : test_suite("Master Test Suite"), argc(0), argv(0)
    {
    }
...
class BOOST_TEST_DECL test_tree_visitor
{
  public:
    ...
    virtual bool test_suite_start(test_suite const &)
    {
        return true;
    }
...
class test_case_counter : public test_tree_visitor
{
  public:
    ...
    BOOST_READONLY_PROPERTY(counter_t, (test_case_counter))
    p_count;
...
class test_case_template_invoker
{
  public:
    void operator()()
    {
        TestCaseTemplate::run((boost::type<TestType> *)0);
    }
};
...
struct generate_test_case_4_type
{
    explicit generate_test_case_4_type(const_string tc_name, Generator &G)
        : m_test_case_name(tc_name), m_holder(G)
    {
    }
