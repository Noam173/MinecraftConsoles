...
struct tuple_extract
    : tuple_extract_base_select<
          Tuple, typename mpl::lambda<Predicate>::type>::type
{
};
...
struct doc_extract
    : tuple_extract<
          Tuple, mpl::not_<
                     mpl::or_<
                         indirect_traits::is_reference_to_class<mpl::_1>, indirect_traits::is_reference_to_member_function_pointer<mpl::_1>>>>
{
};
...
struct policy_extract
    : tuple_extract<
          Tuple, mpl::and_<
                     mpl::not_<is_same<not_specified const &, mpl::_1>>, indirect_traits::is_reference_to_class<mpl::_1>, mpl::not_<is_reference_to_keywords<mpl::_1>>>>
{
};
...
struct default_implementation_extract
    : tuple_extract<
          Tuple, indirect_traits::is_reference_to_member_function_pointer<mpl::_1>>
{
};
...
struct def_helper
{
    ...
    typedef boost::tuples::tuple<
        T1 const &, T2 const &, T3 const &, T4 const &, default_call_policies, detail::keywords<0>, char const *, void (not_specified::*)() // A function pointer type which is never an
  ...
  public: // Constants which can be used for static assertions.
    ...
    BOOST_STATIC_CONSTANT(
        bool, has_default_implementation = (!is_same<default_implementation_t, void (not_specified::*)()>::value));
