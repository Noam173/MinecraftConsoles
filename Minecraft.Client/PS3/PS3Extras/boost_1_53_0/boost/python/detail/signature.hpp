...
#define BOOST_PP_LOCAL_MACRO(i) \
    {                           \
        type_id<BOOST_DEDUCED_TYPENAME mpl::at_c<Sig, i>::type>().name(), &converter::expected_pytype_for_arg<BOOST_DEDUCED_TYPENAME mpl::at_c<Sig, i>::type>::get_pytype, indirect_traits::is_reference_to_non_const<BOOST_DEDUCED_TYPENAME mpl::at_c<Sig, i>::type>::value},
#else
#define BOOST_PP_LOCAL_MACRO(i) \
    {                           \
        type_id<BOOST_DEDUCED_TYPENAME mpl::at_c<Sig, i>::type>().name(), 0, indirect_traits::is_reference_to_non_const<BOOST_DEDUCED_TYPENAME mpl::at_c<Sig, i>::type>::value},
#endif
