...
#if (defined(BOOST_MSVC) && _MSC_FULL_VER <= 13102140) || (defined(__GNUC__) && __GNUC__ < 3) || (defined(__MWERKS__) && __MWERKS__ < 0x3000)
...
struct result_result
{
    typedef typename mpl::if_c<
        is_class<T>::value, get_result_type<T>, void_type>::type t1;
