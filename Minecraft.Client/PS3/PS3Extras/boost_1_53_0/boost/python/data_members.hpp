...
struct default_getter_by_ref
    : mpl::and_<
          mpl::bool_<
              to_python_value<
                  typename value_arg<T>::type>::uses_registry>,
...
struct default_member_getter_policy
    : mpl::if_<
          default_getter_by_ref<T>, return_internal_reference<>, return_value_policy<return_by_value>>
{
};
...
struct default_datum_getter_policy
    : mpl::if_<
          default_getter_by_ref<T>, return_value_policy<reference_existing_object>, return_value_policy<return_by_value>>
{
};
...
#endif
    return python::make_function(
        detail::member<D, Class>(pm), policies, mpl::vector2<D &, Class &>());
}
...
{
    return python::make_function(
        detail::member<D, C>(pm), policies, mpl::vector3<void, C &, D const &>());
}
