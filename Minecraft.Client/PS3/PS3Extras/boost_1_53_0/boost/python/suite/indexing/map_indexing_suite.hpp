...
class map_indexing_suite
    : public indexing_suite<
          Container, DerivedPolicies, NoProxy, true, typename Container::value_type::second_type, typename Container::key_type, typename Container::key_type>
{
  public:
    ...
    extension_def(Class &cl)
    {
        ...
        typedef typename mpl::if_<
            mpl::and_<is_class<data_type>, mpl::bool_<!NoProxy>>, return_internal_reference<>, default_call_policies>::type get_data_return_policy;
    ...
    static
        typename mpl::if_<
            mpl::and_<is_class<data_type>, mpl::bool_<!NoProxy>>, data_type &, data_type>::type
