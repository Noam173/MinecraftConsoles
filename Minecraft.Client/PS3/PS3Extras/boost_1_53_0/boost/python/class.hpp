...
#include <boost/detail/workaround.hpp>
    ...
    || (BOOST_WORKAROUND(__MWERKS__, > 0x3100) && BOOST_WORKAROUND(__MWERKS__, BOOST_TESTED_AT(0x3201))) || BOOST_WORKAROUND(__GNUC__, < 3)
...
struct is_data_member_pointer
    : mpl::and_<
          is_member_pointer<T>, mpl::not_<is_member_function_pointer<T>>>
{
};
...
class class_ : public objects::class_base
{
  ...
  public: // member functions
    ...
    {
        this->def_impl(
            detail::unwrap_wrapper((W *)0), name, f, detail::def_helper<char const *>(0), &f);
        return *this;
    }
    ...
    self &def(char const *name, Fn fn, A1 const &a1, A2 const &a2)
    {
        ...
        this->def_impl(
            detail::unwrap_wrapper((W *)0), name, fn, detail::def_helper<A1, A2>(a1, a2), &fn);
    ...
    {
        this->def_impl(
            detail::unwrap_wrapper((W *)0), name, fn, detail::def_helper<A1, A2, A3>(a1, a2, a3), &fn);
  ...
  private: // helper functions
    ...
    object make_getter(F f)
    {
        ...
        return this->make_fn_impl(
            detail::unwrap_wrapper((W *)0), f, is_obj_or_proxy(), (char *)0, detail::is_data_member_pointer<F>());
    }
    ...
    object make_setter(F f)
    {
        ...
        return this->make_fn_impl(
            detail::unwrap_wrapper((W *)0), f, is_obj_or_proxy(), (int *)0, detail::is_data_member_pointer<F>());
    }
    ...
    inline void def_impl(
        T *, char const *name, LeafVisitor, Helper const &helper, def_visitor<Visitor> const *v)
    {
    ...
    inline void def_impl(
        T *, char const *name, Fn fn, Helper const &helper, ...)
    {
        objects::add_to_namespace(
            *this, name, make_function(fn, helper.policies(), helper.keywords(), detail::get_signature(fn, (T *)0)), helper.doc());
    ...
    inline void def_default(
        char const *name, Fn, Helper const &helper, mpl::bool_<true>)
    {
    ...
    void def_maybe_overloads(
        char const *name, SigT sig, OverloadsT const &overloads, detail::overloads_base const *)
    ...
    void def_maybe_overloads(
        char const *name, Fn fn, A1 const &a1, ...)
    {
        this->def_impl(
            detail::unwrap_wrapper((W *)0), name, fn, detail::def_helper<A1>(a1), &fn);
    }
    // }
};
