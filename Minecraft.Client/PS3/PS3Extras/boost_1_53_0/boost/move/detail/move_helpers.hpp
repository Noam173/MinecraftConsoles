...
#define BOOST_MOVE_CONVERSION_AWARE_CATCH(PUB_FUNCTION, TYPE, RETURN_VALUE, FWD_FUNCTION)                                    \
    ...
    typename ::boost::enable_if_c<::boost::is_class<TYPE>::value && ::boost::is_same<TYPE, BOOST_MOVE_TEMPL_PARAM>::value && \
    ...
    {                                                                                                                        \
        return FWD_FUNCTION(u);                                                                                              \
                                                                                                                             ...
                                                                                                                             \
    template <class BOOST_MOVE_TEMPL_PARAM>                                                                                  \
    typename ::boost::enable_if_c<(!::boost::is_class<BOOST_MOVE_TEMPL_PARAM>::value ||                                      \
...
#define BOOST_MOVE_CONVERSION_AWARE_CATCH(PUB_FUNCTION, TYPE, RETURN_VALUE, FWD_FUNCTION)                     \
    ...
    {                                                                                                         \
        return FWD_FUNCTION(::boost::move(x));                                                                \
                                                                                                              ...
                                                                                                              \
    template <class BOOST_MOVE_TEMPL_PARAM>                                                                   \
    typename ::boost::enable_if_c<!::boost::is_same<TYPE, BOOST_MOVE_TEMPL_PARAM>::value, RETURN_VALUE>::type \
    PUB_FUNCTION(const BOOST_MOVE_TEMPL_PARAM &u)                                                             \
    {                                                                                                         \
        TYPE t(u);                                                                                            \
        return FWD_FUNCTION(::boost::move(t));                                                                \
