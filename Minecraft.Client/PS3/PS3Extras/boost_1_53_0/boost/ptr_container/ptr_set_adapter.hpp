                                                             ...
                                                             CloneAllocator>
{
  ...
  public:
    ...
    {
        return iterator(this->base().find(const_cast<key_type *>(&x)));
    }
...
template <
    ...
    class CloneAllocator = heap_clone_allocator,
    bool Ordered = true>
class ptr_set_adapter : public ptr_container_detail::ptr_set_adapter_base<Key, VoidPtrSet, CloneAllocator, Ordered>
{
...
template <
    ...
    class CloneAllocator = heap_clone_allocator,
    bool Ordered = true>
class ptr_multiset_adapter : public ptr_container_detail::ptr_set_adapter_base<Key, VoidPtrMultiSet, CloneAllocator, Ordered>
{
