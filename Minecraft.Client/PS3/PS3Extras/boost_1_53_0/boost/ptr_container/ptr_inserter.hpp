...
template <class PtrContainer>
class ptr_back_insert_iterator : public std::iterator<std::output_iterator_tag, void, void, void, void>
{
  public:
...
template <class PtrContainer>
class ptr_front_insert_iterator : public std::iterator<std::output_iterator_tag, void, void, void, void>
{
  public:
    typedef PtrContainer container_type;
...
template <class PtrContainer>
class ptr_insert_iterator : public std::iterator<std::output_iterator_tag, void, void, void, void>
{
  public:
    typedef PtrContainer container_type;
