...
class BOOST_SIGNALS_DECL connection : private less_than_comparable1<connection>,
...
{
  public:
    auto_disconnect_bound_object(const bound_object &b) : binding(b), auto_disconnect(true)
    {
    }
