...
struct get_default_conversion
{
    typedef typename unscaled_get_default_conversion_impl<
        unscaled_get_default_conversion<typename unscale<BaseUnit>::type>::is_defined>::template apply<BaseUnit>::type type;
};
...
#define BOOST_UNITS_DETAIL_BASE_UNIT_CONVERTER_IS_DEFINED(Source, Dest)                                                 \
    base_unit_converter<                                                                                                \
        ...
        typename select_base_unit_converter<typename unscale<Source>::type, typename unscale<Dest>::type>::destination_type>::is_defined
...
template <class Source, class Dest>
struct call_base_unit_converter<Source, BOOST_UNITS_MAKE_HETEROGENEOUS_UNIT(Dest, typename Source::dimension_type)> : call_base_unit_converter_base_unit_impl<
                                                                                                                          BOOST_UNITS_DETAIL_BASE_UNIT_CONVERTER_IS_DEFINED(Source, typename Dest::unit_type),
                                                                                                                          BOOST_UNITS_DETAIL_BASE_UNIT_CONVERTER_IS_DEFINED(Dest, typename Source::unit_type)>::template apply<Source, Dest>
{
};
...
struct conversion_impl
{
    ...
    struct apply
    {
        ...
        static type value()
        {
            return (static_rational_power<typename unit_pair::value_type>(converter::value()) * next_iteration::value());
        }
    };
};
