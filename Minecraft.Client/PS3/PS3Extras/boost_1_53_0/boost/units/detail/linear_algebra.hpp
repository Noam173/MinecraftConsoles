...
struct determine_extra_equations_skip_zeros_impl<true, false>
{
    ...
    struct apply
    {
        ...
        typedef typename determine_extra_equations_skip_zeros_impl<
            ...
            >::template apply<typename RowsBegin::next,
                              RemainingRows - 1,
                              CurrentColumn,
                              TotalColumns,
                              Result>
...
struct determine_extra_equations
{
    ...
    struct apply
    {
        ...
        typedef typename determine_extra_equations_skip_zeros_impl<
            ...
            RowsBegin::item::size::value == 1>::template apply<RowsBegin,
        ...
        typedef typename determine_extra_equations<
            RemainingColumns - 1,
            column_info::next_equations::size::value == 0>::template apply<typename column_info::next_equations,
                                                                           TotalColumns,
                                                                           typename column_info::type>::type type;
    };
};
...
struct determine_extra_equations<RemainingColumns, true>
{
    ...
    struct apply
    {
        typedef typename determine_extra_equations<RemainingColumns - 1, true>::template apply<
            RowsBegin,
            TotalColumns,
            list<typename create_row_of_identity<TotalColumns - RemainingColumns, TotalColumns>::type, Result>>::type type;
    };
};
...
struct invert_handle_inital_rows<0>
{
    ...
    struct apply
    {
        ...
        typedef typename invert_strip_leading_zeroes<
            ...
            (RowsBegin::size::value == 1)>::template apply<RowsBegin,
                                                           IdentityBegin>
            next;
        // results
...
struct invert_strip_leading_zeroes<true, false>
{
    ...
    struct apply
    {
        ...
        typedef typename invert_strip_leading_zeroes<
            next_row::item::Numerator == 0,
            RowsBegin::size::value == 2>::template apply<typename RowsBegin::next,
                                                         typename IdentityBegin::next>
            next;
        typedef typename IdentityBegin::item current_identity_row;
...
struct make_square_and_invert
{
    ...
    typedef typename invert_impl<invertible::size::value>::template apply<
        invertible,
        typename make_identity<invertible::size::value>::template apply<invertible::size::value>::type>::type type;
};
...
struct find_base_dimensions_impl_impl
{
    ...
    struct apply
    {
        ...
        typedef typename set_insert<
            (has_key<next, typename Begin::item::tag_type>::value)>::template apply<next,
                                                                                    typename Begin::item::tag_type>::type type;
    };
};
...
struct find_base_dimensions_impl
{
    ...
    struct apply
    {
        typedef typename find_base_dimensions_impl_impl<(Begin::item::dimension_type::size::value)>::template apply<
            ...
            typename find_base_dimensions_impl<N - 1>::template apply<typename Begin::next>::type>::type type;
    };
};
...
struct find_base_dimensions
{
    typedef typename insertion_sort<
        typename find_base_dimensions_impl<
            (T::size::value)>::template apply<T>::type>::type type;
};
    ...
    struct apply
    {
        typedef typename calculate_base_dimension_coefficients_func<
            begins_with_dimension<typename BaseUnitDimensions::item>::template apply<
                Dim>::value>::template apply<typename BaseUnitDimensions::item>
            result;
...
struct expand_dimensions
{
    ...
    {
        typedef typename calculate_base_dimension_coefficients_func<
            begins_with_dimension<DimensionIterator>::template apply<typename Begin::item>::value>::template apply<DimensionIterator>
            result;
        typedef list<
...
struct multiply_add_units
{
    ...
    struct apply
    {
        typedef typename multiply_add_units_impl<
            (Begin2::item::size::value)>::template apply<typename multiply_add_units<N - 1>::template apply<typename Begin1::next,
                                                                                                            typename Begin2::next>::type,
                                                         typename Begin2::item,
...
struct multiply_add_units<1>
{
    ...
    struct apply
    {
        typedef typename add_zeroes_impl<
            (Begin2::item::size::value)>::template apply<dimensionless_type>::type type1;
        typedef typename multiply_add_units_impl<
            (Begin2::item::size::value)>::template apply<type1,
                                                         typename Begin2::item,
                                                         typename Begin1::item>::type type;
    };
};
...
struct is_simple_system
{
    ...
    typedef typename mpl::and_<
        ...
        typename is_simple_system_impl<
            T::size::value - 1>::template apply<typename Begin::next::type,
                                                typename test::base_dimension_type>>::type type;
    static const bool value = type::value;
};
...
struct calculate_base_unit_exponents_impl<false>
{
    ...
    struct apply
    {
        ...
        typedef typename multiply_add_units<dimensions::size::value>::template apply<
            dimensions,
            typename base_solutions::type>::type units;
