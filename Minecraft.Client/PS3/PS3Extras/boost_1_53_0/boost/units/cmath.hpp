...
inline bool
    isgreater
    BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity<Unit, Y> &q1,
...
template <class Unit, class Y>
inline quantity<Unit, Y> nextafter BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity<Unit, Y> &q1,
                                                                    const quantity<Unit, Y> &q2)
{
...
template <class Unit, class Y>
inline quantity<Unit, Y> nexttoward BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity<Unit, Y> &q1,
                                                                     const quantity<Unit, Y> &q2)
{
...
inline quantity<BOOST_UNITS_DIMENSIONLESS_UNIT(S), Y>
    ...
    sqrt(const quantity<Unit, Y> &q)
{
    ...
    typedef typename root_typeof_helper<
        quantity<Unit, Y>,
        static_rational<2>>::type quantity_type;
