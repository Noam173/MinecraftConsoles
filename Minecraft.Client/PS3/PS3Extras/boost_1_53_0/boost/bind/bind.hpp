...
template <class R, class F, class L>
bool function_equal_impl(bind_t<R, F, L> const &a, bind_t<R, F, L> const &b, int)
{
    return a.compare(b);
}
...
template <class R, class F, class L>
bool function_equal(_bi::bind_t<R, F, L> const &a, _bi::bind_t<R, F, L> const &b)
{
    return a.compare(b);
}
...
template <class R, class F, class L>
bool function_equal_impl(_bi::bind_t<R, F, L> const &a, _bi::bind_t<R, F, L> const &b, int)
{
    return a.compare(b);
}
...
#if !defined(BOOST_NO_ARGUMENT_DEPENDENT_LOOKUP) && !defined(__BORLANDC__) && !(defined(__GNUC__) && __GNUC__ == 3 && __GNUC_MINOR__ <= 3)
...
#if defined(BOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION) || defined(BOOST_NO_FUNCTION_TEMPLATE_ORDERING) || (defined(__BORLANDC__) && BOOST_WORKAROUND(__BORLANDC__, BOOST_TESTED_AT(0x620)))
