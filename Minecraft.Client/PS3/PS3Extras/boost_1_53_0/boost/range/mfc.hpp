...
struct mfc_ptr_array_iterator : mfc_ptr_array_iterator_super<ArrayT, PtrType>::type
{
  ...
  public:
    ...
    explicit mfc_ptr_array_iterator(ArrayT &arr, INT_PTR index) : super_t(index), m_parr(boost::addressof(arr))
    {
    }
    ...
    mfc_ptr_array_iterator(mfc_ptr_array_iterator<ArrayT_, PtrType_> const &other) : super_t(other.base()), m_parr(other.m_parr)
    {
    }
...
struct mfc_map_iterator : mfc_map_iterator_super<MapT, KeyT, MappedT>::type
{
  ...
  public:
    ...
    explicit mfc_map_iterator(MapT const &map, POSITION pos) : m_pmap(boost::addressof(map)), m_posNext(pos)
    {
        increment();
    }

    explicit mfc_map_iterator(MapT const &map) : m_pmap(&map), m_pos(0) // end iterator
    {
    }
    ...
    mfc_map_iterator(mfc_map_iterator<MapT_, KeyT_, MappedT_> const &other) : m_pmap(other.m_pmap),
...
struct mfc_cpair_map_iterator : mfc_pget_map_iterator_super<MapT, PairT>::type
{
  ...
  public:
    ...
    explicit mfc_cpair_map_iterator(MapT &map, PairT *pp) : m_pmap(boost::addressof(map)), m_pp(pp)
    {
    }
    ...
    mfc_cpair_map_iterator(mfc_cpair_map_iterator<MapT_, PairT_> const &other) : m_pmap(other.m_pmap), m_pp(other.m_pp)
    {
    }
