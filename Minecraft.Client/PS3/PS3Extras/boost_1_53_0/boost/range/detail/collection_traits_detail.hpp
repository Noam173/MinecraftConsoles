...
struct default_container_traits
{
    ...
    typedef BOOST_STRING_TYPENAME ::boost::mpl::if_<::boost::is_const<ContainerT>,
                                                    const_iterator,
                                                    iterator>::type result_iterator;
    ...
    typedef BOOST_STRING_TYPENAME ::boost::mpl::eval_if<
        ...
        ::boost::mpl::eval_if<
            ...
            ::boost::mpl::eval_if<
                ...
                array_traits_impl_selector<T, const volatile BaseT>>>>::type type;
};
...
struct array_traits_selector
{
  private:
    ...
    typedef BOOST_STRING_TYPENAME ::boost::mpl::vector10<
        wchar_t,
#else  // BOOST_NO_INTRINSIC_WCHAR_T
    typedef BOOST_STRING_TYPENAME ::boost::mpl::vector9<
        ...
        unsigned int,
        signed long,
        unsigned long>::type array_base_types;

  public:
    typedef BOOST_STRING_TYPENAME ::boost::mpl::fold<
        array_base_types,
...
struct array_container_traits
{
  ...
  public:
    ...
    typedef BOOST_STRING_TYPENAME ::boost::mpl::if_<::boost::is_const<T>,
                                                    const_iterator,
                                                    iterator>::type result_iterator;

  private:
    // resolve array size
    typedef BOOST_STRING_TYPENAME ::boost::remove_cv<value_type>::type char_type;
    typedef BOOST_STRING_TYPENAME
        array_length_selector<char_type>::
            BOOST_NESTED_TEMPLATE array_length<traits_type>
                array_length_type;
...
{
    typedef BOOST_STRING_TYPENAME ::boost::remove_pointer<T>::type value_type;
