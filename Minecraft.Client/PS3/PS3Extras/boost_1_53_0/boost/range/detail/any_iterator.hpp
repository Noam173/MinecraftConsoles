...
struct is_const_reference
{
    typedef typename mpl::and_<
        ...
        typename is_const<
            typename remove_reference<T>::type>::type>::type type;
};
...
struct is_convertible_to_value_as_reference
{
    typedef typename mpl::and_<
        typename mpl::not_<
            typename is_reference<TargetReference>::type>::type,
        typename is_convertible<
            SourceReference, TargetReference>::type>::type type;
};
          ...
          Value, Traversal, Reference, Difference>
{
    ...
    typedef typename any_iterator_interface_type_generator<
        Traversal, Reference, Difference, Buffer>::type abstract_base_type;
  ...
  public:
    ...
    explicit any_iterator(
        ...
        typename disable_if<
            typename is_any_iterator<WrappedIterator>::type, disabler>::type * = 0)
    {
        typedef typename any_iterator_wrapper_type_generator<
            WrappedIterator, Traversal, Reference, Difference, Buffer>::type wrapper_type;
