          ...
          Reference, Buffer>
{
  ...
  public:
    ...
    BOOST_STATIC_ASSERT((is_convertible<
                         typename iterator_reference<WrappedIterator>::type, Reference>::value));
    ...
    virtual any_incrementable_iterator_wrapper *clone(
        typename any_incrementable_iterator_wrapper::buffer_type &buffer) const
    {
          ...
          Reference, Buffer>
{
  ...
  public:
    ...
    virtual any_single_pass_iterator_wrapper *clone(
        typename any_single_pass_iterator_wrapper::buffer_type &buffer) const
    {
        return new (buffer.allocate(sizeof(*this)))
          ...
          Reference, Buffer>
{
  ...
  public:
    ...
    virtual any_forward_iterator_wrapper *clone(
        typename any_forward_iterator_wrapper::buffer_type &buffer) const
    {
        return new (buffer.allocate(sizeof(*this)))
          ...
          Reference, Buffer>
{
  ...
  public:
    ...
    virtual any_bidirectional_iterator_wrapper *clone(
        typename any_bidirectional_iterator_wrapper::buffer_type &buffer) const
    {
        return new (buffer.allocate(sizeof(*this)))
          ...
          Reference, Difference, Buffer>
{
  ...
  public:
    ...
    virtual any_random_access_iterator_wrapper *clone(
        typename any_random_access_iterator_wrapper::buffer_type &buffer) const
    {
        return new (buffer.allocate(sizeof(*this)))
