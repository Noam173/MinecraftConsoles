...
struct mutable_ : disable_if<is_const<T>, Iterator>
{
};
...
struct compatible_mutable_iterator : BOOST_RANGE_DETAIL_MICROSOFT_range_mutable_iterator<Range>
{
};
...
#define BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE_tag(Tag, Fullname)   \
    template <>                                                              \
    struct customization_tag<Fullname> : customization_tag_of<Tag, Fullname> \
    {                                                                        \
    };                                                                       \
    /**/
...
#define BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE_mutable_iterator(Fullname)                                               \
    template <>                                                                                                                  \
    struct BOOST_RANGE_DETAIL_MICROSOFT_range_mutable_iterator<Fullname> : range_detail_microsoft::mutable_iterator_of<Fullname> \
    {                                                                                                                            \
    };                                                                                                                           \
    /**/
...
#define BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE_const_iterator(Fullname)                \
    template <>                                                                                 \
    struct range_const_iterator<Fullname> : range_detail_microsoft::const_iterator_of<Fullname> \
    {                                                                                           \
    };                                                                                          \
    /**/
...
#define BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE_size_type(Fullname)      \
    template <>                                                                  \
    struct range_size<Fullname> : range_detail_microsoft::size_type_of<Fullname> \
    {                                                                            \
    };                                                                           \
    /**/
...
#define BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE_begin(Fullname)       \
    inline boost::range_detail_microsoft::mutable_iterator_of<Fullname>::type \
...
#define BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE_begin_const(Fullname) \
    inline boost::range_detail_microsoft::const_iterator_of<Fullname>::type   \
...
#define BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE_size(Fullname) \
    inline boost::range_detail_microsoft::size_type_of<Fullname>::type \
...
#define BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE_to_param_seq(ParamSeqOrCount) \
    BOOST_PP_IIF(BOOST_PP_IS_UNARY(ParamSeqOrCount),                                      \
                 ...
                 BOOST_PP_REPEAT)(ParamSeqOrCount, BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE_to_param_seq_op, ~) /**/
...
struct list_iterator : list_iterator_super<ListT, Value, Reference, Traversal>::type
{
  private:
  ...
  public:
    ...
    explicit list_iterator(ListT &lst, POSITION pos) : m_plst(boost::addressof(lst)), m_pos(pos)
    {
    }
    ...
    list_iterator(list_iterator<ListT_, Value_, Reference_, Traversal_> const &other) : m_plst(other.m_plst), m_pos(other.m_pos)
    {
    }
...
{
    return boost::distance(rng1) == boost::distance(rng2) &&
...
bool test_bidirectional(Range &rng)
{
    ...
    result = result && (test_equals)(boost::make_iterator_range(boost::rbegin(saved), boost::rend(saved)),
...
struct test_mutable_iter : boost::is_same<typename boost::BOOST_RANGE_DETAIL_MICROSOFT_range_mutable_iterator<Range>::type, Iter>
{
};

template <class Range, class Iter>
struct test_const_iter : boost::is_same<typename boost::range_const_iterator<Range>::type, Iter>
{
};
