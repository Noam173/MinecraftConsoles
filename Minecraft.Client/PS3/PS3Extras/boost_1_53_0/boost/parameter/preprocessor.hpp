...
struct unwrap_predicate
{
    ...
    enum
    {
        dummy = sizeof(msvc_store_predicate_type(f))
    };
...
struct argument_pack
{
    typedef typename make_arg_list<
        typename BOOST_PARAMETER_build_arg_list(
            BOOST_PARAMETER_MAX_ARITY, make_items, typename Parameters::parameter_spec, A)::type,
        typename Parameters::deduced_list, tag_keyword_arg, mpl::false_>::type result;
...
struct apply_predicate
{
    ...
    typedef typename mpl::if_<
        typename mpl::apply2<Predicate, T, Args>::type, char, int>::type type;
};
...
struct funptr_predicate
{
    ...
    static typename mpl::if_<
        is_convertible<T, P0>, char, int>::type
    check_predicate(type<T>, Args *, void *(*)(P0));
...
#define BOOST_PARAMETER_MEMBER_FUNCTION_NAME(name) \
    BOOST_PP_IF(                                   \
        BOOST_PARAMETER_MEMBER_FUNCTION_IS_STATIC(name), BOOST_PARAMETER_MEMBER_FUNCTION_STRIP_STATIC, name BOOST_PP_TUPLE_EAT(1))(name)
...
#define BOOST_PARAMETER_ARITY_RANGE_M(s, state, x) \
    BOOST_PP_CAT(                                  \
        BOOST_PARAMETER_ARITY_RANGE_M_, BOOST_PARAMETER_FN_ARG_QUALIFIER(x))(state)
/**/

#define BOOST_PARAMETER_ARITY_RANGE(args) \
    (                                     \
        BOOST_PP_SEQ_FOLD_LEFT(BOOST_PARAMETER_ARITY_RANGE_M, 0, args), BOOST_PP_INC(BOOST_PP_SEQ_SIZE(args)))
/**/
...
#define BOOST_PARAMETER_FUNCTION_KEYWORD(x) \
    BOOST_PP_IF(                            \
        BOOST_PARAMETER_FUNCTION_IS_KEYWORD_QUALIFIER(x), BOOST_PARAMETER_FUNCTION_KEYWORD_GET, x BOOST_PP_TUPLE_EAT(1))(x)
/**/
...
#define BOOST_PARAMETER_FUNCTION_FWD_MATCH_Z(z, name, parameters, n) \
    , typename boost::parameter::aux::match<                         \
          parameters, BOOST_PP_ENUM_PARAMS(n, ParameterArgumentType)>::type = parameters()
#else
#define BOOST_PARAMETER_FUNCTION_FWD_MATCH_Z(z, name, parameters, n)
#endif
/**/
...
#define BOOST_PARAMETER_FUNCTION_PARAMETERS_NAME(base) \
    BOOST_PP_CAT(                                      \
        boost_param_parameters_, BOOST_PP_CAT(__LINE__, BOOST_PARAMETER_MEMBER_FUNCTION_NAME(base)))

// Produce a name for a result type metafunction for the function
// named base
#define BOOST_PARAMETER_FUNCTION_RESULT_NAME(base) \
    BOOST_PP_CAT(                                  \
        boost_param_result_, BOOST_PP_CAT(__LINE__, BOOST_PARAMETER_MEMBER_FUNCTION_NAME(base)))
...
#define BOOST_PARAMETER_FUNCTION_FWD_FUNCTION00(z, n, r, data, elem)                                                                                                                                \
    BOOST_PP_IF(                                                                                                                                                                                    \
        n, BOOST_PARAMETER_FUNCTION_FWD_FUNCTION_TEMPLATE_Z, BOOST_PP_TUPLE_EAT(2))(z, n)                                                                                                           \
        BOOST_PARAMETER_MEMBER_FUNCTION_STATIC(BOOST_PP_TUPLE_ELEM(7, 3, data)) inline BOOST_PP_EXPR_IF(n, typename)                                                                                \
                ...
                BOOST_PP_EXPR_IF(n, typename)                                                                                                                                                       \
                    boost::parameter::aux::argument_pack<                                                                                                                                           \
                        BOOST_PARAMETER_FUNCTION_PARAMETERS_NAME(BOOST_PP_TUPLE_ELEM(7, 3, data))                                                                                                   \
                            BOOST_PP_COMMA_IF(n)                                                                                                                                                    \
                                BOOST_PP_IF(                                                                                                                                                        \
                                    n, BOOST_PP_SEQ_ENUM, BOOST_PP_TUPLE_EAT(1))(elem)>::type>::type                                                                                                \
            BOOST_PARAMETER_MEMBER_FUNCTION_NAME(BOOST_PP_TUPLE_ELEM(7, 3, data))(                                                                                                                  \
                BOOST_PP_IF(                                                                                                                                                                        \
                    ...
                    BOOST_PP_IF(n, BOOST_PARAMETER_FUNCTION_FWD_MATCH_Z, BOOST_PP_TUPLE_EAT(4))(                                                                                                    \
                        z, BOOST_PP_TUPLE_ELEM(7, 3, data), BOOST_PARAMETER_FUNCTION_PARAMETERS_NAME(BOOST_PP_TUPLE_ELEM(7, 3, data)), n)) BOOST_PP_EXPR_IF(BOOST_PP_TUPLE_ELEM(7, 4, data), const) \
    {                                                                                                                                                                                               \
...
#define BOOST_PARAMETER_FUNCTION_FWD_FUNCTION0(r, data, elem) \
    BOOST_PARAMETER_FUNCTION_FWD_FUNCTION00(                  \
        BOOST_PP_TUPLE_ELEM(7, 0, data), BOOST_PP_TUPLE_ELEM(7, 1, data), r, data, elem)
/**/

#define BOOST_PARAMETER_FUNCTION_FWD_FUNCTION_ARITY_0(z, n, data) \
    BOOST_PARAMETER_FUNCTION_FWD_FUNCTION00(                      \
        z, n, BOOST_PP_DEDUCE_R(), (z, n, BOOST_PP_TUPLE_REM(5) data), ~)
/**/

#define BOOST_PARAMETER_FUNCTION_FWD_FUNCTION_ARITY_N(z, n, data) \
    BOOST_PP_SEQ_FOR_EACH(                                        \
        BOOST_PARAMETER_FUNCTION_FWD_FUNCTION0, (z, n, BOOST_PP_TUPLE_REM(5) data), BOOST_PP_SEQ_FOR_EACH_PRODUCT(BOOST_PARAMETER_FUNCTION_FWD_PRODUCT, BOOST_PP_SEQ_FIRST_N(n, BOOST_PP_TUPLE_ELEM(5, 3, data))))
/**/

#define BOOST_PARAMETER_FUNCTION_FWD_FUNCTION(z, n, data) \
    BOOST_PP_IF(                                          \
        n, BOOST_PARAMETER_FUNCTION_FWD_FUNCTION_ARITY_N, BOOST_PARAMETER_FUNCTION_FWD_FUNCTION_ARITY_0)(z, n, data) /**/

#define BOOST_PARAMETER_FUNCTION_FWD_FUNCTIONS0(     \
    result, name, args, const_, combinations, range) \
    BOOST_PP_REPEAT_FROM_TO(                         \
        BOOST_PP_TUPLE_ELEM(2, 0, range), BOOST_PP_TUPLE_ELEM(2, 1, range), BOOST_PARAMETER_FUNCTION_FWD_FUNCTION, (result, name, const_, combinations, BOOST_PP_TUPLE_ELEM(2, 1, range)))
/**/
...
#define BOOST_PARAMETER_FUNCTION_PARAMETERS_M(r, tag_namespace, i, elem)                         \
    ...
    boost::parameter::BOOST_PP_CAT(                                                              \
        BOOST_PARAMETER_FUNCTION_PARAMETERS_QUALIFIER_, BOOST_PARAMETER_FN_ARG_QUALIFIER(elem))( \
        tag_namespace::BOOST_PARAMETER_FUNCTION_KEYWORD(                                         \
            BOOST_PARAMETER_FN_ARG_KEYWORD(elem))),                                              \
        typename boost::parameter::aux::unwrap_predicate<                                        \
            BOOST_PARAMETER_PREDICATE_TYPE(BOOST_PARAMETER_FN_ARG_PRED(elem))>::type >
...
#define BOOST_PARAMETER_FUNCTION_PARAMETERS(tag_namespace, base, args)                                                                                                                                               \
    ...
    struct BOOST_PP_CAT(                                                                                                                                                                                             \
        BOOST_PP_CAT(boost_param_params_, __LINE__), BOOST_PARAMETER_MEMBER_FUNCTION_NAME(base)) : boost::parameter::parameters<BOOST_PP_SEQ_FOR_EACH_I(BOOST_PARAMETER_FUNCTION_PARAMETERS_M, tag_namespace, args)> \
    {                                                                                                                                                                                                                \
    };                                                                                                                                                                                                               \
                                                                                                                                                                                                                     \
    typedef BOOST_PP_CAT(                                                                                                                                                                                            \
        BOOST_PP_CAT(boost_param_params_, __LINE__), BOOST_PARAMETER_MEMBER_FUNCTION_NAME(base))<int>

// Defines result type metafunction
#define BOOST_PARAMETER_FUNCTION_RESULT_ARG(z, _, i, x) \
    BOOST_PP_COMMA_IF(i)                                \
    class BOOST_PP_TUPLE_ELEM(3, 1, x)
/**/
...
#define BOOST_PARAMETER_FUNCTION_SPLIT_ARG_required(state, arg) \
    (                                                           \
        BOOST_PP_INC(BOOST_PP_TUPLE_ELEM(4, 0, state)), BOOST_PP_SEQ_PUSH_BACK(BOOST_PP_TUPLE_ELEM(4, 1, state), arg), BOOST_PP_TUPLE_ELEM(4, 2, state), BOOST_PP_TUPLE_ELEM(4, 3, state))
...
#define BOOST_PARAMETER_FUNCTION_SPLIT_ARG_optional(state, arg) \
    (                                                           \
        BOOST_PP_TUPLE_ELEM(4, 0, state), BOOST_PP_TUPLE_ELEM(4, 1, state), BOOST_PP_INC(BOOST_PP_TUPLE_ELEM(4, 2, state)), BOOST_PP_SEQ_PUSH_BACK(BOOST_PP_TUPLE_ELEM(4, 3, state), arg))
...
#define BOOST_PARAMETER_FUNCTION_SPLIT_ARG(s, state, arg) \
    BOOST_PP_CAT(                                         \
        BOOST_PARAMETER_FUNCTION_SPLIT_ARG_, BOOST_PARAMETER_FN_ARG_QUALIFIER(arg))(state, arg)

// Returns (required_count, required, optional_count, optionals) tuple
#define BOOST_PARAMETER_FUNCTION_SPLIT_ARGS(args) \
    BOOST_PP_SEQ_FOLD_LEFT(                       \
        BOOST_PARAMETER_FUNCTION_SPLIT_ARG, (0, BOOST_PP_SEQ_NIL, 0, BOOST_PP_SEQ_NIL), args)
...
#define BOOST_PARAMETER_FUNCTION_DEFAULT_NAME(name) \
    BOOST_PP_CAT(                                   \
        boost_param_default_, BOOST_PP_CAT(__LINE__, BOOST_PARAMETER_MEMBER_FUNCTION_NAME(name)))
...
#define BOOST_PARAMETER_FUNCTION_DEFAULT_ARGUMENTS(macro, n, split_args) \
    BOOST_PP_SEQ_FOR_EACH(                                               \
        macro, ~, BOOST_PP_TUPLE_ELEM(4, 1, split_args))                 \
    BOOST_PP_SEQ_FOR_EACH(                                               \
        macro, ~, BOOST_PP_SEQ_FIRST_N(BOOST_PP_SUB(BOOST_PP_TUPLE_ELEM(4, 2, split_args), n), BOOST_PP_TUPLE_ELEM(4, 3, split_args)))

// Generates a keyword | default expression.
#define BOOST_PARAMETER_FUNCTION_DEFAULT_EVAL_DEFAULT(arg, tag_namespace) \
    boost::parameter::keyword<                                            \
        tag_namespace::BOOST_PARAMETER_FN_ARG_KEYWORD(arg)>::instance |   \
        boost::parameter::aux::use_default_tag()

#define BOOST_PARAMETER_FUNCTION_DEFAULT_FUNCTION_GET_ARG(arg, tag_ns) \
    BOOST_PARAMETER_FUNCTION_CAST(                                     \
        args[BOOST_PARAMETER_FUNCTION_DEFAULT_EVAL_DEFAULT(            \
            arg, tag_ns)],                                             \
        BOOST_PARAMETER_FN_ARG_PRED(arg), Args)
...
#define BOOST_PARAMETER_FUNCTION_DEFAULT_FUNCTION_BODY(name, n, split_args, tag_namespace)                                                                                                                                                                                                                                                     \
    {                                                                                                                                                                                                                                                                                                                                          \
        return BOOST_PARAMETER_FUNCTION_DEFAULT_NAME(name)(                                                                                                                                                                                                                                                                                    \
            (ResultType (*)())0, args, 0L BOOST_PARAMETER_FUNCTION_DEFAULT_ARGUMENTS(BOOST_PARAMETER_FUNCTION_DEFAULT_FUNCTION_PARAMETER, n, split_args), BOOST_PARAMETER_FUNCTION_DEFAULT_FUNCTION_GET_ARG(BOOST_PP_SEQ_ELEM(BOOST_PP_SUB(BOOST_PP_TUPLE_ELEM(4, 2, split_args), n), BOOST_PP_TUPLE_ELEM(4, 3, split_args)), tag_namespace)); \
    }

#define BOOST_PARAMETER_FUNCTION_DEFAULT_EVAL_ACTUAL_DEFAULT(arg) \
    BOOST_PARAMETER_FUNCTION_CAST(                                \
        boost::parameter::aux::as_lvalue(BOOST_PARAMETER_FN_ARG_DEFAULT(arg), 0L), BOOST_PARAMETER_FN_ARG_PRED(arg), Args)
    ...
    template <                                                                                                                                                                                                                                                                                                                                                 \
        class ResultType, class Args                                                                                                                                                                                                                                                                                                                           \
                              BOOST_PARAMETER_FUNCTION_DEFAULT_ARGUMENTS(                                                                                                                                                                                                                                                                                      \
                                  BOOST_PARAMETER_FUNCTION_DEFAULT_FUNCTION_TEMPLATE_ARG, BOOST_PP_INC(n), split_args)>                                                                                                                                                                                                                                        \
    BOOST_PARAMETER_MEMBER_FUNCTION_STATIC(name)                                                                                                                                                                                                                                                                                                               \
    ResultType BOOST_PARAMETER_FUNCTION_DEFAULT_NAME(name)(                                                                                                                                                                                                                                                                                                    \
        ResultType (*)(), Args const &args, long BOOST_PARAMETER_FUNCTION_DEFAULT_ARGUMENTS(BOOST_PARAMETER_FUNCTION_DEFAULT_FUNCTION_ARG, BOOST_PP_INC(n), split_args), boost::parameter::aux::use_default_tag) BOOST_PP_EXPR_IF(const_, const)                                                                                                               \
    {                                                                                                                                                                                                                                                                                                                                                          \
        return BOOST_PARAMETER_FUNCTION_DEFAULT_NAME(name)(                                                                                                                                                                                                                                                                                                    \
            (ResultType (*)())0, args, 0L BOOST_PARAMETER_FUNCTION_DEFAULT_ARGUMENTS(BOOST_PARAMETER_FUNCTION_DEFAULT_FUNCTION_PARAMETER, BOOST_PP_INC(n), split_args), BOOST_PARAMETER_FUNCTION_DEFAULT_EVAL_ACTUAL_DEFAULT(BOOST_PP_SEQ_ELEM(BOOST_PP_SUB(BOOST_PP_TUPLE_ELEM(4, 2, split_args), BOOST_PP_INC(n)), BOOST_PP_TUPLE_ELEM(4, 3, split_args)))); \
    }
...
#define BOOST_PARAMETER_FUNCTION_DEFAULT_FUNCTION0(z, n, data)                                                                                                                                                                          \
    template <                                                                                                                                                                                                                          \
        class ResultType, class Args                                                                                                                                                                                                    \
                              BOOST_PARAMETER_FUNCTION_DEFAULT_ARGUMENTS(                                                                                                                                                               \
                                  BOOST_PARAMETER_FUNCTION_DEFAULT_FUNCTION_TEMPLATE_ARG, n, BOOST_PP_TUPLE_ELEM(5, 1, data))>                                                                                                          \
    ...
    ResultType BOOST_PARAMETER_FUNCTION_DEFAULT_NAME(BOOST_PP_TUPLE_ELEM(5, 0, data))(                                                                                                                                                  \
        ResultType (*)(), Args const &args, int BOOST_PARAMETER_FUNCTION_DEFAULT_ARGUMENTS(BOOST_PARAMETER_FUNCTION_DEFAULT_FUNCTION_ARG, n, BOOST_PP_TUPLE_ELEM(5, 1, data))) BOOST_PP_EXPR_IF(BOOST_PP_TUPLE_ELEM(5, 2, data), const) \
        BOOST_PP_IF(                                                                                                                                                                                                                    \
            n, BOOST_PARAMETER_FUNCTION_DEFAULT_FUNCTION_BODY, ; BOOST_PP_TUPLE_EAT(4))(                                                                                                                                                \
            BOOST_PP_TUPLE_ELEM(5, 0, data), n, BOOST_PP_TUPLE_ELEM(5, 1, data), BOOST_PP_TUPLE_ELEM(5, 3, data))

#define BOOST_PARAMETER_FUNCTION_DEFAULT_FUNCTION(z, n, data)                                                                                                          \
    BOOST_PP_IF(                                                                                                                                                       \
        BOOST_PP_AND(                                                                                                                                                  \
            BOOST_PP_NOT(n), BOOST_PP_TUPLE_ELEM(5, 4, data)),                                                                                                         \
        BOOST_PP_TUPLE_EAT(3), BOOST_PARAMETER_FUNCTION_DEFAULT_FUNCTION0)(z, n, data)                                                                                 \
        BOOST_PP_IF(                                                                                                                                                   \
            BOOST_PP_EQUAL(n, BOOST_PP_TUPLE_ELEM(4, 2, BOOST_PP_TUPLE_ELEM(5, 1, data))), BOOST_PP_TUPLE_EAT(5), BOOST_PARAMETER_FUNCTION_DEFAULT_EVAL_DEFAULT_BODY)( \
            BOOST_PP_TUPLE_ELEM(5, 0, data), n, BOOST_PP_TUPLE_ELEM(5, 1, data), BOOST_PP_TUPLE_ELEM(5, 3, data), BOOST_PP_TUPLE_ELEM(5, 2, data))

#define BOOST_PARAMETER_FUNCTION_DEFAULT_GET_ARG(r, tag_ns, arg) \
    , BOOST_PARAMETER_FUNCTION_CAST(                             \
          args[boost::parameter::keyword<tag_ns::BOOST_PARAMETER_FN_ARG_KEYWORD(arg)>::instance], BOOST_PARAMETER_FN_ARG_PRED(arg), Args)
...
#define BOOST_PARAMETER_FUNCTION_INITIAL_DISPATCH_FUNCTION(name, split_args, const_, tag_ns)                               \
    ...
    {                                                                                                                      \
        return BOOST_PARAMETER_FUNCTION_DEFAULT_NAME(name)(                                                                \
            (typename BOOST_PARAMETER_FUNCTION_RESULT_NAME(name) < Args > ::type (*)())0, args, 0L                         \
                                                                                                                           \
            BOOST_PP_SEQ_FOR_EACH(BOOST_PARAMETER_FUNCTION_DEFAULT_GET_ARG, tag_ns, BOOST_PP_TUPLE_ELEM(4, 1, split_args)) \
                                                                                                                           \
        );                                                                                                                 \
    }
...
#define BOOST_PARAMETER_FUNCTION_DEFAULT_LAYER_AUX(                                                                                                                  \
    ...
    BOOST_PP_REPEAT_FROM_TO(                                                                                                                                         \
        0, BOOST_PP_INC(BOOST_PP_TUPLE_ELEM(4, 2, split_args)), BOOST_PARAMETER_FUNCTION_DEFAULT_FUNCTION, (name, split_args, const_, tag_namespace, skip_fwd_decl)) \
                                                                                                                                                                     \
    ...
    template <                                                                                                                                                       \
        class ResultType, class Args                                                                                                                                 \
                              BOOST_PARAMETER_FUNCTION_DEFAULT_ARGUMENTS(                                                                                            \
                                  BOOST_PARAMETER_FUNCTION_DEFAULT_FUNCTION_TEMPLATE_ARG, 0, split_args)>                                                            \
    BOOST_PARAMETER_MEMBER_FUNCTION_STATIC(name)                                                                                                                     \
    ResultType BOOST_PARAMETER_FUNCTION_DEFAULT_NAME(name)(                                                                                                          \
        ResultType (*)(), Args const &args, int BOOST_PARAMETER_FUNCTION_DEFAULT_ARGUMENTS(BOOST_PARAMETER_FUNCTION_DEFAULT_FUNCTION_ARG, 0, split_args)) BOOST_PP_EXPR_IF(const_, const)
...
#define BOOST_PARAMETER_FUNCTION_AUX(result, name, tag_namespace, args)         \
    ...
    BOOST_PARAMETER_FUNCTION_FWD_FUNCTIONS(                                     \
        result, name, args, 0, BOOST_PARAMETER_FUNCTION_FWD_COMBINATIONS(args)) \
                                                                                \
...
#define BOOST_PARAMETER_BASIC_MEMBER_FUNCTION_AUX(result, name, tag_namespace, args, const_) \
    BOOST_PARAMETER_FUNCTION_HEAD(result, name, tag_namespace, args)                         \
                                                                                             \
    BOOST_PARAMETER_FUNCTION_FWD_FUNCTIONS(                                                  \
        result, name, args, const_, BOOST_PARAMETER_FUNCTION_FWD_COMBINATIONS(args))         \
                                                                                             \
    BOOST_PARAMETER_FUNCTION_IMPL_HEAD(name)                                                 \
...
#define BOOST_PARAMETER_BASIC_MEMBER_FUNCTION(result, name, tag_namespace, args) \
    BOOST_PARAMETER_BASIC_MEMBER_FUNCTION_AUX(                                   \
        result, name, tag_namespace, BOOST_PARAMETER_FLATTEN(2, 2, 3, args), 0)
/**/

#define BOOST_PARAMETER_BASIC_CONST_MEMBER_FUNCTION(result, name, tag_namespace, args) \
    BOOST_PARAMETER_BASIC_MEMBER_FUNCTION_AUX(                                         \
        result, name, tag_namespace, BOOST_PARAMETER_FLATTEN(2, 2, 3, args), 1)
/**/
...
#define BOOST_PARAMETER_MEMBER_FUNCTION(result, name, tag_namespace, args)      \
    BOOST_PARAMETER_MEMBER_FUNCTION_AUX(                                        \
        result, name, tag_namespace, 0, BOOST_PARAMETER_FLATTEN(3, 2, 3, args)) \
    /**/

#define BOOST_PARAMETER_CONST_MEMBER_FUNCTION(result, name, tag_namespace, args) \
    BOOST_PARAMETER_MEMBER_FUNCTION_AUX(                                         \
        result, name, tag_namespace, 1, BOOST_PARAMETER_FLATTEN(3, 2, 3, args))  \
    /**/
        ...
        BOOST_PP_EXPR_IF(BOOST_PP_EQUAL(n, 1), explicit)                                                        \
            BOOST_PP_TUPLE_ELEM(6, 2, data)(                                                                    \
                BOOST_PP_IF(                                                                                    \
                    ...
                    r, BOOST_PARAMETER_FUNCTION_ARGUMENT, ~, elem)                                              \
                    BOOST_PP_IF(n, BOOST_PARAMETER_FUNCTION_FWD_MATCH_Z, BOOST_PP_TUPLE_EAT(4))(                \
                        z, BOOST_PP_TUPLE_ELEM(6, 3, data), BOOST_PP_CAT(constructor_parameters, __LINE__), n)) \
...
#define BOOST_PARAMETER_FUNCTION_FWD_CONSTRUCTOR0(r, data, elem) \
    BOOST_PARAMETER_FUNCTION_FWD_CONSTRUCTOR00(                  \
        BOOST_PP_TUPLE_ELEM(6, 0, data), BOOST_PP_TUPLE_ELEM(6, 1, data), r, data, elem)
/**/
...
#define BOOST_PARAMETER_FUNCTION_FWD_CONSTRUCTOR_ARITY_0(z, n, data) \
    BOOST_PARAMETER_FUNCTION_FWD_CONSTRUCTOR00(                      \
        z, n, BOOST_PP_DEDUCE_R(), (z, n, BOOST_PP_TUPLE_REM(4) data), ~)
/**/

#define BOOST_PARAMETER_FUNCTION_FWD_CONSTRUCTOR_ARITY_N(z, n, data) \
    BOOST_PP_SEQ_FOR_EACH(                                           \
        BOOST_PARAMETER_FUNCTION_FWD_CONSTRUCTOR0, (z, n, BOOST_PP_TUPLE_REM(4) data), BOOST_PP_SEQ_FOR_EACH_PRODUCT(BOOST_PARAMETER_FUNCTION_FWD_PRODUCT, BOOST_PP_SEQ_FIRST_N(n, BOOST_PP_TUPLE_ELEM(4, 2, data))))
/**/

#define BOOST_PARAMETER_FUNCTION_FWD_CONSTRUCTOR(z, n, data) \
    BOOST_PP_IF(                                             \
        n, BOOST_PARAMETER_FUNCTION_FWD_CONSTRUCTOR_ARITY_N, BOOST_PARAMETER_FUNCTION_FWD_CONSTRUCTOR_ARITY_0)(z, n, data) /**/

#define BOOST_PARAMETER_FUNCTION_FWD_CONSTRUCTORS0(class_, base, args, combinations, range) \
    BOOST_PP_REPEAT_FROM_TO(                                                                \
        BOOST_PP_TUPLE_ELEM(2, 0, range), BOOST_PP_TUPLE_ELEM(2, 1, range), BOOST_PARAMETER_FUNCTION_FWD_CONSTRUCTOR, (class_, base, combinations, BOOST_PP_TUPLE_ELEM(2, 1, range)))
/**/
...
#define BOOST_PARAMETER_CONSTRUCTOR_AUX(class_, base, tag_namespace, args)   \
    ...
    BOOST_PARAMETER_FUNCTION_FWD_CONSTRUCTORS(                               \
        class_, base, args, BOOST_PARAMETER_FUNCTION_FWD_COMBINATIONS(args)) \
    /**/
...
#define BOOST_PARAMETER_FUNCTION_FWD_COMBINATION(r, _, i, elem) \
    (BOOST_PP_IF(                                               \
        ...
        (const ParameterArgumentType##i)(ParameterArgumentType##i), (const ParameterArgumentType##i)))
...
#define BOOST_PARAMETER_FUNCTION_FWD_COMBINATION(r, _, i, elem) \
    (BOOST_PP_IF(                                               \
        BOOST_PARAMETER_FUNCTION_IS_KEYWORD_QUALIFIER(          \
            BOOST_PARAMETER_FN_ARG_NAME(elem)),                 \
        (ParameterArgumentType##i), (const ParameterArgumentType##i)))
