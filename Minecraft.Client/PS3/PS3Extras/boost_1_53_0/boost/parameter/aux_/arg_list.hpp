...
#if BOOST_WORKAROUND(BOOST_MSVC, <= 1300) || (BOOST_WORKAROUND(__GNUC__, < 3)) || BOOST_WORKAROUND(__BORLANDC__, BOOST_TESTED_AT(0x564))
...
struct arg_list : Next
{
    ...
    typedef typename mpl::eval_if<
        holds_maybe, get_reference<typename TaggedArg::value_type>, get_reference<TaggedArg>>::type reference;

    typedef typename mpl::if_<
        holds_maybe, reference, typename TaggedArg::value_type>::type value_type;
    ...
    arg_list( // A0& a0, A1& a1, ...
        ...
        : Next( // a1, a2, ...
              BOOST_PP_ENUM_SHIFTED_PARAMS(BOOST_PARAMETER_MAX_ARITY, a), void_reference()),
          arg(a0)
    {
    }
    ...
    struct binding
    {
        ...
        {
            typedef typename mpl::eval_if<
                boost::is_same<KW, key_type>, mpl::if_<Reference, reference, value_type>, mpl::apply_wrap3<typename Next::binding, KW, Default, Reference>>::type type;
        };
    };
...
#define BOOST_PARAMETER_CALL_HAS_KEY(next, key) next::has_key((key *)0)
    ...
    BOOST_MPL_ASSERT_MSG(
        sizeof(BOOST_PARAMETER_CALL_HAS_KEY(Next, key_type)) == sizeof(no_tag), duplicate_keyword, (key_type));
...
#undef BOOST_PARAMETER_CALL_HAS_KEY
    ...
    struct key_owner
    {
        ...
        {
            typedef typename mpl::eval_if<
                boost::is_same<KW, key_type>, mpl::identity<arg_list<TaggedArg, Next>>, mpl::apply_wrap1<typename Next::key_owner, KW>>::type type;
        };
    };
    ...
    typename mpl::apply_wrap3<
        binding, KW, typename result_of0<F>::type, mpl::true_>::type
    ...
    static typename mpl::apply_wrap2<
        typename mpl::lambda<Predicate, lambda_tag>::type, value_type, ArgPack>::type
    satisfies(
