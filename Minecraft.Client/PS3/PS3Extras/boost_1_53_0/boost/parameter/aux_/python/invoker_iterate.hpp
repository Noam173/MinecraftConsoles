...
#define BOOST_PARAMETER_PY_ARG_TYPES(z, n, _)                                                                                          \
    ...
    typedef typename mpl::if_<                                                                                                         \
        mpl::and_<                                                                                                                     \
            mpl::not_<typename BOOST_PP_CAT(spec, n)::required>, typename BOOST_PP_CAT(spec, n)::optimized_default>,                   \
        parameter::aux::maybe<typename BOOST_PP_CAT(spec, n)::type>, typename BOOST_PP_CAT(spec, n)::type>::type BOOST_PP_CAT(arg, n); \
...
#endif
{
    ...
    typedef typename mpl::if_<
        mpl::and_<
            mpl::not_<typename spec0::required>, typename spec0::optimized_default>,
        parameter::aux::maybe<typename spec0::type>, typename spec0::type>::type arg0;
