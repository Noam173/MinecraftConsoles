...
template <class T, class NodeTraits, typename NodeTraits::node T::*PtrToMember, link_mode_type LinkMode = safe_link>
struct member_value_traits
{
  public:
    ...
    {
        return pointer(detail::parent_from_member<value_type, node>(boost::intrusive::detail::to_raw_pointer(n), PtrToMember));
    }
