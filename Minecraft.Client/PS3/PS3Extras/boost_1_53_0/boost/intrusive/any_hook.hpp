...
struct make_any_base_hook
{
    ...
    typedef detail::generic_hook<get_any_node_algo<typename packed_options::void_pointer>, typename packed_options::tag, packed_options::link_mode, detail::AnyBaseHook> implementation_defined;
    /// @endcond
...
struct make_any_member_hook
{
    ...
    typedef detail::generic_hook<get_any_node_algo<typename packed_options::void_pointer>, member_tag, packed_options::link_mode, detail::NoBaseHook> implementation_defined;
    /// @endcond
    typedef implementation_defined type;
};
...
{
    typedef typename pointer_traits<typename ValueTraits::boost_intrusive_tags::node_traits::node_ptr>::template rebind_pointer<void>::type type;
};

template <class ValueTraits>
struct any_to_get_member_pointer_type
{
    typedef typename pointer_traits<typename ValueTraits::node_ptr>::template rebind_pointer<void>::type type;
};
...
struct any_to_some_hook
{
    ...
    struct pack : public Base
    {
        struct value_traits : public old_value_traits
        {
            ...
            typedef typename detail::eval_if_c<detail::internal_base_hook_bool_is_true<old_value_traits>::value, any_to_get_base_pointer_type<old_value_traits>, any_to_get_member_pointer_type<old_value_traits>>::type void_pointer;
