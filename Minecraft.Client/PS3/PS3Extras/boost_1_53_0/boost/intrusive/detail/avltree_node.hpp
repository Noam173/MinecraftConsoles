...
{
    typedef typename pointer_traits<VoidPointer>::template rebind_pointer<compact_avltree_node<VoidPointer>>::type node_ptr;
    enum balance
    {
        negative_t,
        zero_t,
...
struct avltree_node
{
    typedef typename pointer_traits<VoidPointer>::template rebind_pointer<avltree_node<VoidPointer>>::type node_ptr;
    enum balance
    {
        negative_t,
        zero_t,
...
struct avltree_node_traits
    : public avltree_node_traits_dispatch<VoidPointer, OptimizeSize &&
                                                           max_pointer_plus_bits<VoidPointer, detail::alignment_of<compact_avltree_node<VoidPointer>>::value>::value >= 2u>
{
};
