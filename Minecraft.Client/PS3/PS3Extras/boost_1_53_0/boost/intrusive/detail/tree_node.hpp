...
struct tree_node
{
    typedef typename pointer_traits<VoidPointer>::template rebind_pointer<tree_node<VoidPointer>>::type node_ptr;
    ...
    : public std::iterator<std::bidirectional_iterator_tag, typename Container::value_type, typename Container::difference_type, typename detail::if_c<IsConst, typename Container::const_pointer, typename Container::pointer>::type, typename detail::if_c<IsConst, typename Container::const_reference, typename Container::reference>::type>
{
  protected:
    ...
    typedef typename pointer_traits<node_ptr>::template rebind_pointer<void>::type void_pointer;
  ...
  private:
    struct members
        : public detail::select_constptr<void_pointer, store_container_ptr>::type
    {
        typedef typename detail::select_constptr<void_pointer, store_container_ptr>::type Base;
