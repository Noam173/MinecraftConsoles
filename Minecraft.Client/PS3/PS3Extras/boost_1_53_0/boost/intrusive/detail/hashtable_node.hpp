...
template <int Dummy>
const std::size_t prime_list_holder<Dummy>::prime_list_size = sizeof(prime_list) / sizeof(std::size_t);
...
struct bucket_traits_impl
{
  ...
  public:
    ...
    typedef typename pointer_traits<typename Slist::pointer>::template rebind_pointer<bucket_impl<Slist>>::type bucket_ptr;
...
class hashtable_iterator
    : public std::iterator<std::forward_iterator_tag, typename Container::value_type, typename pointer_traits<typename Container::value_type *>::difference_type, typename detail::add_const_if_c<typename Container::value_type, IsConst>::type *, typename detail::add_const_if_c<typename Container::value_type, IsConst>::type &>
{
    ...
    typedef typename pointer_traits<typename Container::pointer>::template rebind_pointer<const Container>::type const_cont_ptr;
  ...
  public:
    ...
    typedef typename detail::add_const_if_c<typename Container::value_type, IsConst>::type *pointer;
    typedef typename detail::add_const_if_c<typename Container::value_type, IsConst>::type &reference;
  ...
  public:
    ...
    {
        return boost::intrusive::detail::to_raw_pointer(this->get_real_value_traits()->to_value_ptr(downcast_bucket(slist_it_.pointed_node())));
    }
  ...
  private:
    void increment()
    {
            ...
            slist_it_.pointed_node() <= buckets[buckets_len].cend().pointed_node())
        {
            ...
            const bucket_type &b = static_cast<const bucket_type &>(bucket_type::slist_type::container_from_end_iterator(slist_it_));
