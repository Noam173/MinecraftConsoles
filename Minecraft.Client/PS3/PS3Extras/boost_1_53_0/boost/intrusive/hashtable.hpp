...
template <class UsetOpt, std::size_t BoolMask>
struct usetopt_mask
{
    typedef usetopt<typename UsetOpt::value_traits, typename UsetOpt::hash, typename UsetOpt::equal, typename UsetOpt::size_type, typename UsetOpt::bucket_traits, UsetOpt::bool_flags & BoolMask> type;
};
...
{
    template <class U>
    static detail::one test(...);
    template <class U>
    static detail::two test(typename U::reduced_slist_node_traits * = 0);
...
{
    typedef typename detail::eval_if_c<hash_reduced_slist_node_traits<NodeTraits>::value, apply_reduced_slist_node_traits<NodeTraits>, detail::identity<NodeTraits>>::type type;
};
...
struct get_slist_impl
{
    ...
    struct type : make_slist<typename NodeTraits::node, boost::intrusive::value_traits<trivial_traits>, boost::intrusive::constant_time_size<false>, boost::intrusive::size_type<typename boost::make_unsigned<typename pointer_traits<typename NodeTraits::node_ptr>::difference_type>::type>>::type
    {
    };
};
...
{
    typedef typename detail::eval_if_c<detail::external_value_traits_bool_is_true<SupposedValueTraits>::value, detail::eval_value_traits<SupposedValueTraits>, detail::identity<SupposedValueTraits>>::type type;
};

template <class SupposedValueTraits>
struct get_slist_impl_from_supposed_value_traits
{
    typedef typename real_from_supposed_value_traits<SupposedValueTraits>::type real_value_traits;
    typedef typename detail::get_node_traits<real_value_traits>::type node_traits;
    typedef typename get_slist_impl<typename reduced_slist_node_traits<node_traits>::type>::type type;
};

template <class SupposedValueTraits>
struct unordered_bucket_impl
{
    typedef typename get_slist_impl_from_supposed_value_traits<SupposedValueTraits>::type slist_impl;
...
{
    typedef typename detail::get_node_traits<SupposedValueTraits>::type::node_ptr node_ptr;
    typedef typename unordered_bucket_impl<SupposedValueTraits>::type bucket_type;

    typedef typename pointer_traits<node_ptr>::template rebind_pointer<bucket_type>::type implementation_defined;
    typedef implementation_defined type;
};
...
struct store_hash_bool
{
    ...
    static one test(...);
    template <class U>
    static two_or_three<U::store_hash> test(int);
...
struct optimize_multikey_bool
{
    ...
    static one test(...);
    template <class U>
    static two_or_three<U::optimize_multikey> test(int);
    static const std::size_t value = sizeof(test<T>(0));
};
...
struct bucket_plus_size
    : public detail::size_holder // size_traits
      <0 != (Config::bool_flags & hash_bool_flags::constant_time_size_pos), typename Config::size_type>
{
    typedef detail::size_holder<0 != (Config::bool_flags & hash_bool_flags::constant_time_size_pos), typename Config::size_type> size_traits;
    ...
    : public detail::ebo_functor_holder<typename Config::equal>
{
    ...
    typedef typename Config::hash hasher;
    typedef typename Config::bucket_traits bucket_traits;
    typedef typename unordered_bucket_ptr_impl<typename Config::value_traits>::type bucket_ptr;
...
struct hashtable_data_t : public Config::value_traits
{
    ...
    template <class BucketTraits>
    hashtable_data_t(BOOST_FWD_REF(BucketTraits) b_traits, const hasher &h, const equal &e, const value_traits &val_traits)
        : Config::value_traits(val_traits) // value_traits
          ,
          internal_(::boost::forward<BucketTraits>(b_traits), h, e)
    {
    }
    typedef typename detail::usetopt_mask<Config, detail::hash_bool_flags::constant_time_size_pos | detail::hash_bool_flags::incremental_pos>::type masked_config_t;
    struct internal
        : public detail::size_holder // split_traits
          <0 != (Config::bool_flags & hash_bool_flags::incremental_pos), typename Config::size_type>
    {
        template <class BucketTraits>
        ...
        bucket_hash_equal_t<masked_config_t, 0 != (bool_flags & hash_bool_flags::cache_begin_pos)> bucket_hash_equal_;
    } internal_;
};
...
struct group_functions
{
    ...
    typedef typename reduced_slist_node_traits<node_traits>::type reduced_node_traits;
    ...
    static slist_node_ptr get_bucket_before_begin(const slist_node_ptr &bucket_beg, const slist_node_ptr &bucket_end, const node_ptr &p)
    {
    ...
    static slist_node_ptr get_previous_and_next_in_group(const slist_node_ptr &i, node_ptr &nxt_in_group
                                                         ...
                                                         const slist_node_ptr &first_end_ptr, const slist_node_ptr &last_end_ptr)
    {
        ...
        if (first_in_group)
        {
            ...
            {
                bucket_node = group_functions::get_bucket_before_begin(first_end_ptr, last_end_ptr, start_pos);
            }
            else
            {
...
class incremental_rehash_rollback
{
  ...
  public:
    incremental_rehash_rollback(bucket_type &source_bucket, bucket_type &destiny_bucket, split_traits &split_traits)
        : source_bucket_(source_bucket), destiny_bucket_(destiny_bucket), split_traits_(split_traits), released_(false)
    {
    }
...
struct unordered_bucket_ptr
    : public detail::unordered_bucket_ptr_impl<typename ValueTraitsOrHookOption::
                                                   template pack<none>::value_traits>
{
};
...
struct unordered_default_bucket_traits
{
    ...
    typedef typename detail::
        get_slist_impl_from_supposed_value_traits<supposed_value_traits>::type slist_impl;
    typedef detail::bucket_traits_impl<slist_impl> implementation_defined;
    typedef implementation_defined type;
};
...
struct uset_defaults
    : pack_options<none, base_hook<detail::default_uset_hook>, constant_time_size<true>, size_type<std::size_t>, equal<std::equal_to<T>>, hash<boost::hash<T>>, bucket_traits<default_bucket_traits>, power_2_buckets<false>, cache_begin<false>, compare_hash<false>, incremental<false>>::type
{
};
    ...
    : private detail::clear_on_destructor_base<hashtable_impl<Config>>
{
  ...
  public:
    ...
    typedef typename detail::eval_if_c<external_value_traits, detail::eval_value_traits<value_traits>, detail::identity<value_traits>>::type real_value_traits;
    typedef typename Config::bucket_traits bucket_traits;
    static const bool external_bucket_traits =
        detail::external_bucket_traits_bool_is_true<bucket_traits>::value;
    typedef typename detail::eval_if_c<external_bucket_traits, detail::eval_bucket_traits<bucket_traits>, detail::identity<bucket_traits>>::type real_bucket_traits;
    typedef typename detail::get_slist_impl<typename detail::reduced_slist_node_traits<typename real_value_traits::node_traits>::type>::type slist_impl;
    /// @endcond
    ...
    typedef typename pointer_traits<pointer>::template rebind_pointer<bucket_type>::type bucket_ptr;
    ...
    typedef typename node_traits::node node;
    typedef typename pointer_traits<pointer>::template rebind_pointer<node>::type node_ptr;
    typedef typename pointer_traits<pointer>::template rebind_pointer<const node>::type const_node_ptr;
  ...
  private:
    ...
    typedef typename pointer_traits<slist_node_ptr>::template rebind_pointer<void>::type void_pointer;
    ...
    static const std::size_t hashtable_data_bool_flags_mask =
        (detail::hash_bool_flags::cache_begin_pos | detail::hash_bool_flags::constant_time_size_pos | detail::hash_bool_flags::incremental_pos);
    typedef typename detail::usetopt_mask<Config, hashtable_data_bool_flags_mask>::type masked_config_t;
        ...
        : public detail::node_to_value<hashtable_impl, IsConst>
    {
        ...
        typedef typename detail::add_const_if_c<typename slist_impl::node, IsConst>::type &first_argument_type;
        typedef typename detail::add_const_if_c<node, IsConst>::type &intermediate_argument_type;
  ...
  public:
    ...
    typedef detail::transform_iterator<typename slist_impl::iterator, downcast_node_to_value<false>> local_iterator;
  ...
  public:
    ...
    //!   *this is disposed.
    explicit hashtable_impl(const bucket_traits &b_traits, const hasher &hash_func = hasher(), const key_equal &equal_func = key_equal(), const value_traits &v_traits = value_traits())
        : data_(b_traits, hash_func, equal_func, v_traits)
    {
        ...
        BOOST_INTRUSIVE_INVARIANT_ASSERT(!power_2_buckets || (0 == (bucket_sz & (bucket_sz - 1))));
    ...
    hashtable_impl(BOOST_RV_REF(hashtable_impl) x)
        : data_(::boost::move(x.priv_bucket_traits()), ::boost::move(x.priv_hasher()), ::boost::move(x.priv_equal()), ::boost::move(x.priv_value_traits()))
    {
    ...
    void clone_from(const hashtable_impl &src, Cloner cloner, Disposer disposer)
    {
        ...
        if (!constant_time_size || !src.empty())
        {
            ...
            // Check power of two bucket array if the option is activated
            BOOST_INTRUSIVE_INVARIANT_ASSERT(!power_2_buckets || (0 == (src_bucket_count & (src_bucket_count - 1))));
            BOOST_INTRUSIVE_INVARIANT_ASSERT(!power_2_buckets || (0 == (dst_bucket_count & (dst_bucket_count - 1))));
            ...
            if (!incremental && (src_bucket_count >= dst_bucket_count))
            {
                ...
                for (constructed = 0; constructed < dst_bucket_count; ++constructed)
                {
                    dst_buckets[constructed].clone_from(src_buckets[constructed], NodeCloner(cloner, this), node_disp);
                }
                if (src_bucket_count != dst_bucket_count)
                {
                    // Now insert the remaining ones using the modulo trick
                    for ( //"constructed" comes from the previous loop
                        ; constructed < src_bucket_count; ++constructed)
                    {
                        bucket_type &dst_b =
    ...
    iterator insert_equal(reference value)
    {
        ...
        siterator prev;
        siterator it = this->priv_find(value, this->priv_hasher(), this->priv_equal(), bucket_num, hash_value, prev);
    ...
    std::pair<iterator, bool> insert_unique(reference value)
    {
        ...
        std::pair<iterator, bool> ret = this->insert_unique_check(value, this->priv_hasher(), this->priv_equal(), commit_data);
        if (!ret.second)
        {
            return ret;
        }
    ...
    void erase_and_dispose(const_iterator b, const_iterator e, Disposer disposer)
    {
        if (b != e)
        {
            ...
            siterator before_first_local_it = this->priv_get_previous(buck_ptr[first_bucket_num], first_local_it);
    ...
    size_type erase_and_dispose(const KeyType &key, KeyHasher hash_func, KeyValueEqual equal_func, Disposer disposer)
    {
        ...
        {
            siterator last = bucket_type::s_iterator_to(*node_traits::get_next(group_functions_t::get_last_in_group(hashtable_impl::dcast_bucket_ptr(it.pointed_node()), optimize_multikey_t())));
    ...
    {
        size_type bucket_n1, bucket_n2, cnt;
        std::pair<siterator, siterator> ret = this->priv_equal_range(key, hash_func, equal_func, bucket_n1, bucket_n2, cnt);
    ...
    void rehash(const bucket_traits &new_bucket_traits)
    {
        ...
        // Check power of two bucket array if the option is activated
        BOOST_INTRUSIVE_INVARIANT_ASSERT(!power_2_buckets || (0 == (new_bucket_count & (new_bucket_count - 1u))));
        ...
        for (; n < old_bucket_count; ++n)
        {
            ...
            if (!fast_shrink)
            {
                ...
                for (; i != end_sit; ++i)
                {
                    ...
                    siterator last = bucket_type::s_iterator_to(*group_functions_t::get_last_in_group(hashtable_impl::dcast_bucket_ptr(i.pointed_node()), optimize_multikey_t()));
            ...
            else
            {
                ...
                if (!old_bucket.empty())
                {
                    new_b.splice_after(new_b.before_begin(), old_bucket, old_bucket.before_begin(), hashtable_impl::priv_get_last(old_bucket));
                }
            }
        }
    ...
    bool incremental_rehash(bool grow = true)
    {
        ...
        if (grow)
        {
            ...
            detail::incremental_rehash_rollback<bucket_type, split_traits> rollback(buck_ptr[split_idx], old_bucket, this->priv_split_traits());
            for (; i != end_sit; ++i)
            {
                const value_type &v = this->priv_value_from_slist_node(i.pointed_node());
                const std::size_t hash_value = this->priv_stored_or_compute_hash(v, store_hash_t());
  ...
  private:
    ...
    template <class Disposer>
    void priv_erase_range_impl(size_type bucket_num, siterator before_first_it, siterator end_sit, Disposer disposer, size_type &num_erased)
    {
    ...
    template <class Disposer>
    void priv_erase_range_impl(size_type first_bucket_num, size_type num_buckets, Disposer disposer, size_type &num_erased)
    {
        ...
        for (size_type i = first_bucket_num; i < (num_buckets + first_bucket_num); ++i)
        {
            ...
            while (nxt != end_sit)
            {
                ...
                nxt = b.erase_after_and_dispose(b_begin, make_node_disposer(disposer));
                this->priv_size_traits().decrement();
                ++num_erased;
            }
        }
    ...
    template <class Disposer>
    void priv_erase_range(siterator before_first_it, size_type first_bucket, siterator last_it, size_type last_bucket, Disposer disposer)
    {
    ...
    {
        return this->priv_hash_to_bucket(this->priv_stored_hash(it.pointed_node(), store_hash_t()));
    }
    ...
    std::size_t priv_get_bucket_num_no_hash_store(siterator it, detail::true_)
    {
        ...
        slist_node_ptr bb = group_functions_t::get_bucket_before_begin(f->end().pointed_node(), l->end().pointed_node(), hashtable_impl::dcast_bucket_ptr(it.pointed_node()));
        // Now get the bucket_impl from the iterator
        const bucket_type &b = static_cast<const bucket_type &>(bucket_type::slist_type::container_from_end_iterator(bucket_type::s_iterator_to(*bb)));
    ...
    std::size_t priv_get_bucket_num_no_hash_store(siterator it, detail::false_)
    {
        ...
        slist_node_ptr first_ptr(f->cend().pointed_node()), last_ptr(l->cend().pointed_node());
        ...
        // Now get the bucket_impl from the iterator
        const bucket_type &b = static_cast<const bucket_type &>(bucket_type::container_from_end_iterator(it));

        // Now just calculate the index b has in the bucket array
        return static_cast<std::size_t>(&b - &*f);
    }

    siterator priv_get_previous(bucket_type &b, siterator i)
    {
        return this->priv_get_previous(b, i, optimize_multikey_t());
    }

    siterator priv_get_previous(bucket_type &b, siterator i, detail::true_)
    {
    ...
    siterator priv_get_previous(bucket_type &b, siterator i, detail::false_)
    {
        return b.previous(i);
    }
    ...
    void priv_erase(const_iterator i, Disposer disposer, detail::true_)
    {
        ...
        if (store_hash)
        {
            f_bucket_end = l_bucket_end =
                (this->priv_bucket_pointer()
                     [this->priv_hash_to_bucket(this->priv_stored_hash(elem, store_hash_t()))])
                    .before_begin()
                    .pointed_node();
        }
        else
        ...
        siterator prev = bucket_type::s_iterator_to(*group_functions_t::get_previous_and_next_in_group(elem, nxt_in_group, f_bucket_end, l_bucket_end));
    ...
    void priv_erasure_update_cache(detail::true_)
    {
        ...
        else
        {
            ...
            for (const size_type num_buckets = this->priv_bucket_count(); current_n < num_buckets; ++current_n, ++this->data_.internal_.bucket_hash_equal_.cached_begin_)
            {
    ...
    {
        std::swap(this->data_.internal_.bucket_hash_equal_.cached_begin_, other.data_.internal_.bucket_hash_equal_.cached_begin_);
    }
    ...
    {
        this->priv_clear_buckets(this->priv_get_cache(), this->priv_bucket_count() - (this->priv_get_cache() - this->priv_bucket_pointer()));
    }
    ...
    template <class KeyType, class KeyHasher, class KeyValueEqual>
    siterator priv_find(const KeyType &key, KeyHasher hash_func, KeyValueEqual equal_func, size_type &bucket_number, std::size_t &h, siterator &previt) const
    {
        h = hash_func(key);
    ...
    siterator priv_find_with_hash(const KeyType &key, KeyValueEqual equal_func, size_type &bucket_number, const std::size_t h, siterator &previt) const
    {
        ...
        while (it != b.end())
        {
            ...
            {
                previt = bucket_type::s_iterator_to(*group_functions_t::get_last_in_group(hashtable_impl::dcast_bucket_ptr(it.pointed_node()), optimize_multikey_t()));
                it = previt;
            }
            else
            {
    ...
    iterator priv_insert_equal_with_hash(reference value, std::size_t hash_value)
    {
        size_type bucket_num;
        siterator prev;
        siterator it = this->priv_find_with_hash(value, this->priv_equal(), bucket_num, hash_value, prev);
        return this->priv_insert_equal_find(value, bucket_num, hash_value, it);
    }
    ...
    iterator priv_insert_equal_find(reference value, size_type bucket_num, std::size_t hash_value, siterator it)
    {
        ...
        if (optimize_multikey)
        {
            node_ptr first_in_group = found_equal ? hashtable_impl::dcast_bucket_ptr(it.pointed_node()) : node_ptr();
    ...
    template <class KeyType, class KeyHasher, class KeyValueEqual>
    std::pair<siterator, siterator> priv_equal_range(const KeyType &key, KeyHasher hash_func, KeyValueEqual equal_func, size_type &bucket_number_first, size_type &bucket_number_second, size_type &cnt) const
    {
        std::size_t h;
        cnt = 0;
        siterator prev;
        // Let's see if the element is present
        std::pair<siterator, siterator> to_return(this->priv_find(key, hash_func, equal_func, bucket_number_first, h, prev), this->priv_invalid_local_it());
        ...
        }
        {
            ...
            if (optimize_multikey)
            {
                to_return.second = bucket_type::s_iterator_to(*node_traits::get_next(group_functions_t::get_last_in_group(hashtable_impl::dcast_bucket_ptr(it.pointed_node()), optimize_multikey_t())));
        ...
        for (bucket_number_second = bucket_number_first + 1; bucket_number_second != this->priv_bucket_count(); ++bucket_number_second)
        {
...
template <class T, bool UniqueKeys, class O1 = none, class O2 = none, class O3 = none, class O4 = none, class O5 = none, class O6 = none, class O7 = none, class O8 = none, class O9 = none, class O10 = none>
#else
template <class T, bool UniqueKeys, class... Options>
#endif
struct make_hashtable_opt
{
    typedef typename pack_options<uset_defaults<T>,
#if !defined(BOOST_INTRUSIVE_VARIADIC_TEMPLATES)
    ...
    typedef typename detail::get_value_traits<T, typename packed_options::value_traits>::type value_traits;
    static const bool external_value_traits =
        detail::external_value_traits_bool_is_true<value_traits>::value; /*
    ...
    typedef typename detail::if_c<detail::is_same<specified_bucket_traits, default_bucket_traits>::value, detail::bucket_traits_impl<slist_impl>, specified_bucket_traits>::type real_bucket_traits;

    typedef detail::usetopt<value_traits, typename packed_options::hash, typename packed_options::equal, typename packed_options::size_type, real_bucket_traits, (std::size_t(UniqueKeys) * detail::hash_bool_flags::unique_keys_pos) | (std::size_t(packed_options::constant_time_size) * detail::hash_bool_flags::constant_time_size_pos) | (std::size_t(packed_options::power_2_buckets) * detail::hash_bool_flags::power_2_buckets_pos) | (std::size_t(packed_options::cache_begin) * detail::hash_bool_flags::cache_begin_pos) | (std::size_t(packed_options::compare_hash) * detail::hash_bool_flags::compare_hash_pos) | (std::size_t(packed_options::incremental) * detail::hash_bool_flags::incremental_pos)> type;
};
/// @endcond
...
template <class T, class... Options>
#else
template <class T, class O1 = none, class O2 = none, class O3 = none, class O4 = none, class O5 = none, class O6 = none, class O7 = none, class O8 = none, class O9 = none, class O10 = none>
#endif
struct make_hashtable
{
    /// @cond
    typedef hashtable_impl<typename make_hashtable_opt<T, false,
#if !defined(BOOST_INTRUSIVE_VARIADIC_TEMPLATES)
                                                       O1, O2, O3, O4, O5, O6, O7, O8, O9, O10
#else
                                                       Options...
                            ...
                            >::type
{
  ...
  public:
    ...
    hashtable(const bucket_traits &b_traits, const hasher &hash_func = hasher(), const key_equal &equal_func = key_equal(), const value_traits &v_traits = value_traits())
