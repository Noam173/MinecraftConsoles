...
struct splaydown_rollback
{
    ...
    splaydown_rollback(const node_ptr *pcur_subtree, const node_ptr &header, const node_ptr &leftmost, const node_ptr &rightmost)
        : pcur_subtree_(pcur_subtree), header_(header), leftmost_(leftmost), rightmost_(rightmost)
    {
    }
...
class splaytree_algorithms
{
  ...
  public:
    ...
    static std::pair<node_ptr, bool> insert_unique_check(const node_ptr &header, const KeyType &key, KeyNodePtrCompare comp, insert_commit_data &commit_data)
    {
    ...
    template <class KeyType, class KeyNodePtrCompare>
    static std::pair<node_ptr, bool> insert_unique_check(const node_ptr &header, const node_ptr &hint, const KeyType &key, KeyNodePtrCompare comp, insert_commit_data &commit_data)
    {
        splay_down(header, key, comp);
    ...
    //! <b>Throws</b>: If "comp" throws.
    template <class KeyType, class KeyNodePtrCompare>
    static node_ptr find(const const_node_ptr &header, const KeyType &key, KeyNodePtrCompare comp, bool splay = true)
    {
        if (splay)
        {
    ...
    //! <b>Throws</b>: If "comp" throws.
    template <class KeyType, class KeyNodePtrCompare>
    static std::pair<node_ptr, node_ptr> equal_range(const const_node_ptr &header, const KeyType &key, KeyNodePtrCompare comp, bool splay = true)
    {
        // if(splay)
        // splay_down(uncast(header), key, comp);
    ...
    template <class KeyType, class KeyNodePtrCompare>
    static std::pair<node_ptr, node_ptr> bounded_range(const const_node_ptr &header, const KeyType &lower_key, const KeyType &upper_key, KeyNodePtrCompare comp, bool left_closed, bool right_closed, bool splay = true)
    {
        std::pair<node_ptr, node_ptr> ret =
    ...
    //! <b>Throws</b>: If "comp" throws.
    template <class KeyType, class KeyNodePtrCompare>
    static node_ptr lower_bound(const const_node_ptr &header, const KeyType &key, KeyNodePtrCompare comp, bool splay = true)
    {
        // if(splay)
        // splay_down(uncast(header), key, comp);
    ...
    //! <b>Throws</b>: If "comp" throws.
    template <class KeyType, class KeyNodePtrCompare>
    static node_ptr upper_bound(const const_node_ptr &header, const KeyType &key, KeyNodePtrCompare comp, bool splay = true)
    {
        // if(splay)
        // splay_down(uncast(header), key, comp);
    ...
    //! <b>Throws</b>: If "comp" throws.
    template <class NodePtrCompare>
    static node_ptr insert_equal_upper_bound(const node_ptr &header, const node_ptr &new_node, NodePtrCompare comp)
    {
        splay_down(header, new_node, comp);
    ...
    //! <b>Throws</b>: If "comp" throws.
    template <class NodePtrCompare>
    static node_ptr insert_equal_lower_bound(const node_ptr &header, const node_ptr &new_node, NodePtrCompare comp)
    {
        splay_down(header, new_node, comp);
