...
class splay_set_impl
{
  ...
  public:
    ...
    explicit splay_set_impl(const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
        : tree_(cmp, v_traits)
    {
    }
    ...
    splay_set_impl(Iterator b, Iterator e, const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
    ...
    {
        return *detail::parent_from_member<splay_set_impl, tree_type>(&tree_type::container_from_end_iterator(end_iterator), &splay_set_impl::tree_);
    }
    ...
    {
        return *detail::parent_from_member<splay_set_impl, tree_type>(&tree_type::container_from_iterator(it), &splay_set_impl::tree_);
    }
    ...
    //!   and lower_bound for lower_value and upper_value.
    std::pair<const_iterator, const_iterator>
    bounded_range_dont_splay_dont_splay(const_reference lower_value, const_reference upper_value, bool left_closed, bool right_closed) const
    {
    ...
    template <class KeyType, class KeyValueCompare>
    std::pair<const_iterator, const_iterator>
    bounded_range_dont_splay(const KeyType &lower_key, const KeyType &upper_key, KeyValueCompare comp, bool left_closed, bool right_closed) const
    {
...
{
    /// @cond
    typedef splay_set_impl<typename make_splaytree_opt<T,
...
class splay_set
    : public make_splay_set<T,
                            ...
                            >::type
{
    typedef typename make_splay_set<T,
#if !defined(BOOST_INTRUSIVE_VARIADIC_TEMPLATES)
                                    O1, O2, O3, O4
#else
                                    Options...
  ...
  public:
    ...
    template <class Iterator>
    splay_set(Iterator b, Iterator e, const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
...
class splay_multiset_impl
{
  ...
  public:
    ...
    //!   constructor throws (this does not happen with predefined Boost.Intrusive hooks)
    //!   or the copy constructor/operator() of the value_compare object throws.
    explicit splay_multiset_impl(const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
        : tree_(cmp, v_traits)
    {
    }
    ...
    //!   or the copy constructor/operator() of the value_compare object throws.
    template <class Iterator>
    splay_multiset_impl(Iterator b, Iterator e, const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
    ...
    {
        return *detail::parent_from_member<splay_multiset_impl, tree_type>(&tree_type::container_from_end_iterator(end_iterator), &splay_multiset_impl::tree_);
    }
    ...
    {
        return *detail::parent_from_member<splay_multiset_impl, tree_type>(&tree_type::container_from_iterator(it), &splay_multiset_impl::tree_);
    }
    ...
    //!   and lower_bound for lower_value and upper_value.
    std::pair<const_iterator, const_iterator>
    bounded_range_dont_splay(const_reference lower_value, const_reference upper_value, bool left_closed, bool right_closed) const
    {
        return tree_.bounded_range_dont_splay(lower_value, upper_value, left_closed, right_closed);
    }
...
{
    /// @cond
    typedef splay_multiset_impl<typename make_splaytree_opt<T,
#if !defined(BOOST_INTRUSIVE_VARIADIC_TEMPLATES)
                                                            O1, O2, O3, O4
#else
                                                            Options...
                                 ...
                                 >::type
{
  ...
  public:
    ...
    template <class Iterator>
    splay_multiset(Iterator b, Iterator e, const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
        : Base(b, e, cmp, v_traits)
    {
    }
