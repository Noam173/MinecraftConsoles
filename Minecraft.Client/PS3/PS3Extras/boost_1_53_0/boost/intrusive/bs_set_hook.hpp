...
struct make_bs_set_base_hook
{
    ...
    typedef detail::generic_hook<get_bs_set_node_algo<typename packed_options::void_pointer>, typename packed_options::tag, packed_options::link_mode, detail::BsSetBaseHook> implementation_defined;
    /// @endcond
...
struct make_bs_set_member_hook
{
    ...
    typedef detail::generic_hook<get_bs_set_node_algo<typename packed_options::void_pointer>, member_tag, packed_options::link_mode, detail::NoBaseHook> implementation_defined;
    /// @endcond
    typedef implementation_defined type;
};
