...
struct sg_set_defaults
    : pack_options<none, base_hook<detail::default_bs_set_hook>, floating_point<true>, size_type<std::size_t>, compare<std::less<T>>>::type
{
};
    ...
    : private detail::clear_on_destructor_base<sgtree_impl<Config>>
{
  ...
  private:
    ...
    struct data_t : public sgtree_impl::value_traits
    {
        ...
        data_t(const value_compare &comp, const value_traits &val_traits)
            : value_traits(val_traits), node_plus_pred_(comp), max_tree_size_(0)
        {
        }
  ...
  public:
    ...
    explicit sgtree_impl(const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
        : data_(cmp, v_traits)
    {
    ...
    iterator insert_equal(reference value)
    {
        ...
        node_ptr p = node_algorithms::insert_equal_upper_bound(this->priv_header_ptr(), to_insert, key_node_comp, (size_type)this->size(), this->get_h_alpha_func(), max_tree_size);
    ...
    iterator insert_equal(const_iterator hint, reference value)
    {
        ...
        std::size_t max_tree_size = (std::size_t)data_.max_tree_size_;
        node_ptr p = node_algorithms::insert_equal(this->priv_header_ptr(), hint.pointed_node(), to_insert, key_node_comp, (std::size_t)this->size(), this->get_h_alpha_func(), max_tree_size);
        this->priv_size_traits().increment();
        data_.max_tree_size_ = (size_type)max_tree_size;
        return iterator(p, this);
    }
    ...
    std::pair<iterator, bool> insert_unique_check(const KeyType &key, KeyValueCompare key_value_comp, insert_commit_data &commit_data)
    {
        ...
        std::pair<node_ptr, bool> ret =
            (node_algorithms::insert_unique_check(this->priv_header_ptr(), key, comp, commit_data));
    ...
    std::pair<iterator, bool> insert_unique_check(const_iterator hint, const KeyType &key, KeyValueCompare key_value_comp, insert_commit_data &commit_data)
    {
        detail::key_nodeptr_comp<KeyValueCompare, sgtree_impl>
            comp(key_value_comp, this);
        std::pair<node_ptr, bool> ret =
            (node_algorithms::insert_unique_check(this->priv_header_ptr(), hint.pointed_node(), key, comp, commit_data));
        return std::pair<iterator, bool>(iterator(ret.first, this), ret.second);
    }
    ...
    iterator insert_unique_commit(reference value, const insert_commit_data &commit_data)
    {
        ...
        std::size_t max_tree_size = (std::size_t)data_.max_tree_size_;
        node_algorithms::insert_unique_commit(this->priv_header_ptr(), to_insert, commit_data, (std::size_t)this->size(), this->get_h_alpha_func(), max_tree_size);
        this->priv_size_traits().increment();
        data_.max_tree_size_ = (size_type)max_tree_size;
    ...
    iterator insert_before(const_iterator pos, reference value)
    {
        ...
        std::size_t max_tree_size = (std::size_t)data_.max_tree_size_;
        node_ptr p = node_algorithms::insert_before(this->priv_header_ptr(), pos.pointed_node(), to_insert, (size_type)this->size(), this->get_h_alpha_func(), max_tree_size);
        this->priv_size_traits().increment();
        data_.max_tree_size_ = (size_type)max_tree_size;
        return iterator(p, this);
    }
    ...
    void push_back(reference value)
    {
        ...
        std::size_t max_tree_size = (std::size_t)data_.max_tree_size_;
        node_algorithms::push_back(this->priv_header_ptr(), to_insert, (size_type)this->size(), this->get_h_alpha_func(), max_tree_size);
        this->priv_size_traits().increment();
        data_.max_tree_size_ = (size_type)max_tree_size;
    }
    ...
    void push_front(reference value)
    {
        ...
        std::size_t max_tree_size = (std::size_t)data_.max_tree_size_;
        node_algorithms::push_front(this->priv_header_ptr(), to_insert, (size_type)this->size(), this->get_h_alpha_func(), max_tree_size);
        this->priv_size_traits().increment();
        data_.max_tree_size_ = (size_type)max_tree_size;
    }
    ...
    iterator erase(const_iterator i)
    {
        ...
        node_algorithms::erase(this->priv_header_ptr(), to_erase, (std::size_t)this->size(), max_tree_size, this->get_alpha_by_max_size_func());
        data_.max_tree_size_ = (size_type)max_tree_size;
    ...
    {
        size_type n;
        return private_erase(b, e, n, disposer);
    }
    ...
    {
        node_algorithms::clear_and_dispose(this->priv_header_ptr(), detail::node_disposer<Disposer, sgtree_impl>(disposer, this));
        this->priv_size_traits().set_size(0);
    }
    ...
    iterator lower_bound(const KeyType &key, KeyValueCompare comp)
    {
        ...
        return iterator(node_algorithms::lower_bound(this->priv_header_ptr(), key, key_node_comp), this);
    }
    ...
    const_iterator lower_bound(const KeyType &key, KeyValueCompare comp) const
    {
        detail::key_nodeptr_comp<KeyValueCompare, sgtree_impl>
            key_node_comp(comp, this);
        return const_iterator(node_algorithms::lower_bound(this->priv_header_ptr(), key, key_node_comp), this);
    }
    ...
    iterator upper_bound(const KeyType &key, KeyValueCompare comp)
    {
        detail::key_nodeptr_comp<KeyValueCompare, sgtree_impl>
            key_node_comp(comp, this);
        return iterator(node_algorithms::upper_bound(this->priv_header_ptr(), key, key_node_comp), this);
    }
    ...
    const_iterator upper_bound(const KeyType &key, KeyValueCompare comp) const
    {
        detail::key_nodeptr_comp<KeyValueCompare, sgtree_impl>
            key_node_comp(comp, this);
        return const_iterator(node_algorithms::upper_bound(this->priv_header_ptr(), key, key_node_comp), this);
    }
    ...
    iterator find(const KeyType &key, KeyValueCompare comp)
    {
        detail::key_nodeptr_comp<KeyValueCompare, sgtree_impl>
            key_node_comp(comp, this);
        return iterator(node_algorithms::find(this->priv_header_ptr(), key, key_node_comp), this);
    }
    ...
    const_iterator find(const KeyType &key, KeyValueCompare comp) const
    {
        detail::key_nodeptr_comp<KeyValueCompare, sgtree_impl>
            key_node_comp(comp, this);
        return const_iterator(node_algorithms::find(this->priv_header_ptr(), key, key_node_comp), this);
    }
    ...
    std::pair<iterator, iterator> equal_range(const KeyType &key, KeyValueCompare comp)
    {
        detail::key_nodeptr_comp<KeyValueCompare, sgtree_impl>
            key_node_comp(comp, this);
        std::pair<node_ptr, node_ptr> ret(node_algorithms::equal_range(this->priv_header_ptr(), key, key_node_comp));
    ...
    template <class KeyType, class KeyValueCompare>
    std::pair<iterator, iterator> bounded_range(const KeyType &lower_key, const KeyType &upper_key, KeyValueCompare comp, bool left_closed, bool right_closed)
    {
        detail::key_nodeptr_comp<KeyValueCompare, sgtree_impl>
            key_node_comp(comp, this);
        std::pair<node_ptr, node_ptr> ret(node_algorithms::bounded_range(this->priv_header_ptr(), lower_key, upper_key, key_node_comp, left_closed, right_closed));
        return std::pair<iterator, iterator>(iterator(ret.first, this), iterator(ret.second, this));
    }
    ...
    //!   and lower_bound for lower_key and upper_key.
    template <class KeyType, class KeyValueCompare>
    std::pair<const_iterator, const_iterator> bounded_range(const KeyType &lower_key, const KeyType &upper_key, KeyValueCompare comp, bool left_closed, bool right_closed) const
    {
        detail::key_nodeptr_comp<KeyValueCompare, sgtree_impl>
            key_node_comp(comp, this);
        std::pair<node_ptr, node_ptr> ret(node_algorithms::bounded_range(this->priv_header_ptr(), lower_key, upper_key, key_node_comp, left_closed, right_closed));
    ...
    void clone_from(const sgtree_impl &src, Cloner cloner, Disposer disposer)
    {
        ...
        if (!src.empty())
        {
            ...
            node_algorithms::clone(src.priv_header_ptr(), this->priv_header_ptr(), detail::node_cloner<Cloner, sgtree_impl>(cloner, this), detail::node_disposer<Disposer, sgtree_impl>(disposer, this));
    ...
    {
        node_ptr to_be_disposed(node_algorithms::unlink_leftmost_without_rebalance(this->priv_header_ptr()));
        if (!to_be_disposed)
        {
            return 0;
        }
    ...
    {
        node_algorithms::replace_node(get_real_value_traits().to_node_ptr(*replace_this), this->priv_header_ptr(), get_real_value_traits().to_node_ptr(with_this));
        if (safemode_or_autounlink)
        {
  ...
  private:
    ...
    {
        header_plus_alpha *r = detail::parent_from_member<header_plus_alpha, node>(boost::intrusive::detail::to_raw_pointer(end_iterator.pointed_node()), &header_plus_alpha::header_);
        node_plus_pred_t *n = detail::parent_from_member<node_plus_pred_t, header_plus_alpha>(r, &node_plus_pred_t::header_plus_alpha_);
...
{
    typedef typename pack_options<sg_set_defaults<T>,
#if !defined(BOOST_INTRUSIVE_VARIADIC_TEMPLATES)
                                  O1, O2, O3, O4
#else
                                  Options...
...
{
    /// @cond
    typedef sgtree_impl<typename make_sgtree_opt<T,
#if !defined(BOOST_INTRUSIVE_VARIADIC_TEMPLATES)
                                                 O1, O2, O3, O4
#else
                                                 Options...
...
class sgtree
    : public make_sgtree<T,
                         ...
                         >::type
{
    typedef typename make_sgtree<T,
#if !defined(BOOST_INTRUSIVE_VARIADIC_TEMPLATES)
                                 O1, O2, O3, O4
#else
                                 Options...
  ...
  public:
    ...
    sgtree(const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
        : Base(cmp, v_traits)
    {
    }

    template <class Iterator>
    sgtree(bool unique, Iterator b, Iterator e, const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
