...
class avl_set_impl
{
  ...
  public:
    ...
    explicit avl_set_impl(const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
        : tree_(cmp, v_traits)
    {
    }
    ...
    avl_set_impl(Iterator b, Iterator e, const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
    ...
    {
        return *detail::parent_from_member<avl_set_impl, tree_type>(&tree_type::container_from_iterator(it), &avl_set_impl::tree_);
    }
...
{
    /// @cond
    typedef avl_set_impl<typename make_avltree_opt
      ...
      ::type
{
  ...
  public:
    ...
    avl_set(const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
        : Base(cmp, v_traits)
    {
    }

    template <class Iterator>
    avl_set(Iterator b, Iterator e, const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
...
class avl_multiset_impl
{
  ...
  public:
    ...
    //!   constructor throws (this does not happen with predefined Boost.Intrusive hooks)
    //!   or the copy constructor/operator() of the value_compare object throws.
    explicit avl_multiset_impl(const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
        : tree_(cmp, v_traits)
    {
    }
    ...
    //!   or the copy constructor/operator() of the value_compare object throws.
    template <class Iterator>
    avl_multiset_impl(Iterator b, Iterator e, const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
    ...
    {
        return *detail::parent_from_member<avl_multiset_impl, tree_type>(&tree_type::container_from_end_iterator(end_iterator), &avl_multiset_impl::tree_);
    }
    ...
    {
        return *detail::parent_from_member<avl_multiset_impl, tree_type>(&tree_type::container_from_iterator(it), &avl_multiset_impl::tree_);
    }
...
{
    /// @cond
    typedef avl_multiset_impl<typename make_avltree_opt
#if !defined(BOOST_INTRUSIVE_VARIADIC_TEMPLATES)
                              <T, O1, O2, O3, O4>
#else
                              <T, Options...>
                               ...
                               >::type
{
  ...
  public:
    ...
    avl_multiset(const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
        : Base(cmp, v_traits)
    {
    }

    template <class Iterator>
    avl_multiset(Iterator b, Iterator e, const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
        : Base(b, e, cmp, v_traits)
    {
    }
