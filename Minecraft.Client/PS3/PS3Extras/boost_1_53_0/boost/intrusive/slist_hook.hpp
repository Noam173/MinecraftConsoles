...
struct make_slist_base_hook
{
    ...
    typedef detail::generic_hook<get_slist_node_algo<typename packed_options::void_pointer>, typename packed_options::tag, packed_options::link_mode, detail::SlistBaseHook> implementation_defined;
    /// @endcond
...
struct make_slist_member_hook
{
    ...
    typedef detail::generic_hook<get_slist_node_algo<typename packed_options::void_pointer>, member_tag, packed_options::link_mode, detail::NoBaseHook> implementation_defined;
    /// @endcond
    typedef implementation_defined type;
};
