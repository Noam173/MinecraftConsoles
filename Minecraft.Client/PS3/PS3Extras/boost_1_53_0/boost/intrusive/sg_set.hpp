...
class sg_set_impl
{
  ...
  public:
    ...
    explicit sg_set_impl(const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
        : tree_(cmp, v_traits)
    {
    }
    ...
    {
        return *detail::parent_from_member<sg_set_impl, tree_type>(&tree_type::container_from_end_iterator(end_iterator), &sg_set_impl::tree_);
    }
    ...
    {
        return *detail::parent_from_member<sg_set_impl, tree_type>(&tree_type::container_from_iterator(it), &sg_set_impl::tree_);
    }
...
{
    /// @cond
    typedef sg_set_impl<typename make_sgtree_opt<T,
...
class sg_set
    : public make_sg_set<T,
                         ...
                         >::type
{
    typedef typename make_sg_set<T,
#if !defined(BOOST_INTRUSIVE_VARIADIC_TEMPLATES)
                                 O1, O2, O3, O4
#else
                                 Options...
  ...
  public:
    ...
    sg_set(const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
        : Base(cmp, v_traits)
    {
    }

    template <class Iterator>
    sg_set(Iterator b, Iterator e, const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
...
class sg_multiset_impl
{
  ...
  public:
    ...
    //!   constructor throws (this does not happen with predefined Boost.Intrusive hooks)
    //!   or the copy constructor/operator() of the value_compare object throws.
    explicit sg_multiset_impl(const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
        : tree_(cmp, v_traits)
    {
    }
    ...
    //!   or the copy constructor/operator() of the value_compare object throws.
    template <class Iterator>
    sg_multiset_impl(Iterator b, Iterator e, const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
    ...
    {
        return *detail::parent_from_member<sg_multiset_impl, tree_type>(&tree_type::container_from_end_iterator(end_iterator), &sg_multiset_impl::tree_);
    }
    ...
    {
        return *detail::parent_from_member<sg_multiset_impl, tree_type>(&tree_type::container_from_iterator(it), &sg_multiset_impl::tree_);
    }
...
{
    /// @cond
    typedef sg_multiset_impl<typename make_sgtree_opt<T,
#if !defined(BOOST_INTRUSIVE_VARIADIC_TEMPLATES)
                                                      O1, O2, O3, O4
#else
                                                      Options...
                              ...
                              >::type
{
  ...
  public:
    ...
    sg_multiset(const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
        : Base(cmp, v_traits)
    {
    }

    template <class Iterator>
    sg_multiset(Iterator b, Iterator e, const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
        : Base(b, e, cmp, v_traits)
    {
    }
