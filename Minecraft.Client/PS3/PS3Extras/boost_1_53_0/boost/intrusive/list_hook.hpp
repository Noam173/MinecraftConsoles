...
struct make_list_base_hook
{
    ...
    typedef detail::generic_hook<get_list_node_algo<typename packed_options::void_pointer>, typename packed_options::tag, packed_options::link_mode, detail::ListBaseHook> implementation_defined;
    /// @endcond
...
struct make_list_member_hook
{
    ...
    typedef detail::generic_hook<get_list_node_algo<typename packed_options::void_pointer>, member_tag, packed_options::link_mode, detail::NoBaseHook> implementation_defined;
    /// @endcond
    typedef implementation_defined type;
};
