...
struct pointer_traits
{
    ...
    template <class U>
    using rebind = typename boost::intrusive::detail::type_rebinder<Ptr, U>::type;
#endif
    ...
    static pointer pointer_to(reference r)
    {
        ...
        const bool value = boost::intrusive::detail::
            has_member_function_callable_with_pointer_to<Ptr, typename boost::intrusive::detail::unvoid<element_type &>::type>::value;
    ...
    {
        const bool value = boost::intrusive::detail::
            has_member_function_callable_with_static_cast_from<Ptr, const UPtr>::value;
        ::boost::integral_constant<bool, value> flag;
    ...
    {
        const bool value = boost::intrusive::detail::
            has_member_function_callable_with_const_cast_from<Ptr, const UPtr>::value;
        ::boost::integral_constant<bool, value> flag;
    ...
    {
        const bool value = boost::intrusive::detail::
            has_member_function_callable_with_dynamic_cast_from<Ptr, const UPtr>::value;
        ::boost::integral_constant<bool, value> flag;
