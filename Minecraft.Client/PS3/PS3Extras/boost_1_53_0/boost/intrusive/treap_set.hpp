...
class treap_set_impl
{
  ...
  public:
    ...
    explicit treap_set_impl(const value_compare &cmp = value_compare(), const priority_compare &pcmp = priority_compare(), const value_traits &v_traits = value_traits())
    ...
    {
        return *detail::parent_from_member<treap_set_impl, tree_type>(&tree_type::container_from_end_iterator(end_iterator), &treap_set_impl::tree_);
    }
    ...
    {
        return *detail::parent_from_member<treap_set_impl, tree_type>(&tree_type::container_from_iterator(it), &treap_set_impl::tree_);
    }
    ...
    std::pair<iterator, bool> insert_check(const KeyType &key, KeyValueCompare key_value_comp, KeyValuePriorityCompare key_value_pcomp, insert_commit_data &commit_data)
    {
    ...
    //!   objects are inserted or erased from the treap_set.
    template <class KeyType, class KeyValueCompare, class KeyValuePriorityCompare>
    std::pair<iterator, bool> insert_check(const_iterator hint, const KeyType &key, KeyValueCompare key_value_comp, KeyValuePriorityCompare key_value_pcomp, insert_commit_data &commit_data)
    {
    ...
    template <class KeyType, class KeyValueCompare>
    std::pair<const_iterator, const_iterator>
    bounded_range(const KeyType &lower_key, const KeyType &upper_key, KeyValueCompare comp, bool left_closed, bool right_closed) const
    {
        return tree_.bounded_range(lower_key, upper_key, comp, left_closed, right_closed);
    }
...
{
    /// @cond
    typedef treap_set_impl<typename make_treap_opt<T,
...
class treap_set
    : public make_treap_set<T,
                            ...
                            >::type
{
    typedef typename make_treap_set<T,
#if !defined(BOOST_INTRUSIVE_VARIADIC_TEMPLATES)
                                    O1, O2, O3, O4
#else
                                    Options...
  ...
  public:
    ...
    template <class Iterator>
    treap_set(Iterator b, Iterator e, const value_compare &cmp = value_compare(), const priority_compare &pcmp = priority_compare(), const value_traits &v_traits = value_traits())
...
class treap_multiset_impl
{
  ...
  public:
    ...
    explicit treap_multiset_impl(const value_compare &cmp = value_compare(), const priority_compare &pcmp = priority_compare(), const value_traits &v_traits = value_traits())
        : tree_(cmp, pcmp, v_traits)
    {
    }
    ...
    template <class Iterator>
    treap_multiset_impl(Iterator b, Iterator e, const value_compare &cmp = value_compare(), const priority_compare &pcmp = priority_compare(), const value_traits &v_traits = value_traits())
    ...
    {
        return *detail::parent_from_member<treap_multiset_impl, tree_type>(&tree_type::container_from_end_iterator(end_iterator), &treap_multiset_impl::tree_);
    }
    ...
    {
        return *detail::parent_from_member<treap_multiset_impl, tree_type>(&tree_type::container_from_iterator(it), &treap_multiset_impl::tree_);
    }
...
{
    /// @cond
    typedef treap_multiset_impl<typename make_treap_opt<T,
#if !defined(BOOST_INTRUSIVE_VARIADIC_TEMPLATES)
                                                        O1, O2, O3, O4
#else
                                                        Options...
...
class treap_multiset
    : public make_treap_multiset<T,
                                 ...
                                 >::type
{
    typedef typename make_treap_multiset<T,
#if !defined(BOOST_INTRUSIVE_VARIADIC_TEMPLATES)
                                         O1, O2, O3, O4
#else
                                         Options...
  ...
  public:
    ...
    template <class Iterator>
    treap_multiset(Iterator b, Iterator e, const value_compare &cmp = value_compare(), const priority_compare &pcmp = priority_compare(), const value_traits &v_traits = value_traits())
        : Base(b, e, cmp, pcmp, v_traits)
    {
    }
