...
class set_impl
{
  ...
  protected:
    ...
    {
        return tree_.prot_header_node();
    }
    node const &prot_header_node() const
    {
        return tree_.prot_header_node();
    }
    void prot_set_size(size_type s)
    {
        tree_.prot_set_size(s);
    }
    value_compare &prot_comp()
    {
        return tree_.prot_comp();
    }
  ...
  public:
    ...
    explicit set_impl(const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
        : tree_(cmp, v_traits)
    {
    }
    ...
    set_impl(Iterator b, Iterator e, const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
    ...
    {
        return *detail::parent_from_member<set_impl, tree_type>(&tree_type::container_from_end_iterator(end_iterator), &set_impl::tree_);
    }
    ...
    {
        return *detail::parent_from_member<set_impl, tree_type>(&tree_type::container_from_iterator(it), &set_impl::tree_);
    }
...
{
    /// @cond
    typedef set_impl<typename make_rbtree_opt<T,
                      ...
                      >::type
{
  ...
  public:
    ...
    set(const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
        : Base(cmp, v_traits)
    {
    }

    template <class Iterator>
    set(Iterator b, Iterator e, const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
...
class multiset_impl
{
  ...
  public:
    ...
    //!   constructor throws (this does not happen with predefined Boost.Intrusive hooks)
    //!   or the copy constructor/operator() of the value_compare object throws.
    explicit multiset_impl(const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
        : tree_(cmp, v_traits)
    {
    }
    ...
    {
        return *detail::parent_from_member<multiset_impl, tree_type>(&tree_type::container_from_end_iterator(end_iterator), &multiset_impl::tree_);
    }
    ...
    {
        return *detail::parent_from_member<multiset_impl, tree_type>(&tree_type::container_from_iterator(it), &multiset_impl::tree_);
    }
...
{
    /// @cond
    typedef multiset_impl<typename make_rbtree_opt<T,
#if !defined(BOOST_INTRUSIVE_VARIADIC_TEMPLATES)
                                                   O1, O2, O3, O4
#else
                                                   Options...
                           ...
                           >::type
{
  ...
  public:
    ...
    multiset(const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
        : Base(cmp, v_traits)
    {
    }

    template <class Iterator>
    multiset(Iterator b, Iterator e, const value_compare &cmp = value_compare(), const value_traits &v_traits = value_traits())
        : Base(b, e, cmp, v_traits)
    {
    }
