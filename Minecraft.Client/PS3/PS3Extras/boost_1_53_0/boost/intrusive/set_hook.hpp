...
struct make_set_base_hook
{
    ...
    typedef detail::generic_hook<get_set_node_algo<typename packed_options::void_pointer, packed_options::optimize_size>, typename packed_options::tag, packed_options::link_mode, detail::SetBaseHook> implementation_defined;
    /// @endcond
...
struct make_set_member_hook
{
    ...
    typedef detail::generic_hook<get_set_node_algo<typename packed_options::void_pointer, packed_options::optimize_size>, member_tag, packed_options::link_mode, detail::NoBaseHook> implementation_defined;
    /// @endcond
    typedef implementation_defined type;
};
