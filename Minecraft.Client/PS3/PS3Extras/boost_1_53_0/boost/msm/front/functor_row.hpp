...
struct get_functor_return_value<Func,
                                typename ::boost::enable_if<
                                    typename has_deferring_action<Func>::type>::type>
{
...
struct get_functor_return_value<Func,
                                typename ::boost::enable_if<
                                    typename has_some_deferring_actions<Func>::type>::type>
{
...
struct ActionSequence_
{
    ...
    struct Call
    {
        Call(EVT const &evt, FSM &fsm, STATE &state) : evt_(evt), fsm_(fsm), state_(state)
        {
        }
        template <class FCT>
    ...
    struct Call2
    {
        Call2(EVT const &evt, FSM &fsm, SourceState &src, TargetState &tgt) : evt_(evt), fsm_(fsm), src_(src), tgt_(tgt)
        {
        }
        template <class FCT>
        void operator()(::boost::msm::wrap<FCT> const &)
    ...
    {
        mpl::for_each<Sequence, boost::msm::wrap<::boost::mpl::placeholders::_1>>(Call<EVT, FSM, STATE>(evt, fsm, state));
    }
    template <class EVT, class FSM, class SourceState, class TargetState>
    void operator()(EVT const &evt, FSM &fsm, SourceState &src, TargetState &tgt)
    {
        mpl::for_each<Sequence, boost::msm::wrap<::boost::mpl::placeholders::_1>>(Call2<EVT, FSM, SourceState, TargetState>(evt, fsm, src, tgt));
    }
};
