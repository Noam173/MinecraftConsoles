...
struct state_machine_def : public boost::msm::front::detail::state_base<BaseState>
{
    ...
    template <
        typename T1, class Event, typename T2, void (Derived::*action)(Event const &)>
    struct a_row
    {
    ...
    template <
        typename T1, class Event, typename T2, void (Derived::*action)(Event const &), bool (Derived::*guard)(Event const &)>
    struct row
    {
    ...
    template <
        typename T1, class Event, typename T2, bool (Derived::*guard)(Event const &)>
    struct g_row
    {
    ...
    template <
        typename T1, class Event, void (Derived::*action)(Event const &)>
    struct a_irow
    {
    ...
    template <
        typename T1, class Event, void (Derived::*action)(Event const &), bool (Derived::*guard)(Event const &)>
    struct irow
    {
    ...
    template <
        typename T1, class Event, bool (Derived::*guard)(Event const &)>
    struct g_irow
    {
