...
struct Insert_ : euml_action<Insert_<Container, Param1, Param2, Param3>>
{
    ...
    void operator()(EVT const &evt, FSM &fsm, SourceState &src, TargetState &tgt) const
    {
        (Container()(evt, fsm, src, tgt)).insert(Param1()(evt, fsm, src, tgt), Param2()(evt, fsm, src, tgt), Param3()(evt, fsm, src, tgt));
    }
    template <class Event, class FSM, class STATE>
    void operator()(Event const &evt, FSM &fsm, STATE &state) const
    {
        (Container()(evt, fsm, state)).insert(Param1()(evt, fsm, state), Param2()(evt, fsm, state), Param3()(evt, fsm, state));
    }
};
    ...
    : euml_action<Insert_<Container, Param1, Param2, void>>
{
        ...
        typename ::boost::mpl::and_<
            ...
            typename ::boost::mpl::not_<
                typename has_iterator_category<
                    typename Param2::template transition_action_result<EVT, FSM, SourceState, TargetState>::type>::type>::type>::type,
        typename transition_action_result<EVT, FSM, SourceState, TargetState>::type>::type
    operator()(EVT const &evt, FSM &fsm, SourceState &src, TargetState &tgt) const
    {
    ...
    typename ::boost::enable_if<
        typename ::boost::mpl::and_<
            typename ::boost::mpl::has_key<
                typename Container::tag_type, action_tag>::type,
            typename has_iterator_category<
                typename Param2::template transition_action_result<EVT, FSM, SourceState, TargetState>::type>::type>::type,
        typename transition_action_result<EVT, FSM, SourceState, TargetState>::type>::type
    operator()(EVT const &evt, FSM &fsm, SourceState &src, TargetState &tgt) const
    {
    ...
    typename ::boost::enable_if<
        typename ::boost::mpl::and_<
            ...
            typename ::boost::mpl::not_<
                typename has_iterator_category<
                    typename Param2::template state_action_result<Event, FSM, STATE>::type>::type>::type>::type,
        typename state_action_result<Event, FSM, STATE>::type>::type
    operator()(Event const &evt, FSM &fsm, STATE &state) const
    {
    ...
    typename ::boost::enable_if<
        typename ::boost::mpl::and_<
            typename ::boost::mpl::has_key<
                typename Container::tag_type, state_action_tag>::type,
            typename has_iterator_category<
                typename Param2::template state_action_result<Event, FSM, STATE>::type>::type>::type,
        typename state_action_result<Event, FSM, STATE>::type>::type
    operator()(Event const &evt, FSM &fsm, STATE &state) const
    {
    ...
    : euml_action<Splice_<Container, Param1, Param2, Param3, Param4>>
{
    ...
    void operator()(EVT const &evt, FSM &fsm, SourceState &src, TargetState &tgt) const
    {
        (Container()(evt, fsm, src, tgt)).splice(Param1()(evt, fsm, src, tgt), Param2()(evt, fsm, src, tgt), Param3()(evt, fsm, src, tgt));
    }
    template <class Event, class FSM, class STATE>
    void operator()(Event const &evt, FSM &fsm, STATE &state) const
    {
        (Container()(evt, fsm, state)).splice(Param1()(evt, fsm, state), Param2()(evt, fsm, state), Param3()(evt, fsm, state));
    }
};
template <class Container, class Param1, class Param2, class Param3, class Param4>
struct Splice_<Container, Param1, Param2, Param3, Param4,
    ...
    : euml_action<Splice_<Container, Param1, Param2, Param3, Param4>>
{
    ...
    void operator()(EVT const &evt, FSM &fsm, SourceState &src, TargetState &tgt) const
    {
        (Container()(evt, fsm, src, tgt)).splice(Param1()(evt, fsm, src, tgt), Param2()(evt, fsm, src, tgt), Param3()(evt, fsm, src, tgt), Param4()(evt, fsm, src, tgt));
    }
    template <class Event, class FSM, class STATE>
    void operator()(Event const &evt, FSM &fsm, STATE &state) const
    {
        (Container()(evt, fsm, state)).splice(Param1()(evt, fsm, state), Param2()(evt, fsm, state), Param3()(evt, fsm, state), Param4()(evt, fsm, state));
    }
};
struct splice_tag
{
...
struct StringFind_ : euml_action<StringFind_<Container, Param1, Param2, Param3>>
{
    ...
    operator()(EVT const &evt, FSM &fsm, SourceState &src, TargetState &tgt) const
    {
        return (Container()(evt, fsm, src, tgt)).find(Param1()(evt, fsm, src, tgt), Param2()(evt, fsm, src, tgt), Param3()(evt, fsm, src, tgt));
    }
    template <class Event, class FSM, class STATE>
    typename state_action_result<Event, FSM, STATE>::type
    operator()(Event const &evt, FSM &fsm, STATE &state) const
    {
        return (Container()(evt, fsm, state)).find(Param1()(evt, fsm, state), Param2()(evt, fsm, state), Param3()(evt, fsm, state));
    }
};
...
struct StringRFind_<
    ...
    typename ::boost::enable_if<
        typename ::boost::is_same<Param2, void>::type>::type>
...
struct StringRFind_<
    Container, Param1, Param2, Param3,
    typename ::boost::disable_if<
        typename ::boost::is_same<Param3, void>::type>::type>
    : euml_action<StringRFind_<Container, Param1, Param2, Param3>>
{
    template <class Event, class FSM, class STATE>
    struct state_action_result
    ...
    operator()(EVT const &evt, FSM &fsm, SourceState &src, TargetState &tgt) const
    {
        return (Container()(evt, fsm, src, tgt)).rfind(Param1()(evt, fsm, src, tgt), Param2()(evt, fsm, src, tgt), Param3()(evt, fsm, src, tgt));
    }
    template <class Event, class FSM, class STATE>
    typename state_action_result<Event, FSM, STATE>::type
    operator()(Event const &evt, FSM &fsm, STATE &state) const
    {
        return (Container()(evt, fsm, state)).rfind(Param1()(evt, fsm, state), Param2()(evt, fsm, state), Param3()(evt, fsm, state));
    }
};
...
struct StringFindFirstOf_ : euml_action<StringFindFirstOf_<Container, Param1, Param2, Param3>>
{
    ...
    operator()(EVT const &evt, FSM &fsm, SourceState &src, TargetState &tgt) const
    {
        return (Container()(evt, fsm, src, tgt)).find_first_of(Param1()(evt, fsm, src, tgt), Param2()(evt, fsm, src, tgt), Param3()(evt, fsm, src, tgt));
    }
    template <class Event, class FSM, class STATE>
    typename state_action_result<Event, FSM, STATE>::type
    operator()(Event const &evt, FSM &fsm, STATE &state) const
    {
        return (Container()(evt, fsm, state)).find_first_of(Param1()(evt, fsm, state), Param2()(evt, fsm, state), Param3()(evt, fsm, state));
    }
};
template <class Container, class Param1>
...
struct StringFindFirstOf_Helper : proto::extends<proto::terminal<string_find_first_of_tag>::type, StringFindFirstOf_Helper, boost::msm::sm_domain>
{
    ...
    : euml_action<StringFindFirstNotOf_<Container, Param1, Param2, Param3>>
{
    ...
    operator()(EVT const &evt, FSM &fsm, SourceState &src, TargetState &tgt) const
    {
        return (Container()(evt, fsm, src, tgt)).find_first_not_of(Param1()(evt, fsm, src, tgt), Param2()(evt, fsm, src, tgt), Param3()(evt, fsm, src, tgt));
    }
    template <class Event, class FSM, class STATE>
    typename state_action_result<Event, FSM, STATE>::type
    operator()(Event const &evt, FSM &fsm, STATE &state) const
    {
        return (Container()(evt, fsm, state)).find_first_not_of(Param1()(evt, fsm, state), Param2()(evt, fsm, state), Param3()(evt, fsm, state));
    }
};
...
struct StringFindFirstNotOf_Helper : proto::extends<proto::terminal<string_find_first_not_of_tag>::type, StringFindFirstNotOf_Helper, boost::msm::sm_domain>
{
    ...
    : euml_action<StringFindLastOf_<Container, Param1, Param2, Param3>>
{
    ...
    operator()(EVT const &evt, FSM &fsm, SourceState &src, TargetState &tgt) const
    {
        return (Container()(evt, fsm, src, tgt)).find_last_of(Param1()(evt, fsm, src, tgt), Param2()(evt, fsm, src, tgt), Param3()(evt, fsm, src, tgt));
    }
    template <class Event, class FSM, class STATE>
    typename state_action_result<Event, FSM, STATE>::type
    operator()(Event const &evt, FSM &fsm, STATE &state) const
    {
        return (Container()(evt, fsm, state)).find_last_of(Param1()(evt, fsm, state), Param2()(evt, fsm, state), Param3()(evt, fsm, state));
    }
};
...
struct StringFindLastOf_Helper : proto::extends<proto::terminal<string_find_last_of_tag>::type, StringFindLastOf_Helper, boost::msm::sm_domain>
{
    ...
    : euml_action<StringFindLastNotOf_<Container, Param1, Param2, Param3>>
{
    ...
    operator()(EVT const &evt, FSM &fsm, SourceState &src, TargetState &tgt) const
    {
        return (Container()(evt, fsm, src, tgt)).find_last_not_of(Param1()(evt, fsm, src, tgt), Param2()(evt, fsm, src, tgt), Param3()(evt, fsm, src, tgt));
    }
    template <class Event, class FSM, class STATE>
    typename state_action_result<Event, FSM, STATE>::type
    operator()(Event const &evt, FSM &fsm, STATE &state) const
    {
        return (Container()(evt, fsm, state)).find_last_not_of(Param1()(evt, fsm, state), Param2()(evt, fsm, state), Param3()(evt, fsm, state));
    }
};
...
struct StringFindLastNotOf_Helper : proto::extends<proto::terminal<string_find_last_of_tag>::type, StringFindLastNotOf_Helper, boost::msm::sm_domain>
{
    ...
    : euml_action<Associative_Erase_<Container, Param1, void>>
{
    ...
    typename ::boost::enable_if<
        typename ::boost::mpl::and_<
            typename ::boost::mpl::has_key<
                typename Container::tag_type, action_tag>::type,
            typename has_iterator_category<
                typename Param1::template transition_action_result<EVT, FSM, SourceState, TargetState>::type>::type>::type,
        void>::type
    operator()(EVT const &evt, FSM &fsm, SourceState &src, TargetState &tgt) const
    {
    ...
    typename ::boost::enable_if<
        typename ::boost::mpl::and_<
            typename ::boost::mpl::has_key<
                typename Container::tag_type, state_action_tag>::type,
            typename has_iterator_category<
                typename Param1::template state_action_result<Event, FSM, STATE>::type>::type>::type,
        void>::type
    operator()(Event const &evt, FSM &fsm, STATE &state) const
    {
    ...
    typename ::boost::enable_if<
        typename ::boost::mpl::and_<
            ...
            typename ::boost::mpl::not_<
                typename has_iterator_category<
                    typename Param1::template transition_action_result<EVT, FSM, SourceState, TargetState>::type>::type>::type>::type,
        typename transition_action_result<EVT, FSM, SourceState, TargetState>::type>::type
    operator()(EVT const &evt, FSM &fsm, SourceState &src, TargetState &tgt) const
    {
    ...
    typename ::boost::enable_if<
        typename ::boost::mpl::and_<
            ...
            typename ::boost::mpl::not_<
                typename has_iterator_category<
                    typename Param1::template state_action_result<Event, FSM, STATE>::type>::type>::type>::type,
        typename state_action_result<Event, FSM, STATE>::type>::type
    operator()(Event const &evt, FSM &fsm, STATE &state) const
    {
...
struct Substr_ : euml_action<Substr_<Container, Param1, Param2>>
{
    ...
    operator()(EVT const &evt, FSM &fsm, SourceState &src, TargetState &tgt) const
    {
        return (Container()(evt, fsm, src, tgt)).substr(Param1()(evt, fsm, src, tgt), Param2()(evt, fsm, src, tgt));
    }
    template <class Event, class FSM, class STATE>
    typename state_action_result<Event, FSM, STATE>::type
    operator()(Event const &evt, FSM &fsm, STATE &state) const
    {
        return (Container()(evt, fsm, state)).substr(Param1()(evt, fsm, state), Param2()(evt, fsm, state));
    }
};
template <class Container>
...
struct StringCompare_ : euml_action<StringCompare_<Container, Param1, Param2, Param3, Param4>>
{
    ...
    operator()(EVT const &evt, FSM &fsm, SourceState &src, TargetState &tgt) const
    {
        return (Container()(evt, fsm, src, tgt)).compare(Param1()(evt, fsm, src, tgt), Param2()(evt, fsm, src, tgt), Param3()(evt, fsm, src, tgt), Param4()(evt, fsm, src, tgt));
    }
    template <class Event, class FSM, class STATE>
    typename ::boost::enable_if<
        typename ::boost::mpl::has_key<
    ...
    operator()(Event const &evt, FSM &fsm, STATE &state) const
    {
        return (Container()(evt, fsm, state)).compare(Param1()(evt, fsm, state), Param2()(evt, fsm, state), Param3()(evt, fsm, state), Param4()(evt, fsm, state));
    }
};
template <class Container, class Param1>
    ...
    : euml_action<StringCompare_<Container, Param1, Param2, Param3, void>>
{
    ...
    operator()(EVT const &evt, FSM &fsm, SourceState &src, TargetState &tgt) const
    {
        return (Container()(evt, fsm, src, tgt)).compare(Param1()(evt, fsm, src, tgt), Param2()(evt, fsm, src, tgt), Param3()(evt, fsm, src, tgt));
    }
    template <class Event, class FSM, class STATE>
    typename ::boost::enable_if<
        typename ::boost::mpl::has_key<
    ...
    operator()(Event const &evt, FSM &fsm, STATE &state) const
    {
        return (Container()(evt, fsm, state)).compare(Param1()(evt, fsm, state), Param2()(evt, fsm, state), Param3()(evt, fsm, state));
    }
};
...
struct Append_ : euml_action<Append_<Container, Param1, Param2, Param3>>
{
    ...
    operator()(EVT const &evt, FSM &fsm, SourceState &src, TargetState &tgt) const
    {
        return (Container()(evt, fsm, src, tgt)).append(Param1()(evt, fsm, src, tgt), Param2()(evt, fsm, src, tgt), Param3()(evt, fsm, src, tgt));
    }
    template <class Event, class FSM, class STATE>
    typename ::boost::enable_if<
        typename ::boost::mpl::has_key<
    ...
    operator()(Event const &evt, FSM &fsm, STATE &state) const
    {
        return (Container()(evt, fsm, state)).append(Param1()(evt, fsm, state), Param2()(evt, fsm, state), Param3()(evt, fsm, state));
    }
};
template <class Container, class Param1>
...
struct StringInsert_ : euml_action<StringInsert_<Container, Param1, Param2, Param3, Param4>>
{
    ...
    operator()(EVT const &evt, FSM &fsm, SourceState &src, TargetState &tgt) const
    {
        return (Container()(evt, fsm, src, tgt)).insert(Param1()(evt, fsm, src, tgt), Param2()(evt, fsm, src, tgt), Param3()(evt, fsm, src, tgt), Param4()(evt, fsm, src, tgt));
    }
    template <class Event, class FSM, class STATE>
    typename ::boost::enable_if<
        typename ::boost::mpl::has_key<
    ...
    operator()(Event const &evt, FSM &fsm, STATE &state) const
    {
        return (Container()(evt, fsm, state)).insert(Param1()(evt, fsm, state), Param2()(evt, fsm, state), Param3()(evt, fsm, state), Param4()(evt, fsm, state));
    }
};
template <class Container, class Param1, class Param2>
    ...
    : euml_action<StringInsert_<Container, Param1, Param2, Param3, void>>
{
    ...
    operator()(EVT const &evt, FSM &fsm, SourceState &src, TargetState &tgt) const
    {
        return (Container()(evt, fsm, src, tgt)).insert(Param1()(evt, fsm, src, tgt), Param2()(evt, fsm, src, tgt), Param3()(evt, fsm, src, tgt));
    }
    template <class Event, class FSM, class STATE>
    typename ::boost::enable_if<
        typename ::boost::mpl::has_key<
    ...
    operator()(Event const &evt, FSM &fsm, STATE &state) const
    {
        return (Container()(evt, fsm, state)).insert(Param1()(evt, fsm, state), Param2()(evt, fsm, state), Param3()(evt, fsm, state));
    }
};
...
struct StringErase_ : euml_action<StringErase_<Container, Param1, Param2>>
{
    ...
    operator()(EVT const &evt, FSM &fsm, SourceState &src, TargetState &tgt) const
    {
        return (Container()(evt, fsm, src, tgt)).erase(Param1()(evt, fsm, src, tgt), Param2()(evt, fsm, src, tgt));
    }
    template <class Event, class FSM, class STATE>
    typename state_action_result<Event, FSM, STATE>::type
    operator()(Event const &evt, FSM &fsm, STATE &state) const
    {
        return (Container()(evt, fsm, state)).erase(Param1()(evt, fsm, state), Param2()(evt, fsm, state));
    }
};
template <class Container>
...
struct StringAssign_ : euml_action<StringAssign_<Container, Param1, Param2, Param3>>
{
    ...
    operator()(EVT const &evt, FSM &fsm, SourceState &src, TargetState &tgt) const
    {
        return (Container()(evt, fsm, src, tgt)).assign(Param1()(evt, fsm, src, tgt), Param2()(evt, fsm, src, tgt), Param3()(evt, fsm, src, tgt));
    }
    template <class Event, class FSM, class STATE>
    typename ::boost::enable_if<
        typename ::boost::mpl::has_key<
    ...
    operator()(Event const &evt, FSM &fsm, STATE &state) const
    {
        return (Container()(evt, fsm, state)).assign(Param1()(evt, fsm, state), Param2()(evt, fsm, state), Param3()(evt, fsm, state));
    }
};
template <class Container, class Param1>
...
struct StringReplace_ : euml_action<StringReplace_<Container, Param1, Param2, Param3, Param4>>
{
    ...
    operator()(EVT const &evt, FSM &fsm, SourceState &src, TargetState &tgt) const
    {
        return (Container()(evt, fsm, src, tgt)).replace(Param1()(evt, fsm, src, tgt), Param2()(evt, fsm, src, tgt), Param3()(evt, fsm, src, tgt), Param4()(evt, fsm, src, tgt));
    }
    template <class Event, class FSM, class STATE>
    typename ::boost::enable_if<
        typename ::boost::mpl::has_key<
    ...
    operator()(Event const &evt, FSM &fsm, STATE &state) const
    {
        return (Container()(evt, fsm, state)).replace(Param1()(evt, fsm, state), Param2()(evt, fsm, state), Param3()(evt, fsm, state), Param4()(evt, fsm, state));
    }
};
    ...
    : euml_action<StringReplace_<Container, Param1, Param2, Param3, void>>
{
    ...
    operator()(EVT const &evt, FSM &fsm, SourceState &src, TargetState &tgt) const
    {
        return (Container()(evt, fsm, src, tgt)).replace(Param1()(evt, fsm, src, tgt), Param2()(evt, fsm, src, tgt), Param3()(evt, fsm, src, tgt));
    }
    template <class Event, class FSM, class STATE>
    typename ::boost::enable_if<
        typename ::boost::mpl::has_key<
    ...
    operator()(Event const &evt, FSM &fsm, STATE &state) const
    {
        return (Container()(evt, fsm, state)).replace(Param1()(evt, fsm, state), Param2()(evt, fsm, state), Param3()(evt, fsm, state));
    }
};
    ...
    : euml_action<StringCopy_<Container, Param1, Param2, Param3>>
{
    ...
    operator()(EVT const &evt, FSM &fsm, SourceState &src, TargetState &tgt) const
    {
        return (Container()(evt, fsm, src, tgt)).copy(Param1()(evt, fsm, src, tgt), Param2()(evt, fsm, src, tgt), Param3()(evt, fsm, src, tgt));
    }
    template <class Event, class FSM, class STATE>
    typename state_action_result<Event, FSM, STATE>::type
    operator()(Event const &evt, FSM &fsm, STATE &state) const
    {
        return (Container()(evt, fsm, state)).copy(Param1()(evt, fsm, state), Param2()(evt, fsm, state), Param3()(evt, fsm, state));
    }
};
