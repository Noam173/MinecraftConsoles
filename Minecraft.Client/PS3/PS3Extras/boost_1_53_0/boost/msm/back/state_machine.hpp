...
typedef ::boost::parameter::parameters<
    ::boost::parameter::required<::boost::msm::back::tag::front_end>, ::boost::parameter::optional<::boost::parameter::deduced<::boost::msm::back::tag::history_policy>, has_history_policy<::boost::mpl::_>>, ::boost::parameter::optional<::boost::parameter::deduced<::boost::msm::back::tag::compile_policy>, has_compile_policy<::boost::mpl::_>>, ::boost::parameter::optional<::boost::parameter::deduced<::boost::msm::back::tag::fsm_check_policy>, has_fsm_check<::boost::mpl::_>>, ::boost::parameter::optional<::boost::parameter::deduced<::boost::msm::back::tag::queue_container_policy>, has_queue_container_policy<::boost::mpl::_>>>
...
template <
    class A0, class A1 = parameter::void_, class A2 = parameter::void_, class A3 = parameter::void_, class A4 = parameter::void_>
class state_machine : // public Derived
                      public ::boost::parameter::binding<
                          typename state_machine_signature::bind<A0, A1, A2, A3, A4>::type, ::boost::msm::back::tag::front_end>::type,
                                                    ...
                                                    typename state_machine_signature::bind<A0, A1, A2, A3, A4>::type, ::boost::msm::back::tag::front_end>::type>
{
  public:
    // Create ArgumentPack
    typedef typename state_machine_signature::bind<A0, A1, A2, A3, A4>::type
        state_machine_args;
  ...
  private:
    ...
    typedef typename boost::mpl::eval_if<
        ...
        // default
        ::boost::mpl::identity<active_state_switch_after_entry>>::type active_state_switching;
...
#undef MSM_VISITOR_HELPER_EXECUTE_SUB
  ...
  public:
    ...
    typedef typename ::boost::mpl::eval_if<
        ...
        ::boost::mpl::identity<InitEvent>>::type fsm_initial_event;
    ...
    typedef typename ::boost::mpl::eval_if<
        ...
        ::boost::mpl::identity<ExitEvent>>::type fsm_final_event;
    ...
    struct exit_pt : public ExitPoint
    {
        ...
        typedef typename ExitPoint::event Event;
    ...
    struct row_
    {
        ...
        typedef typename ::boost::mpl::eval_if<
            ...
            ::boost::mpl::eval_if<
                ...
                ::boost::mpl::identity<T2>>>::type next_state_type;
        ...
        static HandledEnum execute(library_sm &fsm, int region_index, int state, transition_event const &evt)
        {
            ...
            execute_exit<current_state_type>(::boost::fusion::at_key<current_state_type>(fsm.m_substate_list), evt, fsm);
            ...
            convert_event_and_execute_entry<next_state_type, T2>(::boost::fusion::at_key<next_state_type>(fsm.m_substate_list), evt, fsm);
    ...
    struct create_real_stt
    {
        ...
        typedef typename ::boost::mpl::fold<
            ...
            ::boost::mpl::push_back<::boost::mpl::placeholders::_1,
                                    make_row_tag<::boost::mpl::placeholders::_2, BaseType>>>::type type;
    };
    ...
    struct get_internal_transition_table
    {
        ...
        typedef typename ::boost::mpl::fold<
            ...
            ::boost::mpl::push_back<::boost::mpl::placeholders::_1,
                                    make_row_tag<::boost::mpl::placeholders::_2, StateType>>>::type recursive_istt_with_tag;
        ...
        typedef typename ::boost::mpl::eval_if<
            ...
            ::boost::mpl::identity<::boost::mpl::vector0<>>>::type type;
    };
    template <class StateType>
    ...
    typedef typename ::boost::msm::back::generate_event_set<
        typename create_real_stt<library_sm, typename library_sm::internal_transition_table>::type>::type processable_events_internal_table;
    ...
    struct extend_table
    {
        ...
        typedef typename ::boost::mpl::fold<
            ...
            ::boost::mpl::push_back<::boost::mpl::placeholders::_1,
                                    make_row_tag<::boost::mpl::placeholders::_2, Composite>>>::type internal_stt;
        ...
        typedef typename ::boost::mpl::fold<state_list, stt_plus_internal,
                                            ::boost::mpl::insert_range<
                                                ...
                                                get_internal_transition_table<
                                                    ...
                                                    is_composite_state<::boost::mpl::placeholders::_2>>>>::type type;
    };
    ...
    void start(Event const &incomingEvent)
    {
        ...
        ::boost::mpl::for_each<initial_states, boost::msm::wrap<mpl::placeholders::_1>>(call_init<Event>(incomingEvent, this));
        // give a chance to handle an anonymous (eventless) transition
        handle_eventless_transitions_helper<library_sm> eventless_helper(this, true);
        eventless_helper.process_completion_event();
    }
    ...
    struct serialize_state
    {
        ...
        typename ::boost::enable_if<
            typename ::boost::mpl::or_<
                ...
                typename is_composite_state<T>::type>::type,
            void>::type
        operator()(T &t) const
        {
            ar_ & t;
    ...
    {
        get_state_id_helper(int id, const BaseState **res, const library_sm *self_) : result_state(res), searched_id(id), self(self_)
        {
        }
    ...
    {
        return const_cast<State>(&(::boost::fusion::at_key<
    ...
    {
        return &(static_cast<typename boost::add_reference<typename ::boost::remove_pointer<State>::type>::type>(::boost::fusion::at_key<typename ::boost::remove_pointer<State>::type>(m_substate_list)));
    }
    // as a reference
    template <class State>
    typename ::boost::enable_if<typename ::boost::is_reference<State>::type, State>::type
...
#undef MSM_VISIT_STATE_SUB
  ...
  public:
    ...
    state_machine<A0, A1, A2, A3, A4>()
        : Derived(), m_events_queue(), m_deferred_events_queue(), m_history(), m_event_processing(false), m_is_included(false), m_visitors(), m_substate_list()
    {
    ...
    template <class Expr>
    state_machine<A0, A1, A2, A3, A4>(Expr const &expr, typename ::boost::enable_if<typename ::boost::proto::is_expr<Expr>::type>::type * = 0)
        : Derived(), m_events_queue(), m_deferred_events_queue(), m_history(), m_event_processing(false), m_is_included(false), m_visitors(), m_substate_list()
    {
...
#define MSM_CONSTRUCTOR_HELPER_EXECUTE(z, n, unused)                                                                                                                                      \
    template <BOOST_PP_ENUM_PARAMS(n, class ARG)>                                                                                                                                         \
    state_machine<A0, A1, A2, A3, A4>(BOOST_PP_ENUM(n, MSM_CONSTRUCTOR_HELPER_EXECUTE_SUB, ~),                                                                                            \
                                      typename ::boost::disable_if<typename ::boost::proto::is_expr<ARG0>::type>::type * = 0)                                                             \
        : Derived(BOOST_PP_ENUM_PARAMS(n, t)), m_events_queue(), m_deferred_events_queue(), m_history(), m_event_processing(false), m_is_included(false), m_visitors(), m_substate_list() \
    {                                                                                                                                                                                     \
        ::boost::mpl::for_each<seq_initial_states, ::boost::msm::wrap<mpl::placeholders::_1>>(init_states(m_states));                                                                     \
        m_history.set_initial_states(m_states);                                                                                                                                           \
        fill_states(this);                                                                                                                                                                \
    ...
    state_machine<A0, A1, A2, A3, A4>(Expr const &expr, BOOST_PP_ENUM(n, MSM_CONSTRUCTOR_HELPER_EXECUTE_SUB, ~),                                                                          \
...
#undef MSM_CONSTRUCTOR_HELPER_EXECUTE_SUB
    ...
    state_machine<A0, A1, A2, A3, A4>(library_sm const &rhs)
        : Derived(rhs)
    {
        if (this != &rhs)
        {
    ...
    {
        handle_defer_helper(deferred_msg_queue_helper<library_sm> &a_queue) : events_queue(a_queue), next_deferred_event()
        {
        }
        void do_pre_handle_deferred()
        {
        ...
        void process_completion_event()
        {
            typedef typename ::boost::mpl::deref<
                typename ::boost::mpl::begin<
                    typename find_completion_events<StateType>::type>::type>::type first_completion_event;
            if (handled)
            {
    ...
    execute_return process_event_internal(Event const &evt, bool is_direct_call)
    {
        ...
        if (is_event_handling_blocked_helper<Event>(::boost::mpl::bool_<has_fsm_blocking_states<library_sm>::type::value>()))
        {
            return HANDLED_TRUE;
        }
        // if a message queue is needed and processing is on the way
        if (!do_pre_msg_queue_helper<Event>(evt, ::boost::mpl::bool_<is_no_message_queue<library_sm>::type::value>()))
        {
        ...
        else
        {
            ...
            // process event
            HandledEnum handled = this->do_process_helper<Event>(evt, ::boost::mpl::bool_<is_no_exception_thrown<library_sm>::type::value>(), is_direct_call);
            if (handled)
            {
                ret_handled = handled;
            }
...
#undef MSM_COMPOSITE_ACCEPT_SUB2
    ...
    struct call_init
    {
        call_init(Event const &an_event, library_sm *self_) : evt(an_event), self(self_)
        {
        }
        template <class State>
        void operator()(boost::msm::wrap<State> const &)
    ...
    flag_handler *get_entries_for_flag() const
    {
        ...
        // build a state list
        ::boost::mpl::for_each<state_list, boost::msm::wrap<::boost::mpl::placeholders::_1>>(init_flags<Flag>(flags_entries));
...
#define MSM_VISITOR_ARGS_EXECUTE(z, n, unused)                                                                                           \
    ...
    {                                                                                                                                    \
        ...
        helper(library_sm *sm,                                                                                                           \
               int id, StateType &astate)                                                                                                \
        {                                                                                                                                \
            void (StateType::*caccept)(BOOST_PP_ENUM(n, MSM_VISITOR_ARGS_TYPEDEF_SUB, ~)) = &StateType::composite_accept;                \
...
// and also to MS VC < 8
  ...
  private:
    ...
    struct add_state
    {
        ...
        template <class StateType>
        typename ::boost::enable_if<
            typename boost::mpl::and_<typename boost::mpl::not_<typename is_composite_state<StateType>::type>::type,
                                      typename boost::mpl::not_<typename is_pseudo_exit<StateType>::type>::type>::type,
            void>::type
    ...
    struct copy_helper
    {
        copy_helper(library_sm *sm) : m_sm(sm)
        {
        }
        template <class StateType>
        void operator()(::boost::msm::wrap<StateType> const &)
        ...
        {
            visitor_args<StateType, StateType::accept_sig::args_number>::template helper<StateType>(m_sm, id, ::boost::fusion::at_key<StateType>(m_sm->m_substate_list));
        }
        template <class StateType>
                 ...
                 ::boost::msm::back::dummy<0> = 0)
    {
        ...
        ::boost::mpl::for_each<state_list, ::boost::msm::wrap<::boost::mpl::placeholders::_1>>(copy_helper(this));
    }
    ...
    {
        entry_exit_helper(int id, Event const &e, library_sm *self_) : state_id(id), evt(e), self(self_)
        {
        }
    ...
    struct region_start_helper
    {
        ...
        static void do_start(library_sm *self_, Event const &incomingEvent)
        {
            ...
            ::boost::mpl::for_each<state_list, ::boost::msm::wrap<::boost::mpl::placeholders::_1>>(entry_exit_helper<Event, true>(self_->m_states[region_id::value], incomingEvent, self_));
            region_start_helper<::boost::mpl::int_<region_id::value + 1>>::do_start(self_, incomingEvent);
        }
    };
    template <int Dummy>
    ...
    struct find_region_id
    {
        ...
        struct In<-1, Dummy>
        {
            typedef typename build_orthogonal_regions<
                library_sm,
                initial_states>::type all_regions;
            enum
            {
                region_index = find_region_index < all_regions,
                StateType > ::value
            };
        };
        enum
        {
            region_index = In<StateType::zone_index>::region_index
        };
    };
    ...
    struct direct_event_start_helper
    {
        ...
        typename ::boost::enable_if<
            typename ::boost::mpl::and_<
                ...
                typename ::boost::mpl::and_<typename has_direct_entry<EventType>::type,
                                            typename ::boost::mpl::not_<typename ::boost::mpl::is_sequence<typename EventType::active_state>::type>::type>::type>::type,
            void>::type
            ...
            typename ::boost::mpl::and_<
                ...
                typename ::boost::mpl::and_<typename has_direct_entry<EventType>::type,
                                            typename ::boost::mpl::is_sequence<
                                                typename EventType::active_state>::type>::type>::type,
            void>::type
        operator()(EventType const &evt, FsmType &fsm, ::boost::msm::back::dummy<2> = 0)
        {
            (static_cast<Derived *>(self))->on_entry(evt, fsm);
            ::boost::mpl::for_each<typename EventType::active_state,
                                   ::boost::msm::wrap<::boost::mpl::placeholders::_1>>(fork_helper<EventType>(self, evt));
        ...
        template <class EventType, class FsmType>
        typename ::boost::enable_if<
            typename is_pseudo_entry<typename EventType::active_state>::type, void>::type
      ...
      private:
        ...
        struct fork_helper
        {
            fork_helper(library_sm *self_, EventType const &evt_) : helper_self(self_), helper_evt(evt_)
            {
            }
            template <class StateType>
            void operator()(::boost::msm::wrap<StateType> const &)
    ...
    struct region_entry_exit_helper
    {
        ...
        static void do_entry(library_sm *self_, Event const &incomingEvent)
        {
            ...
            region_entry_exit_helper<::boost::mpl::int_<region_id::value + 1>>::do_entry(self_, incomingEvent);
        }
        template <class Event>
        static void do_exit(library_sm *self_, Event const &incomingEvent)
        {
            ::boost::mpl::for_each<state_list, ::boost::msm::wrap<::boost::mpl::placeholders::_1>>(entry_exit_helper<Event, false>(self_->m_states[region_id::value], incomingEvent, self_));
            region_entry_exit_helper<::boost::mpl::int_<region_id::value + 1>>::do_exit(self_, incomingEvent);
        }
    };
    template <int Dummy>
  ...
  private:
    ...
    deferred_msg_queue_helper<library_sm> m_deferred_events_queue;
