...
struct dispatch_table
{
  private:
    ...
    struct make_chain_row_from_map_entry
    {
        ...
        enum
        {
            number_frows = ::boost::mpl::count_if < typename Entry::second,
            has_is_frow<::boost::mpl::placeholders::_1> > ::value
        };
        ...
        struct erase_first_rows
        {
            typedef typename ::boost::mpl::erase<
                ...
                typename ::boost::mpl::advance<
                    typename ::boost::mpl::begin<Sequence>::type,
                    ::boost::mpl::int_<NumberToDelete>>::type>::type type;
        };
        ...
        typedef typename ::boost::mpl::eval_if<
            ...
            ::boost::mpl::identity<typename Entry::second>>::type filtered_stt;
    ...
    struct change_frow_event
    {
        typedef typename ::boost::mpl::eval_if<
            ...
            boost::mpl::identity<FrowTransition>>::type type;
    };
    ...
    struct default_init_cell
    {
        ...
        typename ::boost::disable_if<
            typename ::boost::mpl::or_<
                ...
                typename ::boost::is_same<State, Fsm>::type>::type,
            void>::type
  ...
  public:
    ...
    dispatch_table()
    {
        ...
        typedef typename ::boost::mpl::reverse_fold<
            // filter on event
            ::boost::mpl::filter_view<Stt, boost::mpl::or_<
            ...
            ::boost::mpl::if_<
                ...
                ::boost::mpl::insert<
                    ::boost::mpl::placeholders::_1,
                    ::boost::mpl::pair<transition_source_type<::boost::mpl::placeholders::_2>,
                                       make_vector<change_frow_event<::boost::mpl::placeholders::_2>>>>>>::type map_of_row_seq;
        ...
        typedef typename ::boost::mpl::fold<
            ...
            ::boost::mpl::if_<
                ...
                ::boost::mpl::push_back<::boost::mpl::placeholders::_1,
                                        get_first_element_pair_second<::boost::mpl::placeholders::_2>>>>::type chained_rows;
