...
struct set_insert_range
{
    typedef typename ::boost::mpl::fold<
        Range, Sequence,
        ::boost::mpl::insert<::boost::mpl::placeholders::_1, ::boost::mpl::placeholders::_2>>::type type;
};
    ...
    typedef typename ::boost::mpl::fold<
        ...
        ::boost::mpl::pair<
            ...
            ::boost::mpl::if_<
                ...
                ::boost::mpl::next<::boost::mpl::second<mpl::placeholders::_1>>>> // pair
        ...
        ::boost::mpl::pair<
            ...
            ::boost::mpl::if_<
                ::boost::mpl::has_key<::boost::mpl::first<::boost::mpl::placeholders::_1>,
                                      transition_target_type<::boost::mpl::placeholders::_2>>,
                ::boost::mpl::second<::boost::mpl::placeholders::_1>,
                ::boost::mpl::next<::boost::mpl::second<::boost::mpl::placeholders::_1>>>> // pair
        >::type all_state_ids;
...
struct get_active_state_switch_policy
{
    ...
    typedef typename ::boost::mpl::eval_if<
        typename ::boost::is_same<
            iter,
            typename ::boost::mpl::end<typename Fsm::configuration>::type>::type,
        get_active_state_switch_policy_helper<Fsm>,
        get_active_state_switch_policy_helper2<iter>>::type type;
};
...
struct have_same_source
{
    enum
    {
        current_state1 = get_state_id < stt,
        typename Transition1::current_state_type > ::type::value
    };
    enum
    {
        current_state2 = get_state_id < stt,
        typename Transition2::current_state_type > ::type::value
    };
    enum
    {
        value = ((int)current_state1 == (int)current_state2)
    };
};
...
struct is_composite_state
{
    enum
    {
        value = has_composite_tag<State>::type::value
    };
...
struct generate_state_set
{
    ...
    typedef typename ::boost::mpl::fold<
        ...
        ::boost::mpl::insert<::boost::mpl::placeholders::_1, ::boost::mpl::placeholders::_2>>::type source_set;
    typedef typename ::boost::mpl::fold<
        targets, source_set,
        ::boost::mpl::insert<::boost::mpl::placeholders::_1, ::boost::mpl::placeholders::_2>>::type type;
};
    ...
    typedef typename ::boost::mpl::fold<
        ...
        ::boost::mpl::if_<
            ...
            ::boost::mpl::insert<::boost::mpl::placeholders::_1,
                                 transition_event<::boost::mpl::placeholders::_2>>>>::type type;
};
...
struct is_pseudo_entry
{
    typedef typename ::boost::mpl::if_<typename has_pseudo_entry<State>::type,
                                       ::boost::mpl::bool_<true>, ::boost::mpl::bool_<false>>::type type;
};
...
struct convert_fake_state
{
    ...
    typedef typename ::boost::mpl::if_<
        ...
        typename ::boost::mpl::identity<StateType>::type>::type type;
};
...
struct create_stt
{
    ...
    typedef typename ::boost::mpl::fold<
        ...
        ::boost::mpl::if_<
            ...
            ::boost::mpl::insert<::boost::mpl::placeholders::_1, ::boost::mpl::end<::boost::mpl::placeholders::_1>,
                                 not_a_row<get_wrapped_state<::boost::mpl::placeholders::_2>>>>>::type with_init;
    ...
    typedef typename get_explicit_creation_as_sequence<
        typename ::boost::mpl::eval_if<
            ...
            ::boost::mpl::vector0<>>::type>::type fake_explicit_created;
    ...
    typedef typename ::boost::mpl::fold<
        ...
        ::boost::mpl::if_<
            ...
            ::boost::mpl::insert<::boost::mpl::placeholders::_1, ::boost::mpl::end<mpl::placeholders::_1>,
                                 not_a_row<get_wrapped_state<::boost::mpl::placeholders::_2>>>>>::type type;
};
...
struct recursive_get_internal_transition_table
{
    ...
    typedef typename ::boost::mpl::fold<
        ...
        ::boost::mpl::insert_range<::boost::mpl::placeholders::_1, ::boost::mpl::end<::boost::mpl::placeholders::_1>,
                                   recursive_get_internal_transition_table<::boost::mpl::placeholders::_2, is_composite_state<::boost::mpl::placeholders::_2>>>>::type type;
};
...
struct recursive_get_transition_table
{
    ...
    typedef typename ::boost::mpl::fold<
        ...
        ::boost::mpl::insert_range<::boost::mpl::placeholders::_1, ::boost::mpl::end<mpl::placeholders::_1>,
                                   recursive_get_transition_table<::boost::mpl::placeholders::_2>>>::type type;
};
...
struct has_fsm_deferred_events
{
    ...
    typedef typename ::boost::mpl::or_<
        ...
        ::boost::mpl::bool_<::boost::mpl::count_if<
                                ...
                                has_activate_deferred_events<::boost::mpl::placeholders::_1>>::value != 0>>::type found_in_fsm;

    typedef typename ::boost::mpl::or_<
        found_in_fsm,
        ::boost::mpl::bool_<::boost::mpl::count_if<
                                state_list, has_state_delayed_events<
                                                ::boost::mpl::placeholders::_1>>::value != 0>>::type type;
};
...
struct has_fsm_eventless_transition
{
    ...
    typedef ::boost::mpl::bool_<::boost::mpl::count_if<
                                    event_list, is_completion_event<::boost::mpl::placeholders::_1>>::value != 0>
        type;
};
template <class Derived>
...
struct make_entry
{
    typedef typename ::boost::mpl::if_<
        ...
        typename ::boost::mpl::if_<
            ...
            typename ::boost::mpl::identity<StateType>::type>::type>::type type;
};
// metafunction used to say if a SM has pseudo exit states
template <class StateType>
struct has_exit_pseudo_states_helper
{
    ...
    typedef ::boost::mpl::bool_<::boost::mpl::count_if<
                                    state_list, is_pseudo_exit<::boost::mpl::placeholders::_1>>::value != 0>
        type;
};
template <class StateType>
...
struct get_flag_list
{
    typedef typename ::boost::mpl::insert_range<
        ...
        typename StateType::internal_flag_list>::type type;
};
...
struct is_state_blocking
{
    typedef typename ::boost::mpl::fold<
        ...
        ::boost::mpl::if_<
            ...
            ::boost::mpl::insert<::boost::mpl::placeholders::_1, ::boost::mpl::placeholders::_2>,
            ::boost::mpl::placeholders::_1>>::type blocking_flags;
...
struct has_fsm_blocking_states
{
    ...
    typedef typename ::boost::mpl::fold<
        ...
        ::boost::mpl::if_<
            ...
            ::boost::mpl::insert<::boost::mpl::placeholders::_1, ::boost::mpl::placeholders::_2>,
            ::boost::mpl::placeholders::_1>>::type blocking_states;
...
struct is_no_exception_thrown
{
    typedef ::boost::mpl::bool_<::boost::mpl::count_if<
                                    ...
                                    has_no_exception_thrown<::boost::mpl::placeholders::_1>>::value != 0>
        found;
...
struct is_no_message_queue
{
    typedef ::boost::mpl::bool_<::boost::mpl::count_if<
                                    typename StateType::configuration,
                                    has_no_message_queue<::boost::mpl::placeholders::_1>>::value != 0>
        found;
...
struct is_active_state_switch_policy
{
    typedef ::boost::mpl::bool_<::boost::mpl::count_if<
                                    typename StateType::configuration,
                                    has_active_state_switch_policy<::boost::mpl::placeholders::_1>>::value != 0>
        found;
...
struct build_one_orthogonal_region
{
    ...
    struct row_to_incidence : ::boost::mpl::vector<
                                  ::boost::mpl::pair<
    ...
    typedef typename ::boost::mpl::fold<
        TransitionTable,
        ::boost::mpl::vector<>,
        transition_incidence_list_helper<::boost::mpl::placeholders::_1, ::boost::mpl::placeholders::_2>>::type transition_incidence_list;

    typedef ::boost::msm::mpl_graph::incidence_list_graph<transition_incidence_list>
        transition_graph;

    struct preordering_dfs_visitor : ::boost::msm::mpl_graph::dfs_default_visitor_operations
    {
        template <typename Node, typename Graph, typename State>
        struct discover_vertex : ::boost::mpl::insert<State, Node>
        {
        };
    };
...
struct build_orthogonal_regions
{
    typedef typename ::boost::mpl::fold<
        ...
        ::boost::mpl::push_back<
            ::boost::mpl::placeholders::_1,
            build_one_orthogonal_region<typename Fsm::stt, ::boost::mpl::placeholders::_2>>>::type without_entries;

    typedef typename ::boost::mpl::fold<
        typename find_entry_states<Fsm>::type, ::boost::mpl::vector0<>,
        ::boost::mpl::push_back<
            ::boost::mpl::placeholders::_1,
            build_one_orthogonal_region<typename Fsm::stt, ::boost::mpl::placeholders::_2>>>::type only_entries;

    typedef typename ::boost::mpl::fold<
        only_entries, without_entries,
        add_entry_region<::boost::mpl::placeholders::_2, ::boost::mpl::placeholders::_1>>::type type;
};
...
struct find_region_index
{
    typedef typename ::boost::mpl::fold<
        ...
        ::boost::mpl::if_<
            ...
            ::boost::mpl::pair<
                ::boost::mpl::first<::boost::mpl::placeholders::_1>,
                ::boost::mpl::next<::boost::mpl::second<::boost::mpl::placeholders::_1>>>>>::type result_pair;
...
struct check_regions_orthogonality
{
    ...
    typedef typename ::boost::mpl::fold<
        ...
        ::boost::mpl::plus<::boost::mpl::placeholders::_1, ::boost::mpl::size<::boost::mpl::placeholders::_2>>>::type number_of_states_in_regions;

    typedef typename ::boost::mpl::fold<
        regions, mpl::set0<>,
        set_insert_range<
            ::boost::mpl::placeholders::_1,
            ::boost::mpl::placeholders::_2>>::type one_big_states_set;

    enum
    {
        states_in_regions_raw = number_of_states_in_regions::value
    };
    enum
    {
        cumulated_states_in_regions_raw = ::boost::mpl::size<one_big_states_set>::value
    };
};
...
struct check_no_unreachable_state
{
    ...
    typedef typename set_insert_range<
        ...
        typename ::boost::mpl::eval_if<
            ...
            ::boost::mpl::vector0<>>::type>::type with_explicit_creation;

    enum
    {
        states_in_fsm = ::boost::mpl::size<typename Fsm::substate_list>::value
    };
    enum
    {
        cumulated_states_in_regions = ::boost::mpl::size<with_explicit_creation>::value
    };
};
    ...
    is_exit_state_active(FSM &fsm)
{
    ...
    return (std::find(comp.current_state(), comp.current_state() + Composite::nr_regions::value, state_id) != comp.current_state() + Composite::nr_regions::value);
}
template <class StateType, class OwnerFct, class FSM>
inline
