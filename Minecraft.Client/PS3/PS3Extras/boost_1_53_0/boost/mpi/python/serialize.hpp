...
#define BOOST_PYTHON_DIRECT_SERIALIZATION_ARCHIVE(IArchiver, OArchiver)      \
    ...
    {                                                                        \
                                                                             ...
                                                                             \
    template <>                                                              \
    struct output_archiver<IArchiver>                                        \
    {                                                                        \
        typedef OArchiver type;                                              \
    };                                                                       \
                                                                             \
    template <>                                                              \
    struct input_archiver<OArchiver>                                         \
    {                                                                        \
        typedef IArchiver type;                                              \
    };                                                                       \
    }                                                                        \
    }
...
#define BOOST_PYTHON_DIRECT_SERIALIZATION_ARCHIVE_IMPL(IArchiver, OArchiver)               \
    ...
    namespace detail                                                                       \
    {                                                                                      \
    template class BOOST_MPI_PYTHON_DECL direct_serialization_table<IArchiver, OArchiver>; \
                                                                                           \
    template <>                                                                            \
