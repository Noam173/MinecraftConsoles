      ...
      public archive::detail::shared_ptr_helper
{
  public:
    ...
    packed_iarchive(MPI_Comm const &comm, std::size_t s = 0,
        ...
        : iprimitive(internal_buffer_, comm), archive::detail::common_iarchive<packed_iarchive>(flags), internal_buffer_(s)
    {
    }
    ...
    {
        typedef typename mpl::apply1<use_array_optimization, BOOST_DEDUCED_TYPENAME remove_const<T>::type>::type use_optimized;
