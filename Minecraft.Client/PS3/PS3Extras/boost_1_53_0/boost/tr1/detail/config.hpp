...
#if (defined(__GNUC__) && !(defined(linux) || defined(__linux) || defined(__linux__))) || (!defined(_AIX) && defined(__IBMCPP__) && (__IBMCPP__ >= 800))
...
#if defined(_MSC_VER) && (_MSC_VER >= 1500) && defined(_MSC_FULL_VER) && \
