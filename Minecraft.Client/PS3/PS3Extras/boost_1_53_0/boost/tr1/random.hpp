...
{
    typedef ::boost::random::mersenne_twister<UIntType, w, n, m, r, a, u, s, b, t, c, l, 0> imp_type;
...
void xor_combine<UniformRandomNumberGenerator1, s1, UniformRandomNumberGenerator2, s2>::init_minmax()
{
    ...
    //
    if ((((std::numeric_limits<result_type>::max)() >> s1) < (m_b1.max)()) || ((((std::numeric_limits<result_type>::max)()) >> s2) < (m_b2.max)()))
    {
