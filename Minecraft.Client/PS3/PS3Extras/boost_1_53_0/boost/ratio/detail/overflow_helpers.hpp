    ...
    typedef typename ratio_multiply<
        ...
        ratio<
            boost::ratio_detail::br_add<
                ...
                boost::ratio_detail::br_mul<R2::num / gcd_n1_n2, R1::den / gcd_d1_d2>::value>::value,
            R2::den>>::type type;
};
...
struct ratio_multiply
{
  ...
  public:
    typedef typename ratio<
        ...
        boost::ratio_detail::br_mul<R2::den / gcd_n1_d2, R1::den / gcd_d1_n2>::value>::type type;
};
...
struct ratio_divide
{
  ...
  public:
    typedef typename ratio<
        boost::ratio_detail::br_mul<R1::num / gcd_n1_n2, R2::den / gcd_d1_d2>::value,
        boost::ratio_detail::br_mul<R2::num / gcd_n1_n2, R1::den / gcd_d1_d2>::value>::type type;
};
template <class R1, class R2>
...
{
    static const bool value = ratio_less1<ratio<R2::den, M2>, ratio<R1::den, M1>>::value;
};
