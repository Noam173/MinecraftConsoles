...
#if !defined(BOOST_MPL_CFG_NO_NESTED_VALUE_ARITHMETIC_2) && !defined(BOOST_MPL_PREPROCESSING_MODE) && (defined(BOOST_MSVC) || BOOST_WORKAROUND(__EDG_VERSION__, <= 238))
...
struct lcm
    : lcm_impl<
          typename lcm_tag<N1>::type, typename lcm_tag<N2>::type>::template apply<N1, N2>::type
{
...
template <typename T1, boost::intmax_t n1, bool n1_is_0, typename T2, boost::intmax_t n2, bool n2_is_0>
struct lcm_aux
