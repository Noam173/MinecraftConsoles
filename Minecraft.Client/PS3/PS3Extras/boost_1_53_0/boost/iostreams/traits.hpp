...
struct char_type_of
{
    ...
    typedef typename mpl::eval_if<
        is_std_io<U>,
        mpl::identity<char>,
        detail::member_char_type<U>>::type type;
};
...
struct char_type_of
{
    ...
    typedef typename mpl::eval_if<
        ...
        get_value_type<T>,
        detail::member_char_type<
            BOOST_DEDUCED_TYPENAME detail::unwrapped_type<T>::type>>::type type;
};
...
struct category_of
{
    ...
    typedef typename mpl::eval_if<
        ...
        detail::member_category<U>>::type type;
};
