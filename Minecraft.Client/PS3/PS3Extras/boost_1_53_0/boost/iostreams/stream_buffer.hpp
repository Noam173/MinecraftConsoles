...
struct stream_buffer_traits
{
    typedef typename mpl::if_<
        ...
        indirect_streambuf<T, Tr, Alloc, Mode>>::type type;
};
    ...
    : public detail::stream_buffer_traits<T, Tr, Alloc, Mode>::type
{
  private:
    BOOST_STATIC_ASSERT((
        is_convertible<
            BOOST_DEDUCED_TYPENAME iostreams::category_of<T>::type, Mode>::value));
    typedef typename detail::stream_buffer_traits<
        T, Tr, Alloc, Mode>::type base_type;
