...
#if BOOST_WORKAROUND(__MWERKS__, BOOST_TESTED_AT(0x3202)) || BOOST_WORKAROUND(BOOST_MSVC, <= 1300)
...
struct impl
{
    ...
    BOOST_STATIC_CONSTANT(
        bool, value = sizeof(is_dereferenceable_::check_increment(BOOST_comma(*x, 0))) == 1);
};
} // namespace is_dereferenceable_
