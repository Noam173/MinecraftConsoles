    ...
    : public linked_streambuf<BOOST_DEDUCED_TYPENAME char_type_of<T>::type, Tr>
{
  ...
  private:
    ...
    typedef BOOST_IOSTREAMS_BASIC_STREAMBUF(
        char_type, traits_type) streambuf_type;
...
direct_streambuf<T, Tr>::underflow()
{
    ...
    return gptr() != iend_ ? traits_type::to_int_type(*gptr()) : traits_type::eof();
}
...
direct_streambuf<T, Tr>::seekoff(off_type off, BOOST_IOS::seekdir way, BOOST_IOS::openmode which)
{
...
template <typename T, typename Tr>
inline typename direct_streambuf<T, Tr>::pos_type
direct_streambuf<T, Tr>::seekpos(pos_type sp, BOOST_IOS::openmode which)
{
...
template <typename T, typename Tr>
typename direct_streambuf<T, Tr>::pos_type direct_streambuf<T, Tr>::seek_impl(stream_offset off, BOOST_IOS::seekdir way, BOOST_IOS::openmode which)
{
    using namespace std;
