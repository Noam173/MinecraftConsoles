...
#define BOOST_IOSTREAMS_DEFINE_PUSH_IMPL(name, mode, ch, helper, has_return, result)                    \
    template <typename T>                                                                               \
    void BOOST_PP_CAT(name, _msvc_impl)(::boost::mpl::true_, const T &t BOOST_IOSTREAMS_PUSH_PARAMS())  \
    {                                                                                                   \
        t.push(*this);                                                                                  \
    }                                                                                                   \
    template <typename T>                                                                               \
    void BOOST_PP_CAT(name, _msvc_impl)(::boost::mpl::false_, const T &t BOOST_IOSTREAMS_PUSH_PARAMS()) \
    {                                                                                                   \
        this->helper(::boost::iostreams::detail::resolve<mode, ch>(t)                                   \
                         BOOST_IOSTREAMS_PUSH_ARGS());                                                  \
    }                                                                                                   \
    ...
    {                                                                                                   \
        this->BOOST_PP_CAT(name, _msvc_impl)(::boost::iostreams::detail::is_pipeline<T>(),              \
