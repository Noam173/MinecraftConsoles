...
struct stream_traits
{
    ...
    typedef typename iostreams::select< // Disambiguation required for Tru64.
        mpl::and_<
        ...
        else_,
        BOOST_IOSTREAMS_BASIC_OSTREAM(char_type, traits_type)>::type stream_type;
    typedef typename iostreams::select< // Disambiguation required for Tru64.
        mpl::and_<
            is_convertible<mode, input>,
            is_convertible<mode, output>>,
...
struct stream : detail::stream_base<Device, Tr, Alloc>
{
  ...
  private:
    typedef typename detail::stream_traits<
        Device, Tr>::stream_type stream_type;
