...
class basic_file
{
  ...
  private:
    struct impl
    {
        ...
        BOOST_IOSTREAMS_BASIC_FILEBUF(Ch)
        file_;
    };
...
template <typename Ch>
basic_file<Ch>::basic_file(const std::string &path, BOOST_IOS::openmode mode,
                           BOOST_IOS::openmode base_mode)
{
...
template <typename Ch>
inline std::streamsize basic_file<Ch>::read(char_type *s, std::streamsize n)
{
...
template <typename Ch>
inline std::streamsize basic_file<Ch>::write(const char_type *s, std::streamsize n)
{
    return pimpl_->file_.sputn(s, n);
}

template <typename Ch>
std::streampos basic_file<Ch>::seek(stream_offset off, BOOST_IOS::seekdir way,
                                    BOOST_IOS::openmode)
{
...
template <typename Ch>
void basic_file<Ch>::open(const std::string &path, BOOST_IOS::openmode mode,
                          BOOST_IOS::openmode base_mode)
{
