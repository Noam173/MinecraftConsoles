    ...
    : iterator_facade<segmented_iterator<Context>, forward_traversal_tag>
{
    ...
    struct deref
    {
        typedef
            typename result_of::deref<
                typename It::context_type::car_type::begin_type>::type
                type;
    ...
    // the bottom-most.
    template <
        typename It1, typename It2, int Size1 = It1::context_type::size::value, int Size2 = It2::context_type::size::value>
    struct equal_to
        : mpl::false_
    {
    };
    ...
    struct equal_to<It1, It2, Size, Size>
        : detail::segmented_equal_to<
              typename It1::context_type, typename It2::context_type>
    {
    };
