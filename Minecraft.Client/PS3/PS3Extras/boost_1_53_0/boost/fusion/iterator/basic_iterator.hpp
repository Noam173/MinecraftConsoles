    ...
    : iterator_facade<basic_iterator<Tag, Category, Seq, Index>, Category>
{
    ...
    struct advance
    {
        typedef basic_iterator<Tag, Category, Seq, Index + N::value>
            type;
    ...
    struct equal_to
        : mpl::and_<
              is_same<
                  typename remove_const<typename It1::seq_type>::type, typename remove_const<typename It2::seq_type>::type>,
