...
struct cons_advance
{
    typedef typename cons_advance<Cons, I - 1>::type::cdr_type
        type;
};
...
struct at_impl<cons_tag>
{
    ...
    struct apply
    {
        ...
        typedef typename mpl::if_<
            is_const<Sequence>, typename detail::cref_result<element>::type, typename detail::ref_result<element>::type>::type
            type;
