...
struct is_associative
    : is_base_of<
          associative_tag, typename category_of<T>::type>
{
};
...
struct is_incrementable
    : is_base_of<
          incrementable_traversal_tag, typename category_of<T>::type>
{
};
...
struct is_single_pass
    : is_base_of<
          single_pass_traversal_tag, typename category_of<T>::type>
{
};
...
struct is_forward
    : is_base_of<
          forward_traversal_tag, typename category_of<T>::type>
{
};
...
struct is_bidirectional
    : is_base_of<
          bidirectional_traversal_tag, typename category_of<T>::type>
{
};
...
struct is_random_access
    : is_base_of<
          random_access_traversal_tag, typename category_of<T>::type>
{
};
} // namespace traits
} // namespace fusion
