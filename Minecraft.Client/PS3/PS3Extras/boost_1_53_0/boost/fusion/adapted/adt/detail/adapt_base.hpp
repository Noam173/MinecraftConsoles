...
#define BOOST_FUSION_ADAPT_ADT_GET_IDENTITY_TEMPLATE_IMPL(TEMPLATE_PARAMS_SEQ) \
    typename detail::get_identity<                                             \
        lvalue, BOOST_PP_SEQ_ELEM(1, TEMPLATE_PARAMS_SEQ)>::type
...
#define BOOST_FUSION_ADAPT_ADT_C_BASE(                                                                           \
    ...
    struct adt_attribute_proxy<                                                                                  \
        BOOST_FUSION_ADAPT_STRUCT_UNPACK_NAME(NAME_SEQ), I, true>                                                \
    {                                                                                                            \
        typedef BOOST_PP_TUPLE_ELEM(ATTRIBUTE_TUPEL_SIZE, 1, ATTRIBUTE) type;                                    \
                                                                                                                 \
        explicit adt_attribute_proxy(                                                                            \
        ...
        {                                                                                                        \
            return access::adt_attribute_access<                                                                 \
                BOOST_FUSION_ADAPT_STRUCT_UNPACK_NAME(NAME_SEQ), I>::boost_fusion_adapt_adt_impl_get(*obj);      \
        }                                                                                                        \
                                                                                                                 \
        operator type() const                                                                                    \
        {                                                                                                        \
    ...
    template <                                                                                                   \
        BOOST_FUSION_ADAPT_STRUCT_UNPACK_TEMPLATE_PARAMS(TEMPLATE_PARAMS_SEQ)>                                   \
    struct adt_attribute_proxy<                                                                                  \
        BOOST_FUSION_ADAPT_STRUCT_UNPACK_NAME(NAME_SEQ), I, false>                                               \
    {                                                                                                            \
        ...
        {                                                                                                        \
            access::adt_attribute_access<                                                                        \
                BOOST_FUSION_ADAPT_STRUCT_UNPACK_NAME(NAME_SEQ), I>::boost_fusion_adapt_adt_impl_set(*obj, val); \
            return *this;                                                                                        \
        }                                                                                                        \
                                                                                                                 \
        type get() const                                                                                         \
    ...
    {                                                                                                            \
        ...
        struct apply                                                                                             \
        {                                                                                                        \
            typedef adt_attribute_proxy<                                                                         \
                BOOST_FUSION_ADAPT_STRUCT_UNPACK_NAME(NAME_SEQ), I, is_const<Seq>::value>                        \
                type;                                                                                            \
                                                                                                                 \
            static type                                                                                          \
            call(Seq &obj)                                                                                       \
