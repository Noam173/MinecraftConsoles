...
#define BOOST_FUSION_DEFINE_STRUCT_ASSIGN_FILLER_I(                  \
    ...
    BOOST_PP_EXPR_IF(                                                \
        ...
        typedef typename boost::fusion::result_of::next<             \
            BOOST_PP_CAT(I, BOOST_PP_DEC(I_))>::type                 \
            BOOST_PP_CAT(I, I_);                                     \
...
#define BOOST_FUSION_DEFINE_STRUCT_ASSIGN_OP(                             \
    ...
    {                                                                     \
        typedef typename boost::fusion::result_of::begin<Seq const>::type \
            I0;                                                           \
...
#define BOOST_FUSION_DEFINE_STRUCT_CTOR_1(                                                          \
    NAME, ATTRIBUTES_SEQ, ATTRIBUTE_TUPEL_SIZE)                                                     \
                                                                                                    \
    explicit NAME(boost::call_traits<                                                               \
                  BOOST_PP_TUPLE_ELEM(                                                              \
                      ATTRIBUTE_TUPEL_SIZE, 0, BOOST_PP_SEQ_HEAD(ATTRIBUTES_SEQ))>::param_type arg) \
        : BOOST_PP_TUPLE_ELEM(                                                                      \
...
#define BOOST_FUSION_DEFINE_TPL_STRUCT_CTOR_1(                                        \
    TEMPLATE_PARAMS_SEQ, NAME, ATTRIBUTES_SEQ, ATTRIBUTE_TUPEL_SIZE)                  \
                                                                                      \
    explicit NAME(typename boost::call_traits<                                        \
    ...
    typename boost::call_traits<                                         \
        typename boost::fusion::detail::get_first_arg<                   \
            BOOST_PP_TUPLE_ELEM(                                         \
                ...
                0,                                                       \
                ATTRIBUTE),                                              \
            BOOST_PP_TUPLE_ELEM(3, 2, DATA)>::type>::param_type          \
    BOOST_PP_CAT(_, I)
...
#define BOOST_FUSION_DEFINE_STRUCT_CTOR_ARG_I(                               \
    ...
    BOOST_PP_COMMA_IF(I)                                                     \
    boost::call_traits<                                                      \
        BOOST_PP_TUPLE_ELEM(ATTRIBUTE_TUPEL_SIZE, 0, ATTRIBUTE)>::param_type \
    BOOST_PP_CAT(_, I)
