...
#define BOOST_FUSION_ADAPT_STRUCT_TAG_OF_SPECIALIZATION(                       \
    ...
    struct tag_of<                                                             \
        BOOST_FUSION_ADAPT_STRUCT_UNPACK_NAME(NAME_SEQ) MODIFIER, void>        \
    {                                                                          \
        typedef TAG type;                                                      \
    };
#else
...
#define BOOST_FUSION_ADAPT_STRUCT_C_BASE(                                                                 \
    ...
    {                                                                                                     \
        typedef BOOST_PP_TUPLE_ELEM(ATTRIBUTE_TUPEL_SIZE, 0, ATTRIBUTE)                                   \
            attribute_type;                                                                               \
        ...
        {                                                                                                 \
            typedef typename add_reference<                                                               \
                typename mpl::eval_if<                                                                    \
                    is_const<Seq>, add_const<attribute_type>, mpl::identity<attribute_type>>::type>::type \
                type;                                                                                     \
                                                                                                          \
            static type                                                                                   \
            call(Seq &seq)                                                                                \
