...
{
#if defined(FUSION_DIRECT_OPERATOR_USAGE)
    return result_of::size<Seq1>::value != result_of::size<Seq2>::value || detail::sequence_not_equal_to<
                                                                               Seq1 const, Seq2 const, result_of::size<Seq1>::value == result_of::size<Seq2>::value>::
...
inline typename boost::enable_if<
    traits::enable_equality<Seq1, Seq2>, bool>::type
