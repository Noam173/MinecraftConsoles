...
struct BOOST_PP_CAT(unrolled_, BOOST_FUSION_FOLD_NAME)
{
    ...
    {
        typedef typename result_of::BOOST_FUSION_FOLD_IMPL_NEXT_IT_FUNCTION<
            It0 const>::type
            It1;
        ...
        return BOOST_PP_CAT(unrolled_, BOOST_FUSION_FOLD_NAME)<
            Result, N - 4>::call(f(state3, BOOST_FUSION_FOLD_IMPL_INVOKE_IT_TRANSFORM(it3)),
...
{
    typedef typename BOOST_PP_CAT(BOOST_FUSION_FOLD_NAME, _lvalue_state)<
        StateRef, It0 const, F>::type
        rest1;
    typedef typename result_of::BOOST_FUSION_FOLD_IMPL_NEXT_IT_FUNCTION<
        It0 const>::type
        it1;
    typedef typename BOOST_PP_CAT(BOOST_FUSION_FOLD_NAME, _lvalue_state)<
        rest1, it1, F>::type
        rest2;
    typedef typename result_of::BOOST_FUSION_FOLD_IMPL_NEXT_IT_FUNCTION<it1>::type
        it2;
    typedef typename BOOST_PP_CAT(BOOST_FUSION_FOLD_NAME, _lvalue_state)<
        rest2, it2, F>::type
        rest3;
    typedef typename result_of::BOOST_FUSION_FOLD_IMPL_NEXT_IT_FUNCTION<it2>::type
        it3;

    typedef typename BOOST_PP_CAT(result_of_unrolled_, BOOST_FUSION_FOLD_NAME)<
...
struct BOOST_PP_CAT(BOOST_FUSION_FOLD_NAME, _impl)
{
    typedef typename BOOST_PP_CAT(
        ...
        StateRef, BOOST_FUSION_FOLD_IMPL_FIRST_IT_META_TRANSFORM(typename result_of::BOOST_FUSION_FOLD_IMPL_FIRST_IT_FUNCTION<Seq>::type), F, SeqSize>::type
        type;

    static type
    call(StateRef state, Seq &seq, F f)
    {
        typedef BOOST_PP_CAT(unrolled_, BOOST_FUSION_FOLD_NAME)<
            type, SeqSize>
            unrolled_impl;
...
struct BOOST_PP_CAT(result_of_, BOOST_FUSION_FOLD_NAME)
    : BOOST_PP_CAT(BOOST_FUSION_FOLD_NAME, _impl)<
          result_of::size<Seq>::value, typename add_reference<typename add_const<State>::type>::type, Seq, F>
{
};
} // namespace detail
...
struct BOOST_FUSION_FOLD_NAME
    : detail::BOOST_PP_CAT(result_of_, BOOST_FUSION_FOLD_NAME)<
          Seq, State, F, traits::is_segmented<Seq>::type::value>
{
};
} // namespace result_of
