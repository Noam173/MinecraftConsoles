...
{
    typedef typename iter_fold_lvalue_state<
    ...
    typedef typename result_of::next<it2>::type
        it3;
    typedef typename result_of_unrolled_iter_fold<
