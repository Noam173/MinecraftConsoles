...
struct unrolled_reverse_fold
{
    ...
    call(State const &state, It0 const &it0, F f)
    {
        ...
        return unrolled_reverse_fold<
            Result, N - 4>::call(f(state3, fusion::deref(it3)),
                                 fusion::prior(it3),
                                 f);
    }
};
...
{
    typedef typename reverse_fold_lvalue_state<
...
struct result_of_first_unrolledreverse_fold
{
    typedef typename result_of_unrolled_reverse_fold<
        typename boost::result_of<
            F(
                StateRef,
                typename fusion::result_of::deref<It0 const>::type)>::type,
        typename result_of::prior<
            It0 const>::type,
        F, SeqSize - 1>::type
        type;
...
{
    typedef typename result_of_first_unrolledreverse_fold<
