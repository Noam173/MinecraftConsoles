...
struct pop_back_iterator
    : iterator_adapter<
          pop_back_iterator<Iterator_, IsLast>, Iterator_>
{
    ...
    struct distance
        : mpl::minus<
              typename result_of::distance<
                  typename First::iterator_base_type, typename Last::iterator_base_type>::type,
    ...
    struct prior_impl
    {
        ...
        typedef typename result_of::prior<base_type>::type
            base_prior;
    ...
    struct prior_impl<Iterator, true>
    {
        ...
        typedef typename result_of::prior<
            typename result_of::prior<base_type>::type>::type
            base_prior;
...
struct pop_back
{
    ...
    typedef iterator_range<begin_type, end_type>
        type;
};
} // namespace result_of
...
pop_back(Sequence const &seq)
{
    ...
    return result(
        begin_type(fusion::begin(seq)), end_type(fusion::end(seq)));
}
} // namespace fusion
} // namespace boost
