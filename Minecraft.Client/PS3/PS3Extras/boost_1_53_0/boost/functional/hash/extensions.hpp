...
#define BOOST_HASH_TUPLE_F(z, n, _)                                          \
    ...
    inline std::size_t hash_value(std::tuple<                                \
                                  BOOST_PP_ENUM_PARAMS_Z(z, n, A)> const &v) \
    {                                                                        \
        return boost::hash_detail::hash_tuple(v);                            \
    }
...
template <class T>
struct call_hash
    : public call_hash_impl<boost::is_array<T>::value>::BOOST_NESTED_TEMPLATE inner<T>
{
};
} // namespace hash_detail
...
struct hash_impl_msvc2
    : public hash_impl_msvc<boost::is_const<T>::value>::BOOST_NESTED_TEMPLATE inner<T>
{
};
