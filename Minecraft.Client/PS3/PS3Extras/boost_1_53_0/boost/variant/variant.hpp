    ...
    struct apply
        : mpl::size_t<
              ::boost::math::static_lcm<
                  BOOST_MPL_AUX_VALUE_WKND(State)::value, ::boost::alignment_of<Item>::value>::value>
    {
    };
};
...
struct find_fallback_type
{
  private: // helpers, for metafunction result (below)
    ...
    typedef typename mpl::iter_fold_if<
        Types, mpl::int_<0>, mpl::protect<mpl::next<>>, mpl::protect<find_fallback_type_pred>>::type first_result_;
    ...
    typedef typename mpl::iter_fold_if<
        mpl::iterator_range<first_result_it, end_it>, first_result_index, mpl::protect<mpl::next<>>, mpl::protect<mpl::not_same_as<boost::blank>>>::type second_result_;
  ...
  public: // metafunction result
    ...
    typedef typename mpl::eval_if<
        is_same<second_result_it, end_it>, mpl::if_<is_same<first_result_it, end_it>, mpl::pair<no_fallback_type, no_fallback_type>, first_result_>, mpl::identity<second_result_>>::type type;
};
...
struct make_storage
{
  private: // helpers, for metafunction result (below)
    typedef typename mpl::eval_if<
        NeverUsesBackupFlag, mpl::identity<Types>, mpl::push_front<Types, backup_holder<void *>>>::type types;

    typedef typename max_value<
        types, mpl::sizeof_<mpl::_1>>::type max_size;

#if !BOOST_WORKAROUND(__BORLANDC__, BOOST_TESTED_AT(0x0551))

    typedef typename mpl::fold<
        types, mpl::size_t<1>, add_alignment>::type max_alignment;
  ...
  public: // metafunction result
    ...
    typedef ::boost::aligned_storage<
        BOOST_MPL_AUX_VALUE_WKND(max_size)::value, BOOST_MPL_AUX_VALUE_WKND(max_alignment)::value>
        type;
    ...
    typedef ::boost::aligned_storage<
        msvc_max_size_c, msvc_max_alignment_c>
        type;
    ...
    : public static_visitor<>
{
  ...
  public: // internal visitor interfaces
    ...
    internal_visit(backup_holder<T> &lhs_content, long) const
    {
        lhs_content.get() = ::boost::detail::variant::move(static_cast<backup_holder<T> *>(rhs_storage_)->get());
        BOOST_VARIANT_AUX_RETURN_VOID;
    }
    ...
    : public static_visitor<>
{
  ...
  private: // helpers, for visitor interface (below)
    ...
    void backup_assign_impl(
        LhsT &lhs_content, mpl::true_ // has_nothrow_move
    )
    {
    ...
    template <typename LhsT>
    void backup_assign_impl(
        LhsT &lhs_content, mpl::false_ // has_nothrow_move
    )
    {
        // Backup lhs content...
...
class variant
{
  private: // helpers, for typedefs (below)
    ...
    typedef typename mpl::eval_if<
        is_recursive_, T0_, mpl::identity<T0_>>::type unwrapped_T0_;
  ...
  private: // helpers, for typedefs (below)
    typedef typename mpl::eval_if<
        ...
        detail::variant::make_variant_list<
            unwrapped_T0_, BOOST_VARIANT_ENUM_SHIFTED_PARAMS(T)>>::type specified_types;

    BOOST_STATIC_ASSERT((
        ::boost::mpl::not_<mpl::empty<specified_types>>::value));

    typedef typename mpl::eval_if<
        is_recursive_, mpl::transform<specified_types, mpl::protect<detail::variant::quoted_enable_recursive<wknd_self_t>>>, mpl::identity<specified_types>>::type recursive_enabled_types;

  public: // public typedefs
    typedef typename mpl::transform<
        recursive_enabled_types, unwrap_recursive<mpl::_1>>::type types;

  private: // internal typedefs
    typedef typename mpl::transform<
        recursive_enabled_types, mpl::protect<detail::make_reference_content<>>>::type internal_types;

    typedef typename mpl::front<
        internal_types>::type internal_T0;
...
#define BOOST_VARIANT_AUX_ENABLE_RECURSIVE_TYPEDEFS(z, N, _)                                                                                                              \
    typedef typename mpl::eval_if<                                                                                                                                        \
        is_recursive_, detail::variant::enable_recursive<BOOST_PP_CAT(T, N), wknd_self_t>, mpl::identity<BOOST_PP_CAT(T, N)>>::type BOOST_PP_CAT(recursive_enabled_T, N); \
    /**/

    BOOST_PP_REPEAT(
        BOOST_VARIANT_LIMIT_TYPES, BOOST_VARIANT_AUX_ENABLE_RECURSIVE_TYPEDEFS, _)

#undef BOOST_VARIANT_AUX_ENABLE_RECURSIVE_TYPEDEFS

#define BOOST_VARIANT_AUX_UNWRAP_RECURSIVE_TYPEDEFS(z, N, _)                   \
    typedef typename unwrap_recursive<                                         \
        BOOST_PP_CAT(recursive_enabled_T, N)>::type BOOST_PP_CAT(public_T, N); \
    /**/

    BOOST_PP_REPEAT(
        BOOST_VARIANT_LIMIT_TYPES, BOOST_VARIANT_AUX_UNWRAP_RECURSIVE_TYPEDEFS, _)

#undef BOOST_VARIANT_AUX_UNWRAP_RECURSIVE_TYPEDEFS

  public: // public typedefs
    typedef typename detail::variant::make_variant_list<
        BOOST_VARIANT_ENUM_PARAMS(public_T)>::type types;
...
#define BOOST_VARIANT_AUX_MAKE_REFERENCE_CONTENT_TYPEDEFS(z, N, _)               \
    typedef detail::make_reference_content<                                      \
        BOOST_PP_CAT(recursive_enabled_T, N)>::type BOOST_PP_CAT(internal_T, N); \
    /**/

    BOOST_PP_REPEAT(
        BOOST_VARIANT_LIMIT_TYPES, BOOST_VARIANT_AUX_MAKE_REFERENCE_CONTENT_TYPEDEFS, _)

#undef BOOST_VARIANT_AUX_MAKE_REFERENCE_CONTENT_TYPEDEFS

  private: // internal typedefs
    typedef typename detail::variant::make_variant_list<
        BOOST_VARIANT_ENUM_PARAMS(internal_T)>::type internal_types;
  ...
  private: // helpers, for representation (below)
    typedef typename detail::variant::find_fallback_type<
        internal_types>::type fallback_type_result_;
  ...
  private: // helpers, for representation (below)
    ...
    typedef typename mpl::eval_if<
        mpl::equal_to<mpl::O1_size<internal_types>, mpl::long_<-1>>, mpl::identity<int>, mpl::if_<mpl::less<mpl::O1_size<internal_types>, mpl::int_<SCHAR_MAX>>, signed char, int>>::type which_t;
...
// representation -- private when possible
  ...
  private: // helpers, for structors, below
    ...
    void convert_construct_variant(Variant &operand)
    {
        ...
        typedef typename mpl::find_if<
            types, is_same<
                       add_const<mpl::_1>, const Variant>>::type found_it;

        typedef typename mpl::end<types>::type not_found;
        typedef typename is_same<
            found_it, not_found>::type is_foreign_variant;
  ...
  public: // structors, cont.
    ...
    template <typename T>
    variant(
        T &operand, typename enable_if<
                        mpl::not_<is_const<T>>, void>::type * = 0)
    {
        convert_construct(operand, 1L);
    }
  ...
  private: // helpers, for modifiers (below)
        ...
        : public static_visitor<>
    {
      ...
      private: // helpers, for internal visitor interface (below)
        ...
        void assign_impl(
            const RhsT &rhs_content, mpl::true_ // has_nothrow_copy
            ,
        ...
        void assign_impl(
            const RhsT &rhs_content, mpl::false_ // has_nothrow_copy
            ,
        ...
        )
        {
            ...
            catch (...)
            {
                ...
                lhs_.indicate_which(
                    BOOST_MPL_AUX_VALUE_WKND(fallback_type_index_)::value); // nothrow
      ...
      public: // internal visitor interfaces
        ...
        internal_visit(const RhsT &rhs_content, int)
        {
            ...
            typedef typename mpl::or_< // reduces compile-time
                nothrow_copy, detail::variant::has_nothrow_move_constructor<RhsT>>::type nothrow_move_constructor;
        ...
        : public static_visitor<>
    {
      ...
      private: // helpers, for internal visitor interface (below)
        template <typename RhsT, typename B1, typename B2>
        void assign_impl(
            RhsT &rhs_content, mpl::true_ // has_nothrow_copy
            ,
            mpl::false_ // has_nothrow_move_constructor
            ,
            B2 // has_fallback_type
        ...
        template <typename RhsT>
        void assign_impl(
            RhsT &rhs_content, mpl::false_ // has_nothrow_copy
            ,
            mpl::false_ // has_nothrow_move_constructor
            ,
            mpl::true_ // has_fallback_type
      ...
      public: // internal visitor interfaces
        ...
        internal_visit(RhsT &rhs_content, int)
        {
            ...
            typedef typename mpl::or_< // reduces compile-time
                nothrow_move_constructor, has_nothrow_copy<RhsT>>::type nothrow_copy;
...
// helpers, for visitation support (below) -- private when possible
  ...
  public:
    ...
    static BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(
            ...
            int internal_which, int logical_which, Visitor &visitor, VoidPtrCV storage)
    {
        ...
        return detail::variant::visitation_impl(
            internal_which, logical_which, visitor, storage, mpl::false_(), never_uses_backup_flag(), static_cast<first_which *>(0), static_cast<first_step *>(0));
    }
