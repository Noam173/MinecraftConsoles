...
//
#if BOOST_WORKAROUND(__MWERKS__, <= 0x3201) || BOOST_WORKAROUND(BOOST_INTEL, <= 700) || BOOST_WORKAROUND(BOOST_MSVC, <= 1300) && !defined(BOOST_VARIANT_AUX_BROKEN_CONSTRUCTOR_TEMPLATE_ORDERING)
