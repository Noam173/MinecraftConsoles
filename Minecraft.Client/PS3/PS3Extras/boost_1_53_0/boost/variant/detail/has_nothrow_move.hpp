...
struct has_nothrow_move_impl
{
    BOOST_STATIC_CONSTANT(
        bool, value = (::boost::mpl::or_<
                       has_trivial_move<T>, ::boost::mpl::and_<
                                                has_nothrow_copy<T>, has_nothrow_assign<T>>>::type::value));
};

BOOST_VARIANT_TT_AUX_BOOL_TRAIT_DEF1(
    has_nothrow_move, T, (::boost::detail::variant::has_nothrow_move_impl<T>::value))
...
struct has_nothrow_move_constructor_impl
{
    BOOST_STATIC_CONSTANT(
        bool, value = (::boost::mpl::or_<
                       has_nothrow_move<T>, has_trivial_move_constructor<T>, has_nothrow_copy<T>>::type::value));
};

BOOST_VARIANT_TT_AUX_BOOL_TRAIT_DEF1(
    has_nothrow_move_constructor, T, (::boost::detail::variant::has_nothrow_move_constructor_impl<T>::value))
...
struct has_nothrow_move_assign_impl
{
    BOOST_STATIC_CONSTANT(
        bool, value = (::boost::mpl::or_<
                       has_nothrow_move<T>, has_trivial_move_assign<T>, has_nothrow_assign<T>>::type::value));
};

BOOST_VARIANT_TT_AUX_BOOL_TRAIT_DEF1(
    has_nothrow_move_assign, T, (::boost::detail::variant::has_nothrow_move_assign_impl<T>::value))
