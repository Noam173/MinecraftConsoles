...
//
#if defined(BOOST_VARIANT_AUX_BROKEN_CONSTRUCTOR_TEMPLATE_ORDERING) && !defined(BOOST_VARIANT_AUX_HAS_CONSTRUCTOR_TEMPLATE_ORDERING_SFINAE_WKND) && !defined(BOOST_VARIANT_NO_REFERENCE_SUPPORT)
...
#if defined(BOOST_VARIANT_DETAIL_NO_SUBSTITUTE) && !defined(BOOST_VARIANT_NO_FULL_RECURSIVE_VARIANT_SUPPORT)
...
BOOST_PP_REPEAT(
    BOOST_VARIANT_LIMIT_TYPES, BOOST_VARIANT_DETAIL_DEFINE_VOID_N, _)
...
#define BOOST_VARIANT_AUX_DECLARE_PARAMS                                     \
    BOOST_PP_ENUM(                                                           \
        BOOST_VARIANT_LIMIT_TYPES, BOOST_VARIANT_AUX_DECLARE_PARAMS_IMPL, T) \
    /**/
