...
{
  public:
    connection_body_base() : _connected(true)
    {
    }
...
class connection_body : public connection_body_base
{
  public:
    ...
    connection_body(const SlotType &slot_in) : slot(slot_in)
    {
    }
...
class connection
{
  public:
    ...
    connection(const boost::weak_ptr<detail::connection_body_base> &connectionBody) : _weak_connection_body(connectionBody)
    {
    }
    ~connection()
    {
