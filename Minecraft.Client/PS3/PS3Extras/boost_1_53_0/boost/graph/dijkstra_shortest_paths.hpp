...
template <class Graph, class DijkstraVisitor,
          ...
          class DistZero>
inline void
dijkstra_shortest_paths_no_init(const Graph &g,
                                ...
                                DijkstraVisitor vis, ColorMap color)
{
    ...
    typedef detail::vertex_property_map_generator<Graph, IndexMap, std::size_t>
...
template <class VertexListGraph, class DijkstraVisitor,
          ...
          typename Base>
inline void
dijkstra_shortest_paths(const VertexListGraph &g,
...
inline void
dijkstra_dispatch2(const VertexListGraph &g,
                   typename graph_traits<VertexListGraph>::vertex_descriptor s,
...
template <class VertexListGraph, class DistanceMap, class WeightMap,
          class IndexMap, class Params>
inline void
dijkstra_dispatch1(const VertexListGraph &g,
                   typename graph_traits<VertexListGraph>::vertex_descriptor s,
                   DistanceMap distance, WeightMap weight, IndexMap index_map,
                   const Params &params)
{
    ...
    detail::dijkstra_dispatch2(g, s, choose_param(distance, make_iterator_property_map(distance_map.begin(), index_map, distance_map[0])),
