...
class directed_graph
{
  ...
  public:
    ...
    directed_graph(directed_graph const &x)
        : m_graph(x), m_num_vertices(x.m_num_vertices), m_num_edges(x.m_num_edges), m_max_vertex_index(x.m_max_vertex_index), m_max_edge_index(x.m_max_edge_index)
    {
    }
...
inline typename property_traits<
    typename property_map<
        typename DIRECTED_GRAPH::graph_type, vertex_all_t>::const_type>::value_type
