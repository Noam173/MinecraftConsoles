...
struct grid_force_pairs
{
    ...
    explicit grid_force_pairs(const Topology &topology,
...
make_grid_force_pairs(const Topology &topology,
...
void maybe_jitter_point(const Topology &topology,
...
struct fr_force_directed_layout
{
    ...
    {
        fruchterman_reingold_force_directed_layout(g, position, topology, attractive_force, repulsive_force,
