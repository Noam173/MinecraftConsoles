...
class component_index
{
  ...
  public:
    ...
    component_index(ParentIterator parent_start,
                    ...
                    const ElementIndexMap &index_map) : m_num_elements(std::distance(parent_start, parent_end)),
    ...
    template <typename ParentIterator>
    component_index(ParentIterator parent_start,
                    ParentIterator parent_end) : m_num_elements(std::distance(parent_start, parent_end)),
                                                 m_components(make_shared<IndexContainer>()),
                                                 m_index_list(make_shared<IndexContainer>(m_num_elements))
    {
    ...
    operator[](IndexType component_index) const
    {
        ...
        return (std::make_pair(component_iterator(m_index_list->begin(), first_index),
