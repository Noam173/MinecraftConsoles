...
class sgb_edge
{
  ...
  public:
    ...
    friend Vertex *source(self e, sgb_const_graph_ptr)
    {
        return e._src;
    }
    friend Vertex *target(self e, sgb_const_graph_ptr)
    {
        return e._arc->tip;
    }
          ...
          std::ptrdiff_t, boost::sgb_edge *, boost::sgb_edge>
{
  ...
  public:
    ...
    {
        return boost::sgb_edge(_arc, _src);
    }
    self &operator++()
    {
        _arc = _arc->next;
...
inline long num_vertices(sgb_const_graph_ptr g)
{
    return g->n;
}
inline long num_edges(sgb_const_graph_ptr g)
{
    return g->m;
}
...
// helpers
inline Vertex *&get_util(util &u, Vertex *)
{
    return u.V;
}
inline Arc *&get_util(util &u, Arc *)
{
    return u.A;
}
inline sgb_graph_ptr &get_util(util &u, sgb_graph_ptr)
{
    return u.G;
}
inline char *&get_util(util &u, char *)
{
    return u.S;
}
inline long &get_util(util &u, long)
{
    return u.I;
}
...
#define SGB_UTIL_ACCESSOR(KIND, X)                                                \
    ...
    inline typename sgb_##KIND##_util_map<X##_property<T>, const T &>::value_type \
...
#define SGB_UTIL_ACCESSOR_TYPE(KIND, TAG, TYPE)                                \
    ...
    template <>                                                                \
    struct property_map<sgb_graph_ptr, TAG<TYPE>>                              \
    {                                                                          \
