...
strong_components_impl(const Graph &g,    // Input
...
struct strong_comp_dispatch2<param_not_found>
{
          ...
          param_not_found)
    {
        ...
        return strong_components_impl(g, comp, r_map,
                                      make_iterator_property_map(time_vec.begin(), choose_const_pmap(get_param(params, vertex_index), g, vertex_index), time_vec[0]),
                                      params);
    }
};
...
struct strong_comp_dispatch1<param_not_found>
{
          ...
          param_not_found)
    {
        ...
        return scc_helper2(g, comp,
                           make_iterator_property_map(root_vec.begin(), choose_const_pmap(get_param(params, vertex_index), g, vertex_index), root_vec[0]),
                           params,
                           ...
                           FinishTime finish_time, ColorMap color)
{
    ...
    depth_first_search(G, make_dfs_visitor(stamp_times(finish_time, time, on_finish_vertex())),
                       color);
