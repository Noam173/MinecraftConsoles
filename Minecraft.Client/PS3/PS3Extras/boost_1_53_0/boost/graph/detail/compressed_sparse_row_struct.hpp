...
class compressed_sparse_row_structure : public detail::indexed_edge_properties<
                                            ...
                                            csr_edge_index_map<Vertex, EdgeIndex>>
{
  public:
                                     ...
                                     const SourcePred &source_pred)
    {
        ...
        boost::graph::detail::count_starts(sources_begin, sources_end, m_rowstart.begin(), numlocalverts,
        ...
        boost::graph::detail::histogram_sort(sources_begin, sources_end, m_rowstart.begin(), numlocalverts,
                                           ...
                                           GlobalToLocal global_to_local)
    {
        ...
        boost::graph::detail::count_starts(sources.begin(), sources.end(), m_rowstart.begin(), numverts,
                                           keep_all(), boost::make_property_map_function(global_to_local));
        boost::graph::detail::histogram_sort_inplace(sources.begin(), m_rowstart.begin(), numverts,
...
{
    std::size_t operator()(detail::csr_edge_descriptor<Vertex, EdgeIndex> const &x) const
    {
