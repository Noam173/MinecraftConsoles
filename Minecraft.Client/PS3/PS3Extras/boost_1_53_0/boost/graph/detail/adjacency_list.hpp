...
struct out_edge_iter
    : iterator_adaptor<
          out_edge_iter<BaseIter, VertexDescriptor, EdgeDescriptor, Difference>, BaseIter, EdgeDescriptor, use_default, EdgeDescriptor, Difference>
{
...
struct in_edge_iter
    : iterator_adaptor<
          in_edge_iter<BaseIter, VertexDescriptor, EdgeDescriptor, Difference>, BaseIter, EdgeDescriptor, use_default, EdgeDescriptor, Difference>
{
    typedef iterator_adaptor<
        in_edge_iter<BaseIter, VertexDescriptor, EdgeDescriptor, Difference>, BaseIter, EdgeDescriptor, use_default, EdgeDescriptor, Difference>
        super_t;
...
struct undirected_edge_iter
    : iterator_adaptor<
          undirected_edge_iter<EdgeIter, EdgeDescriptor, Difference>, EdgeIter, EdgeDescriptor, use_default, EdgeDescriptor, Difference>
{
    typedef iterator_adaptor<
        undirected_edge_iter<EdgeIter, EdgeDescriptor, Difference>, EdgeIter, EdgeDescriptor, use_default, EdgeDescriptor, Difference>
        super_t;
                   ...
                   directed_graph_helper<Config> &g_)
{
    ...
    detail::remove_directed_edge_if_dispatch(first, last, g.out_edge_list(u), pred, edge_parallel_category());
}
...
struct undirected_graph_helper
{
    ...
    remove_edge(typename Config::edge_descriptor e)
    {
        ...
        typedef typename Config::OutEdgeList::value_type::property_type PType;
        detail::remove_undirected_edge_dispatch<PType>::apply(e, *this, *(PType *)e.get_property());
    }
    // O(E/V)
    inline void
    remove_edge(typename Config::out_edge_iterator iter)
                        ...
                        undirected_graph_helper<Config> &g_)
{
    ...
    boost::tie(first, last) = out_edges(u, g);
    typedef typename Config::edge_parallel_category Cat;
    detail::undirected_remove_out_edge_if_dispatch<PropT>(g, first, last, g.out_edge_list(u), pred, Cat());
}
template <class Config, class Predicate>
         ...
         undirected_graph_helper<Config> &g_)
{
    ...
    typename Config::EdgeContainer::iterator p_iter = graph_detail::push(g.m_edges, e).first;
    ...
    else
    {
        ...
        return std::make_pair(edge_descriptor(u, v, &i->get_iter()->get_property()), false);
    }
}
template <class Config>
inline std::pair<typename Config::edge_descriptor, bool>
                   ...
                   bidirectional_graph_helper_with_property<Config> &g_)
{
    ...
    for (boost::tie(out_i, out_end) = out_edges(u, g); out_i != out_end; ++out_i)
    {
        if (pred(*out_i))
        {
            detail::remove_directed_edge_dispatch(*out_i, in_edge_list(g, target(*out_i, g)),
    ...
    boost::tie(first, last) = out_edges(u, g);
    typedef typename Config::edge_parallel_category Cat;
    detail::remove_directed_edge_if_dispatch(first, last, g.out_edge_list(u), pred, Cat());
                  ...
                  bidirectional_graph_helper_with_property<Config> &g_)
{
    ...
    for (boost::tie(in_i, in_end) = in_edges(v, g); in_i != in_end; ++in_i)
    {
        if (pred(*in_i))
        {
            ...
            detail::remove_directed_edge_dispatch(*in_i, g.out_edge_list(u), *(PropT *)(*in_i).get_property());
            // Put in garbage to delete later. Will need the properties
            // for the remove_if of the out-edges.
    ...
    typedef typename Config::edge_parallel_category Cat;
    detail::remove_directed_edge_if_dispatch(first, last, in_edge_list(g, v), pred, Cat());
             ...
             bidirectional_graph_helper_with_property<Config> &g_)
{
    ...
    for (; ei != ei_end; ++ei)
    {
        detail::erase_from_incidence_list(in_edge_list(g, (*ei).get_target()), u, Cat());
    ...
    {
        detail::erase_from_incidence_list(g.out_edge_list((*in_ei).get_target()), u, Cat());
     ...
     const adj_list_helper<Config, Base> &g_)
{
    ...
    return std::make_pair(
        typename Config::edge_descriptor(u, v, (it == el.end() ? 0 : &(*it).get_property())),
        (it != el.end()));
}
  ...
  public:
    ...
    inline void copy_impl(const adj_list_impl &x_)
    {
        ...
        for (boost::tie(ei, ei_end) = edges(x); ei != ei_end; ++ei)
        {
            ...
            *((edge_property_type *)e.m_eproperty) = *((edge_property_type *)(*ei).m_eproperty);
        }
    }
           ...
           adj_list_impl<Derived, Config, Base> &g_)
{
    typedef typename Config::vertex_descriptor vertex_descriptor;
    Derived &g = static_cast<Derived &>(g_);
    if (optional<vertex_descriptor> v = g.vertex_by_property(get_property_value(p, vertex_bundle)))
    {
        return *v;
    }
...
struct adj_list_gen
{
    ...
    struct config
    {
        ...
        typedef typename mpl::if_<on_edge_storage,
                                  std::size_t, typename EdgeContainer::size_type>::type edges_size_type;
        ...
        typedef typename mpl::if_<on_edge_storage,
                                  ...
                                  typename mpl::if_<is_edge_ra,
                                                    ...
                                                    stored_edge_iter<vertex_descriptor, EdgeIter, EdgeProperty>>::type>::type StoredEdge;
        ...
        typedef undirected_edge_iter<
            EdgeIter, edge_descriptor, EdgeIterDiff>
        ...
        typedef typename mpl::if_<is_rand_access,
                                  ...
                                  typename mpl::if_<BidirectionalT,
                                                    bidir_seq_stored_vertex, seq_stored_vertex>::type>::type StoredVertex;
    ...
    typedef typename mpl::if_<BidirectionalT,
                              ...
                              typename mpl::if_<DirectedT,
                                                ...
                                                undirected_graph_helper<config>>::type>::type DirectedHelper;
...
struct adj_list_any_vertex_pa
{
    ...
    struct bind_
    {
        ...
        typedef adj_list_vertex_property_map<Graph, value_type, reference, Tag> type;
        typedef adj_list_vertex_property_map<Graph, value_type, const_reference, Tag> const_type;
    };
};
...
struct vec_adj_list_any_vertex_pa
{
    ...
    struct bind_
    {
        ...
        typedef vec_adj_list_vertex_property_map<Graph, Graph *, value_type, reference, Tag> type;
        typedef vec_adj_list_vertex_property_map<Graph, const Graph *, value_type, const_reference, Tag> const_type;
    };
};
...
struct vec_adj_list_all_vertex_pa
{
    ...
    {
        typedef typename Graph::vertex_descriptor Vertex;
        typedef vec_adj_list_vertex_all_properties_map<Graph, Graph *, Property, Property &> type;
        typedef vec_adj_list_vertex_all_properties_map<Graph, const Graph *, Property, const Property &> const_type;
    };
};
namespace detail
{
...
struct adj_list_choose_vertex_pa
    : boost::mpl::if_<
          ...
          adj_list_any_vertex_pa>::type ::template bind_<Tag, Graph, Property>
{
};
...
struct adj_list_any_edge_pmap
{
    ...
    struct bind_
    {
        ...
        typedef adj_list_edge_property_map<typename Graph::directed_category, value_type, reference,
                                           typename Graph::vertex_descriptor, Property, Tag>
            type;
        typedef adj_list_edge_property_map<typename Graph::directed_category, value_type, const_reference,
...
struct adj_list_all_edge_pmap
{
    ...
    struct bind_
    {
        typedef adj_list_edge_all_properties_map<typename Graph::directed_category, Property, Property &, Property *,
                                                 typename Graph::vertex_descriptor>
            type;
        typedef adj_list_edge_all_properties_map<typename Graph::directed_category, Property, const Property &,
