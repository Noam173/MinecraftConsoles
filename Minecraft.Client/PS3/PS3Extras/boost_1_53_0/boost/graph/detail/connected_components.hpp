...
{
    return time_recorder<DiscoverTimeMap, FinishTimeMap, TimeT, DFSVisitor>(d, f, t, vis);
}
...
template <class Parent1, class Parent2,
          class Integer>
void link_components(Parent1 component, Parent2 header,
...
void construct_component_index(IndexContainer &index, HeaderContainer &header)
{
