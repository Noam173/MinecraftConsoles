             ...
             i != topo_order.end(); ++i)
        {
            ...
            if (!in_a_chain[v])
            {
                ...
                for (;;)
                {
                    ...
                    typename graph_traits<CG_t>::adjacency_iterator next = std::find_if(adj_first, adj_last,
                                 ...
                                 G_to_TC_VertexMap g_to_tc_map, VertexIndexMap index_map)
{
    ...
    transitive_closure(g, tc,
                       choose_param(g_to_tc_map, make_iterator_property_map(to_tc_vec.begin(), index_map, to_tc_vec[0])),
                       index_map);
}
} // namespace detail
                        ...
                        const bgl_named_params<P, T, R> &params)
{
    ...
    detail::transitive_closure_dispatch(g, tc, get_param(params, orig_to_copy_t()),
