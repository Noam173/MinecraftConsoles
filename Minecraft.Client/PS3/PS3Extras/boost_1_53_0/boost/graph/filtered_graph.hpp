...
struct edge_predicate
{
    ...
    bool operator()(const Edge &e) const
    {
        return m_edge_pred(e) && m_vertex_pred(source(e, *m_g)) && m_vertex_pred(target(e, *m_g));
    }
    EdgePredicate m_edge_pred;
    VertexPredicate m_vertex_pred;
    const Graph *m_g;
...
struct vertex_property_type<filtered_graph<Graph, EdgePredicate, VertexPredicate>> : vertex_property_type<Graph>
{
};
...
template <typename Graph,
          typename EdgePredicate,
          typename VertexPredicate>
struct edge_property_type<filtered_graph<Graph, EdgePredicate, VertexPredicate>> : edge_property_type<Graph>
{
};
...
template <typename Graph,
          typename EdgePredicate,
          typename VertexPredicate>
struct graph_property_type<filtered_graph<Graph, EdgePredicate, VertexPredicate>> : graph_property_type<Graph>
{
};
...
struct property_map_filter
{
    ...
    property_map_filter(const PropertyMap &property_map) : m_property_map(property_map)
    {
    }
