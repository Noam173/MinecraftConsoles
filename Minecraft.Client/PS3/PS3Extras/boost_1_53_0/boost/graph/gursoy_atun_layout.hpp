...
struct update_position_visitor
{
    ...
    update_position_visitor(PositionMap position_map,
                            ...
                            double distance_limit,
                            double learning_constant,
                            double falloff_ratio) : position_map(position_map), node_distance(node_distance),
                                                    space(space),
...
struct gursoy_shortest
{
    ...
    {
        boost::dijkstra_shortest_paths(g, s, weight_map(weight).visitor(boost::make_dijkstra_visitor(std::make_pair(boost::record_distances(node_distance, boost::on_edge_relaxed()), update_position))));
    }
};
                      ...
                      EdgeWeightMap weight)
{
    ...
    vertex_descriptor min_distance_loc = graph_traits<VertexListAndIncidenceGraph>::null_vertex();
