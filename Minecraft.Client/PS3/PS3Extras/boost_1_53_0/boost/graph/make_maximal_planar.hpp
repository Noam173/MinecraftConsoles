...
struct triangulation_visitor : public planar_face_traversal_visitor
{
    ...
    typedef iterator_property_map<typename v_size_vector_t::iterator, VertexIndexMap>
        vertex_to_v_size_map_t;
    typedef iterator_property_map<typename degree_size_vector_t::iterator, VertexIndexMap>
    ...
    triangulation_visitor(Graph &arg_g,
                          ...
                          AddEdgeVisitor arg_add_edge_visitor) : g(arg_g),
                                                                 vm(arg_vm),
    ...
    void end_face()
    {
        ...
        typename vertex_vector_t::iterator marked_neighbor = vertices_on_face.end();
