                                    ...
                                    ValueType>
{
  public:
    ...
    typedef face_iterator<Graph, FaceHandlesMap, ValueType, TraversalType, VisitorType, Time> self;
    typedef typename FaceHandlesMap::value_type face_handle_t;

    face_iterator() : m_lead(graph_traits<Graph>::null_vertex()),
    ...
    face_iterator(face_handle_t anchor_handle,
                  ...
                  TraversalSubType traversal_type) : m_follow(anchor_handle.get_anchor()),
    ...
    face_iterator(vertex_t anchor,
                  FaceHandlesMap face_handles,
                  TraversalSubType traversal_type) : m_follow(anchor),
                                                     m_face_handles(face_handles)
    {
...
{
  public:
    typedef face_iterator<Graph, FaceHandlesMap, ValueType, both_sides, VisitorType, Time> self;
    typedef typename graph_traits<Graph>::vertex_descriptor vertex_t;
    typedef typename FaceHandlesMap::value_type face_handle_t;
    ...
    face_iterator(face_handle_t anchor_handle, FaceHandlesMap face_handles) : first_itr(anchor_handle, face_handles, first_side()),
    ...
    face_iterator(vertex_t anchor, FaceHandlesMap face_handles) : first_itr(face_handles[anchor], face_handles, first_side()),
  ...
  private:
    ...
    typedef face_iterator<Graph, FaceHandlesMap, ValueType, single_side, follow_visitor, Time>
        inner_itr_t;
