...
struct choose_impl_result : boost::mpl::eval_if<
...
{
    return detail::choose_impl_helper<!boost::is_same<Param, param_not_found>::value>::f(boost::mpl::true_(), g, p, tag);
}
...
{
    return detail::choose_impl_helper<!boost::is_same<Param, param_not_found>::value>::f(boost::mpl::false_(), g, p, tag);
}
...
struct override_const_property_result
{
    typedef
        typename override_const_property_t<
            ...
            Prop,
            Graph,
            boost::detail::parameter_exists<ArgPack, Tag>::value>::result_type
            type;
};
...
override_const_property(const ArgPack &ap, const boost::parameter::keyword<Tag> &t, const Graph &g, Prop)
{
    return override_const_property_t<
        ...
        Prop,
        Graph,
        boost::detail::parameter_exists<ArgPack, Tag>::value>()(g, ap[t | 0]);
}
...
#define BOOST_GRAPH_MAKE_AP_TYPE_SPECIALIZATION(z, i, _)                                                                                                                   \
    ...
    {                                                                                                                                                                      \
        typedef BOOST_PP_REPEAT(i, BOOST_GRAPH_OPENING_PART_OF_PAIR, BOOST_PP_DEC(i)) boost::parameter::aux::empty_arg_list BOOST_PP_REPEAT(i, > BOOST_PP_TUPLE_EAT(3), ~) \
            type;                                                                                                                                                          \
    };
...
#define BOOST_GRAPH_MAKE_FORWARDING_FUNCTION(name, nfixed, nnamed_max)                                                                                                                                                                                                                                                   \
    ...
    template <BOOST_PP_ENUM_PARAMS(nfixed, typename Param) BOOST_PP_COMMA_IF(nfixed) typename ArgPack>                                                                                                                                                                                                                   \
        typename boost::result_of<                                                                                                                                                                                                                                                                                       \
            detail::BOOST_PP_CAT(name, _impl) < BOOST_PP_ENUM_PARAMS(nfixed, Param)>(BOOST_PP_ENUM_PARAMS(nfixed, Param) BOOST_PP_COMMA_IF(nfixed) const ArgPack &) > ::type                                                                                                                                             \
...
#define BOOST_GRAPH_MAKE_FORWARDING_FUNCTION_ONEX(z, nnamed, name, nfixed)                                                                                                                                                                                                                                                             \
    template <BOOST_PP_ENUM_PARAMS(nfixed, typename Param) BOOST_PP_ENUM_TRAILING_PARAMS(nnamed, typename Keyword) BOOST_PP_ENUM_TRAILING_PARAMS(nnamed, typename Arg)>                                                                                                                                                                \
        typename boost::result_of<                                                                                                                                                                                                                                                                                                     \
            detail::BOOST_PP_CAT(name, _impl) < BOOST_PP_ENUM_PARAMS(nfixed, Param)>(BOOST_PP_ENUM_PARAMS(nfixed, Param) BOOST_PP_COMMA_IF(nfixed)                                                                                                                                                                                     \
                                                                                         const typename boost::detail::make_arg_pack_type<void(BOOST_PP_ENUM_PARAMS(nnamed, Keyword) BOOST_PP_COMMA_IF(nnamed) BOOST_PP_ENUM_PARAMS(nnamed, Arg))>::type &) > ::type                                                                   \
                                                                                                                                                                                                                                                              name(BOOST_PP_ENUM_BINARY_PARAMS(nfixed, const Param, &param)            \
                                                                                                                                                                                                                                                                       BOOST_PP_ENUM_TRAILING(nnamed, BOOST_GRAPH_MAKE_PAIR_PARAM, ~)) \
    {                                                                                                                                                                                                                                                                                                                                  \
        return detail::BOOST_PP_CAT(name, _impl)<BOOST_PP_ENUM_PARAMS(nfixed, Param)>()(BOOST_PP_ENUM_PARAMS(nfixed, param),                                                                                                                                                                                                           \
...
#define BOOST_GRAPH_MAKE_OLD_STYLE_PARAMETER_FUNCTION(name, nfixed)                                                                                                                                                                                                                                    \
    ...
    typename boost::result_of<                                                                                                                                                                                                                                                                         \
        ::boost::graph::detail::BOOST_PP_CAT(name, _impl) BOOST_PP_EXPR_IF(nfixed, <) BOOST_PP_ENUM_PARAMS(nfixed, Param) BOOST_PP_EXPR_IF(nfixed, >)(BOOST_PP_ENUM_PARAMS(nfixed, Param) BOOST_PP_COMMA_IF(nfixed)                                                                                    \
                                                                                                                                                          const typename boost::detail::convert_bgl_params_to_boost_parameter<boost::bgl_named_params<P, T, R>>::type &)>::type                        \
    ...
    BOOST_PP_EXPR_IF(nfixed, template <)                                                                                                                                                                                                                                                               \
                             BOOST_PP_ENUM_PARAMS(nfixed, typename Param) BOOST_PP_EXPR_IF(nfixed, >)                                                                                                                                                                                                  \
                                 BOOST_PP_EXPR_IF(nfixed, typename) boost::result_of<                                                                                                                                                                                                                  \
                                     ::boost::graph::detail::BOOST_PP_CAT(name, _impl) BOOST_PP_EXPR_IF(nfixed, <) BOOST_PP_ENUM_PARAMS(nfixed, Param) BOOST_PP_EXPR_IF(nfixed, >)(BOOST_PP_ENUM_PARAMS(nfixed, Param) BOOST_PP_COMMA_IF(nfixed) const boost::parameter::aux::empty_arg_list &)>::type \
                                 name(BOOST_PP_ENUM_BINARY_PARAMS(nfixed, const Param, &param))                                                                                                                                                                                                        \
    {                                                                                                                                                                                                                                                                                                  \
    ...
    typedef typename boost::remove_const<
        typename override_const_property_t<
            ...
            boost::detail::parameter_exists<
                ArgPack, boost::graph::keywords::tag::vertex_index_map>::value>::result_type>::type vi_map_type;
    typedef boost::shared_array_property_map<Value, vi_map_type>
        map_type;
...
struct map_maker
{
    BOOST_STATIC_CONSTANT(
        bool,
        has_map =
            (parameter_exists<ArgPack, MapTag>::value));
...
struct priority_queue_maker
{
    BOOST_STATIC_CONSTANT(
        bool,
        g_hasQ =
            (parameter_exists<ArgPack, PriorityQueueTag>::value));
