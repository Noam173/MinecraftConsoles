                              ...
                              mpl::true_)
{
    ...
    typedef typename parameter::binding<ArgumentPack,
                                        tag::vertex_index_map,
                                        typename property_map<typename remove_reference<graph_t>::type,
                                                              vertex_index_t>::const_type>::type vertex_index_map_t;

    boyer_myrvold_impl<graph_t,
                       vertex_index_map_t,
                              ...
                              mpl::false_)
{
    ...
    typedef typename parameter::binding<ArgumentPack,
                                        tag::vertex_index_map,
                                        typename property_map<graph_t, vertex_index_t>::type>::type vertex_index_map_t;
    ...
    {
        planarity_tester.extract_kuratowski_subgraph(args[kuratowski_subgraph],
...
bool boyer_myrvold_planarity_test(ArgumentPack const &args)
{
    ...
    typedef typename parameter::binding<ArgumentPack,
                                        tag::embedding,
                                        const no_planar_embedding &>::type
        embedding_arg_t;

    return dispatched_boyer_myrvold(args,
                                    boost::is_same<embedding_arg_t, const no_planar_embedding &>(),
                                    boost::is_same<kuratowski_arg_t, const no_kuratowski_subgraph_isolation &>());
}
...
{
    return boyer_myrvold_params::core::boyer_myrvold_planarity_test(boyer_myrvold_params::boyer_myrvold_params_t()(arg0));
}
...
bool boyer_myrvold_planarity_test(A0 const &arg0, A1 const &arg1)
{
    return boyer_myrvold_params::core::boyer_myrvold_planarity_test(boyer_myrvold_params::boyer_myrvold_params_t()(arg0, arg1));
}
...
bool boyer_myrvold_planarity_test(A0 const &arg0,
                                  ...
                                  A2 const &arg2)
{
    return boyer_myrvold_params::core::boyer_myrvold_planarity_test(boyer_myrvold_params::boyer_myrvold_params_t()(arg0, arg1, arg2));
}
...
bool boyer_myrvold_planarity_test(A0 const &arg0,
                                  ...
                                  A3 const &arg3)
{
    return boyer_myrvold_params::core::boyer_myrvold_planarity_test(boyer_myrvold_params::boyer_myrvold_params_t()(arg0, arg1, arg2, arg3));
}
...
bool boyer_myrvold_planarity_test(A0 const &arg0,
                                  ...
                                  A4 const &arg4)
{
    return boyer_myrvold_params::core::boyer_myrvold_planarity_test(boyer_myrvold_params::boyer_myrvold_params_t()(arg0, arg1, arg2, arg3, arg4));
}
