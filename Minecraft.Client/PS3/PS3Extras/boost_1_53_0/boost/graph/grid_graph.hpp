...
struct grid_graph_vertex_at
{
    ...
    result_type
    operator()(typename graph_traits<Graph>::vertices_size_type vertex_index) const
    {
...
struct grid_graph_out_edge_at
{
  ...
  public:
    ...
    grid_graph_out_edge_at(vertex_descriptor source_vertex,
                           const Graph *graph) : m_vertex(source_vertex),
                                                 m_graph(graph)
    {
    }

    result_type
    operator()(typename graph_traits<Graph>::degree_size_type out_edge_index) const
    {
...
struct grid_graph_in_edge_at
{
  ...
  public:
    ...
    grid_graph_in_edge_at(vertex_descriptor target_vertex,
                          const Graph *graph) : m_vertex(target_vertex),
                                                m_graph(graph)
    {
    }

    result_type
    operator()(typename graph_traits<Graph>::degree_size_type in_edge_index) const
    {
...
struct grid_graph_edge_at
{
    ...
    result_type
    operator()(typename graph_traits<Graph>::edges_size_type edge_index) const
    {
...
struct grid_graph_adjacent_vertex_at
{
  ...
  public:
    ...
    result_type
    operator()(typename graph_traits<Graph>::degree_size_type adjacent_index) const
    {
...
class grid_graph
{
  ...
  public:
    ...
    grid_graph(vertex_descriptor dimension_lengths) : m_dimension_lengths(dimension_lengths)
    {
    ...
    grid_graph(vertex_descriptor dimension_lengths,
               bool wrap_all_dimensions) : m_dimension_lengths(dimension_lengths)
    {
    ...
    // specified.
    grid_graph(vertex_descriptor dimension_lengths,
               WrapDimensionArray wrap_dimension) : m_dimension_lengths(dimension_lengths),
                               ...
                               vertices_size_type distance = 1) const
    {
        ...
        vertex[dimension_index] =
            (distance > vertex[dimension_index]) ? (wrapped(dimension_index) ? (length(dimension_index) - (distance % length(dimension_index))) : 0) : vertex[dimension_index] - distance;
  ...
  protected:
    ...
    edge_descriptor edge_at(edges_size_type edge_index) const
    {
        ...
        else
        {
                 ...
                 ++dimension_index_iter)
            {
                ...
                std::size_t dimension_length = (dimension_index_iter == dimension_index) ? length(dimension_index_iter) - 1 : length(dimension_index_iter);
    ...
    edges_size_type index_of(edge_descriptor edge) const
    {
        ...
        else
        {
                 ...
                 ++dimension_index)
            {
                ...
                index_multiplier *= (dimension_index == different_dimension_index) ? length(dimension_index) - 1 : length(dimension_index);
            }
        }
                                ...
                                degree_size_type out_edge_index) const
    {
        ...
        return (std::make_pair(vertex, is_forward ? next(vertex, dimension_index) : previous(vertex, dimension_index)));
    }
    ...
    edge_descriptor in_edge_at(vertex_descriptor vertex,
  ...
  public:
    ...
    vertices(const type &graph)
    {
        ...
        return (std::make_pair(vertex_iterator(vertex_index_iterator(0),
    ...
    edges(const type &graph)
    {
        ...
        return (std::make_pair(edge_iterator(edge_index_iterator(0),
                                             edge_function(&graph)),
         ...
         const type &graph)
    {
             ...
             ++dimension_index)
        {
            ...
            dim_difference = (source_dim > dest_dim) ? (source_dim - dest_dim) : (dest_dim - source_dim);
