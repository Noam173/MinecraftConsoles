...
struct bicomp_dispatch3
{
    ...
    {
        return biconnected_components_impl(g, comp, out, index_map, dtm, lowpt, pred,
...
struct bicomp_dispatch3<param_not_found>
{
                                                        ...
                                                        param_not_found)
    {
        ...
        return biconnected_components_impl(g, comp, out, index_map, dtm, lowpt,
...
struct bicomp_dispatch2
{
                                                        ...
                                                        LowPointMap lowpt)
    {
        ...
        return bicomp_dispatch3<dispatch_type>::apply(g, comp, out, index_map, dtm, lowpt, params,
...
struct bicomp_dispatch2<param_not_found>
{
                                                        ...
                                                        param_not_found)
    {
        ...
        return bicomp_dispatch3<dispatch_type>::apply(g, comp, out, index_map, dtm,
...
struct bicomp_dispatch1
{
                                                        ...
                                                        const bgl_named_params<P, T, R> &params, DiscoverTimeMap dtm)
    {
        ...
        return bicomp_dispatch2<dispatch_type>::apply(g, comp, out, index_map, dtm, params,
...
struct bicomp_dispatch1<param_not_found>
{
                                                        ...
                                                        const bgl_named_params<P, T, R> &params, param_not_found)
    {
        ...
        return bicomp_dispatch2<dispatch_type>::apply(g, comp, out, index_map,
                       ...
                       const bgl_named_params<P, T, R> &params)
{
    return biconnected_components(g, comp,
                                  graph_detail::dummy_output_iterator(), params)
        .first;
}
