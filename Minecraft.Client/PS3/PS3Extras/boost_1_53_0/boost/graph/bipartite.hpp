...
struct bipartition_colorize
{
    ...
    bipartition_colorize(PartitionMap partition_map) : partition_map_(partition_map)
    {
    }
...
struct bipartition_check
{
    ...
    bipartition_check(PartitionMap partition_map) : partition_map_(partition_map)
    {
    }
...
inline std::pair<BiDirectionalIterator1, BiDirectionalIterator2> reverse_mismatch(std::pair<
                                                                                      ...
                                                                                      sequence1,
                                                                                  std::pair<BiDirectionalIterator2,
