...
struct choose_edge_property_map_archetype
{
    ...
    struct bind_
    {
        typedef mutable_lvalue_property_map_archetype<typename Graph::edge_descriptor, Property> type;
        typedef lvalue_property_map_archetype<typename Graph::edge_descriptor, Property> const_type;
    };
};
template <>
...
struct choose_vertex_property_map_archetype
{
    ...
    struct bind_
    {
        typedef mutable_lvalue_property_map_archetype<typename Graph::vertex_descriptor, Property> type;
        typedef lvalue_property_map_archetype<typename Graph::vertex_descriptor, Property> const_type;
    };
};
...
void put(P p, property_graph_archetype<G, P, V> &g,
...
struct color_value_archetype
{
    ...
    bool operator==(const color_value_archetype &) const
    {
        return true;
    }
    bool operator!=(const color_value_archetype &) const
...
struct color_traits<color_value_archetype>
{
    ...
    {
        return color_value_archetype(static_object<detail::dummy_constructor>::get());
    }
