...
struct parallel_dijkstra_impl
{
    ...
    run(const DistributedGraph &g,
        ...
        DijkstraVisitor vis)
    {
        graph::detail::parallel_dijkstra_impl2<Lookahead>::run(g, s, predecessor, distance, lookahead, weight, index_map,
...
inline void
dijkstra_shortest_paths(const DistributedGraph &g,
                        typename graph_traits<DistributedGraph>::vertex_descriptor s,
                            ...
                            BOOST_GRAPH_ENABLE_IF_MODELS_PARM(DistributedGraph, distributed_graph_tag))
{
    ...
    bool use_default_color_map = is_default_param(get_param(params, vertex_color));
    ...
    graph::detail::parallel_dijkstra_impl<color_map_type>::run(g, s, predecessor, distance,
