...
enum edge_target_processor_id_t
{
...
void serialize(Archiver &ar, edge_base<Directed, Vertex> &e,
               const unsigned int /*version*/)
{
    ar &unsafe_serialize(e.m_source) & unsafe_serialize(e.m_target);
}

template <typename Archiver, typename Directed, typename Vertex>
void serialize(Archiver &ar, edge_desc_impl<Directed, Vertex> &e,
               const unsigned int /*version*/)
{
    ar &boost::serialization::base_object<edge_base<Directed, Vertex>>(e) & unsafe_serialize(e.m_eproperty);
}
} // namespace detail
...
struct edge_descriptor
{
  ...
  private:
    ...
    void serialize(Archiver &ar, const unsigned int /*version*/)
    {
        ar & source_processor & target_processor & source_owns_edge & local;
    }
};
...
{
    return (e1.source_processor == e2.source_processor && e1.target_processor == e2.target_processor && e1.local == e2.local);
}
      ...
      maybe_store_property<EdgeProperty>
{
  ...
  public:
    ...
    void serialize(Archiver &ar, const unsigned int /*version*/)
    {
        ar &boost::serialization::base_object<inherited_data>(*this) & boost::serialization::base_object<inherited_property>(*this);
    }
};
    ...
    struct apply
    {
      ...
      public:
        typedef ::boost::parallel::distributed_property_map<
            process_group_type, global_map, local_pmap>
            type;

        typedef ::boost::parallel::distributed_property_map<
            process_group_type, global_map, local_const_pmap>
            const_type;
    };
};
...
remove_in_edge(typename Graph::edge_descriptor e, Graph &g, bidirectionalS)
{
    ...
    while (i != in_edges.end() && !(i->source_processor == source(e, g).owner) && i->e == e.local)
    {
        ++i;
    }
  ...
  public:
    ...
    typedef typename boost::mpl::if_<typename DirectedS::is_bidir_t,
                                     ...
                                     typename boost::mpl::if_<typename DirectedS::is_directed_t,
                                                              directed_tag, undirected_tag>::type>::type directed_category;
                                                  ...
                                                  EdgeListS>>
{
  ...
  public:
    ...
    typedef typename boost::mpl::if_<
        ...
        typename boost::mpl::if_<is_same<DirectedS, bidirectionalS>,
                                 ...
                                 undirected_distributed_adj_list_tag>::type>::type traversal_category;
  ...
  public:
    ...
    typedef boost::adjacency_iterator<
        ...
        typename detail::iterator_traits<base_out_edge_iterator>::difference_type>
        adjacency_iterator;
  ...
  public:
    ...
    {
        return process_id(process_group_);
    }
    process_group_type process_group() const
    {
        return process_group_.base();
    }
  ...
  public:
    ...
    typedef boost::detail::parallel::msg_nonlocal_edge_data<
        edge_property_type, local_edge_descriptor>
        msg_nonlocal_edge_data;
                      ...
                      processor_id_type other_proc, bidirectionalS)
    {
        ...
        if (src.owner == process_id(process_group_))
        {
                 ...
                 ei != ei_end; ++ei)
            {
                ...
                // edges. Egads!
                if (tgt.local == target(*ei, base()) && get(edge_target_processor_id, base(), *ei) == other_proc)
                {
                    break;
                }
            }
        ...
        else
        {
            ...
            {
                if (src.local == source(ei->e, base()) && src.owner == ei->source_processor)
                {
                    break;
                }
            }
                      ...
                      processor_id_type other_proc, undirectedS)
    {
        ...
        // Remove the edge from the out-edge list, if it is there
        {
                 ...
                 ei != ei_end; ++ei)
            {
                ...
                // have changed if we're allowing the removal of
                // edges. Egads!
                if (remote_vertex.local == target(*ei, base()) && get(edge_target_processor_id, base(), *ei) == other_proc)
                {
                    break;
                }
            }
  ...
  public:
                                ...
                                undirectedS)
    {
        ...
        // list.
        {
            ...
            {
                if ((source(*ei, *this) == src && target(*ei, *this) == tgt) || (source(*ei, *this) == tgt && target(*ei, *this) == src))
                {
                    break;
                }
            }

            if (ei != local_edges_.end())
            {
                local_edges_.erase(ei);
            }
        }
    }
    ...
    ~lazy_add_vertex_with_property()
{
    ...
    process_id_type owner = static_cast<graph_type &>(self).owner_by_property(property);
    ...
    add_local_edge(const edge_property_type &property, bidirectionalS) const
{
    ...
    std::pair<edge_descriptor, bool> result = this->add_local_edge(property, directedS());
 ...
 */
template <PBGL_DISTRIB_ADJLIST_TEMPLATE_PARMS>
std::pair<typename PBGL_DISTRIB_ADJLIST_TYPE ::vertex_iterator,
          typename PBGL_DISTRIB_ADJLIST_TYPE ::vertex_iterator>
vertices(const PBGL_DISTRIB_ADJLIST_TYPE &g)
{
    typedef typename PBGL_DISTRIB_ADJLIST_TYPE ::vertex_descriptor Vertex;
 ...
 */
template <PBGL_DISTRIB_ADJLIST_TEMPLATE_PARMS>
typename PBGL_DISTRIB_ADJLIST_TYPE ::vertices_size_type
...
std::pair<typename PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(bidirectionalS)::in_edge_iterator,
          typename PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(bidirectionalS)::in_edge_iterator>
in_edges(typename PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(bidirectionalS)::vertex_descriptor v,
 ...
 */
template <PBGL_DISTRIB_ADJLIST_TEMPLATE_PARMS_CONFIG>
std::pair<typename PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(undirectedS)::in_edge_iterator,
          typename PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(undirectedS)::in_edge_iterator>
in_edges(typename PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(undirectedS)::vertex_descriptor v,
...
typename PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(bidirectionalS)::degree_size_type
    in_degree(typename PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(bidirectionalS)::vertex_descriptor v,
              const PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(bidirectionalS) & g)
{
    BOOST_ASSERT(v.owner == g.processor());
...
typename PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(undirectedS)::degree_size_type
    in_degree(typename PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(undirectedS)::vertex_descriptor v,
              const PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(undirectedS) & g)
{
    BOOST_ASSERT(v.owner == g.processor());
...
template <PBGL_DISTRIB_ADJLIST_TEMPLATE_PARMS_CONFIG>
typename PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(undirectedS)::degree_size_type
    degree(typename PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(undirectedS)::vertex_descriptor v,
           const PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(undirectedS) & g)
{
    BOOST_ASSERT(v.owner == g.processor());
    return out_degree(v.local, g.base());
...
template <PBGL_DISTRIB_ADJLIST_TEMPLATE_PARMS_CONFIG>
typename PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(bidirectionalS)::degree_size_type
    degree(typename PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(bidirectionalS)::vertex_descriptor v,
           const PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(bidirectionalS) & g)
{
    BOOST_ASSERT(v.owner == g.processor());
...
{
    typedef typename PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(directedS)::edge_descriptor edge_descriptor;

    // For directed graphs, u must be local
    BOOST_ASSERT(u.owner == process_id(g.process_group()));

    typename PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(directedS)::out_edge_iterator ei, ei_end;
...
edge(typename PBGL_DISTRIB_ADJLIST_TYPE::vertex_descriptor u,
     ...
     const PBGL_DISTRIB_ADJLIST_TYPE &g)
{
    typedef typename PBGL_DISTRIB_ADJLIST_TYPE ::edge_descriptor edge_descriptor;
...
template <PBGL_DISTRIB_ADJLIST_TEMPLATE_PARMS>
typename PBGL_DISTRIB_ADJLIST_TYPE ::lazy_add_edge_with_property
add_edge(typename PBGL_DISTRIB_ADJLIST_TYPE::vertex_descriptor u,
         typename PBGL_DISTRIB_ADJLIST_TYPE::vertex_descriptor v,
         typename PBGL_DISTRIB_ADJLIST_TYPE::edge_property_type const &p,
         PBGL_DISTRIB_ADJLIST_TYPE &g)
{
    typedef typename PBGL_DISTRIB_ADJLIST_TYPE ::lazy_add_edge_with_property lazy_add_edge_with_property;
 ...
 ************************************************************************/
template <PBGL_DISTRIB_ADJLIST_TEMPLATE_PARMS>
void remove_edge(typename PBGL_DISTRIB_ADJLIST_TYPE::edge_descriptor e,
                 PBGL_DISTRIB_ADJLIST_TYPE &g)
{
    BOOST_ASSERT(source(e, g).owner == g.processor() || target(e, g).owner == g.processor());
    ...
    if (source(e, g).owner != g.processor() || (target(e, g).owner != g.processor() && !(is_same<DirectedS, directedS>::value)))
    {
...
template <PBGL_DISTRIB_ADJLIST_TEMPLATE_PARMS>
void remove_edge(typename PBGL_DISTRIB_ADJLIST_TYPE::vertex_descriptor u,
                 typename PBGL_DISTRIB_ADJLIST_TYPE::vertex_descriptor v,
                 PBGL_DISTRIB_ADJLIST_TYPE &g)
{
    typedef typename PBGL_DISTRIB_ADJLIST_TYPE ::vertex_descriptor vertex_descriptor;
    typedef typename PBGL_DISTRIB_ADJLIST_TYPE ::edge_descriptor edge_descriptor;
    std::pair<edge_descriptor, bool> the_edge = edge(u, v, g);
    if (the_edge.second)
    {
        remove_edge(the_edge.first, g);
    }
}
...
template <PBGL_DISTRIB_ADJLIST_TEMPLATE_PARMS_CONFIG>
inline void
remove_edge(typename PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(directedS)::out_edge_iterator ei,
...
struct remove_out_edge_predicate
{
    ...
    bool operator()(const argument_type &le)
    {
        ...
        if (predicate(e))
        {
            if (source(e, g).owner != target(e, g).owner && !(is_same<directed_selector, directedS>::value))
            {
                g.send_remove_edge_request(e);
            }
            else
...
inline void
remove_out_edge_if(typename PBGL_DISTRIB_ADJLIST_TYPE::vertex_descriptor u,
                   Predicate predicate,
                   PBGL_DISTRIB_ADJLIST_TYPE &g)
{
...
inline void
remove_in_edge_if(typename PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(bidirectionalS)::vertex_descriptor u,
                  Predicate predicate,
...
template <PBGL_DISTRIB_ADJLIST_TEMPLATE_PARMS_CONFIG, typename Predicate>
inline void
remove_in_edge_if(typename PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(undirectedS)::vertex_descriptor u,
                  Predicate predicate,
...
template <PBGL_DISTRIB_ADJLIST_TEMPLATE_PARMS_CONFIG>
void clear_vertex(typename PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(bidirectionalS)::vertex_descriptor u,
                  PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(bidirectionalS) & g)
{
    clear_out_edges(u, g);
    clear_in_edges(u, g);
...
template <PBGL_DISTRIB_ADJLIST_TEMPLATE_PARMS_CONFIG>
void clear_vertex(typename PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(undirectedS)::vertex_descriptor u,
                  PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(undirectedS) & g)
{
 ...
 ************************************************************************/
template <PBGL_DISTRIB_ADJLIST_TEMPLATE_PARMS_CONFIG>
void clear_out_edges(typename PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(directedS)::vertex_descriptor u,
                     PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(directedS) & g)
{
    BOOST_ASSERT(u.owner == g.processor());
...
template <PBGL_DISTRIB_ADJLIST_TEMPLATE_PARMS_CONFIG>
void clear_out_edges(typename PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(bidirectionalS)::vertex_descriptor u,
                     PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(bidirectionalS) & g)
{
    remove_out_edge_if(u, parallel::detail::always_true(), g);
}
 ...
 ************************************************************************/
template <PBGL_DISTRIB_ADJLIST_TEMPLATE_PARMS_CONFIG>
void clear_in_edges(typename PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(bidirectionalS)::vertex_descriptor u,
                    PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(bidirectionalS) & g)
{
...
add_vertex(typename PBGL_DISTRIB_ADJLIST_TYPE::vertex_property_type const &p,
           PBGL_DISTRIB_ADJLIST_TYPE &g)
{
    typedef typename PBGL_DISTRIB_ADJLIST_TYPE ::lazy_add_vertex_with_property lazy_add_vertex;
 ...
 ************************************************************************/
template <PBGL_DISTRIB_ADJLIST_TEMPLATE_PARMS>
void remove_vertex(typename PBGL_DISTRIB_ADJLIST_TYPE::vertex_descriptor u,
                   PBGL_DISTRIB_ADJLIST_TYPE &g)
{
...
struct property_map<PBGL_DISTRIB_ADJLIST_TYPE, Property>
    : detail::parallel::get_adj_list_pmap<Property>::template apply<PBGL_DISTRIB_ADJLIST_TYPE>
{
};
...
inline
    typename property_traits<typename property_map<
        PBGL_DISTRIB_ADJLIST_TYPE, Property>::const_type>::value_type
...
void put(Property p, PBGL_DISTRIB_ADJLIST_TYPE &g, const Key &key, const Value &v)
{
    if (owner(key) == process_id(g.process_group()))
    {
...
struct property_map<PBGL_DISTRIB_ADJLIST_TYPE, T Bundle::*>
    : detail::parallel::get_adj_list_pmap<T Bundle::*>::template apply<PBGL_DISTRIB_ADJLIST_TYPE>
{
};

template <PBGL_DISTRIB_ADJLIST_TEMPLATE_PARMS, typename T, typename Bundle>
struct property_map<PBGL_DISTRIB_ADJLIST_TYPE const, T Bundle::*>
    : detail::parallel::get_adj_list_pmap<T Bundle::*>::template apply<PBGL_DISTRIB_ADJLIST_TYPE const>
{
};
