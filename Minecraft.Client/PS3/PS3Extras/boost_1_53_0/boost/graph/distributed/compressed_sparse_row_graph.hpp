    ...
    InEdgeIndex>
{
  ...
  public:
    ...
    {
        typename graph_traits<base_type>::vertex_descriptor v = boost::add_vertex(m_base);
    ...
    {
        typename graph_traits<base_type>::vertex_descriptor v = boost::add_vertex(m_base, p);
    ...
    {
        typename graph_traits<base_type>::vertex_descriptor v = boost::add_vertices(count, m_base);
...
edges(const BOOST_DISTRIB_CSR_GRAPH_TYPE &g)
{
    ...
    else
    {
        ...
        Vertex src = 0;
        while (g.base().m_forward.m_rowstart[src + 1] == 0)
        {
            ++src;
        }
...
{
    typedef typename property_map<BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_global_t>::type result_type;
    return result_type();
}

template <BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline std::pair<typename ProcessGroup::process_id_type,
                 typename BOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor>
get(vertex_global_t, BOOST_DISTRIB_CSR_GRAPH_TYPE &g,
...
{
    typedef typename property_map<BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_global_t>::const_type result_type;
    return result_type();
}
...
{
  public:
    typedef typename property_map<BOOST_DISTRIB_CSR_GRAPH_TYPE, Property>::const_type type;
    typedef type const_type;
};
...
{
    typedef typename property_map<BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_owner_t>::type result_type;
    return result_type();
}
...
{
    typedef typename property_map<BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_owner_t>::const_type result_type;
    return result_type();
}
...
{
    typedef typename property_map<BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_local_t>::type result_type;
    return result_type();
}
...
{
    typedef typename property_map<BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_local_t>::const_type result_type;
    return result_type();
}
...
{
    typedef typename property_map<BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_index_t>::type result_type;
...
{
    typedef typename property_map<BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_index_t>::const_type result_type;
    return result_type(g.process_group(), get(vertex_global, g),
                       get(vertex_local, g));
}
    ...
    typename csr_edge_global_map<ProcessID, Vertex, EdgeIndex>::key_type k)
{
    ...
    return std::pair<ProcessID, detail::csr_edge_descriptor<Vertex, EdgeIndex>>((k.src >> local_index_bits),
...
{
    typedef typename property_map<BOOST_DISTRIB_CSR_GRAPH_TYPE, edge_global_t>::type result_type;
    return result_type();
}
...
{
    typedef typename property_map<BOOST_DISTRIB_CSR_GRAPH_TYPE, edge_global_t>::const_type result_type;
    return result_type();
}
    ...
    typename BOOST_DISTRIB_CSR_GRAPH_TYPE::edge_descriptor k)
{
    ...
    return result_type(k.src >> local_index_bits,
                       typename BOOST_DISTRIB_CSR_GRAPH_TYPE::base_type::edge_descriptor(k.src & local_index_mask, k.idx));
}
...
{
    typedef typename property_map<BOOST_DISTRIB_CSR_GRAPH_TYPE, edge_global_t>::type global_map;
...
{
    typedef typename property_map<BOOST_DISTRIB_CSR_GRAPH_TYPE, edge_index_t>::type result_type;
...
{
    typedef typename property_map<BOOST_DISTRIB_CSR_GRAPH_TYPE, edge_index_t>::const_type result_type;
    return result_type(g.process_group(), get(edge_global, g),
                       get(edge_index, g.base()));
}
