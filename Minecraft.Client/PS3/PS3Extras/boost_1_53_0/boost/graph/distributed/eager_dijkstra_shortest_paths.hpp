          ...
          typename property_map<Graph, vertex_owner_t>::const_type>
{
    ...
    typedef mutable_queue<vertex_descriptor, std::vector<vertex_descriptor>,
                          queue_compare_type, VertexIndexMap>
        queue_type;
  ...
  private:
    ...
    {
        return (!queue.empty() && get(distance_map, queue.top()) <= min_distance + lookahead);
    }
...
void eager_dijkstra_shortest_paths(const DistributedGraph &g,
                                   ...
                                   DijkstraVisitor vis)
{
    ...
    // Dijkstra Queue
    typedef detail::lookahead_dijkstra_queue<DistributedGraph, Combine, Compare, IndexMap, DistanceMap,
                                             PredecessorMap>
        Queue;
    ...
    detail::parallel_dijkstra_bfs_visitor<DijkstraVisitor, Queue, WeightMap, PredecessorMap, DistanceMap, Combine,
                                          Compare>
    ...
    eager_dijkstra_shortest_paths_stats.execution_time =
        accounting::get_time() - eager_dijkstra_shortest_paths_stats.execution_time;
#endif
}
