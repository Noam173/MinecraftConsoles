...
template <class VertexAndEdgeListGraph, class DistanceMatrix,
          ...
          class VertexID>
bool johnson_dispatch(VertexAndEdgeListGraph &g,
                      DistanceMatrix &D,
                      const bgl_named_params<P, T, R> &params,
...
bool johnson_all_pairs_shortest_paths(VertexAndEdgeListGraph &g, DistanceMatrix &D)
{
    ...
    return detail::johnson_dispatch(g, D, params, get(edge_weight, g), get(vertex_index, g));
}
