...
class bfs_king_visitor : public default_bfs_visitor
{
  public:
    bfs_king_visitor(OutputIterator *iter, Buffer *b, Compare compare,
                     ...
                     VertexIndexMap vertices) : permutation(iter), Qptr(b), degree(deg), comp(compare),
  ...
  protected:
    ...
    void percolate_down(int offset)
    {
        ...
        int smallest_child = (valid && get(degree, (*Qptr)[left_child]) > get(degree, (*Qptr)[right_child])) ? right_child : left_child;
        ...
        while (valid && smallest_child < heap_last && comp((*Qptr)[drifter], (*Qptr)[smallest_child]))
        {
            ...
            smallest_child = (valid && get(degree, (*Qptr)[left_child]) > get(degree, (*Qptr)[right_child])) ? right_child : left_child;
        }
    }
