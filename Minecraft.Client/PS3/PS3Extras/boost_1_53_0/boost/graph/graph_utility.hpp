...
struct connects_predicate
{
    ...
    bool operator()(const Edge &e) const
    {
        ...
        {
            return (source(e, m_g) == m_u && target(e, m_g) == m_v) || (source(e, m_g) == m_v && target(e, m_g) == m_u);
        }
    }
    Vertex m_u, m_v;
    const Graph &m_g;
...
inline bool is_reachable(typename graph_traits<IncidenceGraph>::vertex_descriptor x,
