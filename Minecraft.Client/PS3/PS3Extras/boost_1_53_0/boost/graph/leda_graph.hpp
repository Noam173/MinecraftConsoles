...
struct graph_traits<leda::GRAPH<vtype, etype>>
{
                                 ...
                                 const leda::node *>
    {
      ...
      private:
        leda::node dereference() const
        {
            return leda::target(base);
        }
        ...
        void increment()
        {
            base = g->adj_succ(base);
        }
        void decrement()
        {
            base = g->adj_pred(base);
        }
                                 ...
                                 const leda::edge *>
    {
      ...
      private:
        const leda::edge &dereference() const
        {
            return base;
        }
                                 ...
                                 const leda::node *>
    {
      ...
      private:
        const leda::node &dereference() const
        {
            return base;
        }
        ...
        void increment()
        {
            base = g->succ_node(base);
        }
        void decrement()
        {
            base = g->pred_node(base);
        }
                                 ...
                                 const leda::edge *>
    {
      ...
      private:
        ...
        void increment()
        {
            base = g->succ_edge(base);
        }
        void decrement()
        {
            base = g->pred_edge(base);
        }
...
out_edges(
    ...
    const leda::GRAPH<vtype, etype> &g)
{
    typedef typename graph_traits<leda::GRAPH<vtype, etype>>::out_edge_iterator Iter;
...
in_edges(
    ...
    const leda::GRAPH<vtype, etype> &g)
{
    typedef typename graph_traits<leda::GRAPH<vtype, etype>>::in_edge_iterator Iter;
...
adjacent_vertices(
    ...
    const leda::GRAPH<vtype, etype> &g)
{
    typedef typename graph_traits<leda::GRAPH<vtype, etype>>::adjacency_iterator Iter;
    return std::make_pair(Iter(g.first_adj_edge(u, 0), &g), Iter(0, &g));
}
    ...
    : public put_get_helper<ERef, leda_node_property_map<E, ERef, NodeMapPtr>>
{
  public:
    ...
    ERef operator[](leda::node n) const
    {
        return (*m_array)[n];
    }
...
{
    typedef typename leda_property_map<Tag>::template bind_<vtype, etype> map_gen;
...
inline
    typename boost::property_traits<
        typename boost::property_map<leda::GRAPH<vtype, etype>, PropertyTag>::const_type>::value_type
    ...
    : public put_get_helper<ERef, leda_edge_property_map<E, ERef, EdgeMapPtr>>
{
  public:
    ...
    ERef operator[](leda::edge n) const
    {
        return (*m_array)[n];
    }
