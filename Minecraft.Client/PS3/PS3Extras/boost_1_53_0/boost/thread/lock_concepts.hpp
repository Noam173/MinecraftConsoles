...
struct BasicLock
{
    ...
    BasicLock() : mtx(*static_cast<mutex_type *>(0))
    {
    }
...
struct Lock
{
    ...
    Lock() : mtx(*static_cast<mutex_type *>(0))
    {
    }
...
struct TimedLock
{
    ...
    TimedLock() : mtx(*static_cast<mutex_type *>(0))
    {
    }
...
struct UniqueLock
{
    ...
    UniqueLock() : mtx(*static_cast<mutex_type *>(0))
    {
    }
...
struct SharedLock
{
    ...
    SharedLock() : mtx(*static_cast<mutex_type *>(0))
    {
    }
...
struct UpgradeLock
{
    ...
    UpgradeLock() : mtx(*static_cast<mutex_type *>(0))
    {
    }
...
struct StrictLock
{
    ...
    StrictLock() : l1(*static_cast<Lk *>(0)),
