...
class externally_locked
{
  ...
  public:
     ...
     */
    BOOST_CONSTEXPR externally_locked(mutex_type &mtx, const T &obj) : obj_(obj), mtx_(&mtx)
    {
    }
     ...
     */
    BOOST_CONSTEXPR externally_locked(mutex_type &mtx, BOOST_THREAD_RV_REF(T) obj) : obj_(move(obj)), mtx_(&mtx)
    {
    }
     ...
     */
    externally_locked(mutex_type &mtx) : obj_(), mtx_(&mtx)
    {
    }
     ...
     *  Move constructor
     */
    externally_locked(BOOST_THREAD_RV_REF(externally_locked) rhs) : obj_(move(rhs.obj_)), mtx_(rhs.mtx_)
    {
        rhs.mtx_ = 0;
    }
...
class externally_locked<T &, MutexType>
{
  ...
  public:
     ...
     */
    externally_locked(T &obj, mutex_type &mtx) : obj_(&obj), mtx_(&mtx)
    {
    }

    /// move constructor
    externally_locked(BOOST_THREAD_RV_REF(externally_locked) rhs) : obj_(rhs.obj_), mtx_(rhs.mtx_)
    {
        rhs.obj_ = 0;
        rhs.mtx_ = 0;
    }
