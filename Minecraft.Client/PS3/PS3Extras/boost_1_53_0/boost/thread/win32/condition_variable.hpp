...
class basic_cv_list_entry
{
  ...
  public:
    ...
    explicit basic_cv_list_entry(detail::win32::handle_manager const &wake_sem_) : semaphore(detail::win32::create_anonymous_semaphore(0, LONG_MAX)),
...
class basic_condition_variable
{
    ...
    struct relocker
    {
        ...
        relocker(lock_type &lock_) : lock(lock_), unlocked(false)
        {
        }
        void unlock()
        {
    ...
    struct entry_manager
    {
        ...
        entry_manager(entry_ptr const &entry_) : entry(entry_)
        {
        }
  ...
  public:
    basic_condition_variable() : total_count(0), active_generation_count(0), wake_sem(0)
    {
    }
