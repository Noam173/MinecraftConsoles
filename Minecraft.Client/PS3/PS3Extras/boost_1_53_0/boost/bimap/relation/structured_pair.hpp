...
class normal_storage : public symmetrical_base<FirstType, SecondType>
{
...
template <class FirstType, class SecondType>
class mirror_storage : public symmetrical_base<SecondType, FirstType>
{
...
class pair_info_hook : public ::boost::bimaps::relation::detail::storage_finder<TA, TB, Layout>::type
{
  ...
  protected:
    ...
    template <class Pair>
    pair_info_hook(const Pair &p) : base_(p.first, p.second),
                                    info(p.info)
    {
    }
...
class pair_info_hook<TA, TB, ::boost::mpl::na, Layout> : public ::boost::bimaps::relation::detail::storage_finder<TA, TB, Layout>::type
{
    typedef BOOST_DEDUCED_TYPENAME ::boost::bimaps::relation::detail::storage_finder<TA, TB, Layout>::type base_;
  ...
  public:
    typedef ::boost::mpl::vector3<
        ...
        BOOST_DEDUCED_TYPENAME ::boost::mpl::if_<
            ...
            mutant_relation<SecondType, FirstType, Info, true>>::type
    ...
    structured_pair(const std::pair<First, Second> &p) : base_(p.first, p.second)
    {
    }
...
copy_with_first_replaced(structured_pair<FirstType, SecondType, Info, Layout> const &p,
                         BOOST_DEDUCED_TYPENAME ::boost::call_traits<BOOST_DEDUCED_TYPENAME
                                                                         structured_pair<FirstType, SecondType, Info, Layout>::first_type>::param_type f)
{
...
copy_with_first_replaced(structured_pair<FirstType, SecondType, ::boost::mpl::na, Layout> const &p,
                         BOOST_DEDUCED_TYPENAME ::boost::call_traits<BOOST_DEDUCED_TYPENAME
                                                                         structured_pair<FirstType, SecondType, ::boost::mpl::na, Layout>::first_type>::param_type f)
{
...
copy_with_second_replaced(structured_pair<FirstType, SecondType, Info, Layout> const &p,
                          BOOST_DEDUCED_TYPENAME ::boost::call_traits<BOOST_DEDUCED_TYPENAME
                                                                          structured_pair<FirstType, SecondType, Info, Layout>::second_type>::param_type s)
{
...
copy_with_second_replaced(structured_pair<FirstType, SecondType, ::boost::mpl::na, Layout> const &p,
                          BOOST_DEDUCED_TYPENAME ::boost::call_traits<BOOST_DEDUCED_TYPENAME
                                                                          structured_pair<FirstType, SecondType, ::boost::mpl::na, Layout>::second_type>::param_type s)
{
