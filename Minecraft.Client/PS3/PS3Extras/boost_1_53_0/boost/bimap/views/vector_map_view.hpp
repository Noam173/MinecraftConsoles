          ...
          map_view_base<vector_map_view<Tag, BimapType>, Tag, BimapType>
{
  ...
  public:
    ...
    vector_map_view(BOOST_DEDUCED_TYPENAME base_::base_type &c) : base_(c)
    {
    }
...
{
  private:
    typedef ::boost::bimaps::views::vector_map_view<Tag, BimapType> map_view_;

  public:
    BOOST_BIMAP_MAP_VIEW_EXTRA_TYPEDEFS_BODY(map_view_, left)
};
