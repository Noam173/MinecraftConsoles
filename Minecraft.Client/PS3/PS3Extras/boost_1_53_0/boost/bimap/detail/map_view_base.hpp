...
class map_view_base
{
    ...
    typedef ::boost::bimaps::detail::map_view_iterator<Tag, BimapType> iterator_;
  ...
  public:
    ...
    data_type_ &at(const CompatibleKey &k)
    {
        typedef ::boost::bimaps::detail::
            map_view_iterator<Tag, BimapType>
                iterator;
    ...
    {
        typedef ::boost::bimaps::detail::
            const_map_view_iterator<Tag, BimapType>
                const_iterator;
    ...
    {                                                                          \
        ...
        return range_type(                                                     \
            this->template functor<                                            \
                BOOST_DEDUCED_TYPENAME BASE::iterator_from_base>()(r.first),   \
            this->template functor<                                            \
                BOOST_DEDUCED_TYPENAME BASE::iterator_from_base>()(r.second)); \
    }                                                                          \
                                                                               \
    template <class LowerBounder, class UpperBounder>                          \
