...
typename uint_t<Bits>::fast augmented_crc(void const *buffer,
                                          std::size_t byte_count, typename uint_t<Bits>::fast initial_remainder BOOST_ACRC_DUMMY_PARM_TYPE);
...
typename crc_table_t<Bits, TruncPoly, Reflect>::table_type
    crc_table_t<Bits, TruncPoly, Reflect>::table_ = {0};

// Populate CRC lookup table
template <std::size_t Bits, BOOST_CRC_PARM_TYPE TruncPoly, bool Reflect>
void crc_table_t<Bits, TruncPoly, Reflect>::init_table()
{
    ...
    do
    {
        ...
        table_[crc_helper<CHAR_BIT, Reflect>::reflect(dividend)] = crc_helper<Bits, Reflect>::reflect(remainder);
    } while (++dividend);
...
class crc_helper
{
  public:
    ...
    static unsigned char index(value_type rem, unsigned char x)
    {
        return x ^ (DoReflect ? rem : ((Bits > CHAR_BIT) ? (rem >> (Bits - CHAR_BIT)) : (rem << (CHAR_BIT - Bits))));
    }
...
inline crc_basic<Bits>::crc_basic(
    ...
    : rem_(initial_remainder), poly_(truncated_polynominal), init_(initial_remainder), final_(final_xor_value), rft_in_(reflect_input), rft_out_(reflect_remainder)
{
}
...
inline
    ...
    crc_basic<Bits>::get_truncated_polynominal() const
{
    return poly_;
}
...
inline
    typename crc_basic<Bits>::value_type
    crc_basic<Bits>::get_initial_remainder() const
{
    return init_;
}
...
inline
    typename crc_basic<Bits>::value_type
    crc_basic<Bits>::get_final_xor_value() const
{
    return final_;
}
...
template <std::size_t Bits>
inline bool
crc_basic<Bits>::get_reflect_input() const
{
    return rft_in_;
}
...
template <std::size_t Bits>
inline bool
crc_basic<Bits>::get_reflect_remainder() const
{
    return rft_out_;
}
...
inline
    typename crc_basic<Bits>::value_type
    crc_basic<Bits>::get_interim_remainder() const
{
...
template <std::size_t Bits>
void crc_basic<Bits>::process_bits(
    unsigned char bits,
...
template <std::size_t Bits>
void crc_basic<Bits>::process_block(
...
inline
    typename crc_basic<Bits>::value_type
    crc_basic<Bits>::checksum() const
{
    return ((rft_out_ ? detail::reflector<Bits>::reflect(rem_) : rem_) ^ final_) & masking_type::sig_bits;
}
...
inline
    ...
    BOOST_CRC_OPTIMAL_NAME::get_truncated_polynominal() const
{
    return TruncPoly;
}
...
inline
    typename BOOST_CRC_OPTIMAL_NAME::value_type
    BOOST_CRC_OPTIMAL_NAME::get_initial_remainder() const
{
    return InitRem;
}
...
inline
    typename BOOST_CRC_OPTIMAL_NAME::value_type
    BOOST_CRC_OPTIMAL_NAME::get_final_xor_value() const
{
    return FinalXor;
}
...
template <std::size_t Bits, BOOST_CRC_PARM_TYPE TruncPoly,
          ...
          bool ReflectIn, bool ReflectRem>
inline bool
BOOST_CRC_OPTIMAL_NAME::get_reflect_input() const
{
    return ReflectIn;
}
...
template <std::size_t Bits, BOOST_CRC_PARM_TYPE TruncPoly,
          ...
          bool ReflectIn, bool ReflectRem>
inline bool
BOOST_CRC_OPTIMAL_NAME::get_reflect_remainder() const
{
    return ReflectRem;
}
...
inline
    typename BOOST_CRC_OPTIMAL_NAME::value_type
    BOOST_CRC_OPTIMAL_NAME::get_interim_remainder() const
{
...
inline
    typename BOOST_CRC_OPTIMAL_NAME::value_type
    BOOST_CRC_OPTIMAL_NAME::checksum() const
{
    return (reflect_out_type::reflect(rem_) ^ get_final_xor_value()) & masking_type::sig_bits_fast;
}
...
inline
    typename BOOST_CRC_OPTIMAL_NAME::value_type
    BOOST_CRC_OPTIMAL_NAME::operator()() const
{
    return checksum();
}
