...
{
    static BOOST_CHRONO_LIB_CONSTEXPR T lowest() BOOST_CHRONO_LIB_NOEXCEPT_OR_THROW
    {
...
class BOOST_SYMBOL_VISIBLE duration
{
  ...
  public:
    ...
    template <class Rep2>
    BOOST_SYMBOL_VISIBLE inline BOOST_CONSTEXPR explicit duration(const Rep2 &r, typename boost::enable_if<
                                                                                     mpl::and_<
                                                                                         ...
                                                                                         mpl::or_<
                                                                                             ...
                                                                                             mpl::and_<
                                                                                                 ...
                                                                                                 mpl::not_<treat_as_floating_point<Rep2>>>>>>::type * = 0) : rep_(r)
    {
    }
    //~duration() {} //= default;
    ...
    BOOST_CONSTEXPR
    duration(const duration<Rep2, Period2> &d, typename boost::enable_if<
                                                   mpl::or_<
                                                       treat_as_floating_point<rep>,
                                                       mpl::and_<
