...
struct count_impl<aux::multiset_tag>
{
    ...
    struct apply
        : if_<
              is_reference<Key>, aux::multiset_count_ref_impl<Set, Key>, aux::multiset_count_impl<Set, Key>>::type
    {
    };
};
...
struct count_impl<aux::multiset_tag>
{
    ...
    struct apply
    {
        enum
        {
            msvc71_wknd_ = sizeof(Set::key_count(BOOST_MPL_AUX_STATIC_CAST(aux::type_wrapper<Key> *, 0))) - 1
        };
