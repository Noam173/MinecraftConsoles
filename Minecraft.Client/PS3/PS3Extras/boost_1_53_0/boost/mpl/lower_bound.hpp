...
struct lower_bound_step
{
    typedef typename eval_if<
        Distance, lower_bound_step_impl<Distance, Predicate, T, DeferredIterator>, DeferredIterator>::type type;
};
...
struct lower_bound_step_impl
{
    ...
    typedef typename apply2<
        Predicate, typename deref<middle_>::type, T>::type cond_;
    ...
    typedef typename eval_if<
        cond_, step_backward_, step_forward_>::type type;
};
