...
#if BOOST_WORKAROUND(__BORLANDC__, BOOST_TESTED_AT(0x610)) || (BOOST_MPL_CFG_GCC != 0) || BOOST_WORKAROUND(__IBMCPP__, <= 600)
#define BOOST_MPL_CFG_ASSERT_USE_RELATION_NAMES
#endif

#if BOOST_WORKAROUND(__MWERKS__, < 0x3202) || BOOST_WORKAROUND(__EDG_VERSION__, <= 238) || BOOST_WORKAROUND(__BORLANDC__, BOOST_TESTED_AT(0x610)) || BOOST_WORKAROUND(__DMC__, BOOST_TESTED_AT(0x840))
...
// at a function scope)
#if BOOST_WORKAROUND(__BORLANDC__, BOOST_TESTED_AT(0x610)) || (BOOST_MPL_CFG_GCC != 0)
...
#define BOOST_MPL_ASSERT(pred)                                                                  \
    BOOST_MPL_AUX_ASSERT_CONSTANT(                                                              \
        std::size_t, BOOST_PP_CAT(mpl_assertion_in_line_, BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
...
#define BOOST_MPL_ASSERT_RELATION_IMPL(counter, x, rel, y)                                                                  \
    ...
    BOOST_MPL_AUX_ASSERT_CONSTANT(                                                                                          \
        std::size_t, BOOST_PP_CAT(mpl_assertion_in_line_, counter) = sizeof(                                                \
...
#define BOOST_MPL_ASSERT_RELATION_IMPL(counter, x, rel, y)                                                                                 \
    BOOST_MPL_AUX_ASSERT_CONSTANT(                                                                                                         \
        std::size_t, BOOST_PP_CAT(mpl_assert_rel, counter) = sizeof(                                                                       \
                         boost::mpl::assert_::arg rel boost::mpl::assert_::arg));                                                          \
        ...
        std::size_t, BOOST_PP_CAT(mpl_assertion_in_line_, counter) = sizeof(                                                               \
                         boost::mpl::assertion_failed<BOOST_PP_CAT(mpl_assert_rel_value, counter)>(                                        \
                             boost::mpl::assert_rel_arg(boost::mpl::assert_relation<                                                       \
                                                        boost::mpl::assert_::relations(BOOST_PP_CAT(mpl_assert_rel, counter)), x, y>())))) \
/**/
#endif
