...
#define BOOST_MPL_HAS_XXX_TRAIT_NAMED_DEF_(trait, name, default_)                                                               \
    ...
    template <typename T, typename fallback_ = boost::mpl::bool_<default_>>                                                     \
        struct trait                                                                                                            \
        : boost::mpl::if_c<                                                                                                     \
              boost::mpl::aux::msvc_is_incomplete<T>::value, boost::mpl::bool_<false>, BOOST_PP_CAT(trait, _impl) < T> > ::type \
    {                                                                                                                           \
    };                                                                                                                          \
                                                                                                                                \
...
#elif BOOST_WORKAROUND(BOOST_MSVC, BOOST_TESTED_AT(1400)) || BOOST_WORKAROUND(__IBMCPP__, <= 700)
...
#define BOOST_MPL_HAS_XXX_TRAIT_NAMED_DEF(trait, name, default_)                             \
    ...
    template <typename T>                                                                    \
        struct BOOST_PP_CAT(trait, _impl_)<                                                  \
            T, typename BOOST_PP_CAT(trait, _msvc_sfinae_helper) < typename T::name>::type > \
    {                                                                                        \
...
#define BOOST_MPL_HAS_XXX_TRAIT_NAMED_BCB_DEF(trait, trait_tester, name, default_)                                                        \
    ...
    {                                                                                                                                     \
        ...
        {                                                                                                                                 \
            template <class U>                                                                                                            \
            static int resolve(boost::mpl::aux::type_wrapper<U> const volatile *, boost::mpl::aux::type_wrapper<typename U::name> * = 0); \
            static char resolve(...);                                                                                                     \
        };                                                                                                                                \
...
#define BOOST_MPL_HAS_XXX_TRAIT_NAMED_DEF(trait, name, default_)                               \
    BOOST_MPL_HAS_XXX_TRAIT_NAMED_BCB_DEF(trait, BOOST_PP_CAT(trait, _tester), name, default_) \
    /**/
...
#define BOOST_MPL_HAS_XXX_TRAIT_NAMED_DEF(trait, name, default_)                                                                      \
    ...
    {                                                                                                                                 \
        ...
        {                                                                                                                             \
            template <typename U>                                                                                                     \
            static boost::mpl::aux::yes_tag test(                                                                                     \
                boost::mpl::aux::type_wrapper<U> const volatile *, boost::mpl::aux::type_wrapper<BOOST_MSVC_TYPENAME U::name> * = 0); \
                                                                                                                                      \
        ...
        typedef boost::mpl::aux::type_wrapper<T> t_;                                                                                  \
        BOOST_STATIC_CONSTANT(bool, value =                                                                                           \
                                        sizeof(gcc_3_2_wknd::test(static_cast<t_ *>(0))) == sizeof(boost::mpl::aux::yes_tag));        \
        typedef boost::mpl::bool_<value> type;                                                                                        \
    };                                                                                                                                \
    /**/
...
#define BOOST_MPL_HAS_MEMBER_SUBSTITUTE(args, substitute_macro)                    \
    BOOST_PP_REPEAT(                                                               \
        BOOST_PP_ARRAY_ELEM(2, args), BOOST_MPL_HAS_MEMBER_MULTI_SUBSTITUTE, args) \
    /**/
...
#define BOOST_MPL_HAS_MEMBER_MULTI_ACCEPT(z, n, args)                                                                        \
    ...
    static boost::mpl::aux::yes_tag                                                                                          \
        BOOST_MPL_HAS_MEMBER_INTROSPECTION_TEST_NAME(args)(                                                                  \
            boost::mpl::aux::type_wrapper<V> const volatile *, BOOST_MPL_HAS_MEMBER_INTROSPECTION_SUBSTITUTE_NAME(args, n) < \
                                                                   V::template BOOST_PP_ARRAY_ELEM(1, args) > * = 0);        \
    /**/
#define BOOST_MPL_HAS_MEMBER_ACCEPT(args, member_macro)                        \
    BOOST_PP_REPEAT(                                                           \
        BOOST_PP_ARRAY_ELEM(2, args), BOOST_MPL_HAS_MEMBER_MULTI_ACCEPT, args) \
    /**/
#else
#define BOOST_MPL_HAS_MEMBER_ACCEPT(args, member_macro)          \
    template <typename V>                                        \
...
#define BOOST_MPL_HAS_MEMBER_TEST(args) \
    sizeof(BOOST_MPL_HAS_MEMBER_INTROSPECTION_TEST_NAME(args) < U > (0)) == sizeof(boost::mpl::aux::yes_tag) /**/
#else
#if !BOOST_MPL_HAS_XXX_NO_WRAPPED_TYPES
#define BOOST_MPL_HAS_MEMBER_TEST(args)                     \
    sizeof(                                                 \
        BOOST_MPL_HAS_MEMBER_INTROSPECTION_TEST_NAME(args)( \
            static_cast<boost::mpl::aux::type_wrapper<U> *>(0))) == sizeof(boost::mpl::aux::yes_tag) /**/
#else
#define BOOST_MPL_HAS_MEMBER_TEST(args)                     \
    sizeof(                                                 \
        BOOST_MPL_HAS_MEMBER_INTROSPECTION_TEST_NAME(args)( \
...
#define BOOST_MPL_HAS_MEMBER_IMPLEMENTATION(                                                                                                             \
    ...
    template <                                                                                                                                           \
        typename T, typename fallback_ = boost::mpl::bool_<BOOST_PP_ARRAY_ELEM(3, args)>>                                                                \
    class BOOST_PP_ARRAY_ELEM(0, args)                                                                                                                   \
    {                                                                                                                                                    \
      introspect_macro(args, substitute_macro, member_macro) public : static const bool value = BOOST_MPL_HAS_MEMBER_INTROSPECTION_NAME(args)<T>::value; \
...
#define BOOST_MPL_HAS_MEMBER_WITH_FUNCTION_SFINAE(                             \
    ...
    BOOST_MPL_HAS_MEMBER_IMPLEMENTATION(                                       \
        args, BOOST_MPL_HAS_MEMBER_INTROSPECT, substitute_macro, member_macro) \
    /**/
...
#define BOOST_MPL_HAS_MEMBER_INTROSPECTION_SUBSTITUTE_NAME_WITH_TEMPLATE_SFINAE(         \
    args, n)                                                                             \
    BOOST_PP_CAT(                                                                        \
        boost_mpl_has_xxx_, BOOST_MPL_HAS_MEMBER_INTROSPECTION_SUBSTITUTE_NAME(args, n)) \
    /**/
#endif
...
#define BOOST_MPL_HAS_MEMBER_MULTI_SUBSTITUTE_WITH_TEMPLATE_SFINAE(                 \
    ...
    struct BOOST_MPL_HAS_MEMBER_INTROSPECTION_SUBSTITUTE_NAME_WITH_TEMPLATE_SFINAE( \
        args, n)                                                                    \
    {                                                                               \
        typedef BOOST_MPL_HAS_MEMBER_INTROSPECTION_SUBSTITUTE_TAG_NAME(args)        \
            type;                                                                   \
    };                                                                              \
    /**/
...
#define BOOST_MPL_HAS_MEMBER_SUBSTITUTE_WITH_TEMPLATE_SFINAE(                                           \
    ...
    BOOST_PP_REPEAT(                                                                                    \
        BOOST_PP_ARRAY_ELEM(2, args), BOOST_MPL_HAS_MEMBER_MULTI_SUBSTITUTE_WITH_TEMPLATE_SFINAE, args) \
    /**/

#define BOOST_MPL_HAS_MEMBER_REJECT_WITH_TEMPLATE_SFINAE(                                      \
    args, member_macro)                                                                        \
    template <                                                                                 \
        typename U, typename V = BOOST_MPL_HAS_MEMBER_INTROSPECTION_SUBSTITUTE_TAG_NAME(args)> \
...
#define BOOST_MPL_HAS_MEMBER_MULTI_ACCEPT_WITH_TEMPLATE_SFINAE(                                  \
    ...
    template <typename U>                                                                        \
        struct BOOST_MPL_HAS_MEMBER_INTROSPECTION_TEST_NAME(args)<                               \
            U, typename BOOST_MPL_HAS_MEMBER_INTROSPECTION_SUBSTITUTE_NAME_WITH_TEMPLATE_SFINAE( \
                   args, n) <                                                                    \
                   BOOST_MSVC_TYPENAME U::BOOST_PP_ARRAY_ELEM(1, args) <> > ::type >             \
    {                                                                                            \
        BOOST_STATIC_CONSTANT(bool, value = true);                                               \
        typedef boost::mpl::bool_<value> type;                                                   \
    };                                                                                           \
...
#define BOOST_MPL_HAS_MEMBER_ACCEPT_WITH_TEMPLATE_SFINAE(                                           \
    args, member_macro)                                                                             \
    BOOST_PP_REPEAT(                                                                                \
        BOOST_PP_ARRAY_ELEM(2, args), BOOST_MPL_HAS_MEMBER_MULTI_ACCEPT_WITH_TEMPLATE_SFINAE, args) \
    /**/
...
#define BOOST_MPL_HAS_MEMBER_WITH_TEMPLATE_SFINAE(                                                  \
    ...
    BOOST_MPL_HAS_MEMBER_SUBSTITUTE_WITH_TEMPLATE_SFINAE(                                           \
        args, substitute_macro)                                                                     \
    BOOST_MPL_HAS_MEMBER_IMPLEMENTATION(                                                            \
        args, BOOST_MPL_HAS_MEMBER_INTROSPECT_WITH_TEMPLATE_SFINAE, substitute_macro, member_macro) \
    /**/
...
#define BOOST_MPL_HAS_XXX_TEMPLATE_NAMED_DEF(trait, name, default_)                                                                                                 \
    BOOST_MPL_HAS_MEMBER_WITH_FUNCTION_SFINAE(                                                                                                                      \
        (4, (trait, name, BOOST_MPL_LIMIT_METAFUNCTION_ARITY, default_)), BOOST_MPL_HAS_MEMBER_TEMPLATE_SUBSTITUTE_PARAMETER, BOOST_MPL_HAS_MEMBER_TEMPLATE_ACCESS) \
    /**/
#else
#define BOOST_MPL_HAS_XXX_TEMPLATE_NAMED_DEF(trait, name, default_)                                                                                                 \
