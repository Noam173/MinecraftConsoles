...
struct msvc_apply0
{
    ...
    struct result_
        : f_<aux::msvc_never_true<F>::value>::template apply<>
    {
    };
};
...
struct msvc_apply1
{
    ...
    struct result_
        : f_<aux::msvc_never_true<F>::value>::template apply<T1>
    {
    };
};
...
struct msvc_apply2
{
    ...
    struct result_
        : f_<aux::msvc_never_true<F>::value>::template apply<T1, T2>
    {
    };
};
