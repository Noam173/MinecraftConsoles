...
struct quote1
{
...

    {
        typedef typename quote_impl<
            F<U1>, aux::has_type<F<U1>>::value>::type type;
    };
};
...
struct quote2
{
    ...
    {
        typedef typename quote_impl<
            F<U1, U2>, aux::has_type<F<U1, U2>>::value>::type type;
    };
};
...
struct quote3
{
    ...
    {
        typedef typename quote_impl<
            F<U1, U2, U3>, aux::has_type<F<U1, U2, U3>>::value>::type type;
    };
};
...
struct quote4
{
    ...
    {
        typedef typename quote_impl<
            F<U1, U2, U3, U4>, aux::has_type<F<U1, U2, U3, U4>>::value>::type type;
    };
};
...
struct quote5
{
    ...
    {
        typedef typename quote_impl<
            F<U1, U2, U3, U4, U5>, aux::has_type<F<U1, U2, U3, U4, U5>>::value>::type type;
    };
};
