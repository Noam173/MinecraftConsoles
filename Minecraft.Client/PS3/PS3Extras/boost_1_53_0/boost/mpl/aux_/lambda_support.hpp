...
#define BOOST_MPL_AUX_LAMBDA_SUPPORT(i, name, params)                                                 \
    ...
    BOOST_PP_LIST_FOR_EACH_I_R(                                                                       \
        1, BOOST_MPL_AUX_LAMBDA_SUPPORT_ARG_TYPEDEF_FUNC, typedef, BOOST_PP_TUPLE_TO_LIST(i, params)) \
    struct rebind                                                                                     \
    {                                                                                                 \
...
#define BOOST_MPL_AUX_LAMBDA_SUPPORT_HAS_REBIND(i, name, params)                                 \
    ...
    ::boost::mpl::aux::yes_tag operator|(                                                        \
        ::boost::mpl::aux::has_rebind_tag<int>, name<BOOST_MPL_PP_PARAMS(i, T)> *);              \
    ::boost::mpl::aux::no_tag operator|(                                                         \
        ::boost::mpl::aux::has_rebind_tag<int>, name<BOOST_MPL_PP_ENUM(i, ::boost::mpl::na)> *); \
/**/
#elif !BOOST_WORKAROUND(BOOST_MSVC, < 1300)
#define BOOST_MPL_AUX_LAMBDA_SUPPORT_HAS_REBIND(i, name, params)                                                       \
    template <BOOST_MPL_PP_PARAMS(i, typename T)>                                                                      \
    ::boost::mpl::aux::yes_tag operator|(                                                                              \
        ::boost::mpl::aux::has_rebind_tag<int>, ::boost::mpl::aux::has_rebind_tag<name<BOOST_MPL_PP_PARAMS(i, T)>> *); \
/**/
#else
#define BOOST_MPL_AUX_LAMBDA_SUPPORT_HAS_REBIND(i, name, params) /**/
#endif
