...
#define AUX778076_SEQUENCE_PARAMS()                                  \
    BOOST_PP_ENUM_PARAMS(                                            \
        AUX778076_SEQUENCE_LIMIT, AUX778076_SEQUENCE_TEMPLATE_PARAM) \
    /**/

#define AUX778076_SEQUENCE_ARGS()    \
    BOOST_PP_ENUM_PARAMS(            \
        AUX778076_SEQUENCE_LIMIT, T) \
    /**/

#define AUX778076_SEQUENCE_DEFAULT_PARAMS()                                                      \
    BOOST_PP_ENUM_PARAMS_WITH_A_DEFAULT(                                                         \
        AUX778076_SEQUENCE_LIMIT, AUX778076_SEQUENCE_TEMPLATE_PARAM, AUX778076_SEQUENCE_DEFAULT) \
    /**/
...
#define AUX778076_SEQUENCE_N_PARTIAL_SPEC_ARGS(n)                                                            \
    ...
    BOOST_PP_COMMA_IF(n)                                                                                     \
    BOOST_PP_ENUM(                                                                                           \
        BOOST_PP_SUB_D(1, AUX778076_SEQUENCE_LIMIT, n), BOOST_PP_TUPLE_ELEM_3_2, AUX778076_SEQUENCE_DEFAULT) \
    /**/
...
struct BOOST_PP_CAT(AUX778076_SEQUENCE_NAME, _impl)
{
    typedef aux::BOOST_PP_CAT(AUX778076_SEQUENCE_NAME, _count_args)<
        BOOST_PP_ENUM_PARAMS(AUX778076_SEQUENCE_LIMIT, AUX778076_SEQUENCE_PARAM_NAME)> arg_num_;

    typedef typename aux::BOOST_PP_CAT(AUX778076_SEQUENCE_NAME, _chooser)<arg_num_::value>::template result_<AUX778076_SEQUENCE_ARGS()>::type type;
};
...
struct BOOST_PP_CAT(AUX778076_SEQUENCE_NAME, _chooser)<i_>
{
    ...
    struct result_
    {
        ...
        typedef typename AUX778076_SEQUENCE_NAME_N(i_)<
            AUX778076_SEQUENCE_N_ARGS(i_)>::type type;
#else
