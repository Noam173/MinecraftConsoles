...
#if BOOST_WORKAROUND(BOOST_MPL_CFG_GCC, BOOST_TESTED_AT(0x0302)) || BOOST_WORKAROUND(__BORLANDC__, BOOST_TESTED_AT(0x561)) || BOOST_WORKAROUND(__SUNPRO_CC, BOOST_TESTED_AT(0x530)) || BOOST_WORKAROUND(__DMC__, BOOST_TESTED_AT(0x840))
