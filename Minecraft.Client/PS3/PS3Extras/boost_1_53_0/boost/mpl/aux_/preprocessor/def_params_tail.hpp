...
#define BOOST_MPL_PP_DEF_PARAMS_TAIL_IMPL(i, param, value_func)                        \
    BOOST_MPL_PP_DEF_PARAMS_TAIL_DELAY_1(                                              \
        i, BOOST_MPL_PP_SUB(BOOST_MPL_LIMIT_METAFUNCTION_ARITY, i), param, value_func) \
    /**/
...
#define BOOST_MPL_PP_AUX_TAIL_PARAM_FUNC(unused, i, op) \
    , BOOST_PP_CAT(                                     \
          BOOST_PP_TUPLE_ELEM(3, 1, op), BOOST_PP_ADD_D(1, i, BOOST_PP_INC(BOOST_PP_TUPLE_ELEM(3, 0, op)))) BOOST_PP_TUPLE_ELEM(3, 2, op)() /**/

#define BOOST_MPL_PP_DEF_PARAMS_TAIL_IMPL(i, param, value_func)                                                             \
    BOOST_PP_REPEAT(                                                                                                        \
        BOOST_PP_SUB_D(1, BOOST_MPL_LIMIT_METAFUNCTION_ARITY, i), BOOST_MPL_PP_AUX_TAIL_PARAM_FUNC, (i, param, value_func)) \
    /**/
