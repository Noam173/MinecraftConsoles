...
#if !defined(BOOST_MPL_CFG_BCC590_WORKAROUNDS) && !defined(BOOST_MPL_PREPROCESSING_MODE) && BOOST_WORKAROUND(__BORLANDC__, >= 0x590) && BOOST_WORKAROUND(__BORLANDC__, BOOST_TESTED_AT(0x610))
