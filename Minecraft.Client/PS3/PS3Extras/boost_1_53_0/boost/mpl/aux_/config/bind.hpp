...
#if !defined(BOOST_MPL_CFG_NO_BIND_TEMPLATE) && !defined(BOOST_MPL_PREPROCESSING_MODE) && (BOOST_WORKAROUND(BOOST_MSVC, <= 1300) || BOOST_WORKAROUND(__BORLANDC__, BOOST_TESTED_AT(0x610)))
