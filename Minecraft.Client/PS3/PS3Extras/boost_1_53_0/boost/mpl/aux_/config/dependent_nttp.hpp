...
#if !defined(BOOST_MPL_CFG_NO_DEPENDENT_NONTYPE_PARAMETER_IN_PARTIAL_SPEC) && !defined(BOOST_MPL_PREPROCESSING_MODE) && (BOOST_WORKAROUND(__EDG_VERSION__, BOOST_TESTED_AT(300)) || BOOST_WORKAROUND(BOOST_MPL_CFG_GCC, BOOST_TESTED_AT(0x0302)))
