...
#if !defined(BOOST_MPL_CFG_NO_DEPENDENT_ARRAY_TYPES) && !defined(BOOST_MPL_PREPROCESSING_MODE) && (BOOST_WORKAROUND(__BORLANDC__, BOOST_TESTED_AT(0x610)) || BOOST_WORKAROUND(BOOST_MSVC, <= 1300))
