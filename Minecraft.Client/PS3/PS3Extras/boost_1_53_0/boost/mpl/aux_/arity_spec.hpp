...
#define BOOST_MPL_AUX_NONTYPE_ARITY_SPEC(i, type, name)                         \
    ...
    struct arity<                                                               \
        name<BOOST_MPL_PP_PARAMS(i, T)>, N>                                     \
    {                                                                           \
        BOOST_STATIC_CONSTANT(int, value = BOOST_MPL_LIMIT_METAFUNCTION_ARITY); \
    };                                                                          \
    }                                                                           \
/**/
#else
...
#if defined(BOOST_MPL_CFG_EXTENDED_TEMPLATE_PARAMETERS_MATCHING) && !defined(BOOST_MPL_CFG_NO_FULL_LAMBDA_SUPPORT)
