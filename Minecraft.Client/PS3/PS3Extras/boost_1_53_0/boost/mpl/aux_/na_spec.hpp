...
#define BOOST_MPL_AUX_NA_SPEC_ARITY(i, name)       \
    ...
    struct arity<                                  \
        name<BOOST_MPL_AUX_NA_PARAMS(i)>, N>       \
...
#define BOOST_MPL_AUX_NA_SPEC_LAMBDA(i, name)            \
    template <>                                          \
    struct lambda<                                       \
        name<BOOST_MPL_AUX_NA_PARAMS(i)>, void_, true_>  \
    {                                                    \
    ...
    template <>                                          \
    struct lambda<                                       \
        name<BOOST_MPL_AUX_NA_PARAMS(i)>, void_, false_> \
    {                                                    \
        typedef false_ is_le;                            \
        typedef name<BOOST_MPL_AUX_NA_PARAMS(i)> type;   \
    };                                                   \
...
#define BOOST_MPL_AUX_NA_SPEC_LAMBDA(i, name)                                             \
    ...
    struct lambda<                                                                        \
        name<BOOST_MPL_AUX_NA_PARAMS(i)>, Tag                                             \
...
#if defined(BOOST_MPL_CFG_EXTENDED_TEMPLATE_PARAMETERS_MATCHING) || defined(BOOST_MPL_CFG_NO_FULL_LAMBDA_SUPPORT) && defined(BOOST_MPL_CFG_BROKEN_OVERLOAD_RESOLUTION)
