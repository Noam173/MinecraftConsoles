...
#elif BOOST_WORKAROUND(__BORLANDC__, BOOST_TESTED_AT(0x561)) || BOOST_WORKAROUND(__IBMCPP__, BOOST_TESTED_AT(502)) || (BOOST_WORKAROUND(__HP_aCC, <= 53800) && (BOOST_WORKAROUND(__hpxstd98, != 1)))
