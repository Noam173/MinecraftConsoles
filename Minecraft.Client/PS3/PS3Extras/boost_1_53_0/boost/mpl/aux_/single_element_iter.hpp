...
struct advance<aux::sel_iter<T, is_last_>, Distance>
{
    typedef aux::sel_iter<
        T, (is_last_ + BOOST_MPL_AUX_NESTED_VALUE_WKND(int, Distance))>
        type;
};

template <
    typename T, BOOST_MPL_AUX_NTTP_DECL(int, l1), BOOST_MPL_AUX_NTTP_DECL(int, l2)>
...
struct advance_impl<aux::sel_iter_tag>
{
    ...
    struct apply
    {
        ...
        typedef aux::sel_iter<
            typename Iterator::type, (pos_ + n_)>
            type;
    };
};
