...
template <
    typename BOOST_MPL_AUX_NA_PARAM(Sequence)>
struct sequence_tag
    : aux::sequence_tag_impl<!aux::is_msvc_eti_arg<Sequence>::value>::template result_<Sequence>
{
};
...
#define AUX_CLASS_SEQUENCE_TAG_SPEC(has_tag, has_begin, result_type) \
    template <>                                                      \
    struct sequence_tag_impl<has_tag, has_begin>                     \
    {                                                                \
        template <typename Sequence>                                 \
        struct result2_                                              \
        {                                                            \
...
struct sequence_tag
    : aux::sequence_tag_impl<
          ::boost::mpl::aux::has_tag<Sequence>::value, ::boost::mpl::aux::has_begin<Sequence>::value>::template result2_<Sequence>
{
};
