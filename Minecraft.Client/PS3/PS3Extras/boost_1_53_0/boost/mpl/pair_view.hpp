...
struct distance_impl<aux::pair_iter_tag>
{
    ...
    struct apply
    {
        ...
        typedef typename mpl::distance<
            typename first<Iter1>::type, typename first<Iter2>::type>::type type;
    };
};
...
struct pair_view
{
    ...
    typedef typename min<
        typename iterator_category<iter1_>::type, typename iterator_category<iter2_>::type>::type category_;
