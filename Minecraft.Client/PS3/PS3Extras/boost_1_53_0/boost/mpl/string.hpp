...
struct push_back_impl<mpl::string_tag>
{
    ...
    struct apply
    {
        BOOST_MPL_ASSERT_MSG(
            (BOOST_MPL_LIMIT_STRING_SIZE != mpl::size<Sequence>::type::value), PUSH_BACK_FAILED_MPL_STRING_IS_FULL, (Sequence));
        // If the above assertion didn't fire, then the string is sparse.
        // Repack the string and retry the push_back
        typedef
            typename mpl::push_back<
                typename mpl::copy<
                    Sequence, mpl::back_inserter<mpl::string<>>>::type,
                Value>::type
                type;
    };
    ...
    {                                                                                                         \
        typedef mpl::string<                                                                                  \
            BOOST_PP_ENUM_PARAMS_Z(z, BOOST_PP_DEC(n), C)                                                     \
                    BOOST_PP_COMMA_IF(BOOST_PP_DEC(n))((unsigned)BOOST_PP_CAT(C, BOOST_PP_DEC(n)) > 0xffffff) \
...
#undef M0
    ...
    {
        typedef mpl::string<
            BOOST_PP_ENUM_PARAMS(BOOST_PP_DEC(BOOST_MPL_STRING_MAX_PARAMS), C), BOOST_MPL_MULTICHAR_PUSH_BACK(BOOST_PP_CAT(C, BOOST_PP_DEC(BOOST_MPL_STRING_MAX_PARAMS)), Value::value)>
            type;
    };
};
...
struct push_front_impl<mpl::string_tag>
{
    ...
    {
        BOOST_MPL_ASSERT_MSG(
            (BOOST_MPL_LIMIT_STRING_SIZE != mpl::size<Sequence>::type::value), PUSH_FRONT_FAILED_MPL_STRING_IS_FULL, (Sequence));
        // If the above assertion didn't fire, then the string is sparse.
        // Repack the string and retry the push_front.
        typedef
            typename mpl::push_front<
                typename mpl::reverse_copy<
                    Sequence, mpl::front_inserter<string<>>>::type,
                Value>::type
                type;
    };
...
#undef M0
    ...
    {
        typedef mpl::string<
            BOOST_MPL_MULTICHAR_PUSH_FRONT(C0, Value::value), BOOST_PP_ENUM_SHIFTED_PARAMS(BOOST_MPL_STRING_MAX_PARAMS, C)>
            type0;

#if BOOST_WORKAROUND(__SUNPRO_CC, BOOST_TESTED_AT(0x590))
        typedef
            typename mpl::if_<
                mpl::empty<mpl::string<BOOST_PP_ENUM_PARAMS(BOOST_MPL_STRING_MAX_PARAMS, C)>>, mpl::string<(char)Value::value>, type0>::type
                type;
#else
        typedef type0 type;
#endif
...
#define M0(z, n, data)                                                                          \
    ...
    {                                                                                           \
        ...
        typedef mpl::string<BOOST_PP_ENUM_SHIFTED_PARAMS_Z(z, n, C)>                            \
            type;                                                                               \
    };
...
#undef M0
    ...
    {
        typedef mpl::string<
            BOOST_MPL_MULTICHAR_POP_FRONT(C0), BOOST_PP_ENUM_SHIFTED_PARAMS(BOOST_MPL_STRING_MAX_PARAMS, C)>
            type;
    };
};
...
struct insert_range_impl<mpl::string_tag>
{
    ...
    struct apply
        : mpl::copy<
              mpl::joint_view<
                  mpl::iterator_range<
                      mpl::string_iterator<Sequence, 0, 0>, Pos>,
                  mpl::joint_view<
                      Range, mpl::iterator_range<
    ...
    struct apply
        : mpl::copy<
              mpl::joint_view<
                  ...
                  mpl::iterator_range<
                      typename mpl::if_na<Last, typename mpl::next<First>::type>::type, typename mpl::end<Sequence>::type>>,
              mpl::back_inserter<mpl::string<>>>
    {
    };
};
...
#define M0(z, n, data)                                                                              \
    ...
    {                                                                                               \
        ...
        typedef mpl::string_iterator<string, n + eomc_, eomc_ ? 0 : J + 1>                          \
            next;                                                                                   \
        typedef mpl::string_iterator<string, n, J - 1>                                              \
            prior;                                                                                  \
    ...
    {                                                                                               \
        ...
        typedef mpl::string<BOOST_PP_ENUM_PARAMS(BOOST_MPL_STRING_MAX_PARAMS, C)> string;           \
        typedef std::bidirectional_iterator_tag category;                                           \
        typedef mpl::string_iterator<string, n + eomc_, !eomc_>                                     \
            next;                                                                                   \
        typedef mpl::string_iterator<                                                               \
            string, n - 1, BOOST_MPL_MULTICHAR_LENGTH(BOOST_PP_CAT(C, BOOST_PP_DEC(n))) - 1>        \
            prior;                                                                                  \
