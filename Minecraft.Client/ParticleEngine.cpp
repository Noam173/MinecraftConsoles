...
void ParticleEngine::crack(int x, int y, int z, int face)
{
    ...
    if (face == 0)
    {
        yp = y + tile->getShapeY0() - r;
    }
    if (face == 1)
    {
        yp = y + tile->getShapeY1() + r;
    }
    if (face == 2)
    {
        zp = z + tile->getShapeZ0() - r;
    }
    if (face == 3)
    {
        zp = z + tile->getShapeZ1() + r;
    }
    if (face == 4)
    {
        xp = x + tile->getShapeX0() - r;
    }
    if (face == 5)
    {
        xp = x + tile->getShapeX1() + r;
    }
