...
bool TileRenderer::isTranslucentAt(LevelSource *level, int x, int y, int z)
{
    if (cache)
    {
        ...
        if ((id & 0xffff8000) == 0) // Check 0 <= id <= 32767
        {
            ...
            {
                return ((cache[id] & cache_isTranslucentAt_flag) == cache_isTranslucentAt_flag);
            }
...
float TileRenderer::getShadeBrightness(Tile *tt, LevelSource *level, int x, int y, int z)
{
    if (cache)
    {
        ...
        if ((id & 0xffff8000) == 0) // Check 0 <= id <= 32767
        {
            ...
            {
                return ((cache[id] & cache_isSolidBlockingTile_flag) ? 0.2f : 1.0f);
            }
...
bool TileRenderer::tesselateLeverInWorld(Tile *tt, int x, int y, int z)
{
    ...
    if (!hadFixed)
    {
        this->setFixedTexture(getTexture(Tile::cobblestone));
    }
    float w1 = 4.0f / 16.0f;
    float w2 = 3.0f / 16.0f;
    float h = 3.0f / 16.0f;
...
bool TileRenderer::tesselateTripwireSourceInWorld(Tile *tt, int x, int y, int z)
{
    ...
    if (!hadFixed)
    {
        this->setFixedTexture(getTexture(Tile::wood));
    }
...
bool TileRenderer::tesselateFireInWorld(FireTile *tt, int x, int y, int z)
{
    ...
    else
    {
        ...
        {
            t->vertexUV((float)(x + r), (float)(y + h + yo), (float)(z + 1.0f), (float)(u1), (float)(v0));
            t->vertexUV((float)(x + 0.0f), (float)(y + 0.0f + yo), (float)(z + 1.0f), (float)(u1), (float)(v1));
            t->vertexUV((float)(x + 0.0f), (float)(y + 0.0f + yo), (float)(z + 0.0f), (float)(u0), (float)(v1));
            t->vertexUV((float)(x + r), (float)(y + h + yo), (float)(z + 0.0f), (float)(u0), (float)(v0));
        ...
        if (Tile::fire->canBurn(level, x + 1, y, z))
        {
            t->vertexUV((float)(x + 1 - r), (float)(y + h + yo), (float)(z + 0.0f), (float)(u0), (float)(v0));
            t->vertexUV(static_cast<float>(x + 1 - 0), (float)(y + 0 + yo), (float)(z + 0.0f), (float)(u0), (float)(v1));
            t->vertexUV(static_cast<float>(x + 1 - 0), (float)(y + 0 + yo), (float)(z + 1.0f), (float)(u1), (float)(v1));
            t->vertexUV((float)(x + 1 - r), (float)(y + h + yo), (float)(z + 1.0f), (float)(u1), (float)(v0));

            t->vertexUV((float)(x + 1.0f - r), (float)(y + h + yo), (float)(z + 1.0f), (float)(u1), (float)(v0));
            t->vertexUV((float)(x + 1.0f - 0.0f), (float)(y + 0.0f + yo), (float)(z + 1.0f), (float)(u1), (float)(v1));
            t->vertexUV((float)(x + 1.0f - 0), (float)(y + 0.0f + yo), (float)(z + 0.0f), (float)(u0), (float)(v1));
            t->vertexUV((float)(x + 1.0f - r), (float)(y + h + yo), (float)(z + 0.0f), (float)(u0), (float)(v0));
        }
        if (Tile::fire->canBurn(level, x, y, z - 1))
        {
            t->vertexUV((float)(x + 0.0f), (float)(y + h + yo), (float)(z + r), (float)(u1), (float)(v0));
            t->vertexUV((float)(x + 0.0f), (float)(y + 0.0f + yo), (float)(z + 0.0f), (float)(u1), (float)(v1));
            t->vertexUV((float)(x + 1.0f), (float)(y + 0.0f + yo), (float)(z + 0.0f), (float)(u0), (float)(v1));
            t->vertexUV((float)(x + 1.0f), (float)(y + h + yo), (float)(z + r), (float)(u0), (float)(v0));
        ...
        if (Tile::fire->canBurn(level, x, y, z + 1))
        {
            t->vertexUV((float)(x + 1.0f), (float)(y + h + yo), (float)(z + 1.0f - r), (float)(u0), (float)(v0));
            t->vertexUV((float)(x + 1.0f), (float)(y + 0.0f + yo), (float)(z + 1.0f - 0.0f), (float)(u0), (float)(v1));
            t->vertexUV((float)(x + 0.0f), (float)(y + 0.0f + yo), (float)(z + 1.0f - 0.0f), (float)(u1), (float)(v1));
            t->vertexUV((float)(x + 0.0f), (float)(y + h + yo), (float)(z + 1.0f - r), (float)(u1), (float)(v0));
        ...
        if (Tile::fire->canBurn(level, x, y + 1.0f, z))
        {
            ...
            if (((x + y + z) & 1) == 0)
            {
                t->vertexUV(static_cast<float>(x0_), (float)(y + h), static_cast<float>(z + 0), (float)(u1), (float)(v0));
                t->vertexUV(static_cast<float>(x0), static_cast<float>(y + 0), static_cast<float>(z + 0), (float)(u1), (float)(v1));
                t->vertexUV(static_cast<float>(x0), static_cast<float>(y + 0), static_cast<float>(z + 1), (float)(u0), (float)(v1));
                t->vertexUV(static_cast<float>(x0_), (float)(y + h), static_cast<float>(z + 1), (float)(u0), (float)(v0));
                ...
                t->vertexUV(static_cast<float>(x1_), (float)(y + h), (float)(z + 1.0f), (float)(u1), (float)(v0));
                t->vertexUV(static_cast<float>(x1), (float)(y + 0.0f), (float)(z + 1.0f), (float)(u1), (float)(v1));
                t->vertexUV(static_cast<float>(x1), (float)(y + 0.0f), static_cast<float>(z + 0), (float)(u0), (float)(v1));
                t->vertexUV(static_cast<float>(x1_), (float)(y + h), static_cast<float>(z + 0), (float)(u0), (float)(v0));
            }
            else
            {
                t->vertexUV((float)(x + 0.0f), (float)(y + h), static_cast<float>(z1_), (float)(u1), (float)(v0));
                t->vertexUV((float)(x + 0.0f), (float)(y + 0.0f), static_cast<float>(z1), (float)(u1), (float)(v1));
                t->vertexUV((float)(x + 1.0f), (float)(y + 0.0f), static_cast<float>(z1), (float)(u0), (float)(v1));
                t->vertexUV((float)(x + 1.0f), (float)(y + h), static_cast<float>(z1_), (float)(u0), (float)(v0));
                ...
                t->vertexUV((float)(x + 1.0f), (float)(y + h), static_cast<float>(z0_), (float)(u1), (float)(v0));
                t->vertexUV((float)(x + 1.0f), (float)(y + 0.0f), static_cast<float>(z0), (float)(u1), (float)(v1));
                t->vertexUV((float)(x + 0.0f), (float)(y + 0.0f), static_cast<float>(z0), (float)(u0), (float)(v1));
                t->vertexUV((float)(x + 0.0f), (float)(y + h), static_cast<float>(z0_), (float)(u0), (float)(v0));
            }
        }
    }
...
bool TileRenderer::tesselateDustInWorld(Tile *tt, int x, int y, int z)
{
    ...
    bool w = RedStoneDustTile::shouldConnectTo(level, x - 1, y, z, Direction::WEST) || (!level->isSolidBlockingTile(x - 1, y, z) && RedStoneDustTile::shouldConnectTo(level, x - 1, y - 1, z,
                                                                                                                                                                      Direction::UNDEFINED));
    bool e = RedStoneDustTile::shouldConnectTo(level, x + 1, y, z, Direction::EAST) || (!level->isSolidBlockingTile(x + 1, y, z) && RedStoneDustTile::shouldConnectTo(level, x + 1, y - 1, z,
                                                                                                                                                                      Direction::UNDEFINED));
    bool n = RedStoneDustTile::shouldConnectTo(level, x, y, z - 1, Direction::NORTH) || (!level->isSolidBlockingTile(x, y, z - 1) && RedStoneDustTile::shouldConnectTo(level, x, y - 1, z - 1,
                                                                                                                                                                       Direction::UNDEFINED));
    bool s = RedStoneDustTile::shouldConnectTo(level, x, y, z + 1, Direction::SOUTH) || (!level->isSolidBlockingTile(x, y, z + 1) && RedStoneDustTile::shouldConnectTo(level, x, y - 1, z + 1,
                                                                                                                                                                       Direction::UNDEFINED));
    ...
    if (pic == 0)
    {
        ...
        if (!w)
        {
            x0 += cutDistance / static_cast<float>(SharedConstants::WORLD_RESOLUTION);
        }
        if (!w)
        {
            u0 += cutDistance;
        ...
        if (!e)
        {
            x1 -= cutDistance / static_cast<float>(SharedConstants::WORLD_RESOLUTION);
        }
        if (!e)
        {
            u1 -= cutDistance;
        ...
        if (!n)
        {
            z0 += cutDistance / static_cast<float>(SharedConstants::WORLD_RESOLUTION);
        }
        if (!n)
        {
            v0 += cutDistance;
        ...
        if (!s)
        {
            z1 -= cutDistance / static_cast<float>(SharedConstants::WORLD_RESOLUTION);
        }
        if (!s)
        {
            v1 -= cutDistance;
...
bool TileRenderer::tesselateLadderInWorld(Tile *tt, int x, int y, int z)
{
    ...
    if (face == 5)
    {
        t->vertexUV((float)(x + r), (float)(y + 1 + o), (float)(z + 1 + o), (float)(u0), (float)(v0));
        t->vertexUV((float)(x + r), (float)(y + 0 - o), (float)(z + 1 + o), (float)(u0), (float)(v1));
        t->vertexUV((float)(x + r), (float)(y + 0 - o), (float)(z + 0 - o), (float)(u1), (float)(v1));
        t->vertexUV((float)(x + r), (float)(y + 1 + o), (float)(z + 0 - o), (float)(u1), (float)(v0));
    }
    if (face == 4)
    {
        t->vertexUV((float)(x + 1 - r), (float)(y + 0 - o), (float)(z + 1 + o), (float)(u1), (float)(v1));
        t->vertexUV((float)(x + 1 - r), (float)(y + 1 + o), (float)(z + 1 + o), (float)(u1), (float)(v0));
        t->vertexUV((float)(x + 1 - r), (float)(y + 1 + o), (float)(z + 0 - o), (float)(u0), (float)(v0));
        t->vertexUV((float)(x + 1 - r), (float)(y + 0 - o), (float)(z + 0 - o), (float)(u0), (float)(v1));
    }
    if (face == 3)
    {
        t->vertexUV((float)(x + 1 + o), (float)(y + 0 - o), (float)(z + r), (float)(u1), (float)(v1));
        t->vertexUV((float)(x + 1 + o), (float)(y + 1 + o), (float)(z + r), (float)(u1), (float)(v0));
        t->vertexUV((float)(x + 0 - o), (float)(y + 1 + o), (float)(z + r), (float)(u0), (float)(v0));
        t->vertexUV((float)(x + 0 - o), (float)(y + 0 - o), (float)(z + r), (float)(u0), (float)(v1));
    }
    if (face == 2)
    {
        t->vertexUV((float)(x + 1 + o), (float)(y + 1 + o), (float)(z + 1 - r), (float)(u0), (float)(v0));
        t->vertexUV((float)(x + 1 + o), (float)(y + 0 - o), (float)(z + 1 - r), (float)(u0), (float)(v1));
        t->vertexUV((float)(x + 0 - o), (float)(y + 0 - o), (float)(z + 1 - r), (float)(u1), (float)(v1));
        t->vertexUV((float)(x + 0 - o), (float)(y + 1 + o), (float)(z + 1 - r), (float)(u1), (float)(v0));
    }
...
void TileRenderer::tesselateTorch(Tile *tt, float x, float y, float z, float xxa, float zza, int data)
{
    ...
    t->vertexUV((float)(x - r + xxa), (float)(y + 0), (float)(z0 + zza), (float)(u0), (float)(v1));
    t->vertexUV((float)(x - r + xxa), (float)(y + 0), (float)(z1 + zza), (float)(u1), (float)(v1));
    t->vertexUV((float)(x - r), (float)(y + 1), (float)(z1), (float)(u1), (float)(v0));

    t->vertexUV((float)(x + r), (float)(y + 1), (float)(z1), (float)(u0), (float)(v0));
    t->vertexUV((float)(x + xxa + r), (float)(y + 0), (float)(z1 + zza), (float)(u0), (float)(v1));
    t->vertexUV((float)(x + xxa + r), (float)(y + 0), (float)(z0 + zza), (float)(u1), (float)(v1));
    t->vertexUV((float)(x + r), (float)(y + 1), (float)(z0), (float)(u1), (float)(v0));

    t->vertexUV((float)(x0), (float)(y + 1), (float)(z + r), (float)(u0), (float)(v0));
    t->vertexUV((float)(x0 + xxa), (float)(y + 0), (float)(z + r + zza), (float)(u0), (float)(v1));
    t->vertexUV((float)(x1 + xxa), (float)(y + 0), (float)(z + r + zza), (float)(u1), (float)(v1));
    t->vertexUV((float)(x1), (float)(y + 1), (float)(z + r), (float)(u1), (float)(v0));

    t->vertexUV((float)(x1), (float)(y + 1), (float)(z - r), (float)(u0), (float)(v0));
    t->vertexUV((float)(x1 + xxa), (float)(y + 0), (float)(z - r + zza), (float)(u0), (float)(v1));
    t->vertexUV((float)(x0 + xxa), (float)(y + 0), (float)(z - r + zza), (float)(u1), (float)(v1));
    ...
    if (faceFlags & 0x04)
    {
...

        {
            if (smoothShapeLighting) // MGH - unifying tesselateBlockInWorldWithAmbienceOcclusionTexLighting and tesselateBlockInWorldWithAmbienceOcclusionTexLighting2
            {
                ...
                ll1 = static_cast<float>(_ll1 * tileShapeY1 * (1.0 - tileShapeX0) + _ll2 * tileShapeY0 * tileShapeX0 + _ll3 * (1.0 - tileShapeY1) * tileShapeX0 + _ll4 * (1.0 - tileShapeY1) * (1.0 - tileShapeX0));
                ll2 = static_cast<float>(_ll1 * tileShapeY1 * (1.0 - tileShapeX1) + _ll2 * tileShapeY1 * tileShapeX1 + _ll3 * (1.0 - tileShapeY1) * tileShapeX1 + _ll4 * (1.0 - tileShapeY1) * (1.0 - tileShapeX1));
                ll3 = static_cast<float>(_ll1 * tileShapeY0 * (1.0 - tileShapeX1) + _ll2 * tileShapeY0 * tileShapeX1 + _ll3 * (1.0 - tileShapeY0) * tileShapeX1 + _ll4 * (1.0 - tileShapeY0) * (1.0 - tileShapeX1));
                ll4 = static_cast<float>(_ll1 * tileShapeY0 * (1.0 - tileShapeX0) + _ll2 * tileShapeY0 * tileShapeX0 + _ll3 * (1.0 - tileShapeY0) * tileShapeX0 + _ll4 * (1.0 - tileShapeY0) * (1.0 - tileShapeX0));
    ...
    if (faceFlags & 0x08)
    {
...

        {
            if (smoothShapeLighting) // MGH - unifying tesselateBlockInWorldWithAmbienceOcclusionTexLighting and tesselateBlockInWorldWithAmbienceOcclusionTexLighting2
            {
                ...
                ll1 = static_cast<float>(_ll1 * tileShapeY1 * (1.0 - tileShapeX0) + _ll4 * tileShapeY1 * tileShapeX0 + _ll3 * (1.0 - tileShapeY1) * tileShapeX0 + _ll2 * (1.0 - tileShapeY1) * (1.0 - tileShapeX0));
                ll2 = static_cast<float>(_ll1 * tileShapeY0 * (1.0 - tileShapeX0) + _ll4 * tileShapeY0 * tileShapeX0 + _ll3 * (1.0 - tileShapeY0) * tileShapeX0 + _ll2 * (1.0 - tileShapeY0) * (1.0 - tileShapeX0));
                ll3 = static_cast<float>(_ll1 * tileShapeY0 * (1.0 - tileShapeX1) + _ll4 * tileShapeY0 * tileShapeX1 + _ll3 * (1.0 - tileShapeY0) * tileShapeX1 + _ll2 * (1.0 - tileShapeY0) * (1.0 - tileShapeX1));
                ll4 = static_cast<float>(_ll1 * tileShapeY1 * (1.0 - tileShapeX1) + _ll4 * tileShapeY1 * tileShapeX1 + _ll3 * (1.0 - tileShapeY1) * tileShapeX1 + _ll2 * (1.0 - tileShapeY1) * (1.0 - tileShapeX1));
    ...
    if (faceFlags & 0x10) // ((noCulling) || (tt->shouldRenderFace(level, pX - 1, pY, pZ, 4)))
    {
...

        {
            if (smoothShapeLighting) // MGH - unifying tesselateBlockInWorldWithAmbienceOcclusionTexLighting and tesselateBlockInWorldWithAmbienceOcclusionTexLighting2
            {
                ...
                ll1 = static_cast<float>(_ll1 * tileShapeY1 * tileShapeZ1 + _ll2 * tileShapeY1 * (1.0 - tileShapeZ1) + _ll3 * (1.0 - tileShapeY1) * (1.0 - tileShapeZ1) + _ll4 * (1.0 - tileShapeY1) * tileShapeZ1);
                ll2 = static_cast<float>(_ll1 * tileShapeY1 * tileShapeZ0 + _ll2 * tileShapeY1 * (1.0 - tileShapeZ0) + _ll3 * (1.0 - tileShapeY1) * (1.0 - tileShapeZ0) + _ll4 * (1.0 - tileShapeY1) * tileShapeZ0);
                ll3 = static_cast<float>(_ll1 * tileShapeY0 * tileShapeZ0 + _ll2 * tileShapeY0 * (1.0 - tileShapeZ0) + _ll3 * (1.0 - tileShapeY0) * (1.0 - tileShapeZ0) + _ll4 * (1.0 - tileShapeY0) * tileShapeZ0);
                ll4 = static_cast<float>(_ll1 * tileShapeY0 * tileShapeZ1 + _ll2 * tileShapeY0 * (1.0 - tileShapeZ1) + _ll3 * (1.0 - tileShapeY0) * (1.0 - tileShapeZ1) + _ll4 * (1.0 - tileShapeY0) * tileShapeZ1);
    ...
    if (faceFlags & 0x20) // ((noCulling) || (tt->shouldRenderFace(level, pX + 1, pY, pZ, 5)))
    {
...

        {
            if (smoothShapeLighting) // MGH - unifying tesselateBlockInWorldWithAmbienceOcclusionTexLighting and tesselateBlockInWorldWithAmbienceOcclusionTexLighting2
            {
                ...
                ll1 = static_cast<float>(_ll1 * (1.0 - tileShapeY0) * tileShapeZ1 + _ll2 * (1.0 - tileShapeY0) * (1.0 - tileShapeZ1) + _ll3 * tileShapeY0 * (1.0 - tileShapeZ1) + _ll4 * tileShapeY0 * tileShapeZ1);
                ll2 = static_cast<float>(_ll1 * (1.0 - tileShapeY0) * tileShapeZ0 + _ll2 * (1.0 - tileShapeY0) * (1.0 - tileShapeZ0) + _ll3 * tileShapeY0 * (1.0 - tileShapeZ0) + _ll4 * tileShapeY0 * tileShapeZ0);
                ll3 = static_cast<float>(_ll1 * (1.0 - tileShapeY1) * tileShapeZ0 + _ll2 * (1.0 - tileShapeY1) * (1.0 - tileShapeZ0) + _ll3 * tileShapeY1 * (1.0 - tileShapeZ0) + _ll4 * tileShapeY1 * tileShapeZ0);
                ll4 = static_cast<float>(_ll1 * (1.0 - tileShapeY1) * tileShapeZ1 + _ll2 * (1.0 - tileShapeY1) * (1.0 - tileShapeZ1) + _ll3 * tileShapeY1 * (1.0 - tileShapeZ1) + _ll4 * tileShapeY1 * tileShapeZ1);
...
bool TileRenderer::tesselateFenceInWorld(FenceTile *tt, int x, int y, int z)
{
    ...
    if (tt->connectsTo(level, x - 1, y, z) || tt->connectsTo(level, x + 1, y, z))
    {
        vertical = true;
    }
    if (tt->connectsTo(level, x, y, z - 1) || tt->connectsTo(level, x, y, z + 1))
    {
        horizontal = true;
    }
...
bool TileRenderer::tesselateFenceGateInWorld(FenceGateTile *tt, int x, int y, int z)
{
    ...
    if (((direction == Direction::NORTH || direction == Direction::SOUTH) && level->getTile(x - 1, y, z) == Tile::cobbleWall_Id && level->getTile(x + 1, y, z) == Tile::cobbleWall_Id) || ((direction == Direction::EAST || direction == Direction::WEST) && level->getTile(x, y, z - 1) == Tile::cobbleWall_Id && level->getTile(x, y, z + 1) == Tile::cobbleWall_Id))
    {
        h00 -= 3.0f / 16.0f;
        h01 -= 3.0f / 16.0f;
        h10 -= 3.0f / 16.0f;
...
void TileRenderer::renderTile(Tile *tile, int data, float brightness, float fAlpha, bool useCompiled)
{
    ...
    else if (shape == Tile::SHAPE_STAIRS)
    {
        for (int i = 0; i < 2; i++)
        {
            if (i == 0)
            {
                setShape(0, 0, 0, 1, 1, 0.5f);
            }
            if (i == 1)
            {
                setShape(0, 0, 0.5f, 1, 0.5f, 1);
            }
    ...
    else if (shape == Tile::SHAPE_FENCE)
    {
        for (int i = 0; i < 4; i++)
        {
            ...
            if (i == 0)
            {
                setShape(0.5f - w, 0, 0, 0.5f + w, 1, w * 2);
            }
            if (i == 1)
            {
                setShape(0.5f - w, 0, 1 - w * 2, 0.5f + w, 1, 1);
            }
            w = 1 / 16.0f;
            if (i == 2)
            {
                setShape(0.5f - w, 1 - w * 3, -w * 2, 0.5f + w, 1 - w, 1 + w * 2);
            }
            if (i == 3)
            {
                setShape(0.5f - w, 0.5f - w * 3, -w * 2, 0.5f + w, 0.5f - w, 1 + w * 2);
            }
    ...
    else if (shape == Tile::SHAPE_FENCE_GATE)
    {
        for (int i = 0; i < 3; i++)
        {
            ...
            if (i == 0)
            {
                setShape(0.5f - w, .3f, 0, 0.5f + w, 1, w * 2);
            }
            if (i == 1)
            {
                setShape(0.5f - w, .3f, 1 - w * 2, 0.5f + w, 1, 1);
            }
            w = 1 / 16.0f;
            if (i == 2)
            {
                setShape(0.5f - w, .5f, 0, 0.5f + w, 1 - w, 1);
            }
...
bool TileRenderer::canRender(int renderShape)
{
    ...
    if (renderShape == Tile::SHAPE_TREE)
    {
        return true;
    }
    if (renderShape == Tile::SHAPE_QUARTZ)
    {
        return true;
    }
    ...
    if (renderShape == Tile::SHAPE_EGG)
    {
        return true;
    }
    if (renderShape == Tile::SHAPE_ENTITYTILE_ANIMATED)
    {
        return true;
    }
    ...
    if (renderShape == Tile::SHAPE_PISTON_BASE)
    {
        return true;
    }
    if (renderShape == Tile::SHAPE_PORTAL_FRAME)
    {
        return true;
    }
    if (renderShape == Tile::SHAPE_WALL)
    {
        return true;
    }
    if (renderShape == Tile::SHAPE_BEACON)
    {
        return true;
    }
    if (renderShape == Tile::SHAPE_ANVIL)
    {
        return true;
    }
    return false;
