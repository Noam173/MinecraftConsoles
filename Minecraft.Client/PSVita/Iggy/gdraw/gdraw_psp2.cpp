...
{
    if (gdraw->dynamic_stats.allocs_attempted == gdraw->dynamic_stats.allocs_succeeded + 1)
...
static RADINLINE void fence_resources(void *r1, void *r2 = nullptr, void *r3 = nullptr)
{
    ...
    if (r1)
    {
        check_resource(r1)->fence = fence;
    }
    if (r2)
    {
        check_resource(r2)->fence = fence;
    }
    if (r3)
    {
        check_resource(r3)->fence = fence;
    }
}
