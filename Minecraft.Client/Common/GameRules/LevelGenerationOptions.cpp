...
bool JustGrSource::requiresTexturePack()
{
...
wstring JustGrSource::getDefaultSaveName()
{
    return m_defaultSaveName;
}
LPCWSTR JustGrSource::getWorldName()
{
    return m_worldName.c_str();
}
LPCWSTR JustGrSource::getDisplayName()
{
    return m_displayName.c_str();
}
wstring JustGrSource::getGrfPath()
{
    return m_grfPath;
}
bool JustGrSource::requiresBaseSave()
{
    return m_bRequiresBaseSave;
};
wstring JustGrSource::getBaseSavePath()
{
...
void JustGrSource::setDefaultSaveName(const wstring &x)
{
    m_defaultSaveName = x;
}
void JustGrSource::setWorldName(const wstring &x)
{
    m_worldName = x;
}
void JustGrSource::setDisplayName(const wstring &x)
{
    m_displayName = x;
}
void JustGrSource::setGrfPath(const wstring &x)
{
    m_grfPath = x;
}
void JustGrSource::setBaseSavePath(const wstring &x)
{
    m_baseSavePath = x;
    m_bRequiresBaseSave = true;
}

bool JustGrSource::ready()
{
    return true;
}
...
unordered_map<wstring, ConsoleSchematicFile *> *LevelGenerationOptions::getUnfinishedSchematicFiles()
{
    ...
    unordered_map<wstring, ConsoleSchematicFile *> *out = new unordered_map<wstring, ConsoleSchematicFile *>();
...
wstring LevelGenerationOptions::getGrfPath()
{
...
wstring LevelGenerationOptions::getBaseSavePath()
{
...
void LevelGenerationOptions::setDefaultSaveName(const wstring &x)
{
    info()->setDefaultSaveName(x);
}
void LevelGenerationOptions::setWorldName(const wstring &x)
{
    info()->setWorldName(x);
}
void LevelGenerationOptions::setDisplayName(const wstring &x)
{
    info()->setDisplayName(x);
}
void LevelGenerationOptions::setGrfPath(const wstring &x)
{
    info()->setGrfPath(x);
}
void LevelGenerationOptions::setBaseSavePath(const wstring &x)
{
...
{
    return m_dwBaseSaveSize > 0 && m_pbBaseSaveData != nullptr;
}
...
int64_t LevelGenerationOptions::getLevelSeed()
{
    return m_seed;
}
