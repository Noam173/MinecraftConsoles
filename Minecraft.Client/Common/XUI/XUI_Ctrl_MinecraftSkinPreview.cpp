...
//-----------------------------------------------------------------------------
CXuiCtrlMinecraftSkinPreview::CXuiCtrlMinecraftSkinPreview() : m_bDirty(FALSE),
                                                               m_fScale(1.0f),
                                                               m_fAlpha(1.0f)
{
...
void CXuiCtrlMinecraftSkinPreview::CyclePreviousAnimation()
{
    ...
    {
        m_currentAnimation = static_cast<ESkinPreviewAnimations>(e_SkinPreviewAnimation_Count - 1);
    }
