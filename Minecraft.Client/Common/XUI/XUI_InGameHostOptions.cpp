...
HRESULT CScene_InGameHostOptions::OnInit(XUIMessageInit *pInitData, BOOL &bHandled)
{
    ...
    if (app.GetGameHostOption(eGameHostOption_CheatsEnabled) && Player::getPlayerGamePrivilege(privs, Player::ePlayerGamePrivilege_CanTeleport) && (g_NetworkManager.GetPlayerCount() > 1))
    {
