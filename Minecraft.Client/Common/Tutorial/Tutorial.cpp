...
Tutorial::Tutorial(int iPad, bool isFullTutorial /*= false*/) : m_iPad(iPad)
{
    ...
    {
        addHint(e_Tutorial_State_Gameplay, new TutorialHint(e_Tutorial_Hint_Hold_To_Mine, this, IDS_TUTORIAL_HINT_HOLD_TO_MINE, TutorialHint::e_Hint_HoldToMine));
    }
    if (!isHintCompleted(e_Tutorial_Hint_Tool_Damaged))
    {
        addHint(e_Tutorial_State_Gameplay, new TutorialHint(e_Tutorial_Hint_Tool_Damaged, this, IDS_TUTORIAL_HINT_TOOL_DAMAGED, TutorialHint::e_Hint_ToolDamaged));
    }
    if (!isHintCompleted(e_Tutorial_Hint_Swim_Up))
    {
        addHint(e_Tutorial_State_Gameplay, new TutorialHint(e_Tutorial_Hint_Swim_Up, this, IDS_TUTORIAL_HINT_SWIM_UP, TutorialHint::e_Hint_SwimUp));
    }
    ...
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Rock, this, rockItems, 1));
    }

    int stoneItems[] = {Tile::cobblestone_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Stone))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Stone, this, stoneItems, 1));
    }

    int plankItems[] = {Tile::wood_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Planks))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Planks, this, plankItems, 1));
    }

    int saplingItems[] = {Tile::sapling_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Sapling))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Sapling, this, saplingItems, 1));
    }

    int unbreakableItems[] = {Tile::unbreakable_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Unbreakable))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Unbreakable, this, unbreakableItems, 1));
    }

    int waterItems[] = {Tile::water_Id, Tile::calmWater_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Water))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Water, this, waterItems, 2));
    }

    int lavaItems[] = {Tile::lava_Id, Tile::calmLava_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Lava))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Lava, this, lavaItems, 2));
    }

    int sandItems[] = {Tile::sand_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Sand))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Sand, this, sandItems, 1));
    }

    int gravelItems[] = {Tile::gravel_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Gravel))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Gravel, this, gravelItems, 1));
    }

    int goldOreItems[] = {Tile::goldOre_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Gold_Ore))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Gold_Ore, this, goldOreItems, 1));
    }

    int ironOreItems[] = {Tile::ironOre_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Iron_Ore))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Iron_Ore, this, ironOreItems, 1));
    }

    int coalOreItems[] = {Tile::coalOre_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Coal_Ore))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Coal_Ore, this, coalOreItems, 1));
    }

    int treeTrunkItems[] = {Tile::treeTrunk_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Tree_Trunk))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Tree_Trunk, this, treeTrunkItems, 1));
    }

    int leavesItems[] = {Tile::leaves_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Leaves))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Leaves, this, leavesItems, 1));
    }

    int glassItems[] = {Tile::glass_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Glass))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Glass, this, glassItems, 1));
    }

    int lapisOreItems[] = {Tile::lapisOre_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Lapis_Ore))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Lapis_Ore, this, lapisOreItems, 1));
    }

    int lapisBlockItems[] = {Tile::lapisBlock_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Lapis_Block))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Lapis_Block, this, lapisBlockItems, 1));
    }

    int dispenserItems[] = {Tile::dispenser_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Dispenser))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Dispenser, this, dispenserItems, 1));
    }
    ...
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Note_Block, this, noteBlockItems, 1));
    }

    int poweredRailItems[] = {Tile::goldenRail_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Powered_Rail))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Powered_Rail, this, poweredRailItems, 1));
    }
    ...
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Wool, this, woolItems, 1));
    }

    int flowerItems[] = {Tile::flower_Id, Tile::rose_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Flower))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Flower, this, flowerItems, 2));
    }

    int mushroomItems[] = {Tile::mushroom_brown_Id, Tile::mushroom_red_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Mushroom))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Mushroom, this, mushroomItems, 2));
    }

    int goldBlockItems[] = {Tile::goldBlock_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Gold_Block))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Gold_Block, this, goldBlockItems, 1));
    }

    int ironBlockItems[] = {Tile::ironBlock_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Iron_Block))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Iron_Block, this, ironBlockItems, 1));
    }
    ...
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Red_Brick, this, redBrickItems, 1));
    }

    int tntItems[] = {Tile::tnt_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Tnt))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Tnt, this, tntItems, 1));
    }

    int bookshelfItems[] = {Tile::bookshelf_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Bookshelf))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Bookshelf, this, bookshelfItems, 1));
    }

    int mossStoneItems[] = {Tile::mossyCobblestone_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Moss_Stone))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Moss_Stone, this, mossStoneItems, 1));
    }

    int obsidianItems[] = {Tile::obsidian_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Obsidian))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Obsidian, this, obsidianItems, 1));
    }

    int torchItems[] = {Tile::torch_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Torch))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Torch, this, torchItems, 1));
    }

    int mobSpawnerItems[] = {Tile::mobSpawner_Id};
    if (!isHintCompleted(e_Tutorial_Hint_MobSpawner))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_MobSpawner, this, mobSpawnerItems, 1));
    }

    int chestItems[] = {Tile::chest_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Chest))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Chest, this, chestItems, 1));
    }

    int redstoneItems[] = {Tile::redStoneDust_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Redstone))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Redstone, this, redstoneItems, 1, Item::redStone_Id));
    }

    int diamondOreItems[] = {Tile::diamondOre_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Diamond_Ore))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Diamond_Ore, this, diamondOreItems, 1));
    }

    int diamondBlockItems[] = {Tile::diamondBlock_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Diamond_Block))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Diamond_Block, this, diamondBlockItems, 1));
    }

    int craftingTableItems[] = {Tile::workBench_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Crafting_Table))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Crafting_Table, this, craftingTableItems, 1));
    }

    int cropsItems[] = {Tile::wheat_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Crops))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Crops, this, cropsItems, 1, -1, -1, 7));
    }

    int farmlandItems[] = {Tile::farmland_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Farmland))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Farmland, this, farmlandItems, 1));
    }

    int furnaceItems[] = {Tile::furnace_Id, Tile::furnace_lit_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Furnace))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Furnace, this, furnaceItems, 2));
    }

    int signItems[] = {Tile::sign_Id, Tile::wallSign_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Sign))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Sign, this, signItems, 2, Item::sign_Id));
    }

    int doorWoodItems[] = {Tile::door_wood_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Door_Wood))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Door_Wood, this, doorWoodItems, 1, Item::door_wood->id));
    }

    int ladderItems[] = {Tile::ladder_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Ladder))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Ladder, this, ladderItems, 1));
    }
    ...
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Stairs_Stone, this, stairsStoneItems, 9));
    }

    int railItems[] = {Tile::rail_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Rail))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Rail, this, railItems, 1));
    }

    int leverItems[] = {Tile::lever_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Lever))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Lever, this, leverItems, 1));
    }
    ...
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_PressurePlate, this, pressurePlateItems, 2));
    }

    int doorIronItems[] = {Tile::door_iron_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Door_Iron))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Door_Iron, this, doorIronItems, 1, Item::door_iron->id));
    }

    int redstoneOreItems[] = {Tile::redStoneOre_Id, Tile::redStoneOre_lit_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Redstone_Ore))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Redstone_Ore, this, redstoneOreItems, 2));
    }
    ...
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Redstone_Torch, this, redstoneTorchItems, 2));
    }

    int buttonItems[] = {Tile::button_stone_Id, Tile::button_wood_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Button))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Button, this, buttonItems, 2));
    }

    int snowItems[] = {Tile::snow_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Snow))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Snow, this, snowItems, 1));
    }

    int iceItems[] = {Tile::ice_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Ice))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Ice, this, iceItems, 1));
    }

    int cactusItems[] = {Tile::cactus_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Cactus))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Cactus, this, cactusItems, 1));
    }

    int clayItems[] = {Tile::clay_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Clay))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Clay, this, clayItems, 1));
    }

    int sugarCaneItems[] = {Tile::reeds_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Sugarcane))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Sugarcane, this, sugarCaneItems, 1));
    }

    int recordPlayerItems[] = {Tile::jukebox_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Record_Player))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Record_Player, this, recordPlayerItems, 1));
    }

    int pumpkinItems[] = {Tile::pumpkin_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Pumpkin))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Pumpkin, this, pumpkinItems, 1, -1, -1, 0));
    }

    int hellRockItems[] = {Tile::netherRack_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Hell_Rock))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Hell_Rock, this, hellRockItems, 1));
    }

    int hellSandItems[] = {Tile::soulsand_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Hell_Sand))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Hell_Sand, this, hellSandItems, 1));
    }

    int glowstoneItems[] = {Tile::glowstone_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Glowstone))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Glowstone, this, glowstoneItems, 1));
    }

    int portalItems[] = {Tile::portalTile_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Portal))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Portal, this, portalItems, 1));
    }

    int pumpkinLitItems[] = {Tile::litPumpkin_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Pumpkin_Lit))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Pumpkin_Lit, this, pumpkinLitItems, 1, -1, -1, 0));
    }

    int cakeItems[] = {Tile::cake_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Cake))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Cake, this, cakeItems, 1));
    }

    int redstoneRepeaterItems[] = {Tile::diode_on_Id, Tile::diode_off_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Redstone_Repeater))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Redstone_Repeater, this, redstoneRepeaterItems, 2, Item::repeater_Id));
    }

    int trapdoorItems[] = {Tile::trapdoor_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Trapdoor))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Trapdoor, this, trapdoorItems, 1));
    }

    int pistonItems[] = {Tile::pistonBase_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Piston))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Piston, this, pistonItems, 1));
    }

    int stickyPistonItems[] = {Tile::pistonStickyBase_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Sticky_Piston))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Sticky_Piston, this, stickyPistonItems, 1));
    }

    int monsterStoneEggItems[] = {Tile::monsterStoneEgg_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Monster_Stone_Egg))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Monster_Stone_Egg, this, monsterStoneEggItems, 1));
    }

    int stoneBrickSmoothItems[] = {Tile::stoneBrick_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Stone_Brick_Smooth))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Stone_Brick_Smooth, this, stoneBrickSmoothItems, 1));
    }
    ...
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Huge_Mushroom, this, hugeMushroomItems, 2));
    }

    int ironFenceItems[] = {Tile::ironFence_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Iron_Fence))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Iron_Fence, this, ironFenceItems, 1));
    }

    int thisGlassItems[] = {Tile::thinGlass_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Thin_Glass))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Thin_Glass, this, thisGlassItems, 1));
    }

    int melonItems[] = {Tile::melon_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Melon))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Melon, this, melonItems, 1));
    }

    int vineItems[] = {Tile::vine_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Vine))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Vine, this, vineItems, 1));
    }

    int fenceGateItems[] = {Tile::fenceGate_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Fence_Gate))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Fence_Gate, this, fenceGateItems, 1));
    }

    int mycelItems[] = {Tile::mycel_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Mycel))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Mycel, this, mycelItems, 1));
    }

    int waterLilyItems[] = {Tile::waterLily_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Water_Lily))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Water_Lily, this, waterLilyItems, 1));
    }

    int netherBrickItems[] = {Tile::netherBrick_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Nether_Brick))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Nether_Brick, this, netherBrickItems, 1));
    }

    int netherFenceItems[] = {Tile::netherFence_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Nether_Fence))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Nether_Fence, this, netherFenceItems, 1));
    }

    int netherStalkItems[] = {Tile::netherStalk_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Nether_Stalk))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Nether_Stalk, this, netherStalkItems, 1));
    }

    int enchantTableItems[] = {Tile::enchantTable_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Enchant_Table))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Enchant_Table, this, enchantTableItems, 1));
    }

    int brewingStandItems[] = {Tile::brewingStand_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Brewing_Stand))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Brewing_Stand, this, brewingStandItems, 1, Item::brewingStand_Id));
    }

    int cauldronItems[] = {Tile::cauldron_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Cauldron))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Cauldron, this, cauldronItems, 1, Item::cauldron_Id));
    }

    int endPortalItems[] = {Tile::endPortalTile_Id};
    if (!isHintCompleted(e_Tutorial_Hint_End_Portal))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_End_Portal, this, endPortalItems, 1, -2));
    }

    int endPortalFrameItems[] = {Tile::endPortalFrameTile_Id};
    if (!isHintCompleted(e_Tutorial_Hint_End_Portal_Frame))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_End_Portal_Frame, this, endPortalFrameItems, 1));
    }

    int whiteStoneItems[] = {Tile::endStone_Id};
    if (!isHintCompleted(e_Tutorial_Hint_White_Stone))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_White_Stone, this, whiteStoneItems, 1));
    }

    int dragonEggItems[] = {Tile::dragonEgg_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Dragon_Egg))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Dragon_Egg, this, dragonEggItems, 1));
    }

    int redstoneLampItems[] = {Tile::redstoneLight_Id, Tile::redstoneLight_lit_Id};
    if (!isHintCompleted(e_Tutorial_Hint_RedstoneLamp))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_RedstoneLamp, this, redstoneLampItems, 2));
    }

    int cocoaItems[] = {Tile::cocoa_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Cocoa))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Cocoa, this, cocoaItems, 1, Item::dye_powder_Id, -1, DyePowderItem::BROWN));
    }

    int emeraldOreItems[] = {Tile::emeraldOre_Id};
    if (!isHintCompleted(e_Tutorial_Hint_EmeraldOre))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_EmeraldOre, this, emeraldOreItems, 1));
    }

    int emeraldBlockItems[] = {Tile::emeraldBlock_Id};
    if (!isHintCompleted(e_Tutorial_Hint_EmeraldBlock))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_EmeraldBlock, this, emeraldBlockItems, 1));
    }

    int enderChestItems[] = {Tile::enderChest_Id};
    if (!isHintCompleted(e_Tutorial_Hint_EnderChest))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_EnderChest, this, enderChestItems, 1));
    }

    int tripwireSourceItems[] = {Tile::tripWireSource_Id};
    if (!isHintCompleted(e_Tutorial_Hint_TripwireSource))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_TripwireSource, this, tripwireSourceItems, 1));
    }

    int tripwireItems[] = {Tile::tripWire_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Tripwire))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Tripwire, this, tripwireItems, 1, Item::string_Id));
    }
    ...
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Flowerpot, this, flowerpotItems, 1, Item::flowerPot_Id));
    }

    int anvilItems[] = {Tile::anvil_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Anvil))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Anvil, this, anvilItems, 1));
    }

    int quartzOreItems[] = {Tile::netherQuartz_Id};
    if (!isHintCompleted(e_Tutorial_Hint_QuartzOre))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_QuartzOre, this, quartzOreItems, 1));
    }
    ...
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_WoolCarpet, this, carpetItems, 1));
    }

    int potatoItems[] = {Tile::potatoes_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Potato))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Potato, this, potatoItems, 1, -1, -1, 7));
    }

    int carrotItems[] = {Tile::carrots_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Carrot))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Carrot, this, carrotItems, 1, -1, -1, 7));
    }

    int commandBlockItems[] = {Tile::commandBlock_Id};
    if (!isHintCompleted(e_Tutorial_Hint_CommandBlock))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_CommandBlock, this, commandBlockItems, 1));
    }

    int beaconItems[] = {Tile::beacon_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Beacon))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Beacon, this, beaconItems, 1));
    }

    int activatorRailItems[] = {Tile::activatorRail_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Activator_Rail))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Activator_Rail, this, activatorRailItems, 1));
    }
    ...
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_DaylightDetector, this, daylightDetectorItems, 1));
    }

    int dropperItems[] = {Tile::dropper_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Dropper))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Dropper, this, dropperItems, 1));
    }

    int hopperItems[] = {Tile::hopper_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Hopper))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Hopper, this, hopperItems, 1));
    }

    int comparatorItems[] = {Tile::comparator_off_Id, Tile::comparator_on_Id};
    if (!isHintCompleted(e_Tutorial_Hint_Comparator))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_Comparator, this, comparatorItems, 2, Item::comparator_Id));
    }

    int trappedChestItems[] = {Tile::chest_trap_Id};
    if (!isHintCompleted(e_Tutorial_Hint_ChestTrap))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_ChestTrap, this, trappedChestItems, 1));
    }

    int hayBlockItems[] = {Tile::hayBlock_Id};
    if (!isHintCompleted(e_Tutorial_Hint_HayBlock))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_HayBlock, this, hayBlockItems, 1));
    }

    int clayHardenedItems[] = {Tile::clayHardened_Id};
    if (!isHintCompleted(e_Tutorial_Hint_ClayHardened))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_ClayHardened, this, clayHardenedItems, 1));
    }

    int clayHardenedColoredItems[] = {Tile::clayHardened_colored_Id};
    if (!isHintCompleted(e_Tutorial_Hint_ClayHardenedColored))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_ClayHardenedColored, this, clayHardenedColoredItems, 1));
    }

    int coalBlockItems[] = {Tile::coalBlock_Id};
    if (!isHintCompleted(e_Tutorial_Hint_CoalBlock))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtTileHint(e_Tutorial_Hint_CoalBlock, this, coalBlockItems, 1));
    }
    ...
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtEntityHint(e_Tutorial_Hint_Squid, this, IDS_DESC_SQUID, IDS_SQUID, eTYPE_SQUID));
    }
    if (!isHintCompleted(e_Tutorial_Hint_Cow))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtEntityHint(e_Tutorial_Hint_Cow, this, IDS_DESC_COW, IDS_COW, eTYPE_COW));
    }
    if (!isHintCompleted(e_Tutorial_Hint_Sheep))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtEntityHint(e_Tutorial_Hint_Sheep, this, IDS_DESC_SHEEP, IDS_SHEEP, eTYPE_SHEEP));
    }
    if (!isHintCompleted(e_Tutorial_Hint_Chicken))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtEntityHint(e_Tutorial_Hint_Chicken, this, IDS_DESC_CHICKEN, IDS_CHICKEN, eTYPE_CHICKEN));
    }
    if (!isHintCompleted(e_Tutorial_Hint_Pig))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtEntityHint(e_Tutorial_Hint_Pig, this, IDS_DESC_PIG, IDS_PIG, eTYPE_PIG));
    }
    if (!isHintCompleted(e_Tutorial_Hint_Wolf))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtEntityHint(e_Tutorial_Hint_Wolf, this, IDS_DESC_WOLF, IDS_WOLF, eTYPE_WOLF));
    }
    if (!isHintCompleted(e_Tutorial_Hint_Creeper))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtEntityHint(e_Tutorial_Hint_Creeper, this, IDS_DESC_CREEPER, IDS_CREEPER, eTYPE_CREEPER));
    }
    if (!isHintCompleted(e_Tutorial_Hint_Skeleton))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtEntityHint(e_Tutorial_Hint_Skeleton, this, IDS_DESC_SKELETON, IDS_SKELETON, eTYPE_SKELETON));
    }
    if (!isHintCompleted(e_Tutorial_Hint_Spider))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtEntityHint(e_Tutorial_Hint_Spider, this, IDS_DESC_SPIDER, IDS_SPIDER, eTYPE_SPIDER));
    }
    if (!isHintCompleted(e_Tutorial_Hint_Zombie))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtEntityHint(e_Tutorial_Hint_Zombie, this, IDS_DESC_ZOMBIE, IDS_ZOMBIE, eTYPE_ZOMBIE));
    }
    if (!isHintCompleted(e_Tutorial_Hint_Pig_Zombie))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtEntityHint(e_Tutorial_Hint_Pig_Zombie, this, IDS_DESC_PIGZOMBIE, IDS_PIGZOMBIE, eTYPE_PIGZOMBIE));
    }
    if (!isHintCompleted(e_Tutorial_Hint_Ghast))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtEntityHint(e_Tutorial_Hint_Ghast, this, IDS_DESC_GHAST, IDS_GHAST, eTYPE_GHAST));
    }
    if (!isHintCompleted(e_Tutorial_Hint_Slime))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtEntityHint(e_Tutorial_Hint_Slime, this, IDS_DESC_SLIME, IDS_SLIME, eTYPE_SLIME));
    }
    if (!isHintCompleted(e_Tutorial_Hint_Enderman))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtEntityHint(e_Tutorial_Hint_Enderman, this, IDS_DESC_ENDERMAN, IDS_ENDERMAN, eTYPE_ENDERMAN));
    }
    if (!isHintCompleted(e_Tutorial_Hint_Silverfish))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtEntityHint(e_Tutorial_Hint_Silverfish, this, IDS_DESC_SILVERFISH, IDS_SILVERFISH, eTYPE_SILVERFISH));
    }
    if (!isHintCompleted(e_Tutorial_Hint_Cave_Spider))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtEntityHint(e_Tutorial_Hint_Cave_Spider, this, IDS_DESC_CAVE_SPIDER, IDS_CAVE_SPIDER, eTYPE_CAVESPIDER));
    }
    if (!isHintCompleted(e_Tutorial_Hint_MushroomCow))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtEntityHint(e_Tutorial_Hint_MushroomCow, this, IDS_DESC_MUSHROOM_COW, IDS_MUSHROOM_COW, eTYPE_MUSHROOMCOW));
    }
    if (!isHintCompleted(e_Tutorial_Hint_SnowMan))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtEntityHint(e_Tutorial_Hint_SnowMan, this, IDS_DESC_SNOWMAN, IDS_SNOWMAN, eTYPE_SNOWMAN));
    }
    if (!isHintCompleted(e_Tutorial_Hint_IronGolem))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtEntityHint(e_Tutorial_Hint_IronGolem, this, IDS_DESC_IRONGOLEM, IDS_IRONGOLEM, eTYPE_VILLAGERGOLEM));
    }
    if (!isHintCompleted(e_Tutorial_Hint_EnderDragon))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtEntityHint(e_Tutorial_Hint_EnderDragon, this, IDS_DESC_ENDERDRAGON, IDS_ENDERDRAGON, eTYPE_ENDERDRAGON));
    }
    if (!isHintCompleted(e_Tutorial_Hint_Blaze))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtEntityHint(e_Tutorial_Hint_Blaze, this, IDS_DESC_BLAZE, IDS_BLAZE, eTYPE_BLAZE));
    }
    if (!isHintCompleted(e_Tutorial_Hint_Lava_Slime))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtEntityHint(e_Tutorial_Hint_Lava_Slime, this, IDS_DESC_LAVA_SLIME, IDS_LAVA_SLIME, eTYPE_LAVASLIME));
    }
    if (!isHintCompleted(e_Tutorial_Hint_Ozelot))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtEntityHint(e_Tutorial_Hint_Ozelot, this, IDS_DESC_OZELOT, IDS_OZELOT, eTYPE_OCELOT));
    }
    if (!isHintCompleted(e_Tutorial_Hint_Villager))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtEntityHint(e_Tutorial_Hint_Villager, this, IDS_DESC_VILLAGER, IDS_VILLAGER, eTYPE_VILLAGER));
    }
    if (!isHintCompleted(e_Tutorial_Hint_Wither))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtEntityHint(e_Tutorial_Hint_Wither, this, IDS_DESC_WITHER, IDS_WITHER, eTYPE_WITHERBOSS));
    }
    if (!isHintCompleted(e_Tutorial_Hint_Witch))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtEntityHint(e_Tutorial_Hint_Witch, this, IDS_DESC_WITCH, IDS_WITCH, eTYPE_WITCH));
    }
    if (!isHintCompleted(e_Tutorial_Hint_Bat))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtEntityHint(e_Tutorial_Hint_Bat, this, IDS_DESC_BAT, IDS_BAT, eTYPE_BAT));
    }
    if (!isHintCompleted(e_Tutorial_Hint_Horse))
    {
        addHint(e_Tutorial_State_Gameplay, new LookAtEntityHint(e_Tutorial_Hint_Horse, this, IDS_DESC_HORSE, IDS_HORSE, eTYPE_HORSE));
    }
    ...
    {
        addHint(e_Tutorial_State_Gameplay, new DiggerItemHint(e_Tutorial_Hint_Item_Shovel, this, IDS_TUTORIAL_HINT_DIGGER_ITEM_SHOVEL, shovelItems, 5));
    }
    ...
    {
        addHint(e_Tutorial_State_Gameplay, new DiggerItemHint(e_Tutorial_Hint_Item_Hatchet, this, IDS_TUTORIAL_HINT_DIGGER_ITEM_HATCHET, hatchetItems, 5));
    }
    ...
    {
        addHint(e_Tutorial_State_Gameplay, new DiggerItemHint(e_Tutorial_Hint_Item_Pickaxe, this, IDS_TUTORIAL_HINT_DIGGER_ITEM_PICKAXE, pickaxeItems, 5));
    }
    ...
    if (isFullTutorial || !isStateCompleted(e_Tutorial_State_Horse))
    {
        ...
        if (isFullTutorial)
        {
            addTask(e_Tutorial_State_Horse, new RideEntityTask(eTYPE_HORSE, this, IDS_TUTORIAL_TASK_HORSE_RIDE, true, nullptr, false, false, false));
        }
        else
        {
            addTask(e_Tutorial_State_Horse, new InfoTask(this, IDS_TUTORIAL_TASK_HORSE_RIDE, IDS_TUTORIAL_PROMPT_PRESS_A_TO_CONTINUE, true, ACTION_MENU_A));
        }
    ...
    if (!m_allTutorialsComplete && currentFailedConstraint[m_CurrentState] == nullptr)
    {
        ...
        while (activeTasks[m_CurrentState].size() > 0 && it != activeTasks[m_CurrentState].end())
        {
            ...
            if (isCurrentTask || task->isPreCompletionEnabled())
            {
                isCurrentTask = false;
                if (
                    (!task->ShowMinimumTime() || (task->hasBeenActivated() && (lastMessageTime + m_iTutorialMinimumDisplayMessageTime) < GetTickCount())) && task->isCompleted())
                {
...
bool Tutorial::setMessage(PopupMessageDetails *message)
{
    ...
    if (message != nullptr && (message->m_messageId > 0 || !message->m_messageString.empty()))
    {
        ...
        if (!message->m_titleString.empty() || message->m_titleId > 0)
        {
            ...
            {
                title = wstring(app.GetString(message->m_titleId));
            }
            else
            {
...
bool Tutorial::isInputAllowed(int mapping)
{
    ...
    if (Minecraft::GetInstance()->localplayers[m_iPad]->isUnderLiquid(Material::water))
    {
        return true;
    }
...
void Tutorial::RemoveConstraint(TutorialConstraint *c, bool delayedRemove /*= false*/)
{
    ...
    else
    {
        ...
        {
            constraints[m_CurrentState].erase(find(constraints[m_CurrentState].begin(), constraints[m_CurrentState].end(), c));
        }
        ...
        {
            constraints[e_Tutorial_State_Gameplay].erase(find(constraints[e_Tutorial_State_Gameplay].begin(), constraints[e_Tutorial_State_Gameplay].end(), c));
        }
    }
}
