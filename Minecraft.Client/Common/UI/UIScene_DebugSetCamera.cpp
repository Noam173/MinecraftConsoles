...
UIControl_TextInput *UIScene_DebugSetCamera::getTextInputForControl(eControls ctrl)
{
    ...
    case eControl_CamZ:
        return &m_textInputZ;
    case eControl_YRot:
        return &m_textInputYRot;
    case eControl_Elevation:
        return &m_textInputElevation;
    default:
        return NULL;
    }
}
...
#else
        >>>>>>> origin / main InputManager.RequestKeyboard(L"Enter something", L"", (DWORD)0, 25, &UIScene_DebugSetCamera::KeyboardCompleteCallback, this, C_4JInput::EKeyboardMode_Default);
#endif
        break;
    };
}
...
#else
    >>>>>>> origin / main InputManager.GetText(pchText);
#endif
