...
{
    if (m_staticGroupsA != nullptr)
    {
        delete[] m_staticGroupsA;
    }
    if (m_dynamicGroupsA != nullptr)
    {
        delete[] m_dynamicGroupsA;
    }
    if (m_debugGroupsA != nullptr)
    {
        delete[] m_debugGroupsA;
    }
}
    ...
    case ACTION_MENU_RIGHT_SCROLL:
        {
            ...
            if (tab < 0)
            {
                tab = static_cast<ECreativeInventoryTabs>(eCreativeInventoryTab_COUNT - 1);
            }
