...
UIControl_TextInput *UIScene_DebugCreateSchematic::getTextInputForControl(eControls ctrl)
{
    ...
    case eControl_StartX:
        return &m_textInputStartX;
    case eControl_StartY:
        return &m_textInputStartY;
    case eControl_StartZ:
        return &m_textInputStartZ;
    case eControl_EndX:
        return &m_textInputEndX;
    case eControl_EndY:
        return &m_textInputEndY;
    case eControl_EndZ:
        return &m_textInputEndZ;
    default:
        return NULL;
    }
}
...
void UIScene_DebugCreateSchematic::onDirectEditFinished(UIControl_TextInput *input, UIControl_TextInput::EDirectEditResult result)
{
    ...
    else if (input == &m_textInputStartX)
    {
        m_data->startX = iVal;
    }
    else if (input == &m_textInputStartY)
    {
        m_data->startY = iVal;
    }
    else if (input == &m_textInputStartZ)
    {
        m_data->startZ = iVal;
    }
    else if (input == &m_textInputEndX)
    {
        m_data->endX = iVal;
    }
    else if (input == &m_textInputEndY)
    {
        m_data->endY = iVal;
    }
    else if (input == &m_textInputEndZ)
    {
        m_data->endZ = iVal;
    }
}
