...
vector<Biome::MobSpawnerData *> *Biome::getMobs(MobCategory *category)
{
    ...
    {
        return &waterFriendlies;
    }
    if (category == MobCategory::creature_chicken)
    {
        return &friendlies_chicken;
    }
    if (category == MobCategory::creature_wolf)
    {
        return &friendlies_wolf;
    }
