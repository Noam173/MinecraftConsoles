...
void CompressedTileStorage::compress(int upgradeBlock /*=-1*/)
{
    ...
    if ((allocatedSize == 1024) && (upgradeBlock == -1))
    {
        return;
    }
