...
unsigned int ClothTileItem::getDescriptionId(shared_ptr<ItemInstance> instance)
{
    ...
    {
        return CARPET_COLOR_DESCS[ClothTile::getTileDataForItemAuxValue(instance->getAuxValue())];
    }
    else
    {
        return COLOR_DESCS[ClothTile::getTileDataForItemAuxValue(instance->getAuxValue())];
    }
}
