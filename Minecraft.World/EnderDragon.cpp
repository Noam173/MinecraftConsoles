...
void EnderDragon::readAdditionalSaveData(CompoundTag *tag)
{
    ...
    {
        setSynchedAction(static_cast<EEnderdragonAction>(tag->getInt(L"DragonState")), true);
    }
