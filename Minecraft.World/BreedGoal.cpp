...
void BreedGoal::breed()
{
    ...
    for (int i = 0; i < 7; i++)
    {
        ...
        level->addParticle(eParticleType_heart, animal->x + random->nextFloat() * animal->bbWidth * 2 - animal->bbWidth, animal->y + .5f + random->nextFloat() * animal->bbHeight, animal->z + random->nextFloat() * animal->bbWidth * 2 - animal->bbWidth, xa, ya, za);
    }
