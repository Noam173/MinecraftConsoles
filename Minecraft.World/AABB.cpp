...
HitResult *AABB::clip(Vec3 *a, Vec3 *b)
{
    ...
    if (xh0 != nullptr && (closest == nullptr || a->distanceToSqr(xh0) < a->distanceToSqr(closest)))
    {
        closest = xh0;
    }
    if (xh1 != nullptr && (closest == nullptr || a->distanceToSqr(xh1) < a->distanceToSqr(closest)))
    {
        closest = xh1;
    }
    if (yh0 != nullptr && (closest == nullptr || a->distanceToSqr(yh0) < a->distanceToSqr(closest)))
    {
        closest = yh0;
    }
    if (yh1 != nullptr && (closest == nullptr || a->distanceToSqr(yh1) < a->distanceToSqr(closest)))
    {
        closest = yh1;
    }
    if (zh0 != nullptr && (closest == nullptr || a->distanceToSqr(zh0) < a->distanceToSqr(closest)))
    {
        closest = zh0;
    }
    if (zh1 != nullptr && (closest == nullptr || a->distanceToSqr(zh1) < a->distanceToSqr(closest)))
    {
        closest = zh1;
    }
