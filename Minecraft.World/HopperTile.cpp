...
{
    if (name.compare(TEXTURE_OUTSIDE) == 0)
    {
        return Tile::hopper->hopperIcon;
    }
    if (name.compare(TEXTURE_INSIDE) == 0)
    {
        return Tile::hopper->hopperInnerIcon;
    }
    return nullptr;
}
